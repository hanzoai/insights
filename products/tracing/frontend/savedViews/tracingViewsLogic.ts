...
// Handwritten until `insightscli build:openapi` generates `TracingViewApi` from TracingViewSerializer.
...
const tracingViewsUrl = (teamId: number | null): string => `v1/projects/${teamId}/tracing/views`
...
export interface tracingViewsLogicActions {
    ...
    createView: ({ name, filters }: { filters: Partial<SavedTracingFilters>; name: string }) => {
        name: string
        filters: Partial<SavedTracingFilters>
    }
    createViewFailure: (
