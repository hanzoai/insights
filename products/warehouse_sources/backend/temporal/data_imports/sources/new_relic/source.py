...
class NewRelicSource(ResumableSource[NewRelicSourceConfig, NewRelicResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your New Relic User API key and account ID to pull your New Relic data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/new-relic",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
