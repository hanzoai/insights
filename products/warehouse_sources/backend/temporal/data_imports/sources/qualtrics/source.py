...
class QualtricsSource(ResumableSource[QualtricsSourceConfig, QualtricsResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Qualtrics datacenter ID and credentials to pull surveys, responses and account metadata into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/qualtrics",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
