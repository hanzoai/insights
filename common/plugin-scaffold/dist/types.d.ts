...
export interface Plugin<Input extends PluginInput = {}> {
    /** Ran when the plugin is loaded by the Insights plugin server. */
    setupPlugin?: (meta: Meta<Input>) => void;
    /** Ran when the plugin is unloaded by the Insights plugin server. */
    ...
    filterEvent?: (event: InsightsEvent, meta: Meta<Input>) => boolean;
    /** Used for modifying events, return the updated event */
    modifyEvent?: (event: InsightsEvent, meta: Meta<Input>) => InsightsEvent;
    ...
    composeWebhook?: (event: InsightsEvent, meta: Meta<Input>) => Webhook | null;
    /** @deprecated */
...
export type PluginMeta<T> = T extends {
    __internalMeta?: infer M;
} ? M : never;
export type Properties = Record<string, any>;
/** The standard Insights event model. */
...
/** @deprecated: Use InsightsEvent.properties['$elements_chain'] */
