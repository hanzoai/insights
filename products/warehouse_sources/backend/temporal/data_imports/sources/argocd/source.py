...
Your Argo CD API server must be reachable from Insights over HTTPS with a publicly trusted certificate — servers on a private network can't be synced.""",
            iconPath="/static/services/argocd.png",
            docsUrl="https://hanzo.ai/docs/cdp/sources/argocd",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
