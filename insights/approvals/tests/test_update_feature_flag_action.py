...
from insights.approvals.actions.feature_flags import UpdateFeatureFlagAction
...
class TestMultiPolicyConflictDetection(APIBaseTest):
    ...
    @patch("insights.approvals.decorators._is_approvals_enabled", return_value=True)
...
class TestActionRegistrationAndIntegration(APIBaseTest):
    def test_update_feature_flag_action_registered_in_registry(self):
        from insights.approvals.actions.registry import ACTION_REGISTRY, register_actions
