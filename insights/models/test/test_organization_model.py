...
class TestOrganization(BaseTest):
    ...
    def test_plugins_are_preinstalled_on_self_hosted(self, mock_get):
        with self.is_cloud(False):
            with self.settings(PLUGINS_PREINSTALLED_URLS=["https://github.com/hanzoai/helloworldplugin/"]):
        ...
        mock_get.assert_any_call(
            f"https://github.com/hanzoai/helloworldplugin/archive/{HELLO_WORLD_PLUGIN_GITHUB_ZIP[0]}.zip",
            headers={},
        )
