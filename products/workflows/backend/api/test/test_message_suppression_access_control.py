...
class TestMessageSuppressionAccessControl(APIBaseTest):
    ...
    def setUp(self) -> None:
        ...
        self.object_viewer = User.objects.create_and_join(self.organization, "obj-viewer@hanzo.ai", "testtest")
        self.object_editor = User.objects.create_and_join(self.organization, "obj-editor@hanzo.ai", "testtest")
        self.resource_viewer = User.objects.create_and_join(self.organization, "res-viewer@hanzo.ai", "testtest")
        self.resource_editor = User.objects.create_and_join(self.organization, "res-editor@hanzo.ai", "testtest")
        ...
        # per-object lookup, so a real InsightsFlow row isn't needed to prove the regression.
