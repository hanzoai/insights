...
const streamlitAppsCreate = (): ToolBase<typeof StreamlitAppsCreateSchema, WithInsightsUrl<Schemas.AppContract>> => ({
...
const streamlitAppsGet = (): ToolBase<typeof StreamlitAppsGetSchema, WithInsightsUrl<Schemas.AppContract>> => ({
...
const streamlitAppsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedAppSummaryContractList>
> => ({
            ...
            context,
            {
                ...
                results: await Promise.all(
                    (result.results ?? []).map((item) =>
                        withInsightsUrl(context, item, `/streamlit-apps/${item.short_id}`)
                    )
                ),
            },
            '/streamlit-apps'
...
const streamlitAppsStart = (): ToolBase<typeof StreamlitAppsStartSchema, WithInsightsUrl<Schemas.AppContract>> => ({
...
const streamlitAppsStop = (): ToolBase<typeof StreamlitAppsStopSchema, WithInsightsUrl<Schemas.AppContract>> => ({
...
const streamlitAppsUpdate = (): ToolBase<typeof StreamlitAppsUpdateSchema, WithInsightsUrl<Schemas.AppContract>> => ({
...
const streamlitAppsVersions = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.StreamlitAppVersionList>
> => ({
