...
from insights.models.oauth import OAuthAccessToken, OAuthApplication, revoke_oauth_session
...
class ConnectedAppSerializer(serializers.Serializer):
    ...
    is_verified = serializers.BooleanField(help_text="Whether this application has been verified by Insights")
    is_first_party = serializers.BooleanField(help_text="Whether this is a first-party Insights application")
