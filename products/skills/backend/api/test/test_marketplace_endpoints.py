...
class TestMarketplaceResilience(APIBaseTest):
    def test_skill_with_uncloneable_paths_is_skipped_not_fatal(self):
        ...
        assert "plugins/insights-skill-store/skills/good/SKILL.md" in tree
        assert "plugins/insights-skill-store/skills/bad/SKILL.md" not in tree
...
class TestMarketplaceInstallCommand(APIBaseTest):
    ...
    def test_get_reports_absent_when_no_credential(self):
        ...
        assert body["plugin_name"] == "insights-skill-store"
    ...
    def test_post_mints_read_only_team_scoped_credential(self):
        ...
        assert f"codex plugin add insights-skill-store@{body['marketplace_name']}" in body["codex_command"]
    ...
    def test_one_user_connecting_does_not_roll_another_users_credential(self):
        ...
        teammate = User.objects.create_and_join(self.organization, "teammate@hanzo.ai", "pw")
...
class TestImportAndCreateValidation(APIBaseTest):
    ...
    def test_oversize_skills_skipped_from_marketplace_tree(self):
        ...
        assert "plugins/insights-skill-store/skills/aaa/SKILL.md" in tree
        assert "plugins/insights-skill-store/skills/zzz/SKILL.md" not in tree
...
class TestSkillMarketplaceRBAC(APIBaseTest):
    ...
    def setUp(self):
        ...
        self.member = User.objects.create_and_join(self.organization, "rbac-member@hanzo.ai", "pw")
