/**
 * Insights Design System — Data-visualization tokens
 *
 * Two kinds of token live here, both consumed by `@hanzo/quill-charts`
 ...
 *
 * Var names match the Insights app's historical `--data-color-*` /
...
export declare const dataColors: readonly DataColorTuple[];
...
export declare const dataColorPalette: readonly string[];
/** CSS custom property name for the categorical color at `index` (0-based). */
export declare function dataColorVarName(index: number): string;
/**
 ...
 */
export declare function generateDataVizVars(indent?: string): {
    light: string;
    dark: string;
};
