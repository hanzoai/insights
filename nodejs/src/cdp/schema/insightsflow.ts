...
const InsightsFlowOutputVariableSchema = z.object({
    key: z.string(),
...
const legacyStringOutputVariable = z.string().transform((key): z.infer<typeof InsightsFlowOutputVariableSchema> => ({ key }))
...
const _commonActionFields = {
    ...
    output_variable: z // The Hogflow-level variable to store the output of this action into
        .union([
            InsightsFlowOutputVariableSchema,
            z.array(z.union([InsightsFlowOutputVariableSchema, legacyStringOutputVariable])),
...
const InsightsFlowTriggerSchema = z.discriminatedUnion('type', [
    z.object({
...
export const InsightsFlowActionSchema = z.discriminatedUnion('type', [
    ...
    z.object({
        ...
        config: InsightsFlowTriggerSchema,
...
export const InsightsFlowSchema = z.object({
    ...
    trigger: InsightsFlowTriggerSchema,
