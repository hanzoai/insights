...
CheckConstraint (see insights/models/oauth.py :: enforce_supported_grant_types)
...
STREAMLIT_OAUTH_APP_NAME = "Insights Streamlit Apps"
STREAMLIT_OAUTH_CLIENT_ID = "insights-streamlit-apps-first-party"


def seed_oauth_app(apps, schema_editor):
    OAuthApplication = apps.get_model("insights", "OAuthApplication")
