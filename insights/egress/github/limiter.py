...
depending on the account's plan tier, shared across every Insights consumer of that
...
# insights/egress/github/transport.py) absorbs drift between our local count and GitHub's actual
