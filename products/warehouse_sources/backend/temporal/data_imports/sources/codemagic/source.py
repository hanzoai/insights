...
class CodemagicSource(ResumableSource[CodemagicSourceConfig, CodemagicResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Codemagic",
            caption="""Enter a Codemagic personal API token to sync your applications and build history into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/codemagic",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
