...
from insights.async_migrations.examples.test_migration import Migration
from insights.async_migrations.runner import run_async_migration_next_op, run_async_migration_operations
from insights.async_migrations.test.util import create_async_migration
...
class TestAsyncMigrations(BaseTest):
    ...
    @patch("insights.celery.app.control.inspect", side_effect=inspect_mock)
    @patch(
        "insights.tasks.async_migrations.run_async_migration.delay",
