...
# Mirrors the AiRegexHelper prompt style (insights/session_recordings/ai_data/ai_regex_prompts.py)
# but inverts the task: given real URL paths, propose path-cleaning rules.
SYSTEM_PROMPT = """You are a web analytics expert who writes URL path-cleaning rules for Insights.
