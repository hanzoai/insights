...
from insights.temporal.session_replay.session_summary.activities.video_based.a6_consolidate_video_segments import (
...
ACTIVITY_MODULE = "insights.temporal.session_replay.session_summary.activities.video_based.a6_consolidate_video_segments"
