 ...
 * {@link Composer} primitives that reproduces the Insights AI input look (bordered rounded container,
 * large textarea with an overlaid placeholder, an absolutely-positioned primary send button) without
 * any of Insights AI's conversation-only features. It holds no draft or send state of its own: callers
