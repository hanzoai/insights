...
data through the Insights MCP with `call --json` and save each payload to a file,
...
def main() -> int:
    ...
    ap.add_argument("--no-art", dest="art", action="store_false", help="skip the mascot banner")
    ap.add_argument("--base-url", default="https://us.hanzo.ai")
