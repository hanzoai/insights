...
export const STREAM_COMPLETE_CONTROL_TYPE = '_insights/stream_complete'
...
export const CORS_ALLOW_HEADERS =
    'authorization, last-event-id, content-type, accept, x-csrftoken, x-insights-distinct-id, x-insights-session-id'
export const CORS_MAX_AGE = '600'

// JWT audience strings (must match Python validate_* helpers)
export const STREAM_READ_AUDIENCE = 'insights:stream_read'
export const SANDBOX_EVENT_INGEST_AUDIENCE = 'insights:sandbox_event_ingest'
