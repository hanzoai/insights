...
from insights.schema import AlertCalculationInterval, AlertState
...
from insights.tasks.alerts.metrics_investigation import MAX_SUMMARY_LENGTH
from insights.tasks.alerts.test.alert_check_helpers import run_alert_check
...
@patch("products.alerts.backend.api.alert.hanzo_insights.feature_enabled", side_effect=_metrics_flag_only)
@patch("insights.tasks.alerts.utils.send_notifications_for_errors")
@patch("insights.tasks.alerts.utils.send_notifications_for_breaches")
class TestMetricsAlerts(APIBaseTest, DatastoreTestMixin):
    def setUp(self) -> None:
        super().setUp()
    ...
    def test_investigation_failure_is_recorded_without_breaking_the_alert(
        ...
        with patch(
            "insights.tasks.alerts.metrics_investigation._run_investigation",
