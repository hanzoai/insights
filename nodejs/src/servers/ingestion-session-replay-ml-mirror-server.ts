...
async function assertAnonymizerHealthy(anonymizer: typeof import('@hanzo/replay-anonymizer')): Promise<void> {
...
export class IngestionSessionReplayMlMirrorServer implements NodeServer {
    ...
    private async startServices(): Promise<void> {
        ...
        const anonymizer = require('@hanzo/replay-anonymizer') as typeof import('@hanzo/replay-anonymizer')
