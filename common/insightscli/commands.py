...
This is the extension point for adding new Click commands to insightscli.
Add your @cli.command() decorated functions here as an alternative to shell scripts.

They auto-register with insightscli and appear in `insightscli --help` automatically.

Example:
    ```python
    import click
    from common.insightscli.core.cli import cli
...
- Import cli group from common.insightscli.core.cli
...
from insightscli import (
    doctor,  # noqa: F401
    migrations,  # noqa: F401
    product,  # noqa: F401
)
from insightscli.devenv import cli as devenv_cli  # noqa: F401
