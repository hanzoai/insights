...
export interface insightVizDataLogicValues {
    ...
    querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null;
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface insightVizDataLogicActions {
    cancelChanges: () => {
        value: true;
    }; // insightDataLogic
    loadData: (refresh?: RefreshType | undefined, alreadyRunningQueryId?: string | undefined, overrideQuery?: DataNode<Record<string, any>> | undefined) => {
    ...
    updateDateRange: (dateRange: DateRange, ignoreDebounce?: boolean) => {
        dateRange: DateRange;
    ...
    zoomDateRange: (dateFrom: string, dateTo: string) => {
        dateFrom: string;
        dateTo: string;
    };
}
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface insightVizDataLogicMeta {
    key: string;
    __keaTypeGenInternalSelectorTypes: {
        querySource: (query: Node<Record<string, any>> | null) => FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null;
        localQuerySource: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null, filterTestAccountsDefault: boolean) => InsightQueryNode;
        isTrends: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean;
        isFunnels: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean;
        isRetention: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean;
        isPaths: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean;
        isStickiness: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean;
        isLifecycle: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean;
        isWebStatsTable: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean;
        isWebOverview: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean;
        isWebAnalytics: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean;
        isTrendsLike: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean;
        supportsDisplay: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean;
        supportsCompare: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null, display: ChartDisplayType | null | undefined, dateRange: DateRange | null | undefined) => boolean;
        supportsPercentStackView: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean;
        supportsBarValueStacking: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean;
        supportsValueOnSeries: (isTrends: boolean, isFunnels: boolean, isStickiness: boolean, isLifecycle: boolean, display: ChartDisplayType | null | undefined) => boolean;
        supportsResultCustomizationBy: (isTrends: boolean, display: ChartDisplayType | null | undefined) => boolean;
        dateRange: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => DateRange | null | undefined;
        breakdownFilter: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => BreakdownFilter | null | undefined;
        compareFilter: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => CompareFilter | null | undefined;
        display: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => ChartDisplayType | null | undefined;
        formula: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => string | null | undefined;
        formulas: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => string[] | null | undefined;
        formulaNodes: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => TrendsFormulaNode[];
        series: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => (AnyEntityNode<AnyDataWarehouseNode> | GroupNode<DataWarehouseNode>)[] | null | undefined;
        interval: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => IntervalType | null | undefined;
        properties: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => PropertyGroupFilter | AnyPropertyFilter[] | null | undefined;
        samplingFactor: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => number | null | undefined;
        showAlertThresholdLines: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean | null | undefined;
        showAnnotations: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean | null | undefined;
        showLegend: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean | null | undefined;
        legendPosition: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => string | null | undefined;
        showValuesOnSeries: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean | null | undefined;
        showPercentagesOnSeries: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean | null | undefined;
        showLabelOnSeries: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean | null | undefined;
        showPercentStackView: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean | null | undefined;
        yAxisScaleType: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => string | null | undefined;
        showMultipleYAxes: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean | null | undefined;
        resultCustomizationBy: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => ResultCustomizationBy | null | undefined;
        aggregationGroupTypeIndex: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => GroupTypeIndex | null | undefined;
        labelGroupType: (aggregationGroupTypeIndex: GroupTypeIndex | null | undefined) => LabelGroupType;
        goalLines: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => GoalLine[] | null | undefined;
        insightFilter: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => InsightFilter | null | undefined;
        trendsFilter: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => TrendsFilter | null | undefined;
        detailedResultsAggregationType: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => AggregationType | undefined;
        funnelsFilter: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => FunnelsFilter | null | undefined;
        retentionFilter: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => RetentionFilter | null;
        pathsFilter: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => PathsFilter | null;
        stickinessFilter: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => StickinessFilter | null | undefined;
        lifecycleFilter: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => LifecycleFilter | null | undefined;
        funnelPathsFilter: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => FunnelPathsFilter | null | undefined;
        vizSpecificOptions: (query: Node<Record<string, any>> | null) => VizSpecificOptions | null | undefined;
        isUsingSessionAnalysis: (series: (AnyEntityNode<AnyDataWarehouseNode> | GroupNode<DataWarehouseNode>)[] | null | undefined, breakdownFilter: BreakdownFilter | null | undefined, properties: PropertyGroupFilter | AnyPropertyFilter[] | null | undefined) => boolean | Breakdown;
        shouldShowSessionAnalysisWarning: (isUsingSessionAnalysis: boolean | Breakdown, query: Node<Record<string, any>> | null) => boolean;
        isNonTimeSeriesDisplay: (display: ChartDisplayType | null | undefined) => boolean;
        isSingleSeriesOutput: (isTrends: boolean, formula: string | null | undefined, formulas: string[] | null | undefined, formulaNodes: TrendsFormulaNode[], series: (AnyEntityNode<AnyDataWarehouseNode> | GroupNode<DataWarehouseNode>)[] | null | undefined, breakdownFilter: BreakdownFilter | null | undefined) => boolean;
        isBreakdownSeries: (breakdownFilter: BreakdownFilter | null | undefined) => boolean;
        isSingleSeriesDefinition: (isTrends: boolean, formula: string | null | undefined, formulas: string[] | null | undefined, formulaNodes: TrendsFormulaNode[], series: (AnyEntityNode<AnyDataWarehouseNode> | GroupNode<DataWarehouseNode>)[] | null | undefined) => boolean;
        hasDataWarehouseSeries: (series: (AnyEntityNode<AnyDataWarehouseNode> | GroupNode<DataWarehouseNode>)[] | null | undefined) => boolean;
        hasOnlyDataWarehouseSeries: (series: (AnyEntityNode<AnyDataWarehouseNode> | GroupNode<DataWarehouseNode>)[] | null | undefined) => boolean;
        currentDataWarehouseSchemaColumns: (series: (AnyEntityNode<AnyDataWarehouseNode> | GroupNode<DataWarehouseNode>)[] | null | undefined, isSingleSeriesOutput: boolean, isTrends: boolean, hasDataWarehouseSeries: boolean, isBreakdownSeries: boolean, dataWarehouseTablesMap: Record<string, DatabaseSchemaDataWarehouseTable | DatabaseSchemaViewTable>) => DatabaseSchemaField[];
        valueOnSeries: (isTrends: boolean, isStickiness: boolean, isLifecycle: boolean, insightFilter: InsightFilter | null | undefined) => boolean;
        hasLegend: (isTrends: boolean, isStickiness: boolean, isLifecycle: boolean, display: ChartDisplayType | null | undefined) => boolean;
        usesInChartLegend: (isTrends: boolean, isStickiness: boolean, isLifecycle: boolean, display: ChartDisplayType | null | undefined) => boolean;
        hasDetailedResultsTable: (isTrends: boolean, isStickiness: boolean, display: ChartDisplayType | null | undefined) => boolean;
        hasFormula: (formulaNodes: TrendsFormulaNode[], isFormulaModeOpenedExplicitly: boolean) => boolean;
        activeUsersMath: (series: (AnyEntityNode<AnyDataWarehouseNode> | GroupNode<DataWarehouseNode>)[] | null | undefined) => BaseMathType.MonthlyActiveUsers | BaseMathType.WeeklyActiveUsers | null;
        enabledIntervals: (activeUsersMath: BaseMathType.WeeklyActiveUsers | BaseMathType.MonthlyActiveUsers | null, isTrends: boolean, featureFlags: FeatureFlagsSet) => Intervals;
        ...
        allEventNames: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null, actions: import("~/types").ActionType[]) => string[];
        theme: (getTheme: (themeId: number | string | null | undefined) => DataColorTheme | null // dataThemeLogic
        , querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => DataColorTheme | null;
        isAllEventsQuery: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean;
        isFirstTimeForUserQuery: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean;
        isStrictFunnelQuery: (querySource: FunnelsQuery | LifecycleQuery | PathsQuery | RetentionQuery | StickinessQuery | TrendsQuery | WebOverviewQuery | WebStatsTableQuery | null) => boolean;
        slowQueryPossibilities: (isAllEventsQuery: boolean, isFirstTimeForUserQuery: boolean, isStrictFunnelQuery: boolean) => SlowQueryPossibilities[];
    };
}

export type insightVizDataLogicType = MakeLogicType<insightVizDataLogicValues, insightVizDataLogicActions, InsightLogicProps, insightVizDataLogicMeta>;
...
export const insightVizDataLogic = kea<insightVizDataLogicType>([
    ...
    selectors({
        ...
        supportsResultCustomizationBy: [
            ...
            (isTrends: boolean, display: ChartDisplayType | null | undefined) =>
        ...
        isBreakdownSeries: [
            (s) => [s.breakdownFilter],
            (breakdownFilter: BreakdownFilter | null | undefined): boolean => {
        ...
        validationError: [
            (s) => [s.insightDataError],
            (insightDataError: Record<string, any> | null): string | null => extractValidationError(insightDataError),
        ],
        validationErrorCode: [
            (s) => [s.insightDataError],
            (insightDataError: Record<string, any> | null): string | null =>
                extractValidationErrorCode(insightDataError),
        ],
