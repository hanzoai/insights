    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption=(
                ...
                "customers, license keys, and more into Insights. Create an API key under "
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/lemon-squeezy",
            ...
            webhookSetupCaption=(
                "Insights tries to register a webhook on each of your Lemon Squeezy stores using "
                ...
                "field below so Insights can verify deliveries\n"
            ...
            webhookFields=cast(
                ...
                [
                    SourceFieldInputConfig(
                        ...
                        placeholder="",
                        caption=(
                            "The signing secret configured on the Lemon Squeezy webhook. Insights "
