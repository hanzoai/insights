...
from insights.insightsql_queries.insights.funnels.funnel_correlation_query_runner import FunnelCorrelationQueryRunner
...
from insights.insightsql_queries.query_runner import AnalyticsQueryRunner, QueryRunner, get_query_runner
from insights.models import Team
from insights.models.filters.mixins.utils import cached_property
from insights.models.user import User
from insights.types import InsightActorsQueryNode
...
from products.product_analytics.backend.insightsql_queries.stickiness.stickiness_query_runner import StickinessQueryRunner


class InsightActorsQueryRunner(AnalyticsQueryRunner[InsightsQLQueryResponse]):
    ...
    def is_session_aggregation(self) -> bool:
        if isinstance(self.source_runner, FunnelsQueryRunner):
            ...
            return funnels_filter.funnelAggregateByInsightsQL == FunnelAggregateByInsightsQL.PROPERTIES__SESSION_ID.value
        return False
