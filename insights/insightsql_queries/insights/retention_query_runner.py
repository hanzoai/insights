...
from insights.constants import TREND_FILTER_TYPE_EVENTS
from insights.insightsql_queries.insights.trends.breakdown import BREAKDOWN_OTHER_STRING_LABEL
...
class RetentionQueryRunner(AnalyticsQueryRunner[RetentionQueryResponse]):
                ...
                ast.Alias(
                    ...
                    expr=parse_expr(
                        "floor(dateDiff({unit}, {date_from}, t_0) / {count})",
                        {
                            ...
                            "date_from": self.query_date_range.date_from_as_insightsql(),
                        },
                    ),
                ),
                ast.Alias(
        ...
        if self.is_first_occurrence_matching_filters or self.is_first_ever_occurrence:
            ...
            start_event_timestamps = parse_expr(
                ...
                """,
                {
                    ...
                    "min_timestamp": self.query_date_range.date_to_start_of_interval_insightsql(min_timestamp_inner_expr),
                },
            )
            ...
            ast.Alias(
                ...
                expr=parse_expr(
                    ...
                    """,
                    {
                        ...
                        "date_from_start_of_interval": self.query_date_range.date_from_to_start_of_interval_insightsql(),
    ...
    def _calculate(self) -> RetentionQueryResponse:
        ...
        return RetentionQueryResponse(results=results, timings=response.timings, insightsql=insightsql, modifiers=self.modifiers)
