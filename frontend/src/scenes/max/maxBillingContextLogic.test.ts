    ...
    products: [
        {
            ...
            screenshot_url: 'https://hanzo.ai/docs/product-analytics',
            subscribed: false,
            ...
            addons: [
                {
                    ...
                    docs_url: 'https://hanzo.ai/docs/addon',
                    price_description: '1000',
                    image_url: 'https://hanzo.ai/docs/addon',
                    tiers: [],
                    tiered: false,
                    subscribed: false,
                    inclusion_only: false,
        ...
        },
        {
            ...
            screenshot_url: 'https://hanzo.ai/docs/session-replay',
            subscribed: false,
            current_amount_usd_before_addons: '0',
            current_amount_usd: '0',
            usage_limit: 15000,
        ...
        },
        {
            ...
            screenshot_url: 'https://hanzo.ai/docs/platform-and-support',
            docs_url: 'https://hanzo.ai/docs/platform-and-support',
            current_amount_usd_before_addons: '0',
            current_amount_usd: '0',
            usage_limit: 1000000,
            subscribed: false,
            ...
            plans: [
                {
                    ...
                    current_plan: false,
                    features: [],
                    image_url: 'https://hanzo.ai/docs/platform-and-support',
                    docs_url: 'https://hanzo.ai/docs/platform-and-support',
    ...
    beforeEach(() => {
        useMocks({
            get: {
                ...
                '/v1/organizations/@current/pipeline_destinations/': { results: mockDestinations },
                '/v1/environments/:team_id/pipeline-destinations': { results: mockDestinations },
                '/v1/environments/:team_id/plugin_configs': { results: [] },
                '/v1/organizations/@current/plugins': { results: [] },
                '/v1/organizations/@current/batch_exports': { results: [] },
