...
class TestTrackReviewCompleted(BaseTest):
    ...
    def test_captures_the_turn_with_review_scoped_properties(self, published: bool) -> None:
        ...
        with patch("products.review_hog.backend.temporal.activities.hanzo_insights.capture") as capture:
    ...
    def test_capture_failure_is_swallowed(self) -> None:
        ...
        with patch(
            "products.review_hog.backend.temporal.activities.hanzo_insights.capture",
