...
export interface experimentsTabLogicValues {
    allExperiments: WebExperiment[] // experimentsLogic
    buttonVisible: boolean // toolbarConfigLogic
    dataAttributes: string[] // toolbarConfigLogic
    experimentId: ExperimentIdType | null // toolbarConfigLogic
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface experimentsTabLogicActions {
    getExperiments: (_?: any) => any // experimentsLogic
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface experimentsTabLogicMeta {
...
export type experimentsTabLogicType = MakeLogicType<
    experimentsTabLogicValues,
    experimentsTabLogicActions,
    Record<string, any>,
    experimentsTabLogicMeta
>
