...
import { dimensions, setupJsdom, setupSyncRaf } from '@hanzo/quill-charts/testing'
...
describe('TrendsBarChart (ActionsBarValue)', () => {
    ...
    // Five mascot breakdowns → by default one series carrying five per-bar colors across five
    ...
    it('fires context.onDataPointClick without a day argument', async () => {
        ...
        // script-charts hover/click helpers don't yet handle horizontal axis-orientation, so
...
describe('TrendsBarChart overlays', () => {
    ...
    describe('quill in-chart legend', () => {
        ...
        const getInChartLegend = (container: HTMLElement): HTMLElement =>
            container.querySelector<HTMLElement>('[data-attr="script-chart-timeseries-bar-legend"]')!
