...
from insights.tasks.alerts.investigation_notifications import (
...
class TestInvestigationNotificationSafetyNet(APIBaseTest):
    ...
    @patch("insights.tasks.alerts.investigation_notifications.dispatch_alert_notification")
    @patch("insights.tasks.alerts.investigation_notifications.record_alert_delivery")
    def test_grace_period_predicate(
        ...
        mock_dispatch.return_value = ["test@hanzo.ai"]  # type: ignore[attr-defined]
    ...
    def test_skips_legacy_delivered_check(self, mock_dispatch: object) -> None:
        ...
        self._make_check(
            ...
            targets_notified={"users": ["legacy@hanzo.ai"]},
        )
        notified = run_investigation_notification_safety_net()
        assert notified == 0
        mock_dispatch.assert_not_called()  # type: ignore[attr-defined]
