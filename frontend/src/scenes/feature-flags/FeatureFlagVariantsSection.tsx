import { Collapse, Lettermark, LettermarkColor } from '@hanzo/elements'
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <Collapse
                multiple
                defaultActiveKeys={[]}
                className="[&_.CollapsePanel:not(:last-child)]:border-b [&_.CollapsePanel:not(:last-child)]:border-border-secondary"
