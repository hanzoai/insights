...
# Posted as an in-thread reply under every scout Slack message, inviting @Insights follow-ups.
_SCOUT_SLACK_REPLY_TEXT = "💬 If you have questions, reply in this thread and mention *`@Insights`*!"
...
def _post_scout_slack_reply(
    ...
    *,
    ...
    """Invite @Insights follow-ups when the Slack connection uses the scout's environment.
    ...
    blocks.append(
        {
            ...
            "elements": [
                {
                    "type": "button",
                    "text": {"type": "plain_text", "text": "View finding in Insights"},
                    "url": finding_url,
                }
            ],
        }
    ...
    blocks.append(
        {
            ...
            "elements": [
                {
                    "type": "button",
                    "text": {"type": "plain_text", "text": "View report in Insights"},
                    "url": report_url,
                }
            ],
        }
