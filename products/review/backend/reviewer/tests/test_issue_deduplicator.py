...
from products.review.backend.reviewer.models.issue_deduplicator import DuplicateIssue, IssueDeduplication
from products.review.backend.reviewer.models.issues_review import Issue, IssuePriority, LineRange
from products.review.backend.reviewer.tests.conftest import create_mock_run_sandbox_review
from products.review.backend.reviewer.tools.issue_deduplicator import (
    _comment_range,
    _select_dedup_candidates,
    deduplicate_issues,
)

_MODULE = "products.review.backend.reviewer.tools.issue_deduplicator"
