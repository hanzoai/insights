...
WEBHOOK_URL = "https://us.hanzo.ai/public/webhooks/abc"
...
class TestFourthwallSource:
    ...
    def test_get_source_config(self):
        ...
        assert config.docsUrl == "https://hanzo.ai/docs/cdp/sources/fourthwall"
    ...
    def test_webhook_template_resource_keys_match_the_settings_mapping(self):
        # The script template carries its own event -> resource dict; a schema mapped to a key the
