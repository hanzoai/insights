"""Generate shell completion scripts for insightscli."""

import click
from insightscli.core.manifest import get_manifest


def generate_bash_completion(cli_name: str = "insightscli") -> str:
    """Generate bash completion script for insightscli."""
    manifest = get_manifest()
    commands = " ".join(manifest.get_all_commands())

    return f"""# bash completion for {cli_name}
# Generated by insightscli completion system

_insightscli_completion() {{
...
complete -o bashdefault -o default -o nospace -F _insightscli_completion {cli_name}
"""


def generate_zsh_completion(cli_name: str = "insightscli") -> str:
    """Generate zsh completion script for insightscli."""
    manifest = get_manifest()
    ...
    return f"""#compdef insightscli

# zsh completion for {cli_name}
# Generated from insightscli manifest
...
_insightscli() {{
  ...
  _describe 'insightscli commands' commands
}}
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Generate shell completion for insightscli")
