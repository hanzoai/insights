...
import { Button, Card, CardContent } from '@hanzo/quill'
...
export interface LoopReviewConnectors {
    ...
    insights_mcp_scopes?: 'read_only' | 'full'
}
...
export function describeInsightsAccess(connectors: LoopReviewConnectors | undefined): string {
    return connectors?.insights_mcp_scopes === 'full' ? 'Full (read-write)' : 'Read-only'
}
...
export function LoopReviewView({ data, onCreate, state }: LoopReviewViewProps): ReactElement {
    ...
    const items: { label: string; value: ReactNode }[] = [
        ...
        },
        {
            ...
            value: describeInsightsAccess(data.connectors),
        },
