...
export interface sessionRecordingDataCoordinatorLogicActions {
    ...
    setSnapshots: (snapshots: import('@hanzo/replay-shared').RecordingSnapshot[]) => {
        snapshots: RecordingSnapshot[]
    } // metaLogic
...
export interface sessionRecordingDataCoordinatorLogicMeta {
    ...
    __keaTypeGenInternalSelectorTypes: {
        snapshots: (processedSnapshots: import('@hanzo/replay-shared').RecordingSnapshot[]) => RecordingSnapshot[]
        start: (
            snapshots: import('@hanzo/replay-shared').RecordingSnapshot[],
            sessionPlayerMetaData: SessionRecordingType | null
        ) => Dayjs | null
        end: (
            snapshots: import('@hanzo/replay-shared').RecordingSnapshot[],
        ...
        windowIdForTimestamp: (
            segments: import('@hanzo/replay-shared').RecordingSegment[]
        ) => (timestamp: number) => number | undefined
        urls: (snapshots: import('@hanzo/replay-shared').RecordingSnapshot[]) => {
            timestamp: number
            url: string
        }[]
        ...
        customRRWebEvents: (snapshots: import('@hanzo/replay-shared').RecordingSnapshot[]) => customEvent[]
