...
from insights.temporal.common.insights_client import (
    _InsightsClientActivityInboundInterceptor,
    _InsightsClientWorkflowInterceptor,
)
...
@pytest.mark.parametrize(
    ...
    [
        (_InsightsClientActivityInboundInterceptor, ExecuteActivityInput, "execute_activity", "RunActivity"),
        (_InsightsClientWorkflowInterceptor, ExecuteWorkflowInput, "execute_workflow", "RunWorkflow"),
    ],
)
class TestInsightsClientTeamIdTagging:
