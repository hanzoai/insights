...
class LLMPromptLabel(ModelActivityMixin, UUIDModel):
    ...
    class Meta:
        ...
        db_table = "insights_llmpromptlabel"
    ...
    # db_constraint=False: insights_team / insights_user are hot tables — adding a real FK
...
def invalidate_llm_prompt_cache(sender: type[LLMPrompt], instance: LLMPrompt, **kwargs) -> None:
    ...
    def clear_cache() -> None:
        from insights.storage.llm_prompt_cache import invalidate_prompt_latest_cache, invalidate_prompt_version_cache
...
def invalidate_llm_prompt_label_cache(sender: type[LLMPromptLabel], instance: LLMPromptLabel, **kwargs) -> None:
    ...
    def clear_cache() -> None:
        from insights.storage.llm_prompt_cache import invalidate_prompt_label_cache
