...
export interface maxThreadLogicValues {
    ...
    effectiveApprovalStatuses: Record<string, {
        feedback?: string;
    ...
    resolvedApprovalStatuses: Record<string, {
        feedback?: string;
...
export interface maxThreadLogicActions {
    ...
    askMax: (prompt: string | null, addToThread?: boolean | undefined, uiContext?: Partial<MaxUIContext> | undefined) => {
        addToThread: boolean;
        prompt: string | null;
    ...
    loadConversationHistorySuccess: (conversationHistory: ConversationDetail[], payload?: {
        doNotUpdateCurrentThread?: boolean;
    } | undefined) => {
    ...
    pushSandboxError: (errorMessage: string, variant?: "crash" | "error" | undefined) => {
        errorMessage: string;
        variant: "crash" | "error";
    }; // runStreamLogic
    ...
    continueWithClientToolResult: (result: Record<string, unknown>, toolCallId: string) => {
    ...
    loadQueueData: () => any;
    loadQueueDataFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadQueueDataSuccess: (queueData: {
        limit: number;
        messages: ConversationQueueMessage[];
    }, payload?: any) => {
        queueData: {
    ...
    processNotebookUpdate: (notebookId: string, notebookContent: JSONContent) => {
    ...
    setResolvedApprovalStatus: (proposalId: string, status: "approved" | "auto_rejected" | "rejected", feedback?: string) => {
        feedback: string | undefined;
        proposalId: string;
        status: "approved" | "auto_rejected" | "rejected";
    };
    ...
    setToolCallUpdate: (update: AssistantUpdateEvent | SubagentUpdateEvent, toolMap: Record<string, ToolRegistration>) => {
    ...
    streamConversation: (streamData: {
        ...
        ui_context?: any;
    }, generationAttempt: number, addToThread?: boolean) => {
        addToThread: boolean;
...
export interface maxThreadLogicMeta {
    ...
    __keaTypeGenInternalSelectorTypes: {
        ...
        effectiveApprovalStatuses: (resolvedApprovalStatuses: Record<string, {
            feedback?: string;
            status: "approved" | "auto_rejected" | "rejected";
        }>, pendingApprovalsData: Record<string, PendingApproval>) => Record<string, {
            feedback?: string;
            status: ApprovalDecisionStatus;
        }>;
        isSharedThread: (conversation: Conversation | null, user: null | import("~/types").UserType) => boolean;
        isImpersonatingExistingConversation: (conversation: Conversation | null, supportOverrideEnabled: boolean, user: null | import("~/types").UserType) => boolean;
        ...
        queueDisabledReason: (queueingEnabled: boolean, threadLoading: boolean, queueIsFull: boolean) => string | undefined;
        threadGrouped: (threadRaw: ThreadMessage[], threadLoading: boolean, toolCallUpdateMap: Map<string, string[]>, pendingApprovalsData: Record<string, PendingApproval>, resolvedApprovalStatuses: Record<string, {
            feedback?: string;
            status: "approved" | "auto_rejected" | "rejected";
        }>, currentThinkingMessage: string | null) => ThreadMessage[];
        ...
        activeDangerousOperationApproval: (pendingApprovalProposalId: string | null, pendingApprovalsData: Record<string, PendingApproval>, resolvedApprovalStatuses: Record<string, {
            feedback?: string;
            status: "approved" | "auto_rejected" | "rejected";
        }>) => {
            payload: Record<string, any>;
        ...
        inputDisabled: (formPending: boolean, multiQuestionFormPending: boolean, threadLoading: boolean, dataProcessingAccepted: boolean, isSharedThread: boolean, isImpersonatingExistingConversation: boolean, pendingApprovalProposalId: string | null, resolvedApprovalStatuses: Record<string, {
            feedback?: string;
            status: "approved" | "auto_rejected" | "rejected";
        }>) => boolean;
        contextDisabledReason: (formPending: boolean, multiQuestionFormPending: boolean, threadLoading: boolean, activeStreamingThreads: number, isImpersonatingExistingConversation: boolean) => string | undefined;
        submissionDisabledReason: (contextDisabledReason: string | undefined, question: string, queueDisabledReason: string | undefined) => string | undefined;
        filteredCommands: (question: string, featureFlags: FeatureFlagsSet, threadLoading: boolean, conversation: Conversation | null) => SlashCommand[];
...
export type maxThreadLogicType = MakeLogicType<maxThreadLogicValues, maxThreadLogicActions, MaxThreadLogicProps, maxThreadLogicMeta>;
