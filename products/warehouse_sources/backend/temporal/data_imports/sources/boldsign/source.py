...
class BoldSignSource(ResumableSource[BoldSignSourceConfig, BoldSignResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your BoldSign API key to pull your eSignature documents, templates, and contacts into the Insights Data warehouse.
...
Pick the region your BoldSign account lives in — accounts are hosted on either the US (`api.boldsign.com`) or EU (`api-eu.boldsign.com`) host.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/boldsign",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
