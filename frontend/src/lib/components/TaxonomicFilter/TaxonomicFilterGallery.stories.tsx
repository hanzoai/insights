...
const USAGES: Usage[] = [
    {
        ...
        entry: 'filter',
        props: {
            taxonomicGroupTypes: [G.Events, G.Actions, G.DataWarehouse, G.InsightsQLExpression, G.EventProperties],
            onChange: noop,
        },
    },
    {
    ...
    },
    {
        ...
        props: {
            onChange: noop,
            taxonomicGroupTypes: [G.PersonProperties, G.Cohorts, G.InsightsQLExpression],
        },
    },
    {
    ...
    {
        name: 'Script function event filter',
        site: 'InsightsFunctionFilters.tsx',
        entry: 'properties',
        props: {
            onChange: noop,
            taxonomicGroupTypes: [
    ...
    },
    {
        ...
        props: {
            onChange: noop,
            taxonomicGroupTypes: [G.EventProperties, G.PersonProperties, G.Cohorts, G.InsightsQLExpression],
        },
    },
    {
...
function UsagePreview({ usage, storyKey }: { usage: Usage; storyKey: string }): JSX.Element {
    ...
    if (usage.entry === 'filter') {
        return (
            <>
                <Button type="secondary" size="small" onClick={() => setOpen((v) => !v)}>
