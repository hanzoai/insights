...
export function CustomFlowEditorPanelVariables(): JSX.Element | null {
    const { workflow } = useValues(customFlowEditorLogic)
    const { setWorkflowInfo } = useActions(customFlowEditorLogic)
