...
# insights/models/ai_events/person_shims.py. Column ALTERs on the main
...
# related to https://github.com/Datastore/Datastore/issues/10471
...
""".format(
        cluster=settings.DATASTORE_CLUSTER,
        database=settings.DATASTORE_DATABASE,
        datastore_user=dict_reader_creds.user,
        datastore_password=dict_reader_creds.password,
    )
