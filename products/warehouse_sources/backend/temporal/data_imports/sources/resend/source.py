...
class ResendSource(ResumableSource[ResendSourceConfig, ResendResumeConfig], OAuthMixin):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Connect Resend to pull your Resend data into the Insights Data warehouse. Connect with OAuth, or paste a Resend API key.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/resend",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldSelectConfig(
