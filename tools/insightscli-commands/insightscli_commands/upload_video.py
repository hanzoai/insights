"""insightscli pr:upload-video: upload short demo videos to the public Insights/pr-assets repo.
...
def upload_video(files: tuple[Path, ...], label: str | None, yes: bool) -> None:
    """Upload demo video(s) to the public Insights/pr-assets repo and print link markdown.
    ...
    \b
        insightscli pr:upload-video demo.mp4
        insightscli pr:upload-video --label "duplicate-question demo" frontend-qa.mp4
