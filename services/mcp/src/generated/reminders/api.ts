...
export const RemindersCreateBody = /* @__PURE__ */ zod.object({
    ...
    resource_type: zod
        ...
        .nullish()
        .describe(
            'Optional Insights resource this reminder is about. One of: dashboard, insight, experiment, feature_flag, survey, notebook, replay, error_tracking. Resources are project-scoped, so a team must be set when this is provided.'
        ),
    resource_id: zod
        .string()
