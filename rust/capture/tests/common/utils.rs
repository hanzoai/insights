...
impl ServerHandle {
    ...
    /// of headers `Context::new` requires (auth + the custom Insights-* headers).
    pub async fn capture_v1<T: Into<reqwest::Body>>(
        ...
        self.client
            ...
            .header("Insights-Sdk-Info", "insights-rs/1.0.0")
            .header("Insights-Attempt", "1")
            .header("Insights-Request-Id", uuid::Uuid::new_v4().to_string())
            .header("Insights-Request-Timestamp", "2026-03-19T14:30:00.000Z")
