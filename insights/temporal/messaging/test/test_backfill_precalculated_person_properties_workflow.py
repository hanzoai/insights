...
from insights.temporal.messaging.backfill_precalculated_person_properties_workflow import flush_kafka_batch
...
class TestFlushKafkaBatch:
    ...
    async def test_final_batch_includes_final_in_messages(self):
        ...
        with patch("insights.temporal.messaging.backfill_precalculated_person_properties_workflow.asyncio.to_thread"):
