...
`insights/models/team/production_event_activation.py` (they're plain Python
...
from insights.dags.common import JobOwners, dagster_tags, skip_if_already_running
...
def detect_first_team_production_event_schedule(context: dagster.ScheduleEvaluationContext):
    ...
    # Datastore scans would fully duplicate and the bookkeeping bulk UPDATEs
