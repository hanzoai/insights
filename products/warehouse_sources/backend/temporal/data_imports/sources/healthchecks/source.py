...
class HealthchecksSource(
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Healthchecks.io API key to pull your cron and scheduled-task monitoring data into the Insights Data warehouse.
...
Leave the base URL blank for Healthchecks.io Cloud, or set it to your instance URL for a self-hosted deployment.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/healthchecks",
