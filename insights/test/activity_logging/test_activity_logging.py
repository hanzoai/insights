...
from insights.models.activity_logging.activity_log import ActivityLog, Change, Detail, Trigger, log_activity
from insights.models.activity_logging.model_activity import ActivityTriggerContext
from insights.models.activity_logging.utils import activity_storage, activity_visibility_manager
...
class TestActivityLogModel(BaseTest):
    ...
    def test_client_is_populated_from_activity_storage(self) -> None:
        activity_storage.set_client("insights-js/1.234.0")
        try:
            log_activity(
                organization_id=self.organization.id,
                team_id=self.team.id,
        ...
        log: ActivityLog = ActivityLog.objects.latest("id")
        self.assertEqual(log.client, "insights-js/1.234.0")
    ...
    def test_does_not_throw_if_cannot_log_activity(self) -> None:
        ...
        with patch("insights.models.activity_logging.activity_log.logger") as mock_logger:
