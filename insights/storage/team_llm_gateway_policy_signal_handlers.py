...
Wired from InsightsConfig.ready() via connect_signal_handlers() so the receivers
...
from insights.storage.team_llm_gateway_policy_cache import clear_team_llm_gateway_policy_cache
...
def _update_cache_on_save(sender: type[Team], instance: Team, created: bool, **kwargs: Any) -> None:
    ...
    def enqueue_task() -> None:
        ...
        from insights.tasks.team_llm_gateway_policy import update_team_llm_gateway_policy_cache_task  # noqa: PLC0415
