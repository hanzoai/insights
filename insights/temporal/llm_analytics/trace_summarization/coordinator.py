...
with temporalio.workflow.unsafe.imports_passed_through():
    from insights.temporal.llm_analytics.coordinator_metrics import (
        increment_team_failed,
        increment_team_succeeded,
        record_teams_discovered,
    )
    from insights.temporal.llm_analytics.shared_activities import (
        FetchAllClusteringFiltersInput,
        fetch_all_clustering_filters_activity,
    )
    from insights.temporal.llm_analytics.team_discovery import (
...
class BatchTraceSummarizationCoordinatorWorkflow(InsightsWorkflow):
    """
