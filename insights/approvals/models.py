...
if TYPE_CHECKING:
    from insights.approvals.actions.base import BaseAction
    from insights.approvals.models import ApprovalPolicy as ApprovalPolicyType
...
class ChangeRequest(UUIDModel, CreatedMetaFields, UpdatedMetaFields):
    ...
    organization = models.ForeignKey("insights.Organization", on_delete=models.CASCADE)
    ...
    def get_policy(self) -> Optional["ApprovalPolicyType"]:
        ...
        from insights.approvals.policies import PolicyEngine
...
class ApprovalPolicy(UUIDModel, CreatedMetaFields, UpdatedMetaFields):
    ...
    # bypass_roles M2M removed (ee.Role no longer exists)
