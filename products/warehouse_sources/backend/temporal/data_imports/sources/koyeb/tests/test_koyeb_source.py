...
from insights.schema import DataWarehouseSourceCategory, ReleaseStatus, SourceFieldInputConfig
...
class TestKoyebSource:
    ...
    def test_source_config_metadata(self) -> None:
        ...
        # Slug must agree with the hanzo.ai doc filename.
        assert config.docsUrl == "https://hanzo.ai/docs/cdp/sources/koyeb"
