    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex justify-end">
                <Button type="primary" onClick={showCreateDialog} data-attr="create-cimd-verification-token">
            ...
            <Modal
                ...
                footer={
                    <>
                        <Button type="secondary" onClick={hideCreateDialog}>
                            Cancel
                        </Button>
                        <Button
                            type="primary"
            ...
            <Modal
                ...
                title="Token created"
                footer={
                    <Button type="primary" onClick={() => setJustCreatedToken(null)}>
                        Done
                    </Button>
                }
            >
