...
describe('insight error states', () => {
    ...
    beforeEach(() => {
        useMocks({})
        initKeaTests()
        captureSpy = jest.spyOn(insights, 'capture')
    ...
    // one, `sideAction` must stay undefined so Button doesn't render a stray empty side action.
    it.each([
        ...
        expect(container.querySelector('.ButtonWithSideAction') !== null).toBe(expectsSideAction)
    })
