...
from insights.schema import DateRange, LogsQuery
...
class TestLogsCustomColumns(DatastoreTestMixin, APIBaseTest):
    ...
    def test_custom_columns_resolve_and_align_to_aliases(self):
        # A shorthand map lookup and a InsightsQL transform, appended after the fixed columns.
