...
class BettermodeSource(ResumableSource[BettermodeSourceConfig, BettermodeResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Connect your Bettermode (formerly Tribe) community to pull members, spaces, posts, replies, tags, and moderation items into the Insights Data warehouse.
...
If your community is hosted in the EU (eu-central-1), select the EU region so requests go to Bettermode's EU endpoint.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/bettermode",
