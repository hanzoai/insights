...
export interface DeleteWarehouseOrgResponseApi {
    ...
    status?: string
    /** duckgres org identifier (the Insights organization id) */
    org?: string
}
...
export interface ManagedWarehouseSourceTableStatusApi {
    ...
    last_applied_at: string | null
    /**
     * When Insights most recently completed the upstream source import.
     * @nullable
     */
    last_synced_at: string | null
}
...
export interface InsightVariableApi {
    ...
    readonly created_at: string
    /**
     * Generated code-safe name used in InsightsQL as {variables.code_name}. Derived from name.
     * @nullable
     */
...
export interface WarehouseColumnStatisticsApi {
    ...
    /** Datastore type the statistics were computed against (e.g. Int64, DateTime64). */
...
export interface TableApi {
    ...
    /** @maxLength 128 */
    name: string
    /** Dotted name the table is queried by in InsightsQL (e.g. `googleanalytics.devices` or `postgres.<prefix>.<table>`), as opposed to `name`, which is the underlying storage identifier. */
    readonly insightsql_name: string
...
export interface CreateTableFromUploadApi {
    ...
    /** Name the resulting table is queried by in InsightsQL. */
    table_name: string
}
...
export interface ViewLinkApi {
    ...
    /**
     * Column or InsightsQL expression on the source table used as the join key.
     * @maxLength 400
     */
    ...
    /**
     * Column or InsightsQL expression on the joining table used as the join key.
     * @maxLength 400
     */
...
export interface ViewLinkValidationResponseApi {
    ...
    msg: string | null
    /**
     * The InsightsQL statement used to validate the join.
     * @nullable
     */
...
export interface ViewLinkValidationErrorApi {
    ...
    type: string
    /**
     * The InsightsQL statement that failed to validate.
     * @nullable
     */
    insightsql: string | null
}
