...
export interface OrganizationOAuthApplicationApi {
    ...
    /** True if this application has been verified by Insights */
    is_verified?: boolean
 ...
 * * `use_insights_ai` - use_insights_ai
 * * `use_insights_code` - use_insights_code
 * * `use_insights_mcp` - use_insights_mcp
 * * `use_insights_in_slack` - use_insights_in_slack
 */
...
export const AvailableSetupTaskIdsEnumApi = {
    ...
    UseInsightsAi: 'use_insights_ai',
    UseInsightsCode: 'use_insights_code',
    UseInsightsMcp: 'use_insights_mcp',
    UseInsightsInSlack: 'use_insights_in_slack',
} as const
...
export interface ProjectBackwardCompatApi {
    ...
    /** When true, Insights drops the IP address from every ingested event. */
    ...
    /**
     * Disables insights-js autocapture (clicks, page views) when true.
     * @nullable
     */
    ...
    /**
     * Enables displaying surveys via insights-js on allowed origins.
     * @nullable
     */
    surveys_opt_in?: boolean | null
    /**
     * Enables heatmap recording on pages that host insights-js.
     * @nullable
     */
...
export interface OrganizationApi {
    ...
    /**
     * When True, this organization allows its data to be used to train Insights AI models.
     * @nullable
     */
...
export interface UserApi {
    ...
    /**
     * Whether Insights should anonymize events captured for this user when identified.
     * @nullable
     */
...
export interface UserGitHubIntegrationItemApi {
    /** Insights UserIntegration row id. */
    id: string
...
export interface GitHubRepoApi {
    ...
    archived?: boolean
    /** Whether the Insights GitHub App has write access — required to open pull requests. */
    can_push?: boolean
}
...
export interface UserGitHubLinkStartRequestApi {
    /**
     * Optional team/project id (e.g. Insights Desktop); web UI uses the session's current team.
     * @nullable
     */
    team_id?: number | null
    /** Optional client hint (e.g. insights_code) for return routing after OAuth. */
    connect_from?: string
}
...
export interface UserSlackLinkableWorkspaceItemApi {
    /** Insights team/project id owning the Slack workspace install. */
    insights_team_id: number
    /** Insights team/project name, for display in a picker. */
    insights_team_name: string
    /** Insights organization name owning the team, for picker disambiguation. */
    insights_organization_name: string
    /** Slack workspace (team) id. */
    slack_team_id: string
    /**
     * Slack workspace display name as known by Insights.
     * @nullable
     */
