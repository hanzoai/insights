...
BOT_DEFINITIONS: dict[str, BotDefinition] = {
    ...
    # Insights Desktop clients (Electron desktop, React Native mobile, agent CLI, cloud agent server).
    # Dots are escaped because keys are evaluated as re2 regex by the REGEXP_TREE dictionary.
    r"desktop\.script\.dev": BotDefinition(
        "Insights Desktop",
        "ai_assistant",
        "AI Agent",
        "Insights",
        documentation_url="https://hanzo.ai/code",
    ),
    r"mobile\.script\.dev": BotDefinition(
        "Insights Mobile",
        "ai_assistant",
        "AI Agent",
        "Insights",
    ...
    r"agent\.script\.dev": BotDefinition(
        "Insights Code Agent",
        "ai_assistant",
        "AI Agent",
        "Insights",
    ...
    r"cloud\.script\.dev": BotDefinition(
        "Insights Code Cloud",
        "ai_assistant",
        "AI Agent",
        "Insights",
