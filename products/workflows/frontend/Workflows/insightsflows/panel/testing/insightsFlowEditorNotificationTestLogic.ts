...
import { InsightsFlowTestResult } from '../../steps/types'
import type { insightsFlowEditorNotificationTestLogicType } from './insightsFlowEditorNotificationTestLogicType'
import { createExampleEvent, createGlobalsFromResponse } from './insightsFlowEditorTestLogic'
...
export const insightsFlowEditorNotificationTestLogic = kea<insightsFlowEditorNotificationTestLogicType>([
    path((key) => [
        'products',
        'workflows',
        'frontend',
    ...
    connect((props: WorkflowLogicProps) => ({
        values: [workflowLogic(props), ['workflow', 'workflowSanitized'], insightsFlowEditorLogic, ['selectedNodeId']],
        actions: [insightsFlowEditorLogic, ['setSelectedNodeId']],
    })),
    actions({
        ...
        setTestResult: (testResult: InsightsFlowTestResult | null) => ({ testResult }),
    ...
    reducers({
        ...
        testResult: [
            null as InsightsFlowTestResult | null,
            {
    ...
    forms(({ actions, values }) => ({
        testInvocation: {
            ...
            } as InsightsFlowTestInvocation,
            errors: (data: InsightsFlowTestInvocation) => {
            ...
            submit: async (testInvocation: InsightsFlowTestInvocation) => {
                try {
                    ...
                    const apiResponse = await api.insightsFlows.createTestInvocation(values.workflow.id, {
                    ...
                    const result: InsightsFlowTestResult = {
                        ...apiResponse,
