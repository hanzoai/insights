...
export interface MarkdownProps {
     ...
     * When set, only images served from Insights (same-origin or a `hanzo.ai` host) render inline
     ...
     * that opt in (see `MarkdownWithMermaid`).
     */
        ...
        () => ({
            ...
            li: ({ children, node }: any): JSX.Element => {
                ...
                if (isTaskItem) {
                    ...
                    // We replace it with our Checkbox.
                    ...
                    return (
                        <li className="Markdown__task">
                            ...
                            <span className="Markdown__task-content">{filteredChildren}</span>
                        </li>
                    )
                }
                ...
                ? Object.fromEntries(
                      HEADING_TAGS.map((tag) => [
                          ...
                          ({ children }: any): JSX.Element => (
                              <strong className="Markdown__low-key-heading">{children}</strong>
                          ),
                      ])
                  )
                : generateHeadingIds
