...
import type { customFlowManualTriggerButtonLogicType } from './CustomFlowManualTriggerButtonLogicType'
...
export const customFlowManualTriggerButtonLogic = kea<customFlowManualTriggerButtonLogicType>([
    path(['products', 'workflows', 'frontend', 'Workflows', 'customflows', 'customFlowManualTriggerButtonLogic']),
