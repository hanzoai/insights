...
import type { TooltipContext } from '@hanzo/quill-charts'
...
/** Bridges script-charts TooltipContext to the legacy InsightTooltip.
 *  Once script-charts fully replaces Chart.js, we can refactor InsightTooltip
...
export function TrendsTooltip({
    ...
    const renderCount = useCallback(
        (value: number): string => {
            ...
            // script-charts passes each segment as a 0..1 fraction (segment_height = top − bottom
