...
use crate::router::PersonInsightsRouter;

use super::PersonInsightsRouterService;
...
fn create_service_with_mock(mock: MockBackend) -> PersonInsightsRouterService {
    let router = PersonInsightsRouter::new(Arc::new(mock));
    PersonInsightsRouterService::new(Arc::new(router))
}
