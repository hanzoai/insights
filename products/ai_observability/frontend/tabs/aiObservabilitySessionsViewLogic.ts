...
import { DataTableNode, InsightsQLQuery, NodeKind, RefreshType } from '~/queries/schema/schema-general'
    ...
    listeners(({ actions, values }) => {
        ...
        return {
            loadSessions: async ({ refresh }) => {
                ...
                const source = values.sessionsQuery.source as InsightsQLQuery
                try {
                    // Default loads use cache (fast, Insights convention); the Refresh button forces a recompute
