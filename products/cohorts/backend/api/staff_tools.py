...
from insights.api.fields import RepeatedOrCommaSeparatedListField
...
# Recalculating a cohort fans out into its full dependency chain of Datastore calculations,
...
class CohortsStaffToolsViewSet(viewsets.ViewSet):
    ...
    # surface (see insights/api/documentation.py's INTERNAL handling).
