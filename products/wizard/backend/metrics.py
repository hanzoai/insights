...
_KNOWN_WORKFLOWS = {"insights-integration"}
...
WIZARD_SESSIONS_FINISHED_TOTAL = Counter(
    "insights_wizard_sessions_finished_total",
...
WIZARD_SESSION_RUN_DURATION_SECONDS = Histogram(
    "insights_wizard_session_run_duration_seconds",
...
WIZARD_LATEST_SESSION_REQUESTS_TOTAL = Counter(
    "insights_wizard_latest_session_requests_total",
...
WIZARD_PUBSUB_PUBLISH_TOTAL = Counter(
    "insights_wizard_pubsub_publish_total",
