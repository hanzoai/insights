"""Composing InsightsQL property filters into Datastore clauses for batch exports.

Batch exports let users filter which events are exported. The filters arrive as serialized
InsightsQL, and this turns them into a printed Datastore boolean clause plus the placeholder values
