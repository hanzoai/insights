...
from insights.api.github_callback import personal_finish, redirects, state, team_services
from insights.api.github_callback.types import CallbackContext, FinishResult, FlowKind, is_personal_github_setup_state
from insights.auth import session_auth_required
...
def _is_personal_github_setup_update(user: User, ctx: CallbackContext) -> bool:
    ...
    # directly without going through Insights UI).
