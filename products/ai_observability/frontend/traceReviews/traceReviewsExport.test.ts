...
const baseReview: TraceReview = {
    id: 'review-1',
    trace_id: 'trace-abc',
    trace_url: 'https://us.hanzo.ai/project/1/ai-observability/traces/trace-abc',
    comment: 'Looks good',
    created_at: '2026-03-12T00:00:00Z',
...
describe('traceReviewsExport', () => {
    ...
    describe('getReviewClipboardRows', () => {
        ...
        it('includes the absolute trace URL alongside the trace_id', () => {
            ...
            expect(row.trace_url).toBe('https://us.hanzo.ai/project/1/ai-observability/traces/trace-abc')
        })
