...
def primary_source_for(native: NativeMarketingSource) -> str | None:
    ...
    """
    from products.marketing_analytics.backend.insightsql_queries.constants import INTEGRATION_PRIMARY_SOURCE
...
def _build_canonical_aliases() -> dict[str, NativeIntegration]:
    ...
    """
    from products.marketing_analytics.backend.insightsql_queries.constants import INTEGRATION_DEFAULT_SOURCES
