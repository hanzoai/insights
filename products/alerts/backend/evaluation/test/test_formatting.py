...
from insights.schema import AggregationAxisFormat, TrendsFilter
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # a non-currency prefix that shares a leading char with the value is kept, not dropped
        (1000.0, {"prefix": "1"}, "11,000"),
