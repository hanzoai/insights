...
export interface webVitalsToolbarLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface webVitalsToolbarLogicActions {
    getWebVitals: () => {
        value: true
    }
    getWebVitalsFailure: (
...
export type webVitalsToolbarLogicType = MakeLogicType<webVitalsToolbarLogicValues, webVitalsToolbarLogicActions>
