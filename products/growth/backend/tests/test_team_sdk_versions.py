...
class TestGetSdkVersionsForTeam(SimpleTestCase):
    ...
    def test_sorts_partial_and_full_semver_versions_consistently(
        ...
        mock_run_query.return_value = MagicMock(
            results=[
                ("insights-server", "1.2.0", "2026-07-14T00:00:00Z", 100),
                ("insights-server", "1.10", "2026-07-14T00:00:00Z", 50),
            ]
        )
        ...
        assert [entry["lib_version"] for entry in result["insights-server"]] == ["1.10", "1.2.0"]
