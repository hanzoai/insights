...
from insights.test.base import BaseTest, DatastoreDestroyTablesMixin, _create_event
from insights.datastore.client import sync_execute

module = importlib.import_module("insights.datastore.migrations.0064_materialize_elements_chain")

add_columns_to_required_tables = module.add_columns_to_required_tables

from insights.models.element.element import Element, chain_to_elements
...
class Test0064(DatastoreDestroyTablesMixin):
