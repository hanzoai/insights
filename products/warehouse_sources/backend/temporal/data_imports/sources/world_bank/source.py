...
class WorldBankSource(ResumableSource[WorldBankSourceConfig, WorldBankResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Pull country-level development statistics from the [World Bank Indicators API](https://datahelpdesk.worldbank.org/knowledgebase/topics/125589-developer-information) into the Insights Data warehouse.
...
The API has no "changed since" filter, and the World Bank revises historical values on each quarterly release, so every table syncs as a full refresh.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/world-bank",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
