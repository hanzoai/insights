...
// assemble the parts the same way a real surface (the tasks run viewer, Insights AI) does.
...
const meta: Meta<ComposerStoryArgs> = {
    title: 'Products/Insights AI/Composer',
    tags: ['autodocs'],
    args: {
        initialValue: '',
                ...
                <Composer.Root value={value} onChange={setValue} onSubmit={() => setValue('')} {...rootProps}>
                    <Composer.Frame>
                        <Composer.Header className="flex flex-wrap items-center gap-1">
                            <Tag type="muted">@ Current dashboard</Tag>
                            <Tag type="muted">@ Weekly signups</Tag>
                        </Composer.Header>
                        <Composer.Field>
                            <Composer.Placeholder>{placeholder}</Composer.Placeholder>
                            <Composer.Textarea />
                        ...
                        <Composer.Footer>
                            <div className="flex items-center gap-1 pl-2">
                                <Button size="xsmall" type="tertiary" icon={<IconGear />} tooltip="Settings" />
                            </div>
                        </Composer.Footer>
                    </Composer.Frame>
                    <Composer.Submit />
