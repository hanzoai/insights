...
from products.workflows.backend.models import InsightsFlow, InsightsFlowBatchJob
...
class TestEmailReputationAPI(APIBaseTest):
    ...
    def _create_flow(self, name: str) -> InsightsFlow:
    ...
    def test_reputation_endpoint_serializes_unnamed_workflows_with_empty_name(self):
        unnamed = InsightsFlow.objects.create(
            team=self.team,
            name=None,
            status="active",
            trigger={"type": "event"},
    ...
    def test_reputation_endpoint_never_resolves_other_teams_workflows(self):
        ...
        other_flow = InsightsFlow.objects.create(
            team=other_team,
...
class TestEmailReputationAccessControl(APIBaseTest):
    ...
    def test_object_level_only_member_gets_rows_but_no_project_wide_state(self):
        ...
        member = User.objects.create_and_join(self.organization, "obj-only@hanzo.ai", "testtest")
