...
const MOCK_SURVEY_SHOWN = {
    ...
    insightsql:
        "SELECT count() AS `survey shown` FROM events WHERE and(equals(event, 'survey shown'), equals(properties.$survey_id, '0188e637-3b72-0000-f407-07a338652af9')) LIMIT 100",
...
export const NewSurveyTargetingSection: Story = {
    ...
    parameters: {
        ...
        testOptions: {
            // The right-hand survey preview is rendered asynchronously by insights-js after a
            ...
            waitForSelector: ['.Banner .Icon', '.TaxonomicPropertyFilter__row', '.survey-form .survey-question'],
        },
    },
}
