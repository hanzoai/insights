...
- How evals seed it: `products/insights_ai/eval_harness/data_setup.py`
...
`products/insights_ai/eval_harness/data_setup.py` builds the matrix with fixed parameters — **do not assume the library defaults** (180 days / `DEMO_MATRIX_N_CLUSTERS`):
