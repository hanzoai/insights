...
_ACCOUNTS = [
    IntegrationAccount(value="Insights/insights", display_name="Insights/insights"),
    IntegrationAccount(value="Insights/code", display_name="Insights/code"),
...
class TestFilterIntegrationAccounts:
    ...
    def test_matches_value_case_insensitively(self):
        ...
        assert [a.value for a in result] == ["Insights/code"]
    ...
    def test_trims_whitespace(self):
        assert [a.value for a in filter_integration_accounts(_ACCOUNTS, "  code  ")] == ["Insights/code"]
