...
import insights.storage.object_storage as object_storage_module
...
from insights.storage.object_storage import (
    ObjectStorage,
    ObjectStorageError,
    UnavailableStorage,
    copy_objects,
...
class TestStorage(APIBaseTest):
    ...
    @patch("insights.storage.object_storage.client")
...
class TestObjectStorageClientFactory(SimpleTestCase):
    ...
    @patch("insights.storage.object_storage.capture_exception")
    @patch("insights.storage.object_storage.client")
