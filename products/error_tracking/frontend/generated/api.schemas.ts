...
export interface ErrorTrackingIssueEventsQueryRequestApi {
    ...
    /** When true, exclude internal/test account data from results. Defaults to true. */
    filterTestAccounts?: boolean
    /** Advanced flat AND property filters applied to sampled events. InsightsQL filters are rejected. */
...
export interface ErrorTrackingIssuesListQueryRequestApi {
     ...
     */
    volumeResolution?: number
    /** Filter by SDK/library value from event $lib, for example insights-js. */
     ...
     */
    user?: string
    /** Filter by exact Insights person UUID. */
    personId?: string
    /**
