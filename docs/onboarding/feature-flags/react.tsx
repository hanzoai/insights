                ...
                <Tab.Group tabs={['Using hooks', 'Using InsightsFeature component']}>
                    ...
                    <Tab.Panels>
                        <Tab.Panel>
                            <Markdown>
                                {dedent`
                                    Insights provides several hooks to make it easy to use feature flags in your React app. Use \`useFeatureFlagEnabled\` for boolean flags:
                                `}
                            </Markdown>
                                ...
                                blocks={[
                                    {
                                        ...
                                        file: 'App.tsx',
                                        code: dedent`
                                            import { InsightsFeature } from '@posthog/react'
