    ...
    (
        ...
        FileSystemActivityCase(
            ...
            create_instance=lambda test: InsightsFunction.objects.create(
                team=test.team,
                name="File system script function",
...
class TestLogApiFileSystemView(APIBaseTest):
    ...
    def test_log_api_file_system_view_skips_for_impersonated_session(self) -> None:
        ...
        with patch("insights.api.file_system.file_system_logging.is_impersonated_session", return_value=True):
            log_api_file_system_view(request, self.action)
