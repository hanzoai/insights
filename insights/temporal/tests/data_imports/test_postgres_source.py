...
import pytest
from insights.test.base import override_settings
...
from insights.temporal.data_imports.sources.common.base import SimpleSource
from insights.temporal.data_imports.sources.generated_configs import PostgresSourceConfig
from insights.temporal.data_imports.sources.postgres.postgres import (
...
class TestSSLRequirement:
    ...
    def test_source_requires_ssl_for_new_sources(self, team, postgres_config):
        from insights.temporal.data_imports.sources.postgres.source import PostgresSource
        ...
        with mock.patch(
            "insights.temporal.data_imports.sources.postgres.source.postgres_source"
