...
class TestMarketingAnalyticsAttributionPathsQueryRunner(DatastoreTestMixin, BaseTest):
    maxDiff = None
    ...
    def test_touchpoints_appear_in_time_order(self):
        ...
        # google -> newsletter regardless of what order Datastore aggregated the rows in.
        create_person(team=self.team, distinct_ids=["p1"])
    ...
    def test_per_conversion_path_is_materialized_for_its_two_readers(self):
        # path_rows and the footer both read per_conversion_path; without materialization Datastore
