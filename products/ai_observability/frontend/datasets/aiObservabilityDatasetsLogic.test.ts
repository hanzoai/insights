...
describe('aiObservabilityDatasetsLogic', () => {
    ...
    describe('dataset archiving', () => {
        it('archives and restores a dataset from Undo', async () => {
            ...
            expect(toast.success).toHaveBeenCalledWith(`${mockDataset1.name} has been restored.`)
        })
        ...
        it('surfaces an archive error', async () => {
            ...
            expect(toast.error).toHaveBeenCalledWith("Couldn't archive dataset. Try again.")
        })
    })
