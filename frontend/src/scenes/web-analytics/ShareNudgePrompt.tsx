...
export function ShareNudgePrompt(): JSX.Element | null {
    ...
    const handleShare = (): void => {
        ...
        insights.capture('web analytics share link copied', { source: promptSource })
        dismissForSession()
    }
    ...
    return (
        ...
        >
            <div className="flex items-start justify-between gap-2">
                ...
                <Button size="xsmall" icon={<IconX />} tooltip="Dismiss" onClick={dismissForSession} />
            </div>
            <p className="m-0 text-sm text-muted">
                Web analytics is better with your team. Send this exact view so they see what you see.
            </p>
            <div className="flex">
                <Button type="primary" icon={<IconShare />} onClick={handleShare}>
                    Copy link
                </Button>
            </div>
        </div>
