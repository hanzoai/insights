...
export interface internalMultipleChoiceSurveyLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface internalMultipleChoiceSurveyLogicActions {
    getSurveys: () => {}
    handleChoiceChange: (
        choice: string,
        isAdded: boolean
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface internalMultipleChoiceSurveyLogicMeta {
    key: string
}

export type internalMultipleChoiceSurveyLogicType = MakeLogicType<
    internalMultipleChoiceSurveyLogicValues,
    internalMultipleChoiceSurveyLogicActions,
    InternalSurveyLogicProps,
    internalMultipleChoiceSurveyLogicMeta
>
