...
from insights.api.insight_suggestions import generate_insight_name, get_insight_analysis, get_insight_suggestions
...
from insights.insightsql_queries.legacy_compatibility.feature_flag import get_query_method, insightsql_insights_replace_filters
...
from insights.models import Cohort, DashboardTile, Filter, Insight, User
...
from insights.models.alert import AlertConfiguration
...
from insights.models.insight import InsightViewed
...
from insights.rbac.user_access_control import UserAccessControlError, UserAccessControlSerializerMixin
...
class InsightSerializer(InsightBasicSerializer):
    ...
    def get_alerts(self, insight: Insight):
        ...
        from insights.api.alert import AlertSerializer
