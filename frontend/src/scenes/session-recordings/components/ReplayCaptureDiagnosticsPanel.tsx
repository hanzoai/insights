...
import { Banner, BannerProps } from 'lib/elements/Banner'
...
const BANNER_TYPE_BY_VERDICT: Record<DiagnosisVerdict, BannerProps['type']> = {
    captured: 'success',
    ad_blocked: 'warning',
    disabled: 'warning',
...
function DiagnosisContent({ diagnosis }: { diagnosis: ReplayCaptureDiagnosis }): JSX.Element {
    return (
        <Banner type={BANNER_TYPE_BY_VERDICT[diagnosis.verdict]} className="text-left">
