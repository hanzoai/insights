...
from insights.models.oauth import find_oauth_access_token, find_oauth_refresh_token, revoke_oauth_session
...
GITHUB_TYPE_FOR_SECURE_API_KEY = "insights_personal_api_key"
