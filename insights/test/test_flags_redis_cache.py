...
class TestFlagsRedisCache(BaseTest):
    ...
    def test_continues_on_dedicated_cache_failure(self):
        ...
        with (
            patch("insights.caching.flags_redis_cache.cache", shared_cache),
            patch("insights.caching.flags_redis_cache.caches") as mock_caches,
            patch("insights.caching.flags_redis_cache.settings") as mock_settings,
        ):
