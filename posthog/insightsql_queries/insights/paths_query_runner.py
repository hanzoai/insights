...
from posthog.constants import INSIGHTSQL, PAGEVIEW_EVENT, SCREEN_EVENT
from posthog.insightsql_queries.insights.funnels.funnels_query_runner import FunnelsQueryRunner
from posthog.insightsql_queries.insights.funnels.utils import funnel_window_interval_unit_to_sql
...
class PathsQueryRunner(AnalyticsQueryRunner[PathsQueryResponse]):
    ...
    def funnel_join(self) -> ast.JoinExpr:
        ...
        from posthog.insightsql_queries.insights.insight_actors_query_runner import InsightActorsQueryRunner
    ...
    def _calculate(self) -> PathsQueryResponse:
        ...
        return PathsQueryResponse(results=results, timings=response.timings, insightsql=insightsql, modifiers=self.modifiers)
