...
@patch("products.data_warehouse.backend.presentation.views.managed_warehouse.hanzo_insights.feature_enabled")
...
def test_block_team_deletion_blocks_when_delete_fails_and_membership_possible(
    ...
    with patch("insights.ducklake.cp_teams._fetch_org_rows", return_value=rows):
        reason = managed_warehouse.block_team_deletion(team.id, org.id)
