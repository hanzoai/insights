...
def test_report_heartbeat_timeout_heartbeat_not_within_timeout(team):
    ...
    with freeze_time("2024-01-01 12:00:00"):
        ...
        with (
            ...
            mock.patch(
                "products.warehouse_sources.backend.temporal.data_imports.pipelines.common.extract.hanzo_insights.capture"
            ) as mock_insights_capture,
        ):
            from products.warehouse_sources.backend.temporal.data_imports.pipelines.common.extract import (
                report_heartbeat_timeout,
            )
            ...
            mock_insights_capture.assert_called_once_with(
