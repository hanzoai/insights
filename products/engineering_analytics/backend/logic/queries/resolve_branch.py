"""InsightsQL resolution of a git branch to the pull request(s) it belongs to.

Powers the cross-product branch → PR link: another product (the LLM analytics UI)
turns a git branch into a PR detail link without re-deriving Insights's PR↔CI attribution.
