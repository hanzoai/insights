...
import { InsightsQLQueryResponse, NodeKind, ProductKey } from '~/queries/schema/schema-general'
...
export interface issueRateLimitConfigLogicValues {
    chartMode: RateLimitChartMode
    config: ErrorTrackingSettings | null
    configForm: IssueRateLimitConfigForm
    configFormAllErrors: Record<string, any>
    configFormChanged: boolean
    configFormErrors: DeepPartialMap<IssueRateLimitConfigForm, ValidationErrorType>
    ...
    selectedIssue: TopIssue | null
    selectedIssueHistory: RateLimitHistoryBucket[]
    selectedIssueHistoryLoading: boolean
    selectedIssueId: string | null
    selectedIssueVolume: ExceptionVolumeBucket[]
    selectedIssueVolumeLoading: boolean
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface issueRateLimitConfigLogicActions {
    loadConfig: () => any
    loadConfigFailure: (
        error: string,
        errorObject?: any
    ...
    loadSelectedIssueHistoryFailure: (
        error: string,
        errorObject?: any
    ) => {
        error: string
    ...
    loadSelectedIssueHistorySuccess: (
        selectedIssueHistory: RateLimitHistoryBucket[],
        payload?: {
            issueId: string
            bucketMinutes: number
    ...
    loadSelectedIssueVolumeFailure: (
        error: string,
        errorObject?: any
    ) => {
        error: string
    ...
    loadSelectedIssueVolumeSuccess: (
        selectedIssueVolume: {
            bucket: string
            count: number
        }[],
    ...
    loadTopIssues: ({ bucketMinutes }: { bucketMinutes: number }) => {
        bucketMinutes: number
    }
    loadTopIssuesFailure: (
        error: string,
        errorObject?: any
    ) => {
        error: string
    ...
    resetConfigForm: (values?: IssueRateLimitConfigForm) => {
        values?: IssueRateLimitConfigForm
    }
    ...
    setConfigFormValues: (values: DeepPartial<IssueRateLimitConfigForm>) => {
        values: DeepPartial<IssueRateLimitConfigForm>
    }
    submitConfigForm: () => {
        value: boolean
    }
    ...
    submitConfigFormRequest: (configForm: IssueRateLimitConfigForm) => {
        configForm: IssueRateLimitConfigForm
    }
    submitConfigFormSuccess: (configForm: IssueRateLimitConfigForm) => {
        configForm: IssueRateLimitConfigForm
    }
...
export type issueRateLimitConfigLogicType = MakeLogicType<
    issueRateLimitConfigLogicValues,
    issueRateLimitConfigLogicActions,
    Record<string, any>,
    issueRateLimitConfigLogicMeta
>
        ...
        configForm: {
            ...
            submit: async ({ per_issue_rate_limit_value, per_issue_rate_limit_bucket_size_minutes }) => {
                try {
                    ...
                    insights.capture('error_tracking_per_issue_rate_limit_updated', payload)
