...
import { commonConfig, copyRRWebWorkerFiles, createHashlessEntrypoints, esbuildBuild, isDev } from '@hanzo/esbuilder'
...
// URL on the insights-js CDN. Used by insights-js's release workflow to ship a
                    ...
                    contents: `
                        module.exports = new Proxy({}, {
                            get: function(target, prop) {
                                ...
                                const shouldLog = window && window.insights && window.insights.config && window.insights.config.debug;
                                if (shouldLog) {
...
//
//   dist/toolbar.js          — a tiny classic-script loader (src/toolbar/loader.ts). insights-js
...
// the versioned/major-alias/compatibility prefixes on the insights-js CDN (whose release
...
export function getToolbarAppBuildConfig(dirname) {
    return {
        ...
        // from Django /static/ on any region or self-hosted instance and from the insights-js
