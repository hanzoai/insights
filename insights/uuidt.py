...
# Django-free UUID helpers. Kept out of insights.models.utils (which imports the Django ORM at
# module level) so the InsightsQL engine can use them without booting Django. insights.models.utils
