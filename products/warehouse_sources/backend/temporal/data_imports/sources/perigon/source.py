...
class PerigonSource(ResumableSource[PerigonSourceConfig, PerigonResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Perigon API key to sync news articles, story clusters, journalists, sources, people, companies, and topics into the Insights Data warehouse.
...
Datasets available to sync depend on your Perigon plan. Perigon caps each search to 10,000 results, so incremental syncs on articles and stories catch up across runs.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/perigon",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
