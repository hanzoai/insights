...
TEST_BUCKET = "test_storage_bucket-insights.insightsql.datawarehouse.stickinessquery"
...
class TestStickinessQueryRunner(DatastoreTestMixin, APIBaseTest):
    ...
    def _setup_data_warehouse_with_decoy_timestamp(self) -> str:
        ...
        table, _source, _credential, _df, self.cleanUpDataWarehouse = create_data_warehouse_table_from_csv(
            ...
            table_columns={
                "id": {"datastore": "String", "insightsql": "StringDatabaseField"},
                "event_time": {"datastore": "DateTime64(3, 'UTC')", "insightsql": "DateTimeDatabaseField"},
    ...
    def test_property_filtering_insightsql(self):
        self._create_test_events()

        response = self._run_query(properties=[InsightsQLPropertyFilter(key="properties.$browser == 'Chrome'")])
    ...
    def test_insightsql_aggregations(self):
        self._create_test_events()

        series: list[EventsNode | ActionsNode] = [
            EventsNode(event="$pageview", math="insightsql", math_insightsql="e.properties.prop")
        ]
    ...
    def test_actor_query_cumulative(self):
        ...
        response_1 = execute_insightsql_query(
        ...
        response_2 = execute_insightsql_query(
            query_type="StickinessActorsQuery",
        ...
        response_3 = execute_insightsql_query(
            query_type="StickinessActorsQuery",
