...
CANONICAL_DESCRIPTIONS: CanonicalDescriptions = {
    ...
    "contacts": {
        ...
        "columns": {
            ...
            "list_id": "Identifier of the list this contact row was fetched from (injected by Insights).",
    ...
    "forms": {
        ...
        "columns": {
            ...
            "list_id": "Identifier of the list this form row was fetched from (injected by Insights).",
