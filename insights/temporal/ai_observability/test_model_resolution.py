...
from insights.temporal.ai_observability.model_resolution import DefaultModelSpec, ExplicitModelSpec, model_spec
...
class TestExplicitModelSpec:
    ...
    def test_keyless_requires_provider_key(self, team):
        # No pinned key: resolution has no Insights-funded fallback and must ask for a key.
        with pytest.raises(ApplicationError) as exc_info:
