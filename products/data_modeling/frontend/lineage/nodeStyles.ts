...
export const NODE_TYPE_TAG_SETTINGS: Record<DataModelingNodeType, { label: string; type: TagType; color: string }> = {
...
export const STATUS_TAG_SETTINGS: Record<string, TagType> = {
    Running: 'primary',
    Completed: 'success',
    Failed: 'danger',
    Cancelled: 'muted',
