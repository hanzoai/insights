...
class ServiceNowSource(ResumableSource[ServiceNowSourceConfig, ServiceNowResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Sync your ServiceNow ITSM data (incidents, problems, change requests, users, configuration items, and more) into the Insights Data warehouse.
...
The account or API key needs **read** access (the `rest_api_explorer` role or equivalent table ACLs) to the tables you want to sync.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/servicenow",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
