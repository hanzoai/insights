...
`,
    inputs_schema: [
        ...
        },
        {
            ...
            label: 'Action',
            description:
                'How to map Insights events to Klime event types. Automatic converts $identify/$set to identify, $groupidentify to group, and everything else to track.',
            default: 'automatic',
            choices: [
        ...
        },
        {
            ...
            label: 'Group ID',
            description:
                'Organization or account identifier. Required for group events. Defaults to your first Insights group type ($group_0). If you use multiple group types, change to $group_1, $group_2, etc. You can also use a custom event property.',
