import { MakeLogicType, BuiltLogic, actions, connect, kea, listeners, path, reducers } from 'kea'
...
export interface notebooksModelValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface notebooksModelActions {
    createNotebook: (
...
export type notebooksModelType = MakeLogicType<notebooksModelValues, notebooksModelActions>
...
export const notebooksModel = kea<notebooksModelType>([
        ...
        notebooks: [
            [] as NotebookListItemType[],
            {
                createNotebook: async ({ title, location, content, onCreate, shortId }) => {
                    ...
                    insights.capture(`notebook created (client)`, {
    ...
    listeners(({ asyncActions }) => ({
        createNotebookFromDashboard: async ({ dashboard }) => {
            ...
            // insight-backed InsightsQL queries today, not run_widgets widget types/config.
