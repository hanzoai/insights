"""Shared Hypothesis example-database wiring for the InsightsQL parser/printer PBTs.
...
def _resolve_corpus_dir() -> Path:
    ...
    return main_worktree_root / "insights" / "insightsql" / "test" / "parser_pbt_corpus" / hypothesis.__version__
