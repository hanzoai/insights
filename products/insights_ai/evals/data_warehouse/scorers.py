...
from products.insights_ai.evals.product_analytics.scorers import parser_for, user_prompt
from products.insights_ai.evals.sql.scorers import _truncate_result_for_judge, extract_last_execute_sql_call
...
Executed InsightsQL (may be "(no row query executed)"):
<executed_query>
{{output.sql_query}}
</executed_query>
