...
class AnnotationsConfig(AppConfig):
    ...
    def ready(self) -> None:
        ...
        # dedicated light module — importing the viewset module here would pull insights.api
        # routing/utils (and insights.schema with them) into django.setup() for every process type.
