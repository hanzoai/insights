...
describe('workflowRunsLogic', () => {
    ...
    it('scopes the runs list, activity chart, and cost breakdown to the shared branch, reloading all on a change', async () => {
        logic = workflowRunsLogic({ repoOwner: 'Insights', repoName: 'insights', workflowName: 'CI', sourceId: null })
        logic.mount()
        ...
        const runsArgs = { workflow_name: 'CI', repo: 'Insights/insights', date_from: '-7d', branch: undefined }
