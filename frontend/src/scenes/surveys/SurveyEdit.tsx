    ...
    const getFieldLabel = (label: string, fieldKey: string): JSX.Element | string =>
        isAiGeneratedField(fieldKey) ? (
            <span className="flex items-center gap-1">
                <span>{label}</span>
                <Tag type="highlight">AI draft</Tag>
            </span>
        ) : (
            label
        )
                                                        ...
                                                        {survey.type === SurveyType.ExternalSurvey && (
                                                            <>
                                                                ...
                                                                <ul className="space-y-2 text-sm">
                                                                    <li>
                                                                        • The survey will be hosted by Insights and you
                                                                    ...
                                                                    <li>
                                                                        ...
                                                                        {'\n'}
                                                                        <Link
                                                                            to={`https://us.hanzo.ai/external_surveys/01984280-fc8a-0000-28a5-01078e2d553f?distinct_id=${
                                                                                user?.email ?? 'john@acme.co'
                                                                            }`}
                                                                            target="_blank"
                                                                        >{`https://us.hanzo.ai/external_surveys/01984280-fc8a-0000-28a5-01078e2d553f?distinct_id=${
                                                                            user?.email ?? 'john@acme.co'
                                                                        }`}</Link>
                                                                    </li>
                                                                    <li>
                                                      ...
                                                      {hasTargetingSet && (
                                                          <>
                                                                  ...
                                                                  {({ value, onChange }) => (
                                                                      <>
                                                                          <Field.Pure
                                                                              ...
                                                                              help="Regex and exact match need insights-js 1.82+."
                                                                          >
                                                                              <div className="flex flex-row gap-2 items-center">
                                                                                  <Select
                                                                                  ...
                                                                                  <Input
                                                                                      ...
                                                                                      placeholder="ex: https://app.hanzo.ai"
                                                                                      fullWidth
                                                                                  />
                                                                              </div>
                                                              ...
                                                              {featureFlags[FEATURE_FLAGS.SURVEYS_ACTIONS] ? (
                                                                  <Field.Pure label="Activation triggers">
