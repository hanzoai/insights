...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # the value on INSERT, every write to insights_experiment would fail the
        ...
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                migrations.RunSQL(
                    sql='ALTER TABLE "insights_experiment" ALTER COLUMN "exposure_preaggregation_enabled" DROP NOT NULL;',
                    reverse_sql='ALTER TABLE "insights_experiment" ALTER COLUMN "exposure_preaggregation_enabled" SET NOT NULL;',
                ),
            ],
        ),
    ]
