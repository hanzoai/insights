...
/** Canonical (Insights-maintained) vs Custom (team-authored) scout badge. */
export function ScoutOriginBadge({ origin }: { origin: ScoutOriginEnumApi }): JSX.Element {
    return (
        <Tooltip
            title={
                origin === 'canonical'
                    ? 'Part of the standard scout troop built and maintained by Insights'
                    : 'A scout your team created as a signals-scout-* skill in this project'
            }
        >
            <Tag type={origin === 'canonical' ? 'muted' : 'highlight'} size="small">
