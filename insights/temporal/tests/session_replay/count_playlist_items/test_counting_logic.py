...
from insights.temporal.session_replay.count_playlist_items.counting_logic import (
...
class TestRecordingsThatMatchPlaylistFilters(APIBaseTest, QueryMatchingTest):
    ...
    @patch("hanzo_insights.capture_exception")
    @patch("insights.temporal.session_replay.count_playlist_items.counting_logic.list_recordings_from_query")
