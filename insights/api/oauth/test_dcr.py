...
from insights.models.oauth import OAuthApplication, OAuthApplicationAccessLevel, OAuthGrant
...
class TestDynamicClientRegistration(APIBaseTest):
    ...
    def test_rate_limiting_enforced(self):
        ...
        with patch("insights.api.oauth.dcr.DCRBurstThrottle.rate", "2/minute"):
            with patch("insights.api.oauth.dcr.DCRBurstThrottle.get_cache_key") as mock_cache_key:
