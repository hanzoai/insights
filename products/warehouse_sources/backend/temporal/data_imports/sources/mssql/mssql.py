"""MSSQL driver for Insights's data-warehouse import pipeline.
...
The source-class `MSSQLSource` is a thin Insights-layer wrapper that
...
# bastion refusing Insights's IPs, or a proxy that resets the stream. sshtunnel doesn't wrap it, so
