...
with @Insights over the last N days" and returns plain dataclasses. The renderer in
...
workspace admin is not automatically a Insights org member, so the aggregates must never
