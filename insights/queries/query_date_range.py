...
from insights.models.filters.base_filter import BaseFilter
from insights.models.filters.mixins.interval import IntervalMixin
from insights.models.team import Team
from insights.queries.util import TIME_IN_SECONDS, get_start_of_interval_sql
...
class QueryDateRange:
    ...
    def get_earliest_timestamp(self):
        ...
        # Imported here to avoid a circular import at module load (timestamp_utils pulls in InsightsQL).
