...
const experimentArchive = (): ToolBase<typeof ExperimentArchiveSchema, WithInsightsUrl<Schemas.Experiment>> =>
...
const experimentCreate = (): ToolBase<typeof ExperimentCreateSchema, WithInsightsUrl<Schemas.Experiment>> =>
    withUiApp('experiment', {
        ...
        handler: async (context: Context, params: z.infer<typeof ExperimentCreateSchema>) => {
            ...
            return await withInsightsUrl(context, filtered, `/experiments/${filtered.id}`)
        },
    })
...
const experimentEnd = (): ToolBase<typeof ExperimentEndSchema, WithInsightsUrl<Schemas.Experiment>> =>
    withUiApp('experiment', {
        name: 'experiment-end',
...
const experimentFreezeExposure = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.Experiment>
> =>
    withUiApp('experiment', {
...
const experimentGet = (): ToolBase<typeof ExperimentGetSchema, WithInsightsUrl<Schemas.Experiment>> =>
    withUiApp('experiment', {
        name: 'experiment-get',
...
const experimentHoldoutsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedExperimentHoldoutList>
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof ExperimentHoldoutsListSchema>) => {
        ...
        return await withInsightsUrl(context, filtered, '/experiments')
    },
})
...
const experimentLaunch = (): ToolBase<typeof ExperimentLaunchSchema, WithInsightsUrl<Schemas.Experiment>> =>
    withUiApp('experiment', {
...
const experimentList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedExperimentBasicList>
> =>
...
const experimentMetricsRecalculationCreate = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.ExperimentMetricsRecalculation>
> => ({
...
const experimentPause = (): ToolBase<typeof ExperimentPauseSchema, WithInsightsUrl<Schemas.Experiment>> =>
    withUiApp('experiment', {
...
const experimentReset = (): ToolBase<typeof ExperimentResetSchema, WithInsightsUrl<Schemas.Experiment>> =>
    withUiApp('experiment', {
...
const experimentResume = (): ToolBase<typeof ExperimentResumeSchema, WithInsightsUrl<Schemas.Experiment>> =>
    withUiApp('experiment', {
...
const experimentSavedMetricsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedExperimentSavedMetricList>
> => ({
...
const experimentShipVariant = (): ToolBase<typeof ExperimentShipVariantSchema, WithInsightsUrl<Schemas.Experiment>> =>
    withUiApp('experiment', {
...
const experimentUnarchive = (): ToolBase<typeof ExperimentUnarchiveSchema, WithInsightsUrl<Schemas.Experiment>> =>
    withUiApp('experiment', {
...
const experimentUpdate = (): ToolBase<typeof ExperimentUpdateSchema, WithInsightsUrl<Schemas.Experiment>> =>
    withUiApp('experiment', {
