...
class Mem0Source(ResumableSource[Mem0SourceConfig, Mem0ResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Mem0",
            caption="""Enter your Mem0 API key to automatically pull your Mem0 memories, entities, and operation events into the Insights Data warehouse.

You can find your API key in the [Mem0 dashboard](https://app.mem0.ai/dashboard/api-keys).""",
            iconPath="/static/services/mem0.svg",
            docsUrl="https://hanzo.ai/docs/cdp/sources/mem0",
