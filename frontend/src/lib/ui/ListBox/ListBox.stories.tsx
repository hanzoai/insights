        ...
        return (
            <div className="flex flex-col gap-3">
                <div className="flex flex-col gap-1">
                    ...
                    <p>
                        (button, [href], input, select, textarea, [tabindex]:not([tabindex='-1'])) gain focus when
                        clicked or focused with keyboard, disabled elements are not focusable and skipped.
                    </p>
                    <ul className="list-disc list-inside">
                        <li>Default (all elements gain 'real' focus)</li>
                        <li>
                            OR virtual focus = true (where local state keeps track of focus allowing you to navigate
                            with keyboard but keep let's say an input focused).
                        </li>
                    </ul>
                </div>
                <ListBox
