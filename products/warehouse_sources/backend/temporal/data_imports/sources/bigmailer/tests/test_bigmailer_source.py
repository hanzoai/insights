...
class TestSourceConfig:
    ...
    def test_config_identity_and_release(self) -> None:
        ...
        assert config.docsUrl == "https://hanzo.ai/docs/cdp/sources/bigmailer"
...
class TestDocumentedTables:
    def test_renders_table_catalog_without_credentials(self) -> None:
        # lists_tables_without_credentials must stay on so hanzo.ai renders the Supported tables section
