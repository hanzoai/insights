...
class Ticket(UUIDTModel):
    ...
    # Customer's Insights org group key, resolved once at creation or on a later message
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(
                ...
                name="insights_con_slack_thread_idx",
            ),
            ...
            models.Index(
                ...
                name="insights_con_teams_thread_idx",
            ),
            ...
            models.Index(fields=["team", "status", "-updated_at"], name="insights_con_status_upd_idx"),
            ...
            models.Index(
                ...
                name="insights_con_sla_asc_idx",
            ),
            models.Index(
                models.F("team_id"),
                models.F("sla_due_at").desc(nulls_last=True),
                models.F("ticket_number").desc(),
                name="insights_con_sla_desc_idx",
            ),
            ...
            models.Index(
                ...
                models.F("ticket_number").desc(),
                name="insights_con_snooze_asc_idx",
            ),
            models.Index(
                models.F("team_id"),
                models.F("snoozed_until").desc(nulls_last=True),
                models.F("ticket_number").desc(),
                name="insights_con_snooze_desc_idx",
            ),
            # Snooze: wake task (cross-team, only non-null rows)
            models.Index(
                fields=["snoozed_until"],
                name="insights_con_snooze_wake_idx",
                condition=models.Q(snoozed_until__isnull=False),
            ),
            models.Index(fields=["organization_id"], name="insights_org_id_idx"),
            models.Index(
