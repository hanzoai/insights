from insights.schema import FilterLogicalOperator, PropertyGroupFilterValue, RecordingsQuery
...
from insights.session_recordings.queries.utils import is_person_property, poe_is_active
