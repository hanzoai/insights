...
export interface insightsFunctionLogsLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface insightsFunctionLogsLogicActions {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface insightsFunctionLogsLogicMeta {
    key: string
...
export type insightsFunctionLogsLogicType = MakeLogicType<
    insightsFunctionLogsLogicValues,
    insightsFunctionLogsLogicActions,
    LogsViewerLogicProps,
    insightsFunctionLogsLogicMeta
>
