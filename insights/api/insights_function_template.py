...
from insights.models.insights_functions import InsightsFunction
...
class InsightsFunctionTemplateSerializer(serializers.ModelSerializer):
    mapping_templates = InsightsFunctionMappingTemplateSerializer(many=True, required=False, allow_null=True)
