...
class RenderSource(ResumableSource[RenderSourceConfig, RenderResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Render API key to pull your services, deploys, jobs, and databases into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/render",
