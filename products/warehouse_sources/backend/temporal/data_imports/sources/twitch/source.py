...
from products.warehouse_sources.backend.temporal.data_imports.sources.generated_configs.twitch import TwitchSourceConfig
...
class TwitchSource(SimpleSource[TwitchSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            name=SchemaExternalDataSourceType.TWITCH,
