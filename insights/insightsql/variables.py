...
from insights.schema import InsightsQLVariable
...
def replace_variables(node: T, variables: list[InsightsQLVariable], team: Team) -> T:
...
class ReplaceVariables(CloningVisitor):
    ...
    def __init__(self, variables: list[InsightsQLVariable], team: Team):
        super().__init__()
