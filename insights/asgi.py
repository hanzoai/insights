...
os.environ["DJANGO_SETTINGS_MODULE"] = "insights.settings"
...
async def _event_loop_lag_heartbeat() -> None:
    ...
    lag_gauge = Gauge(
        "insights_asgi_event_loop_lag_seconds",
...
def _ensure_post_fork_init():
    ...
    from insights.caching.redis_cluster_connection_factory import prewarm_query_cache_cluster_in_background
    from insights.continuous_profiling import start_continuous_profiling
    from insights.otel_instrumentation import initialize_otel
    from insights.web_memory_probe import install_memory_probe_handler
    from insights.web_memory_sampler import start_web_memory_sampler
    ...
    # ran in prod, leaving insights_web_worker_rss_mb empty. Start it here, post-fork.
