...
CANONICAL_DESCRIPTIONS: CanonicalDescriptions = {
    ...
    "FailingTests": {
        ...
        "columns": {
            ...
            "quarantined": "Whether the test is currently quarantined.",
            "ticket": "The ticket linked to this test case, if any.",
            "synced_through": "Insights-added: the end of the time window this row was synced in, used to track incremental progress.",
        },
    },
    MERGE_QUEUE_PULL_REQUESTS: {
        ...
        "columns": {
            ...
            "synced_through": "Insights-added: the start of the sync run this row was fetched in, used to track incremental progress.",
        },
    },
}
