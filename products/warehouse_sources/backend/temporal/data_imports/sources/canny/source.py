...
class CannySource(ResumableSource[CannySourceConfig, CannyResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Canny API key to sync your Canny feedback, posts, and roadmap data into the Insights Data warehouse.

Find your secret API key under **Settings → API** in your Canny dashboard.""",
            iconPath="/static/services/canny.png",
            docsUrl="https://hanzo.ai/docs/cdp/sources/canny",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
