...
export function GatewayServerScene({
    ...
    if (!server && serversLoadFailed) {
        return (
            <SceneContent>
                <Button size="small" type="tertiary" icon={<IconArrowLeft />} onClick={goBack}>
                    Back to servers
                </Button>
    ...
    return (
        <SceneContent>
            ...
            <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                        ...
                        {isAdmin && !server.is_team_enabled && <Tag type="muted">Off</Tag>}
                    </div>
            ...
            {connection && !connection.is_enabled && (
                <Banner type="info">
                    This server is off for you. Turn it on to offer its tools to Insights and your agents.
                </Banner>
            )}
            ...
            {toolPoliciesLoading && toolPolicies.length === 0 ? (
                ...
                <div className="border rounded divide-y overflow-hidden">
                    ...
                    {filteredToolPolicies.length > TOOL_PREVIEW_LIMIT && !toolSearch.trim() && (
                        <Button fullWidth type="tertiary" onClick={toggleToolsExpanded}>
                            {toolsExpanded
                                ? 'View less'
    ...
    return (
        <div className={`flex items-start gap-2 transition-colors ${TOOL_POLICY_BACKGROUND_CLASSES[displayedState]}`}>
            <div className="min-w-0 flex-1">
                <Collapse
                    embedded
                    className="[&_.CollapsePanel__header]:!bg-transparent"
                    panels={[
                        {
