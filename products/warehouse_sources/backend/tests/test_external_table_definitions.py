...
class TestGetHogqlColumnNameMapping:
    ...
    def test_maps_raw_column_to_insightsql_visible_name(self, table: str, raw: str, expected: str) -> None:
        assert get_insightsql_column_name_mapping(table)[raw] == expected

    def test_non_renamed_columns_map_to_themselves(self) -> None:
        mapping = get_insightsql_column_name_mapping("stripe_charge")
    ...
    def test_hidden_alias_field_is_never_a_target(self) -> None:
        ...
        assert "__created" not in get_insightsql_column_name_mapping("stripe_charge").values()
    ...
    def test_unknown_table_returns_empty_mapping(self) -> None:
        ...
        assert get_insightsql_column_name_mapping("some_postgres_table") == {}
