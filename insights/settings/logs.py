...
LOGGING = {
    ...
    "loggers": {
        ...
        "insights.tasks.exports": {"level": "INFO", "handlers": ["console"], "propagate": False},
        "insights.tasks.llm_analytics_usage_report": {"level": "INFO", "handlers": ["console"], "propagate": False},
        "insights.tasks.hypercache_verification": {"level": "INFO", "handlers": ["console"], "propagate": False},
        "insights.storage.hypercache_verifier": {"level": "INFO", "handlers": ["console"], "propagate": False},
        "insights.auth.mfa": {"level": "INFO", "handlers": ["console"], "propagate": False},
        "insights.temporal.data_imports.pipelines.pipeline_v3.load": {
            "level": "DEBUG",
            "handlers": ["console"],
            "propagate": False,
        },
