...
export interface recommendationsTabLogicValues {
    ...
    openAlertTriggerKey: InsightsFunctionSubTemplateIdType | null
...
export interface recommendationsTabLogicActions {
    ...
    setOpenAlertTriggerKey: (triggerKey: InsightsFunctionSubTemplateIdType | null) => {
...
export const recommendationsTabLogic = kea<recommendationsTabLogicType>([
    ...
    actions({
        ...
        setOpenAlertTriggerKey: (triggerKey: InsightsFunctionSubTemplateIdType | null) => ({ triggerKey }),
    }),
    ...
    reducers({
        ...
        openAlertTriggerKey: [
            null as InsightsFunctionSubTemplateIdType | null,
            {
    ...
    listeners(({ actions, values, cache }) => ({
        loadRecommendations: async () => {
            ...
            try {
                ...
                insights.capture('error_tracking_recommendations_loaded', {
        ...
        dismissRecommendation: async ({ id }) => {
            ...
            actions.upsertRecommendation(updated)
            insights.capture('error_tracking_recommendation_dismissed', {
