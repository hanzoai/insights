...
FUNNEL_AGGREAGTE_BY_INSIGHTSQL = "funnel_aggregate_by_insightsql"
...
PATHS_INSIGHTSQL_EXPRESSION = "paths_insightsql_expression"
...
BREAKDOWN_TYPES = Literal["event", "person", "cohort", "group", "session", "insightsql"]
