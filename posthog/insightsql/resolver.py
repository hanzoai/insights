...
from posthog.insightsql.ast import ConstantType, FieldTraverserType
from posthog.insightsql.base import _T_AST
from posthog.insightsql.constants import InsightsQLDialect
from posthog.insightsql.context import InsightsQLContext
from posthog.insightsql.database.database import Database
from posthog.insightsql.database.models import FunctionCallTable, LazyTable, SavedQuery, StringJSONDatabaseField
...
from posthog.insightsql.functions.explain_csp_report import explain_csp_report
from posthog.insightsql.functions.mapping import INSIGHTSQL_CLICKHOUSE_FUNCTIONS
from posthog.insightsql.functions.recording_button import recording_button
from posthog.insightsql.functions.sparkline import sparkline
from posthog.insightsql.functions.survey import get_survey_response, unique_survey_submissions_filter
from posthog.insightsql.insightsqlx import INSIGHTSQLX_COMPONENTS, INSIGHTSQLX_TAGS, convert_to_hx
from posthog.insightsql.parser import parse_select
from posthog.insightsql.resolver_utils import expand_insightsqlx_query, lookup_field_by_name, lookup_table_by_name
from posthog.insightsql.utils import map_virtual_properties
from posthog.insightsql.visitor import CloningVisitor, TraversingVisitor, clone_expr
...
class Resolver(CloningVisitor):
    ...
    def visit_select_query(self, node: ast.SelectQuery):
        ...
        for new_expr in select_nodes:
            if isinstance(new_expr.type, ast.FieldAliasType):
                ...
                from posthog.insightsql.printer import print_prepared_ast
    ...
    def visit_call(self, node: ast.Call):
        ...
        if return_type is None:
            ...
            # Uncomment once all insightsql mappings are complete with signatures
