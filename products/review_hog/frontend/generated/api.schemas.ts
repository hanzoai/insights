...
export interface ReviewBlindSpotsConfigApi {
    /** Name of the `review-script-blind-spots-*` skill this row represents (the sweep's identity). */
    skill_name: string
...
export interface ReviewPerspectiveConfigApi {
    /** Name of the `review-script-perspective-*` skill this row toggles (the perspective's identity). */
    skill_name: string
...
export interface ReviewValidatorConfigApi {
    /** Name of the `review-script-validation-*` skill this row represents (the validator's identity). */
    skill_name: string
