...
# Importing the package pulls hogland_backend, which needs the insights-hogland
...
class PreviewSecretKeyTest(unittest.TestCase):
    def test_key_is_random_hex_not_the_derivable_constant(self):
        ...
        stack = InsightsPreviewStack(backend)
    ...
    def test_key_differs_across_previews(self):
        ...
        k1 = _secret_key_from_override(InsightsPreviewStack(b1), b1)
        k2 = _secret_key_from_override(InsightsPreviewStack(b2), b2)
