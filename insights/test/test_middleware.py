...
from insights.models import Action, Cohort, Dashboard, FeatureFlag, Insight
...
class TestInsightsTokenCookieMiddleware(APIBaseTest):
    ...
    def test_logged_in_client(self):
        ...
        self.assertEqual(ph_project_token_cookie["domain"], "insights.com")
        ...
        self.assertEqual(ph_project_name_cookie["domain"], "insights.com")
        ...
        self.assertEqual(ph_instance_cookie["domain"], "insights.com")
        ...
        self.assertEqual(ph_last_login_method_cookie["domain"], "insights.com")
