...
def cast_assistant_query(
    query: AssistantTrendsQuery | AssistantFunnelsQuery | AssistantRetentionQuery | AssistantInsightsQLQuery,
) -> TrendsQuery | FunnelsQuery | RetentionQuery | InsightsQLQuery:
    """
    ...
    elif query.kind == "InsightsQLQuery":
        return InsightsQLQuery(**query.model_dump())
    else:
