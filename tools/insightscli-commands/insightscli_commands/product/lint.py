...
def lint_owners(names: list[str] | None = None) -> None:
    ...
    click.echo(f"Validating product.yaml owners across {scope} against Insights/insights teams\n")
    ...
    click.echo(f"✓ All {len(targets)} product owners are valid Insights/insights teams")
