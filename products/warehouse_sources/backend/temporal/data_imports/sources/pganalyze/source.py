...
class PgAnalyzeSource(SimpleSource[PgAnalyzeSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="pganalyze",
            caption="Connect pganalyze to sync Postgres performance issues, query stats, and server metadata into the Insights Data warehouse.",
            iconPath="/static/services/pganalyze.svg",
            docsUrl="https://hanzo.ai/docs/cdp/sources/pganalyze",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
