...
# messages keep routing after the module moved out of insights/approvals.
@shared_task(ignore_result=True, name="insights.approvals.tasks.validate_pending_change_requests")
...
@shared_task(ignore_result=True, name="insights.approvals.tasks.expire_old_change_requests")
@skip_team_scope_audit
