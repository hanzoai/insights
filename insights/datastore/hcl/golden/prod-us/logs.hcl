database "insights" {
  table "kafka_logs_avro" {
    ...
    engine "kafka" {
      ...
      topic_list           = "kafka_topic_list = 'datastore_logs'"
      group_name           = "kafka_group_name = 'datastore-logs-avro-new'"
  ...
  table "kafka_metrics_avro" {
    ...
    engine "kafka" {
      ...
      topic_list           = "kafka_topic_list = 'datastore_metrics'"
      group_name           = "kafka_group_name = 'datastore-metrics-avro-new'"
      format               = "kafka_format = 'Avro'"
      num_consumers        = 8
      skip_broken_messages = 100
      poll_timeout_ms      = 3000
  ...
  table "kafka_trace_spans_avro" {
    ...
    engine "kafka" {
      ...
      topic_list           = "kafka_topic_list = 'datastore_traces'"
      group_name           = "kafka_group_name = 'datastore-traces-avro'"
      format               = "kafka_format = 'Avro'"
      num_consumers        = 8
      skip_broken_messages = 100
      poll_timeout_ms      = 3000
  ...
  table "log_attributes2" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/logs/{shard}/log_attributes34"
  ...
  table "log_attributes3" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.log_attributes3"
  ...
  table "logs34" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/logs/{shard}/insights.logs34"
      replica_name = "{replica}"
    }
  }
  ...
  table "logs_billing_metrics" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/logs/{shard}/logs_billing_metrics"
      replica_name = "{replica}"
    }
  }
  ...
  table "logs_kafka_metrics" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/logs/{shard}/logs_kafka_metrics"
      replica_name = "{replica}"
    }
  }
  ...
  table "metric_attributes" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/logs/{shard}/insights.metric_attributes"
      replica_name = "{replica}"
    }
  }
  ...
  table "metric_samples1" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.metric_samples1"
      replica_name = "{replica}-{shard}"
    }
  }
  ...
  table "metric_series1" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.metric_series1"
      replica_name   = "{replica}-{shard}"
  ...
  table "metrics1" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/logs/{shard}/insights.metrics1"
      replica_name = "{replica}"
    }
  }
  ...
  table "metrics_kafka_metrics" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/logs/{shard}/insights.metrics_kafka_metrics"
      replica_name = "{replica}"
    }
  }
  ...
  table "trace_attributes" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/logs/{shard}/insights.trace_attributes"
      replica_name = "{replica}"
    }
  }
  ...
  table "trace_spans" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/logs/{shard}/insights.trace_spans"
      replica_name = "{replica}"
    }
  }
  ...
  table "trace_spans_kafka_metrics" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/logs/{shard}/insights.trace_spans_kafka_metrics"
      replica_name = "{replica}"
    }
  }
...
SQL
  ...
  materialized_view "kafka_logs_avro_billing_metrics_mv" {
    to_table = "insights.logs_billing_metrics"
    query    = <<SQL
SELECT
  team_id,
  time_bucket,
...
SQL
  ...
  materialized_view "kafka_logs_avro_kafka_metrics_mv" {
    to_table = "insights.logs_kafka_metrics"
    query    = <<SQL
SELECT
  _partition,
  _topic,
...
SQL
  ...
  materialized_view "kafka_metrics_avro_kafka_metrics_mv" {
    to_table = "insights.metrics_kafka_metrics"
    query    = <<SQL
SELECT
  _partition,
  _topic,
...
SQL
  ...
  materialized_view "kafka_metrics_avro_to_metric_samples" {
    to_table = "insights.metric_samples1"
    query    = <<SQL
SELECT
  toInt32OrZero(_headers.value[indexOf(_headers.name, 'team_id')]) AS team_id,
  ifNull(metric_name, '') AS metric_name,
...
SQL
  ...
  materialized_view "kafka_metrics_avro_to_metric_series" {
    to_table = "insights.metric_series1"
    query    = <<SQL
SELECT
  toInt32OrZero(_headers.value[indexOf(_headers.name, 'team_id')]) AS team_id,
  ifNull(metric_name, '') AS metric_name,
...
SQL
  ...
  materialized_view "logs34_to_log_attributes" {
    to_table = "insights.log_attributes2"
    query    = <<SQL
SELECT
  team_id,
  time_bucket,
...
SQL
  ...
  materialized_view "logs34_to_log_attributes3" {
    to_table = "insights.log_attributes3"
    query    = <<SQL
SELECT
  team_id,
  time_bucket,
...
SQL
  ...
  materialized_view "metrics1_to_metric_attributes" {
    to_table = "insights.metric_attributes"
    query    = <<SQL
SELECT
  team_id,
  time_bucket,
...
SQL
  ...
  materialized_view "trace_span_to_attributes" {
    to_table = "insights.trace_attributes"
    query    = <<SQL
SELECT
  team_id,
  original_expiry_time_bucket,
...
SQL
  ...
  materialized_view "trace_spans_to_kafka_metrics_mv" {
    to_table = "insights.trace_spans_kafka_metrics"
    query    = <<SQL
SELECT
  _partition,
  _topic,
