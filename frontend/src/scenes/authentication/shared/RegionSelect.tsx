...
import { Modal, Select, Tag } from '@hanzo/elements'
...
export default function RegionSelect(): JSX.Element | null {
    ...
    // Local dev: offer signing into a remote cloud region over OAuth, styled like the Insights Desktop
    ...
    return (
        ...
        >
            <div className="flex w-full items-center gap-2">
                ...
                {isOAuth && (
                    <Tag type="primary" size="small" className="ml-auto">
                        OAuth
                    </Tag>
                )}
            </div>
