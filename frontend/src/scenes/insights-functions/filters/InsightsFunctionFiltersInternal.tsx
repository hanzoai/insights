 ...
 */
export const getProductEventFilterOptions = (contextId: InsightsFunctionConfigurationContextId): FilterOption[] => {
    switch (contextId) {
        case 'error-tracking':
            return [
                {
...
export const getProductEventPropertyFilterOptions = (contextId: InsightsFunctionConfigurationContextId): string[] => {
    switch (contextId) {
        case 'activity-log':
            return [
                'id',
...
export function InsightsFunctionFiltersInternal(): JSX.Element {
    const { contextId } = useValues(insightsFunctionConfigurationLogic)
