...
class TestReportSlackMentionReceived:
    ...
    @patch("products.slack_app.backend.api.resolve_insights_user_from_event")
    def test_capture_properties(
        ...
        assert kwargs["event"] == "insights code slack mention received"
        ...
        assert props["insights_user_identified"] is exp_identified
