 ...
 */
export class InsightsFlowDuplicateObserverService {
    constructor(
    ...
    public async observe(
        ...
        try {
            const [existingId] = await Promise.all([
                ...
                mirrorCall('script-flow-duplicate-observer.observe', () =>
            ...
            logger.debug('🦔', '[InsightsFlowDuplicateObserver] failed', { error: String(error) })
        }
        return { duplicate }
    }
}
