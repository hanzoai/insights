...
from insights.schema import ReleaseStatus, SourceFieldInputConfig, SourceFieldSelectConfig
...
class TestGrafanaSource:
    ...
    def test_get_source_config(self):
        ...
        assert config.docsUrl == "https://hanzo.ai/docs/cdp/sources/grafana"
    ...
    def test_documented_tables_render_without_credentials(self):
        ...
        # any I/O or config access in get_schemas would break the hanzo.ai table catalog.
