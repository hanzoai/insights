...
export const PLAYER_EMIT_FN = '__insights_player_emit__'
export const PLAYER_CONFIG_KEY = '__insights_player_config__'

// --- Event names (rasterizer → player) ---

export const PLAYER_START_EVENT = 'insights-player-start'
