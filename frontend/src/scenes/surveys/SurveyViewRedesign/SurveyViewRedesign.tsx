...
import { IconArchive, IconCode, IconCopy, IconTrash } from '@hanzo/icons'
import { Button, Dialog, Divider, Tag } from '@hanzo/elements'
    ...
    return (
        <SceneContent className="gap-y-4 flex-1 min-h-full">
            ...
            <ScenePanel>
                ...
                <Tabs size="small" activeKey={panelTabKey} onChange={(key) => setPanelTab(key)} tabs={panelTabs} />
            </ScenePanel>
