// Pure column-layout helpers used by Table internals. Kept separate from
...
// every bundle that renders a Table.
...
export function getStickyColumnInfo<T extends Record<string, any>>(
    ...
    allColumns: TableColumn<T, any>[] | undefined
): PinnedColumnInfo {
 ...
 */
export function determineColumnKey(column: TableColumn<any, any>, obligationReason: string): string
export function determineColumnKey(column: TableColumn<any, any>, obligationReason?: undefined): string | null
export function determineColumnKey(column: TableColumn<any, any>, obligationReason?: string): string | null {
