...
from posthog.kafka_client.topics import KAFKA_DATASTORE_HEATMAP_EVENTS
...
KAFKA_HEATMAPS_TABLE_SQL = lambda: KAFKA_HEATMAPS_TABLE_BASE_SQL.format(
    ...
    engine=kafka_engine(topic=KAFKA_DATASTORE_HEATMAP_EVENTS, group=CONSUMER_GROUP_HEATMAPS),
)
