...
// Extends ApiError so the existing `e instanceof ApiError → toast.error(e.detail)`
...
//   1. Reads disguised as writes — /query serves InsightsQL / trends / funnels /
...
//   3. Insights AI (Max) conversations — the read-only toast tells users to
