...
class DopplerSource(ResumableSource[DopplerSourceConfig, DopplerResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter a Doppler API token to pull your Doppler projects, configs, and activity logs into the Insights Data warehouse for audit and change tracking. Secret values are never synced.
...
Use a [personal token](https://docs.doppler.com/docs/personal-tokens) or a [service account token](https://docs.doppler.com/docs/service-accounts) with read access to the workplace and the projects you want to sync.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/doppler",
            keywords=["secrets"],
            fields=cast(
                list[FieldType],
                [
