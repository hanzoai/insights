...
import { SidePanelRunner } from 'products/insights_ai/frontend/api/runner'
...
/**
 * The new insights_ai side-panel experience: task-based, built on the `products/insights_ai/frontend` runner
 ...
 * replaced outright by the insights_ai product surface.
 */
