...
from insights.constants import MONTHLY_ACTIVE, UNIQUE_USERS, WEEKLY_ACTIVE, PropertyOperatorType
from insights.models import Entity
...
from insights.queries.trends.util import COUNT_PER_ACTOR_MATH_FUNCTIONS, get_active_user_params
