...
from insights.models import ActivityLog, Team
...
class TestExternalTicketAPI(BaseTest):
    ...
    # -- Workflow (InsightsFlow) attribution -----------------------------------
    ...
    def test_patch_tag_changes_record_workflow_trigger(self, _name, payload, action, direction, tag_name):
        ...
        # workflow tag changes render as an anonymous "Insights" on the ticket timeline.
        from insights.models import Tag
