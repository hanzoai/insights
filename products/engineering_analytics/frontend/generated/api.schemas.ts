...
export interface QuarantineRequestApi {
    ...
    reason?: string
    /** GitHub team or user handle responsible for the fix, e.g. '@Insights/team-x'. Required for quarantine and extend. */
    owner?: string
...
export interface TeamCIHealthItemApi {
    /** Owning team slug (the CODEOWNERS handle minus '@Insights/', e.g. 'team-replay'), or the literal 'unowned' for tests whose spans carry no ownership stamp. */
    owner_team: string
