            ...
            {entries.map(([key, value], index) => (
                <div key={index} className="flex gap-2 items-center">
                    ...
                    <Input
                        ...
                        className="flex-[2]"
                    />
                    <Button icon={<IconTrash />} type="secondary" size="small" onClick={() => removeEntry(key)} />
                </div>
            ))}
            <Button icon={<IconPlus />} type="secondary" size="small" onClick={addEntry}>
                Add path
            </Button>
            {entries.length === 0 && (
    ...
    return (
        <div className="border rounded-lg p-4">
            <div className="flex items-start justify-between gap-4">
                ...
                <Button icon={<IconPencil />} type="secondary" size="small" onClick={() => editRepo(repo.id)}>
                    Edit
                </Button>
            </div>
    ...
    return (
        <div className="border-2 border-primary rounded-lg p-4 space-y-4">
            ...
            <div className="flex gap-2 pt-2">
                ...
                <Button type="secondary" size="small" onClick={cancelEdit}>
                    Cancel
                </Button>
            </div>
        </div>
