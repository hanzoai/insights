...
# Validated enum value → Datastore ORDER BY column. Lookup keeps user input out of the SQL string.
...
class TraceSpansAttributeBreakdownQueryRunner(
    ...
    def _row_from_datastore(self, row: list) -> AttributeBreakdownRow:
