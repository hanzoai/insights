...
class TestTeamMetadataCache(BaseTest):
    ...
    @patch("insights.storage.team_metadata_cache.team_metadata_hypercache")
...
class TestTeamMetadataCacheTasks(BaseTest):
    ...
    @patch("insights.tasks.team_metadata.update_team_metadata_cache")
...
class TestTeamMetadataCacheSignals(BaseTest):
    ...
    @patch("insights.tasks.team_metadata.transaction")
    @patch("insights.tasks.team_metadata.settings")
    @patch("insights.tasks.team_metadata.update_team_metadata_cache_task.delay")
    ...
    @patch("insights.tasks.team_metadata.settings")
    @patch("insights.tasks.team_metadata.clear_team_metadata_cache")
...
class TestCacheStats(BaseTest):
    ...
    def test_get_cache_stats_basic(self, mock_get_client):
        ...
        from insights.storage.team_metadata_cache import get_cache_stats
...
class TestWarmCachesExpiryTracking(BaseTest):
    ...
    def test_warm_caches_uses_api_token_for_token_based_cache(self, mock_time, mock_get_client):
        ...
        from insights.storage.team_metadata_cache import TEAM_CACHE_EXPIRY_SORTED_SET, TEAM_HYPERCACHE_MANAGEMENT_CONFIG
...
class TestTeamMetadataGracePeriod(BaseTest):
    ...
    def test_recently_updated_team_is_in_skip_set(self):
        ...
        from insights.storage.team_metadata_cache import _get_team_ids_with_recently_updated_teams
    ...
    def test_config_has_skip_fix_function(self):
        ...
        from insights.storage.team_metadata_cache import TEAM_HYPERCACHE_MANAGEMENT_CONFIG
