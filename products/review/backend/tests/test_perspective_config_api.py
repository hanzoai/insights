...
from products.review.backend.reviewer.lazy_seed import sync_canonical_perspectives
...
class TestReviewPerspectiveConfigAPI(APIBaseTest):
    ...
    @parameterized.expand(
        [
            ("unknown_perspective_skill", f"{REVIEW_FN_PERSPECTIVE_PREFIX}does-not-exist", 404),
            ("not_a_perspective_name", "review-script-validation-criteria", 400),
        ]
    )
