...
> &
    Pick<
        ...
        | 'FN_FUNCTION_MONITORING_APP_METRICS_TOPIC'
        | 'FN_FUNCTION_MONITORING_APP_METRICS_PRODUCER'
        | 'FN_FUNCTION_MONITORING_LOG_ENTRIES_TOPIC'
        | 'FN_FUNCTION_MONITORING_LOG_ENTRIES_PRODUCER'
        | 'FN_INVOCATION_RESULTS_TOPIC'
        | 'FN_INVOCATION_RESULTS_PRODUCER'
        | 'FN_INVOCATION_RESULTS_ENABLED'
...
export function createCdpCoreServices(
    ...
    // choke point regardless of whether the invocation came from a workflow action or a script function.
