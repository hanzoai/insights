...
// lib/api.ts and insightsflows/types.ts are both imported by half the app.
...
export interface MessageAsset {
    ...
    /** InsightsFlowBatchJob id for batch-triggered sends; empty for event-triggered runs. */
