...
from insights.insightsql.ast import And, CompareOperation, Constant, SelectQuery
...
from insights.insightsql_queries.insights.paginators import InsightsQLCursorPaginator, InsightsQLHasMorePaginator
...
class TestInsightsQLHasMorePaginator(ClickhouseTestMixin, APIBaseTest):
    ...
    @patch("insights.insightsql_queries.insights.paginators.execute_insightsql_query")
