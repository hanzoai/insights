...
const insightsTablesFuse = createFuse<DatabaseSchemaTable>([], FUSE_OPTIONS)
...
export interface queryDatabaseLogicValues {
    ...
    allInsightsTables: DatabaseSchemaTable[]; // databaseTableListLogic
    ...
    insightsTables: DatabaseSchemaTable[]; // databaseTableListLogic
    insightsTablesMap: Record<string, DatabaseSchemaTable>; // databaseTableListLogic
...
export interface queryDatabaseLogicActions {
    ...
    deleteUnsavedQueryFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    deleteUnsavedQuerySuccess: (queryTabState: QueryTabState | {
        id: string;
        state: {
    ...
    loadQueryTabStateFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadQueryTabStateSuccess: (queryTabState: QueryTabState | null, payload?: any) => {
        queryTabState: QueryTabState | null;
        payload?: any;
    };
    ...
    moveDraggedViewToDropTarget: (viewId: string, dropTargetId: string | null) => {
    ...
    setExpandedFolders: (folderIds: string[], connectionId?: string | null) => {
    ...
    setPendingViewFolderOverride: (viewId: string, folderId: string | null) => {
        folderId: string | null;
        viewId: string;
    };
...
export interface queryDatabaseLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        ...
        relevantInsightsTables: (insightsTables: DatabaseSchemaTable[], searchTerm: string) => [
            DatabaseSchemaTable,
            FuseSearchMatch[] | null
        ][];
        relevantSystemTables: (systemTables: DatabaseSchemaTable[], searchTerm: string) => [
            DatabaseSchemaTable,
            FuseSearchMatch[] | null
        ][];
        relevantDataWarehouseTables: (dataWarehouseTables: DatabaseSchemaDataWarehouseTable[], searchTerm: string) => [
            DatabaseSchemaDataWarehouseTable,
            FuseSearchMatch[] | null
        ][];
        relevantSavedQueries: (effectiveDataWarehouseSavedQueries: DataWarehouseSavedQuery[], searchTerm: string) => [
            DataWarehouseSavedQuery,
            FuseSearchMatch[] | null
        ][];
        relevantSavedQueryFolders: (dataWarehouseSavedQueryFolders: DataWarehouseSavedQueryFolder[], searchTerm: string) => [
            DataWarehouseSavedQueryFolder,
            FuseSearchMatch[] | null
        ][];
        effectiveDataWarehouseSavedQueries: (dataWarehouseSavedQueries: DataWarehouseSavedQuery[], pendingViewFolderOverrides: Record<string, string | null>) => DataWarehouseSavedQuery[];
        relevantManagedViews: (managedViews: DatabaseSchemaManagedViewTable[], searchTerm: string) => [
            DatabaseSchemaManagedViewTable,
            FuseSearchMatch[] | null
        ][];
        relevantDrafts: (drafts: DataWarehouseSavedQueryDraft[], searchTerm: string) => [
            DataWarehouseSavedQueryDraft,
            FuseSearchMatch[] | null
        ][];
        relevantEndpointTables: (latestEndpointTables: DatabaseSchemaEndpointTable[], searchTerm: string) => [
            DatabaseSchemaEndpointTable,
            FuseSearchMatch[] | null
        ][];
        selectedDirectSource: (dataWarehouseSources: PaginatedResponse<ExternalDataSource> | null, connectionId: string | null) => {
            job_inputs?: Record<string, any>;
        } | undefined;
        searchTreeSourceContext: (allInsightsTables: DatabaseSchemaTable[], systemTables: DatabaseSchemaTable[], dataWarehouseTables: DatabaseSchemaDataWarehouseTable[], effectiveDataWarehouseSavedQueries: DataWarehouseSavedQuery[], dataWarehouseSavedQueryFolders: DataWarehouseSavedQueryFolder[], managedViews: DatabaseSchemaManagedViewTable[], allTablesMap: Record<string, DatabaseSchemaTable>) => SearchTreeSourceContext;
        searchTreeMatches: (relevantInsightsTables: [
            DatabaseSchemaTable,
            FuseSearchMatch[] | null
        ][], relevantSystemTables: [
            DatabaseSchemaTable,
        ...
        searchTreeData: (searchTreeSourceContext: SearchTreeSourceContext, searchTreeMatches: SearchTreeMatches, searchTerm: string, featureFlags: FeatureFlagsSet, expandedSearchFolders: string[], materializingViewIds: string[]) => TreeDataItem[];
        treeDataContext: (allInsightsTables: DatabaseSchemaTable[], insightsTables: DatabaseSchemaTable[], systemTables: DatabaseSchemaTable[], dataWarehouseTables: DatabaseSchemaDataWarehouseTable[], effectiveDataWarehouseSavedQueries: DataWarehouseSavedQuery[], dataWarehouseSavedQueryFolders: DataWarehouseSavedQueryFolder[], managedViews: DatabaseSchemaManagedViewTable[], latestEndpointTables: DatabaseSchemaEndpointTable[], allTablesMap: Record<string, DatabaseSchemaTable>) => TreeDataContext;
        treeData: (treeDataContext: TreeDataContext, databaseLoading: boolean, databaseLoadError: string | null, dataWarehouseSavedQueriesLoading: boolean, drafts: DataWarehouseSavedQueryDraft[], draftsResponseLoading: boolean, hasMoreDrafts: boolean, featureFlags: FeatureFlagsSet, queryTabState: QueryTabState | null, expandedFolders: string[], materializingViewIds: string[]) => TreeDataItem[];
        displayedTreeData: (searchTerm: string, searchTreeData: TreeDataItem[], treeData: TreeDataItem[], connectionId: string | null, selectedDirectSource: {
            job_inputs?: Record<string, any>;
        } | undefined) => TreeDataItem[];
        activeExpandedFolderIds: (searchTerm: string, expandedSearchFolders: string[], expandedFolders: string[]) => string[];
        expandedFolders: (connectionId: string | null, expandedFoldersByConnection: Record<string, string[]>) => string[];
        ...
        sidebarOverlayTreeItems: (selectedSchema: DatabaseSchemaTable | DataWarehouseSavedQuery | null, insightsTablesMap: Record<string, DatabaseSchemaTable>, systemTablesMap: Record<string, DatabaseSchemaTable>, dataWarehouseTablesMap: Record<string, DatabaseSchemaDataWarehouseTable | DatabaseSchemaViewTable>, dataWarehouseSavedQueryMapById: Record<string, DataWarehouseSavedQuery>, viewsMapById: Record<string, DatabaseSchemaEndpointTable | DatabaseSchemaManagedViewTable | DatabaseSchemaViewTable>, joinsByFieldName: Record<string, DataWarehouseViewLink>) => TreeItem[];
    };
}

export type queryDatabaseLogicType = MakeLogicType<queryDatabaseLogicValues, queryDatabaseLogicActions, Record<string, any>, queryDatabaseLogicMeta>;
    ...
    selectors(({ actions, cache }) => ({
        ...
        treeData: [
            ...
            (
                ...
                } else if (databaseLoading && insightsTables.length === 0 && dataWarehouseTables.length === 0) {
                    sourcesChildren.push({
                        id: 'sources-loading/',
                        name: 'Loading...',
                        displayName: <>Loading...</>,
