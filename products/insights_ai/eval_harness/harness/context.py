...
class EvalContext:
    ...
    ``insights_client``) that suites used to take individually. Passed unchanged
    ...
    """Bounds concurrent team cloning and case seeders to protect Datastore RAM."""
