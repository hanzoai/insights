...
# The config-driven twin of `oauth_refresh_counter` in insights.models.integration: a separate metric
...
class CustomOAuth2Integration(TeamScopedRootMixin, CreatedMetaFields, UpdatedMetaFields, UUIDTModel):
    ...
    # db_constraint=False on the FKs to hot tables (insights_team, insights_user): creating a real FK
