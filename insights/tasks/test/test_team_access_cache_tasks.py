...
from insights.tasks.team_access_cache_tasks import (
...
class TestWarmUserTeamsCacheSync(TestCase):
    ...
    @patch("insights.tasks.team_access_cache_tasks.warm_team_token_cache")
...
class TestWarmPersonalApiKeyDeletedCacheTask(TestCase):
    ...
    @patch("insights.tasks.team_access_cache_tasks.warm_team_token_cache")
    @patch("insights.models.team.team.Team")
    @patch("insights.models.organization.OrganizationMembership")
...
class TestWarmAllTeamsCachesTask(TestCase):
    ...
    @patch("insights.tasks.team_access_cache_tasks.get_teams_needing_cache_refresh_paginated")
    ...
    @patch("insights.tasks.team_access_cache_tasks.get_teams_needing_cache_refresh_paginated")
    @patch("insights.tasks.team_access_cache_tasks.warm_team_cache_task.delay")
    @patch("insights.tasks.team_access_cache_tasks.CACHE_WARMING_BATCH_SIZE", 2)
...
class TestTaskIntegration(TestCase):
    ...
    def test_complete_cache_refresh_flow(self, mock_get_teams_paginated: MagicMock, mock_warm: MagicMock) -> None:
        ...
        with patch("insights.tasks.team_access_cache_tasks.warm_team_cache_task.delay") as mock_delay:
