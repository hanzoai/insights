...
from insights.api.llm_prompt_serializers import MAX_PROMPT_PAYLOAD_BYTES
from insights.exceptions_capture import capture_exception
from insights.models import Team, User
from insights.models.activity_logging.activity_log import Change
from insights.storage.llm_prompt_cache import invalidate_prompt_latest_cache, invalidate_prompt_version_caches
...
def archive_prompt(team: Team, prompt_name: str, *, user: User | None = None) -> list[int]:
    with transaction.atomic():
        ...
        def invalidate_caches_on_commit() -> None:
            ...
            try:
                from insights.tasks.llm_prompt_cache import invalidate_archived_prompt_versions_cache_task
