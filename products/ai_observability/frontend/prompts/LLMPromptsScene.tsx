    ...
    const columns: TableColumns<LLMPrompt> = [
        ...
        ...(labelsEnabled
            ? ([
              ...
              ] as TableColumns<LLMPrompt>)
            : []),
        atColumn('created_at', 'Latest version created') as TableColumn<LLMPrompt, keyof LLMPrompt | undefined>,
        {
            width: 0,
        ...
        <SceneContent>
            ...
            {shouldShowEmptyState ? (
                <ProductIntroduction
                    ...
                    thingName="prompt"
                    description="Create and version LLM prompts in Insights, then fetch them from your code at runtime — update prompts without deploying. Every change is an immutable version you can compare, restore, and A/B test."
                    docsURL="https://hanzo.ai/docs/prompt-management"
                    isEmpty
