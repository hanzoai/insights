...
from insights.caching.insight_caching_state import upsert
from insights.caching.test.test_insight_caching_state import create_insight, filter_dict
from insights.models import InsightCachingState, Team, User
...
@pytest.mark.django_db
@freeze_time("2020-01-04T13:01:01Z")
@patch("insights.caching.insight_cache.update_cache_task")
@patch("insights.caching.insight_cache.process_query_dict", side_effect=Exception())  # InsightsQL branch
