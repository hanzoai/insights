...
from insights.datastore.kafka_engine import CONSUMER_GROUP_AI_EVENTS, CONSUMER_GROUP_AI_EVENTS_WS, kafka_engine
from insights.datastore.table_engines import Distributed, MergeTreeEngine, ReplicationScheme
from insights.kafka_client.topics import KAFKA_DATASTORE_AI_EVENTS_JSON
...
def DISTRIBUTED_AI_EVENTS_TABLE_SQL():
    return AI_EVENTS_TABLE_BASE_SQL.format(
        ...
        engine=Distributed(
            ...
            cluster=settings.DATASTORE_AI_EVENTS_CLUSTER,
        ),
        indexes="",
    )
...
def KAFKA_AI_EVENTS_TABLE_SQL():
    return KAFKA_AI_EVENTS_TABLE_BASE_SQL.format(
        ...
        engine=kafka_engine(topic=KAFKA_DATASTORE_AI_EVENTS_JSON, group=CONSUMER_GROUP_AI_EVENTS),
    )
...
def KAFKA_AI_EVENTS_WS_TABLE_SQL():
    return KAFKA_AI_EVENTS_TABLE_BASE_SQL.format(
        ...
        engine=kafka_engine(
            topic=KAFKA_DATASTORE_AI_EVENTS_JSON,
