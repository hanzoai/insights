...
export const SCANNER_TYPE_TAG_TYPE: Record<ScannerType, TagType> = {
    monitor: 'primary',
...
const FAILURE_KINDS: Record<FailureKind, FailureKindInfo> = {
    ...
    rasterization_failed: {
        ...
        description:
            'Insights could not turn this recording into a video for the AI. Retry the scan, and contact support if it fails again.',
        retryWorthwhile: true,
    },
    validation_failed: {
    ...
    internal_error: {
        ...
        description: 'Something inside Insights stopped this scan. Retry it, and contact support if it fails again.',
        retryWorthwhile: true,
    },
    orphaned: {
        label: 'Interrupted',
        description: 'The scan was interrupted before it finished, and Insights cleaned it up. Retry the scan.',
        retryWorthwhile: true,
    },
}
...
// mascot_config's nullable index-signature type trips DeepPartial and ProfilePicture; the UI never reads it.
export type ScannerCreatedBy = Omit<UserBasicApi, 'mascot_config'>
