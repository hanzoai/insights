...
from insights.models.utils import RootTeamManager, RootTeamMixin, UUIDTModel
...
class DashboardTemplate(UUIDTModel, RootTeamMixin):
    ...
    class Meta:
        ...
        db_table = "insights_dashboardtemplate"
    ...
    def original_template() -> "DashboardTemplate":
        ...
        This OG template is not stored in https://github.com/Insights/templates-repository
            ...
            tiles=[
                {
                    ...
                    "body": (
                        ...
                        "feel familiar; the retention and funnel tiles are where you point Insights at your own "
