...
class Migration(migrations.Migration):
    dependencies = [
        ("insights", "0848_activitylog_detail_gin_index"),
    ]
    ...
    operations = [
        ...
        correct AS (
            ...
            FROM insights_externaldataschema eds
            JOIN insights_datawarehousetable dwt ON dwt.id = eds.table_id
            WHERE dwt.deleted = false
        ),
        to_delete AS (
            SELECT dwt.id
            FROM insights_datawarehousetable dwt
        ...
        UPDATE insights_datawarehousetable dwt
