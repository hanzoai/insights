...
from insights.models.utils import CreatedMetaFields, RootTeamMixin, UpdatedMetaFields, UUIDModel
...
class Reminder(RootTeamMixin, CreatedMetaFields, UpdatedMetaFields, UUIDModel):
    ...
    team = models.ForeignKey("insights.Team", on_delete=models.CASCADE, null=True, blank=True)
