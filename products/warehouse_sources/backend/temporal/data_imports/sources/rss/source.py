...
from products.warehouse_sources.backend.temporal.data_imports.sources.rss.settings import (
    ENDPOINTS,
    INCREMENTAL_FIELDS,
    RSS_ENDPOINTS,
)
...
class RssSource(ResumableSource[RssSourceConfig, RssResumeConfig]):
    ...
    default_version = "v4"
    api_docs_url = "https://api.rss.com/v4/docs"
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your RSS.com API key to pull your podcast and episode data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/rss",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
