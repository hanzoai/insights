...
class OkendoSource(ResumableSource[OkendoSourceConfig, OkendoResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Okendo user ID and API key to pull your Okendo reviews and loyalty data into the Insights Data warehouse.

You can find both in the integration settings section of the Okendo app.
""",
            iconPath="/static/services/okendo.png",
            docsUrl="https://hanzo.ai/docs/cdp/sources/okendo",
