...
from insights.tasks.alerts import utils as alert_utils
from insights.tasks.alerts.metrics_investigation import run_metrics_alert_investigation, should_investigate_metrics_alert
from insights.temporal.alerts.investigation import claim_investigation_slot
...
def run_alert_check(alert_id: str) -> None:
    ...
    # Outside the persistence transaction: the investigation issues Datastore
