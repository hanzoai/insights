...
import { IconFlask, IconList, IconLive, IconMessage, IconRewindPlay, IconWarning } from '@hanzo/icons'
...
export const DASHBOARD_WIDGET_GROUP_PRODUCT_INTRO = {
    error_tracking: {
        ...
        docsHref: 'https://hanzo.ai/docs/error-tracking',
    },
    session_replay: {
        ...
        docsHref: 'https://hanzo.ai/docs/session-replay',
    },
...
export const DASHBOARD_WIDGET_CATALOG = {
    error_tracking_list: {
        ...
        sharedPlaceholder: {
            title: 'Top issues',
            message: 'Log in to Insights to see which errors are affecting your users.',
        },
        tileFilters: {
    ...
    session_replay_list: {
        ...
        sharedPlaceholder: {
            ...
            message: 'Log in to Insights to watch session replays from this dashboard.',
        },
        availability: {
            requirement: 'session_replay_enabled',
    ...
    experiments_list: {
        ...
        sharedPlaceholder: {
            title: 'Experiments',
            message: 'Log in to Insights to see experiments from this dashboard.',
        },
    },
    experiment_results: {
        groupId: 'experiments',
        ...
        sharedPlaceholder: {
            ...
            message: 'Log in to Insights to see experiment results from this dashboard.',
        },
    },
    survey_results: {
        groupId: 'surveys',
        ...
        sharedPlaceholder: {
            ...
            message: 'Log in to Insights to see survey results from this dashboard.',
        },
    },
    activity_events_list: {
        ...
        sharedPlaceholder: {
            title: 'Recent events',
            message: 'Log in to Insights to explore the latest events from this dashboard.',
        },
    },
    logs_list: {
        groupId: 'logs',
        ...
        sharedPlaceholder: {
            title: 'Recent logs',
            message: 'Log in to Insights to see the latest logs from this dashboard.',
        },
    },
...
export const DEFAULT_SHARED_DASHBOARD_WIDGET_PLACEHOLDER = {
    title: 'Widget data',
    message: "Log in to Insights to see this widget's data.",
} as const
