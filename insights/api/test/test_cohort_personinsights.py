...
via the personinsights path."""

from insights.test.base import APIBaseTest, BaseTest

from rest_framework import status

from insights.models.person.util import validate_person_uuids_exist
...
class TestRemovePersonFromStaticCohort(APIBaseTest):
    def test_removes_person_and_routes_through_personinsights(self):
