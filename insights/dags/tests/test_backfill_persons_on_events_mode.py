...
from hanzo_insights.types import FeatureFlag, FlagMetadata

from insights.schema import PersonsOnEventsMode

from insights.dags.backfill_persons_on_events_mode import (
    POE_V1_FLAG,
    POE_V2_FLAG,
...
class TestBackfillPersonsOnEventsMode(BaseTest):
    ...
    def _resolver_returns(self, mode: PersonsOnEventsMode):
        return patch(
            "insights.dags.backfill_persons_on_events_mode._resolve_persons_on_events_mode",
            return_value=mode,
        )
