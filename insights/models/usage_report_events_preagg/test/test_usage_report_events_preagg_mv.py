...
Mirrors the test_kafka_insert pattern in ee/datastore/models/test/test_dead_letter_queue.py.
...
from insights.models.usage_report_events_preagg.sql import (
...
class TestUsageReportEventsPreaggMV(DatastoreTestMixin, BaseTest):
    def setUp(self) -> None:
