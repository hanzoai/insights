...
export interface resourceTransferLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface resourceTransferLogicActions {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface resourceTransferLogicMeta {
    key: string
...
export type resourceTransferLogicType = MakeLogicType<
    resourceTransferLogicValues,
    resourceTransferLogicActions,
    ResourceTransferLogicProps,
    resourceTransferLogicMeta
>
