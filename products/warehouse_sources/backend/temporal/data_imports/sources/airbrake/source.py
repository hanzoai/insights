...
class AirbrakeSource(ResumableSource[AirbrakeSourceConfig, AirbrakeResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Airbrake user API key to pull your Airbrake error monitoring data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/airbrake",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
