...
from insights.cdp.templates.kudosity.template_kudosity import template as template_kudosity


class TestTemplateKudosity(BaseInsightsFunctionTemplateTest):
