 ...
 *
 * Insights API - MCP 8 enabled ops
...
/**
 * Replay an API request against the connected Insights project. The server injects the connection's token; the response is passed through.
 * @summary Forward a request through a Insights connection
 */
export const InsightsConnectionsForwardCreateParams = /* @__PURE__ */ zod.object({
    id: zod.string(),
    project_id: zod
        .string()
        .describe(
...
export const InsightsConnectionsForwardCreateBody = /* @__PURE__ */ zod.object({
    method: zod
