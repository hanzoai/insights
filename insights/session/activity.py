...
from insights.utils import _is_valid_ip_address, get_ip_address, get_short_user_agent
...
def sync_current_session_metadata(request: HttpRequest, force: bool = False) -> None:
    ...
    # requests so a suspicious request can't overwrite the known-good reference (insights/session/risk.py).
