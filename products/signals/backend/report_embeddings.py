...
from insights.schema_enums import EmbeddingModelName
...
def _emit(*, team_id: int, report_id: str, content: str, created_at: datetime, deleted: bool) -> None:
    ...
    # from SignalsConfig.ready(), and this module's only heavy dependency is the Kafka/HTTP/Datastore
    # chain behind emit_embedding_request, which only matters once a report is actually embedded.
    from insights.api.embedding_worker import emit_embedding_request  # noqa: PLC0415
