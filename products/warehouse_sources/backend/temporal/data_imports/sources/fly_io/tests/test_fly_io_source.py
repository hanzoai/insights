...
class TestSourceConfig:
    ...
    def test_config_metadata(self) -> None:
        ...
        # docsUrl filename must match the hanzo.ai doc (fly-io).
        assert config.docsUrl == "https://hanzo.ai/docs/cdp/sources/fly-io"
...
class TestCanonicalDescriptionsAndDocs:
    ...
    def test_documented_tables_render_without_credentials(self) -> None:
        # lists_tables_without_credentials=True is what makes the hanzo.ai Supported tables section
