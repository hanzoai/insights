...
class TestInsightsFunctionTemplate(TestCase):
    ...
    def test_get_template_by_id_and_sha(self):
        ...
        template = InsightsFunctionTemplate.objects.create(
        ...
        retrieved_template = InsightsFunctionTemplate.get_template("test-template", template.sha)
        ...
        latest_template = InsightsFunctionTemplate.get_template("test-template")
        assert latest_template
        self.assertEqual(latest_template.template_id, template.template_id)

        # Test getting a non-existent template
        nonexistent_template = InsightsFunctionTemplate.get_template("non-existent-template")
    ...
    def test_update_existing_template(self):
        ...
        original_dto = InsightsFunctionTemplateDC(
            id="update-test",
        ...
        updated_dto = InsightsFunctionTemplateDC(
        ...
        templates = InsightsFunctionTemplate.objects.filter(template_id="update-test")
