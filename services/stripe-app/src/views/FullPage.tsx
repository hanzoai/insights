...
import { DevTokenEntry } from '../components/InsightsConnect'
...
type ConnectionState =
    | { status: 'loading' }
    | { status: 'disconnected' }
    | { status: 'connected'; client: InsightsClient; projectId: string | null }

const DISCONNECTED_DESCRIPTION =
    'Insights gives you product analytics, session replays, experiments, and feature flags for your Stripe customers. ' +
    'To get started, connect this Stripe account from your Insights dashboard.'
