...
class TestQuery(ClickhouseTestMixin, APIBaseTest):
    ...
    @patch("insights.insightsql.constants.DEFAULT_RETURNED_ROWS", 10)
    @patch("insights.insightsql.constants.MAX_SELECT_RETURNED_ROWS", 15)
    ...
    @patch("insights.insightsql.constants.DEFAULT_RETURNED_ROWS", 10)
    @patch("insights.insightsql.constants.CSV_EXPORT_LIMIT", 15)
...
class TestQueryRetrieve(APIBaseTest):
    def setUp(self):
        ...
        self.redis_get_patch = mock.patch("insights.redis.get_client", return_value=self.redis_client_mock)
