...
export class SessionMetadataStore {
    ...
    public async storeSessionBlocks(blocks: SessionBlockMetadata[]): Promise<void> {
        ...
        const events = blocks.map((metadata) => ({
            ...
            first_timestamp: castTimestampOrNow(metadata.startDateTime, TimestampFormat.Datastore),
            last_timestamp: castTimestampOrNow(metadata.endDateTime, TimestampFormat.Datastore),
