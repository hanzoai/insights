# CDP Insights Function Templates

Insights function templates are the main way that people will get started with the CDP V2. Templates are ephemeral configurations of InsightsFunctions. They are purposefully ephemeral for a few reasons:
