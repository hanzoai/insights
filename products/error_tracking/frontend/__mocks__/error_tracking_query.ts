...
const eventProperties = JSON.stringify({
        ...
        values: [
            {
                ...
                stacktrace: {
                    frames: [
                        {
                            filename: 'https://app-static-prod.hanzo.ai/static/chunk-WH2L43MJ.js',
                            function: 'i.onerror',
                            in_app: true,
                            lineno: 18,
                            colno: 76906,
    ...
    $level: 'error',
    $sentry_url: 'https://sentry.io/organizations/insights/issues/?project=project_id&query=issue_id',
    ...
    $sentry_exception__values__0__stacktrace__frames__0__filename:
        'https://app-static-prod.hanzo.ai/static/chunk-WH2L43MJ.js',
