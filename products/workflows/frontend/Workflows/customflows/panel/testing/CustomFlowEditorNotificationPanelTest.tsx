...
import { CustomFunctionTestEditor } from 'scenes/custom-functions/configuration/CustomFunctionTest'
import { LogsViewerTable } from 'scenes/custom-functions/logs/LogsViewer'
...
import { customFlowEditorNotificationTestLogic } from './customFlowEditorNotificationTestLogic'
import { reorderGlobalsForEmailAction } from './customFlowEditorNotificationTestLogic'

export function EmailActionTestContent(): JSX.Element | null {
    const { workflow, selectedNode } = useValues(customFlowEditorLogic)
    const { setSelectedNodeId } = useActions(customFlowEditorLogic)
    ...
    } = useValues(customFlowEditorNotificationTestLogic(logicProps))
    const {
        ...
        setSampleGlobals,
    } = useActions(customFlowEditorNotificationTestLogic(logicProps))
    ...
    return (
        <Form
            logic={customFlowEditorNotificationTestLogic}
            props={logicProps}
