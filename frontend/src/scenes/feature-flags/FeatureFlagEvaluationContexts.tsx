...
import { IconCheck, IconInfo, IconPencil, IconPlus, IconX } from '@hanzo/icons'
            ...
            <div className="flex flex-col gap-1">
                ...
                {isEditingTags ? (
                    ...
                    <div className="inline-flex flex-wrap gap-1 items-center">
                        {tags.length > 0 ? (
                            tags.map((tag) => (
                                <Tag key={tag} type={colorForString(tag)}>
                                    {tag}
                                </Tag>
                            ))
                        ) : (
            ...
            <div className="flex flex-col gap-1">
                <span className="text-sm font-medium inline-flex items-center gap-1">
                    ...
                    {(context === 'form' || isEditingContexts) && (
                        <Tooltip
                            docLink="https://hanzo.ai/docs/feature-flags/evaluation-contexts"
