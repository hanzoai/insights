...
import { OriginProduct, Task, TaskRunStatus } from 'products/insights_ai/frontend/types/taskTypes'
    ...
    listeners(({ actions, values, cache }) => ({
        ...
        runSessionAnalysis: async () => {
            try {
                ...
                toast.error(error?.detail || error?.message || 'Failed to run session analysis')
