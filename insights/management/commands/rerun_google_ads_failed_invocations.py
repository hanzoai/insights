...
enqueues one wrapper job per script function and reports which teams they
were enqueued for.
"""
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--dry-run",
            action="store_true",
            help="List which script functions would be rerun without triggering the reruns.",
        )
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        qs = InsightsFunction.objects.filter(
