...
export interface batchExportSceneLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface batchExportSceneLogicActions {
    setCurrentTab: (tab: BatchExportSceneTab) => {
        tab: 'backfills' | 'configuration' | 'history' | 'logs' | 'metrics' | 'runs'
    }
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface batchExportSceneLogicMeta {
    key: string
...
export type batchExportSceneLogicType = MakeLogicType<
    batchExportSceneLogicValues,
    batchExportSceneLogicActions,
    BatchExportConfigFormLogicProps,
    batchExportSceneLogicMeta
>
