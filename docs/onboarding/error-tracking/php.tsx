    ...
    const automaticCaptureStep: StepDefinition = {
        ...
        content: (
            <>
                <Markdown>
                    {dedent`
                        Enable PHP error tracking when initializing Insights to capture exceptions, PHP errors, and fatal shutdown errors.
                    `}
                </Markdown>
                <CodeBlock
                    blocks={[
                        {
                            ...
                            file: 'PHP',
                            code: dedent`
                                Insights\\Insights::init('<ph_project_token>', [
                    ...
                    blocks={[
                        {
                            ...
                            code: dedent`
                                try {
                                    ...
                                    Insights\\Insights::captureException($exception, 'user_distinct_id', [
