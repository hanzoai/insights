...
class TestOrganizationFeatureFlagGet(APIBaseTest, QueryMatchingTest):
    def setUp(self):
        ...
        self.team_1.api_token = "pk-test_token_1"
        self.team_1.save()
        self.team_2.api_token = "pk-test_token_2"
        self.team_2.save()
        self.team_3.api_token = "pk-test_token_3"
        self.team_3.save()
    ...
    def test_get_feature_flag_redacts_encrypted_payloads(self):
        ...
        url = f"/v1/organizations/{self.organization.id}/feature_flags/encrypted-key"
        response = self.client.get(url)
...
class TestOrganizationFeatureFlagKeys(APIBaseTest):
    ...
    def _keys_url(self, **params: Any) -> str:
        url = f"/v1/organizations/{self.organization.id}/feature_flags/keys/"
    ...
    def test_keys_excludes_flags_denied_by_object_level_access_control(self):
        ...
        other_user = self._create_user("other-keys@hanzo.ai")
        self.client.force_login(other_user)
...
class TestOrganizationFeatureFlagCopy(APIBaseTest, QueryMatchingTest):
    def setUp(self):
        ...
        # Set deterministic API tokens to ensure stable query snapshots
        self.team_1.api_token = "pk-test_copy_token_1"
        self.team_1.save()
        self.team_2.api_token = "pk-test_copy_token_2"
        self.team_2.save()
    ...
    def test_copy_feature_flag_with_dependencies_query_count(self):
        ...
        def dependency_target_flag_lookup(query: str) -> bool:
            return (
                'FROM "insights_featureflag"' in query
                and '"insights_featureflag"."key" IN' in query
        ...
        target_team_refetches = [
            ...
            if 'FROM "insights_team"' in query["sql"] and f'"insights_team"."id" IN ({self.team_2.id})' in query["sql"]
        ]
    ...
    def test_copy_feature_flag_update_override_deleted(self):
        ...
        target_project_2.api_token = "pk-test_copy_token_3"
    ...
    def test_copy_feature_flag_to_target_without_feature_flag_create_access_fails(self):
        ...
        self._enable_access_control()
        copying_user = self._create_user("copy-target-create-denied@hanzo.ai")
    ...
    def test_copy_feature_flag_with_dependencies_succeeds_for_allowed_target_when_another_target_is_denied(self):
        ...
        self._enable_access_control()
        copying_user = self._create_user("copy-mixed-target-create-access@hanzo.ai")
    ...
    def test_copy_feature_flag_does_not_update_object_denied_target_flag(self):
        ...
        self._enable_access_control()
        copying_user = self._create_user("copy-target-object-denied@hanzo.ai")
    ...
    def _copy_flags_url(self) -> str:
        return f"/v1/organizations/{self.organization.id}/feature_flags/copy_flags"
    ...
    def test_copy_feature_flag_source_project_denied_returns_not_found(self, _name, endpoint):
        ...
        self._enable_access_control()
        copying_user = self._create_user("copy-source-project-denied@hanzo.ai")
        AccessControl.objects.create(
            team=self.team_1,
            resource="project",
    ...
    def test_copy_feature_flag_source_object_denied_returns_forbidden(self, _name, endpoint):
        ...
        self._enable_access_control()
        copying_user = self._create_user("copy-source-object-denied@hanzo.ai")
        AccessControl.objects.create(
            team=self.team_1,
            resource="feature_flag",
    ...
    def test_copy_encrypted_payloads_flag_to_multiple_projects(self):
        ...
        team_3 = Team.objects.create(organization=self.organization)
        team_3.api_token = "pk-test_copy_token_3"
        team_3.save()
    ...
    def test_copy_feature_flag_with_dependencies_ignores_restricted_transitive_dependency_under_reused_target(self):
        ...
        self._enable_access_control()
        copying_user = self._create_user("copy-reused-branch-restricted-child@hanzo.ai")
        flag_c = FeatureFlag.objects.create(
            team=self.team_1,
            created_by=self.user,
            key="flag-c",
    ...
    def test_copy_feature_flag_with_dependencies_does_not_reuse_restricted_target_dependency(self):
        ...
        self.organization.save()
        copying_user = self._create_user("copy-restricted-target-dependencies@hanzo.ai")
    ...
    def test_copy_feature_flag_with_dependency_denied_returns_forbidden(self):
        ...
        self.organization.save()
        copying_user = self._create_user("copy-dependencies@hanzo.ai")
    ...
    @patch("insights.rate_limit.CopyFlagsBurstRateThrottle.rate", new="1/minute")
    ...
    def test_copy_feature_flag_overwrite_denied_by_object_level_access_control_fails(self):
        ...
        other_user = self._create_user("other-copy@hanzo.ai")
        existing_flag = FeatureFlag.objects.create(
            team=self.team_2,
...
class TestOrganizationFeatureFlagCopyPersonalAPIKey(APIBaseTest):
    ...
    def setUp(self):
        ...
        self.url = f"/v1/organizations/{self.organization.id}/feature_flags/copy_flags"
        self.body = {
            "feature_flag_key": self.feature_flag_to_copy.key,
            "from_project": self.team_1.id,
            "target_project_ids": [self.team_2.id],
    ...
    @parameterized.expand(
        [
            ...
            # action declares explicit `required_scopes`. See insights/permissions.py:498-499.
            ...
            # insights/permissions.py:541-552 still gates this behind explicit team membership.
...
class TestOrganizationFeatureFlagCopySchedules(APIBaseTest):
    def setUp(self):
        ...
        self.team_1.api_token = "pk-test_schedule_token_1"
        self.team_1.save()
        self.team_2.api_token = "pk-test_schedule_token_2"
        self.team_2.save()
    ...
    def _post_copy_flag(self, **overrides: Any) -> Any:
        ...
        data.update(overrides)
        return self.client.post(f"/v1/organizations/{self.organization.id}/feature_flags/copy_flags", data)
    ...
    def test_copy_flag_schedule_dependency_denied_does_not_disclose_key(self):
        ...
        self.organization.save()
        copying_user = self._create_user("copy-schedule-dependencies@hanzo.ai")
    ...
    def test_copy_flag_to_multiple_projects_with_schedules(self):
        ...
        team_3 = Team.objects.create(organization=self.organization)
        team_3.api_token = "pk-test_schedule_token_3"
        team_3.save()
...
class TestOrganizationFeatureFlagEvaluations(DatastoreTestMixin, APIBaseTest):
    def setUp(self):
        super().setUp()
        cache.clear()
    ...
    def _url(self, key: str) -> str:
        return f"/v1/organizations/{self.organization.id}/feature_flags/{key}/"
    ...
    def test_datastore_failure_returns_null_evaluations(self):
        with patch(
