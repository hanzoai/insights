...
export function PullRequestTable({
    ...
    const columns: TableColumns<PullRequestRow> = [
        {
            title: 'Pull request',
            key: 'title',
            render: (_, row) => (
            ...
            ? ([
                  {
                      ...
                      render: (_, row) => (
                          <div className="flex items-center gap-1.5">
                              ...
                              {row.isBot && <Tag type="muted">bot</Tag>}
                          </div>
                      ),
                  },
              ] as TableColumns<PullRequestRow>)
            : []),
        {
            title: 'CI',
            key: 'ci',
            ...
            render: (_, row) => (
                <div className="flex items-center justify-end gap-2">
                    ...
                    <span className="text-xs tabular-nums whitespace-nowrap">
                        ...
                        {row.rerunCycles > 0 && (
                            <Tag type="warning" className="ml-1.5">
                                +{row.rerunCycles}
                            </Tag>
                        )}
                    </span>
