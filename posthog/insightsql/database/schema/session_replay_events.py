...
from posthog.insightsql.ast import JoinExpr, SelectQuery
...
from posthog.insightsql.database.schema.log_entries import ReplayConsoleLogsLogEntriesTable
from posthog.insightsql.database.schema.person_distinct_ids import (
    PersonDistinctIdsTable,
    join_with_person_distinct_ids_table,
)
from posthog.insightsql.database.schema.sessions_v1 import SessionsTableV1, select_from_sessions_table_v1
...
from posthog.insightsql.database.schema.sessions_v3 import select_from_sessions_table_v3, session_id_to_uint128_as_uuid_expr
...
SESSION_REPLAY_EVENTS_COMMON_FIELDS: dict[str, FieldOrTable] = {
    ...
    # this is so that InsightsQL properties e.g. on test account filters can find the correct column
