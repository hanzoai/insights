...
class ScalewaySource(ResumableSource[ScalewaySourceConfig, ScalewayResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Scaleway API secret key and Organization ID to pull your Scaleway data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/scaleway",
