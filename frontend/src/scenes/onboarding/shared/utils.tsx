...
export const availableOnboardingProducts: AvailableOnboardingProducts = {
    ...
    [ProductKey.DATA_WAREHOUSE]: {
        ...
        valueProps: [
            { title: 'External data joins', problem: 'Combine Stripe, Hubspot, or Postgres data with Insights' },
            { title: 'SQL queries', problem: 'Ask questions no pre-built dashboard can answer' },
        ],
        mascot: MascotConstruction,
        icon: 'IconDatabase',
    ...
    [ProductKey.CONVERSATIONS]: {
        ...
        userCentricDescription: 'Triage, assign, and automate customer support in Insights',
