...
# Each rule carries a stable failure-class key (matching `insightscli ci:preflight` check
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--repo", default=os.environ.get("GITHUB_REPOSITORY", "Insights/insights"))
...
def main(argv: list[str]) -> int:
    ...
    capture_events(args.insights_api_key, args.insights_host, events, args.insights_timeout_seconds)
    return 0
