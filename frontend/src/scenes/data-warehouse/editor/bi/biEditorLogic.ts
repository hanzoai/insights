...
export const biEditorLogic = kea<biEditorLogicType>([
    ...
    connect((logicProps: BIEditorLogicProps) => ({
        values: [
            ...
            ['allTables', 'insightsTables', 'connectionId as databaseConnectionId', 'databaseLoading'],
        ],
    ...
    selectors({
        availableDataSources: [
            (selectors) => [selectors.allTables, selectors.insightsTables, selectors.databaseConnectionId],
            (
                allTables: DatabaseSchemaTable[],
                insightsTables: DatabaseSchemaTable[],
                databaseConnectionId: string | null
