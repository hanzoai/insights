...
class NeonSource(PostgresSource):
    ...
    def get_source_config(self) -> SourceConfig:
        ...
        return SourceConfig(
            ...
            caption="Enter your Neon credentials to automatically pull your data into the Insights Data warehouse",
            docsUrl="https://hanzo.ai/docs/cdp/sources/neon",
            fields=fields,
