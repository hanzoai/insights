...
from insights.insightsql_queries.legacy_compatibility.clean_properties import clean_entity_properties, clean_global_properties
from insights.models.entity.entity import Entity as LegacyEntity
    ...
    if _insight_type(filter) == "TRENDS":
        ...
        insight_filter = {
            "funnelsFilter": FunnelsFilter(
                ...
                funnelAggregateByInsightsQL=filter.get("funnel_aggregate_by_insightsql"),
            ),
        }
        ...
        insight_filter = {
            "pathsFilter": PathsFilter(
                pathsInsightsQLExpression=filter.get("paths_insightsql_expression"),
