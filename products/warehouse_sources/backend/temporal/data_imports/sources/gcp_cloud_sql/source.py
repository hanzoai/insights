...
from products.warehouse_sources.backend.temporal.data_imports.sources.generated_configs.gcpcloudsql import (
    GcpCloudSqlSourceConfig,
)
...
class GcpCloudSqlSource(SimpleSource[GcpCloudSqlSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            name=SchemaExternalDataSourceType.GCP_CLOUD_SQL,
