import { Banner, Button, Modal, Snack, Tag } from '@hanzo/elements'
...
export function CreateFromLegacyModal({
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title="Create trigger groups from legacy settings">
            <div className="space-y-4">
                                    ...
                                    {group.conditions.events && group.conditions.events.length > 0 && (
                                        <div className="flex items-center gap-2 flex-wrap">
                                            ...
                                            {group.conditions.events.map((event) => {
                                                ...
                                                return <Snack key={name}>{name}</Snack>
                                            })}
                ...
                <div className="flex justify-end gap-2 pt-2 border-t">
                    <Button type="secondary" onClick={onClose} disabled={isCreating}>
                        Cancel
                    </Button>
                    <Button
                        type="primary"
