---
name: review-script-validation-criteria
description: >
  The validation criteria for Review — the bar for deciding whether a flagged PR issue is worth
...
- **Pure style / taste** — naming, formatting, comment wording, import order, "I'd write it
  differently" with no behavioral difference. (Formatting is not a Review concern.)
