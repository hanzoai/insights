...
class PostmarkSource(
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Postmark **Server API token** to pull your Postmark data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/postmark",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
...
3. Add a custom HTTP header named `x-insights-webhook-secret` with a value of your choosing, and paste the same value into the webhook secret field below
