...
class LeadfeederSource(ResumableSource[LeadfeederSourceConfig, LeadfeederResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            keywords=["dealfront"],
            caption="""Enter your Leadfeeder (Dealfront) API token to pull your website visitor and lead data into the Insights Data warehouse.
...
Optionally set a **Start date** to bound the initial sync — leave it blank to pull the last year of leads and visits.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/leadfeeder",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
