...
export const SOURCE_MAPS_DOCS_URL = 'https://hanzo.ai/docs/error-tracking/upload-source-maps'
...
export const sourceMapsFixWizardLogic = kea<sourceMapsFixWizardLogicType>([
    ...
    selectors({
        wizardCommand: [() => [], (): string => 'npx -y @hanzo/wizard@latest upload-source-maps'],
    }),

    listeners(({ actions, values, cache }) => ({
        openModal: ({ source }) => {
            insights.capture('error_tracking_source_maps_wizard_opened', { source })
