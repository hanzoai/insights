...
from insights.insightsql.base import ConstantType, UnknownType
...
class InsightsQLFunctionMeta:
    ...
    """Not all Datastore functions are case-insensitive. See https://datastore.com/docs/en/sql-reference/syntax#keywords."""
