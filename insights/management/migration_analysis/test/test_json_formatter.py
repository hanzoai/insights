...
from insights.management.migration_analysis.formatters import JsonFormatter
from insights.management.migration_analysis.models import MigrationRisk, OperationRisk
...
class TestJsonFormatter:
    ...
    def test_single_migration_full_shape(self):
        ...
        assert report == {
            ...
            "max_level": "Safe",
            "migrations": [{"label": "insights.1125_x", "level": "Safe", "file_path": "insights/migrations/1125_x.py"}],
        }
    ...
    def test_missing_file_path_emits_null(self):
        ...
        report = json.loads(self.formatter.format_report([_risk("insights", "1125_x", score=1)]))

        assert report["migrations"] == [{"label": "insights.1125_x", "level": "Safe", "file_path": None}]
