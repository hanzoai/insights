...
class Annotation(ModelActivityMixin, models.Model):
    ...
    dashboard_item = models.ForeignKey("insights.Insight", on_delete=models.SET_NULL, null=True, blank=True)
    dashboard = models.ForeignKey("insights.Dashboard", on_delete=models.SET_NULL, null=True, blank=True)
    team = models.ForeignKey("insights.Team", on_delete=models.CASCADE)
    organization = models.ForeignKey("insights.Organization", on_delete=models.CASCADE, null=True)
