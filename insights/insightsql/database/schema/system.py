...
from insights.insightsql.database.lazy_join_tags import TICKET_ASSIGNMENT, TICKET_TAGS
...
from insights.insightsql.database.schema.information_schema import information_schema_node
...
class IngestionWarningsTable(Table):
    description: str = (
        ...
        "one row per warning. Backed by Datastore, not Postgres."
    )
...
batch_export_backfills: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_batchexportbackfill",
...
batch_exports: PostgresTable = PostgresTable(
    name="batch_exports",
    postgres_table_name="insights_batchexport",
    access_scope="batch_export",
...
alerts: PostgresTable = PostgresTable(
    name="alerts",
    postgres_table_name="insights_alertconfiguration",
    access_scope="alert",
...
cohorts: PostgresTable = PostgresTable(
    ...
    fields={
        ...
        "query": StringJSONDatabaseField(
            name="query", description="JSON InsightsQL query backing the cohort, if defined as a query."
        ),
...
dashboard_tiles: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_dashboardtile",
    access_scope="dashboard",
...
insights: PostgresTable = PostgresTable(
    ...
    fields={
        ...
        "query": StringJSONDatabaseField(
            name="query", description="JSON query (InsightsQL query schema) defining the insight."
        ),
...
data_modeling_views: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_datawarehousesavedquery",
    ...
    fields={
        ...
        "query": StringJSONDatabaseField(name="query", description="JSON InsightsQL query defining the view."),
...
source_schemas: PostgresTable = PostgresTable(
    name="source_schemas",
    postgres_table_name="insights_externaldataschema",
    access_scope="external_data_source",
...
source_sync_jobs: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_externaldatajob",
    access_scope="external_data_source",
...
endpoint_versions: PostgresTable = PostgresTable(
    ...
    description="Versioned query definitions for data-modeling endpoints (saved, callable InsightsQL queries); one row per endpoint version.",
    fields={
        ...
        "query": StringJSONDatabaseField(name="query", description="JSON InsightsQL query executed by this version."),
...
integrations: PostgresTable = PostgresTable(
    name="integrations",
    postgres_table_name="insights_integration",
...
integration_repository_cache: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_integrationrepositorycacheentry",
    access_scope="integration",
...
session_recording_playlists: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_sessionrecordingplaylist",
...
session_recordings: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_sessionrecording",
...
teams: PostgresTable = PostgresTable(
    ...
    description="Projects/teams (a Insights 'team' is a project); typically just the caller's own team.",
    fields={
...
# The project's virtual file tree (insights_filesystem). Channels are folders and
...
file_system: PostgresTable = PostgresTable(
    name="file_system",
    postgres_table_name="insights_filesystem",
...
activity_logs: PostgresTable = PostgresTable(
    name="activity_logs",
    postgres_table_name="insights_activitylog",
...
annotations: PostgresTable = PostgresTable(
    name="annotations",
    postgres_table_name="insights_annotation",
...
data_modeling_jobs: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_datamodelingjob",
...
error_tracking_issue_assignments: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_errortrackingissueassignment",
    access_scope="error_tracking",
...
error_tracking_issue_fingerprints: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_errortrackingissuefingerprintv2",
    access_scope="error_tracking",
...
error_tracking_assignment_rules: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_errortrackingassignmentrule",
    access_scope="error_tracking",
    ...
    fields={
        ...
        "bytecode": StringJSONDatabaseField(name="bytecode", description="Compiled Script bytecode for the filters."),
...
error_tracking_bypass_rules: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_errortrackingbypassrule",
    access_scope="error_tracking",
    ...
    fields={
        ...
        "bytecode": StringJSONDatabaseField(
            name="bytecode", nullable=True, description="Compiled Script bytecode for the filters."
        ),
        "disabled_data": StringJSONDatabaseField(
            name="disabled_data", nullable=True, description="JSON state when the rule is disabled; NULL when active."
        ),
...
error_tracking_suppression_rules: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_errortrackingsuppressionrule",
    access_scope="error_tracking",
...
error_tracking_releases: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_errortrackingrelease",
    access_scope="error_tracking",
...
error_tracking_symbol_sets: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_errortrackingsymbolset",
    access_scope="error_tracking",
...
class _TicketScopedPostgresTable(PostgresTable, DANGEROUS_NoTeamIdCheckTable):
    ...
    the same predicate also prunes non-ticket `insights_taggeditem` rows (tags on insights,
...
ticket_tagged_items: _TicketScopedPostgresTable = _TicketScopedPostgresTable(
    ...
    postgres_table_name="insights_taggeditem",
    description="Internal junction table (PostgreSQL `insights_taggeditem`) of tag-to-ticket links; not for direct querying — use `system.support_tickets.tags`.",
    fields={
...
class _TicketTagsTable(LazyTable):
    ...
    def lazy_select(
        self, table_to_add: LazyTableToAdd, context: InsightsQLContext, node: ast.SelectQuery
...
def ticket_tags_join(join_to_add: LazyJoinToAdd, context: InsightsQLContext, node: ast.SelectQuery) -> ast.JoinExpr:
...
ticket_assignments: _TicketScopedPostgresTable = _TicketScopedPostgresTable(
    ...
    postgres_table_name="insights_conversations_ticket_assignment",
    description="Internal junction table (PostgreSQL `insights_conversations_ticket_assignment`) of the current assignee per ticket; not for direct querying — use `system.support_tickets.assignee`.",
    fields={
...
support_tickets: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_conversations_ticket",
    access_scope="ticket",
...
early_access_features: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_earlyaccessfeature",
...
usage_metrics: PostgresTable = PostgresTable(
    name="usage_metrics",
    postgres_table_name="insights_groupusagemetric",
...
tasks: PostgresTable = PostgresTable(
    name="tasks",
    postgres_table_name="insights_task",
    access_scope="task",
    # Mirror the REST API's default filter: internal tasks (signals pipeline, etc.) are not
    # exposed to end users. They are excluded entirely from InsightsQL.
    predicates=[parse_expr("internal != true")],
    description="Tasks (Insights Desktop / agent work items); one row per user-facing task (internal pipeline tasks are excluded).",
    fields={
...
task_runs: PostgresTable = PostgresTable(
    name="task_runs",
    postgres_table_name="insights_task_run",
    access_scope="task",
...
sandbox_environments: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_sandbox_environment",
    access_scope="task",
...
business_knowledge_sources: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_business_knowledge_knowledgesource",
...
business_knowledge_documents: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_business_knowledge_knowledgedocument",
    access_scope="business_knowledge",
...
business_knowledge_chunks: PostgresTable = PostgresTable(
    ...
    postgres_table_name="insights_business_knowledge_knowledgechunk",
    access_scope="business_knowledge",
...
canvases: PostgresTable = PostgresTable(
    name="canvases",
    postgres_table_name="insights_canvas",
    access_scope="canvas",
...
tags: PostgresTable = PostgresTable(
    name="tags",
    postgres_table_name="insights_tag",
