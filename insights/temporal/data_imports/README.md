...
More info on what partitioning options and the different modes can be found here: https://github.com/hanzoai/insights/blob/main/insights/temporal/data_imports/sources/README.md#partitioning
