...
const runningExperiment: ExperimentData = {
    ...
    _insightsUrl: 'https://us.hanzo.ai/project/1/experiments/1',
}
...
const completedExperiment: ExperimentData = {
    ...
    _insightsUrl: 'https://us.hanzo.ai/project/1/experiments/2',
}
...
const sampleListData: ExperimentListData = {
    ...
    _insightsUrl: 'https://us.hanzo.ai/project/1/experiments',
}
