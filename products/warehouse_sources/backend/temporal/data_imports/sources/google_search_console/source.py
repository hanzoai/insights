...
_LOAD_CONNECTION_ERROR = (
    "Insights couldn't load your Google Search Console connection. Please reconnect your Google account and try again."
)
_LIST_SITES_ERROR = (
    "Insights couldn't reach Google Search Console to list your properties. Please try again in a few minutes."
)
...
class GoogleSearchConsoleSource(
    ...
    def get_non_retryable_errors(self) -> dict[str, str | None]:
        return {
            ...
            "403 Client Error": "Insights is not authorized to read this Search Console property. Please make sure the connected Google account has access to the property.",
    ...
    def validate_credentials(
        ...
        try:
            ...
            return (
                False,
                "Insights could not authenticate with Google Search Console. Your connection may have "
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/google-search-console",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldOauthConfig(
