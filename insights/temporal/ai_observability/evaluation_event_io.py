...
def extract_event_io(event_type: str, properties: dict[str, Any]) -> tuple[Any, Any]:
    ...
    Returns (input_raw, output_raw) for use in Script eval globals and preview display.
    ...
    LLM judge / Script eval would silently grade an empty conversation — hence the invariant.
    """
