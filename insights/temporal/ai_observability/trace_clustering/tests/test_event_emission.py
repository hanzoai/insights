...
from insights.temporal.ai_observability.trace_clustering.event_emission import _build_cluster_data, emit_cluster_events
...
class TestEmitClusterEvents:
    @patch("insights.temporal.ai_observability.trace_clustering.event_emission.create_event")
    @patch("insights.temporal.ai_observability.trace_clustering.event_emission.fetch_item_summaries")
