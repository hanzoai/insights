...
# webhook. `create_webhook` attaches a generated secret in the x-insights-webhook-secret header,
    ...
    inputs_schema=[
        {
            ...
            "secret": True,
            "hidden": False,
            "description": "Shared secret sent by Postmark in the x-insights-webhook-secret header, used to verify the delivery came from your webhook",
        },
        {
            "type": "json",
            "key": "schema_mapping",
