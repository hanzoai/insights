...
function ImpersonationExpiredOverlay({ expiredSessionInfo }: { expiredSessionInfo: ExpiredSessionInfo }): JSX.Element {
    ...
    const { reImpersonate, returnToInsights } = useActions(impersonationNoticeLogic)
            ...
            cancelButton={{
                ...
                sideAction: {
                    dropdown: {
                        placement: 'top-end',
                        overlay: (
                            <Button fullWidth onClick={() => returnToInsights()}>
                                Return to Insights
                            </Button>
                        ),
                    },
                ...
                <Button
                    ...
                    sideAction={{
                        dropdown: {
                            placement: 'top-end',
                            overlay: (
                                <Button fullWidth size="small" onClick={() => returnToInsights()}>
                                    Log out to Insights
                                </Button>
                            ),
                        },
