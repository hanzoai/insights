...
WEBHOOK_SETUP_CAPTION = (
    "Insights registers a webhook on your store for each of the product, order, coupon and customer "
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption=(
                ...
                "into the Insights Data warehouse. Create keys under **WooCommerce → Settings → Advanced → "
                "REST API** with at least **Read** permission."
            ),
            iconPath="/static/services/woocommerce.png",
            docsUrl="https://hanzo.ai/docs/cdp/sources/woocommerce",
            ...
            webhookFields=cast(
                ...
                [
                    SourceFieldInputConfig(
                        ...
                        placeholder="",
                        caption=(
                            "The secret set on your WooCommerce webhooks. Insights fills this in "
