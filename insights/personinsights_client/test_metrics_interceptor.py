...
from insights.personinsights_client.interceptor import MetricsInterceptor, _MutableClientCallDetails
...
class TestMetricsInterceptorErrorTracking:
    @patch("insights.personinsights_client.interceptor.PERSONFN_ERRORS_TOTAL")
