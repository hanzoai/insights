...
from insights.models.property import Property, PropertyIdentifier
from insights.models.property.property import OperatorType
...
def format_action_filter(
    ...
    for index, step in enumerate(steps):
        ...
        if step.event == AUTOCAPTURE_EVENT:
            from insights.models.property.util import filter_element  # prevent circular import
        ...
        event_conditions, event_params = filter_event(
            ...
            index,
            table_name,
            use_new_events_schema=insightsql_context.uses_new_events_schema(),
        )
...
def get_action_tables_and_properties(action: Action) -> TCounter[PropertyIdentifier]:
    from insights.models.property.util import extract_tables_and_properties
