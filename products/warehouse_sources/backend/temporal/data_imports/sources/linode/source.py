...
class LinodeSource(ResumableSource[LinodeSourceConfig, LinodeResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Linode (Akamai Connected Cloud) personal access token to pull your account data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/linode",
