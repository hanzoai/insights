...
demand map). The InsightsQL system-table model classes cross the boundary as objects via
``facade/insightsql.py``, and temporal/source wiring via ``facade/temporal.py`` — not here.
"""
