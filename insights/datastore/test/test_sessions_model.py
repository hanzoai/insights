from insights.test.base import BaseTest, DatastoreDestroyTablesMixin, DatastoreTestMixin, _create_event
...
class TestSessionsModel(DatastoreDestroyTablesMixin, DatastoreTestMixin, BaseTest):
    ...
    def test_select_from_sessions(self):
        ...
        # we can't include all the columns as this datastore driver doesn't support selecting states
