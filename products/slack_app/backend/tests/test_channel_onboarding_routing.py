...
class TestMemberJoinedChannelRouting(TestCase):
    ...
    def setUp(self):
        ...
        # ``insights.models.integration`` directly, so the patch doesn't catch
    ...
    def _request(self):
        return self.factory.post("/slack/event-callback/", HTTP_HOST="us.hanzo.ai")
    ...
    def test_bot_joined_posts_onboarding_and_claims_dedupe(self, slack_cls):
        ...
        result = route_insights_code_event_to_relevant_region(self._request(), self._event(), self.SLACK_TEAM_ID)
    ...
    def test_duplicate_delivery_is_idempotent(self, slack_cls):
        ...
        route_insights_code_event_to_relevant_region(self._request(), self._event(), self.SLACK_TEAM_ID)
        route_insights_code_event_to_relevant_region(self._request(), self._event(), self.SLACK_TEAM_ID)
    ...
    def test_no_workspace_integration_routes_no_integration(self, slack_cls):
        ...
        result = route_insights_code_event_to_relevant_region(request, self._event(), self.SLACK_TEAM_ID)
    ...
    def test_bot_user_id_is_cached(self, slack_cls):
        ...
        route_insights_code_event_to_relevant_region(self._request(), self._event(channel="C_OTHER"), self.SLACK_TEAM_ID)
