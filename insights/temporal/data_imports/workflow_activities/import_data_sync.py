...
from insights.temporal.data_imports.pipelines.pipeline.pipeline import PipelineNonDLT, PipelineResult
...
from insights.temporal.data_imports.row_tracking import setup_row_tracking
from insights.temporal.data_imports.sources import SourceRegistry
from insights.temporal.data_imports.sources.common.base import ResumableSource, SimpleSource
...
async def _run(
    ...
    try:
        ...
        if use_v3:
            from insights.temporal.data_imports.pipelines.pipeline_v3 import PipelineV3
