...
class TestValidateDataWarehouseBreakdown(BaseTest):
    ...
    @parameterized.expand(
        [
            ...
            (
                "insightsql_type",
                BreakdownFilter(breakdown="status", breakdown_type=BreakdownType.INSIGHTSQL),
            ),
        ]
    )
    ...
    @parameterized.expand(
        [
            (
                "two_insightsql_breakdowns",
                [
                    Breakdown(property="status", type=MultipleBreakdownType.INSIGHTSQL),
                    Breakdown(property="plan", type=MultipleBreakdownType.INSIGHTSQL),
                ],
            ),
            (
                "insightsql_and_data_warehouse",
                [
                    Breakdown(property="status", type=MultipleBreakdownType.INSIGHTSQL),
            ...
            (
                ...
                [
                    Breakdown(property="status", type=MultipleBreakdownType.INSIGHTSQL),
                    Breakdown(property="plan", type=MultipleBreakdownType.DATA_WAREHOUSE),
                    Breakdown(property="region", type=MultipleBreakdownType.INSIGHTSQL),
                ],
            ),
        ]
    )
    ...
    @parameterized.expand(
        [
            ...
            (
                "insightsql_and_data_warehouse_person_property",
                [
                    Breakdown(property="status", type=MultipleBreakdownType.INSIGHTSQL),
