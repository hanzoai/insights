...
class SimFinSource(SimpleSource[SimFinSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your SimFin API key and the stock tickers you want to track to pull standardized financial statements, share prices and company data into the Insights Data warehouse.
...
Note: each selected table costs one request per ticker on every sync, and SimFin rate limits requests per second by plan tier. Historical depth and some datasets depend on your SimFin plan.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/simfin",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
