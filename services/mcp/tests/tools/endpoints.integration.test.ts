    ...
    describe('endpoint-openapi-spec tool', () => {
        ...
        it('should return the spec for a specific version', async () => {
            ...
            await updateTool.handler(context, {
                name,
                query: INSIGHTSQL_EVENT_COUNT_QUERY,
