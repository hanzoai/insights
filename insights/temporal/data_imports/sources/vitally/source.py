...
from insights.temporal.data_imports.sources.generated_configs import VitallySourceConfig
from insights.temporal.data_imports.sources.vitally.settings import (
    ENDPOINTS as VITALLY_ENDPOINTS,
    INCREMENTAL_FIELDS as VITALLY_INCREMENTAL_FIELDS,
)
from insights.temporal.data_imports.sources.vitally.vitally import (
