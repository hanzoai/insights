...
from insights.schema import InsightsQLFilters, SessionPropertyFilter
...
def replace_filters(node: T, filters: Optional[InsightsQLFilters], team: Team, database: Optional[Database] = None) -> T:
    if database is None:
...
class ReplaceFilters(CloningVisitor):
    def __init__(
        self,
        filters: Optional[InsightsQLFilters],
