...
from insights.temporal.data_imports.sources.google_sheets.google_sheets import _get_worksheet


def test_get_worksheet_backoff():
    with (
        mock.patch(
            "insights.temporal.data_imports.sources.google_sheets.google_sheets.google_sheets_client"
        ) as mock_google_sheets_client,
        mock.patch("insights.temporal.data_imports.sources.google_sheets.google_sheets.time"),
    ):
