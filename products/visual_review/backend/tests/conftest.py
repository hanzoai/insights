...
Shared Insights test fixtures (team, user, django_db_setup) are inherited
from products/conftest.py which re-exports insights/conftest.py.
"""
...
def _set_team_scope(request):
    ...
    api_token (collision on `insights_team_api_token_a9a1df8a_uniq`).
