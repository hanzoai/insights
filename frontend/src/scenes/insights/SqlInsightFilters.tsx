...
import { InsightsQLQuery, Node } from '~/queries/schema/schema-general'
...
export function SqlInsightFilters({ query, setQuery, children }: SqlInsightFiltersProps): JSX.Element {
    ...
    const setSource = (newSource: InsightsQLQuery): void => {
    ...
    return (
        ...
        >
            ...
            <div className="InsightDisplayConfig @container flex justify-between items-center flex-wrap gap-2 [&_.Button--small]:[--lemon-button-gap:0.25rem] [&_.Button--small]:[--lemon-button-padding-horizontal:0.375rem]">
