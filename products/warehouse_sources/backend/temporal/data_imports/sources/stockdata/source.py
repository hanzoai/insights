...
class StockDataSource(ResumableSource[StockDataSourceConfig, StockDataResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your StockData.org API token to pull market news with sentiment plus quote, end-of-day, intraday, dividend, and split price data into the Insights Data warehouse.
...
Note: StockData.org plans are limited by daily request quotas (100 requests/day on the free plan), and some tables (dividends, splits) require a Standard or higher plan.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/stockdata",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
