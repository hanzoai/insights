...
export function IOSSourceMapsInstructions(): JSX.Element {
    return (
        <>
            ...
            <h3>1. Install and authenticate the Insights CLI</h3>
            <p>
                The Insights CLI handles dSYM upload for iOS apps. iOS dSYM support requires{' '}
            ...
            <CodeSnippet language={Language.Bash}>npm install -g @hanzo/cli</CodeSnippet>
            <h4 className="text-sm font-semibold mt-4 mb-2">curl:</h4>
            <CodeSnippet language={Language.Bash}>
                {[
                    "curl --proto '=https' --tlsv1.2 -LsSf https://download.hanzo.ai/cli | sh",
                    'insights-cli-update',
                ].join('\n')}
            </CodeSnippet>

            <p className="mt-4">
                Run the following command to authenticate with Insights. This opens your browser where you select your
            ...
            <Banner type="warning" className="my-4">
                ...
                <p className="mt-2 text-sm">
                    ...
                    <code>insights-cli</code> which are currently not allowed with User Script Sandboxing enabled.
                </p>
            </Banner>

            <h3>3. Add build phase script</h3>
            <p>
                To symbolicate crash reports, Insights needs your project's debug symbol (dSYM) files. The following
            ...
            <CodeSnippet language={Language.Bash}>
                {'${BUILD_DIR%/Build/*}/SourcePackages/checkouts/insights-ios/build-tools/upload-symbols.sh'}
            </CodeSnippet>

            <h4 className="text-sm font-semibold mt-4 mb-2">CocoaPods:</h4>
            <CodeSnippet language={Language.Bash}>{'${PODS_ROOT}/Insights/build-tools/upload-symbols.sh'}</CodeSnippet>
            ...
            <p className="text-sm text-muted mt-2">
                <strong>Note:</strong> Enabling this flag uploads your source code to Insights's servers. This is
            ...
            <p>
                Build your app in Xcode. The dSYM upload script will automatically run and upload symbols to Insights.
