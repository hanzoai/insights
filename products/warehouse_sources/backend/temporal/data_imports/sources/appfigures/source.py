...
class AppfiguresSource(ResumableSource[AppfiguresSourceConfig, AppfiguresResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter an Appfigures Personal Access Token to pull your app-store analytics into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/appfigures",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
