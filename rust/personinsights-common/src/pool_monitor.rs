...
const DB_POOL_SIZE: &str = "personinsights_db_pool_size";
const DB_POOL_IDLE: &str = "personinsights_db_pool_idle";
const DB_POOL_MAX: &str = "personinsights_db_pool_max";
...
///
/// Reports per pool:
/// - `personinsights_db_pool_size{pool}` — current number of connections (active + idle)
/// - `personinsights_db_pool_idle{pool}` — idle connections available for use
/// - `personinsights_db_pool_max{pool}` — configured max_connections ceiling
