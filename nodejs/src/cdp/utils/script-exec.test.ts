...
describe('script-exec', () => {
    describe('thread relief', () => {
        ...
        it('should process batches in a way that does not block the main thread', async () => {
            ...
            expect(total).toBeLessThan(200 * numberToTest) // the script exec limiter isn't exact
            await new Promise((resolve) => setTimeout(resolve, 1))
            expect(longestDelay).toBeLessThan(blockTime * 2) // Rough upper bound of the script exec limiter (2x the block time)
        })
