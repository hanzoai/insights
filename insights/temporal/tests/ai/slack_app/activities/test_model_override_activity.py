...
``insights/temporal/tests/ai/test_classify_slack_app_model_override.py``. What
...
from insights.temporal.ai.slack_app.activities.classifiers import classify_slack_app_model_override_activity
from insights.temporal.ai.slack_app.types import SlackAppModelOverride, SlackAppModelOverrideInput
...
ACTIVITY_MODULE = "insights.temporal.ai.slack_app.activities.classifiers"
