...
import { Button, Checkbox, Input, Table, TableColumn, Tooltip } from '@hanzo/elements'
...
export function QuickFiltersModalContent({
    ...
    const columns: TableColumn<QuickFilter, any>[] = useMemo(
        () => [
    ...
    return (
        <div className="space-y-4">
            ...
            {quickFilters.length === 0 && !quickFiltersLoading ? (
                ...
                <>
                    {(quickFilters.length > 10 || searchQuery) && (
                        <Input
                            type="search"
                    ...
                    {filteredQuickFilters.length === 0 && !quickFiltersLoading ? (
                        ...
                        <Table dataSource={filteredQuickFilters} loading={quickFiltersLoading} columns={columns} />
                    )}
