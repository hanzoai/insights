...
OUT_DIR="$REPO_ROOT/insights/personinsights_client/proto/generated"
...
mapfile -d '' PROTO_FILES < <(find "$PROTO_DIR/personinsights/service" "$PROTO_DIR/personinsights/types" -name '*.proto' -print0)
