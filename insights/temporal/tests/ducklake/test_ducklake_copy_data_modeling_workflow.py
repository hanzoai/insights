...
def test_copy_data_modeling_model_to_ducklake_activity_uses_duckdb(monkeypatch):
    ...
    monkeypatch.setattr(
        "insights.temporal.ducklake.ducklake_copy_data_modeling_workflow.get_ducklake_catalog_for_team",
...
def test_verify_ducklake_copy_activity_runs_queries(monkeypatch):
    ...
    monkeypatch.setattr(
        "insights.temporal.ducklake.ducklake_copy_data_modeling_workflow.configure_cross_account_connection",
        MagicMock(),
    )
