...
CANONICAL_DESCRIPTIONS: CanonicalDescriptions = {
    ...
    "deploys": {
        "description": "Deploys tracked per project. Airbrake's API returns no deploy identifier, so this table is full-refresh only; projectId is added by Insights for joinability.",
        "docs_url": "https://docs.airbrake.io/docs/devops-tools/api/",
        "columns": {
            "projectId": "Identifier of the project the deploy belongs to (added by Insights; not returned by the Airbrake API).",
