...
import { dimensions, dragSelection, rawDrag, setupJsdom, setupSyncRaf } from '@hanzo/quill-charts/testing'
...
describe('TrendsLineChart', () => {
    ...
    describe('empty state', () => {
        ...
        it('uses context.emptyStateHeading override when provided', async () => {
            renderInsight({
                ...
                context: { emptyStateHeading: 'Nothing to see here, mascot' },
            })

            await waitFor(() => {
                expect(screen.getByText('Nothing to see here, mascot')).toBeInTheDocument()
            })
        })
    })
    ...
    describe('quill in-chart legend', () => {
        ...
        const getInChartLegend = (container: HTMLElement): HTMLElement =>
            container.querySelector<HTMLElement>('[data-attr="script-chart-timeseries-line-legend"]')!
