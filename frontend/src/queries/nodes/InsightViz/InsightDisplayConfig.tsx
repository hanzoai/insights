...
export function InsightDisplayConfig(): JSX.Element {
    ...
    return (
        <div
            className="InsightDisplayConfig @container flex justify-between items-center flex-wrap gap-2 [&_.Button--small]:[--lemon-button-gap:0.25rem] [&_.Button--small]:[--lemon-button-padding-horizontal:0.375rem]"
        ...
        >
            ...
            <div className="flex items-center gap-x-2">
                {advancedOptions.length > 0 && (
                    <>
                        <Menu items={advancedOptions} closeOnClickInside={false} placement="bottom-end">
                            <Button
                                size="small"
