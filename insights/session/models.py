...
class Session(AbstractBaseSession):
    ...
    (`insights.session.backend`). Beyond the base columns (`session_key`, `session_data`,
    ...
    # Plain BigIntegerField, not a ForeignKey to insights_user: avoids a per-write FK constraint
