    ...
    describe('reducers', () => {
        ...
        describe('translationError', () => {
            ...
            it('clears error on resetTranslation', async () => {
                ...
                jest.spyOn(mockApi.aiObservability, 'translate').mockRejectedValueOnce(new Error('API error'))
            ...
            it('sets error on translateFailure', async () => {
                ...
                jest.spyOn(mockApi.aiObservability, 'translate').mockRejectedValue(new Error('Translation failed'))
    ...
    describe('loaders', () => {
        describe('translate', () => {
            it('calls API with correct parameters', async () => {
                ...
                expect(mockApi.aiObservability.translate).toHaveBeenCalledWith({
                    text: mockContent,
                    targetLanguage: 'es',
                })
            })
