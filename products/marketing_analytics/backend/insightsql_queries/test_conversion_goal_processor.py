...
from insights.test.base import BaseTest, DatastoreTestMixin, _create_event, _create_person, events_cache_tests
...
from products.marketing_analytics.backend.insightsql_queries.conversion_goal_conditions import (
...
class TestConversionGoalProcessor(DatastoreTestMixin, BaseTest):
    ...
    def test_data_warehouse_node_empty_utm_falls_back_to_organic(self):
        ...
        table, _source, _credential, _df, cleanup_fn = create_data_warehouse_table_from_csv(
            ...
            "test_storage_bucket-insights.marketing_analytics.empty_utm",
            self.team,
        )
        ...
        response = execute_insightsql_query(query=cte_query, team=self.team)
    ...
    def test_sum_math_currency_conversion_matches_across_live_and_precompute_paths(self, _name, currency_config):
        ...
        live = processor.get_select_field().to_insightsql()
        precompute = processor._get_conversion_value_expr().to_insightsql()
    ...
    def test_temporal_attribution_multiple_conversions_separate_attribution(self):
        ...
        response_april = execute_insightsql_query(query=cte_query_april, team=self.team)
        ...
        response_may = execute_insightsql_query(query=cte_query_may, team=self.team)
        ...
        response_june = execute_insightsql_query(query=cte_query_june, team=self.team)
    ...
    def test_attribution_window_30_day_limit(self):
        ...
        response_within = execute_insightsql_query(query=cte_query_within, team=self.team)
        ...
        response_beyond = execute_insightsql_query(query=cte_query_beyond, team=self.team)
    ...
    def test_comprehensive_real_world_attribution_scenario(self):
        ...
        response_first = execute_insightsql_query(query=cte_query_first, team=self.team)
        ...
        response_full = execute_insightsql_query(query=cte_query_full, team=self.team)
    ...
    def test_actions_multiple_events_unique_users(self):
        ...
        response_dau = execute_insightsql_query(query=cte_query_dau, team=self.team)
    ...
    def test_actions_multiple_events_and_vs_or_semantics(self):
        ...
        response_both = execute_insightsql_query(query=cte_query, team=self.team)
    ...
    def test_integration_multi_event_actions_temporal_attribution(self):
        ...
        events_response = execute_insightsql_query(query=events_query, team=self.team)
        actions_response = execute_insightsql_query(query=actions_query, team=self.team)
        ...
        assert pretty_print_in_tests(actions_response.insightsql, self.team.pk) == self.snapshot
