...
class TestValidateCredentials:
    ...
    def test_returns_false_for_ssrf_targets(self, blocked_url):
        ...
        with mock.patch("insights.security.url_validation.is_dev_mode", return_value=False):
...
class TestResolveApiUrl:
    def test_defaults_to_public_api_when_none(self):
        with (
            mock.patch("insights.security.url_validation.is_dev_mode", return_value=False),
            mock.patch("insights.security.url_validation.resolve_host_ips", return_value=_PUBLIC_IP),
        ):
