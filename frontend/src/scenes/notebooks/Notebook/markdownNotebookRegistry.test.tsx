...
describe('markdownNotebookRegistry', () => {
    describe('getMarkdownRegistryForFeatureFlags', () => {
        it('offers a single SQL and Python cell, gated by the revamped notebooks flag', () => {
            ...
            for (const legacyTag of ['Query', 'Python', 'DuckSQL', 'InsightsQLSQL']) {
    ...
    describe('getQueryTitle', () => {
        it.each([
            ...
            [
                'InsightsQLQuery stays untitled — no SQL body, no generic label',
                { kind: 'DataTableNode', source: { kind: 'InsightsQLQuery', query: 'select event from events' } },
                null,
            ],
