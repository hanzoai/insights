    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption=(
                ...
                f"[v2 secret API key]({REVENUECAT_API_KEYS_URL}). Insights uses the key to pull "
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/revenuecat",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
            ...
            webhookSetupCaption=(
                "Insights tries to register a webhook integration in RevenueCat using your "
                ...
                "Insights rejects deliveries whose header does not match.\n\n"
                ...
                "paste the same value into the field below so Insights can verify deliveries\n"
