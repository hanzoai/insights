...
class CortexSource(SimpleSource[CortexSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Cortex",
            caption="""Enter your Cortex API key to sync your service catalog, scorecards, teams, and entity relationships into the Insights Data warehouse.
...
Create an API key in your Cortex workspace under **Settings → API Keys**. The key needs read access to the catalog, scorecards, and teams you want to sync.""",
            docsUrl="https://hanzo.ai/docs/cdp/sources/cortex",
