...
export function EditAlertModalV2({
    ...
    const { existingInsightsFunctions, pendingNotifications, testDeliveryResultLoading } = useValues(notificationLogic)
    ...
    const hasTestDeliveryTargets =
        ...
        existingInsightsFunctions.some((insightsFunction) => insightsFunction.enabled)
    ...
    const destinationCount = existingInsightsFunctions.length + pendingNotifications.length
    ...
    const definitionNode = (
        <AlertDefinitionSection
            ...
            insightsql={{
                preview: insightsqlAlertPreview,
                columns: insightsqlResultColumns,
                valueColumnOptions: insightsqlValueColumnOptions,
                labelColumnOptions: insightsqlLabelColumnOptions,
            }}
    ...
    const previewNode = (
        <AlertPreviewCard
            ...
            insightsqlPreview={insightsqlAlertPreview}
    ...
    return (
        <Modal onClose={handleClose} isOpen={isOpen} width={900} simple title="">
            {alertLoading && !alert ? (
