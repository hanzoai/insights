from insights.models.batch_imports import BatchImport
...
class TestBatchImportActivityLogging(ActivityLogTestHelper):
    ...
    def test_batch_import_field_exclusions_configured(self):
        ...
        from insights.models.activity_logging.activity_log import field_exclusions
    ...
    def test_batch_import_scope_in_activity_log_types(self):
        ...
        from insights.models.activity_logging.activity_log import ActivityScope
    ...
    def test_batch_import_masked_fields_configured(self):
        ...
        from insights.models.activity_logging.activity_log import field_with_masked_contents
