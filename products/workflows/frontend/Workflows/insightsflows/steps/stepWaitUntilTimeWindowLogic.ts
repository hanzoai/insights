...
export interface stepWaitUntilTimeWindowLogicActions {
    partialSetWorkflowActionConfig: (actionId: string, config: Partial<{
        cohorts: {
...
export type stepWaitUntilTimeWindowLogicType = MakeLogicType<stepWaitUntilTimeWindowLogicValues, stepWaitUntilTimeWindowLogicActions, StepWaitUntilTimeWindowLogicProps, stepWaitUntilTimeWindowLogicMeta>;
