...
class RailwaySource(ResumableSource[RailwaySourceConfig, RailwayResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Railway API token to pull your Railway projects, services, environments, deployments, members, and volumes into the Insights Data warehouse.
...
Note that Railway rate limits API requests per plan (as low as 100 requests/hour on the Free plan), which can slow down large initial syncs.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/railway",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
