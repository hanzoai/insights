...
import insightsLogo from 'public/insights-logo.svg'
...
export function DPALegalPreview({ lawyerMode = false }: DPALegalPreviewProps): JSX.Element {
    ...
    return (
        ...
        >
            {!lawyerMode && <img src={insightsLogo} alt="Insights logo" width={157} className="my-6 not-prose" />}
            <h3>Data Processing Agreement — Insights Inc.</h3>
            <p>
                ...
                <strong>Insights Inc.</strong> (the "<strong>Processor</strong>") (together as the "
            ...
            <p>
                See{' '}
                <Link to="https://hanzo.ai/handbook/company/security" target="_blank">
                    https://hanzo.ai/handbook/company/security
                </Link>
                .
            </p>
        </div>
