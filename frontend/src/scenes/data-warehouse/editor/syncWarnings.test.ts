    ...
    describe('trimRedundantTail', () => {
        ...
        test.each([
            [
                ...
                '`postgres_insights_team` (from Postgres) last synced 2 hours ago, more than twice its configured sync interval. Results may be out of date.',
                '`postgres_insights_team` (from Postgres) last synced 2 hours ago, more than twice its configured sync interval.',
            ],
            [
                'running sync keeps the in-progress note but drops the redundant tail',
                '`postgres_insights_team` (from Postgres) last completed syncing 2 hours ago, more than twice its configured sync interval. A new sync is in progress but results may be out of date.',
                '`postgres_insights_team` (from Postgres) last completed syncing 2 hours ago, more than twice its configured sync interval. A new sync is in progress.',
            ],
            [
