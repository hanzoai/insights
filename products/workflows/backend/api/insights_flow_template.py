...
# NOTE: We allow unauthenticated access to global script flow templates, never put anything secret in them
...
class InsightsFlowTemplateSerializer(serializers.ModelSerializer):
    ...
    def get_created_by(self, obj):
        if obj.created_by:
            from insights.api.shared import UserBasicSerializer  # noqa: PLC0415
