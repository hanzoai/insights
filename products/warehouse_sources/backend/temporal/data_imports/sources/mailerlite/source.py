...
class MailerLiteSource(
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your MailerLite API key to pull your MailerLite data into the Insights Data warehouse.
...
You can create an API key in your [MailerLite integrations settings](https://dashboard.mailerlite.com/integrations/api).""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/mailerlite",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
            ...
            webhookSetupCaption="""Insights registers a MailerLite webhook for your subscriber events using your API key. MailerLite generates the signing secret and returns it once, at creation, so Insights stores it then and uses it to verify every delivery.
...
curl -X POST https://connect.mailerlite.com/api/webhooks \\
  ...
  -d '{"name": "Insights Data warehouse", "url": "YOUR_WEBHOOK_URL", "events": ["subscriber.created", "subscriber.updated", "subscriber.unsubscribed", "subscriber.bounced", "subscriber.spam_reported", "subscriber.active", "subscriber.added_to_group", "subscriber.removed_from_group"]}'
```
            ...
            webhookFields=cast(
                ...
                [
                    SourceFieldInputConfig(
                        ...
                        placeholder="",
                        caption=(
                            "The secret MailerLite returned when the webhook was created. Insights "
