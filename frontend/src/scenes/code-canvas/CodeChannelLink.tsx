...
import { IconLaptop } from '@hanzo/icons'
 ...
 * deep-links into the desktop app via the `insights-code(-dev)://` custom scheme; for visitors
    ...
    return (
        <BridgePage view="code-channel-link">
            <div className="flex flex-col items-center gap-4 text-center max-w-lg mx-auto">
                ...
                <h2 className="text-xl font-semibold m-0">Opening in Insights Desktop…</h2>
                <p className="text-muted mb-0">
                    This {target} lives in the Insights Desktop app. If it's installed, it should open automatically. If
                ...
                <div className="flex flex-col items-center gap-2">
                    {deepLink && (
                        ...
                        >
                            Open in Insights Desktop
                        </Button>
                    )}
                    <Button type="secondary" to="https://hanzo.ai/code" targetBlank>
