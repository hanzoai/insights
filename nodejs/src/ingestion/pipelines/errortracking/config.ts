...
export type ErrorTrackingOutputsConfig = {
    ...
    ERROR_TRACKING_OUTPUT_TOPFN_TOPIC: string
    ERROR_TRACKING_OUTPUT_TOPFN_PRODUCER: ProducerName
}
...
export function getDefaultErrorTrackingOutputsConfig(): ErrorTrackingOutputsConfig {
    return {
        ...
        ERROR_TRACKING_OUTPUT_TOPFN_TOPIC: KAFKA_DATASTORE_TOPHOG,
        ERROR_TRACKING_OUTPUT_TOPFN_PRODUCER: INGESTION_DOWNSTREAM_PRODUCER,
    }
}
