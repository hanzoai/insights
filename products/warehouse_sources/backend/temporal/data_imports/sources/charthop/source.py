...
class ChartHopSource(ResumableSource[ChartHopSourceConfig, ChartHopResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your ChartHop API token to pull your ChartHop people, org chart, and compensation-change data into the Insights Data warehouse.
...
""",
            docsUrl="https://hanzo.ai/docs/cdp/sources/charthop",
