    ...
    return (
        <div className="bg-bg-light rounded-lg border border-border p-4 h-full min-h-[340px] flex flex-col">
            <div className="mb-4 flex items-center justify-between">
                ...
                <Tooltip title="Based on Insights's experimental user agent bot detection, matching search engines, AI crawlers, monitoring tools and more.">
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-center gap-2 cursor-default">
                                        ...
                                        {item.category ? (
                                            <Tag type="muted" size="small" className="shrink-0 text-[10px]">
                                                {item.category}
                                            </Tag>
                                        ) : null}
