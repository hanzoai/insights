...
from insights.api.event_filter_config import EventFilterConfigSerializer, EventFilterConfigViewSet
from insights.models.event_filter_config import EventFilterConfig, EventFilterMode
...
class TestEventFilterConfigAPI(APIBaseTest):
    def _url(self, team_id: int | None = None) -> str:
        return f"/v1/environments/{team_id or self.team.id}/event_filter/"
    ...
    @patch("insights.api.event_filter_config.fetch_app_metrics_trends")
    ...
    @patch("insights.api.event_filter_config.fetch_app_metric_totals")
    ...
    @patch("insights.api.event_filter_config.fetch_app_metrics_trends")
    def test_metrics_calls_datastore_when_config_exists(self, mock_fetch):
        from insights.api.app_metrics2 import AppMetricsResponse
    ...
    @patch("insights.api.event_filter_config.fetch_app_metric_totals")
    def test_metrics_totals_calls_datastore_when_config_exists(self, mock_fetch):
        from insights.api.app_metrics2 import AppMetricsTotalsResponse
