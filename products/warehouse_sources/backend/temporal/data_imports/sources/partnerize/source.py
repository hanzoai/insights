...
class PartnerizeSource(ResumableSource[PartnerizeSourceConfig, PartnerizeResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Partnerize API credentials to pull your partnership and affiliate marketing data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/partnerize",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
