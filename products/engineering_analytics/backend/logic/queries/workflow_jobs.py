"""InsightsQL assembly of a run's jobs, for the expandable job breakdown on the run rows.
...
# Explicit high LIMIT: without it InsightsQL caps at DEFAULT_RETURNED_ROWS (100), and since the rows are ordered
