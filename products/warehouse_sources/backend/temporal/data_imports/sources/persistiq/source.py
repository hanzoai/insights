...
class PersistIqSource(ResumableSource[PersistIqSourceConfig, PersistiqResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your PersistIQ API key to pull your sales engagement data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/persistiq",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
