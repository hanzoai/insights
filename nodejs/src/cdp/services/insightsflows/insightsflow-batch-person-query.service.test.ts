...
describe('InsightsFlowBatchPersonQueryService', () => {
    ...
    const createService = (): InsightsFlowBatchPersonQueryService => {
        return new InsightsFlowBatchPersonQueryService({ fetch: fetchMock } as any)
    }
