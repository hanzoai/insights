...
from insights.schema import DateRange, TraceSpansQuery
...
class TestRootSpansFilter(DatastoreTestMixin, APIBaseTest):
    ...
    def setUpTestData(cls):
        ...
        rows = [
            ...
            _row(3, trace_a, _b64((3).to_bytes(8, "big")), root_a, "datastore.query", "web", 20),
