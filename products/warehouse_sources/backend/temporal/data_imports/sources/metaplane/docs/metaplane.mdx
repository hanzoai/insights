...
`hanzo.ai/contents/docs/cdp/sources/metaplane.mdx` and delete this copy, then run
...
it as a source syncs your monitors and their full evaluation history into the Insights Data warehouse, so
...
2. Copy the key and paste it into the **API key** field in Insights.
