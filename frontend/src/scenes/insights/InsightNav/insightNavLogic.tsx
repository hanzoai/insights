...
const cleanSeriesEntityMath = (
    ...
    if (mathAvailability === MathAvailability.All) {
        if (math != null) {
            return { ...baseEntity, math, math_property, math_group_type_index, math_insightsql }
        }
        ...
        if (cachedEntity && cachedEntity.math !== undefined && entity.math === undefined) {
            return {
                ...
                ...(cachedEntity.math_group_type_index != null
                    ...
                    : {}),
                ...(cachedEntity.math_insightsql != null ? { math_insightsql: cachedEntity.math_insightsql } : {}),
            }
        }
        return entity
    })
