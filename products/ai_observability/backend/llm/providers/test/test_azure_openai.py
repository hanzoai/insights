...
from products.ai_observability.backend.llm.providers.azure_openai import (
...
class TestAzureOpenAIValidateKey:
    @patch("products.ai_observability.backend.llm.providers.azure_openai.httpx.get")
...
class TestAzureOpenAIListModels:
    ...
    @patch(
        "products.ai_observability.backend.llm.providers.azure_openai.httpx.get",
...
class TestAzureOpenAICreateClient:
    ...
    @patch(
        "products.ai_observability.backend.llm.providers.azure_openai.hanzo_insights.default_client", new=MagicMock()
    )
    @patch("products.ai_observability.backend.llm.providers.azure_openai.WrappedAzureOpenAI")
