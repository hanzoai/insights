    ...
    return [
        {
            ...
            content: (
                <>
                    <Markdown>
                        {dedent`
                            Install the Insights Rust SDK. Error tracking is enabled by its default \`error-tracking\` feature.
                        `}
                    </Markdown>
                    <CodeBlock language="bash" code="cargo add insights-rs" />
                    <Markdown>
                        {dedent`
                    ...
                    <CodeBlock
                        ...
                        code={dedent`
                            [dependencies]
                            insights-rs = { version = "*", default-features = false, features = ["async-client", "error-tracking"] }
                        `}
                    />
                </>
            ),
            ...
            content: (
                <>
                    ...
                    <CodeBlock
                        language="rust"
                        code={dedent`
                            use insights_rs::{ClientOptionsBuilder, ErrorTrackingOptionsBuilder};
                            ...
                            insights_rs::init_global(options).await.unwrap();
                        `}
                    />
                </>
            ),
        },
        {
            ...
            content: (
                <Markdown>
                    {dedent`
                        Capture a test error and confirm it appears in [Error tracking](https://app.hanzo.ai/error_tracking).
                    `}
                </Markdown>
            ),
        },
