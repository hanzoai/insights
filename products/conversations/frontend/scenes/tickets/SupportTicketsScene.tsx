...
export function SupportTicketsTable({ embedded = false }: SupportTicketsTableProps): JSX.Element {
    ...
    const columns = useMemo<TableColumns<Ticket>>(() => {
        const checkboxCol: TableColumns<Ticket>[number] = {
    ...
    const emptyState =
        searchQuery && hasActiveFilters ? (
            <div className="flex flex-col items-center gap-2 py-2">
                ...
                <Button type="secondary" size="small" onClick={() => clearFiltersKeepingSearch()}>
