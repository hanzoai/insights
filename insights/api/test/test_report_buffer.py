...
from insights.api.report_buffer import CSP_BUFFER_DROPPED, CSP_BUFFER_FAILED, CSP_BUFFER_SUBMITTED, CspReportBuffer
...
class TestCspReportBufferedView(BaseTest):
    ...
    @patch("insights.api.report.csp_report_buffer")
...
class TestCspReportBufferLogic(SimpleTestCase):
    ...
    @patch("insights.api.report_buffer.capture_batch_internal")
    ...
    @patch("insights.api.report_buffer.capture_exception")
    @patch("insights.api.report_buffer.capture_batch_internal", side_effect=Exception("capture down"))
    ...
    @patch("insights.api.report_buffer.time.monotonic")
    @patch("insights.api.report_buffer.capture_batch_internal")
