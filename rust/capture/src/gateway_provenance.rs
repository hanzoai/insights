...
pub const SIGNATURE_HEADER: &str = "Insights-Ai-Gateway-Signature";
pub const SIGNED_AT_HEADER: &str = "Insights-Ai-Gateway-Signed-At";
pub const REQUEST_ID_HEADER: &str = "Insights-Ai-Gateway-Request-Id";
