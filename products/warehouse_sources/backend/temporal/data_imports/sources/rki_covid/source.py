...
class RKICovidSource(SimpleSource[RKICovidSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Pull German COVID-19 statistics (nationwide, per state, and per district) into the Insights Data warehouse from the public RKI COVID-19 API at [api.corona-zahlen.org](https://api.corona-zahlen.org).
...
Optionally limit the history tables to the last N days; leave empty to sync the full history.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/rki-covid",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
