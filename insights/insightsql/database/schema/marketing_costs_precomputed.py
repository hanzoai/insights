...
from insights.insightsql.database.models import DateTimeDatabaseField, FieldOrTable, LazyTable, LazyTableToAdd
...
class MarketingCostsPrecomputedTable(LazyTable):
    ...
    def lazy_select(
        ...
        return ast.SelectQuery(
            ...
            select_from=ast.JoinExpr(table=ast.Field(chain=["insights", "marketing_costs_preaggregated"]), alias=_RAW),
