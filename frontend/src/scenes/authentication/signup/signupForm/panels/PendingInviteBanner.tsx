...
export function PendingInviteBanner({ invite, email }: { invite: PendingInvite; email: string }): JSX.Element {
    ...
    return (
        <div className="deprecated-space-y-4 Signup__panel__pending-invite">
            <h2 className="m-0">You've already been invited to Insights</h2>
            <p className="text-secondary mb-0">
                <b>{invite.organization_name}</b> sent you an invite to join them on Insights. Look for it in your inbox,
