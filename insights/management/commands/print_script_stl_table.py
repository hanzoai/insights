...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        from insights.insightsql.functions.mapping import INSIGHTSQL_COMPARISON_MAPPING, INSIGHTSQL_DATASTORE_FUNCTIONS

        insightsql_functions = set(INSIGHTSQL_COMPARISON_MAPPING.keys()).union(
            set(INSIGHTSQL_DATASTORE_FUNCTIONS.keys())
        )
