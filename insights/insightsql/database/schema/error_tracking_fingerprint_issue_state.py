...
# Key used to pass pending fingerprint-issue-state updates through InsightsQLContext.data_to_ingest.
PENDING_UPDATES_INSIGHTSQL_CONTEXT_KEY = "error_tracking_fingerprints"
...
def join_with_error_tracking_fingerprint_issue_state_table(
    ...
    pending_updates = context.data_to_ingest.get(PENDING_UPDATES_INSIGHTSQL_CONTEXT_KEY) or []
