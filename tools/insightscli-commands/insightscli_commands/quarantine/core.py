        ...
        "entries": [
            {
                ...
                "runner": "pytest",
                "reason": "Flaky Datastore ordering assertion",
                "owner": "@team-product-analytics",
                "issue": "https://github.com/Insights/insights/issues/12345",
                "added": "2026-06-10",
                "expires": "2026-06-24",
                "mode": "run"
            }
...
- exact nodeid: ``insights/api/test/test_foo.py::TestFoo::test_bar``
- prefix: a directory (``insights/api/test``), file (``.../test_foo.py``),
...
Nodeids are repo-root-relative in every Insights pytest invocation (product
