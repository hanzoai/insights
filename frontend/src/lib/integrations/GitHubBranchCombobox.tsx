...
/**
 * GitHub branch picker built on Quill's Combobox, mirroring the Insights Desktop branch picker: a button
...
export function GitHubBranchCombobox({
    ...
    // Pre-select the repo's default branch once it's known and nothing is chosen yet (matches Insights Desktop).
