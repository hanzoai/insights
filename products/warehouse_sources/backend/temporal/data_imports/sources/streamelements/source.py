...
class StreamElementsSource(ResumableSource[StreamElementsSourceConfig, StreamElementsResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Sync tips, activity feed events, loyalty points, store redemptions and chatbot settings from StreamElements into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/streamelements",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
