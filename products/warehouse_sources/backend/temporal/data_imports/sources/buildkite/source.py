...
class BuildkiteSource(ResumableSource[BuildkiteSourceConfig, BuildkiteResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/buildkite",
            caption="""Enter your Buildkite API access token and organization slug to sync your CI/CD data into the Insights Data warehouse.
