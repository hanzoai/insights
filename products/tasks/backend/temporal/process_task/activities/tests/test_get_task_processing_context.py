...
VM_FLAG_PAYLOAD_TARGET = "products.tasks.backend.constants.hanzo_insights.get_feature_flag_payload"
...
class TestGetTaskProcessingContextActivity:
    ...
    def test_get_task_processing_context_success(self, activity_environment, test_task):
        ...
        assert result.repository == "insights/insights-js"
    ...
    def test_get_task_processing_context_with_different_repository(
        ...
        task = self._create_task_with_repo(team, user, github_integration, "insights/insights-js")
    ...
    def test_pr_loop_enabled_reflects_feature_flag(self, activity_environment, test_task, flag_value, expected):
        ...
        with patch(
            "products.tasks.backend.temporal.process_task.activities.get_task_processing_context.hanzo_insights.feature_enabled",
    ...
    @pytest.mark.parametrize(
        ...
        [
            (None, None),
            ({"default_custom_image": "insights-dev-stack"}, "insights-dev-stack"),
            ('{"default_custom_image": "insights-dev-stack"}', "insights-dev-stack"),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "user_created",
                VmSandboxDecision(use_vm_sandbox=True, default_custom_image="insights-dev-stack"),
            ),
    ...
    def test_modal_vm_sandbox_default_custom_image_resolution(self, origin_product, expected):
        with patch(
            VM_FLAG_PAYLOAD_TARGET,
            return_value='{"default_base_origin_products": ["user_created"], "default_custom_image": "insights-dev-stack"}',
        ):
            assert (
                _resolve_modal_vm_sandbox(
                    distinct_id="distinct-id",
    ...
    def test_modal_vm_sandbox_state_override_never_gets_default_custom_image(self):
        ...
        with patch(
            VM_FLAG_PAYLOAD_TARGET,
            return_value='{"default_base_origin_products": ["image_builder"], "default_custom_image": "insights-dev-stack"}',
        ) as payload_mock:
    ...
    def test_get_task_processing_context_applies_org_default_custom_image(self, activity_environment, test_task):
        ...
        assert result.custom_image_name == "insights-dev-stack"
