...
describe('Alerts', { concurrent: false }, () => {
    ...
    describe('alerts-list tool', () => {
        it('should return paginated structure', async () => {
            ...
            expect(data._insightsUrl).toContain('/alerts')
        })

        it('should return a per-alert _insightsUrl on each result', async () => {
            ...
            expect(found._insightsUrl).toContain(`/alerts?alert_type=insights&alert_id=${createdAlert.id}`)
        })
    ...
    describe('alert-get tool', () => {
        it('should retrieve a specific alert by ID', async () => {
            ...
            expect(alert._insightsUrl).toContain(`/alerts?alert_type=insights&alert_id=${createdAlert.id}`)
        })
