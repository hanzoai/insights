...
test.describe('Logs', () => {
    test.describe('UI integration tests (mocked API)', () => {
        test.beforeEach(async ({ page }) => {
            ...
            await page.route('**/v1/environments/*/logs/query/', (route) =>
                route.fulfill({
                    status: 200,
            ...
            await page.route('**/v1/environments/*/logs/sparkline/', (route) =>
                route.fulfill({
                    status: 200,
                    contentType: 'application/json',
            ...
            await page.route('**/v1/environments/*/logs/values*', (route) =>
                route.fulfill({
                    status: 200,
                    contentType: 'application/json',
