...
class TestPluginAPI(APIBaseTest, QueryMatchingTest):
    ...
    def _create_plugin(
        ...
        params = {"url": "https://github.com/hanzoai/helloworldplugin"}
        ...
        response = self.client.post(
            ...
            {"url": "https://github.com/hanzoai/helloworldplugin"},
        )
    ...
    def test_create_plugin_auth(self, mock_get, mock_reload):
        repo_url = "https://github.com/hanzoai/helloworldplugin"
    ...
    def test_create_plugin_commit_url(self, mock_get, mock_reload):
        ...
        response = self.client.post(
            "/api/organizations/@current/plugins/",
            {"url": f"https://github.com/hanzoai/helloworldplugin/commit/{HELLO_WORLD_PLUGIN_GITHUB_ZIP[0]}"},
        )
        self.assertEqual(response.status_code, 201)
        self.assertEqual(
            response.json(),
    ...
    def test_create_plugin_other_commit_url(self, mock_get, mock_reload):
        ...
        response2 = self.client.post(
            "/api/organizations/@current/plugins/",
            {
                "url": "https://github.com/hanzoai/helloworldplugin/commit/{}".format(
        ...
        self.assertEqual(
            response2.json(),
            {
                ...
                "url": f"https://github.com/hanzoai/helloworldplugin/commit/{HELLO_WORLD_PLUGIN_GITHUB_ATTACHMENT_ZIP[0]}",
                "icon": None,
                "config_schema": {
                    "bar": {
                        "name": "What's in the bar?",
    ...
    def test_create_insights_function_from_plugin_config(self, mock_get, mock_reload):
        mock_geoip_plugin = Plugin.objects.create(
            ...
            url="https://github.com/hanzoai/insights-plugin-geoip",
        )
    ...
    def test_create_insights_function_from_plugin_config_with_inputs(self, mock_get, mock_reload):
        mock_geoip_plugin = Plugin.objects.create(
            ...
            name="Taxonomy",
            description="",
            url="https://github.com/hanzoai/taxonomy-plugin",
        )
