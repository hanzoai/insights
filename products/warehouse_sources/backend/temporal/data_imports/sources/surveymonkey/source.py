...
class SurveyMonkeySource(ResumableSource[SurveyMonkeySourceConfig, SurveyMonkeyResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="SurveyMonkey",
            caption="""Enter a SurveyMonkey access token to pull your surveys, responses, and collectors into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/surveymonkey",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
