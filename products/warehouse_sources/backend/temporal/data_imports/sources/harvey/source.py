...
class HarveySource(ResumableSource[HarveySourceConfig, HarveyResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Harvey",
            caption="""Enter your Harvey API token to pull audit logs, usage and query history, client matters, and Vault project metadata into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/harvey",
