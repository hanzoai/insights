...
| FE config Zod              | `frontend/generated/widget-configs.zod.ts` + `widget-config-schemas/` | Codegen — `insightscli build:widget-types` (Orval `generateReusableSchemas`)                         |
...
After `widget_specs/` changes: `insightscli build:openapi` (OpenAPI serializers derive automatically; do not edit `products/dashboards/frontend/generated/`).
