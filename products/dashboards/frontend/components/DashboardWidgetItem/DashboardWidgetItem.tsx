        ...
        <>
            <WidgetCardHeader
                ...
                moreButtonOverlay={
                    <>
                        {titleHref && (
                            <Button to={titleHref} fullWidth>
                                View
                            </Button>
                        )}
                        {showEditingControls && EditModal && (
                            <Button fullWidth data-attr="dashboard-widget-edit" onClick={() => setEditOpen(true)}>
                                Edit
                            </Button>
                        )}
                        {onDuplicate && (
                            <Button fullWidth onClick={onDuplicate}>
                                Duplicate
                            </Button>
                        )}
                        {hasDashboardSectionActions && (
                            <>
                                ...
                                {showEditingControls && toggleShowDescription && !!description && (
                                    <Button fullWidth onClick={toggleShowDescription}>
                                ...
                                {onRemove && (
                                    <Button status="danger" fullWidth onClick={onRemove}>
