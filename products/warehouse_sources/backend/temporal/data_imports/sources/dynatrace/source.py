...
class DynatraceSource(ResumableSource[DynatraceSourceConfig, DynatraceResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Dynatrace environment URL and an API access token to sync problems, events, entity inventory, audit logs, vulnerabilities, metric metadata, and SLOs into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/dynatrace",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
