        ...
        return (
            <SceneContent>
                <div className="space-y-4">
                    <Skeleton.Text className="h-8 w-[40%]" />
                    <Skeleton.Text className="h-4 w-[30%]" />
                ...
                <div className="col-span-2 flex flex-col gap-4">
                    {interview?.summary && (
                        <Widget title="Summary">
                            <div className="p-4">
                                <Markdown className="text-sm">{interview.summary}</Markdown>
                            </div>
                        </Widget>
                    )}
                ...
                <div className="col-span-1 flex flex-col gap-4">
                    ...
                    <Widget title="Person">
                        <div className="p-4 space-y-3">
                            ...
                            <div>
                                <Tag type={hasResponse ? 'success' : 'default'}>
                    ...
                    {intervieweeContext && (
                        <Widget title="Interviewee context">
                            <div className="p-4">
