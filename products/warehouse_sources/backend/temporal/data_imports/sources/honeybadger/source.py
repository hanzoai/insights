...
class HoneybadgerSource(ResumableSource[HoneybadgerSourceConfig, HoneybadgerResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Honeybadger personal authentication token to pull your error monitoring data (projects, errors, occurrences, deployments, and uptime checks) into the Insights Data warehouse.
...
Note that Honeybadger's API is limited to 360 requests per hour, so large backfills (especially of the notices table) can take a while.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/honeybadger",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
