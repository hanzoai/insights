...
// Stub Table to render only the bulk-action bar, driven by a controllable selection context. The
...
jest.mock('lib/elements/Table', () => ({
    Table: ({ bulkSelection }: any) => (bulkSelection ? <div>{bulkSelection.renderActions(mockCtx)}</div> : null),
}))
