...
from insights.heatmaps.sql import HEATMAPS_WS_TABLE_MV_SQL, KAFKA_HEATMAPS_WS_TABLE_SQL
from insights.models.ai_events.sql import (
...
from insights.models.group.sql import GROUPS_WS_TABLE_MV_SQL, KAFKA_GROUPS_WS_TABLE_SQL
...
#
# CLOUD-ONLY: In non-cloud environments (CI, dev, hobby) there is only one Datastore
...
operations = (
    ...
    if settings.CLOUD_DEPLOYMENT not in ("US", "EU", "DEV")
        ...
        # may be missing when migrate_datastore runs before test conftest setup.
        run_sql_with_exceptions(
            AI_EVENTS_DATA_TABLE_SQL(),
