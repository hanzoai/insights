...
describe('IngestionApiServer', () => {
    ...
    describe('cleanup', () => {
        // groupStore.flush() no longer produces Datastore messages itself (see
        ...
        // reach Datastore, and a redelivery of the same batch finds no property
        // diff and never regenerates the message.
        it('produces Datastore messages returned by groupStore.flush() during shutdown cleanup', async () => {
