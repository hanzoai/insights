...
from insights.models import IdentityProviderConfig, OrganizationDomain

migration = import_module("insights.migrations.1286_cleanup_orphaned_identity_provider_configs")
