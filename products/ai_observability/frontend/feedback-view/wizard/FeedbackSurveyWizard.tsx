        ...
        <div className="space-y-6">
            <div>
                ...
                <div className="flex gap-2">
                    <Button
                        type="primary"
                        to="https://hanzo.ai/docs/ai-observability/collect-user-feedback"
                        targetBlank
                    ...
                    <Button
                        type="secondary"
                        to="https://github.com/Insights/insights/blob/e332d656667b8906410e93591a0f16633079efbd/frontend/src/scenes/surveys/components/question-visualizations/OpenQuestionSummaryV2.tsx#L112"
                        targetBlank
                        sideIcon={<IconArrowRight />}
                    >
