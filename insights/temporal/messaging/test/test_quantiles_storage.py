...
from insights.temporal.messaging.quantiles_storage import (
    CachedQuantiles,
    _get_cache_key,
...
class TestQuantilesCache:
    ...
    def test_current_hour_bucket_format(self):
        ...
        with patch("insights.temporal.messaging.quantiles_storage.dt") as mock_dt:
    ...
    @patch("insights.temporal.messaging.quantiles_storage.get_client")
    ...
    @patch("insights.temporal.messaging.quantiles_storage.get_client")
    @patch("insights.temporal.messaging.quantiles_storage.time.sleep")
    ...
    def test_race_condition_scenario_realistic(self):
        ...
        with patch("insights.temporal.messaging.quantiles_storage.get_client") as mock_get_client:
            mock_redis = Mock()
            mock_get_client.return_value = mock_redis
            mock_redis.exists.return_value = False
