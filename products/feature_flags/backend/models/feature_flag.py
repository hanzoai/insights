...
from insights.constants import ENRICHED_DASHBOARD_INSIGHT_IDENTIFIER
...
from insights.models.utils import RootTeamManager, RootTeamMixin, RootTeamQuerySet
...
class FeatureFlagHashKeyOverride(models.Model):
    ...
    team = models.ForeignKey("insights.Team", on_delete=models.DO_NOTHING, db_constraint=False)
    ...
    class Meta:
        ...
        db_table = "insights_featureflaghashkeyoverride"
...
class FeatureFlagOverride(models.Model):
    ...
    class Meta:
        ...
        db_table = "insights_featureflagoverride"
...
class FeatureFlagDashboards(models.Model):
    ...
    class Meta:
        ...
        db_table = "insights_featureflagdashboards"
