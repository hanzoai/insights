...
import { computeMoveEdges, insightsFlowEditorLogic } from './insightsFlowEditorLogic'
...
describe('insightsFlowEditorLogic', () => {
    let logic: ReturnType<typeof insightsFlowEditorLogic.build>

    beforeEach(() => {
        initKeaTests()
        logic = insightsFlowEditorLogic()
        logic.mount()
    })
