...
from insights.schema import ExperimentSignificanceCode, ExperimentVariantFunnelsBaseStats
...
def calculate_probabilities_v2(
    ...
    Example:
    --------
    >>> from insights.schema import ExperimentVariantFunnelsBaseStats
    >>> from products.experiments.backend.insightsql_queries.funnels_statistics_v2 import calculate_probabilities_v2
...
def calculate_credible_intervals_v2(variants: list[ExperimentVariantFunnelsBaseStats]) -> dict[str, list[float]]:
    ...
    --------
    >>> from insights.schema import ExperimentVariantFunnelsBaseStats
    >>> from products.experiments.backend.insightsql_queries.funnels_statistics_v2 import calculate_credible_intervals_v2
    >>> variants = [
