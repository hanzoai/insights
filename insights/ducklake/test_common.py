...
class TestResetDucklakeCatalog:
    ...
    @patch("insights.ducklake.common.is_dev_mode", return_value=False)
...
class TestInitializeDucklake:
    ...
    @patch("insights.ducklake.common.ensure_ducklake_catalog")
    @patch("insights.ducklake.common.duckdb")
    def test_auto_resets_on_version_mismatch_dev_mode(
        ...
        with patch("insights.ducklake.common.attach_catalog", side_effect=attach_side_effect):
    ...
    def test_raises_in_production_mode(
        ...
        with patch("insights.ducklake.common.attach_catalog", side_effect=version_exc):
    ...
    def test_raises_for_non_version_error_dev_mode(
        ...
        with patch("insights.ducklake.common.attach_catalog", side_effect=unrelated_exc):
...
class TestValidateDuckgresIdentifier:
    ...
    def test_accepts_safe_identifiers(self, ident):
        from insights.ducklake.common import validate_duckgres_identifier
