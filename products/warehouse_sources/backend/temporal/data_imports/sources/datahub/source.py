...
class DatahubSource(ResumableSource[DatahubSourceConfig, DatahubResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your DataHub instance URL and an access token to sync your metadata catalog — datasets, dashboards, charts, pipelines, owners, domains, glossary, and tags — into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/datahub",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
