...
class TestProjectSecretAPIKeyAdmin(BaseTest):
    def setUp(self):
        ...
        self.roll_url = f"/admin/insights/projectsecretapikey/{self.key.pk}/roll/"
        self.change_url = f"/admin/insights/projectsecretapikey/{self.key.pk}/change/"
    ...
    def test_add_page_is_disabled(self):
        response = self.client.get("/admin/insights/projectsecretapikey/add/")
