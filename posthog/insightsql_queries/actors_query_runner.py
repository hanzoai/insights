...
from posthog.insightsql.constants import InsightsQLGlobalSettings, InsightsQLQuerySettings
from posthog.insightsql.context import InsightsQLContext
from posthog.insightsql.parser import parse_expr, parse_order_expr
from posthog.insightsql.printer import prepare_and_print_ast
from posthog.insightsql.property import has_aggregation
from posthog.insightsql.resolver_utils import extract_select_queries

from posthog.api.person import PERSON_DEFAULT_DISPLAY_NAME_PROPERTIES
from posthog.insightsql_queries.actor_strategies import ActorStrategy, GroupStrategy, PersonStrategy
...
from posthog.insightsql_queries.query_runner import AnalyticsQueryRunner, ExecutionMode, QueryRunner, get_query_runner
    ...
    def to_query(self) -> ast.SelectQuery:
        ...
        with self.timings.measure("select"):
            ...
            if not self.query.source:
                ...
                # See https://github.com/Insights/posthog/pull/27131
                if (
                    self.calculating
