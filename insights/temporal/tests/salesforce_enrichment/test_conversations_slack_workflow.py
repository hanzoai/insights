...
from insights.temporal.salesforce_enrichment.conversations_slack_workflow import (
...
WORKFLOW_MODULE = "insights.temporal.salesforce_enrichment.conversations_slack_workflow"
...
def _signals(
    ...
    return ConversationsSlackSignals(
        insights_organization_id=org_id,
        ...
        most_recent_support_ticket_url=f"https://us.hanzo.ai/project/2/support/tickets/{1000 if org_id == 'org-1' else 1001}",
...
class TestPrepareConversationsSlackUpdateRecord(SimpleTestCase):
    def test_formats_datetime_fields_per_salesforce_field_type(self):
        ...
        assert record == {
            ...
            "Most_Recent_Support_Ticket__c": "https://us.hanzo.ai/project/2/support/tickets/1000",
    ...
    def test_omits_none_fields(self):
        signals = ConversationsSlackSignals(
            insights_organization_id="org-1",
...
class TestEnrichConversationsSlackPageActivity(SimpleTestCase):
    ...
    async def test_enriches_page_successfully(
        ...
        mock_get_page.return_value = [
            {"salesforce_account_id": "001ABC", "insights_org_id": "org-1"},
            {"salesforce_account_id": "001DEF", "insights_org_id": "org-2"},
        ]
    ...
    async def test_sfdc_transport_exception_propagates_for_retry(
        ...
        mock_get_page.return_value = [{"salesforce_account_id": "001ABC", "insights_org_id": "org-1"}]
