...
//
// Backed by pino, the Insights Node house logger (see nodejs/src/utils/logger.ts).
...
// x-csrftoken and x-insights-session-id carry per-user browser tokens that api.stream
