...
from insights.models import BatchExportDestination, Integration
...
def test_can_run_databricks_test_step_for_new_destination(
    ...
    with unittest.mock.patch("insights.batch_exports.http.get_destination_test") as mock_get_destination_test:
