...
import { Badge, BadgeProps } from 'lib/elements/Badge'
...
export function IconWithCount({
    ...
    return (
        <span className={clsx('relative inline-flex', className)}>
            {children}
            <Badge.Number count={count} size={size} position="top-right" showZero={showZero} status={status} />
        </span>
    )
}
...
export function IconWithBadge({
    ...
    return (
        <span className={clsx('relative inline-flex', className)}>
            {children}
            <Badge visible={!!content} content={content} size={size} position="top-right" status={status} />
        </span>
    )
}
...
const IconBase = forwardRef<SVGSVGElement, SVGAttributes<SVGSVGElement>>(function IconBase(
    { className, ...props },
    ref
) {
    return (
...
export function IconTextSize(props: IconProps): JSX.Element {
    return (
...
export function IconClipboardEdit(props: IconProps): JSX.Element {
    return (
        <IconBase fill="currentColor" {...props}>
...
export function IconNodeJS(props: IconProps): JSX.Element {
    return (
        <IconBase viewBox="0 0 256 282" fill="currentColor" {...props}>
...
export function IconHandClick(props: IconProps): JSX.Element {
    return (
...
export function SortableDragIcon(props: IconProps): JSX.Element {
    return (
...
export function IconFeedback(props: IconProps): JSX.Element {
    return (
...
export function IconSelectEvents(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconSelectAll(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconSurveys(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconOpenInApp(props: IconProps): JSX.Element {
    return (
        <IconBase aria-hidden="true" role="img" preserveAspectRatio="xMidYMid meet" {...props}>
            <path
                fill="currentColor"
...
export function IconSelectProperties(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fillRule="evenodd"
...
export function IconSwapHoriz(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
...
export function IconBlank(props: IconProps): JSX.Element {
    return <IconBase fill="currentColor" {...props} />
}

/** Material Design Radio Button Unchecked icon. */
export function IconRadioButtonUnchecked(props: IconProps): JSX.Element {
    return (
        <IconBase fill="currentColor" {...props}>
...
export function IconOffline(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconSync(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconSubtitlesOff(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <g fill="currentColor">
...
export function IconCalculate(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <g fill="currentColor">
...
export function IconSubArrowRight(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
...
export function IconGroupedEvents(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                clipRule="evenodd"
...
export function IconCumulativeChart(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconAreaChart(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconTableChart(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
/** SQL insights: curly brackets (matching `IconBrackets` from `@hanzo/icons`) wrapping a bar chart. */
export function IconBracketsChart(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fillRule="evenodd"
...
export function IconInsightRetention(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
...
export function IconInsightUserPaths(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconInsightLifecycle(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
...
export function IconInsightCalendarHeatmap(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
...
export function IconInsightNumber(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function Icon123(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                d="M7,15H5.5v-4.5H4V9h3V15z M13.5,13.5h-3v-1h2c0.55,0,1-0.45,1-1V10c0-0.55-0.45-1-1-1H9v1.5h3v1h-2c-0.55,0-1,0.45-1,1V15 h4.5V13.5z M19.5,14v-4c0-0.55-0.45-1-1-1H15v1.5h3v1h-2v1h2v1h-3V15h3.5C19.05,15,19.5,14.55,19.5,14z"
...
export function IconCohort(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconExclamation(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <g fill="currentColor">
...
export function IconErrorOutline(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconRecording(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconQuestionAnswer(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconGitlab(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconGoogle(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconOpenInNew(props: IconProps): JSX.Element {
    return (
        <IconBase width="1em" height="1em" viewBox="0 0 24 24" {...props}>
            <path
...
export function IconTrendingFlat(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
...
export function IconTrendingFlatDown(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconFlare(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconQueryEditor(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fill="currentColor"
...
export function IconAction(props: IconProps): JSX.Element {
    return (
...
export function IconEvent(props: IconProps): JSX.Element {
    return (
        <IconBase viewBox="0 0 20 10" {...props}>
            <path
...
export function IconCancel(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconPremium(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconReplay(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconHeatmap(props: IconProps): JSX.Element {
    return (
        <IconBase width="1em" height="1em" viewBox="0 0 32 32" {...props}>
            <path
...
export const IconUnverifiedEvent = forwardRef<SVGSVGElement, IconProps>(function IconUnverifiedEvent(props, ref) {
    return (
...
export function IconVerifiedEvent(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fillRule="evenodd"
...
export function IconTuning(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fill="currentColor"
...
export function IconBookmarkBorder(props: IconProps): JSX.Element {
    return (
        <IconBase viewBox="-4 -3 24 24" {...props}>
            <path
...
export function IconSlack(props: IconProps): JSX.Element {
    return (
        <IconBase viewBox="0 0 2447.6 2452.5" {...props}>
...
export function IconSlackExternal(props: IconProps): JSX.Element {
    return (
        <IconBase viewBox="-2 -2 24 24" {...props}>
...
export function IconMicrosoftTeams(props: IconProps): JSX.Element {
    return (
...
export function IconTwilio(props: IconProps): JSX.Element {
    return (
...
export function IconDatabricks(props: IconProps): JSX.Element {
    return (
        <IconBase viewBox="0 0 300 325" {...props}>
            <path
                fill="currentColor"
...
export function IconChrome(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fill="currentColor"
...
export function IconFirefox(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fill="currentColor"
...
export function IconMicrosoftEdge(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fill="currentColor"
...
export function IconSafari(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fill="currentColor"
...
export function IconOpera(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fill="currentColor"
...
export function IconInternetExplorer(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fill="currentColor"
...
export function IconBlackberry(props: IconProps): JSX.Element {
    return (
        <IconBase viewBox="0 0 24 24" {...props}>
            <path
                fill="currentColor"
...
export function IconUCBrowser(props: IconProps): JSX.Element {
    return (
        <IconBase viewBox="0 0 24 24" {...props}>
            <circle
                cx="9.79"
...
export function IconSamsungInternet(props: IconProps): JSX.Element {
    return (
        <IconBase viewBox="0 0 24 24" {...props}>
            <path
                stroke="currentColor"
...
/** Material Web icon. */
export function IconWeb(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fill="currentColor"
...
export function IconListView(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconGridView(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconDevices(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fill="currentColor"
...
export function IconMacOS(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fill="currentColor"
...
export function IconAppleIOS(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fill="currentColor"
...
export function IconWindows(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fill="currentColor"
...
export function IconLinux(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fill="currentColor"
...
export function IconAndroidOS(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fill="currentColor"
...
export function IconPreview(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
                fill="currentColor"
...
export function IconEyeHidden(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconFunnelHorizontal(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconFunnelVertical(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
...
export function IconPauseCircle(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconSkipBackward(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconSkipStart(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
...
export function IconSkipEnd(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
...
export function IconDragHandle(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconDocumentExpand({ mode, ...props }: IconProps & { mode: 'expand' | 'collapse' }): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconAdsClick(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
...
export function IconFingerprint(props: IconProps): JSX.Element {
    return (
        <IconBase viewBox="1 1 23 23" {...props}>
            <path
...
export function IconVerticalAlignCenter(props: IconProps): JSX.Element {
    return (
        <IconBase viewBox="0 0 24 24" {...props}>
            <path
...
export function IconRecordingClip(props: IconProps): JSX.Element {
    return (
        <IconBase viewBox="0 0 24 24" {...props}>
...
export function IconGhost(props: IconProps): JSX.Element {
    return (
        <IconBase viewBox="0 0 24 24" {...props}>
            <path
...
export function IconSanta(props: IconProps): JSX.Element {
    return (
        <IconBase viewBox="0 0 24 24" {...props}>
            <path
...
export function IconChristmasOrnament(props: IconProps): JSX.Element {
    return (
