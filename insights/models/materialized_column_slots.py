...
class MaterializedColumnSlot(UUIDTModel):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["team", "property_type", "slot_index"], name="insights_mat_team_ty_idx"),
            models.Index(fields=["backfill_temporal_workflow_id"], name="insights_mat_backfi_idx"),
        ]
