...
/** Global template with no owning team (Insights built-ins). Staff may still narrow to the current team via API; used here for delete restrictions. */
...
export const DashboardTemplatesTable = (): JSX.Element | null => {
    ...
    const columns: TableColumns<DashboardTemplateType> = [
        ...
        },
        {
            ...
            render: (_, { scope }) => {
                ...
                if (scope === 'organization') {
                    return <Snack>Organization</Snack>
                }
        ...
        ) as TableColumn<DashboardTemplateType, keyof DashboardTemplateType | undefined>,
        {
            width: 0,
                                        ...
                                        disabledReason={
                                            scope === 'global'
                                                ? builtInOfficial
                                                    ...
                                                    : 'Cannot delete a global template until it is project-only'
                                                : undefined
                                        }
                                    >
                                        Delete dashboard
