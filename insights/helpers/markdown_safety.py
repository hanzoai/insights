...
surface (e.g. Slack) that would auto-unfurl or linkify them; only Insights hosts survive.
"""
...
_ALLOWED_LINK_URLS = ["https://hanzo.ai", "https://*.hanzo.ai"]
...
def strip_external_links_markdown(markdown: str) -> str:
    """Drop images, keep only Insights links, and defang every other URL to a code span."""
    ...
    # Backtick-wrap a non-Insights orphan destination so the bare-URL rule's lookbehind keeps it inert.
