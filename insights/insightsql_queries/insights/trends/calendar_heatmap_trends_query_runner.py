from insights.schema import CalendarHeatmapQuery, ResolvedDateRangeResponse, TrendsQueryResponse
...
class CalendarHeatmapTrendsQueryRunner(TrendsQueryRunner):
    ...
    def _calculate(self):
        from insights.insightsql_queries.insights.trends.calendar_heatmap_query_runner import CalendarHeatmapQueryRunner
        ...
        return TrendsQueryResponse(
            ...
            insightsql=calendar_response.insightsql,
            modifiers=self.modifiers,
