...
class TestInsightsFlowAPI(APIBaseTest):
    ...
    def test_mcp_list_is_metadata_only_and_hides_action_secrets(self):
        ...
        mcp_response = self.client.get(f"/api/projects/{self.team.id}/hog_flows", HTTP_X_INSIGHTS_CLIENT="mcp")
    ...
    def test_mcp_update_rejects_graph_replacement(self):
        ...
        mcp_rename = self.client.patch(
            f"/api/projects/{self.team.id}/hog_flows/{flow_id}", {"name": "Renamed"}, HTTP_X_INSIGHTS_CLIENT="mcp"
        )
    ...
    def test_invalid_action_input_error_carries_the_field_message(self):
        ...
        response = self.client.post(f"/api/projects/{self.team.id}/hog_flows", hog_flow, HTTP_X_INSIGHTS_CLIENT="mcp")
...
class TestInsightsFlowSecretInputs(APIBaseTest):
    ...
    def test_function_shaped_trigger_secret_is_masked_on_read(self):
        ...
        listing = self.client.get(f"/api/projects/{self.team.id}/hog_flows", HTTP_X_INSIGHTS_CLIENT="mcp").json()
