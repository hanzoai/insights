...
from insights.session_recordings.playlist_filters import DEFAULT_RECORDING_FILTERS, convert_playlist_to_recordings_query
    ...
    try:
        ...
        hanzo_insights.capture_exception(
            ...
            properties={
                "playlist_id": playlist_id,
                "playlist_short_id": playlist.short_id if playlist else None,
                "insights_feature": "session_replay_playlist_counters",
            },
        )
        logger.exception(
