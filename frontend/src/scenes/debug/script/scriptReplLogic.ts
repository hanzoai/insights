...
import { VMState, newScriptCallable, newScriptClosure } from '@hanzo/scriptvm'

import api from 'lib/api'
import { execScriptAsync } from 'lib/script'
...
export interface scriptReplLogicValues {
    currentCode: string
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface scriptReplLogicActions {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface scriptReplLogicMeta {
...
export type scriptReplLogicType = MakeLogicType<
    scriptReplLogicValues,
    scriptReplLogicActions,
    Record<string, any>,
    scriptReplLogicMeta
>

export const scriptReplLogic = kea<scriptReplLogicType>([
    ...
    listeners(({ actions, values }) => ({
        ...
        runCode: async ({ code }) => {
            ...
            try {
                const res = await api.script.create(code, lastLocals, true)
            ...
            if (values.replChunks.length > 0) {
                ...
                if (replChunksLength > 1024 * 1024) {
                    ...
                    if (newCode.length > 1024 * 1024) {
                        ...
                        return [urls.debugScript(), undefined, undefined, { replace: true }]
                    }
                    return [urls.debugScript(), undefined, { code: newCode }, { replace: true }]
                }
    ...
    urlToAction(({ actions, values }) => ({
        [urls.debugScript()]: (_, __, { repl, code }, { method }) => {
