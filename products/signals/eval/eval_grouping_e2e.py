...
infrastructure (in-memory embedding store replaces Datastore + Kafka).
...
class EvalGroupingPipeline:
    ...
    def _setup(self, insights_client, openai_client, gateway_client, mock_temporal, limit, no_capture, online):
