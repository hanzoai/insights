...
export function getMarkdownNotebookDefaultRegistry(): NotebookComponentRegistry {
    return createMarkdownNotebookRegistry([
        ...
        makeDefinition({
            tagName: 'InsightsQLSQL',
            label: 'SQL (InsightsQL)',
            category: 'Code',
            description: 'InsightsQL SQL block',
            icon: <IconDatabase />,
            defaultProps: { code: '', returnVariable: 'insightsql_df', title: 'SQL (InsightsQL)' },
            getTitle: (node) => getCodeComponentTitle(node, 'SQL (InsightsQL)'),
            ViewComponent: CodeView,
        }),
        makeDefinition({
    ...
    return (
        <div className="MarkdownNotebook__component-edit">
            ...
            <div className="MarkdownNotebook__component-edit-footer">
                ...
                <Button size="small" icon={<IconPencil />} onClick={apply}>
                    Apply
                </Button>
            </div>
        </div>
