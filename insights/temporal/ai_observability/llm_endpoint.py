...
The raw-SDK builders for summarization live in ``insights.llm.gateway_client`` (importing
...
from insights.llm.gateway_client import ai_product_headers, resolve_ai_gateway_config
