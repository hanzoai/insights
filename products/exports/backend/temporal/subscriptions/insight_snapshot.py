...
from insights.caching.calculate_results import calculate_cache_key, calculate_for_query_based_insight
...
def _serialize_insight_result(result: InsightResult) -> dict[str, Any]:
    ...
    #
    # - Cost: result.result is arbitrary Datastore output and can reach several MB; strip_null_bytes
