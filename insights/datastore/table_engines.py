...
# - https://datastore.com/docs/en/engines/table-engines/mergetree-family/
# - https://datastore.com/docs/en/engines/table-engines/mergetree-family/replacingmergetree/
...
class MergeTreeEngine:
    ...
    def __str__(self):
        ...
        zk_path = f"/datastore/tables/{shard_key}/insights.{self.table}"
...
class Distributed:
    ...
    def __str__(self):
        ...
        cluster = self.cluster if self.cluster is not None else settings.DATASTORE_CLUSTER
...
class Buffer:
    ...
    https://datastore.com/docs/en/engines/table-engines/special/buffer.
    """
    ...
    def __str__(self):
        ...
        database = self.database if self.database is not None else settings.DATASTORE_DATABASE
        return (
