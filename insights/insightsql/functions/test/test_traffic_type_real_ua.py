...
def _find_matching_pattern(ua: str) -> str | None:
    ...
    Patterns are evaluated as regex by Datastore multiMatchAnyIndex at runtime,
...
class TestTrafficTypeIntegration(BaseTest):
    ...
    def _query_tagged(self, select: str, tag: str, extra_where: str = ""):
        ...
        # Explicit LIMIT — `BOT_USER_AGENTS` exceeds the default InsightsQL row cap
    ...
    def test_virt_properties_bot_ip_ranges(self):
        ...
        # source IP (published in Google's crawler ranges) identifies it (insights#66604).
        renderer_ua = (
