...
from insights.management.commands.audit_encrypted_field_keys import (
    CLEAN,
    EMPTY,
    LEGACY,
    PLAINTEXT,
...
class TestAuditFieldArgument(SimpleTestCase):
    ...
    def test_unknown_field_raises_clear_error_listing_available_fields(self):
        ...
        assert "insights.Integration.sensitive_config" in message
...
class TestAuditCommandEndToEnd(BaseTest):
    ...
    FIELD = "insights.Integration.sensitive_config"
