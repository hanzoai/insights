    ...
    return [
                ...
                <>
                    <CalloutBox type="info" icon="IconInfo" title="Full working examples">
                        <Markdown>
                            ...
                            the [Node.js
                            wrapper](https://github.com/Insights/insights-js/tree/e08ff1be/examples/example-ai-langgraph)
                            and [Python
                            wrapper](https://github.com/Insights/insights-python/tree/7223c52/examples/example-ai-langgraph)
                            examples.
                        </Markdown>
                    </CalloutBox>
                        ...
                        blocks={[
                            {
                                ...
                                file: 'Python',
                                code: dedent`
                                    pip install langgraph langchain-core langchain-openai opentelemetry-sdk "insights[otel]" opentelemetry-instrumentation-langchain
                                `,
                            },
                            {
                                language: 'bash',
                                file: 'Node',
                                code: dedent`
                                    npm install @langchain/langgraph @langchain/openai @langchain/core zod @hanzo/ai @opentelemetry/sdk-node @opentelemetry/resources @traceloop/instrumentation-langchain
                                `,
                            },
                        ]}
                    />
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        Configure OpenTelemetry to auto-instrument LangChain calls and export traces to Insights.
                        LangGraph is built on LangChain, so the same instrumentation captures all LLM calls. Insights
