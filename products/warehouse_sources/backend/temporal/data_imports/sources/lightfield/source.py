...
class LightfieldSource(SimpleSource[LightfieldSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Lightfield",
            caption="""Enter your Lightfield API key to pull your Lightfield CRM data into the Insights Data warehouse.
...
- `emails:read` - emails
""",
            docsUrl="https://hanzo.ai/docs/cdp/sources/lightfield",
