...
describe('ClientWarnings consumer E2E', () => {
    const testWithTeamIngester = createTestWithTeamIngester({}, (infra) => {
        ...
        // produces to — so the registry's warnings producer reaches Datastore.
    ...
    testWithTeamIngester('produces a client_ingestion_warning to Datastore', {}, async ({ ingester, team, token }) => {
