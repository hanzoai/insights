#!/usr/bin/env bash
# Wrapper script for mcp-grafana that connects to Insights Grafana via Tailscale.
#
# Insights's Grafana instances are reachable over Tailscale at plain HTTP hostnames
