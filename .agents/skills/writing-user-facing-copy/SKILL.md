...
description: >
  Sets the voice and word choices for any text a person reads in Insights: UI labels, buttons, tooltips, empty and error states, notifications, in-app messages, onboarding, docs, and support replies.
...
- ✅ "Wizard sets up Insights for you. The setup agent installs the SDK and wires up your first events."
