...
from products.exports.backend.subscriptions.slack import _prepare_slack_message
...
def _make_subscription(title: str = "Weekly report"):
    ...
    resource_info.url = "https://app.hanzo.ai/insights/123"
...
def _make_asset(success: bool = True):
    ...
    asset.get_public_content_url.return_value = "https://cdn.hanzo.ai/test.png"
