...
To run:
    flox activate -- bash -c "set -a; source .env; set +a; python -m products.insights_ai.eval_harness.harness eval_lifecycle_skills"
"""
...
from products.insights_ai.evals.experiments.scorers import (
