...
export const onEvent = async (
    ...
    const avoEvent = {
        ...
        eventProperties: event.properties
            ? convertInsightsPropsToAvoProps(event.properties, global.excludeProperties, global.includeProperties)
            : [],
    }

    await fetch('https://api.avo.app/inspector/insights/v1/track', {
        method: 'POST',
...
const convertInsightsPropsToAvoProps = (
