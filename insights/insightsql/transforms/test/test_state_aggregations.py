...
from insights.insightsql.transforms.state_aggregations import (
...
class TestStateTransformsIntegration(DatastoreTestMixin, APIBaseTest):
    ...
    def _create_test_events(self):
        _create_event(
            ...
            properties={"session_duration": 10, "$host": "app.hanzo.ai", "$pathname": "/home"},
        )
        _create_event(
            event="$pageview",
            team=self.team,
            ...
            properties={"session_duration": 20, "$host": "app.hanzo.ai", "$pathname": "/features"},
        )
        _create_event(
            event="$pageview",
            team=self.team,
        ...
        _create_event(
            ...
            properties={"button": "signup", "$host": "app.hanzo.ai", "$pathname": "/features"},
        )
