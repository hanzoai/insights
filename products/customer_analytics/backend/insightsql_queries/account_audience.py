"""Account selection for workflows batch audiences: InsightsQL over ``system.accounts``.
...
def list_account_external_ids_for_audience(
    ...
    response = execute_insightsql_query(query=query, team=team, user=_audience_principal(team))
