...
from insights.schema import SourceFieldInputConfig, SourceFieldSelectConfig
...
class TestHoneycombSource:
    ...
    def test_publishes_table_catalog_for_public_docs(self) -> None:
        ...
        # the hanzo.ai "Supported tables" section. Dropping the flag (or making get_schemas
