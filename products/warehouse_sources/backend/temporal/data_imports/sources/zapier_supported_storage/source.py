...
class ZapierSupportedStorageSource(SimpleSource[ZapierSupportedStorageSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Storage by Zapier store secret to pull your key/value store into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/zapier-supported-storage",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
