...
from insights.temporal.data_imports.sources.generated_configs import GoogleAdsIsMccAccountConfig, GoogleAdsSourceConfig
from insights.temporal.data_imports.sources.google_ads.google_ads import (
    GoogleAdsServiceAccountSourceConfig,
    get_schemas,
    google_ads_source,
)
from insights.temporal.data_imports.sources.google_ads.source import GoogleAdsSource
...
class TestGoogleAdsSourceValidation:
    ...
    @mock.patch("insights.temporal.data_imports.sources.google_ads.source.google_ads_client")
