...
// Only the slots (comment, columns, source, insights table, on clause,
...
const QUERY_SCENES: QueryScene[] = [
    ...
    },
    {
        ...
        insightsTable: 'insights.sessions',
    ...
    },
    {
        ...
        insightsTable: 'insights.persons',
    ...
    },
    {
        ...
        insightsTable: 'insights.cohorts',
...
function DataWarehouseQueryInner(): JSX.Element {
    ...
    const handleConnectClick = (): void => {
        insights.capture('dwh onboarding connect clicked', { variant: 'query' })
        setPhase('setup')
    }

    const handleSourceConnected = (): void => {
        insights.capture('dwh onboarding source connected', { variant: 'query' })
        ...
        >
            {phase === 'value-prop' ? (
                <div className="max-w-2xl mx-auto mt-4 space-y-5">
                    ...
                    {/* InsightsQL query — fixed skeleton, animated slots */}
                    <div
                    ...
                    >
                        ...
                        {/* JOIN — keyword static, insights table slide */}
                        <div>
                            <span className="text-[#c678dd]">JOIN</span>
                            <span className="text-[#abb2bf]"> </span>
                            {slideSlot(
                                <span className="inline-flex items-center gap-1.5">
                                    <img src={IconInsights} alt="" className="size-4 inline-block" />
                                    <span className="text-[#98c379]">{s.insightsTable}</span>
                                </span>
                            )}
                        </div>
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-sm text-muted">
                            Import from your CRM, payment provider, or database and query it with InsightsQL — right
