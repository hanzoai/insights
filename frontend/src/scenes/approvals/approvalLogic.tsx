...
export interface approvalLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface approvalLogicActions {
    loadAllMembers: () => {
        value: true
    } // membersLogic
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface approvalLogicMeta {
    key: string
...
export type approvalLogicType = MakeLogicType<
    approvalLogicValues,
    approvalLogicActions,
    ApprovalLogicProps,
    approvalLogicMeta
>
...
export const approvalLogic = kea<approvalLogicType>([
    ...
    selectors({
        ...
        breadcrumbs: [
            (s) => [s.changeRequest],
            (changeRequest: ChangeRequest | null): Breadcrumb[] => [
                {
                    key: Scene.Settings,
                    name: 'Approvals',
                    path: urls.approvals(),
