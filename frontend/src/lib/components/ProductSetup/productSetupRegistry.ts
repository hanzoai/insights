...
export const AI_TASKS: SetupTask[] = [
    ...
    },
    {
        ...
        taskType: 'ai',
        requiresManualCompletion: true,
        docsUrl: 'https://hanzo.ai/code',
    },
    {
        id: SetupTaskId.UseInsightsMcp,
        title: 'Try Insights MCP',
        description:
            'Query your Insights data in plain English from your coding agent — run funnels, check errors, and toggle flags without leaving your editor.',
        taskType: 'ai',
        requiresManualCompletion: true,
        docsUrl: 'https://hanzo.ai/mcp',
    },
    {
        id: SetupTaskId.UseInsightsInSlack,
        title: 'Try Insights in Slack',
        description:
            'Tag @Insights in any Slack thread to ask data questions, run SQL, and draft pull requests — plus get insights and alerts delivered to your channels.',
        taskType: 'ai',
        requiresManualCompletion: true,
