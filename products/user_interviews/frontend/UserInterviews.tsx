    ...
    const card = (
        <div className="border rounded p-3 hover:bg-accent-highlight-secondary">
            <div className="flex items-center gap-2 mb-1 text-sm">
                <Tag type="muted">{result.document_type}</Tag>
        ...
        <SceneContent>
            <SceneTitleSection
                ...
                actions={
                    <Button
                        ...
                        data-attr="new-topic"
                        onClick={() => openMax?.()}
                        disabledReason={openMax ? undefined : 'Insights AI is unavailable here'}
                    >
                        New topic
                    </Button>
                }
            ...
            {hasSearch ? (
                ...
                <Table
                    ...
                    columns={[
                        {
                            ...
                            render: (_, row: UserInterviewTopicApi) => (
                                <TableLink title={row.topic} to={urls.userInterview(row.id)} />
                            ),
                        },
                        {
                            title: 'Targeting',
                    ...
                    emptyState="No topics yet. Click 'New topic' to get started with Insights AI."
                />
            )}
        </SceneContent>
    )
