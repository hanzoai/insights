...
from insights.queries.trends.sql import LIFECYCLE_EVENTS_QUERY, LIFECYCLE_SQL
from insights.queries.trends.util import parse_response
from insights.queries.util import get_person_properties_mode
...
class Lifecycle:
    ...
    def get_people(self, filter: LifecycleFilter, team: Team):
        from insights.queries.trends.lifecycle_actors import LifecycleActors
