...
class TestActivityAndWorkflowTypes:
    def test_activity_types_match_actual_defns(self):
        from insights.temporal.llm_analytics.trace_clustering.activities import (
    ...
    def test_workflow_types_match_actual_defns(self):
        from insights.temporal.llm_analytics.trace_clustering.constants import WORKFLOW_NAME
...
class TestCounterHelpers:
    ...
    def test_counter_emits_in_temporal_context(self, _name, fn, args):
        ...
        with patch(
            "insights.temporal.llm_analytics.trace_clustering.metrics.get_metric_meter",
    ...
    def test_increment_errors_emits_in_temporal_context(self, _name, in_act, in_wf):
        ...
        with (
            patch("insights.temporal.llm_analytics.trace_clustering.metrics.activity") as mock_activity,
            patch("insights.temporal.llm_analytics.trace_clustering.metrics.workflow") as mock_workflow,
            patch(
                "insights.temporal.llm_analytics.trace_clustering.metrics.get_metric_meter",
                return_value=mock_meter,
            ),
