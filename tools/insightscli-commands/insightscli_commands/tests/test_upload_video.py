"""Tests for insightscli pr:upload-video.
...
from insightscli_commands import pr_assets, upload_video

_URL_RE = r"https://raw\.githubusercontent\.com/Insights/pr-assets/deadbeef/\d{4}/\d{2}/[0-9a-f-]+\.mp4"
