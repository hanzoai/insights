...
import type { ComposerSeed } from '../../../../products/insights_ai/frontend/logics/composerSeedLogic'
 ...
 * the new Insights AI view is rendered, leaving the legacy `maxLogic` query handling unchanged.
 */
