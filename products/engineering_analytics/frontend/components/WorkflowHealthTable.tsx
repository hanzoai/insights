...
import { Table, TableColumns, Tag, Link } from '@hanzo/elements'
...
export interface WorkflowHealthTableProps {
    ...
    dataAttr?: string
    /** Drop the table's own border when it sits inside a Card (the hub) — avoids a double frame. */
    embedded?: boolean
...
export function WorkflowHealthTable({
    ...
    const columns: TableColumns<WorkflowHealthRow> = [
        {
            title: 'Workflow',
            key: 'workflowName',
        ...
        ...((showCost
            ...
            : []) as TableColumns<WorkflowHealthRow>),
        {
            title: 'Δ',
