...
// Radix-style compound suggestions surface: a logic-free button row ("Try Insights AI for…") plus an
...
export interface SuggestionsButtonsProps {
    ...
    /** The label above the row. Defaults to the Insights AI prompt; pass `null` to hide it. */
    tip?: ReactNode
