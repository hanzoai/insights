...
class GlassfrogSource(SimpleSource[GlassfrogSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your GlassFrog API key to sync your organization's circles, roles, people, projects, metrics, and checklist items into the Insights Data warehouse.
...
You can create a v3 API key in GlassFrog under [Profile & Settings > API](https://app.glassfrog.com/). The key grants access at your user's permission level.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/glassfrog",
