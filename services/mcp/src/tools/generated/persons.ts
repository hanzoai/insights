...
const personsList = (): ToolBase<typeof PersonsListSchema, WithInsightsUrl<Schemas.PaginatedPersonRecordList>> => ({
    name: 'persons-list',
    ...
    handler: async (context: Context, params: z.infer<typeof PersonsListSchema>) => {
        ...
        return await withInsightsUrl(context, filtered, '/persons')
    },
})
...
const personsRetrieve = (): ToolBase<typeof PersonsRetrieveSchema, WithInsightsUrl<Schemas.PersonRecord>> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof PersonsRetrieveSchema>) => {
        ...
        return await withInsightsUrl(context, filtered, `/persons/${filtered.id}`)
    },
})
