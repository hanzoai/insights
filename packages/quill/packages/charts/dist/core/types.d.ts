...
export declare const DEFAULT_Y_AXIS_ID = "left";
...
export type ResolvedSeries<Meta = unknown> = Series<Meta> & {
    color: string;
};
...
export declare const DEFAULT_SERIES_TYPE: SeriesType;
...
export type AxisLinesConfig = boolean | {
    x?: boolean;
    y?: boolean;
};
export declare function resolveAxisLines(value: AxisLinesConfig | undefined): {
    x: boolean;
    y: boolean;
};
...
export declare const defaultResolveValue: ResolveValueFn;
...
export interface ChartScales {
    ...
    bandSlotAtCursor?: (label: string, cursor: {
        x: number;
        y: number;
    }) => BandSlot | undefined;
