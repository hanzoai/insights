...
When users ask the agent to find or modify a Insights entity by name
...
To run::
    ...
    flox activate -- bash -c "set -a; source .env; set +a; python -m products.insights_ai.eval_harness.harness eval_system_table_search"
"""
...
from products.insights_ai.evals.retrieval.scorers import InfoCalledBeforeTool, InformationSchemaBeforeSql
