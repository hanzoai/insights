"""Per-report signal metadata read off Datastore, outside the temporal package.

Signals live as embedding documents in Datastore; this module answers "what backs this
...
# Datastore query filters on it.
EMBEDDING_MODEL = EmbeddingModelName.TEXT_EMBEDDING_3_SMALL_1536


@dataclass(frozen=True)
class ReportSignalMeta:
    """Per-report signal metadata read off Datastore for the inbox list/detail views."""
