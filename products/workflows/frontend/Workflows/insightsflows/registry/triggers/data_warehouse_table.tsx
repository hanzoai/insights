...
export function isDataWarehouseTableTriggerConfig(
    config: Extract<InsightsFlowAction, { type: 'trigger' }>['config']
...
function StepTriggerConfigurationDataWarehouseTable({ node }: { node: any }): JSX.Element {
    ...
    return (
        <div className="flex flex-col gap-2 w-full">
            ...
            <Field.Pure label="Data warehouse table" error={validationResult?.errors?.table_name}>
                <Select
                ...
                />
                {hasNoTables && (
                    <Banner type="warning" className="w-full mt-1">
                        <p className="mb-0">
            ...
            <Field.Pure label="Only trigger for specific rows">
