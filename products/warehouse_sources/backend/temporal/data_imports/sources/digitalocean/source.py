...
class DigitalOceanSource(SimpleSource[DigitalOceanSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter a DigitalOcean personal access token to pull your DigitalOcean infrastructure and billing data into the Insights Data warehouse.
...
Create a token under [API → Tokens](https://cloud.digitalocean.com/account/api/tokens) with at least **Read** scope.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/digitalocean",
