...
from ee.hogai.chat_agent.sql.mixins import InsightsQLGeneratorMixin, SQLSchemaGeneratorOutput
...
class TestSQLMixins(NonAtomicBaseTest):
    ...
    def _get_node(self):
        class DummyNode(InsightsQLGeneratorMixin):
            pass
    ...
    def test_parse_output_success_path(self):
        """Test successful parsing in InsightsQLGeneratorMixin."""
        mixin = self._node
        ...
        self.assertEqual(
            ...
            SQLSchemaGeneratorOutput(
                query=AssistantInsightsQLQuery(query="SELECT count() FROM events"), name="", description=""
            ),
        )
    ...
    async def test_quality_check_output_success_with_placeholders(self):
        ...
        valid_output = SQLSchemaGeneratorOutput(
            query=AssistantInsightsQLQuery(query="SELECT properties FROM events WHERE {filters}"), name="", description=""
        )
    ...
    async def test_quality_check_output_invalid_syntax_raises_exception(self):
        ...
        invalid_output = SQLSchemaGeneratorOutput(
            query=AssistantInsightsQLQuery(query="SELECT * FROM nowhere"), name="", description=""
        )
    ...
    async def test_quality_check_output_blank_query_raises_exception(self):
        ...
        blank_output = SQLSchemaGeneratorOutput(query=AssistantInsightsQLQuery(query=""), name="", description="")
    ...
    async def test_quality_check_output_no_viable_alternative_error_handling(self):
        ...
        invalid_syntax_output = SQLSchemaGeneratorOutput(
            query=AssistantInsightsQLQuery(query="SELECT FROM events"),
            name="",
        ...
        self.assertIn("query isn't valid InsightsQL", context.exception.validation_message)
    ...
    async def test_quality_check_output_nonexistent_table_raises_exception(self):
        ...
        invalid_table_output = SQLSchemaGeneratorOutput(
            query=AssistantInsightsQLQuery(query="SELECT count() FROM nonexistent_table"), name="", description=""
        )
    ...
    async def test_quality_check_output_complex_query_with_joins(self):
        ...
        complex_output = SQLSchemaGeneratorOutput(
            query=AssistantInsightsQLQuery(
