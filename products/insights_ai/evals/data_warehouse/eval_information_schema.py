...
To run a single eval::
    ...
    flox activate -- bash -c "set -a; source .env; set +a; python -m products.insights_ai.eval_harness.harness eval_dw_discovery"
"""
...
from products.insights_ai.evals.data_warehouse.scorers import (
    AgenticSearchUsed,
...
from products.insights_ai.evals.data_warehouse.seeder import seed_warehouse_schema
from products.insights_ai.evals.data_warehouse.synthesizer import (
    CHAIN_NEEDLE_HOP3,
    DESC_NEEDLE_TABLE,
    REL_NEEDLE_SOURCE,
    REL_NEEDLE_TARGET,
