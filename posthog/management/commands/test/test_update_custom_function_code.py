...
class TestUpdateCustomFunctionCode(BaseTest):
    def setUp(self):
        super().setUp()
        ...
        with patch("posthog.models.custom_functions.custom_function.reload_custom_functions_on_workers"):
            ...
            self.linkedin_function1 = CustomFunction.objects.create(
                team=self.team,
            ...
            self.linkedin_function2 = CustomFunction.objects.create(
                team=self.team,
            ...
            self.other_function = CustomFunction.objects.create(
                team=self.team,
                name="Other Function",
                type="destination",
    ...
    def test_missing_replace_key(self):
        ...
        out = StringIO()
        call_command("update_custom_function_code", stdout=out)
