...
class NotionSource(ResumableSource[NotionSourceConfig, NotionResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Notion internal integration token to pull your Notion data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/notion",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
