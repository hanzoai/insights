...
export function ticketActivityDescriber(logItem: ActivityLogItem, asNotification?: boolean): HumanizedChange {
    ...
    // When a InsightsFlow workflow step made the change, attribute it to (and link to) the workflow
    // instead of the generic "Insights" system actor. The workflow name is resolved live by id
