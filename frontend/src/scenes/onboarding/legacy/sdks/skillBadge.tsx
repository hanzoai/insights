...
/**
 * Wizard `skill_id` → Insights SDKKey. The CLI uses hyphenated framework names
 * (`react-native`) while Insights's SDK catalogue uses underscored enum keys
...
const WIZARD_SKILL_TO_SDK_KEY: Record<string, SDKKey> = {
    ...
    vue: SDKKey.VUE_JS,
    // No Insights SDK match yet — fastapi, flask, tanstack-router fall through to
