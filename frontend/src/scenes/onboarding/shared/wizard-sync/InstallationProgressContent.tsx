        ...
        >
            ...
            <div className="flex items-start justify-between gap-2">
                ...
                <div className="flex items-start gap-1 shrink-0">
                    {phase === 'completed' && <MascotWizard className="w-14 h-14 -my-2" aria-hidden="true" />}
            ...
            {phase === 'error' && (
                ...
                <div className="flex flex-wrap gap-2">
                    {onRetryLocally && (
                        <Button type="primary" onClick={onRetryLocally} icon={<IconTerminal />}>
                            Run it yourself
                        </Button>
                    )}
                    <Button
                        type={onRetryLocally ? 'secondary' : 'primary'}
                        to="https://hanzo.ai/docs/getting-started/install"
                        targetBlank
                    >
                        Read the docs
                    </Button>
            ...
            {prUrl && prMerged && phase !== 'error' && (
                <Banner type="success" icon={<IconPullRequest />} className="ph-no-capture">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Button type="secondary" size="small" to={prUrl} targetBlank className="shrink-0">
                            View PR
                        </Button>
                    </div>
                </Banner>
