...
def test_format_results_traces_filter_generation():
    ...
    assert "https://us.hanzo.ai/ai-observability/traces?filters=" in markdown
...
def test_format_results_dataset_link():
    ...
    expected_link = f"https://us.hanzo.ai/ai-evals/datasets/{dataset_id}"
...
def test_results_formatter_build_traces_url():
    ...
    # Should contain properly encoded traces URL
    assert "https://us.hanzo.ai/ai-observability/traces?filters=" in traces_url
