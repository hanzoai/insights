...
pub fn test_context() -> RequestContext {
    RequestContext {
        ...
        sdk_info: "insights-rs/1.0.0".to_string(),
        attempt: 1,
...
/// A realistic $pageview event with typical insights-js properties.
pub fn realistic_pageview(distinct_id: &str) -> WrappedEvent {
    ...
    WrappedEvent {
        event: Event {
            ...
            properties: raw_obj(
                r#"{"$current_url":"https://app.example.com/dashboard","$referrer":"https://google.com","$browser":"Chrome","$browser_version":"120.0","$os":"Mac OS X","$lib":"insights-js","$lib_version":"1.150.0","custom_prop":42}"#,
            ),
        },
        uuid,
        options: Options {
