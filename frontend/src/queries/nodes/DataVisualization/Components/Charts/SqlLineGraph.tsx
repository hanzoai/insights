...
import { DefaultTooltip, TimeSeriesLineChart, type PointClickData, type TooltipContext } from '@hanzo/quill-charts'
...
/**
 * SQL line/area graph rendered via @hanzo/quill-charts. The default SQL chart renderer (see
