 ...
 */
export const PRIORITY_TAG_TYPE: Record<SignalReportPriority, TagType> = {
    P0: 'danger', // red
    P1: 'warning', // orange
    P2: 'caution', // amber
    P3: 'highlight', // blue
...
/** Matching CSS accent per priority, for non-Tag surfaces (filter dots, monograms). */
...
// Port of desktop `@hanzo/ui/features/inbox/filterOptions`. Drives the Source /
