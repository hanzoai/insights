...
class DataForSEOSource(ResumableSource[DataForSEOSourceConfig, DataForSEOResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your DataForSEO API credentials and the domains you want to track to pull SEO metrics like Google rankings, keywords, competitors, and backlinks into the Insights Data warehouse.
...
Note: DataForSEO bills per API request, so every sync consumes account credits. The backlinks summary table also requires an active Backlinks API subscription.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/dataforseo",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
                    ...
                    SourceFieldInputConfig(
                        ...
                        type=SourceFieldInputConfigType.TEXT,
                        required=True,
                        placeholder="example.com, hanzo.ai",
                        secret=False,
                    ),
                    SourceFieldInputConfig(
                        name="location_name",
