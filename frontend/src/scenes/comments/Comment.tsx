    ...
    return (
        <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
                ...
                {comment.is_task ? (
                    <Tag size="small" type={isCompleted ? 'success' : 'warning'}>
            ...
            <div className="flex items-center gap-1">
                ...
                <span className="opacity-0 transition-opacity group-hover:opacity-100 focus-within:opacity-100 has-[.Button--active]:opacity-100">
                    <EmojiPickerPopover
                        size="xsmall"
            ...
            <div className="flex items-center gap-3">
                {comment.is_task ? (
                    <>
                        ...
                        <Divider vertical className="self-stretch" />
                    </>
                ) : null}
                        ...
                        <div className="flex flex-col flex-1 min-w-0">
                            ...
                            {isEditing ? (
                                ...
                                <div className={clsx(comment.completed_at && 'line-through text-secondary')}>
                                    <Markdown lowKeyHeadings>{text}</Markdown>
                                </div>
                            )}
                        </div>
                    </div>
