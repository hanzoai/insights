...
//! pipeline. Depends on `datastore`, `kafka`, `store`, `domain`, and its `app` siblings.
//!
...
use crate::datastore::person_scanner::{PersonScanError, PersonScanner};
use crate::datastore::person_sql::PersonScanSpec;
use crate::domain::{
