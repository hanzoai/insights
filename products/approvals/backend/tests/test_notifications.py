...
class TestBuildChangeRequestUrl(TestApprovalNotifications):
    def test_builds_correct_url(self):
        with self.settings(SITE_URL="https://app.hanzo.ai"):
            ...
            expected = f"https://app.hanzo.ai/project/{self.team.project_id}/approvals/{self.change_request.id}"
...
class TestEmailTemplateRendering(TestApprovalNotifications):
    ...
    def test_approval_requested_template_renders(self, mock_is_email_available):
        ...
        with override_instance_config("EMAIL_HOST", "localhost"), self.settings(SITE_URL="https://app.hanzo.ai"):
            ...
            message = EmailMessage(
                ...
                subject="Test User needs your sign-off",
                template_context={
                    "change_request_url": "https://app.hanzo.ai/project/1/approvals/123",
                    "team_name": "Test Team",
