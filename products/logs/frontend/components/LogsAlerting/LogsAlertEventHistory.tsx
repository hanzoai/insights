...
import { Button, Modal, Table, TableColumns, Tag, TagType } from '@hanzo/elements'
...
function LogsAlertEventTimeline({ alert }: { alert: LogsAlertConfigurationApi }): JSX.Element {
    ...
    const columns: TableColumns<LogsAlertEventApi> = [
        {
            title: 'Event',
            render: (_, event) => {
        ...
        <div className="space-y-4">
            ...
            {hasMore ? (
                <div className="flex justify-center">
                    <Button type="secondary" size="small" onClick={loadMore} loading={eventsPageLoading}>
                        Load more{shownOf}
                    </Button>
                </div>
            ) : null}
