...
def _scan(*, bounded: bool) -> str:
    ...
    that remain are real InsightsQL placeholders, bound by ``scan_placeholders``.
    """
...
def selector_from_nodeid(nodeid: str) -> str:
    ...
    ('insights/api/test/test_x/TestX::test_y'); re-split on the convention that class segments are
