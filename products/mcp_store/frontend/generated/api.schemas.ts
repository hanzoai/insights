...
export interface GatewayAgentAccessApi {
    ...
    /** Agent display name. */
    name: string
    /** Agent identity handle, e.g. insights-support. */
    handle: string
...
export interface MCPServiceAccountApi {
    ...
    readonly name: string
    readonly description: string
    /** Stable internal identity handle for this Insights agent. */
    readonly handle: string
    /** Stable Insights agent identifier. */
...
export interface InstallCustomApi {
    ...
    insights_code_callback_url?: string
