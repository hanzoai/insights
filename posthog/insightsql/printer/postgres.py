...
from posthog.insightsql.errors import ImpossibleASTError, QueryError
from posthog.insightsql.escape_sql import escape_postgres_identifier
from posthog.insightsql.printer.base import InsightsQLPrinter


class PostgresPrinter(InsightsQLPrinter):
    def __init__(
        self,
