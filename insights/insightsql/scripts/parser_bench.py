...
Run from repo root:
    ...
    CANDIDATE_BACKEND=<some-fast-backend> \\
        PYTHONPATH=. python insights/insightsql/scripts/parser_bench.py
...
For deeper profiling, run the bench under `samply` or `py-spy`:
    ...
    samply record -- python insights/insightsql/scripts/parser_bench.py \\
...
from insights.insightsql.parser import InsightsQLParserShadowMismatch, clear_parse_caches, parse_expr, parse_select
from insights.insightsql.scripts._diagnostic_common import _abort_on_shadow_mismatch, _probe_backend
