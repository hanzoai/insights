...
from products.batch_exports.backend.temporal.sql.common import InsightsQLQueryBatchExportSettings, get_s3_function_call
from products.batch_exports.backend.temporal.sql.sessions import SELECT_FROM_SESSIONS_INSIGHTSQL
...
class SessionsRecordBatchModel(RecordBatchModel):
    ...
    def get_insightsql_query(
        ...
        insightsql_query = clone_expr(SELECT_FROM_SESSIONS_INSIGHTSQL)
...
class InsightsQLQueryRecordBatchModel(RecordBatchModel):
    ...
    def get_datastore_request_settings(self) -> dict[str, str]:
        ...
        return _as_datastore_request_settings(InsightsQLQueryBatchExportSettings())
