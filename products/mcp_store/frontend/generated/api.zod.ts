...
/**
 * Insights's built-in agents and their MCP access grants.
 *
...
export const mcpServerInstallationsInstallCustomCreateBodyInstallSourceDefault = `insights`
export const mcpServerInstallationsInstallCustomCreateBodyInsightsCodeCallbackUrlDefault = ``
...
export const McpServerInstallationsInstallCustomCreateBody = /* @__PURE__ */ zod.object({
    ...
    install_source: zod
        .enum(['insights', 'insights-code'])
        .describe('\* `insights` - insights\n\* `insights-code` - insights-code')
        .default(mcpServerInstallationsInstallCustomCreateBodyInstallSourceDefault),
    insights_code_callback_url: zod
        .string()
        .default(mcpServerInstallationsInstallCustomCreateBodyInsightsCodeCallbackUrlDefault),
    scope: zod
...
export const mcpServerInstallationsInstallTemplateCreateBodyInstallSourceDefault = `insights`
export const mcpServerInstallationsInstallTemplateCreateBodyInsightsCodeCallbackUrlDefault = ``
...
export const McpServerInstallationsInstallTemplateCreateBody = /* @__PURE__ */ zod.object({
    ...
    insights_code_callback_url: zod
        .string()
        .default(mcpServerInstallationsInstallTemplateCreateBodyInsightsCodeCallbackUrlDefault),
    scope: zod
        .enum(['personal', 'shared'])
        .describe('\* `personal` - personal\n\* `shared` - shared')
