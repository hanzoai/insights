...
from insights.api.utils import action, raise_if_user_provided_url_unsafe
...
from insights.models.feature_flag import TeamDefaultEvaluationTag
from insights.models.group_type_mapping import GROUP_TYPE_MAPPING_SERIALIZER_FIELDS, GroupTypeMapping
from insights.models.organization import OrganizationMembership
from insights.models.product_intent.product_intent import ProductIntentSerializer, calculate_product_activation
...
from insights.utils import get_instance_realm, get_instance_region, get_ip_address, get_week_start_for_country_code
...
class TeamViewSet(TeamAndOrgViewSetMixin, AccessControlViewSetMixin, viewsets.ModelViewSet):
    ...
    def perform_destroy(self, team: Team):
        from insights.tasks.tasks import delete_project_data_and_notify_task
