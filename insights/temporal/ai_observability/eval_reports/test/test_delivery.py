...
from insights.temporal.ai_observability.eval_reports.delivery import (
    _build_citation_map,
...
class TestDeliverReport(SimpleTestCase):
    ...
    @patch("insights.temporal.ai_observability.eval_reports.delivery.deliver_email_report")
    @patch("insights.temporal.ai_observability.eval_reports.delivery.deliver_slack_report")
