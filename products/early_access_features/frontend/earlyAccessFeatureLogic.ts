...
export interface earlyAccessFeatureLogicValues {
    ...
    earlyAccessFeatureErrors: DeepPartialMap<EarlyAccessFeatureType | NewEarlyAccessFeatureType, ValidationErrorType>
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface earlyAccessFeatureLogicActions {
    ...
    ) => Partial<EarlyAccessFeatureType | NewEarlyAccessFeatureType>
    ...
    showGAPromotionConfirmation: (onConfirm: (rolloutToAll: boolean) => void) => {
        onConfirm: (rolloutToAll: boolean) => void
    }
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface earlyAccessFeatureLogicMeta {
    key: string
...
export type earlyAccessFeatureLogicType = MakeLogicType<
    earlyAccessFeatureLogicValues,
    earlyAccessFeatureLogicActions,
    EarlyAccessFeatureLogicProps,
    earlyAccessFeatureLogicMeta
>
...
export const earlyAccessFeatureLogic = kea<earlyAccessFeatureLogicType>([
        ...
        earlyAccessFeature: {
            ...
            errors: ({ name, description, payload }) =>
                ({
                    ...
                    // Mirrors the backend rule: Insights's own project (US cloud, id 2) requires a description
    ...
    selectors(({ actions }) => ({
        ...
        projectTreeRef: [
            ...
            (id: string): ProjectTreeRef => ({ type: 'early_access_feature', ref: id === 'new' ? null : String(id) }),
        ],
        [SIDE_PANEL_CONTEXT_KEY]: [
            (s) => [s.earlyAccessFeature],
            (earlyAccessFeature: EarlyAccessFeatureType | NewEarlyAccessFeatureType): SidePanelSceneContext | null => {
        ...
        saveEarlyAccessFeatureFailure: ({ errorObject }) => {
            ...
            if (errorObject) {
                ...
                if (attr && detail) {
                    ...
                    toast.error(`Could not save early access feature: ${message}`)
                    return
                }
                if (detail) {
                    toast.error(`Could not save early access feature: ${detail}`)
                    return
                }
            }
            toast.error('Could not save early access feature.')
        },
