...
class CheckmarxSource(ResumableSource[CheckmarxSourceConfig, CheckmarxResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Checkmarx One credentials to automatically pull your application security data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/checkmarx",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
