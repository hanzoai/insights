import { ChartDimensions, ChartScales, ChartTheme, ResolvedSeries, ResolveValueFn } from './types';
import { Gutter } from './y-axis-gutters';
...
export declare const ChartLayoutContext: import('react').Context<ChartLayoutContextValue<unknown> | null>;
export declare const ChartHoverContext: import('react').Context<ChartHoverContextValue>;
...
export declare function useChartLayout<Meta = unknown>(): ChartLayoutContextValue<Meta>;
/** Subscribes to hover-only context. Re-renders on every hover index change. */
export declare function useChartHover(): ChartHoverContextValue;
...
export declare function useChart<Meta = unknown>(): BaseChartContext<Meta>;
