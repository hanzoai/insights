...
def _register_all_emitters() -> None:
    from insights.temporal.data_imports.signals.github_issues import GITHUB_ISSUES_CONFIG
    from insights.temporal.data_imports.signals.zendesk_tickets import ZENDESK_TICKETS_CONFIG
