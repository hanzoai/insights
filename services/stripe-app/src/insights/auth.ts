...
// Keep in sync with the secret names defined in insights/models/integration.py
export const SECRET_NAMES = {
    region: 'insights_region',
    accessToken: 'insights_access_token',
    refreshToken: 'insights_refresh_token',
    projectId: 'insights_project_id',
    oauthClientId: 'insights_oauth_client_id',
} as const
