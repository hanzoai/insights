...
class TestTagResponse:
    ...
    def test_falls_back_to_openai_request_id_header(self):
        with hanzo_insights.new_context():
            ...
            assert hanzo_insights.get_tags()["provider.last_request_id"] == "req_oai"
    ...
    def test_does_not_leak_tags_outside_the_context(self):
        ...
        assert "provider.last_status" not in hanzo_insights.get_tags()
        assert "provider.last_request_id" not in hanzo_insights.get_tags()
