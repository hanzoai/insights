...
import { resolveProductMeta } from '../messages/insightsProducts'

/**
 * Persistent "Insights resources used" bar for sandbox conversations. Reads the session-cumulative
...
export function ResourcesBar(): JSX.Element | null {
    ...
    return (
        <div className="flex flex-wrap items-center gap-1.5 px-3" data-attr="max-sandbox-resources-bar">
            <span className="text-xs text-muted mr-0.5">Insights resources used:</span>
