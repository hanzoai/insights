...
import type { DataNode, RefreshType } from '../../../../schema/schema-general'
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface variablesLogicActions {
    loadData: (
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface variablesLogicMeta {
    key: string
    __keaTypeGenInternalSelectorTypes: {
        queryVariableCodeNames: (editorQuery: string | null, arg: any) => string[]
...
export type variablesLogicType = MakeLogicType<
    variablesLogicValues,
    variablesLogicActions,
    VariablesLogicProps,
    variablesLogicMeta
>
...
export const variablesLogic = kea<variablesLogicType>([
    ...
    selectors({
        queryVariableCodeNames: [
            ...
            (editorQuery: string | null, sourceQuery): string[] => {
        ...
        variablesWithValues: [
            ...
            (variables: Variable[], internalSelectedVariables: InsightsQLVariable[]): Variable[] => {
        ...
        variablesUsedInQuery: [
            ...
            (variablesWithValues: Variable[], queryVariableCodeNames: string[], searchTerm: string): Variable[] => {
                const queryCodeNames = new Set(queryVariableCodeNames)
                const trimmedSearch = searchTerm.trim().toLowerCase()
