...
from posthog.insightsql_queries.query_runner import ExecutionMode, QueryRunner
from posthog.insightsql_queries.utils.query_date_range import QueryDateRange
from posthog.models.team.team import Team, WeekStartDay

from products.customer_analytics.backend.constants import DEFAULT_ACTIVITY_EVENT
from products.revenue_analytics.backend.insightsql_queries.test.data.structure import REVENUE_ANALYTICS_CONFIG_SAMPLE_EVENT
...
class TestQueryRunner(BaseTest):
    ...
    @mock.patch("posthog.insightsql_queries.query_runner.get_query_cache_manager")
