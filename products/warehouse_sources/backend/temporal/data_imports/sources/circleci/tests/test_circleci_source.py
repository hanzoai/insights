...
class TestCircleCISource:
    def setup_method(self):
        ...
        self.team_id = 123
        self.config = CircleCISourceConfig(api_token="circle-token", org_slug="gh/insights")
    ...
    @parameterized.expand(
        [
            ("401 Client Error: Unauthorized for url: https://circleci.com/api/v2/pipeline?org-slug=gh%2Finsights",),
            ("403 Client Error: Forbidden for url: https://circleci.com/api/v2/workflow/abc/job",),
            ("404 Client Error: Not Found for url: https://circleci.com/api/v2/project/gh/insights/insights",),
        ]
    )
    ...
    def test_source_for_pipeline_plumbs_arguments(self, mock_circleci_source):
        ...
        assert kwargs["org_slug"] == "gh/insights"
