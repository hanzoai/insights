...
const SUMMARY = 'Insights AI Support Ticket Summary:\n\nIssue: Session recordings are not appearing in the dashboard.'
const SUMMARY_WITH_TOPIC = `${SUMMARY}\n\n**Topic:** session_replay`
const DENIAL =
    'The `/ticket` command is available for customers on paid plans or active trials. You can upgrade your plan in the billing settings, or ask the community at https://hanzo.ai/questions for help. If your issue is about billing, you can always contact our support team through the in-app help panel.'
