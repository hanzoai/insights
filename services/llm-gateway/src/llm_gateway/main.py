...
from llm_gateway.rate_limiting.denial_event import InsightsDenialCapturer
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None]:
    ...
    denial_capturer: InsightsDenialCapturer | None = None
    if settings.insights_project_token:
        denial_capturer = InsightsDenialCapturer(
    ...
    logger.info("Plan resolver initialized", insights_api_base_url=settings.insights_api_base_url or "(not configured)")
