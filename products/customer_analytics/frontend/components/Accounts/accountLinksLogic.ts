...
const BILLING_ADMIN_ORIGIN = 'https://billing.hanzo.ai'
const SLACK_ARCHIVES_ORIGIN = 'https://insights.slack.com/archives'
...
export interface accountLinksLogicValues {
    currentTeamId: number | null // teamLogic
    account: AccountApi | null
    accountLoading: boolean
    currentFieldValues: AccountLinkFieldValues
    editorOpen: boolean
    formValues: AccountLinkFieldValues
    links: AccountLink[]
    savingLinks: boolean
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface accountLinksLogicActions {
    closeEditor: () => {
        value: true
    }
    loadAccount: () => any
    ...
    setFieldValue: (
        fieldKey: AccountLinkFieldKey,
        value: string
    ) => {
        fieldKey: AccountLinkFieldKey
        value: string
    }
    setFormValues: (values: AccountLinkFieldValues) => {
        values: AccountLinkFieldValues
    }
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface accountLinksLogicMeta {
    key: string
    __keaTypeGenInternalSelectorTypes: {
        currentFieldValues: (account: AccountApi | null) => AccountLinkFieldValues
        links: (
            account: AccountApi | null,
            currentLocation: {
                hash: string
...
export type accountLinksLogicType = MakeLogicType<
    accountLinksLogicValues,
    accountLinksLogicActions,
    AccountLinksLogicProps,
    accountLinksLogicMeta
>
            ...
            null as AccountApi | null,
            {
                loadAccount: async (): Promise<AccountApi | null> => {
                    try {
                        ...
                        insights.captureException(error as Error, { scope: 'accountLinksLogic.loadAccount' })
                        return null
                    }
                },
            },
    ...
    listeners(({ actions, values, props }) => ({
        ...
        saveLinks: async () => {
            ...
            try {
                ...
                insights.captureException(error as Error, { scope: 'accountLinksLogic.saveLinks' })
