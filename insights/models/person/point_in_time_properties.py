"""
Module for building person properties from Datastore events at a specific point in time.

This module provides functionality to reconstruct person properties as they existed
at a specific timestamp by querying Datastore events and applying property updates
chronologically.
"""
...
# certainly past retention anyway; bounding here saves Datastore from walking
...
def get_person_and_distinct_ids_for_identifier(
    ...
    from insights.models.person.util import get_person_by_uuid, get_persons_by_distinct_ids
    ...
    if distinct_id is not None:
        ...
        with personinsights_caller_tag("persons/point-in-time"):
    ...
    # the personinsights client wrapper around insights/personinsights_client/) and
...
def build_person_properties_at_time(
    ...
    """
    Build person properties at a specific point in time from Datastore events.
    ...
    Args:
        ...
        row_limit: Maximum property update rows to ship back from Datastore (default 100_000).
    ...
    Raises:
        ...
        Exception: If Datastore query fails
    """
    # Validation
    ...
    # window + LIMIT keeps Datastore from walking dead partitions.
    query = f"""
    SELECT
    ...
    try:
        ...
        raise Exception(f"Failed to query Datastore events: {str(e)}") from e
