        ...
        <>
            ...
            <div className="flex flex-col items-start gap-2 min-w-0 text-left">
                ...
                {item.status === 'coming_soon' ? (
                    <>
                        <Tag type="warning">Coming soon</Tag>
                        <Button
                            type="secondary"
                            size="xsmall"
                            icon={<IconMegaphone />}
                    ...
                    <div className="flex flex-wrap items-center gap-1">
                        {item.selfManaged && (
                            <Tooltip title="Self-managed: your files stay in your own bucket and Insights queries them there. The managed version copies the data into Insights on a schedule.">
                                <Tag type="muted">Self-managed</Tag>
                            </Tooltip>
                        )}
    ...
    return (
        <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex flex-col gap-4 flex-1">
                <WarehouseWizardHint />
                <Input type="search" placeholder="Search sources..." value={search} onChange={setSearch} />
            ...
            <Modal
                ...
                footer={
                    <>
                        <Button type="secondary" onClick={hideSourceRequest}>
                            Cancel
                        </Button>
                        <Button
                            type="primary"
