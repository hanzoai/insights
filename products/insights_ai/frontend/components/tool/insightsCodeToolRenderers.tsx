...
import { IconCommit, IconGitBranch, IconGithub } from '@hanzo/icons'
...
/**
 * Bespoke cards for the `insights-code-tools` MCP server (the coding agent's git/repo tools). Without
 * these the calls fall through to the generic MCP card (`Call insights – mcp__…__git_signed_commit
...
/** Dispatches a `insights-code-tools` call to its bespoke card, falling back to the generic MCP card. */
export const InsightsCodeToolRenderer = memo(function InsightsCodeToolRenderer(props: ToolRendererProps): JSX.Element {
