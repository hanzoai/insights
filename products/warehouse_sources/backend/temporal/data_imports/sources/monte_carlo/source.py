...
class MonteCarloSource(ResumableSource[MonteCarloSourceConfig, MonteCarloResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Monte Carlo API key to pull your data observability history into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/monte-carlo",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
