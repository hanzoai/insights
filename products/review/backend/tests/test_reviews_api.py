...
from products.review.backend.api.reviews import IN_PROGRESS_STALE_AFTER
from products.review.backend.models import ReviewReport, ReviewReportArtefact
from products.review.backend.reviewer.artefact_content import (
    FindingOutcomeArtefact,
    ReviewIssueFinding,
    ValidationVerdict,
)
from products.review.backend.reviewer.models.github_meta import PRFile, PRMetadata
from products.review.backend.reviewer.models.issues_review import Issue, IssuePriority, IssuesReview, LineRange
from products.review.backend.reviewer.models.perspective_selection import (
    ChunkPerspectiveSelection,
    PerspectiveSelection,
)
from products.review.backend.reviewer.models.split_pr_into_chunks import Chunk, ChunksList, FileInfo
...
class TestRecentReviewsAPI(APIBaseTest):
    ...
    def _report(
        ...
        **kwargs,
        ...
        return ReviewReport.objects.for_team(team_id).create(
            ...
            pr_number=pr_number,
            pr_url=kwargs.pop("pr_url", f"https://github.com/Insights/insights/pull/{pr_number}"),
            head_branch="feat-branch",
            base_branch="main",
    ...
    def test_lists_only_my_completed_reviews(self) -> None:
        ...
        other = User.objects.create_and_join(self.organization, "other-reviews@hanzo.ai", None)
    ...
    def test_mine_scope_includes_reviews_of_prs_i_authored(self) -> None:
        ...
        other = User.objects.create_and_join(self.organization, "other-author-scope@hanzo.ai", None)
    ...
    def test_list_scope_everyone_covers_the_whole_project(self) -> None:
        ...
        other = User.objects.create_and_join(self.organization, "other-everyone@hanzo.ai", None)
    ...
    def test_counts_scope_to_the_latest_run_and_fall_back_to_the_branch_url(self) -> None:
        ...
        assert row["github_url"] == "https://github.com/Insights/insights/tree/feat-branch"
    ...
    def test_perspective_stats_aggregate_latest_turns_per_scope(self) -> None:
        ...
        logic = "review-script-perspective-logic-correctness"
        blind = "review-script-blind-spots-general"
        ...
        other = User.objects.create_and_join(self.organization, "other-stats@hanzo.ai", None)
    ...
    def test_retrieve_is_project_wide_but_never_cross_team(self) -> None:
        ...
        other = User.objects.create_and_join(self.organization, "other-reviews-detail@hanzo.ai", None)
