...
export function ExternalDataSourceConfiguration({
    ...
    return (
        <SceneSection
            ...
            description="Insights can display revenue data in our Revenue Analytics product from the following data warehouse sources. You can enable/disable each source to stop it from being used for revenue data. You can also configure how we join your revenue data to the Insights persons table - when this is set, we'll be able to properly display revenue for a person via the persons.$virt_revenue and persons.$virt_mrr virtual fields."
        >
