...
from insights.api.organization_member import OrganizationMemberSerializer
from insights.api.shared import SearchMatchTypeSerializerMixin

from products.alerts.backend.api.alert import AlertSerializer
from products.cdp.backend.api.insights_function import InsightsFunctionMinimalSerializer, InsightsFunctionSerializer
...
SEARCH_LIST_SERIALIZERS = [
    ...
    ("insights_function_minimal", InsightsFunctionMinimalSerializer),
    ("insights_function", InsightsFunctionSerializer),
