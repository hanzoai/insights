...
export interface dataVisualizationLogicActions {
    ...
    updateSeries: (columnName: string, settings?: AxisSeriesSettings) => {
        columnName: string;
        settings: AxisSeriesSettings | undefined;
    };
...
export interface dataVisualizationLogicMeta {
    key: string;
    sharedListeners: {
        "axesChanged": (payload: any, breakpoint: BreakPointFunction, action: {
            type: string;
            payload: any;
        }, previousState: any) => void | Promise<void>;
        "conditionalFormattingRules": (payload: any, breakpoint: BreakPointFunction, action: {
            type: string;
            payload: any;
        }, previousState: any) => void | Promise<void>;
        "pinnedColumnsChanged": (payload: any, breakpoint: BreakPointFunction, action: {
            type: string;
            payload: any;
        }, previousState: any) => void | Promise<void>;
    };
...
export type dataVisualizationLogicType = MakeLogicType<dataVisualizationLogicValues, dataVisualizationLogicActions, DataVisualizationLogicProps, dataVisualizationLogicMeta>;
