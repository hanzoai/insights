...
export type APIScope = {
    ...
    /** Mirrors `PRIVILEGED_SCOPES` in insights/scopes.py — excluded from every unprivileged preset. */
...
export const API_SCOPES: APIScope[] = [
    ...
    { key: 'comment', objectName: 'Comment', objectPlural: 'comments' },
    {
        ...
        info: 'Programmatic access to the Insights AI (Max) chat via the conversations API.',
    },
    ...
    { key: 'feature_flag', objectName: 'Feature flag', objectPlural: 'feature flags' },
    {
        ...
        // object (dashboard, insight, cohort, feature flag, script function, ...), so a
    ...
    { key: 'script_flow', objectName: 'Workflow', objectPlural: 'workflows' },
    { key: 'insights_function', objectName: 'Script function', objectPlural: 'script functions' },
    {
    ...
    { key: 'review', objectName: 'Review', objectPlural: 'Review reviews' },
    { key: 'stamp', objectName: 'Stamp', objectPlural: 'stamp' },
...
// `OAUTH_HIDDEN_SCOPE_OBJECTS` in insights/scopes.py.
export const API_SCOPES_OMITTED_FROM_MODAL: Partial<Record<APIScopeObject, string>> = {
    ...
    datastore_test_cluster_perf: 'Internal: minted programmatically only.',
    ...
    // Remove from insights/scopes.py once no PAK/OAuth grant references them.
