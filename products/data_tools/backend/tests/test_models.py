...
@pytest.mark.parametrize(
    ...
    [
        (DataWarehouseJoin, "insights_datawarehousejoin"),
        (DataWarehouseSavedQueryFolder, "insights_datawarehousesavedqueryfolder"),
        (DataWarehouseViewLink, "insights_datawarehouseviewlink"),
        (QueryTabState, "insights_querytabstate"),
    ],
)
