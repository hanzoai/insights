"""
Generate Insights OAuth tokens for the Stripe App in local development.
...
from insights.models.integration import StripeIntegration
...
class Command(BaseCommand):
    help = "Generate Insights OAuth tokens for the Stripe App (local dev only)"
