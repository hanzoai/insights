...
class InsightVariableSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        extra_kwargs = {
            ...
            "type": {"help_text": "Variable type. Controls how the value is rendered and substituted in InsightsQL."},
            ...
            "code_name": {
                "help_text": "Generated code-safe name used in InsightsQL as {variables.code_name}. Derived from name."
            },
