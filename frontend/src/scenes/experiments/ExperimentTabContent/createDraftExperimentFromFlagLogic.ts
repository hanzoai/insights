...
export interface createDraftExperimentFromFlagLogicValues {
...
export interface createDraftExperimentFromFlagLogicActions {
    ...
    createDraftExperimentFailure: (error: string) => {
        error: string
    }
    createDraftExperimentSuccess: (experiment: Experiment) => {
        experiment: Experiment
    }
...
export type createDraftExperimentFromFlagLogicType = MakeLogicType<
    createDraftExperimentFromFlagLogicValues,
    createDraftExperimentFromFlagLogicActions,
    CreateDraftExperimentFromFlagLogicProps
>
...
export const createDraftExperimentFromFlagLogic = kea<createDraftExperimentFromFlagLogicType>([
    ...
    listeners(({ actions, values, props }) => ({
        ...
        createDraftExperimentFailure: ({ error }) => {
            toast.error(`Failed to create experiment: ${error}`)
        },
    })),
])
