...
#   insights/datastore/hcl/diff.sh                 # working tree vs HEAD, all nodes
#   insights/datastore/hcl/diff.sh <ref>           # working tree vs an arbitrary ref
#   insights/datastore/hcl/diff.sh <ref> ops       # filter to one role
set -euo pipefail
