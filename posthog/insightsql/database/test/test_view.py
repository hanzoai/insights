...
from posthog.insightsql.database.test.tables import (
    ...
    def test_view_table_select(self):
        with override_settings(
            ...
            self.assertEqual(
                ...
                "aapl_stock.OpenInt AS OpenInt FROM s3(%(insightsql_val_0_sensitive)s, %(insightsql_val_1)s) AS aapl_stock) "
