...
describe('eventDebugMenuLogic', () => {
    ...
    it('has expected defaults', () => {
        expectLogic(logic).toMatchValues({
            ...
            selectedEventTypes: ['insights', 'custom'],
            hideInsightsProperties: false,
            hideInsightsFlags: false,
    ...
    describe('event type filtering', () => {
        ...
        it('filters by selected event types (default: insights + custom)', () => {
    ...
    describe('expanded properties', () => {
        ...
        it('filters insights properties when hideInsightsProperties is true', () => {
            ...
            logic.actions.addEvent(event)
            logic.actions.markExpanded('expand-me')
            logic.actions.setHideInsightsProperties(true)

            expect(logic.values.expandedProperties).toEqual({ custom_key: 'value' })
        })

        it('filters feature flags when hideInsightsFlags is true', () => {
            const event = makeEvent({
                uuid: 'expand-me',
                properties: {
                    custom_key: 'value',
            ...
            logic.actions.addEvent(event)
            logic.actions.markExpanded('expand-me')
            logic.actions.setHideInsightsFlags(true)
