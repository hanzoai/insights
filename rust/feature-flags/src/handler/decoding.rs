...
pub fn decode_form_data(
    ...
    // see https://github.com/Insights/insights/blob/master/insights/utils.py#L693-L699
    ...
    // Remove whitespace and add padding if necessary
    // https://github.com/Insights/insights/blob/master/insights/utils.py#L701-L705
