    ...
    <div className="mt-4 flex flex-col gap-y-10">
        ...
        <div className="flex flex-col gap-3">
            ...
            <div className="border rounded p-4 flex flex-col gap-3">
                ...
                <Skeleton.Row repeat={5} fade className="h-10" />
            </div>
        </div>
    </div>
)
        ...
        return (
            <>
                ...
                <Banner type="info">
                    ...
                    <Link to="https://app.hanzo.ai/settings/user-feature-previews#marketing-analytics">here</Link>.
                </Banner>
            </>
        )
    }
...
const TAB_DESCRIPTIONS: Record<string, string> = {
    ...
    [MarketingAnalyticsTab.INTEGRATION_HEALTH]:
        'Check that your ad platform campaigns are properly linked to UTM tracking in Insights.',
}
