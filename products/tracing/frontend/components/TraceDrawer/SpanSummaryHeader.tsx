    ...
    return (
        <div className="flex flex-col gap-1.5 px-1 pb-2" data-attr="tracing-span-summary">
            <div className="flex items-center gap-2">
                ...
                <Tag type={summary.status.type} className="shrink-0">
            ...
            <div className="flex items-center gap-1.5 flex-wrap">
                {summary.type && <Tag type="muted">{summary.type}</Tag>}
                <Tag type="muted">{summary.kind}</Tag>
                {summary.cluster && <Tag>Cluster: {summary.cluster}</Tag>}
                {summary.pod && <Tag>Pod: {summary.pod}</Tag>}
            </div>
        </div>
    )
}
