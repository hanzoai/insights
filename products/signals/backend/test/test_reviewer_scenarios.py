...
from insights.models.github_integration_base import GitHubCommitAttribution, GitHubCommitAuthor
...
BOT = ("insights[bot]", "bot@acme.com")  # busiest committer of all, never suggestable
