                        ...
                        <div className="mt-2 border rounded">
                            <div className="flex items-center justify-between px-2 pt-2">
                                ...
                                <div className="flex items-center gap-1">
                                    {props.onClearClick && (
                                        <Button type="tertiary" size="xsmall" onClick={props.onClearClick}>
                                            Clear
                                        </Button>
                                    )}
                                    <Button type="secondary" size="xsmall" onClick={props.config.onClick}>
    ...
    return (
        <div className="divide-y space-y-3">
            ...
            <Source
                ...
                title="Insights Product Analytics"
