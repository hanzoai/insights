...
/**
 * OTLP-pushed per-team ingestion counters, landing in the Insights metrics product
 ...
 * after a message is successfully produced to the Datastore-bound topic, so
