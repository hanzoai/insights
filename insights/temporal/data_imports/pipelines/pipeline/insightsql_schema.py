...
class InsightsQLSchema:
    ...
    def add_field(self, field: pa.Field, column: pa.ChunkedArray) -> None:
        ...
        insightsql_type: type[DatabaseField] = DatabaseField

        if pa.types.is_time(field.type):
            insightsql_type = DateTimeDatabaseField
        elif pa.types.is_timestamp(field.type):
            insightsql_type = DateTimeDatabaseField
        elif pa.types.is_date(field.type):
            insightsql_type = DateDatabaseField
        elif pa.types.is_decimal(field.type):
            insightsql_type = FloatDatabaseField
        elif pa.types.is_floating(field.type):
            insightsql_type = FloatDatabaseField
        elif pa.types.is_boolean(field.type):
            insightsql_type = BooleanDatabaseField
        elif pa.types.is_integer(field.type):
            insightsql_type = IntegerDatabaseField
        elif pa.types.is_string(field.type):
            insightsql_type = StringDatabaseField
        ...
        self.schema[field.name] = insightsql_type.__name__

    def to_insightsql_types(self) -> dict[str, str]:
        return self.schema
