...
def create_property_condition(property_key: str, value: Any) -> ast.CompareOperation:
    """Creates a InsightsQL AST CompareOperation node for comparing a property value.
...
def create_property_conditions(property_key: str, property_values: Union[list, Any]) -> ast.Expr:
    """Creates InsightsQL AST nodes for comparing property values, handling both single values and lists.
