...
from posthog.insightsql_queries.experiments.exposure_query_logic import get_entity_key
...
class ExperimentExposuresQueryRunner(QueryRunner):
    ...
    def _calculate(self) -> ExperimentExposureQueryResponse:
        ...
        response = execute_insightsql_query(
            ...
            settings=InsightsQLGlobalSettings(max_execution_time=600, allow_experimental_analyzer=True),
        )
