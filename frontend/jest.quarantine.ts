 ...
 *
 * Schema contract: tools/insightscli-commands/insightscli_commands/quarantine/core.py; this
...
function recordToleratedFailure(testId: string): void {
    ...
    try {
        ...
        fs.appendFileSync(
            path.join(outputDirectory, `insights-jest-quarantine-${process.pid}.jsonl`),
