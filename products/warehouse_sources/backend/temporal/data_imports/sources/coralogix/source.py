...
class CoralogixSource(ResumableSource[CoralogixSourceConfig, CoralogixResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter a Coralogix API key to pull your logs and spans into the Insights Data warehouse via the DataPrime query API.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/coralogix",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldSelectConfig(
