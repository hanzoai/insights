...
class TestGroupByQueryRunner(DatastoreTestMixin, APIBaseTest):
    ...
    @parameterized.expand(
        [
            ...
            # reach parse_expr, where they would execute as InsightsQL.
...
class TestGroupByAPI(DatastoreTestMixin, APIBaseTest):
    @classmethod
