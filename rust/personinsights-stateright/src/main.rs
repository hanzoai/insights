...
//!
//! ```sh
//! cargo run -p personinsights-stateright -- current
//! cargo run -p personinsights-stateright -- current-zombie
//! cargo run -p personinsights-stateright -- epoch-fenced
//! ```
//!
...
use personinsights_stateright::model::{ClaimDetection, HandoffModel, Variant, WarmOrder};
