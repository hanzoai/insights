...
DATA_WAREHOUSE_REDIS_HOST: str | None = os.getenv(
    "DATA_WAREHOUSE_REDIS_HOST", os.getenv("POSTFN_REDIS_HOST", "localhost")
)
DATA_WAREHOUSE_REDIS_PORT: str | None = os.getenv("DATA_WAREHOUSE_REDIS_PORT", os.getenv("POSTFN_REDIS_PORT", "6379"))
