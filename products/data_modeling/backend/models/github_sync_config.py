...
from insights.models.utils import CreatedMetaFields, UpdatedMetaFields
...
class GitHubSyncConfig(CreatedMetaFields, UpdatedMetaFields):
    ...
    integration = models.ForeignKey("insights.Integration", on_delete=models.SET_NULL, null=True, blank=True)
    ...
    auto_merge_prs = models.BooleanField(default=False, help_text="Auto-merge PRs created by Insights for this env")
    ...
    class Meta:
        ...
        db_table = "insights_datamodelinggithubsyncconfig"
