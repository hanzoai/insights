...
from insights.async_migrations.runner import (
...
from insights.async_migrations.utils import update_async_migration
...
class TestRunner(AsyncMigrationBaseTest):
    ...
    def test_run_migration_in_full(self):
        ...
        self.assertEqual(sm.insights_min_version, "1.0.0")
        self.assertEqual(sm.insights_max_version, "100000.0.0")
