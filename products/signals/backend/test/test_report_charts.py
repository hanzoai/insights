...
class TestReportCharts(SimpleTestCase):
    @parameterized.expand(
        [
            ...
            # A direct connection without the raw-SQL bypass still goes through the InsightsQL printer and
            ...
            (
                "a_warehouse_connection_without_the_raw_sql_bypass",
                {
                    ...
                    "query": {
                        ...
                        "source": {"kind": "InsightsQLQuery", "query": "SELECT 1", "connectionId": "conn-1"},
                    },
                },
            ),
            ...
            (
                "a_query_spelling_out_the_null_escape",
                {
                    ...
                    "query": {
                        "kind": "DataVisualizationNode",
                        "source": {"kind": "InsightsQLQuery", "query": "SELECT 1 WHERE note LIKE '%\\u0000%'"},
                    },
                },
            ),
        ]
    ...
    @parameterized.expand(
        [
            ...
            ("an_undrawable_kind", {"chart_id": "ok", "title": "t", "query": {"kind": "InsightsQLQuery", "q": "SELECT 1"}}),
            ...
            # `sendRawQuery` skips the InsightsQL printer and sends the query text verbatim to the external
