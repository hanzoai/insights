...
TEST_BUCKET = "test_storage_bucket-insights.insightsql_queries.insights.retention.data_warehouse_24h_window"
...
class TestRetentionDataWarehouse24hWindow(DatastoreTestMixin, APIBaseTest):
    def setUp(self):
        super().setUp()
        self.cleanup_fns = []
        self.temp_dirs = []
    ...
    def test_actors_query_filters_to_selected_interval_24h_window(self):
        ...
        response = execute_insightsql_query(query=runner.to_actors_query(interval=1), team=self.team)
