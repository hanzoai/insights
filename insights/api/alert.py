...
from insights.schema import AlertCondition, AlertState, InsightThreshold, TrendsAlertConfig

from insights.api.documentation import extend_schema_field
from insights.api.insight import InsightBasicSerializer
from insights.api.routing import TeamAndOrgViewSetMixin
from insights.api.shared import UserBasicSerializer
from insights.models import Insight, User
from insights.models.activity_logging.activity_log import ActivityContextBase, Detail, changes_between, log_activity
from insights.models.alert import AlertCheck, AlertConfiguration, AlertSubscription, Threshold
...
def cleanup_alert_insights_functions(sender, instance: AlertConfiguration, **kwargs):
    from insights.models.insights_functions.insights_function import InsightsFunction, InsightsFunctionType

    for insights_function in InsightsFunction.objects.filter(
        team_id=instance.team_id,
        type=InsightsFunctionType.INTERNAL_DESTINATION,
        deleted=False,
