...
// depend on @hanzo/esbuilder, not on esbuild directly, so pnpm's strict node_modules
...
export const commonConfig = {
    ...
    plugins: [
        // @hanzo/brand's PNG stubs locate their image via `new URL("./x.png", import.meta.url)`,
...
// Serialize the heavy full-app bundles (Insights App, Exporter). All esbuild contexts in a
