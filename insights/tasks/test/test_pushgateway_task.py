...
from insights.tasks.utils import PushGatewayTask
...
class TestPushGatewayTask:
    ...
    def mock_push_context(self, mock_registry: CollectorRegistry) -> Generator[MagicMock, None, None]:
        with patch("insights.tasks.utils.pushed_metrics_registry") as mock:
    ...
    def test_task_name_extracted_correctly(
        ...
        @shared_task(bind=True, base=PushGatewayTask, name="insights.tasks.feature_flags.my_complex_task")
