...
from insights.schema import ProductItemCategory

from insights.models import User
from insights.models.file_system.user_product_list import (
...
class TestUserProductList(BaseTest):
    ...
    def test_add_default_products_creates_the_default_set(self):
        user = User.objects.create_user(email="user@hanzo.ai", password="password", first_name="User")
    ...
    def test_join_seeds_default_products_for_accessible_teams(self):
        ...
        user = User.objects.create_user(email="joiner@hanzo.ai", password="password", first_name="Joiner")
    ...
    def test_user_product_list_reason_enum_matches_backend(self):
        from insights.schema import UserProductListReason
