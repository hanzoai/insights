...
from insights.datastore.kafka_engine import CONSUMER_GROUP_INGESTION_WARNINGS_V2, kafka_engine
...
# (single shard, replicated). It reads the same `datastore_ingestion_warnings` Kafka topic
...
""".format(
        ...
        columns=INGESTION_WARNINGS_V2_COLUMNS,
        engine=Distributed(data_table=TABLE_NAME, cluster=settings.DATASTORE_AUX_CLUSTER),
    )
