...
class TestEarlyAccessFeatureSiteAppTemplate(unittest.TestCase):
    def test_site_app_template_escapes_user_controlled_fields(self):
        ...
        from insights.cdp.templates._siteapps.template_early_access_features import template
...
class TestEarlyAccessFeature(APIBaseTest):
    ...
    def test_can_update_assignee(self):
        ...
        other_user = User.objects.create_and_join(self.organization, "other-assignee@hanzo.ai", None)
...
class TestPreviewList(BaseTest, QueryMatchingTest):
    ...
    def test_early_access_features_errors_out_on_random_token(self):
        ...
        with self.assertNumQueries(1):
            ...
            self.assertEqual(
                ...
                "Project token invalid. You can find your project token in Insights project settings.",
            )
    ...
    def test_early_access_features_errors_out_on_no_token(self):
        ...
        with self.assertNumQueries(0):
            ...
            self.assertEqual(
                response.json()["detail"],
                "Project token not provided. You can find your project token in Insights project settings.",
            )
    ...
    def test_early_access_features_includes_assignee_display_name_in_preview(self):
        ...
        role = Role.objects.create(name="Data Modeling", organization=self.organization)
        named_user = User.objects.create_and_join(self.organization, "named@hanzo.ai", None, first_name="Ada")
        nameless_user = User.objects.create_and_join(self.organization, "nameless@hanzo.ai", None, first_name="")
        EarlyAccessFeature.objects.create(
            team=self.team,
            name="Sprocket",
            description="A fancy new sprocket.",
...
class TestEarlyAccessFeatureResourceAccessControl(APIBaseTest):
    ...
    def setUp(self) -> None:
        ...
        self.member = User.objects.create_and_join(self.organization, "eaf-member@hanzo.ai", "password")
...
class TestComingSoonWaitlistSurvey(APIBaseTest):
    ...
    def test_ensure_creates_api_survey_linked_to_flag_and_sets_payload(self):
        from insights.tasks.early_access_feature import ensure_waitlist_survey_for_feature
    ...
    def test_ensure_adopts_survey_created_by_concurrent_task(self):
        ...
        with (
            patch("insights.tasks.early_access_feature.transaction"),
    ...
    @patch("insights.tasks.early_access_feature.create_waitlist_survey_for_concept_feature.delay")
    ...
    @patch("insights.tasks.early_access_feature.coming_soon_waitlist_surveys_enabled", return_value=False)
    def test_task_does_nothing_when_flag_disabled(self, _mock_enabled):
        from insights.tasks.early_access_feature import create_waitlist_survey_for_concept_feature
    ...
    @patch("insights.tasks.early_access_feature.coming_soon_waitlist_surveys_enabled", return_value=True)
    ...
    @patch("insights.tasks.early_access_feature.capture_event")
