                ...
                <>
                    ...
                    {canQuestionSkipSubmitButton(question) && (
                        <Checkbox
                            ...
                            info="If enabled, the survey submits immediately after the user makes a selection (for rating or single-choice questions without an open-ended option), and the submit button is hidden. Requires at least version 1.244.0 of insights-js. Not available for the mobile SDKs at the moment."
...
function OpenChoiceControl({
    ...
    return question.hasOpenChoice ? (
        <Button type="tertiary" size="small" status="danger" icon={<IconTrash />} onClick={onRemove}>
            Remove open-ended choice
        </Button>
    ) : (
        <Button type="secondary" size="small" icon={<IconPlusSmall />} onClick={onAdd}>
