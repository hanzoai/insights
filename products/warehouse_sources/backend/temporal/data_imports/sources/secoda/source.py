...
class SecodaSource(ResumableSource[SecodaSourceConfig, SecodaResumeConfig]):
    ...
    default_version = "v1"
    api_docs_url = "https://docs.secoda.co/"
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Secoda API key to pull your data catalog into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/secoda",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
