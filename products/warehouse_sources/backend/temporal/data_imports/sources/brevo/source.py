...
class BrevoSource(ResumableSource[BrevoSourceConfig, BrevoResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Brevo API key to automatically pull your Brevo (formerly Sendinblue) data into the Insights Data warehouse.
...
You can create an API key in your [Brevo account settings](https://app.brevo.com/settings/keys/api).""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/brevo",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
