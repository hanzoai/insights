...
import { InsightsApiError } from '@/lib/errors'
...
interface MockState {
     ...
     * as-is) or an error to throw (e.g. InsightsApiError for 409/410).
     */
...
describe('editHandler', () => {
    ...
    it('lets server errors (e.g. 409 conflict) propagate verbatim for handleToolError to format', async () => {
        ...
        // retry. We rely on InsightsApiError carrying status + body through to
