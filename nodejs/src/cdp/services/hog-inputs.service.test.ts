    ...
    describe('buildInputs', () => {
        ...
        beforeEach(async () => {
            insightsFunction = createInsightsFunction({
                id: 'script-function-1',
                team_id: team.id,
                name: 'Script Function 1',
                enabled: true,
                type: 'destination',
                inputs: {
                    hog_templated: {
        ...
        it('should load integration inputs and replace access tokens with placeholders', async () => {
            insightsFunction = createInsightsFunction({
                ...insightsFunction,
                inputs: {
                    hog_templated: insightsFunction.inputs!.hog_templated,
                    liquid_templated: insightsFunction.inputs!.liquid_templated,
                    oauth: { value: 1 },
                    auth: { value: 2 },
                },
                inputs_schema: [
