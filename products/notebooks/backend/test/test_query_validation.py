...
INSIGHTSQL_SOURCE: dict[str, Any] = {"kind": "InsightsQLQuery", "query": "SELECT 1"}
VALID_DATA_VIZ: dict[str, Any] = {
    "kind": "DataVisualizationNode",
    "source": INSIGHTSQL_SOURCE,
    "display": "ActionsBar",
}
...
class TestNormalizeNotebookQueryNodes:
    ...
    def test_rewraps_insight_viz_node_wrapping_insightsql_query(self) -> None:
        bad = {"kind": "InsightVizNode", "source": INSIGHTSQL_SOURCE}
        result = _extract_query(normalize_notebook_query_nodes(_wrap(bad)))
        assert result == {"kind": "DataVisualizationNode", "source": INSIGHTSQL_SOURCE}
    ...
    def test_rejects_data_visualization_node_with_non_insightsql_source(self) -> None:
    ...
    @parameterized.expand(
        [
            ...
            ("InsightsQLQuery", INSIGHTSQL_SOURCE),
