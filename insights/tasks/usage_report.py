...
from insights.models import BatchExport, GroupTypeMapping, OrganizationMembership, User
...
def send_report_to_billing_service(org_id: str, report: dict[str, Any]) -> None:
    """No-op. EE billing has been removed."""
    return
...
def get_teams_with_billable_event_count_in_period(
    ...
    if count_distinct:
        ...
        # https://github.com/Hanzo Insights/insights/blob/main/insights/models/event/sql.py#L92
