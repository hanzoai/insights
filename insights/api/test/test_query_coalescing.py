...
from insights.api.query_coalescer import (
    DONE_KEY_PREFIX,
    ERROR_KEY_PREFIX,
    LOCK_KEY_PREFIX,
    CoalesceSignal,
...
class TestQueryCoalescer(TestCase):
    def setUp(self):
        self.redis = insights_redis.get_client()
    ...
    def test_leader_increments_counter(self):
        from insights.api.query_coalescer import query_coalesce_counter
...
class TestQueryCoalescingMiddleware(DatastoreTestMixin, APIBaseTest):
    ...
    def test_leader_executes_and_stores_response(self):
        ...
        with (
            mock.patch("insights.api.query_coalescer.hanzo_insights.feature_enabled", return_value=True),
            mock.patch("insights.api.query_coalescer.QueryCoalescer", return_value=mock_coalescer),
        ):
    ...
    def test_dry_run_follower_executes_normally(self):
        ...
        with (
            mock.patch("insights.api.query_coalescer.hanzo_insights.feature_enabled", return_value=False),
            mock.patch("insights.api.query_coalescer.QueryCoalescer", return_value=mock_coalescer),
        ):
            response = self.client.post(self._query_url(), self._query_payload())
    ...
    def test_follower_permission_denied_returns_403_not_500(self):
        ...
        with (
            ...
            mock.patch("insights.api.query_coalescer.QueryCoalescer", return_value=mock_coalescer),
            mock.patch(
                "insights.api.query.QueryViewSet.check_permissions",
    ...
    def test_follower_throttled_still_serves_cached_response(self):
        ...
        with (
            ...
            mock.patch("insights.api.query_coalescer.QueryCoalescer", return_value=mock_coalescer),
            mock.patch(
                "insights.api.query.QueryViewSet.check_throttles",
    ...
    def test_matching_paths_trigger_coalescing(self, _name, path_template):
        ...
        with (
            mock.patch("insights.api.query_coalescer.hanzo_insights.feature_enabled", return_value=True),
            mock.patch("insights.api.query_coalescer.QueryCoalescer", return_value=mock_coalescer) as mock_cls,
        ):
