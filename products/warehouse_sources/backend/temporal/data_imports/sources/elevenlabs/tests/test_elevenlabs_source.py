...
class TestElevenLabsSourceConfig:
    ...
    def test_config_exposes_api_key_password_field(self) -> None:
        ...
        assert config.docsUrl == "https://hanzo.ai/docs/cdp/sources/elevenlabs"
...
class TestElevenLabsSchemas:
    ...
    def test_documented_tables_render_for_public_docs(self) -> None:
        # lists_tables_without_credentials must stay on so the hanzo.ai Supported tables section renders.
