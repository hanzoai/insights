...
template: InsightsFunctionTemplateDC = InsightsFunctionTemplateDC(
    ...
    id="template-desk",
    name="Desk",
    description="Desk bug reporter",
    icon_url="https://raw.githubusercontent.com/Insights/bug-report-app/refs/heads/main/logo.png",
    category=["Custom"],
...
export function onLoad({ inputs, insights }) {
    ...
    const getSessionRecordingUrl = () => {
        ...
        const api_host = insights?.config?.api_host || 'https://app.hanzo.ai'
