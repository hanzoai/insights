import { buildGoalLineReferenceLines } from '@hanzo/quill-charts'
import type { GoalLineConfig, ReferenceLineProps, Series } from '@hanzo/quill-charts'
...
/** Map persisted {@link SchemaGoalLine}s to {@link ReferenceLineProps} for the script-charts
