...
from products.review.backend.reviewer.outcomes.github_fetch import (
    _MAX_REVIEW_COMMENTS,
    fetch_compare_files,
    fetch_review_comments,
)
from products.review.backend.reviewer.tools.github_meta import GITHUB_COMPARE_FILES_CAP

_MODULE = "products.review.backend.reviewer.outcomes.github_fetch"
...
_PAGINATED_FETCH = "products.review.backend.reviewer.tools.github_client.github_api_request"
