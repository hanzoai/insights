...
from insights.temporal.ai_observability.evaluation_clustering.data import fetch_generation_contents

_RESOLVE_PATH = "insights.temporal.ai_observability.evaluation_clustering.data.resolve_trace_ids_for_generation_uuids"
...
class TestFetchGenerationContents:
    def test_empty_id_list_short_circuits(self, team):
        ...
        with (
            patch("insights.temporal.ai_observability.evaluation_clustering.data.query_ai_events") as mock_resolver,
    ...
    def test_returns_per_generation_dict(self, _mock_resolve, team):
        with patch("insights.temporal.ai_observability.evaluation_clustering.data.query_ai_events") as mock_resolver:
    ...
    def test_query_reads_native_heavy_columns_from_ai_events(self, _mock_resolve, team):
        ...
        with patch("insights.temporal.ai_observability.evaluation_clustering.data.query_ai_events") as mock_resolver:
            ...
            from insights.temporal.ai_observability.evaluation_clustering.data import CLUSTERING_QUERY_MAX_EXECUTION_TIME
