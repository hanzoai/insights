...
const STORAGE_KEY = 'insights-ai-web-analytics-nudge-session'
...
export type maxWebAnalyticsNudgeSessionLogicType = MakeLogicType<
    maxWebAnalyticsNudgeSessionLogicValues,
    maxWebAnalyticsNudgeSessionLogicActions
>
