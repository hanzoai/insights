...
class TestAsyncMigration(APIBaseTest):
    ...
    @patch("insights.tasks.async_migrations.run_async_migration.delay")
    ...
    @patch("insights.celery.app.control.revoke")
    ...
    @patch("insights.async_migrations.runner.get_async_migration_definition")
