import { APP_METRICS_OUTPUT, DLQ_OUTPUT, INGESTION_WARNINGS_OUTPUT, TOPFN_OUTPUT } from '~/common/outputs'
...
export function createOutputsRegistry() {
    return new IngestionOutputsBuilder()
        ...
        .register(TOPFN_OUTPUT, {
            topicKey: 'INGESTION_OUTPUT_TOPFN_TOPIC',
            producerKey: 'INGESTION_OUTPUT_TOPFN_PRODUCER',
        })
}
