...
`insightsql_parser_rs::cov` and isn't linked into anything else, so they SIGSEGV
...
See "Coverage-instrumented build" in `rust/insightsql/parser/README.md`.
"""
...
TARGET_CRATE = "insightsql_parser_rs"
