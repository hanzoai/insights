...
from insights.schema import PropertyOperator, SpanPropertyFilter, SpanPropertyFilterType
...
class TestTranslateSpanFilter(SimpleTestCase):
    ...
    @parameterized.expand(
        [
            ...
            # column and makes Datastore throw. Floats (e.g. the slider max) are the regression.
