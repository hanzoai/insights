...
export const navigation3000Logic = kea<navigation3000LogicType>([
    ...
    listeners(({ actions, values }) => ({
        setZenMode: ({ zenMode, trigger }) => {
            insights.capture('zen mode toggled', { enabled: zenMode, trigger })
        },
                ...
                return [
                    ...
                    [
                            ...
                            : null,
                        {
                            ...
                            tooltipDocLink: 'https://hanzo.ai/docs/ai-observability/dashboard',
                        },
                        featureFlags[FEATURE_FLAGS.MCP_ANALYTICS]
                            ? {
                                  ...
                                  tooltipDocLink: 'https://hanzo.ai/docs/mcp-analytics/installation',
                              }
                            : null,
                        {
