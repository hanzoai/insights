...
describe('CustomFlowActionRunnerWaitUntilTimeWindow', () => {
    let action: Extract<CustomFlowAction, { type: 'wait_until_time_window' }>
    ...
    beforeEach(() => {
        ...
        const customFlow = new FixtureCustomFlowBuilder()
            ...
            .build()
        action = findActionByType(customFlow, 'wait_until_time_window')!
    })
