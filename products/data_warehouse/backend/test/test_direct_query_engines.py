...
class TestDirectQueryEngineRegistry:
    @parameterized.expand(["postgres", "mysql", "snowflake", "redshift", "datastore"])
    ...
    @parameterized.expand(
        [
            ...
            # Datastore has no catalog level — the database occupies the "schema" slot.
            ("datastore", (None, "public", "users")),
        ]
    )
    ...
    @parameterized.expand(["mysql", "snowflake", "redshift", "datastore"])
