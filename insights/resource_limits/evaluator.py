...
from insights.resource_limits.registry import get_definition
...
def check_count_limit(
    *,
    ...
    """Emit a ``resource limit hit`` Insights event when a team's next create
    ...
    the team crosses for the first time so a downstream Insights Action can
