...
class TestAutoSelectProjectForUser(DatastoreTestMixin, APIBaseTest):
...
class TestGetOverviewForTeam(DatastoreTestMixin, APIBaseTest):
...
class TestGetTopPages(DatastoreTestMixin, APIBaseTest):
...
class TestGetTopSources(DatastoreTestMixin, APIBaseTest):
...
class TestGetGoalsForTeam(DatastoreTestMixin, APIBaseTest):
...
class TestBuildTeamDigest(DatastoreTestMixin, APIBaseTest):
