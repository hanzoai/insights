...
from insights.storage.team_access_cache import TOKEN_CACHE_PREFIX, TokenAuthCache
...
class TestTokenAuthCacheNotConfigured(TestCase):
    ...
    @patch("insights.storage.team_access_cache.PersonalAPIKey")
...
class TestTokenAuthCache(TestCase):
    ...
    def test_invalidate_team_tokens_deletes_secret_tokens(self):
        ...
        from insights.models.utils import generate_random_token_secret, hash_key_value
