...
import { OutputMappingSuggestion } from '../flowEditorLogic'
...
import type { FlowTestResult } from '../steps/types'
import type { InsightsFlowAction } from '../types'
import type { InsightsFlow, InsightsFlowActionNode } from '../types'
import { createExampleEvent, flowEditorTestLogic } from './testing/flowEditorTestLogic'
...
export interface flowOutputMappingLogicValues {
    selectedNode: InsightsFlowActionNode | null // flowEditorLogic
    accumulatedVariables: Record<string, any> // flowEditorTestLogic
    sampleGlobals: CyclotronJobInvocationGlobals | null // flowEditorTestLogic
    ...
    pendingSuggestions: OutputMappingSuggestion[]
    selectedAction: InsightsFlowAction | null
    selectedActionId: string | null
    shakePickButton: boolean
    suggestions: OutputMappingSuggestion[]
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface flowOutputMappingLogicActions {
    addMapping: () => {
        value: true
    }
    applySuggestion: (suggestion: OutputMappingSuggestion) => {
        suggestion: OutputMappingSuggestion
    }
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface flowOutputMappingLogicMeta {
    key: string
    __keaTypeGenInternalSelectorTypes: {
        selectedAction: (selectedNode: InsightsFlowActionNode | null) => InsightsFlowAction | null
        pendingSuggestions: (
            suggestions: OutputMappingSuggestion[],
            mappings: OutputMapping[]
...
export type flowOutputMappingLogicType = MakeLogicType<
    flowOutputMappingLogicValues,
    flowOutputMappingLogicActions,
    WorkflowLogicProps,
    flowOutputMappingLogicMeta
>

export const flowOutputMappingLogic = kea<flowOutputMappingLogicType>([
    path((key) => [
        'products',
        'workflows',
        'frontend',
    ...
    selectors({
        selectedAction: [
            (s) => [s.selectedNode],
            (selectedNode: null | import('../types').InsightsFlowActionNode) => selectedNode?.data ?? null,
        ],
        pendingSuggestions: [
            (s) => [s.suggestions, s.mappings],
            (suggestions: OutputMappingSuggestion[], mappings: OutputMapping[]): OutputMappingSuggestion[] => {
        ...
        return {
            ...
            runOutputTest: async () => {
                ...
                try {
                    ...
                    const result: FlowTestResult = await api.flows.createTestInvocation(workflow.id, {
