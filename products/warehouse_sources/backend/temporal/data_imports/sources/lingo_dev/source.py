...
class LingoDevSource(ResumableSource[LingoDevSourceConfig, LingoDevResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Lingo.dev",
            caption="""Enter your Lingo.dev API key to automatically pull your Lingo.dev localization job data into the Insights Data warehouse.
...
""",
            docsUrl="https://hanzo.ai/docs/cdp/sources/lingo-dev",
