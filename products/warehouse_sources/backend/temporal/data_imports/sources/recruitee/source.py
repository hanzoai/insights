...
class RecruiteeSource(ResumableSource[RecruiteeSourceConfig, RecruiteeResumeConfig]):
    ...
    api_docs_url = "https://docs.recruitee.com/"
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Recruitee company ID and API token to pull your recruiting data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/recruitee",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
