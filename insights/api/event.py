...
from insights.insightsql.constants import DEFAULT_RETURNED_ROWS
from insights.insightsql.property_utils import create_property_conditions
from insights.insightsql.query import execute_insightsql_query

from insights.api.documentation import PropertiesSerializer, extend_schema
...
from insights.models import Element, Person, PropertyDefinition, User
from insights.models.event.legacy_events_query import LegacyEventsListQuery, get_one_event
...
from insights.utils import convert_property_value, flatten, refresh_requested_by_client, relative_date_parse
...
class EventViewSet(
    ...
    def _get_people(self, query_result: List[dict], team: Team) -> "dict[str, Person]":  # noqa: UP006
        ...
        with personinsights_caller_tag("persons/events-api"):
