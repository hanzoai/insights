...
import { CustomFunctionMapping, MappingSummary } from 'scenes/custom-functions/mapping/CustomFunctionMappings'

import { CustomFunctionConfigurationType, CustomFunctionMappingType } from '~/types'

export function CustomFlowFunctionMappings({
    useMapping,
    inputs,
    inputs_schema,
    mappings,
    ...
    useMapping: boolean
    inputs: CustomFunctionConfigurationType['inputs']
    inputs_schema: CustomFunctionConfigurationType['inputs_schema']
    mappings: CustomFunctionMappingType[]
    mappingTemplates: CustomFunctionMappingType[]
