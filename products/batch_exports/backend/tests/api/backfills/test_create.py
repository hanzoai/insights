...
def test_batch_export_earliest_backfill_rejected_without_feature_flag(
    ...
    with patch("products.batch_exports.backend.api.batch_export.hanzo_insights.feature_enabled", return_value=False):
        response = backfill_batch_export(
            client,
            team.pk,
            batch_export_id,
...
def test_batch_export_earliest_backfill_allowed_with_feature_flag(
    ...
    with patch("products.batch_exports.backend.api.batch_export.hanzo_insights.feature_enabled", return_value=True):
        response = backfill_batch_export(
            client,
            team.pk,
            batch_export_id,
