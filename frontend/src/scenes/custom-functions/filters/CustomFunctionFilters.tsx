...
import { CustomFunctionFiltersInternal } from './CustomFunctionFiltersInternal'
...
export function CustomFunctionFilters({
    embedded = false,
    ...
    } = useActions(customFunctionConfigurationLogic)
    ...
    if (type === 'internal_destination') {
        return <CustomFunctionFiltersInternal />
    }
                            ...
                            {isDataWarehouse ? null : (
                                <>
                                    ...
                                    <PropertyFilters
                                        ...
                                        pageKey={`CustomFunctionPropertyFilters.${type}`}
    ...
    return (
        <MaxTool
            identifier="create_custom_function_filters"
            context={{
