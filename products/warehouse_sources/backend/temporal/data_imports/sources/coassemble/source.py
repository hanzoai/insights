...
class CoassembleSource(ResumableSource[CoassembleSourceConfig, CoassembleResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Coassemble workspace ID and API key to pull your courses, collections, learners, and learner progress into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/coassemble",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
