 ...
 *
 * Insights API - MCP 7 enabled ops
...
export const canvasesPublishCreateBodyProjectOneCapabilitiesOneInsightsInsightsItemMax = 128

export const canvasesPublishCreateBodyProjectOneCapabilitiesOneInsightsInsightsMax = 100

export const canvasesPublishCreateBodyProjectOneCapabilitiesOneInsightsCaptureEventsItemMax = 200

export const canvasesPublishCreateBodyProjectOneCapabilitiesOneInsightsCaptureEventsMax = 100
        ...
        project: zod
            .object({
                ...
                dependencies: zod
                    ...
                    .optional()
                    .describe(
                        'Exact-version dependencies, restricted to the platform-supported set (react, react-dom, @insights\/quill, recharts, lucide-react, dayjs) at their pinned versions.'
                    ),
                ...
                capabilities: zod
                        ...
                        insights: zod.object({
                            insights: zod
                                .array(
                                    zod
                                        .string()
                                        .max(canvasesPublishCreateBodyProjectOneCapabilitiesOneInsightsInsightsItemMax)
                                )
                                .max(canvasesPublishCreateBodyProjectOneCapabilitiesOneInsightsInsightsMax),
                            ...
                            captureEvents: zod
                                .array(
                                    zod
                                        .string()
                                        .max(
                                            canvasesPublishCreateBodyProjectOneCapabilitiesOneInsightsCaptureEventsItemMax
                                        )
                                )
                                .max(canvasesPublishCreateBodyProjectOneCapabilitiesOneInsightsCaptureEventsMax),
                        }),
                        network: zod.object({
                            origins: zod
                                .array(
                    ...
                    .optional()
                    .describe(
                        'Bounded capabilities frozen into the built artifact. Declare every insight short id the canvas loads, every event it captures, and inlineQueries when it runs ad-hoc InsightsQL — the host enforces these at runtime and validation rejects undeclared `ph` calls.'
                    ),
            })
...
export const canvasesValidateCreateBodyProjectOneCapabilitiesOneInsightsInsightsItemMax = 128

export const canvasesValidateCreateBodyProjectOneCapabilitiesOneInsightsInsightsMax = 100

export const canvasesValidateCreateBodyProjectOneCapabilitiesOneInsightsCaptureEventsItemMax = 200

export const canvasesValidateCreateBodyProjectOneCapabilitiesOneInsightsCaptureEventsMax = 100
                        ...
                        insights: zod.object({
                            insights: zod
                                .array(
                                    zod
                                        .string()
                                        .max(canvasesValidateCreateBodyProjectOneCapabilitiesOneInsightsInsightsItemMax)
                                )
                                .max(canvasesValidateCreateBodyProjectOneCapabilitiesOneInsightsInsightsMax),
                            inlineQueries: zod.boolean(),
                            captureEvents: zod
                                .array(
                                    zod
                                        .string()
                                        .max(
                                            canvasesValidateCreateBodyProjectOneCapabilitiesOneInsightsCaptureEventsItemMax
                                        )
                                )
                                .max(canvasesValidateCreateBodyProjectOneCapabilitiesOneInsightsCaptureEventsMax),
                        }),
                        network: zod.object({
                            origins: zod
                                .array(
