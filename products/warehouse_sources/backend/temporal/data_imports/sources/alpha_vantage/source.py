...
class AlphaVantageSource(SimpleSource[AlphaVantageSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Alpha Vantage API key and the stock symbols you want to track to pull market data and company fundamentals into the Insights Data warehouse.
...
Note: the free tier is limited to roughly 25 requests per day, and each selected table costs one request per symbol on every sync. Some datasets require a paid plan.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/alpha-vantage",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
