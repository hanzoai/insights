...
from posthog.insightsql.errors import SyntaxError
from posthog.insightsql.parse_string import parse_string_literal_text as parse_string_py


def parse_string_test_factory(backend: InsightsQLParserBackend):
