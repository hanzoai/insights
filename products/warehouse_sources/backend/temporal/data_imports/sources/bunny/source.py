...
class BunnySource(ResumableSource[BunnySourceConfig, BunnyResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your bunny.net account API key to pull your bunny.net data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/bunny",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
