...
from insights.insightsql_queries.ai.sentiment_evaluations import load_trace_sentiment_evaluations, normalize_sentiment_result
...
def _load_trace_sentiment_from_generation_results(generation_results: list[GenerationResultRow]) -> dict[str, object]:
    ...
    with patch("insights.insightsql_queries.ai.sentiment_evaluations.query_ai_events", return_value=result):
