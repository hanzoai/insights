...
FF_PAYLOAD_PATH = "insights.temporal.ai_observability.team_discovery.hanzo_insights.get_feature_flag_payload"
...
@patch("insights.temporal.ai_observability.team_discovery.Heartbeater", _noop_heartbeater)
@pytest.mark.asyncio
class TestGetTeamIdsForAIObservability:
    @patch("insights.tasks.ai_observability_usage_report.get_teams_with_ai_events")
