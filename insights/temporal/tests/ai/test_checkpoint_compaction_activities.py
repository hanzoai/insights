...
from insights.temporal.ai.checkpoint_compaction.activities import (
    compact_checkpoint_conversations,
    select_checkpoint_compaction_batch,
)
from insights.temporal.ai.checkpoint_compaction.types import CompactionBatch, SelectBatchInput

from products.insights_ai.backend.models.assistant import Conversation, ConversationCheckpoint
...
async def test_one_poison_thread_does_not_sink_the_batch(ateam, auser, activity_environment):
    ...
    with (
        ...
        patch(
            "insights.temporal.ai.checkpoint_compaction.activities.compact_conversation",
