...
from insights.models.cohort.util import sort_cohorts_topologically
from insights.models.experiment import Experiment
from insights.models.scheduled_change import ScheduledChange
...
class TestOrganizationFeatureFlagCopySchedules(APIBaseTest):
    ...
    def test_copy_flag_schedule_failure_surfaces_warning(self):
        ...
        with patch(
            "insights.api.organization_feature_flag.OrganizationFeatureFlagView._copy_feature_flag_schedules"
        ) as mock_copy:
