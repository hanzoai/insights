...
class GoldcastSource(SimpleSource[GoldcastSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Goldcast API token to sync your virtual event and webinar data into the Insights Data warehouse.
...
API access requires a Pro, Premium, or Enterprise plan, and the token feature must be enabled by Goldcast support.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/goldcast",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
