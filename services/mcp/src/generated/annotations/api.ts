 ...
 *
 * Insights API - MCP 5 enabled ops
...
export const AnnotationsCreateBody = /* @__PURE__ */ zod.object({
    ...
    hidden_in_user_interface: zod
        ...
        .nullish()
        .describe(
            'When true, the annotation is hidden from the Insights UI (charts and the annotations list) but still readable over the API and MCP. Use for high-frequency markers like deployments that would otherwise crowd the UI. Null (the default) means the annotation is shown.'
        ),
})
