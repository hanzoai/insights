...
export function TabbedManageSubscriptions({
    ...
    const tabs: Tab<SubscriptionTabKey>[] = tabConfigs
        ...
        <>
            ...
            <Modal.Content>
                <Tabs
                    ...
                    rightSlot={
                        activeTab === 'resource' ? (
                            <Button type="primary" onClick={() => onSelect('new')} data-attr="add-subscription">
                                Add subscription
                            </Button>
                        ) : undefined
                    }
            ...
            <Modal.Footer>
                <div className="flex-1">
                    <Button type="tertiary" to={urls.subscriptions()}>
