...
const TRACING_DOCS_URL = 'https://hanzo.ai/docs/tracing'
...
function TracingSceneContents(): JSX.Element {
    ...
    const onFeedbackClick = (): void => {
        insights.displaySurvey(TRACING_FEEDBACK_SURVEY_ID)
    }
    ...
    return (
        <SceneContent className="h-[calc(var(--scene-layout-rect-height,_100vh)_-_1rem)]">
            <SceneTitleSection
                ...
                actions={
                    <>
                        <Button size="small" type="secondary" icon={<IconFeedback />} onClick={onFeedbackClick}>
                            Feedback
                        </Button>
                        <Button
                            to={TRACING_DOCS_URL}
