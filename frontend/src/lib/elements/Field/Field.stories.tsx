...
import { Button, Checkbox, Input, Select, TextArea } from '@hanzo/elements'
...
export const _PureFields = (): JSX.Element => {
    return (
        <div className="deprecated-space-y-4">
            ...
            >
                <Input placeholder="Optional descriptive placeholder text" />
            </Field.Pure>

            <Field.Pure label="Select label" info={<>With info!</>}>
                <Select options={[{ value: 'foo', label: 'bar' }]} fullWidth />
            </Field.Pure>

            <Field.Pure label="Textarea label" error="This field has an error">
                <TextArea />
            </Field.Pure>
            <Field.Pure>
                <Checkbox bordered label="Checkbox labels are set differently" fullWidth />
            </Field.Pure>
        ...
        <Form logic={formLogic} formKey={formKey} enableFormOnSubmit>
            <div className="deprecated-space-y-4">
                ...
                <Field name="pineappleOnPizza">
                    <Checkbox bordered label="Pineapple on your pizza?" fullWidth />
                </Field>
