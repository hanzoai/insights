...
async function buildCanvas(project) {
    ...
    const manifest = {
        ...
        capabilities: project.capabilities ?? {
            insights: { insights: [], inlineQueries: false, captureEvents: [] },
            network: { origins: [] },
        },
        ...legacy,
    }
