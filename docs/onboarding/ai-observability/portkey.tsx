            ...
            content: (
                <>
                    <CalloutBox type="info" icon="IconInfo" title="Full working examples">
                        <Markdown>
                            See the complete
                            [Node.js](https://github.com/Insights/insights-js/tree/e08ff1be/examples/example-ai-portkey)
                            and
                            [Python](https://github.com/Insights/insights-python/tree/7223c52/examples/example-ai-portkey)
                            examples on GitHub.
                        </Markdown>
                    </CalloutBox>

                    <Markdown>Install the Insights SDK, the OpenAI SDK, and the Portkey SDK.</Markdown>
                        ...
                        blocks={[
                            {
                                ...
                                file: 'Python',
                                code: dedent`
                                    pip install insights openai portkey-ai
                                `,
                            },
                            {
                                language: 'bash',
                                file: 'Node',
                                code: dedent`
                                    npm install @hanzo/ai insights-node openai portkey-ai
                                `,
                            },
                        ]}
                    />
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        {dedent`
                            Create a Insights client, then swap in Insights's OpenAI wrapper, pointed at Portkey's
                            gateway URL.
                        `}
                    </Markdown>
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        {dedent`
                            When you use the wrapped client to call Portkey, Insights automatically captures an
                            \`$ai_generation\` event.
                        `}
                    </Markdown>
