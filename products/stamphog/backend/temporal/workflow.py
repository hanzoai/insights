...
from products.stamphog.backend.temporal.constants import (
    ...
    STAMPFN_BOT_REVIEW_MAX_POLLS,
    STAMPFN_BOT_REVIEW_POLL_SECONDS,
)
...
class StamphogReviewWorkflow(InsightsWorkflow):
    ...
    async def run(self, input: StamphogReviewInput) -> dict:
        try:
            ...
            for _ in range(STAMPFN_BOT_REVIEW_MAX_POLLS):
                ...
                if not bots["in_flight"]:
                    break
                await asyncio.sleep(STAMPFN_BOT_REVIEW_POLL_SECONDS)
