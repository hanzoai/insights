...
from products.cdp.backend.api import insights_function, insights_function_template, plugin, plugin_log_entry
...
def register_routes(routers: RouterRegistry) -> None:
    ...
    routers.projects.register(r"insights_functions", insights_function.InsightsFunctionViewSet, "project_insights_functions", ["team_id"])
    routers.projects.register(
