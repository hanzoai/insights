...
const MOCK_RUNS: RawBatchExportRun[] = [
    ...
    },
    {
        ...
        latest_error:
            'NotFound: 404 POST https://bigquery.googleapis.com/bigquery/v2/projects/insights-301601/datasets/BatchExports/tables?prettyPrint=false: Not found: Dataset insights-301601:BatchExports',
    },
    {
        id: 'run-004',
        status: 'Starting',
...
const MOCK_LOG_RESULTS = {
    results: [
        [
            ...
            'INFO',
            'Batch exporting range 2024-01-15T09:00:00Z - 2024-01-15T10:00:00Z to BigQuery: insights-301601.BatchExports.events',
        ],
        [
            'run-aaa-bbb-ccc',
        ...
        [
            ...
            'INFO',
            'Batch exporting range 2024-01-15T10:00:00Z - 2024-01-15T11:00:00Z to BigQuery: insights-301601.BatchExports.events',
        ],
        ...
        [
            ...
            'ERROR',
            'Batch export for range 2024-01-15T10:00:00Z - 2024-01-15T11:00:00Z failed with a non-recoverable error: NotFound: 404 POST https://bigquery.googleapis.com/bigquery/v2/projects/insights-301601/datasets/BatchExports/tables?prettyPrint=false: Not found: Dataset insights-301601:BatchExports',
        ],
    ],
}
...
const MOCK_ACTIVITY_LOGS = {
    results: [
        {
            id: 'activity-005',
            user: { first_name: 'Max', last_name: 'Script', email: 'max@hanzo.ai' },
            activity: 'updated',
        ...
        {
            id: 'activity-003',
            user: { first_name: 'Mix', last_name: 'Script', email: 'mix@hanzo.ai' },
            activity: 'updated',
