...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            "Higher frequency batch exports are not enabled for this project.",
...
def test_can_patch_insightsql_query(client: HttpClient, temporal, encryption_codec, organization, team, user):
