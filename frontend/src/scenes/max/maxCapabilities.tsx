...
/** One suggestion inside a capability. `content` is the prompt sent to Insights AI. */
export interface CapabilitySuggestion {
    /**
     * The prompt sent to Insights AI. For `requiresUserInput` cards this is the instruction prefix
...
/** Shared across both experiment arms — routes to the Insights Desktop beta in the inbox. */
...
/**
 * A few docs prompts included in every arm so newcomers can learn about Insights. Rendered as a
...
/**
 * Product-based grouping — mirrors Insights's products. Prompt content is drawn from the
 * existing `QUESTION_SUGGESTIONS_DATA` on the Insights AI scene so the two surfaces stay in sync.
 */
        ...
        suggestions: [
            {
                ...
                description: 'Query any of your data with InsightsQL',
...
/**
 * Behavior-based grouping — organized around what people come to Insights to *do*, rather than
...
export const BEHAVIOR_CAPABILITIES: Capability[] = [
    {
        ...
        suggestions: [
            ...
            },
            {
                ...
                description: 'Ask anything of your data with InsightsQL',
                content: 'Write an SQL query to',
                requiresUserInput: true,
                hint: 'type a question you have about your data',
                iconType: 'sql_editor',
