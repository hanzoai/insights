...
Datastore to decompress the payload columns, so it only runs once the count has passed. That keeps
...
from insights.temporal.ai_observability.metrics import increment_payload_budget
...
# worker either way, and the Script `evaluation_events` global exposes it directly.
PAYLOAD_BYTES_EXPR = (
