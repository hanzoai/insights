    ...
    return [
        {
            ...
            content: (
                <>
                    <Markdown>
                        {dedent`
                            Insights accepts logs from any OpenTelemetry-compatible client via OTLP over HTTP.
                            Point your exporter at Insights's OTLP endpoint and authenticate with your project token.

                            Insights does not require any Insights-specific SDK or package — use standard
