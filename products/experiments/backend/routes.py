...
def register_routes(routers: RouterRegistry) -> None:
    # All experiments viewsets currently live in `ee/datastore/views/` and
    ...
    from ee.datastore.views.experiment_holdouts import ExperimentHoldoutViewSet
    from ee.datastore.views.experiment_saved_metrics import ExperimentSavedMetricViewSet
