...
import products.review.backend.temporal.client  # noqa: F401
from products.review.backend.models import ReviewUserSettings
from products.review.backend.receivers import resolve_stamp_acting_reviewer
from products.signals.backend.models import SignalReport, SignalReportArtefact
from products.tasks.backend.models import Task, TaskRun

# receivers.py imports both at call time (startup-import-budget), so the defining modules are the
# patch targets.
_START = "products.review.backend.temporal.client.start_review_pr_workflow"
...
_HEAD_BRANCH = "insights-code/fix-the-thing"
...
class TestInboxTrigger(BaseTest):
    def setUp(self) -> None:
        ...
        self.alice = self._org_member("alice@hanzo.ai", github_login="alice")
    ...
    def _task(
        ...
        *,
        ...
        repository: str | None = "Insights/insights",
        internal: bool = True,
    ...
    def test_opted_out_canonical_reviewer_blocks_the_review(self, mock_start) -> None:
        ...
        self._mock_start = mock_start
        self._org_member("bob@hanzo.ai", github_login="bob")  # canonical, not opted in
    ...
    def test_non_assigned_requester_follows_the_canonical_reviewer(self, mock_start) -> None:
        ...
        self._mock_start = mock_start
        self._org_member("bob@hanzo.ai", github_login="bob")  # canonical, not opted in
        charlie = self._org_member("charlie@hanzo.ai", github_login="charlie")  # not assigned
