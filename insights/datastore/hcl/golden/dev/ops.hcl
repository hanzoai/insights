database "insights" {
  ...
  table "prom_metrics" {
    ...
    engine "time_series" {
      samples {
        target = "insights.prom_metrics_data"
      }
      tags {
        target = "insights.prom_metrics_tags"
      }
      metrics {
        target = "insights.prom_metrics_metrics"
      }
    }
  }
  ...
  table "prom_metrics_data" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/ops/tables/{shard}/insights.prom_metrics/data"
      replica_name = "{replica}"
    }
  }
  ...
  table "prom_metrics_metrics" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path     = "/datastore/ops/tables/{shard}/insights.prom_metrics/metrics"
      replica_name = "{replica}"
    }
  }
  ...
  table "prom_metrics_tags" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/ops/tables/{shard}/insights.prom_metrics/tags"
      replica_name = "{replica}"
    }
  }
  ...
  table "writable_prom_metrics" {
    ...
    engine "time_series" {
      samples {
        target = "insights.writable_prom_metrics_data"
      }
      tags {
        target = "insights.writable_prom_metrics_tags"
      }
      metrics {
        target = "insights.writable_prom_metrics_metrics"
      }
    }
  }
