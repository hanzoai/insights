 ...
 *
 * Insights API - MCP 3 enabled ops
 ...
 */
export const ReviewReviewsListParams = /* @__PURE__ */ zod.object({
    project_id: zod
        .string()
        .describe(
...
export const reviewReviewsListQueryLimitDefault = 5
export const reviewReviewsListQueryLimitMax = 100

export const reviewReviewsListQueryScopeDefault = `mine`

export const ReviewReviewsListQueryParams = /* @__PURE__ */ zod.object({
    limit: zod
        .number()
        .min(1)
        .max(reviewReviewsListQueryLimitMax)
        .default(reviewReviewsListQueryLimitDefault)
        .describe(
    ...
    scope: zod
        .enum(['mine', 'everyone'])
        .default(reviewReviewsListQueryScopeDefault)
        .describe(
 ...
 */
export const ReviewReviewsRetrieveParams = /* @__PURE__ */ zod.object({
 ...
 */
export const ReviewReviewsTriggerCreateParams = /* @__PURE__ */ zod.object({
    project_id: zod
        .string()
        .describe(
            "Project ID of the project you're trying to access. To find the ID of the project, make a call to \/api\/projects\/."
...
export const ReviewReviewsTriggerCreateBody = /* @__PURE__ */ zod.object({
    pr_url: zod
        .string()
        .describe(
            "GitHub pull request URL to review, e.g. 'https:\/\/github.com\/Insights\/hanzo.ai\/pull\/123'. The repository must be accessible to the project's GitHub App installation."
        ),
})
