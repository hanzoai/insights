...
@patch("insights.personinsights_client.client.PERSONFN_DJANGO_CHANNEL_STATE")
@patch("insights.personinsights_client.client.PERSONFN_DJANGO_CHANNEL_STATE_TRANSITIONS_TOTAL")
@patch("insights.personinsights_client.client.PERSONFN_DJANGO_CONNECTION_ESTABLISHMENT_SECONDS")
class TestChannelStateMonitor:
    def _make_monitor(self):
        from insights.personinsights_client.client import _ChannelStateMonitor
