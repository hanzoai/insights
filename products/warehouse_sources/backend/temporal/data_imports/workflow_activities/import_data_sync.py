...
from insights.models.integration import UndecryptedIntegrationSecretError
from insights.sync import database_sync_to_async_pool
from insights.temporal.common.activity_context import current_activity_attempt
...
async def _handle_import_error(
    ...
    (``insights/temporal/common/insights_client.py``) from reporting whatever exception type escapes
    ...
    # Delta table. Not a Insights defect and not a customer credential problem (see
    ...
    # A Django OperationalError/InterfaceError here comes from a lookup against Insights's own app
