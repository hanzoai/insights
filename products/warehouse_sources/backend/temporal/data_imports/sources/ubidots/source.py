...
class UbidotsSource(ResumableSource[UbidotsSourceConfig, UbidotsResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Ubidots API token to pull your IoT devices, variables, and sensor values into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/ubidots",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
