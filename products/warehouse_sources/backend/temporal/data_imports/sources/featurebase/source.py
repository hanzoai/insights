...
class FeaturebaseSource(
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption=(
                ...
                "upvoters, changelogs, and users into the Insights Data warehouse.\n\n"
                "You can create an API key in your Featurebase dashboard under "
                "**Settings** > **API**."
            ),
            iconPath="/static/services/featurebase.png",
            docsUrl="https://hanzo.ai/docs/cdp/sources/featurebase",
            ...
            webhookSetupCaption=(
                "Insights registers the Featurebase webhook for you using your API key, including "
    ...
    def get_desired_webhook_events(
        ...
        # before a table was enabled; unmapped events are dropped by the script function.
