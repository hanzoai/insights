database "insights" {
  ...
  table "ingestion_warnings_v2" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.ingestion_warnings_v2"
      replica_name = "{replica}-{shard}"
    }
  }
  ...
  table "kafka_error_tracking_fingerprint_issue_state" {
    ...
    engine "kafka" {
      ...
      topic_list  = "kafka_topic_list = 'datastore_error_tracking_fingerprint_issue_state'"
      group_name  = "kafka_group_name = 'datastore-error-tracking-fingerprint-issue-state'"
  ...
  table "kafka_ingestion_warnings_v2" {
    ...
    engine "kafka" {
      ...
      topic_list  = "kafka_topic_list = 'datastore_ingestion_warnings'"
      group_name  = "kafka_group_name = 'datastore_ingestion_warnings_v2'"
      format      = "kafka_format = 'JSONEachRow'"
    }
  }
  ...
  table "kafka_message_assets" {
    ...
    engine "kafka" {
      broker_list          = "warpstream_cyclotron"
      topic_list           = "kafka_topic_list = 'datastore_message_assets'"
      group_name           = "kafka_group_name = 'datastore_message_assets'"
      format               = "kafka_format = 'JSONEachRow'"
      skip_broken_messages = 100
    }
  }
  ...
  table "kafka_property_values" {
    ...
    engine "kafka" {
      broker_list         = "warpstream_ingestion"
      topic_list          = "kafka_topic_list = 'datastore_property_values'"
      group_name          = "kafka_group_name = 'datastore_property_values'"
      format              = "kafka_format = 'JSONEachRow'"
      num_consumers       = 8
  ...
  table "message_assets_data" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.message_assets_data"
      replica_name   = "{replica}-{shard}"
      version_column = "version"
    }
  }
  ...
  table "property_values" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.property_values"
      replica_name = "{replica}-{shard}"
    }
  }
  ...
  table "raw_error_tracking_fingerprint_issue_state" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.raw_error_tracking_fingerprint_issue_state"
      replica_name   = "{replica}-{shard}"
      version_column = "version"
    }
  }
  ...
  table "sharded_conversion_goal_attributed_preaggregated" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.conversion_goal_attributed_preaggregated"
      replica_name   = "{replica}-{shard}"
  ...
  table "sharded_experiment_metric_events_preaggregated" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.experiment_metric_events_preaggregated"
      replica_name   = "{replica}-{shard}"
      version_column = "computed_at"
    }
  }
  ...
  table "sharded_marketing_conversions_preaggregated" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.marketing_conversions_preaggregated"
      replica_name   = "{replica}-{shard}"
      version_column = "computed_at"
    }
  }
  ...
  table "sharded_marketing_costs_preaggregated" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.marketing_costs_preaggregated"
      replica_name   = "{replica}-{shard}"
      version_column = "computed_at"
    }
  }
  ...
  table "sharded_marketing_touchpoints_preaggregated" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.marketing_touchpoints_preaggregated"
      replica_name   = "{replica}-{shard}"
      version_column = "computed_at"
    }
  }
  ...
  table "sharded_session_replay_features" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.session_replay_features"
  ...
  table "sharded_usage_report_events_preagg" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.sharded_usage_report_events_preagg"
      replica_name = "{replica}"
    }
  }
  ...
  table "sharded_web_bot_definition" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.sharded_web_bot_definition"
      replica_name = "{replica}"
    }
  }
  ...
  table "sharded_web_bounces_dimensional_preaggregated" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.web_bounces_dimensional_preaggregated"
      replica_name   = "{replica}"
      version_column = "computed_at"
    }
  }
  ...
  table "sharded_web_goals_preaggregated" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.web_goals_preaggregated"
      replica_name   = "{replica}"
      version_column = "computed_at"
    }
  }
  ...
  table "sharded_web_overview_preaggregated" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.web_overview_preaggregated"
      replica_name   = "{replica}"
      version_column = "computed_at"
    }
  }
  ...
  table "sharded_web_stats_dimensional_preaggregated" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.web_stats_dimensional_preaggregated"
      replica_name   = "{replica}"
      version_column = "computed_at"
    }
  }
  ...
  table "sharded_web_stats_frustration_preaggregated" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.web_stats_frustration_preaggregated"
      replica_name   = "{replica}"
      version_column = "computed_at"
    }
  }
  ...
  table "sharded_web_stats_paths_preaggregated" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.web_stats_paths_preaggregated"
      replica_name   = "{replica}"
      version_column = "computed_at"
    }
  }
  ...
  table "sharded_web_stats_paths_preaggregated_pathkey" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.web_stats_paths_preaggregated_pathkey"
      replica_name   = "{replica}"
      version_column = "computed_at"
    }
  }
  ...
  table "sharded_web_stats_preaggregated" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.web_stats_preaggregated"
      replica_name   = "{replica}"
      version_column = "computed_at"
    }
  }
  ...
  table "sharded_web_vitals_paths_preaggregated" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.web_vitals_paths_preaggregated"
      replica_name   = "{replica}"
      version_column = "computed_at"
    }
  }
  ...
  materialized_view "error_tracking_fingerprint_issue_state_mv" {
    to_table = "insights.writable_error_tracking_fingerprint_issue_state"
    query    = <<SQL
SELECT
  team_id,
  fingerprint,
...
SQL
  ...
  materialized_view "ingestion_warnings_v2_mv" {
    to_table = "insights.ingestion_warnings_v2"
    query    = <<SQL
SELECT
  team_id,
  source,
...
SQL
  ...
  materialized_view "message_assets_mv" {
    to_table = "insights.message_assets_data"
    query    = <<SQL
SELECT
  team_id,
  function_kind,
  ...
  _offset,
  _partition
FROM insights.kafka_message_assets
SQL
...
SQL
  ...
  materialized_view "property_values_mv" {
    to_table = "insights.property_values"
    query    = <<SQL
SELECT
  team_id,
  property_type,
...
FROM insights.kafka_property_values
SQL
