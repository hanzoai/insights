...
export const PRODUCT_BRANDING: Record<string, ProductBranding> = {
    product_analytics: {
        ...
        docsHref: 'https://hanzo.ai/docs/product-analytics',
        Icon: IconGraph,
        rgb: '47 128 250',
    },
    web_analytics: {
        label: 'Web analytics',
        docsHref: 'https://hanzo.ai/docs/web-analytics',
        Icon: IconPieChart,
        rgb: '54 196 111',
    },
    session_replay: {
    ...
    feature_flags: {
        label: 'Feature flags',
        docsHref: 'https://hanzo.ai/docs/feature-flags',
        Icon: IconFlag,
        rgb: '48 171 198',
    },
    experiments: {
        label: 'Experiments',
        docsHref: 'https://hanzo.ai/docs/experiments',
        Icon: IconFlask,
        rgb: '182 42 217',
    },
    surveys: {
        label: 'Surveys',
        docsHref: 'https://hanzo.ai/docs/surveys',
        Icon: IconMessage,
        rgb: '243 84 84',
    },
    error_tracking: {
    ...
    data_warehouse: {
        ...
        docsHref: 'https://hanzo.ai/docs/data-warehouse',
        Icon: IconDatabase,
        rgb: '133 103 255',
    },
    llm_analytics: {
        label: 'AI observability',
        docsHref: 'https://hanzo.ai/docs/ai-observability',
