...
//!
//! ```sh
//! cargo test --release -p insights-replay-anonymizer --test bench_images -- --ignored --nocapture
//! ```

use std::time::Instant;

use base64::Engine;
use insights_replay_anonymizer::snapshot::{anonymize_kafka_payload_opts, AnonymizeOpts};
use insights_replay_anonymizer::{AllowLists, ImagePolicy};
use serde_json::json;
