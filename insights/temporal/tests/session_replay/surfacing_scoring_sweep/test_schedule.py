...
from insights.temporal.session_replay.surfacing_scoring_sweep.schedule import _build_schedule
...
class TestSurfacingScoringSchedule:
    ...
    def test_schedule_is_wired_into_deploy_registry(self) -> None:
        ...
        from insights.temporal.session_replay.surfacing_scoring_sweep.schedule import (  # noqa: PLC0415
