...
from insights.models import Action, Dashboard, DashboardTile, EventDefinition, Insight, Person, PropertyDefinition
    ...
    def populate_person_events(self, person: Person, distinct_id: str, _index: int):
        ...
        if random.randint(0, 10) <= 9:
            ...
            self.add_event(
                ...
                properties={"$current_url": "https://insightsflix/" + random.choice(SCREEN_OPTIONS)},
            )
