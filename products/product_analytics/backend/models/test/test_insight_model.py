...
class TestInsightModel(BaseTest):
    ...
    @parameterized.expand(
        [
            ("insightsql_via_data_visualization", {"kind": "DataVisualizationNode", "source": {"kind": "InsightsQLQuery"}}),
            ("bare_insightsql", {"kind": "InsightsQLQuery"}),
            ("no_query", None),
        ]
    )
    ...
    @parameterized.expand(
        [
            ...
            (
                "insightsql_via_data_visualization",
                {"kind": "DataVisualizationNode", "source": {"kind": "InsightsQLQuery"}},
                {"query_kind": "DataVisualizationNode", "query_source_kind": "InsightsQLQuery"},
            ),
            (
                "data_table_events",
            ...
            ("bare_insightsql_no_source", {"kind": "InsightsQLQuery"}, {"query_kind": "InsightsQLQuery"}),
            ("no_query", None, {}),
        ]
    )
