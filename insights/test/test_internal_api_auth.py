...
from insights.settings import LOCAL_DEV_INTERNAL_API_SECRET
...
class TestInternalAPIAuth(APIBaseTest):
    ...
    def test_explicitly_configured_secret_allows_access_outside_debug_or_test(self):
        # The value is not policed — any explicitly-set secret is accepted (e.g. CI sets insights123).
        request = Request(
    ...
    def test_team_and_organization_inferred_from_url_params(self):
        ...
        with patch("insights.auth.apps.get_model") as mock_get_model:
