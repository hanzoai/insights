...
from insights.temporal.llm_analytics.sentiment.schema import ClassifySentimentInput, PendingClassification
from insights.temporal.llm_analytics.sentiment.utils import build_trace_result, collect_pending, resolve_date_bounds
...
async def classify_sentiment_activity(input: ClassifySentimentInput) -> dict[str, dict[str, Any]]:
    ...
    from insights.temporal.llm_analytics.sentiment.constants import MAX_CLASSIFICATIONS_PER_TRACE
    from insights.temporal.llm_analytics.sentiment.data import fetch_generations
    from insights.temporal.llm_analytics.sentiment.model import classify
