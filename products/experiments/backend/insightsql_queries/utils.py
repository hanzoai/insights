...
from products.experiments.backend.insightsql_queries import CONTROL_VARIANT_KEY
from products.experiments.backend.insightsql_queries.cuped_config import CupedQueryConfig, get_cuped_config
...
def get_experiment_query_debug(
    ...
    *,
    ...
    """
    Generate both InsightsQL and Datastore SQL for debugging from experiment query AST.
    Returns (insightsql, datastore_sql) tuple.
    ...
    datastore_sql = substitute_params_for_display(datastore_sql_with_params, datastore_context_with_values.values)
    assert executor.insightsql is not None
    return (executor.insightsql, datastore_sql)
