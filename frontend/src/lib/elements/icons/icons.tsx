...
export function IconWithCount({
    ...
    return (
        <span className={clsx('relative inline-flex', className)}>
            {children}
            <Badge.Number count={count} size="small" position="top-right" showZero={showZero} status={status} />
        </span>
    )
}
...
const IconBase: React.FC<SVGAttributes<SVGSVGElement>> = ({ className, ...props }) => (
    <svg
...
export function IconUnverifiedEvent(props: IconProps): JSX.Element {
    return (
        <IconBase {...props}>
            <path
