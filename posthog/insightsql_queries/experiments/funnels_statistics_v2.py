...
def calculate_probabilities_v2(
    ...
    >>> from posthog.insightsql_queries.experiments.funnels_statistics_v2 import calculate_probabilities_v2
...
def calculate_credible_intervals_v2(variants: list[ExperimentVariantFunnelsBaseStats]) -> dict[str, list[float]]:
    ...
    --------
    >>> from posthog.schema import ExperimentVariantFunnelsBaseStats
    >>> from posthog.insightsql_queries.experiments.funnels_statistics_v2 import calculate_credible_intervals_v2
    >>> variants = [
