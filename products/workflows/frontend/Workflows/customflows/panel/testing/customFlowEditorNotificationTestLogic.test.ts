...
describe('customFlowEditorNotificationTestLogic', () => {
    let logic: ReturnType<typeof customFlowEditorNotificationTestLogic.build>
    ...
    beforeEach(() => {
        ...
        useMocks({
            get: {
                ...
                '/api/environments/@current/custom_flows/test-workflow-id/': {
                    id: 'test-workflow-id',
                    team_id: 1,
                    name: 'Test Workflow',
                    status: 'draft',
        ...
        logic = customFlowEditorNotificationTestLogic({ id: 'test-workflow-id' })
        logic.mount()
    })
    ...
    describe('persistence', () => {
        it('should persist emailAddressOverride, selectedPersonDistinctId, and sampleGlobals across unmount/remount', async () => {
            ...
            const newLogic = customFlowEditorNotificationTestLogic({ id: 'test-workflow-id' })
            newLogic.mount()
