...
class CustomerIOSource(
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption=(
                ...
                f"[App API Key]({CIO_APP_API_KEY_URL}). Insights uses the key to pull "
            ...
            label="Customer.io",
            docsUrl="https://hanzo.ai/docs/cdp/sources/customer-io",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
                        ...
                        caption=(
                            ...
                            "Insights needs this key both for pulling list endpoints and for managing the "
            ...
            webhookSetupCaption=(
                "Insights tries to register the reporting webhook for you using your App API Key. "
    ...
    def webhook_inputs_updated(
        ...
        # events at Insights before we can verify them with the signing secret.
