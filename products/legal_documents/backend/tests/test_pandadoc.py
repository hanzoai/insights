...
class TestPandaDocClient(TestCase):
    ...
    def test_create_document_posts_expected_payload(self) -> None:
        ...
        fake_response.content = b'{"id": "doc_123", "status": "document.uploaded", "name": "Insights BAA"}'
        fake_response.json.return_value = {"id": "doc_123", "status": "document.uploaded", "name": "Insights BAA"}
        ...
        self.assertEqual(body["name"], "Insights BAA")
        ...
        self.assertEqual(body["owner"], {"email": "privacy@hanzo.ai"})
    ...
    def test_send_document_includes_sender_when_provided(self) -> None:
        ...
        with patch(
            ...
            pandadoc.PandaDocClient().send_document(
                ...
                subject="s",
                message="m",
                sender_email="privacy@hanzo.ai",
            )

        args, kwargs = mock_post.call_args
        self.assertEqual(args[0], "https://api.pandadoc.com/public/v1/documents/doc_123/send")
        self.assertEqual(kwargs["json"]["sender"], {"email": "privacy@hanzo.ai"})
    ...
    def test_serialize_recipient_emits_flat_email_and_role_for_each_role(self) -> None:
        # Both the Client signer and the Insights CC serialize to the same
        ...
        insights = pandadoc.PandaDocRecipient(email="privacy@hanzo.ai", role=pandadoc.PandaDocRole.INSIGHTS)
        self.assertEqual(pandadoc._serialize_recipient(insights), {"email": "privacy@hanzo.ai", "role": "Insights"})
