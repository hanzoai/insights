...
class Command(BaseCommand):
    help = (
        ...
        "Shows reports from Postgres with optional signal details from Datastore."
    )
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--signals", action="store_true", help="Include full signal details from Datastore")
