...
export function FinishExperimentModal(): JSX.Element {
    ...
    // The cleanup PR runs as a Insights Desktop task, so the user needs Code access on top of the rollout flag.
                ...
                <div className="space-y-4">
                    {isSingleVariantShipped ? (
                        ...
                        <>
                            ...
                            <div>
                                <Label showOptional>Variant to keep</Label>
                            ...
                            {selectedVariantKey && (
                                <div className="flex flex-col gap-2">
                                    <Label>How to release this variant</Label>
                                    <div
