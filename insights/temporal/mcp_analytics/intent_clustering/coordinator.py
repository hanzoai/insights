...
from insights.temporal.mcp_analytics.intent_clustering.models import (
...
with temporalio.workflow.unsafe.imports_passed_through():
    from insights.temporal.mcp_analytics.intent_clustering.team_discovery import (
...
class IntentClusteringCoordinatorWorkflow(InsightsWorkflow):
