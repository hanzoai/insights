...
export function VercelConnect(): JSX.Element {
        ...
        return (
            <BridgePage view="vercel-connect">
                ...
                <p className="text-center mb-6">
                    Your Insights organization <strong>{linkedOrgName}</strong> is now connected to Vercel.
                </p>
                {redirectUrl ? (
                    <Button
                        fullWidth
                    ...
                    <Button fullWidth type="primary" center to="/">
                        Go to Insights
                    </Button>
                )}
            </BridgePage>
    ...
    if (error && !sessionInfo) {
        return (
            <BridgePage view="vercel-connect">
                ...
                <Button fullWidth type="secondary" center onClick={() => window.close()}>
                    Close
                </Button>
            </BridgePage>
        )
    ...
    return (
        <BridgePage view="vercel-connect">
            ...
            <p className="text-center mb-6">Select which Insights organization to link to your Vercel account.</p>
            ...
            <Button fullWidth type="secondary" center className="mt-2" onClick={() => window.close()}>
                Cancel
            </Button>
        </BridgePage>
    )
