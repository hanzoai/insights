...
pub struct FlagEvaluationState {
    ...
    /// Static results come from `insights_cohortpeople`, realtime results from `cohort_membership`.
...
pub struct FeatureFlagMatcher {
    ...
    /// relative dates), so flag evaluation matches InsightsQL/Datastore cohort behavior.
...
impl FeatureFlagMatcher {
    ...
    /// evaluation agrees with InsightsQL/Datastore cohort membership near day boundaries.
