...
const sessionRecordingGet = (): ToolBase<typeof SessionRecordingGetSchema, WithInsightsUrl<Schemas.SessionRecording>> =>
...
const sessionRecordingPlaylistsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedSessionRecordingPlaylistList>
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof SessionRecordingPlaylistsListSchema>) => {
        ...
        return await withInsightsUrl(context, result, '/replay')
    },
})
...
const sessionRecordingSummariesList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedSingleSessionSummaryMinimalList>
> => ({
...
const sessionRecordingSummaryGet = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.SingleSessionSummary>
> => ({
