        ...
        <div className="border rounded p-4 space-y-3">
            ...
            <div>
                ...
                <CodeSnippet
                    ...
                    wrap
                    thing="psql command"
                    onCopy={() => insights.capture('managed warehouse connection details copied')}
                >
                    {psqlCmd}
                </CodeSnippet>
            </div>
...
export function SettingsTab(): JSX.Element {
    ...
    return (
        <div className="mt-4 space-y-4 max-w-160">
            ...
            {initialPassword && (
                <Banner type="warning" onClose={clearInitialPassword}>
            ...
            {warehouseStatusLoading && !warehouseStatus ? (
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <Input value={schemaName} onChange={setSchemaName} placeholder="my_project" fullWidth />
                ...
                <div className="space-y-4">
                    {isInProgress && (
                        <Banner type={deprovisionTakingLong ? 'warning' : 'info'}>
                            <div className="flex items-center gap-2">
                                <Spinner />
                                <span>
                    ...
                    <div className="border rounded px-4 pt-4 pb-3 space-y-2">
                        <div className="flex items-center justify-between">
                            ...
                            <Tag type={stateToTagType(warehouseStatus!.state)}>
