...
const mockStateGauge = personinsightsConnectionState as jest.Mocked<typeof personinsightsConnectionState>
const mockTransitions = personinsightsConnectionStateTransitionsTotal as jest.Mocked<
    typeof personinsightsConnectionStateTransitionsTotal
>
const mockEstablishment = personinsightsConnectionEstablishmentSeconds as jest.Mocked<
    typeof personinsightsConnectionEstablishmentSeconds
>
const mockStreamsInFlight = personinsightsStreamsInFlight as jest.Mocked<typeof personinsightsStreamsInFlight>
const mockStreamAcquisition = personinsightsStreamAcquisitionSeconds as jest.Mocked<typeof personinsightsStreamAcquisitionSeconds>
