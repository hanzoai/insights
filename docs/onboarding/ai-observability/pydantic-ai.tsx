    ...
    return [
            ...
            content: (
                <>
                    ...
                    <CodeBlock
                        language="bash"
                        code={dedent`
                            pip install "pydantic-ai[openai]" opentelemetry-sdk "insights[otel]"
                        `}
                    />
                </>
            ),
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        Configure OpenTelemetry to export traces to Insights and enable Pydantic AI's built-in OTel
                        instrumentation. Insights converts `gen_ai.*` spans into `$ai_generation` events automatically.
                    </Markdown>
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        Create a Pydantic AI agent and run it. Insights automatically captures an `$ai_generation` event
                    ...
                    <CodeBlock
                        ...
                        code={dedent`
                            ...
                            result = agent.run_sync("Tell me a fun fact about mascots.")
                            print(result.output)
                        `}
                    />
