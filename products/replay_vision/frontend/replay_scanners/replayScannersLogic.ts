...
export interface replayScannersLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface replayScannersLogicActions {
    clearFilters: () => {
        value: true
    }
    ...
    toggleScannerEnabled: (id: string) => {
        id: string
    }
    toggleScannerEnabledDone: (id: string) => {
        id: string
    }
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface replayScannersLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        search: (filters: ScannersFilters) => string
        enabledFilter: (filters: ScannersFilters) => EnabledFilter[]
        scannerTypeFilter: (filters: ScannersFilters) => ScannerTypeEnumApi[]
        createdByFilter: (filters: ScannersFilters) => string[]
...
export type replayScannersLogicType = MakeLogicType<
    replayScannersLogicValues,
    replayScannersLogicActions,
    Record<string, any>,
    replayScannersLogicMeta
>
    ...
    listeners(({ actions, values }) => ({
        loadScanners: async (_, breakpoint) => {
            ...
            try {
                ...
                toast.error(`Failed to load scanners${error.detail ? `: ${error.detail}` : ''}`)
        ...
        deleteScanner: async ({ id }) => {
            ...
            try {
                ...
                visionQuotaLogic.findMounted()?.actions.adjustProjectedMonthly(-delta)
                toast.error(`Failed to delete scanner${error.detail ? `: ${error.detail}` : ''}`)
            } finally {
