    ...
    return [
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        We call Cohere through the OpenAI-compatible API and generate a response. We'll use Insights's OpenAI
                        ...
                        Insights client along with the Cohere config (the base URL and API key) to our OpenAI wrapper.
                    </Markdown>
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        Now, when you call Cohere with the OpenAI SDK, Insights automatically captures an
