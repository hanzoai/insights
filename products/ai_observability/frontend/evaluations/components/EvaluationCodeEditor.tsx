...
const FN_EVAL_COMMON_GLOBAL_DEFINITIONS: readonly HogGlobalDefinition[] = [
    {
        ...
        fields: [
            ...
            { name: 'event', type: 'string', description: 'The Insights event name.' },
        ...
        <div className="space-y-4">
                ...
                <div className="flex justify-between items-center text-sm text-muted">
                    <div className="flex items-center gap-2">
                        ...
                        <Button
                            ...
                            icon={<IconSparkles />}
                            onClick={() =>
                                openAi('Help me write Script evaluation code for this evaluation', {
                                    evaluation: {
                                        id: evaluation.id,
            ...
            <div className="bg-bg-light border rounded p-3">
                <div className="flex items-center justify-between mb-2">
                    ...
                    <Link to="https://hanzo.ai/docs/script" target="_blank" className="text-sm">
                        Script language reference <IconExternal className="inline text-xs" />
                    </Link>
                </div>
