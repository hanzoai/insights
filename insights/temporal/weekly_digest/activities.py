...
from insights.ph_client import get_client as get_ph_client
...
from insights.temporal.weekly_digest.queries import (
...
# Weekly usage snapshot per team. Written in InsightsQL so it inherits the team's test-account
...
def _query_team_usage_trends(team_id: int, period_start: datetime, period_end: datetime) -> UsageTrends | None:
    ...
    Synchronous (InsightsQL execution is sync); callers wrap it with ``database_sync_to_async``.
    """
