...
TEST_BUCKET = "test_storage_bucket-insights.insightsql_queries.insights.retention.data_warehouse"


class TestRetentionDataWarehouse(DatastoreTestMixin, APIBaseTest):
    def setUp(self):
        super().setUp()
        self.cleanup_fns = []
        self.temp_dirs = []
    ...
    def test_retention_data_warehouse_breakdown_by_warehouse_column(self):
        ...
        result = self.run_query(
            query={
                ...
                "breakdownFilter": {"breakdown": "plan", "breakdown_type": "insightsql"},
            }
        )
