...
const dataWarehouseStoredCredentialsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.SourceCredential[]>
> => ({
...
const externalDataSchemasList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedExternalDataSchemaList>
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof ExternalDataSchemasListSchema>) => {
        ...
        return await withInsightsUrl(context, filtered, '/data-management/sources')
    },
})
...
const externalDataSourcesConnectionsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.ExternalDataSourceConnectionOption[]>
> => ({
...
const externalDataSourcesList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedExternalDataSourceSerializersList>
> => ({
