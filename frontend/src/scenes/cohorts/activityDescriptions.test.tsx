...
describe('cohortActivityDescriber', () => {
    ...
    it.each([
        ['created', 'High value users', 'Max Script created the cohort: High value users'],
        ['deleted', 'High value users', 'Max Script deleted the cohort: High value users'],
        ['restored', 'High value users', 'Max Script restored the cohort: High value users'],
        ['persons_added_manually', 'Beta testers', 'Max Script added users to the cohort: Beta testers'],
        ['person_removed_manually', 'Beta testers', 'Max Script removed a user from the cohort: Beta testers'],
    ...
    describe('updated activity', () => {
        ...
        it('falls back to a generic line when changes array is empty', () => {
            ...
            ).toBe('Max Script updated the cohort: My cohort')
        })
        ...
        it('skips excluded fields without rendering them', () => {
            ...
            expect(text).toBe('Max Script updated the cohort: My cohort')
        })
    })
})
