...
to `UNATTRIBUTED_PROJECT` moved most of the plane off the project it was
captured under, so re-projecting now would write a second copy under the new
project and double-count every event it touched rather than adding a `$host`.
