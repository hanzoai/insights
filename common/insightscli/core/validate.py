...
import yaml
from insightscli.core.manifest import REPO_ROOT, get_manifest
...
def get_bin_scripts() -> set[str]:
    ...
    excluded = {"insightscli", "mprocs.yaml", "mprocs-test.yaml"}
...
def auto_update_manifest() -> set[str]:
    ...
    manifest_file = REPO_ROOT / "common" / "insightscli" / "manifest.yaml"
