...
from posthog.insightsql.database.schema.groups import GroupsTable, join_with_group_n_table
...
from posthog.insightsql.database.schema.sessions_v1 import SessionsTableV1, join_events_table_to_sessions_table
