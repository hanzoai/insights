// phrocs is a Insights-branded dev process runner built with Bubble Tea.
//
// It is a drop-in replacement for mprocs: it reads the same YAML config
// that `insightscli dev:generate` produces and renders a customisable TUI with a
// per-process sidebar, scrollable output panes, and insightscli-aware keybindings.
//
// Usage:
//
...
import (
	...
	"github.com/insights/insights/phrocs/internal/ipc"
	"github.com/insights/insights/phrocs/internal/process"
	"github.com/insights/insights/phrocs/internal/tui"
)
...
func printUsage() {
	fmt.Println(`phrocs — Insights dev process runner
