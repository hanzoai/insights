...
export interface screenshotUploadLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface screenshotUploadLogicActions {
    closeModal: () => {
        value: true
    }
...
export type screenshotUploadLogicType = MakeLogicType<
    screenshotUploadLogicValues,
    screenshotUploadLogicActions,
    ScreenshotUploadLogicProps
>
