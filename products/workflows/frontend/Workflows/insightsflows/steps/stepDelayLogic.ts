...
export interface stepDelayLogicActions {
    ...
    setWorkflowActionConfig: (actionId: string, config: {
        cohorts: {
    ...
    setDelayWorkflowActionConfig: (actionId: string, config: {
        delay_duration: string;
    }) => {
        actionId: string;
        config: {
...
export type stepDelayLogicType = MakeLogicType<stepDelayLogicValues, stepDelayLogicActions, StepDelayLogicProps, stepDelayLogicMeta>;
