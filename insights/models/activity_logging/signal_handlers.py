...
from insights.constants import AUTH_BACKEND_DISPLAY_NAMES
from insights.exceptions_capture import capture_exception
from insights.geoip import get_geoip_properties
from insights.helpers.impersonation import get_original_user_from_session, is_impersonated
from insights.models import Organization, PersonalAPIKey, Tag, TaggedItem
...
from insights.models.activity_logging.model_activity import get_current_trigger, get_current_user, get_was_impersonated
from insights.models.activity_logging.personal_api_key_utils import (
    log_personal_api_key_activity,
    log_personal_api_key_scope_change,
)
from insights.models.activity_logging.project_secret_api_key_utils import log_project_secret_api_key_activity
from insights.models.activity_logging.tag_utils import get_tagged_item_related_object_info
...
# --- Receivers relocated from insights.api viewset modules ---------------------------------
...
# --- Login session/device bookkeeping, relocated from insights.api.authentication ---------
