...
from insights.helpers.dashboard_templates import create_from_template, dashboard_template_from_creation_payload
...
from insights.session_recordings.session_recording_api import get_replay_listing_throttle_error
...
class DashboardTileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        exclude = [
            ...
            "refreshing",
            "refresh_attempt",
            # Denormalization for InsightsQL printing; combined with depth=1, leaving it
...
class DashboardSerializer(DashboardMetadataSerializer):
    ...
    def update(self, instance: Dashboard, validated_data: dict, *args: Any, **kwargs: Any) -> Dashboard:
        ...
        if validated_data.get("deleted", False):
            ...
            from insights.models.group_type_mapping import clear_dashboard_from_group_type_mapping
...
class DashboardsViewSet(
    ...
    def _apply_folder_filter(queryset: QuerySet, folder: str) -> QuerySet:
        ...
        # sub-folders don't leak in, and lets the filter ride the insights_fs_team_s_typeref index via the
    ...
    def dangerously_get_queryset(self):
        ...
        # backed by the insights_fs_team_s_typeref index on (team_id, surface, type, ref) — keeps this cheap
