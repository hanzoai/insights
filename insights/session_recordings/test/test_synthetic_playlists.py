...
from insights.models import Comment, SessionRecordingPlaylist
from insights.models.event.sql import EVENTS_JSON_DATA_TABLE
...
from insights.session_recordings.synthetic_playlists import ExpiringPlaylistSource, FrustrationSignalsPlaylistSource
...
class TestSyntheticPlaylists(APIBaseTest):
    ...
    def test_expiring_playlist_caches_and_shares_one_scan(self) -> None:
        ...
        with patch(
            "insights.session_recordings.synthetic_playlists.list_recordings_from_query",
    ...
    def test_synthetic_playlist_pagination(self) -> None:
        from insights.session_recordings.synthetic_playlists import WatchedPlaylistSource
