...
class Migration(migrations.Migration):
    ...
    operations = [
        SafeAddIndexConcurrently(
            model_name="task",
            index=models.Index(fields=["team", "-created_at", "-id"], name="insights_task_team_created_idx"),
        ),
        SafeAddIndexConcurrently(
            model_name="task",
            index=models.Index(
                fields=["team", "created_by", "-created_at", "-id"], name="insights_task_team_creator_idx"
            ),
        ),
        SafeAddIndexConcurrently(
            model_name="taskrun",
