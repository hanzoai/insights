...
``products/insights_ai/evals/experiments/scorers.py`` directly, lightweight as it's
...
def test_first_update_correct_first_try() -> None:
    score = _score(_output(_tool_call("c1", "mcp__insights__experiment-update", {"metrics": [RATIO_SUM]})))
    assert score.score == 1.0
