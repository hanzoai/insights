...
from insights.rbac.user_access_control import RESOURCE_FALLBACK_MAP
...
def queried_access_controlled_resources(query, team: "Team") -> Optional[set[str]]:
    ...
    # Deferred to break the query_runner -> this module -> insightsql import cycle.
    from insights.insightsql.database.database import get_data_warehouse_table_name  # noqa: PLC0415
    from insights.insightsql.database.schema.system import access_controlled_system_tables  # noqa: PLC0415
    from insights.insightsql.errors import BaseInsightsQLError  # noqa: PLC0415
    from insights.insightsql.metadata import get_table_names  # noqa: PLC0415
    from insights.insightsql.parser import parse_select  # noqa: PLC0415

    from products.data_modeling.backend.facade.models import DataWarehouseSavedQuery
    from products.warehouse_sources.backend.facade.models import DataWarehouseTable  # noqa: PLC0415

    # Raw InsightsQL is the only query that references system.* and warehouse tables by name
    if getattr(query, "kind", None) == "InsightsQLQuery":
        ...
        # Warehouse tables/views are per-team and dynamic, and the InsightsQL schema isn't built here (the
