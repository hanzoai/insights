...
class ExecuteDAGWorkflow(InsightsWorkflow):
    ...
    async def _execute_dag(self, inputs: ExecuteDAGInputs) -> ExecuteDAGResult:
        ...
        serving_engine = (
            DataModelingJobEngine.DUCKGRES if inputs.duckgres_only else DataModelingJobEngine.DATASTORE
        ).value
        ...
        # all levels to be a friendlier neighbor to duckgres and datastore infrastructure
