...
export function AskMaxCard(): JSX.Element {
    ...
    return (
        <Card
            ...
            // Card renders a plain <div>; we wrap the whole clickable area in a <button> inside it
        ...
        >
            <button
                ...
                aria-label="Got questions? Ask Insights AI"
            >
                ...
                <div className="flex-1 min-w-0">
                    <div className="font-semibold text-sm">Got questions? Ask Insights AI</div>
