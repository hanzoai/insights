...
@patch(
    "insights.temporal.llm_analytics.trace_summarization.sampling.Heartbeater",
    _noop_heartbeater,
)
class TestSampleItemsInWindowActivity:
    ...
    async def test_sample_traces_success(self, mock_team):
        ...
        with patch("insights.temporal.llm_analytics.trace_summarization.sampling.execute_insightsql_query") as mock_execute:
