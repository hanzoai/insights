...
describe('webhook template', () => {
    ...
    it('should invoke the function', async () => {
        ...
        expect(response.invocation.queueParameters).toMatchInlineSnapshot(`
            {
              "body": "{"event":{"uuid":"event-id","event":"event-name","distinct_id":"distinct-id","properties":{"$lib_version":"1.0.0"},"timestamp":"2024-01-01T00:00:00Z","elements_chain":"","url":"https://us.hanzo.ai/projects/1/events/1234"},"person":{"id":"person-id","name":"person-name","properties":{"email":"example@hanzo.ai"},"url":"https://us.hanzo.ai/projects/1/persons/1234"}}",
              "headers": {
