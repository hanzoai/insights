            ...
            post: {
                '/api/environments/:team_id/query/:kind/': async () => {
                    ...
                    return HttpResponse.json(
                        {
                            type: 'server_error',
                            code: 'datastore_memory_limit_exceeded',
                            detail: "This query ran out of memory before it could finish, usually because it's scanning too much data. Try a shorter date range or narrower filters, or see our docs for more ways to speed it up: https://hanzo.ai/docs/product-analytics/troubleshooting#how-do-i-speed-up-my-insights-and-queries",
                        },
                        { status: 513 }
                    )
                },
