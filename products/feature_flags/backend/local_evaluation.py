...
from insights.utils import capture_exception_throttled, get_safe_cache
...
FLAG_PROCESSING_ERROR_COUNTER = Counter(
    "insights_flag_definitions_processing_error",
...
HYPERCACHE_GROUP_MAPPING_EMPTIED_COUNTER = Counter(
    "insights_hypercache_group_mapping_emptied",
...
FLAG_DEFINITIONS_HYPERCACHE_MANAGEMENT_CONFIG = HyperCacheManagementConfig(
    ...
    # group_type_mapping (personinsights lag), same as the signal-driven write path.
