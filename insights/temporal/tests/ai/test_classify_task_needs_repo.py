...
class TestClassifyTaskNeedsRepo:
    @parameterized.expand(
        [
            (
                ...
                "debug why the automation that sends Insights AI Feedback always gives a thumbs down",
                False,
            ),
            (
            ...
            ("analytics_insightsql", "write a insightsql query to count signups by country", False),
    ...
    def test_llm_path_returns_true_when_model_says_needs_repo(self):
        ...
        text = "open a PR in insights/insights to fix this serializer"
    ...
    def _run_with_llm_content(self, text: str, content: str) -> bool:
        ...
        with patch(
            "insights.temporal.ai.slack_app.activities.classifiers.get_llm_client",
