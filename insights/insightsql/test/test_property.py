...
from insights.schema import EmptyPropertyFilter, InsightsQLPropertyFilter, RetentionEntity
...
from insights.models import Cohort, Property, PropertyDefinition, Team
...
class TestProperty(BaseTest):
    ...
    def test_entity_to_expr_actions_type_with_id(self):
        ...
        with patch("insights.models.Action.objects.get", return_value=action_mock):
