        ...
        <div className="rounded-lg border border-primary bg-surface-secondary p-4 space-y-3">
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="shrink-0 text-right">
                    <Tag type={pct >= 70 ? 'success' : pct >= 40 ? 'warning' : 'default'}>{pct}%</Tag>
    ...
    const columns: TableColumns<IdentityMatchingLinkApi> = [
        ...
        },
        {
            ...
            render: (_, link) => {
                ...
                return <Tag type={pct >= 70 ? 'success' : pct >= 40 ? 'warning' : 'default'}>{pct}%</Tag>
            },
            width: 100,
        },
        {
        ...
        },
        {
            ...
            width: 80,
            render: (_, link) => (link.ua_exact_match ? <Tag type="highlight">Yes</Tag> : '—'),
        },
        {
            title: 'Type',
            key: 'type',
                ...
                <>
                    ...
                    <div className="flex items-center gap-3 text-sm">
                        <span className="text-secondary">
                            <Tag type="completion">{paidLinks.length}</Tag> recovered
                        </span>
                        <span className="text-secondary">
                            <Tag type="highlight">{continuityLinks.length}</Tag> confirmed
                        </span>
