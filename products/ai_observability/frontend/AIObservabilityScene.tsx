...
import { Button, Tab, Tabs, Link, Spinner } from '@hanzo/elements'
...
const DEFAULT_DOCS_URL = 'https://hanzo.ai/docs/ai-observability/installation'
const DOCS_URLS_BY_TAB: Record<string, string> = {
    traces: 'https://hanzo.ai/docs/ai-observability/traces',
    reviews: 'https://hanzo.ai/docs/ai-observability/trace-reviews',
    generations: 'https://hanzo.ai/docs/ai-observability/generations',
    sessions: 'https://hanzo.ai/docs/ai-observability/sessions',
    errors: 'https://hanzo.ai/docs/ai-observability/errors',
    tools: 'https://hanzo.ai/docs/ai-observability/tools',
    sentiment: 'https://hanzo.ai/docs/ai-observability/sentiment',
}
