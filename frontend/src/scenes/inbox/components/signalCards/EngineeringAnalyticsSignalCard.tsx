...
function MetricTag({ signal }: { signal: SignalNode }): JSX.Element | null {
    ...
    switch (signal.source_type) {
        case SignalSourceType.CiFlakyCheck: {
            ...
            return (
                <Tag type="warning" size="small" icon={<IconWarning />}>
        ...
        case SignalSourceType.CiBrokenDefaultBranch: {
            ...
            return (
                <Tag type="danger" size="small" icon={<IconWarning />}>
        ...
        case SignalSourceType.CiDurationRegression: {
            ...
            return (
                <Tag type="warning" size="small" icon={<IconClock />}>
    ...
    return (
        <SignalCardShell signal={signal}>
            <div className="flex flex-wrap items-center gap-2">
                <Tag size="small" icon={<IconGithub />}>
            ...
            {signal.content && (
                <Markdown className="text-sm text-secondary mt-2" disableImages>
                    {signal.content}
                </Markdown>
            )}
        </SignalCardShell>
