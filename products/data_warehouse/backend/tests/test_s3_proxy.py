...
BYPASS_ON = {
    ...
    "BUCKET_URL": "s3://insights-s3-datawarehouse-us-east-1/dlt",
...
def flag(enabled: bool):
    return patch.object(s3_proxy.hanzo_insights, "feature_enabled", return_value=enabled)
...
class TestWarehouseS3ProxyBypass(SimpleTestCase):
    ...
    def test_scopes_the_bypass_to_the_warehouse_bucket_host(self) -> None:
        ...
        assert options["proxy_excludes"] == "insights-s3-datawarehouse-us-east-1.s3.us-east-1.amazonaws.com"
    ...
    def test_folds_the_environments_no_proxy_into_the_exclusions(self) -> None:
        ...
        assert (
            ...
            == "insights-s3-datawarehouse-us-east-1.s3.us-east-1.amazonaws.com,169.254.169.254,.svc.cluster.local"
        )
    ...
    def test_flag_evaluation_failure_leaves_traffic_on_the_proxy(self) -> None:
        with (
            patch.object(s3_proxy.hanzo_insights, "feature_enabled", side_effect=Exception("flags down")),
