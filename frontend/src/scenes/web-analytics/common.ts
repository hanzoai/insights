...
/** Matches BREAKDOWN_NULL_DISPLAY in insights/insightsql_queries/web_analytics/stats_table.py */
export const BREAKDOWN_NULL_DISPLAY = '(none)'
/** Matches BREAKDOWN_REFERRER_PREFIX in insights/insightsql_queries/web_analytics/stats_table.py */
