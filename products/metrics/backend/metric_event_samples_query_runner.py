...
Joins `insights.metric_samples` (the tiny hot rows) to `insights.metric_series`
...
class MetricEventSamplesQueryRunner:
    ...
    def run(self) -> list[dict[str, Any]]:
        ...
        # query string (which would collide with the InsightsQL placeholder braces) —
