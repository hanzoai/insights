...
/** Table columnKey → DRF `ordering` field (see SubscriptionViewSet.ordering_fields). */
    ...
    selectors(({ actions }) => ({
        pagination: [
            ...
            (page: number, subscriptionsResponse: PaginatedSubscriptionListApi | null) => {
                ...
                // Table shows "No …" when the page is empty, so inflating 0→1 only satisfies the hook.
