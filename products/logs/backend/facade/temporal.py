...
(``insights/management/commands/start_temporal_worker.py``), wires its metrics
interceptor (``insights/temporal/common/worker.py``), and registers its schedule
(``insights/temporal/logs_alerting/schedule.py``). That wiring crosses the boundary as
