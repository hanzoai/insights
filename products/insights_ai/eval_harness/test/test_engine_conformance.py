...
from products.insights_ai.eval_harness.engines.braintrust import BraintrustEngine
from products.insights_ai.eval_harness.engines.types import CaseHooks, CaseSpec, ExperimentResult, ExperimentSpec

# Every ``EvalEngine`` must satisfy these obligations; a future ``InsightsEvalsEngine``
