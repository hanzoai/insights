    ...
    return [
        ...
        },
        {
            ...
            render: (_value: unknown, sub: SubscriptionApi) => {
                ...
                return (
                    <Tag type="default" size="small" icon={typeTag.icon}>
                        {typeTag.label}
                    </Tag>
                )
            },
        ...
        {
            ...(createdByColumn() as unknown as TableColumn<SubscriptionApi, 'created_by'>),
            sorter: true,
        } as TableColumn<SubscriptionApi, keyof SubscriptionApi | undefined>,
        {
            ...(atColumn<SubscriptionApi>('created_at', 'Created') as TableColumn<
                SubscriptionApi,
...
export interface SubscriptionsTableProps {
    ...
    renderRowActions: (sub: SubscriptionApi) => JSX.Element
    /** Overrides the "Enabled" column with an interactive control (a Switch). Omit for a read-only tag. */
    renderEnabledToggle?: (sub: SubscriptionApi) => JSX.Element
}
...
export function SubscriptionsTable({
    ...
    return (
        <Table
            ...
            sorting={sorting}
            onSort={onSort}
            // Kea + API `ordering` own sort; Table URL `order` would diverge from subscriptionsSceneLogic on reload.
