...
export interface stampSceneLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface stampSceneLogicActions {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface stampSceneLogicMeta {
...
export type stampSceneLogicType = MakeLogicType<
    stampSceneLogicValues,
    stampSceneLogicActions,
    Record<string, any>,
    stampSceneLogicMeta
>

export const stampSceneLogic = kea<stampSceneLogicType>([
    path(['products', 'stamp', 'frontend', 'scenes', 'StampScene', 'stampSceneLogic']),
