...
from posthog.insightsql.database.schema.web_analytics_s3 import get_s3_function_args, get_s3_url
...
class TestWebAnalyticsS3(BaseTest):
    @patch("posthog.insightsql.database.schema.web_analytics_s3.DEBUG", False)
    ...
    @patch("posthog.insightsql.database.schema.web_analytics_s3.DEBUG", True)
