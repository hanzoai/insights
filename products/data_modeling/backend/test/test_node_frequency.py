...
class TestFrequencyTargetAccessors(BaseTest):
    def _node(self) -> Node:
        return _table_node(self.team, DAG.get_or_create_default(self.team), "events", {"origin": "insights"})
...
class TestResolveSourceIntervals(BaseTest):
    ...
    def test_insights_builtin_is_streaming_unflagged(self):
        node = _table_node(self.team, self._dag, "events", {"origin": "insights"})
...
class TestBuildFrequencyGraph(BaseTest):
    def test_endpoint_target_propagates_to_matview_over_streamed_source(self):
        ...
        source = _table_node(self.team, dag, "events", {"origin": "insights"})
...
class TestSeedTargets(BaseTest):
    ...
    def test_source_tables_are_never_seeded(self):
        ...
        _table_node(self.team, dag, "events", {"origin": "insights"})
