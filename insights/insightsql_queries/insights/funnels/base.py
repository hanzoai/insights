...
from insights.insightsql_queries.insights.funnels.utils import funnel_window_interval_unit_to_sql, get_breakdown_cohort_name
from insights.insightsql_queries.insights.utils.breakdowns import ALL_USERS_COHORT_ID
from insights.insightsql_queries.insights.utils.entities import is_equal, is_superset
from insights.models.property.property import PropertyName
from insights.queries.util import correct_result_for_sampling
from insights.types import FunnelEntityNode
...
class FunnelBase(ABC):
    ...
    def _is_session_aggregation(self) -> bool:
        return self.context.funnelsFilter.funnelAggregateByInsightsQL == FunnelAggregateByInsightsQL.PROPERTIES__SESSION_ID.value
