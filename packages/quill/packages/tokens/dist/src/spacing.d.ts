/**
 * Insights Design System — Spacing
 *
 ...
 *
 * ```ts
 * import { spacing, spacingPx } from '@hanzo/quill-tokens'
...
export declare const SPACING_BASE_REM = 0.25;
/** Base spacing unit as a CSS length string. */
export declare const SPACING_BASE = "0.25rem";
/**
 ...
 */
export declare function spacing(step: number): string;
/**
 ...
 * spacingPx(6)  // 24
 */
export declare function spacingPx(step: number): number;
/**
