...
class Metric(
    ...
    # db_constraint=False on FKs to hot tables (insights_team, insights_user): a real FK constraint
    ...
    def definition_kind(self) -> str | None:
        """The query kind (InsightsQLQuery, TrendsQuery, ...), derived from the stored definition."""
