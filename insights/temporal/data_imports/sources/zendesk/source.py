...
from insights.temporal.data_imports.sources.generated_configs import ZendeskSourceConfig
from insights.temporal.data_imports.sources.zendesk.settings import (
    BASE_ENDPOINTS,
    INCREMENTAL_FIELDS as ZENDESK_INCREMENTAL_FIELDS,
    PARTITION_FIELDS,
    SUPPORT_ENDPOINTS,
)
from insights.temporal.data_imports.sources.zendesk.zendesk import validate_credentials, zendesk_source
