...
class DebugbearSource(SimpleSource[DebugbearSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/debugbear",
            ...
            fields=cast(
                ...
                [
                    SourceFieldInputConfig(
                        ...
                        placeholder="",
                        secret=True,
                        caption="Use an Admin API key so Insights can list every monitored project. Generate one from DebugBear's account settings — see the [API docs](https://www.debugbear.com/docs/api).",
                    ),
                ],
            ),
        )
