...
const BASE_EVENT_FIELDS = {
    uuid: {
        name: 'uuid',
        insightsql_value: 'toString(uuid)',
        type: 'string',
        schema_valid: true,
    },
    timestamp: {
    ...
    distinct_id: {
        name: 'distinct_id',
        insightsql_value: 'toString(distinct_id)',
        type: 'string',
        schema_valid: true,
    },
    properties: {
        name: 'properties',
        insightsql_value: 'properties',
        type: 'json',
        schema_valid: true,
    },
} as const
...
const personsTable: DatabaseSchemaBatchExportTable = {
    ...
    fields: {
        ...
        person_version: {
            name: 'person_version',
            insightsql_value: 'person_version',
            type: 'integer',
            schema_valid: true,
        },
        person_distinct_id_version: {
            name: 'person_distinct_id_version',
            insightsql_value: 'person_distinct_id_version',
            type: 'integer',
            schema_valid: true,
        },
        created_at: {
            name: 'created_at',
            insightsql_value: 'created_at',
            type: 'datetime',
            schema_valid: true,
        },
        is_deleted: {
            name: 'is_deleted',
            insightsql_value: 'is_deleted',
            type: 'boolean',
            schema_valid: true,
        },
    },
...
const sessionsTable: DatabaseSchemaBatchExportTable = {
    ...
    fields: {
        ...
        session_id: {
            name: 'session_id',
            type: 'string',
            insightsql_value: 'session_id',
            schema_valid: true,
        },
        session_id_v7: {
            name: 'session_id_v7',
            type: 'string',
            insightsql_value: 'session_id_v7',
            schema_valid: true,
        },
        distinct_id: {
            name: 'distinct_id',
        ...
        start_timestamp: {
            ...
            type: 'datetime',
            insightsql_value: 'start_timestamp',
            schema_valid: true,
        },
        end_timestamp: {
            name: 'end_timestamp',
            type: 'datetime',
            insightsql_value: 'end_timestamp',
            schema_valid: true,
        },
        urls: {
            name: 'urls',
            type: 'array',
            insightsql_value: 'urls',
            schema_valid: true,
        },
        num_uniq_urls: {
            name: 'num_uniq_urls',
            type: 'integer',
            insightsql_value: 'num_uniq_urls',
            schema_valid: true,
        },
        entry_current_url: {
            name: 'entry_current_url',
            type: 'string',
            insightsql_value: 'entry_current_url',
            schema_valid: true,
        },
        entry_pathname: {
            name: 'entry_pathname',
            type: 'string',
            insightsql_value: 'entry_pathname',
            schema_valid: true,
        },
        entry_hostname: {
            name: 'entry_hostname',
            type: 'string',
            insightsql_value: 'entry_hostname',
            schema_valid: true,
        },
        end_current_url: {
            name: 'end_current_url',
            type: 'string',
            insightsql_value: 'end_current_url',
            schema_valid: true,
        },
        end_pathname: {
            name: 'end_pathname',
            type: 'string',
            insightsql_value: 'end_pathname',
            schema_valid: true,
        },
        end_hostname: {
            name: 'end_hostname',
            type: 'string',
            insightsql_value: 'end_hostname',
            schema_valid: true,
        },
        entry_utm_source: {
            name: 'entry_utm_source',
            type: 'string',
            insightsql_value: 'entry_utm_source',
            schema_valid: true,
        },
        entry_utm_campaign: {
            name: 'entry_utm_campaign',
            type: 'string',
            insightsql_value: 'entry_utm_campaign',
            schema_valid: true,
        },
        entry_utm_medium: {
            name: 'entry_utm_medium',
            type: 'string',
            insightsql_value: 'entry_utm_medium',
            schema_valid: true,
        },
        entry_utm_term: {
            name: 'entry_utm_term',
            type: 'string',
            insightsql_value: 'entry_utm_term',
            schema_valid: true,
        },
        entry_utm_content: {
            name: 'entry_utm_content',
            type: 'string',
            insightsql_value: 'entry_utm_content',
            schema_valid: true,
        },
        entry_referring_domain: {
            name: 'entry_referring_domain',
            type: 'string',
            insightsql_value: 'entry_referring_domain',
            schema_valid: true,
        },
        entry_gclid: {
            name: 'entry_gclid',
            type: 'string',
            insightsql_value: 'entry_gclid',
            schema_valid: true,
        },
        entry_fbclid: {
            name: 'entry_fbclid',
            type: 'string',
            insightsql_value: 'entry_fbclid',
            schema_valid: true,
        },
        entry_gad_source: {
            name: 'entry_gad_source',
            type: 'string',
            insightsql_value: 'entry_gad_source',
            schema_valid: true,
        },
        pageview_count: {
            name: 'pageview_count',
            type: 'integer',
            insightsql_value: 'pageview_count',
            schema_valid: true,
        },
        autocapture_count: {
            name: 'autocapture_count',
            type: 'integer',
            insightsql_value: 'autocapture_count',
            schema_valid: true,
        },
        screen_count: {
            name: 'screen_count',
            type: 'integer',
            insightsql_value: 'screen_count',
            schema_valid: true,
        },
        channel_type: {
            name: 'channel_type',
            type: 'string',
            insightsql_value: 'channel_type',
            schema_valid: true,
        },
        session_duration: {
            name: 'session_duration',
            type: 'integer',
            insightsql_value: 'session_duration',
            schema_valid: true,
        },
        duration: {
            name: 'duration',
            type: 'integer',
            insightsql_value: 'duration',
            schema_valid: true,
        },
        is_bounce: {
            name: 'is_bounce',
            type: 'boolean',
            insightsql_value: 'is_bounce',
            schema_valid: true,
        },
        last_external_click_url: {
            name: 'last_external_click_url',
            type: 'string',
            insightsql_value: 'last_external_click_url',
            schema_valid: true,
        },
        page_screen_autocapture_count_up_to: {
            name: 'page_screen_autocapture_count_up_to',
            type: 'string',
            insightsql_value: 'page_screen_autocapture_count_up_to',
            schema_valid: true,
        },
        exit_current_url: {
            name: 'exit_current_url',
            type: 'string',
            insightsql_value: 'exit_current_url',
            schema_valid: true,
        },
        exit_pathname: {
            name: 'exit_pathname',
            type: 'string',
            insightsql_value: 'exit_pathname',
            schema_valid: true,
        },
        vital_lcp: {
            name: 'vital_lcp',
            type: 'float',
            insightsql_value: 'vital_lcp',
            schema_valid: true,
        },
        entry_gclsrc: {
            name: 'entry_gclsrc',
            type: 'string',
            insightsql_value: 'entry_gclsrc',
            schema_valid: true,
        },
        entry_dclid: {
            name: 'entry_dclid',
            type: 'string',
            insightsql_value: 'entry_dclid',
            schema_valid: true,
        },
        entry_gbraid: {
            name: 'entry_gbraid',
            type: 'string',
            insightsql_value: 'entry_gbraid',
            schema_valid: true,
        },
        entry_wbraid: {
            name: 'entry_wbraid',
            type: 'string',
            insightsql_value: 'entry_wbraid',
            schema_valid: true,
        },
        entry_msclkid: {
            name: 'entry_msclkid',
            type: 'string',
            insightsql_value: 'entry_msclkid',
            schema_valid: true,
        },
        entry_twclid: {
            name: 'entry_twclid',
            type: 'string',
            insightsql_value: 'entry_twclid',
            schema_valid: true,
        },
        entry_li_fat_id: {
            name: 'entry_li_fat_id',
            type: 'string',
            insightsql_value: 'entry_li_fat_id',
            schema_valid: true,
        },
        entry_mc_cid: {
            name: 'entry_mc_cid',
            type: 'string',
            insightsql_value: 'entry_mc_cid',
            schema_valid: true,
        },
        entry_igshid: {
            name: 'entry_igshid',
            type: 'string',
            insightsql_value: 'entry_igshid',
            schema_valid: true,
        },
        entry_ttclid: {
            name: 'entry_ttclid',
            type: 'string',
            insightsql_value: 'entry_ttclid',
            schema_valid: true,
        },
        entry__kx: {
            name: 'entry__kx',
            type: 'string',
            insightsql_value: 'entry__kx',
            schema_valid: true,
        },
        entry_irclid: {
            name: 'entry_irclid',
            type: 'string',
            insightsql_value: 'entry_irclid',
            schema_valid: true,
        },
    },
}
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface batchExportConfigFormLogicActions {
    loadBatchExportConfig: () => any // batchExportDataLogic
    ...
    setBatchExportConfig: (config: BatchExportConfiguration) => BatchExportConfiguration // batchExportDataLogic
    deleteBatchExport: () => boolean
    loadBatchExportConfigTest: () => any
    ...
    updateBatchExportConfigTest: (service: any) => any
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface batchExportConfigFormLogicMeta {
    key: string
...
export type batchExportConfigFormLogicType = MakeLogicType<
    batchExportConfigFormLogicValues,
    batchExportConfigFormLogicActions,
    BatchExportConfigFormLogicProps,
    batchExportConfigFormLogicMeta
>
...
export const batchExportConfigFormLogic = kea<batchExportConfigFormLogicType>([
    ...
    selectors(() => ({
        ...
        service: [
            ...
            (
                config: BatchExportConfiguration | null,
                service:
                    | 'AwsS3'
                    | 'AzureBlob'
                    | 'BigQuery'
                    ...
                    | 'Snowflake'
                    | null
            ) => config?.destination.type || service,
        ],
        isNew: [(_, p) => [p.id], (id: string | null): boolean => !id],
        loading: [
            (s) => [s.batchExportConfigLoading, s.batchExportConfigTestLoading],
            (batchExportConfigLoading: boolean, batchExportConfigTestLoading: boolean) =>
