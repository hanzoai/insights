...
export interface projectSecretAPIKeysLogicValues {
    featureFlags: FeatureFlagsSet // featureFlagLogic
    currentTeamId: number | null // teamLogic
    availablePresets: ProjectSecretAPIKeyScopePreset[]
    editingKey: EditingProjectKeyFormValues
    editingKeyAllErrors: Record<string, any>
    editingKeyChanged: boolean
    editingKeyErrors: DeepPartialMap<EditingProjectKeyFormValues, ValidationErrorType>
    editingKeyHasErrors: boolean
    editingKeyId: ProjectSecretAPIKeyApi['id'] | null
    editingKeyManualErrors: Record<string, any>
    editingKeyTouched: boolean
    editingKeyTouches: Record<string, boolean>
    editingKeyValidationErrors: DeepPartialMap<EditingProjectKeyFormValues, ValidationErrorType>
    filteredScopes: {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface projectSecretAPIKeysLogicActions {
    createKeySuccess: (key: ProjectSecretAPIKeyApi) => {
        key: ProjectSecretAPIKeyApi
    }
    deleteKey: (id: ProjectSecretAPIKeyApi['id']) => {
        id: string
    }
    deleteKeyFailure: (
        error: string,
    ...
    resetEditingKey: (values?: EditingProjectKeyFormValues) => {
        values?: EditingProjectKeyFormValues
    }
    resetScopes: () => {
        value: true
    }
    rollKey: (id: ProjectSecretAPIKeyApi['id']) => {
        id: string
    }
    rollKeyFailure: (
        error: string,
    ...
    setEditingKeyId: (id: ProjectSecretAPIKeyApi['id'] | null) => {
        id: string | null
    }
    ...
    setEditingKeyValues: (values: DeepPartial<EditingProjectKeyFormValues>) => {
        values: DeepPartial<EditingProjectKeyFormValues>
    }
    setScopeRadioValue: (
        key: string,
        action: string
    ...
    showRollKeySuccessDialog: (key: ProjectSecretAPIKeyApi) => {
        key: ProjectSecretAPIKeyApi
    }
    submitEditingKey: () => {
        value: boolean
    ...
    submitEditingKeyRequest: (editingKey: EditingProjectKeyFormValues) => {
        editingKey: EditingProjectKeyFormValues
    }
    submitEditingKeySuccess: (editingKey: EditingProjectKeyFormValues) => {
        editingKey: EditingProjectKeyFormValues
    }
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface projectSecretAPIKeysLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        formScopeRadioValues: (editingKey: EditingProjectKeyFormValues) => Record<string, string>
        filteredScopes: (
            searchTerm: string,
        ...
        availablePresets: (featureFlags: FeatureFlagsSet) => ProjectSecretAPIKeyScopePreset[]
    }
}

export type projectSecretAPIKeysLogicType = MakeLogicType<
    projectSecretAPIKeysLogicValues,
    projectSecretAPIKeysLogicActions,
    Record<string, any>,
    projectSecretAPIKeysLogicMeta
>
            ...
            [] as ProjectSecretAPIKeyApi[],
            {
                loadKeys: async () => {
                    ...
                    try {
                        ...
                        toast.error('Failed to load project API keys')
                        throw error
                    }
                },
                ...
                rollKey: async ({ id }: { id: string }) => {
                    ...
                    try {
                        ...
                        toast.error('Failed to roll project API key')
                        throw error
                    }
                },
            },
            ...
            submit: async (payload, breakpoint) => {
                ...
                try {
                    ...
                    if (values.editingKeyId === 'new') {
                        ...
                        toast.success('Project API key updated')
                    }
