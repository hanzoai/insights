...
// Mock the client `flags.ts` consumes, not insights-node directly: `getInsightsClient()`
// returns a `InsightsMCP` (a insights-node subclass) from the externalized
// `@hanzo/mcp-analytics`, whose internal insights-node import a `vi.mock('insights-node')`
...
import { evaluateFeatureFlags, isFeatureFlagEnabled } from '@/lib/insights/flags'
