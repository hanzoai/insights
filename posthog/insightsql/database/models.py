...
from posthog.insightsql.errors import NotImplementedError, ResolutionError

# Import Workload at module level for Pydantic (needed at runtime)
from posthog.clickhouse.workload import Workload

if TYPE_CHECKING:
    from posthog.insightsql.ast import LazyJoinType, SelectQuery
    from posthog.insightsql.base import ConstantType
...
class DatabaseField(FieldOrTable):
    ...
    def get_constant_type(self) -> "ConstantType":
        from posthog.insightsql.ast import UnknownType
...
class IntegerDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from posthog.insightsql.ast import IntegerType
...
class FloatDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from posthog.insightsql.ast import FloatType
...
class DecimalDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from posthog.insightsql.ast import DecimalType
...
class StringDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from posthog.insightsql.ast import StringType
...
class StringJSONDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from posthog.insightsql.ast import StringJSONType
...
class StringArrayDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from posthog.insightsql.ast import StringArrayType
...
class DateDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from posthog.insightsql.ast import DateType
...
class DateTimeDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from posthog.insightsql.ast import DateTimeType
...
class BooleanDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from posthog.insightsql.ast import BooleanType
...
class UUIDDatabaseField(DatabaseField):
    def get_constant_type(self) -> "ConstantType":
        from posthog.insightsql.ast import UUIDType
...
class LazyJoin(FieldOrTable):
    ...
    join_function: Callable[["LazyJoinToAdd", "InsightsQLContext", "SelectQuery"], Any]
