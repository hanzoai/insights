...
class PardotSource(ResumableSource[PardotSourceConfig, PardotResumeConfig], OAuthMixin):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Connect Salesforce Marketing Cloud Account Engagement (formerly Pardot) to pull your marketing data into the Insights Data warehouse.
...
Connect a Salesforce account that has access to Account Engagement, then enter the ID of the business unit you want to sync.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/pardot",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldOauthConfig(
