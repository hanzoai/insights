import type { SelectOptions } from '@hanzo/elements'
...
/** See insights/api/organization.py for details. */
...
export const FEATURE_FLAGS = {
    ...
    MEMBERS_CAN_USE_PERSONAL_API_KEYS: 'members-can-use-personal-api-keys', // owner: @yasen-insights #team-platform-features
    ...
    REPLAY_INSIGHTSQL_FILTERS: 'replay-insightsql-filters', // owner: @pauldambra #team-replay
    ...
    APPROVALS: 'approvals', // owner: @yasen-insights #team-platform-features
    AVERAGE_PAGE_VIEW_COLUMN: 'average-page-view-column', // owner: @jordanm-insights #team-web-analytics
    ...
    CDP_FN_SOURCES: 'cdp-script-sources', // owner #team-workflows-cdp
    ...
    CLEARABLE_NOTIFICATIONS: 'clearable-notifications', // owner: @jordanm-insights #team-web-analytics
    ...
    EXPERIMENT_RECORDINGS_TAB: 'experiment-recordings-tab', // owner: @mp-script #team-experiments
    ...
    EXPERIMENTS_FREEZE_EXPOSURE_AA_TEST: 'experiments-freeze-exposure-aa-test', // owner: @mp-script #team-experiments multivariate=control,test, dogfood A/A used to validate the freeze-exposure lifecycle action
    ...
    LIVE_EVENTS_RICH_FILTERS: 'live-events-rich-filters', // owner: @jordanm-insights #team-web-analytics
    LLM_ANALYTICS_CLUSTERING_ADMIN: 'llm-analytics-clustering-admin', // owner: #team-ai-observability
    LLM_ANALYTICS_DATASETS: 'llm-analytics-datasets', // owner: #team-ai-observability #team-insights-ai
    ...
    MAX_AI_INSIGHT_SEARCH: 'max-ai-insight-search', // owner: #team-insights-ai
    MAX_BILLING_CONTEXT: 'max-billing-context', // owner: @pawel-cebula #team-billing
    MAX_DEEP_RESEARCH: 'max-deep-research', // owner: @kappa90 #team-insights-ai
    MAX_HANDS_FREE: 'max-hands-free', // owner: #team-insights-ai
    MAX_HOMEPAGE_CAPABILITIES: 'max-homepage-capabilities', // owner: @rafaeelaudibert #team-insights-ai multivariate=control,behaviors,products — /home capability badges grouped by behavior vs product
    MAX_WEB_ANALYTICS_NUDGE: 'insights-ai-web-analytics-nudge', // owner: @jordanm-insights #team-web-analytics
    ...
    MCP_SERVERS: 'mcp-servers', // owner: #team-insights-ai
    ...
    PAGE_REPORTS_AVERAGE_PAGE_VIEW: 'page-reports-average-page-view', // owner: @jordanm-insights #team-web-analytics
    PAGE_REPORTS_RANKED_URL_SEARCH: 'page-reports-ranked-url-search', // owner: @jordanm-insights #team-web-analytics
    PASSWORD_PROTECTED_SHARES: 'password-protected-shares', // owner: @aspicer
    PHAI_PLAN_MODE: 'phai-plan-mode', // owner: #team-insights-ai
    ...
    PRODUCT_ANALYTICS_QUILL_DATE_FILTER: 'product-analytics-quill-date-filter', // owner: @sampennington #team-product-analytics, swaps the insight date filter for the chip-based quill date filter (elements-skinned)
    ...
    QUILL_DATE_PICKER: 'quill-date-picker', // owner: @pauldambra, flips the lib/components/DatePicker seam from UI to Quill
    QUILL_SPARKLINE: 'quill-sparkline', // owner: @sampennington #team-product-analytics, gates rendering the shared lib Sparkline via @hanzo/quill-charts (docs/internal/quill-migration-sparkline.md)
    ...
    REPLAY_EXPERIMENT_CONTEXT: 'replay-experiment-context', // owner: @mp-script #team-experiments
    ...
    SHOW_REFERRER_FAVICON: 'show-referrer-favicon', // owner: @jordanm-insights #team-web-analytics
    ...
    TASK_TOOL: 'phai-task-tool', // owner: @kappa90 #team-insights-ai
    ...
    WEB_ANALYTICS_ACHIEVEMENTS: 'web-analytics-achievements', // owner: @jordanm-insights #team-web-analytics
    ...
    WEB_ANALYTICS_DRAG_TO_ZOOM: 'web-analytics-drag-to-zoom', // owner: @jordanm-insights #team-web-analytics
    WEB_ANALYTICS_EMPTY_ONBOARDING: 'web-analytics-empty-onboarding', // owner: @jordanm-insights #team-web-analytics
    WEB_ANALYTICS_FILTERS_V2: 'web-analytics-filters-v2', // owner: @jordanm-insights #team-web-analytics
    WEB_ANALYTICS_FOCUS_MODE: 'web-analytics-focus-mode', // owner: @jordanm-insights #team-web-analytics
    WEB_ANALYTICS_INCLUDE_HOST: 'web-analytics-include-host', // owner: @lricoy #team-web-analytics
    WEB_ANALYTICS_LIVE_CITY_BREAKDOWN: 'web-analytics-live-city-breakdown', // owner: @jordanm-insights #team-web-analytics
    WEB_ANALYTICS_LIVE_MAP: 'web-analytics-live-map', // owner: @jordanm-insights #team-web-analytics
    WEB_ANALYTICS_LIVE_PERSON_DRILLDOWN: 'web-analytics-live-person-drilldown', // owner: @jordanm-insights #team-web-analytics
    ...
    WEB_ANALYTICS_RECAP: 'web-analytics-recap', // owner: @jordanm-insights #team-web-analytics
    WEB_ANALYTICS_REGIONS_MAP: 'web-analytics-regions-map', // owner: @jordanm-insights #team-web-analytics
    ...
    WEB_ANALYTICS_SHARE_NUDGE_V2: 'web-analytics-share-nudge-v2', // owner: @jordanm-insights #team-web-analytics multivariate=control,control_b,banner,export
    WEB_ANALYTICS_STREAK_CADENCE: 'web-analytics-streak-cadence', // owner: @jordanm-insights #team-web-analytics multivariate=control,hybrid,daily-only,weekly-only
    WEB_ANALYTICS_TILE_HEADER_V2: 'web-analytics-tile-header-v2', // owner: @jordanm-insights #team-web-analytics multivariate=control,test
    WEB_ANALYTICS_TILE_SKELETONS: 'web-analytics-tile-skeletons', // owner: @jordanm-insights #team-web-analytics
...
export const CLOUD_HOSTNAMES = {
    [Region.US]: 'us.hanzo.ai',
    [Region.EU]: 'eu.hanzo.ai',
    [Region.DEV]: 'app.dev.insights.dev',
}
