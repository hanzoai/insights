...
from insights.caching.warming import insights_to_keep_fresh, schedule_warming_for_teams_task
from insights.models import Dashboard, DashboardTile, Insight, InsightViewed
...
class TestWarming(APIBaseTest):
    ...
    @patch("insights.insightsql_queries.query_cache.QueryCacheManagerBase.get_stale_insights")
