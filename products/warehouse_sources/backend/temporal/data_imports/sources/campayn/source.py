...
class CampaynSource(SimpleSource[CampaynSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Campayn subdomain and API key to pull your Campayn email-marketing data into the Insights Data warehouse.
...
Your subdomain is the first part of your account host — for `acme.campayn.com`, enter `acme`. You can find and regenerate your API key in your Campayn account settings.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/campayn",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
