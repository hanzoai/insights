...
export const NotebooksSqlV2RunCreateBody = /* @__PURE__ */ zod.object({
    ...
    node_type: zod
        .enum(['insightsql', 'python'])
        .describe('\* `insightsql` - insightsql\n\* `python` - python')
    ...
    code: zod
        .string()
        .describe("The node's source — SQL for a insightsql node, Python for a python node. Must not be blank."),
    output_name: zod
        .string()
