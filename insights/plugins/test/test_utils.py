...
from insights.plugins.utils import (
...
class TestPluginsUtils(BaseTest):
    def test_parse_github_urls(self, mock_get):
        parsed_url = parse_url("https://github.com/hanzoai/insights")
        ...
        parsed_url = parse_url("https://github.com/hanzoai/insights", get_latest_if_none=True)
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "Insights")
        self.assertEqual(parsed_url["repo"], "insights")
        ...
        mock_get.assert_called_with(
            "https://api.github.com/repos/Insights/insights/commits?sha=&path=",
            headers={},
        )
        mock_get.reset_mock()

        parsed_url = parse_url("https://github.com/hanzoai/insights/tree/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e")
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "Insights")
        self.assertEqual(parsed_url["repo"], "insights")
        ...
        parsed_url = parse_url(
            "https://github.com/hanzoai/insights/tree/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e",
        ...
        parsed_url = parse_url(
            "https://github.com/hanzoai/insights/tree/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e/test/path/in/repo",
            get_latest_if_none=True,
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "Insights")
        ...
        parsed_url = parse_url("https://github.com/hanzoai/insights/tree/main", get_latest_if_none=True)
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "Insights")
        self.assertEqual(parsed_url["repo"], "insights")
        self.assertEqual(parsed_url["tag"], "MOCKLATESTCOMMIT")
        ...
        self.assertEqual(mock_get.call_count, 1)
        mock_get.assert_called_with(
            "https://api.github.com/repos/Insights/insights/commits?sha=main&path=",
            headers={},
        )
        mock_get.reset_mock()

        parsed_url = parse_url(
            "https://github.com/hanzoai/insights/tree/main/test/path/in/repo",
            get_latest_if_none=True,
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "Insights")
        ...
        self.assertEqual(mock_get.call_count, 1)
        mock_get.assert_called_with(
            "https://api.github.com/repos/Insights/insights/commits?sha=main&path=test/path/in/repo",
            headers={},
        )
        mock_get.reset_mock()

        parsed_url = parse_url("https://www.github.com/hanzoai/insights/commit/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e")
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "Insights")
        self.assertEqual(parsed_url["repo"], "insights")
        self.assertEqual(parsed_url["tag"], "82c9218ee40f561b7f37a22d6b6a0ca82887ee3e")
        ...
        parsed_url = parse_url(
            "https://www.github.com/hanzoai/insights/commit/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e",
            get_latest_if_none=True,
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "Insights")
        ...
        parsed_url = parse_url(
            "https://github.com/hanzoai/insights/releases/tag/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e"
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "Insights")
        self.assertEqual(parsed_url["repo"], "insights")
        ...
        parsed_url = parse_url(
            "https://www.github.com/hanzoai/insights/archive/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e.zip"
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "Insights")
        self.assertEqual(parsed_url["repo"], "insights")
        ...
        parsed_url = parse_url(
            "https://github.com/hanzoai/insights/archive/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e.tar.gz"
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "Insights")
        self.assertEqual(parsed_url["repo"], "insights")
        ...
        # private tokens
        parsed_url = parse_url("https://github.com/hanzoai/insights?private_token=TOKEN")
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "Insights")
        self.assertEqual(parsed_url["repo"], "insights")
        self.assertEqual(parsed_url.get("tag", None), None)
        ...
        parsed_url = parse_url(
            "https://github.com/hanzoai/insights?private_token=TOKEN",
            get_latest_if_none=True,
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "Insights")
        ...
        parsed_url = parse_url(
            "https://github.com/hanzoai/insights/tree/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e?private_token=TOKEN"
        )
        self.assertEqual(parsed_url["type"], "github")
        self.assertEqual(parsed_url["user"], "Insights")
        self.assertEqual(parsed_url["repo"], "insights")
    ...
    def test_parse_npm_urls(self, mock_get):
        parsed_url = parse_url("https://www.npmjs.com/package/insights-helloworld-plugin")
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "insights-helloworld-plugin")
        self.assertEqual(parsed_url.get("tag", None), None)
        self.assertEqual(mock_get.call_count, 0)
        ...
        parsed_url = parse_url(
            "https://www.npmjs.com/package/insights-helloworld-plugin",
            get_latest_if_none=True,
        )
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "insights-helloworld-plugin")
        ...
        parsed_url = parse_url(
            "https://www.npmjs.com/package/insights-helloworld-plugin/v/0.0.0",
            get_latest_if_none=True,
        )
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "insights-helloworld-plugin")
        ...
        # private tokens
        parsed_url = parse_url(
            "https://www.npmjs.com/package/insights-helloworld-plugin?private_token=TOKEN",
            get_latest_if_none=True,
        )
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "insights-helloworld-plugin")
        ...
        self.assertEqual(mock_get.call_count, 3)
        mock_get.assert_called_with(
            "https://registry.npmjs.org/insights-helloworld-plugin/latest",
            headers={"Authorization": "Bearer TOKEN"},
        )

        parsed_url = parse_url("https://www.npmjs.com/package/insights-helloworld-plugin/v/0.0.0?private_token=TOKEN")
        self.assertEqual(parsed_url["type"], "npm")
        self.assertEqual(parsed_url["pkg"], "insights-helloworld-plugin")
        self.assertEqual(parsed_url["tag"], "0.0.0")
        self.assertEqual(parsed_url["private_token"], "TOKEN")
    ...
    def test_download_plugin_archive_github(self, mock_get):
        plugin_github_zip_1 = download_plugin_archive(
            "https://www.github.com/hanzoai/helloworldplugin/commit/82c9218ee40f561b7f37a22d6b6a0ca82887ee3e",
            HELLO_WORLD_PLUGIN_GITHUB_ZIP[0],
        )
        self.assertEqual(plugin_github_zip_1, base64.b64decode(HELLO_WORLD_PLUGIN_GITHUB_ZIP[1]))
        self.assertEqual(mock_get.call_count, 1)
        mock_get.assert_called_with(
            "https://github.com/hanzoai/helloworldplugin/archive/d5aa1d2b8a534f37cd93be48b214f490ef9ee904.zip",
            headers={},
        )

        plugin_github_zip_2 = download_plugin_archive(
            "https://www.github.com/hanzoai/helloworldplugin/commit/{}".format(HELLO_WORLD_PLUGIN_GITHUB_ZIP[0])
        )
        ...
        plugin_github_zip_3 = download_plugin_archive(
            "https://www.github.com/hanzoai/helloworldplugin/commit/{}?private_token=TOKEN".format(
                HELLO_WORLD_PLUGIN_GITHUB_ZIP[0]
            )
        )
        ...
        plugin_github_zip_6 = download_plugin_archive(
            "https://www.github.com/hanzoai/helloworldplugin/tree/main/app",
        ...
        mock_get.assert_called_with(
            "https://github.com/hanzoai/helloworldplugin/archive/f5a9ea85adaafe7c99014b7e8e0982c447631d54.zip",
            headers={},
        )
        self.assertEqual(
    ...
    def test_download_plugin_archive_npm(self, mock_get):
        plugin_npm_tgz = download_plugin_archive("https://www.npmjs.com/package/insights-helloworld-plugin/v/0.0.0")
        self.assertEqual(plugin_npm_tgz, base64.b64decode(HELLO_WORLD_PLUGIN_NPM_TGZ[1]))
        self.assertEqual(mock_get.call_count, 1)
        mock_get.assert_called_with(
            "https://registry.npmjs.org/insights-helloworld-plugin/-/insights-helloworld-plugin-0.0.0.tgz",
            headers={},
        )
    ...
    def test_get_file_from_archive(self, mock_get):
        ...
        self.assertEqual(plugin_json_zip["url"], "https://github.com/hanzoai/helloworldplugin")
        ...
        self.assertEqual(plugin_json_tgz["url"], "https://github.com/hanzoai/helloworldplugin")
    ...
    def test_put_json_into_zip_archive(self, mock_get):
        ...
        plugin_json["insightsVersion"] = "0.0.0"
        ...
        self.assertEqual(new_plugin_json["insightsVersion"], "0.0.0")
        ...
        self.assertEqual(new_plugin_json_2["insightsVersion"], "0.0.0")
