...
class TestClassifyUntaggedFollowupActivity(TestCase):
    ...
    def setUp(self):
        ...
        self.inputs = InsightsCodeSlackMentionWorkflowInputs(
            event={},
    ...
    def test_mapping_gone_returns_false(self):
        ...
        self.mapping.delete()
        with patch(
            "insights.temporal.ai.slack_app.activities.classifiers.classify_message_is_agent_directed"
        ) as mock_classify:
...
class TestClassifyMessageIsAgentDirected(TestCase):
    ...
    def test_emoji_only_dropped_without_llm(self):
        with patch("insights.temporal.ai.slack_app.activities.classifiers.get_llm_client") as mock_client:
