...
class LinkSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data: dict[str, Any]) -> Link:
        ...
        if validated_data.get("short_link_domain") != "pscript.gg":
            raise serializers.ValidationError({"short_link_domain": "Only pscript.gg is allowed as a short link domain"})
