...
class ExternalDataSourceCreateSerializer(serializers.Serializer):
    ...
    prefix = serializers.CharField(
        max_length=100, required=False, allow_null=True, allow_blank=True, help_text="Table name prefix in InsightsQL."
    )
    description = serializers.CharField(
...
class SourceSetupSerializer(serializers.Serializer):
    ...
    prefix = serializers.CharField(
        ...
        allow_null=True,
        allow_blank=True,
        help_text="Table name prefix in InsightsQL, e.g. 'stripe' produces stripe_charges. Defaults to the source type.",
    )
    description = serializers.CharField(
        max_length=400, required=False, allow_null=True, allow_blank=True, help_text="Human-readable description."
    )
