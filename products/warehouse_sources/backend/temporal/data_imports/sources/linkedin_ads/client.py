...
class LinkedinAdsApiError(Exception):
    ...
    Not named `status_code`: drf-exceptions-script reads that attribute off any escaping exception and
    would render LinkedIn's status as Insights's HTTP response status.
    """
