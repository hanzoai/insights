...
class MailosaurSource(ResumableSource[MailosaurSourceConfig, MailosaurResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Mailosaur API key to sync your email and SMS testing data into the Insights Data warehouse.
...
Use an **account-level** API key — a server-scoped key cannot list servers, so it can't enumerate the mail to sync.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/mailosaur",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
