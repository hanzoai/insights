...
QUERY_LOG_ARCHIVE_FIELDS: dict[str, FieldOrTable] = {
    ...
    "query_start_time": DateTimeDatabaseField(
        name="query_start_time", nullable=False, description="When Datastore started executing the query."
    ),
    ...
    "created_by": IntegerDatabaseField(
        name="lc_user_id", nullable=False, description="ID of the Insights user who triggered the query."
    ),
    "product": StringDatabaseField(
        name="lc_product", nullable=False, description="Insights product that issued the query, e.g. 'sql_editor'."
    ),
    "read_rows": IntegerDatabaseField(
        name="read_rows", nullable=False, description="Number of rows Datastore read while executing the query."
    ),
    "read_bytes": IntegerDatabaseField(
        name="read_bytes", nullable=False, description="Number of bytes Datastore read while executing the query."
    ),
    ...
    "exception_code": IntegerDatabaseField(
        name="exception_code", nullable=False, description="Datastore exception code if the query failed, else 0."
    ),
    "exception_name": StringDatabaseField(
        name="exception_name", nullable=False, description="Datastore exception name if the query failed."
    ),
...
class QueryLogArchiveTable(LazyTable):
    description: str = (
        "Archived Datastore query log for analyzing query performance and cost. One row per executed query, "
...
class RawQueryLogArchiveTable(Table):
    description: str = (
        "Raw archived Datastore query log, exposing the underlying `lc_*` columns directly. "
    ...
    fields: dict[str, FieldOrTable] = {
        ...
        "query_id": StringDatabaseField(
            name="query_id", nullable=False, description="Datastore-assigned query identifier."
        ),
