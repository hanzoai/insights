...
from products.warehouse_sources.backend.temporal.data_imports.sources.generated_configs.azureresourcehealth import (
    AzureResourceHealthSourceConfig,
)
...
class AzureResourceHealthSource(SimpleSource[AzureResourceHealthSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            name=SchemaExternalDataSourceType.AZURE_RESOURCE_HEALTH,
