    ...
    return render(
        <Provider>
            <TaxonomicPopoverMenu
                ...
                groupTypes={[TaxonomicFilterGroupType.EventProperties, TaxonomicFilterGroupType.InsightsQLExpression]}
...
describe('TaxonomicPopoverMenu input trigger (lazy placeholder)', () => {
    ...
    it('arms to the dropdown menu (not the combobox) when the filter icon is clicked from the resting trigger', async () => {
        ...
        // The icon arms straight to the menu — its "InsightsQL expression" entry confirms it.
        await waitFor(() => {
