...
from insights.queries.base import determine_parsed_incoming_date, relative_date_parse_for_feature_flag_matching


class TestBase(APIBaseTest):
    def test_determine_compared_filter(self):
        from insights.queries.base import determine_compared_filter
