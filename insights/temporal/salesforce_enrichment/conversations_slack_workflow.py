...
from insights.temporal.salesforce_enrichment.usage_workflow import cache_org_mappings_activity
...
async def enrich_conversations_slack_page_activity(
    ...
    async with Heartbeater() as heartbeater:
        ...
        org_to_sf = {m["insights_org_id"]: m["salesforce_account_id"] for m in cached_mappings}
...
class SalesforceConversationsSlackEnrichmentWorkflow(InsightsWorkflow):
