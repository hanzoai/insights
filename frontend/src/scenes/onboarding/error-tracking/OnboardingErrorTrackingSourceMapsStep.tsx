        ...
        >
            ...
            <div className="space-y-3 mt-4">
                ...
                <SourceMapOptionCard
                    ...
                    description="If source maps are publicly available Insights can fetch and provide readable stack traces without any additional setup."
                    ...
                    <div className="mt-4 space-y-4">
                        <div>
                            ...
                            <CodeSnippet language={Language.Bash}>
                                {[
                                    "curl --proto '=https' --tlsv1.2 -LsSf https://github.com/Insights/posthog/releases/download/posthog-cli-v0.0.2/posthog-cli-installer.sh | sh",
                                    'posthog-cli-update',
                                ].join('\n')}
                            </CodeSnippet>
            ...
            <div className="mt-6">
                ...
                <p className="mb-4">
                    For some frameworks and languages, Insights can automatically upload source maps during your build
