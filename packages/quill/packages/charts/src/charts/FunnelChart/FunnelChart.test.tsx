...
describe('FunnelChart', () => {
    ...
    it('renders one step-footer cell per step and hides the axis step labels', async () => {
        ...
        await waitFor(() => {
            const cells = document.querySelectorAll('[data-attr="script-funnel-step-footer-cell"]')
    ...
    it('floors the chart region height with chartMinHeight so a tall footer cannot collapse the canvas', async () => {
        ...
        await waitFor(() => {
            expect(document.querySelectorAll('[data-attr="script-funnel-step-footer-cell"]')).toHaveLength(STEPS.length)
        })
        const region = document.querySelector('[data-attr="script-funnel-chart-region"]') as HTMLElement
