"""Insightscli core framework.

This package contains the internal framework code for insightscli.
...
- ../manifest.yaml - for bin scripts, shell commands, and compositions
"""
