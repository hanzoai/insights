...
from insights.tasks.plugin_server import _dispatch_plugin_disabled_realtime

from products.cdp.backend.models.plugin import Plugin, PluginConfig


class TestDispatchPluginDisabledRealtime(BaseTest):
    @patch("insights.tasks.plugin_server.create_notification")
    ...
    @patch("insights.tasks.plugin_server.create_notification", side_effect=RuntimeError("kafka"))
    ...
    @patch("insights.tasks.plugin_server.create_notification")
    @patch("insights.tasks.plugin_server.has_been_dispatched", return_value=True)
