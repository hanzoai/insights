...
export type webAnalyticsFilterPresetsLogicType = MakeLogicType<
    webAnalyticsFilterPresetsLogicValues,
    webAnalyticsFilterPresetsLogicActions,
    Record<string, any>,
    webAnalyticsFilterPresetsLogicMeta
>
...
export const webAnalyticsFilterPresetsLogic = kea<webAnalyticsFilterPresetsLogicType>([
    ...
    selectors({
        ...
        isEditMode: [
            (s) => [s.editingPreset],
            (editingPreset: WebAnalyticsFilterPresetType | null): boolean => !!editingPreset,
        ],
    }),
    afterMount(({ actions }) => {
        actions.loadPresets()
