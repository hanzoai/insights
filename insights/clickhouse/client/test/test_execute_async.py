...
from insights.test.base import ClickhouseTestMixin, snapshot_clickhouse_queries
...
from insights.clickhouse.client.execute_async import QueryNotFoundError, QueryStatusManager, execute_process_query
...
class TestExecuteProcessQuery(TestCase):
    ...
    @patch("insights.clickhouse.client.execute_async.redis.get_client")
...
class ClickhouseClientTestCase(TestCase, ClickhouseTestMixin):
    ...
    @patch("insights.clickhouse.client.execute_process_query")
    ...
    @patch("insights.clickhouse.client.async_task_chain.execute_task_chain")
    @patch("django.db.transaction.on_commit")
    def test_context_manager_exit(self, on_commit_mock, execute_task_chain_mock):
        mock_chain: list[Any] = []
        with patch("insights.clickhouse.client.async_task_chain.get_task_chain", return_value=mock_chain):
