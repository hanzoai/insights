...
class _PandaDocUnavailable(exceptions.APIException):
    ...
    default_detail = (
        "Couldn't cancel the PandaDoc envelope. Please try again, or contact Insights support if this keeps happening."
    )
    ...
    def destroy(self, request: Request, pk: str, **kwargs) -> Response:
        ...
        try:
            ...
            raise exceptions.PermissionDenied(
                "Signed documents can't be deleted from the UI. Contact Insights support if you need to remove a signed record."
            )
