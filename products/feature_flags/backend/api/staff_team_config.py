...
class FeatureFlagsStaffTeamConfigViewSet(viewsets.ViewSet):
    ...
    def set(self, request: request.Request, **kwargs) -> response.Response:
        ...
        # insights.tasks.team_metadata sits under insights.tasks, whose __init__ is a celery
        ...
        from insights.tasks.team_metadata import update_team_metadata_cache_task  # noqa: PLC0415
