...
def _scopes_for_loop_fired_run(scopes: InsightsMcpScopes) -> list[str]:
...
def create_oauth_access_token(
    ...
    *,
    ...
    effective_scopes: InsightsMcpScopes = _scopes_for_loop_fired_run(scopes) if loop_id else scopes
