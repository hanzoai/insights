...
from insights.api.schema_property_group import SchemaPropertyGroupSerializer
from insights.models import EventDefinition, EventSchema, SchemaPropertyGroup
