...
class TestSlugParsing:
    @parameterized.expand(
        [
            ("gh/insights/insights", ["gh/insights/insights"]),
...
class TestValidateCredentials:
    ...
    def test_status_mapping(self, me_status, project_status, expected, mock_session):
        ...
        is_valid, error = validate_credentials("token", "gh/insights/insights")
    ...
    def test_probes_every_project_and_names_the_broken_one(self, mock_session):
        ...
        is_valid, error = validate_credentials("token", "gh/insights/insights, gh/insights/nope")

        assert is_valid is False
        assert error is not None and "gh/insights/nope" in error
    ...
    def test_sends_circle_token_header(self, mock_session):
        ...
        validate_credentials("token", "gh/insights/insights")
