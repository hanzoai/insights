...
class SparkPostSource(
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Connect your SparkPost account to sync message events, suppression lists, recipient lists, templates, sending domains, subaccounts, and webhooks into the Insights Data warehouse.
...
SparkPost runs independent US and EU stacks that do not share data — pick the region your account is on. Message events are retained for 10 days, so the initial sync of events can only reach back that far.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/sparkpost",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldSelectConfig(
            ...
            webhookSetupCaption=(
                "Insights registers an event webhook on your SparkPost account and subscribes it to the "
                ...
                "Then paste the matching `Basic ...` header value into the field below so Insights can "
            ...
            webhookFields=cast(
                ...
                [
                    SourceFieldInputConfig(
                        ...
                        caption=(
                            "The exact value SparkPost sends in the Authorization header. Insights fills "
