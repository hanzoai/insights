...
pub struct Config {
    ...
    #[envconfig(default = "personinsights_updates")]
    ...
    /// reads.
    #[envconfig(default = "personinsights-writer")]
    ...
    /// `check_properties_size` constraint on `insights_person` measures it:
    ...
    /// the queueing. The `personinsights_leader_recovery_pool_wait_ms`
    ...
    /// Prod pairs insights_person on both sides; the dev validation stack
    /// pairs personinsights_person_tmp on both — flip them together at cutover.
    #[envconfig(default = "insights_person")]
