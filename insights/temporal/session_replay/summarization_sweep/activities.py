...
from insights.temporal.session_replay.summarization_sweep.session_candidates import (
    coerce_sample_rate,
...
async def delete_team_schedule_activity(inputs: DeleteTeamScheduleInput) -> None:
    """Idempotent."""
    from insights.temporal.session_replay.summarization_sweep.schedule import a_delete_team_schedule
...
async def list_summarization_schedule_team_ids_activity() -> dict[int, str | None]:
    ...
    query = f'InsightsScheduleType = "{SCHEDULE_TYPE}"'
