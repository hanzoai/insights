...
class IterableSource(ResumableSource[IterableSourceConfig, IterableResumeConfig]):
    ...
    api_docs_url = "https://api.iterable.com/api/docs"
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Iterable",
            caption="""Enter your Iterable API key to pull your Iterable data into the Insights Data warehouse.
...
Make sure the data center below matches the one that issued your key (US or EU).""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/iterable",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
