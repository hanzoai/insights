...
#
# Worker consumers config here https://github.com/Insights/charts/blob/main/config/insights/prod-us.yaml.gotmpl#L538
# e.g.
#   consumers:
#     - name: priority
#       queues:
...
# modules that load during django.setup(), and the insights.tasks package (the enum's old
