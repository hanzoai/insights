...
These properties are emitted by the Insights SDK on every event when session replay is configured.
...
This skill works best with the current Insights-JS SDK.
