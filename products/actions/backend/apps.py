...
class ActionsConfig(AppConfig):
    ...
    def ready(self) -> None:
        ...
        # module. It must not live in the viewset module: that pulls insights.api routing/utils
        # (and insights.schema with them) into django.setup() for every process type.
