...
class GenerateBriefWorkflowInputs:
    ...
    # SLO tracking; the SloInterceptor (registered on ANALYTICS_PLATFORM_TASK_QUEUE) reads this at
    # workflow start and emits started/completed+duration. None disables tracking.
