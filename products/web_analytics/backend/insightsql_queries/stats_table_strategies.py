...
from products.web_analytics.backend.insightsql_queries.query_constants.stats_table_queries import (
...
from products.web_analytics.backend.insightsql_queries.web_analytics_query_runner import WEB_ANALYTICS_NO_JOIN_SERVED
