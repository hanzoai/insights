...
pub struct ProcessingConfig {
    ...
    // VC, where the insights-functions consumer reads). When unset, internal events go through the
    ...
    // Optional override for the brokers used to produce `datastore_app_metrics2`. When set,
    // cymbal opens a dedicated producer pointed at this host list (the warpstream-ingestion VC,
    // where Datastore consumes app_metrics2). When unset, app metrics go through the primary
    ...
    #[envconfig(default = "datastore_error_tracking_fingerprint_issue_state")]
    ...
    #[envconfig(
        ...
        default = "@hanzo/error-tracking-cymbal-rate-limiter"
    )]
