...
- `metrics`: structured numeric data computed mechanically from Datastore,
...
from insights.temporal.ai_observability.eval_reports.targets import GENERATION_TARGET, resolve_evaluation_target
...
class EvalReportMetrics:
    """Structured metrics computed mechanically from Datastore.
