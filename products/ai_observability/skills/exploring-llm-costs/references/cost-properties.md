...
All costs are USD, recorded per event at ingestion. Insights derives them from the
...
mirror that. See [Calculating LLM costs](https://hanzo.ai/docs/ai-observability/calculating-costs)
