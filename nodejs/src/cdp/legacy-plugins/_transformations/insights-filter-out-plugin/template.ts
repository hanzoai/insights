...
export const insightsFilterOutPlugin: LegacyTransformationPlugin = {
    ...
    template: {
        ...
        icon_url: 'https://raw.githubusercontent.com/hanzoai/insights-filter-out-plugin/main/logo.png',
