...
class TestFunnelTrendsUDF(DatastoreTestMixin, APIBaseTest):
    ...
    def test_funnel_insightsql_breakdown_with_alias(self, _name: str, breakdown_expr: str):
        journeys_for(
            {
                "user_one": [
        ...
        def _build_query(expr: str) -> FunnelsQuery:
            return FunnelsQuery(
                ...
                breakdownFilter=BreakdownFilter(breakdown=expr, breakdown_type="insightsql"),
                funnelsFilter=FunnelsFilter(
                    funnelVizType="trends",
                    funnelWindowInterval=7,
                    funnelWindowIntervalUnit="day",
...
class TestFunnelTrendsDaysOfWeekUDF(DatastoreTestMixin, APIBaseTest):
    maxDiff = None
...
@override_settings(IN_UNIT_TESTING=True)
class TestFunnelTrendsCompareUDF(DatastoreTestMixin, APIBaseTest):
