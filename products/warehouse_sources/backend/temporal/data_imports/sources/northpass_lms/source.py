...
class NorthpassLMSSource(ResumableSource[NorthpassLMSSourceConfig, NorthpassResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Northpass API key to sync your Northpass (Gainsight Customer Education) learning data into the Insights Data warehouse.

You can create an API key in your Northpass admin panel under **Apps → API Access**.""",
            iconPath="/static/services/northpass_lms.png",
            docsUrl="https://hanzo.ai/docs/cdp/sources/northpass-lms",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
