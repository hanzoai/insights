...
from insights.temporal.llm_analytics.trace_summarization.models import SummarizeAndSaveInput, TextReprExpiredError
from insights.temporal.llm_analytics.trace_summarization.summarize_and_save import summarize_and_save_activity
...
@patch(
    "insights.temporal.llm_analytics.trace_summarization.summarize_and_save.Heartbeater",
    _noop_heartbeater,
)
class TestSummarizeAndSaveActivity:
    ...
    async def test_redis_key_missing_raises_text_repr_expired(self, mock_team):
        with (
            patch("insights.temporal.llm_analytics.trace_summarization.summarize_and_save.get_async_client"),
            patch("insights.temporal.llm_analytics.trace_summarization.summarize_and_save.load_text_repr") as mock_load,
        ):
    ...
    async def test_trace_summary_success(self, mock_team):
        ...
        with (
            ...
            patch("insights.temporal.llm_analytics.trace_summarization.summarize_and_save.load_text_repr") as mock_load,
            patch(
                "insights.temporal.llm_analytics.trace_summarization.summarize_and_save.delete_text_repr"
            ) as mock_delete,
            patch("insights.temporal.llm_analytics.trace_summarization.summarize_and_save.summarize") as mock_summarize,
            patch(
                "insights.temporal.llm_analytics.trace_summarization.summarize_and_save.create_event"
            ) as mock_create_event,
            patch("insights.temporal.llm_analytics.trace_summarization.summarize_and_save.LLMTracesSummarizerEmbedder"),
        ):
    ...
    async def test_generation_summary_success(self, mock_team):
        ...
        with (
            patch("insights.temporal.llm_analytics.trace_summarization.summarize_and_save.get_async_client"),
            patch("insights.temporal.llm_analytics.trace_summarization.summarize_and_save.load_text_repr") as mock_load,
            patch("insights.temporal.llm_analytics.trace_summarization.summarize_and_save.delete_text_repr"),
            patch("insights.temporal.llm_analytics.trace_summarization.summarize_and_save.summarize") as mock_summarize,
            patch(
                "insights.temporal.llm_analytics.trace_summarization.summarize_and_save.create_event"
            ) as mock_create_event,
    ...
    async def test_embedding_failure_captured_not_fatal(self, mock_team):
        ...
        with (
            ...
            patch("insights.temporal.llm_analytics.trace_summarization.summarize_and_save.delete_text_repr"),
            patch("insights.temporal.llm_analytics.trace_summarization.summarize_and_save.summarize") as mock_summarize,
            patch("insights.temporal.llm_analytics.trace_summarization.summarize_and_save.create_event"),
            patch(
                "insights.temporal.llm_analytics.trace_summarization.summarize_and_save.LLMTracesSummarizerEmbedder"
