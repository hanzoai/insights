...
CANONICAL_DESCRIPTIONS: CanonicalDescriptions = {
    ...
    "stages": {
        ...
        "columns": {
            ...
            "promotion_id": "Identifier of the promotion this stage belongs to (added by Insights during sync).",
        },
    },
    "users": {
        ...
        "columns": {
            ...
            "promotion_id": "Identifier of the promotion this user registered in (added by Insights during sync).",
    ...
    "participations": {
        ...
        "columns": {
            ...
            "promotion_id": "Identifier of the promotion this participation belongs to (added by Insights during sync).",
    ...
    "prizes": {
        ...
        "columns": {
            ...
            "promotion_id": "Identifier of the promotion this prize belongs to (added by Insights during sync).",
    ...
    "coin_transactions": {
        ...
        "docs_url": DOCS_BASE,
        "columns": {
            "promotion_id": "Identifier of the promotion this transaction belongs to (added by Insights during sync).",
        },
    },
    "rankings": {
        ...
        "docs_url": DOCS_BASE,
        "columns": {
            "promotion_id": "Identifier of the promotion this ranking belongs to (added by Insights during sync).",
        },
    },
    "points_of_sale": {
        ...
        "docs_url": DOCS_BASE,
        "columns": {
            "promotion_id": "Identifier of the promotion this point of sale belongs to (added by Insights during sync).",
        },
    },
}
