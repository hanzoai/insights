...
from insights.temporal.ai_observability.shared_activities import AnalysisLevel  # noqa: F401
...
class ClusteringWorkflowInputs:
    ...
    # Uses Insights's standard property filter format (same as evaluations, feature flags, etc.)
