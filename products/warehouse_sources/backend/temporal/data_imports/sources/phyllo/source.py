...
class PhylloSource(ResumableSource[PhylloSourceConfig, PhylloResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Phyllo API credentials to pull creator accounts, profiles, content, and income data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/phyllo",
