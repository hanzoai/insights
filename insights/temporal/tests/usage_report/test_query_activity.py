...
from insights.temporal.usage_report.activities import run_query_to_s3
from insights.temporal.usage_report.queries import QuerySpec
from insights.temporal.usage_report.storage import queries_key
from insights.temporal.usage_report.types import RunQueryToS3Inputs, WorkflowContext
...
async def test_run_query_to_s3_calls_fn_with_period_and_writes_to_s3(
    ...
    with patch.dict(
        "insights.temporal.usage_report.activities.QUERY_INDEX",
...
async def test_run_query_to_s3_propagates_query_failure(
    ...
    with (
        ...
        patch("insights.temporal.usage_report.storage.object_storage.write") as mock_write,
    ):
