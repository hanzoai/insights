...
from insights.models.remote_config import organization_membership_deleted, user_saved
...
class TestUserSavedSignalHandler(TestCase):
    ...
    @patch("insights.models.remote_config.logger")
    @patch("django.db.transaction.on_commit")
    ...
    @patch("insights.tasks.team_access_cache_tasks.warm_user_teams_cache_sync")
    @patch("django.db.transaction.on_commit")
    ...
    @patch("insights.tasks.team_access_cache_tasks.warm_user_teams_cache_task")
    @patch("django.db.transaction.on_commit")
...
class TestOrganizationMembershipDeletedSignalHandler(TestCase):
    ...
    @patch("insights.tasks.team_access_cache_tasks.warm_organization_teams_cache_task")
    @patch("django.db.transaction.on_commit")
