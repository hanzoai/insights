...
def _build_tier_schedule(
    ...
    from insights.temporal.data_modeling.workflows.execute_dag import (  # noqa: PLC0415 — the workflows package imports this product's models back; importing it lazily keeps this module importable from models code and temporal off django.setup()
        ExecuteDAGInputs,
    )
