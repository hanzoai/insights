...
/** A concrete question for Insights AI, tied to their actual worst tool so the answer is useful. */
...
export function buildEditorPrompt({ client }: { client: string | null }): { label: string; prompt: string } {
    ...
    return {
        ...
        prompt: 'Using the Insights MCP, pull my $mcp_tool_call events and tell me which tools error most and why.',
    }
}
