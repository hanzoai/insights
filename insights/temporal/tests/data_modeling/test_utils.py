...
class TestStripHostnameFromError:
    @parameterized.expand(
        [
            ...
            (
                "Code: 159. DB::Exception (from chi-insights-01.svc.cluster.local:9000): Timeout exceeded",
                "Code: 159. DB::Exception (from [host]): Timeout exceeded",
            ),
            # Pattern: "Received from host:port"
            (
                "Code: 159. DB::Exception: Received from chi-insights-01.svc.cluster.local:9000. DB::Exception: Timeout exceeded",
            ...
            # Hostname in complex Datastore error
            (
                "Code: 241. DB::Exception: Memory limit (for query) exceeded: would use 5.00 GiB (from chi-insights-production-01.datastore.svc.cluster.local:9000)",
