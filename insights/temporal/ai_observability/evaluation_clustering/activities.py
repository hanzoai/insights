...
from insights.temporal.ai_observability.evaluation_clustering.aggregates import aggregate_evaluation_metrics
...
from insights.temporal.ai_observability.evaluation_clustering.data import (
    EvaluationMetadata,
    fetch_evaluation_embeddings,
    fetch_evaluation_metadata,
)
from insights.temporal.ai_observability.evaluation_clustering.event_emission import emit_evaluation_cluster_events
from insights.temporal.ai_observability.evaluation_clustering.labeling import generate_evaluation_cluster_labels
from insights.temporal.ai_observability.trace_clustering import constants as trace_constants
...
class GenerateEvaluationLabelsInputs:
    ...
    # Datastore for partition pruning.
    window_start: str
    window_end: str
...
def _compute_sync(inputs: EvaluationClusteringComputeInputs) -> EvaluationClusteringComputeResult:
    ...
    # unresolvable navigation targets. Also prunes Datastore date partitions.
