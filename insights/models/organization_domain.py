...
from insights.models.linked_identity_provider_config import LinkedIdentityProviderConfig
...
class OrganizationDomainManager(models.Manager):
    ...
    def get_verified_for_email_address_and_issuer(
        ...
        """
        if "@" not in email:
            return None, "ID-JAG sub email domain is not a verified domain for any Insights organization"
