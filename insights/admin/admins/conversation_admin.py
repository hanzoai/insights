...
class ConversationAdmin(admin.ModelAdmin):
    ...
    def get_urls(self):
        compact_url = path(
            ...
            name="insights_ai_conversation_compact",
        )
    ...
    def team_link(self, conversation: Conversation):
        return format_html(
            '<a href="{}">{}</a>',
            reverse("admin:insights_team_change", args=[conversation.team_id]),
    ...
    def checkpoint_storage(self, conversation: Conversation):
        ...
        return format_html(
            ...
            reverse("admin:insights_ai_conversation_compact", args=[conversation.pk]),
        )
    ...
    def compact_view(self, request, object_id: str):
        ...
        if conversation is None:
            ...
            return redirect("admin:insights_ai_conversation_changelist")
        ...
        return redirect("admin:insights_ai_conversation_change", conversation.id)
