...
export function VisualReviewRunsScene(): JSX.Element {
    ...
    const columns: TableColumns<RunApi> = [
        {
            title: 'Branch',
            key: 'branch',
        ...
        },
        {
            ...
            width: 90,
            render: (_, run) => (
                <Tag type="muted" size="small" className="uppercase">
                    {run.run_type}
                </Tag>
            ),
        },
            ...
            <SceneTitleSection
                ...
                actions={
                    <div className="flex gap-2 items-center">
                        ...
                        <Button size="small" type="secondary" icon={<IconGear />} to={urls.visualReviewSettings()}>
                            Settings
                        </Button>
                    </div>
                }
                        ...
                        label: (
                            <span className="flex items-center gap-1.5">
                                ...
                                {(key === 'needs_review' || key === 'processing') && counts[key] > 0 && (
                                    <Tag type={TAB_COUNT_TYPES[key]} size="small">
                                        {counts[key]}
                                    </Tag>
                                )}
                            </span>
