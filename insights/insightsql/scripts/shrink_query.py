# ruff: noqa: T201, E402
"""Shrink one InsightsQL query, read from stdin, to a minimal parser-parity repro.
...
[`rust/insightsql/parser/README.md`](../../../rust/insightsql/parser/README.md): a
...
## Usage
    ...
    echo '<query>' | PYTHONPATH=. python insights/insightsql/scripts/shrink_query.py
    pbpaste | PYTHONPATH=. python insights/insightsql/scripts/shrink_query.py --rule program

Needs the optional `insightsql-parser-parity` dependency group
...
from insights.insightsql.scripts._diagnostic_common import _probe_backend, _safe_parse, _shape_for, shrink_to_shape
