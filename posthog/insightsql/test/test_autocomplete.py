...
from posthog.insightsql.database.schema.persons import PERSONS_FIELDS
...
class TestAutocomplete(ClickhouseTestMixin, APIBaseTest):
    ...
    def _expr(self, query: str, start: int, end: int, database: Optional[Database] = None) -> InsightsQLAutocompleteResponse:
        autocomplete = InsightsQLAutocomplete(
    ...
    def _json(self, query: str, start: int, end: int, database: Optional[Database] = None) -> InsightsQLAutocompleteResponse:
        autocomplete = InsightsQLAutocomplete(
            kind="InsightsQLAutocomplete",
            query=query,
    ...
    def test_autocomplete_empty_source_query(self):
        ...
        results = get_insightsql_autocomplete(query=autocomplete, team=self.team)
