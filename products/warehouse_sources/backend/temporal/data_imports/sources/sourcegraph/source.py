...
class SourcegraphSource(ResumableSource[SourcegraphSourceConfig, SourcegraphResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Sourcegraph instance URL and an access token to pull your Sourcegraph data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/sourcegraph",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
