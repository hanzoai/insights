...
pytest insights/insightsql/database/schema/test/test_persons_revenue_analytics.py insights/insightsql/database/schema/test/test_groups_revenue_analytics.py -v --snapshot-update
```
