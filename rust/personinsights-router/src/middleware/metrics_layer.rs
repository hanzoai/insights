...
///
/// Note: For error tracking, use `personinsights_router_backend_errors_total` from the
    ...
    ReqBody: Send + 'static,
{
    ...
    fn call(&mut self, request: Request<ReqBody>) -> Self::Future {
        ...
        // Extract method name from URI path (e.g., "/personinsights.service.v1.PersonInsightsService/GetPerson")
