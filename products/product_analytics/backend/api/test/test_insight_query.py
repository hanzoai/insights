...
class TestInsight(DatastoreTestMixin, LicensedTestMixin, APIBaseTest, QueryMatchingTest):
    ...
    @parameterized.expand(
        [
            ...
            (
                "bare_insightsql_query",
                {"kind": "InsightsQLQuery", "query": "select event from events limit 1"},
        ...
        [
            ...
            (
                "already_wrapped_data_visualization_node",
                {
                    ...
                    "source": {"kind": "InsightsQLQuery", "query": "select event from events limit 1"},
                },
                "DataVisualizationNode",
                "InsightsQLQuery",
            ),
