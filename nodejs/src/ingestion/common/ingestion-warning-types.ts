 ...
 * warning requires registering it here, which keeps the Datastore v2
...
export const INGESTION_WARNING_TYPES = {
    ...
    // The personinsights leader trimmed or rejected a person property update at
    ...
    // Transformations — user-configured script transformations
