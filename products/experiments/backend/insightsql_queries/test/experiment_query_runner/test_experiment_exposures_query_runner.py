...
from insights.schema import ActionsNode, ExperimentEventExposureConfig, ExperimentExposureQuery
...
class TestExperimentExposuresQueryRunner(ExperimentQueryRunnerBaseTest):
    ...
    def test_exposure_event_selected_relative_to_cutoff(
        ...
        # unrelated InsightsQL query modifiers on and break the query under test.
