...
class VeeqoSource(ResumableSource[VeeqoSourceConfig, VeeqoResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Veeqo",
            caption="""Enter your Veeqo API key to automatically pull your Veeqo inventory, order and shipping data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/veeqo",
