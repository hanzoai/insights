...
from posthog.insightsql_queries.sessions_timeline_query_runner import SessionsTimelineQueryRunner
...
class TestSessionsTimelineQueryRunner(ClickhouseTestMixin, APIBaseTest):
    ...
    @snapshot_clickhouse_queries
    @patch("posthog.insightsql_queries.sessions_timeline_query_runner.SessionsTimelineQueryRunner.EVENT_LIMIT", 2)
