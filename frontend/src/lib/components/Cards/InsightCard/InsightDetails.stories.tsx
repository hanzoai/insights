...
export const DataTableInsightsQLQuery: Story = {
    args: {
        insight: __dataTableInsightsQL as any,
    },
}

export const DataVisualizationInsightsQLQuery: Story = {
    args: {
        insight: __dataVisualizationInsightsQL as any,
    },
}
