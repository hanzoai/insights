...
class SonarCloudSource(ResumableSource[SonarCloudSourceConfig, SonarCloudResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your SonarQube Cloud user token and organization key to sync code-quality data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/sonar-cloud",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
