...
export const pullRequestReports: SignalReport[] = [
    makeReport({
        ...
        signal_count: 12,
        source_products: ['error_tracking'],
        implementation_pr_url: 'https://github.com/Insights/insights/pull/12001',
        is_suggested_reviewer: true,
    }),
    makeReport({
        ...
        signal_count: 31,
        source_products: ['error_tracking'],
        implementation_pr_url: 'https://github.com/Insights/insights/pull/12002',
    }),
    makeReport({
        ...
        signal_count: 7,
        source_products: ['session_replay'],
        implementation_pr_url: 'https://github.com/Insights/insights/pull/12003',
        is_suggested_reviewer: true,
    }),
]
            ...
            content: [
                {
                    ...
                    relevant_commits: [
                        {
                            sha: 'a1b2c3d4',
                            url: 'https://github.com/Insights/insights/commit/a1b2c3d4',
...
function makeTaskRun(taskId: string, runId: string, status: string): any {
    return {
        ...
        log_url: null,
        error_message: null,
        output: taskId.includes('impl') ? { pr_url: 'https://github.com/Insights/insights/pull/12001' } : {},
        state: {},
        artifacts: [],
        created_at: BASE_DATE,
        updated_at: BASE_DATE,
...
+                toast.error('Add at least one recipient before sending invites.')
+                return
+            }
...
export const mockReviewers = {
    results: [
        ...
        { user_uuid: 'u-2', name: 'Hedge Script', email: 'hedge@example.com' },
