...
```bash
# Download and run
curl -L https://github.com/hanzoai/insights/releases/download/hobby-latest/insights-hobby -o insights-hobby
...
- **Stable URL**: `https://github.com/hanzoai/insights/releases/download/hobby-latest/insights-hobby` always points to the latest build
- **Version history**: All previous builds are available at `https://github.com/hanzoai/insights/releases?q=hobby-&expanded=true`
