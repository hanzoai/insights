...
from insights.plugins.test.plugin_archives import HELLO_WORLD_PLUGIN_GITHUB_ATTACHMENT_ZIP, HELLO_WORLD_PLUGIN_GITHUB_ZIP
from insights.queries.app_metrics.test.test_app_metrics import create_app_metric
...
@mock.patch("insights.models.plugin.reload_plugins_on_workers", side_effect=mocked_plugin_reload)
...
class TestPluginAPI(APIBaseTest, QueryMatchingTest):
    ...
    @mock.patch("insights.models.plugin.PluginSourceFile.objects.sync_from_plugin_archive")
    ...
    @patch("insights.api.plugin.transpile", side_effect=mock_transpile)
