...
table (insights_team, insights_user, ...) that SHARE ROW EXCLUSIVE conflicts with the
...
from insights.migration_helpers.not_valid_constraint import ValidateConstraint, _constraint_validity
...
class AddForeignKeyNotValid(Operation):
    ...
    *referenced parent* table for the catalog metadata add - it is NOT lock-free, but it
    ...
    Arguments:
        ...
        to_table: the referenced parent table, e.g. `"insights_team"`.
