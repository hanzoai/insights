...
import { Button, Card, Divider, Link } from '@hanzo/elements'
            ...
            <SceneSection
                ...
                description={
                    <>
                        ...
                        <Link to="https://hanzo.ai/docs/support/workflows" target="_blank">
                            Workflow docs
                        </Link>
                    </>
                }
            >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-[800px]">
                    {WORKFLOW_TEMPLATES.map((template) => (
                        <Card key={template.title} hoverEffect={false} className="flex flex-col gap-2 px-4 py-3">
                            ...
                            <div className="flex items-center justify-between gap-2 mt-1">
                                ...
                                <Button type="secondary" size="small" to={urls.workflowNew()}>
                                    Create workflow
                                </Button>
                            </div>
                        </Card>
