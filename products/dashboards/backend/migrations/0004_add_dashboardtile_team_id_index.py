...
class Migration(migrations.Migration):
    ...
    InsightsQL queries against system.dashboard_tiles inject `WHERE team_id = X`,
    ...
    operations = [
        migrations.RunSQL(
            sql=(
                ...
                '"insights_dashboardtile_team_id_idx" '
                'ON "insights_dashboardtile" ("team_id")'
            ),
            reverse_sql='DROP INDEX CONCURRENTLY IF EXISTS "insights_dashboardtile_team_id_idx"',
        ),
    ]
