...
from insights.insightsql.property import entity_to_expr, property_to_expr
...
from insights.insightsql_queries.insights.retention.retention_base_query_fixed import RetentionFixedIntervalBaseQueryBuilder
from insights.insightsql_queries.insights.retention.retention_base_query_rolling import (
    RetentionRollingIntervalBaseQueryBuilder,
)
from insights.insightsql_queries.insights.retention.retention_validation_rules import (
...
from insights.insightsql_queries.insights.utils.properties import has_cohort_property
from insights.insightsql_queries.query_runner import AnalyticsQueryRunner
from insights.insightsql_queries.utils.query_date_range import QueryDateRangeWithIntervals
...
class RetentionQueryRunner(AnalyticsQueryRunner[RetentionQueryResponse]):
    ...
    def update_insightsql_modifiers(self) -> None:
        """
        Update InsightsQL modifiers to optimize cohort filtering performance.
    ...
    def property_aggregation_expr(self) -> ast.Expr | None:
        if (
            ...
            if self.query.retentionFilter.aggregationPropertyType == "person":
                # person.properties resolves via the InsightsQL person join on the events table
    ...
    def _calculate(self) -> RetentionQueryResponse:
        ...
        response = execute_insightsql_query(
            ...
            settings=InsightsQLGlobalSettings(max_bytes_before_external_group_by=MAX_BYTES_BEFORE_EXTERNAL_GROUP_BY),
        )
    ...
    def format_results(self, response: InsightsQLQueryResponse) -> list[dict[str, Any]]:
        """Format raw retention InsightsQL response into nested interval structures.
    ...
    def to_events_query(
        ...
        Returns:
            A InsightsQL query that returns matching events
        """
                ...
                """,
                    {
                        ...
                        "start_of_interval_sql": self.query_date_range.get_start_of_interval_insightsql(
