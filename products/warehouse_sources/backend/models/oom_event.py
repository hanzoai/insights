...
from insights.models.utils import UUIDModel, sane_repr
...
class ExternalDataSchemaOOMEvent(TeamScopedRootMixin, UUIDModel):
    ...
    # hot insights_team table on create. Team scoping is enforced at the app layer by TeamScopedRootMixin.
