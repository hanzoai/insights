...
fn test_decode_form_data_kludges() {
    // see https://github.com/Insights/insights/blob/master/insights/utils.py#L686-L708
...
async fn test_fetch_and_filter_preserves_evaluation_metadata() {
    ...
    let cache_key = format!("insights:1:cache/teams/{}/feature_flags/flags.json", team.id);
    redis_client
