...
$ai_evaluation) to a Insights client.
...
class TraceEventEmitter:
    """Emits Insights $ai_* events for a single eval case trace.

    Holds the Insights client, trace_id, and experiment metadata so individual
