...
function buildNewMenuItems(existingTypes: Set<LegalDocumentType>): MenuItems {
                ...
                },
                {
                    label: (
                        <div className="flex flex-col text-sm py-1">
                            ...
                            <span className="text-xs font-normal text-muted">
                                Negotiated with sales — contact your TAM or Insights support to sign one.
                            </span>
                        </div>
                    ),
    ...
    if (!isCloudOrDev) {
        return (
            <SceneContent>
                ...
                />
                <Banner type="info">
                    <p className="mb-0">Legal documents are only available on Insights Cloud.</p>
                </Banner>
            </SceneContent>
        )
    }
    ...
    return (
        <SceneContent>
            <SceneTitleSection
                ...
                resourceType={{ type: 'default_icon_type', forceIcon: <IconBalance /> }}
                actions={
                    <Menu items={buildNewMenuItems(existingDocumentTypes)} placement="bottom-end">
                        <Button
                            type="primary"
                            icon={<IconPlusSmall />}
                            size="small"
            ...
            <Table
                ...
                columns={[
                    ...
                    },
                    {
                        ...
                        render: (_: any, row: LegalDocument) =>
                            row.status === 'signed' ? (
                                <Tag type="success">Signed</Tag>
                            ) : (
                                <Tag type="warning">Awaiting signature</Tag>
                            ),
                    },
                    {
                        title: 'Signed copy',
