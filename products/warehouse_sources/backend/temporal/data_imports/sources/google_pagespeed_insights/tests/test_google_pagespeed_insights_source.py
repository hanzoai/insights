...
class TestGooglePageSpeedInsightsSource:
    def setup_method(self):
        ...
        self.team_id = 123
        self.config = GooglePageSpeedInsightsSourceConfig(api_key="test-key", urls="https://hanzo.ai")
    ...
    def test_get_source_config(self):
        ...
        assert config.docsUrl == "https://hanzo.ai/docs/cdp/sources/google-pagespeed-insights"
