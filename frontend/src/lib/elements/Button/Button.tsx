...
import { INTERACTIVE_CLOSE_DELAY_MS } from '../Input/Input'
import { Link } from '../Link'
import { PopoverOverlayContext, PopoverReferenceContext } from '../Popover'
import { Spinner } from '../Spinner/Spinner'
import { Tooltip, TooltipProps } from '../Tooltip'

export type ButtonDropdown = Omit<DropdownProps, 'children'>
...
export interface ButtonWithoutSideActionProps extends ButtonPropsBase {
    sideIcon?: React.ReactElement | null
    sideAction?: null
}

/** A ButtonWithSideAction can't have a sideIcon - instead it has a clickable sideAction. */
export interface ButtonWithSideActionProps extends ButtonPropsBase {
...
export interface ButtonWithDropdownProps extends ButtonPropsBase {
    dropdown: ButtonDropdown
    sideIcon?: React.ReactElement | null
}
 ...
 * The difference vs. plain `Button` is dropdown visibility being controlled internally, which is more convenient.
 * @deprecated In almost all cases you should use the newer `Menu` with a `Button` child.
 */
export const ButtonWithDropdown: React.FunctionComponent<
    ButtonWithDropdownProps & React.RefAttributes<HTMLButtonElement>
