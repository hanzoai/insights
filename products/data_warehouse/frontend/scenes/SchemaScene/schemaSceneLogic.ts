            ...
            null as SchemaIncrementalFieldsResponse | null,
            {
                loadSchemaIncrementalFields: async (schemaId: string) => {
                    try {
                        ...
                        toast.error(e?.data?.message ?? e?.message ?? e)
                        throw e
                    }
                },
            },
    ...
    listeners(({ actions, values, props }) => ({
        updateSchema: async ({ schema }) => {
            ...
            try {
                ...
                toast.error(e?.message || "Can't update schema at this time")
            } finally {
                actions.loadSchema()
            }
        },
        reloadSchema: async ({ schema }) => {
            ...
            try {
                ...
                insights.capture('schema reloaded', { sourceType: values.source?.source_type })
            } catch (e: any) {
                toast.error(e?.message || 'Cant reload schema at this time')
            } finally {
                actions.loadSchema()
            }
        },
        resyncSchema: async ({ schema }) => {
            ...
            try {
                ...
                insights.capture('schema resynced', { sourceType: values.source?.source_type })
                toast.success(`Resync started for ${schema.label ?? schema.name}`)
            } catch (e: any) {
                toast.error(e?.message || "Couldn't start resync")
            } finally {
        ...
        cancelSchema: async ({ schema }) => {
            try {
                ...
                toast.error(e?.message || "Can't cancel sync at this time")
            } finally {
                actions.loadSchema()
            }
        },
        deleteTable: async ({ schema }) => {
            try {
                ...
                insights.capture('schema data deleted', { sourceType: values.source?.source_type })
                toast.success(`Data for ${schema.label ?? schema.name} has been deleted`)
            } catch (e: any) {
                toast.error(e?.message || "Can't delete data at this time")
            } finally {
                actions.loadSchema()
            }
        },
        refreshSchemas: async () => {
            try {
                ...
                toast.error(e?.message || "Can't refresh schemas at this time")
            } finally {
