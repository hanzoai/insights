...
TASK_RUN_CREATED_TOTAL = Counter(
    "insights_tasks_task_run_created_total",
...
TASK_RUN_WORKFLOW_START_TOTAL = Counter(
    "insights_tasks_task_run_workflow_start_total",
...
TASK_RUN_DISPATCH_CALLBACK_TOTAL = Counter(
    "insights_tasks_task_run_dispatch_callback_total",
...
AGENT_OTEL_TELEMETRY_STAMPED_TOTAL = Counter(
    "insights_tasks_agent_otel_telemetry_stamped_total",
...
RUN_LOG_MIRROR_ENTRIES_TOTAL = Counter(
    "insights_tasks_run_log_mirror_entries_total",
...
CUSTOM_IMAGE_BUILD_TOTAL = Counter(
    "insights_tasks_custom_image_build_total",
    "Custom sandbox image build lifecycle events",
    labelnames=["outcome"],
)

DEV_STACK_IMAGE_BAKE_TOTAL = Counter(
    "insights_tasks_dev_stack_image_bake_total",
...
TASK_RUN_STREAM_CONNECTIONS_OPENED_TOTAL = Counter(
    "insights_tasks_task_run_stream_connections_opened_total",
    "SSE task-run stream connections opened",
    labelnames=["origin_product"],
)

TASK_RUN_STREAM_CONNECTIONS_CLOSED_TOTAL = Counter(
    "insights_tasks_task_run_stream_connections_closed_total",
...
TASK_RUN_STREAM_CONNECTION_DURATION_SECONDS = Histogram(
    "insights_tasks_task_run_stream_connection_duration_seconds",
...
TASK_RUN_STREAM_LENGTH_ON_CONNECT = Histogram(
    "insights_tasks_task_run_stream_length_on_connect",
...
TASK_RUN_STREAM_RESUME_GAP_TOTAL = Counter(
    "insights_tasks_task_run_stream_resume_gap_total",
...
TASK_RUN_AGENT_FAILURE_TOTAL = Counter(
    "insights_tasks_agent_turn_failed_total",
...
TASK_RUN_FOLLOWUP_DELIVERY_FAILED_TOTAL = Counter(
    "insights_tasks_followup_delivery_failed_total",
...
LOOP_FIRE_TOTAL = Counter(
    "insights_tasks_loop_fire_total",
    "Loop trigger fire outcomes",
    labelnames=["reason"],
)

LOOP_AUTO_PAUSED_TOTAL = Counter(
    "insights_tasks_loop_auto_paused_total",
...
CODE_USAGE_GATE_CHECK_TOTAL = Counter(
    "insights_tasks_code_usage_gate_check_total",
    "Cloud usage-gate check outcomes for Insights Code runs",
    labelnames=["outcome"],
)
