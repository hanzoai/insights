...
pub struct Args {
    ...
    /// This is the identifier insights will use to look up with mapping file, when it's processing your
    /// stack traces. Must match with the identifier provided to the insights SDK at runtime, for this build.
    #[arg(short, long)]
    pub map_id: String,
