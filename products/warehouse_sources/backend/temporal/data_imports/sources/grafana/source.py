...
class GrafanaSource(ResumableSource[GrafanaSourceConfig, GrafanaResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Grafana instance URL and credentials to pull your Grafana metadata (dashboards, folders, alert rules, annotations, and more) into the Insights Data warehouse.
...
Self-hosted Grafana OSS can alternatively authenticate with a username and password. Grafana Cloud only supports service account tokens.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/grafana",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
