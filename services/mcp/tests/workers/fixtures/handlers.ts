...
// Real Insights API responses captured from a freshly-seeded local dev server
...
// `MCP.detectRegion` calls users/@me on both us.hanzo.ai and eu.hanzo.ai
    ...
    resources: [
        {
            ...
            uri: 'insights://guide/getting-started',
            resource: {
                mimeType: 'text/plain',
                description: 'A guide to getting started with Insights',
                text: 'Welcome to Insights. This is a test resource.',
            },
        },
    ],
}
