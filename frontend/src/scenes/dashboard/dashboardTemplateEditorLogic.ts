...
export interface dashboardTemplateEditorLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface dashboardTemplateEditorLogicActions {
    clear: () => {
        value: true
    }
    ...
    deleteDashboardTemplate: ({ id, templateName }: { id: string; templateName: string }) => {
        id: string
        templateName: string
    }
    ...
    getDashboardTemplate: (id: string) => string
    ...
    toggleTemplateOrganizationScope: (template: DashboardTemplateType) => {
...
export type dashboardTemplateEditorLogicType = MakeLogicType<
    dashboardTemplateEditorLogicValues,
    dashboardTemplateEditorLogicActions
>
            ...
            undefined as DashboardTemplateEditorType | undefined | null,
            {
                createDashboardTemplate: async (): Promise<DashboardTemplateEditorType | undefined> => {
                    ...
                    if (raw) {
                        ...
                        if (!payload) {
                            toast.error('Unable to parse dashboard template JSON')
                            return
                        }
                    } else {
                ...
                deleteDashboardTemplate: async ({
                    ...
                    try {
                        ...
                        toast.error(e?.detail || e?.message || 'Could not delete dashboard template')
                        throw e
                    }
