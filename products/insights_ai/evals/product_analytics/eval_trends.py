...
Intent mirrors ``ee/scriptai/eval/ci/eval_trends.py`` — the CI version asserts
...
To run:
    flox activate -- bash -c "set -a; source .env; set +a; python -m products.insights_ai.eval_harness.harness eval_trends"
"""
