...
from insights.approvals.models import (
    Approval,
    ApprovalDecision,
    ApprovalPolicy,
    ChangeRequest,
...
class TestChangeRequestViewSet(APIBaseTest):
    ...
    @patch("insights.approvals.services.apply_change_request")
...
class TestApprovalPolicyViewSet(APIBaseTest):
    ...
    def test_filter_by_action_key(self):
        ...
        response = self.client.get(
            f"/v1/environments/{self.team.id}/approval_policies/?action_key=feature_flag.enable"
        )
