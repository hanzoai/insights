...
from insights.security.pinned_requests import SSRFBlockedError, pinned_session
from insights.security.url_validation import strip_userinfo
...
def analyze_framing_headers(headers: dict[str, str]) -> tuple[Framing, BlockedBy | None]:
    """Decide whether the Insights app may embed a page in an iframe, from its response headers."""
