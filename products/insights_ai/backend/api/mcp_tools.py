...
class DocsSearchRequestSerializer(serializers.Serializer):
    query = serializers.CharField(
        help_text=(
            "Natural-language description of what to find in the Insights documentation. "
...
class DocsSearchResponseSerializer(serializers.Serializer):
    content = serializers.CharField(
        help_text=(
            ...
            "an empty result set returns guidance to navigate to https://hanzo.ai/docs."
        )
    )
...
class MCPToolsViewSet(TeamAndOrgViewSetMixin, GenericViewSet):
    ...
    @validated_request(
        ...
        description=(
            "Run a hybrid (semantic + full-text) RAG search over the Insights documentation via "
