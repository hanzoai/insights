...
class TestInsightsQLExtractorFiltersPlaceholder(APIBaseTest, DatastoreDestroyTablesMixin):
    ...
    def _evaluate(self, insightsql_source: dict) -> float | None:
        insight = Insight.objects.create(
            team=self.team,
            query={"kind": "DataVisualizationNode", "source": insightsql_source},
        )
        ...
        result = InsightsQLExtractor().extract(
            alert, insight, insightsql_source, ExecutionMode.RECENT_CACHE_CALCULATE_BLOCKING_IF_STALE
        )
