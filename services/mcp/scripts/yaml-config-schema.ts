...
export const ToolConfigSchema = z
    .object({
        ...
        /**
         * Insights feature flag key that controls whether this tool is exposed.
         ...
         */
        /**
         * Override the category-level URL prefix for `_insightsUrl` enrichment.
...
const DetailUiAppSchema = z
    .object({
        ...
        view_prop: z.string(),
        /** Display name shown in the MCP client. Default: "Insights " + title-case of key. */
 ...
 * server_name + tool_name. With server name "insights" (7 chars), tool names
...
export const QueryWrapperToolConfigSchema = z
    .object({
         ...
         * `ee/scriptai/context/insight/format/`. Enabling this:
        ...
        /**
         * Override the URL enrichment prefix. When set, `_insightsUrl` uses
