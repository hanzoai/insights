...
import { SegmentedButton, Table, TableColumns } from '@hanzo/elements'
...
// SegmentedButton values must be React.Keys, so "any" stands in for the filter's null.
...
export function ConversionPaths({
    ...
    const columns: TableColumns<MarketingAnalyticsAttributionPathRow> = [
        {
            title: 'Path',
            key: 'path',
            render: (_, row) => (
