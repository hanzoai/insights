...
Heavy InsightsQL-adjacent wiring (model classes, table resolution, Datastore→InsightsQL
type mappings) lives in ``facade/insightsql.py``; temporal/source wiring in
