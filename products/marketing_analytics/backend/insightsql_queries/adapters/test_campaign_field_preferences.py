...
from products.marketing_analytics.backend.insightsql_queries.adapters.bing_ads import BingAdsAdapter, BingAdsConfig
from products.marketing_analytics.backend.insightsql_queries.adapters.google_ads import GoogleAdsAdapter, GoogleAdsConfig
from products.marketing_analytics.backend.insightsql_queries.adapters.linkedin_ads import (
    LinkedinAdsAdapter,
    LinkedinAdsConfig,
)
from products.marketing_analytics.backend.insightsql_queries.adapters.meta_ads import MetaAdsAdapter, MetaAdsConfig
from products.marketing_analytics.backend.insightsql_queries.adapters.reddit_ads import RedditAdsAdapter, RedditAdsConfig
from products.marketing_analytics.backend.insightsql_queries.adapters.tiktok_ads import TikTokAdsAdapter, TikTokAdsConfig
...
class TestCampaignFieldPreferences(BaseTest):
    ...
    def test_googleads_always_returns_both_fields(self):
        ...
        name_insightsql = campaign_name_expr.to_insightsql()
        assert "campaign_name" in name_insightsql

        # Check that campaign_id field exists
        campaign_id_expr = adapter._get_campaign_id_field()
        id_insightsql = campaign_id_expr.to_insightsql()
        assert "campaign_id" in id_insightsql
    ...
    def test_googleads_uses_campaign_id_for_matching_when_configured(self):
        ...
        match_insightsql = match_field_expr.to_insightsql()
        assert "campaign_id" in match_insightsql
    ...
    def test_metaads_always_returns_both_fields(self):
        ...
        campaign_name_expr = adapter._get_campaign_name_field()
        name_insightsql = campaign_name_expr.to_insightsql()
        assert ".name" in name_insightsql

        # Check that the campaign id field uses 'id' field
        campaign_id_expr = adapter._get_campaign_id_field()
        id_insightsql = campaign_id_expr.to_insightsql()
        assert ".id" in id_insightsql
    ...
    def test_different_preferences_per_integration(self):
        ...
        google_match_insightsql = google_match_field.to_insightsql()
        assert "campaign_id" in google_match_insightsql
        ...
        meta_match_insightsql = meta_match_field.to_insightsql()
        assert ".name" in meta_match_insightsql
    ...
    def test_linkedin_adapter_respects_preferences(self):
        ...
        name_insightsql = name_field_expr.to_insightsql()
        assert ".name" in name_insightsql
