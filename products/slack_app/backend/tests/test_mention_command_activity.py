...
from insights.temporal.ai.slack_app.activities.rules import handle_insights_code_slack_mention_command_activity
from insights.temporal.ai.slack_app.types import InsightsCodeSlackMentionCommandWorkflowInputs
...
class TestMentionCommandActivity:
    ...
    def _inputs(
        ...
        return InsightsCodeSlackMentionCommandWorkflowInputs(
            event=event,
    ...
    @parameterized.expand(
        [
            ...
            # reply anchors to the channel root and speaks the ``/insights`` surface.
            ("slash_outside_thread", "/insights", {}, ""),
            ...
            ("mention_top_level", "@Insights", {"ts": "111.1"}, ""),
            # A mention inside a real thread carries thread_ts; the reply threads there.
            ("mention_in_thread", "@Insights", {"ts": "222.2", "thread_ts": "111.1"}, "111.1"),
        ]
    )
    ...
    def test_dispatches_with_surface_prefix(
        ...
        result = handle_insights_code_slack_mention_command_activity(
