...
export interface onboardingExitLogicValues {
    currentStepKey: OnboardingStepKey | null // onboardingLogic
    onCompleteOnboardingRedirectUrl: string // onboardingLogic
    currentOrganizationId: string // organizationLogic
    canSubmitDelegation: boolean
    isExitModalOpen: boolean
    isSubmitting: boolean
    message: string
    orgIdAtOpen: string | null
    targetEmail: string
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface onboardingExitLogicActions {
    ...
    captureOrgIdAtOpen: (orgId: string | null) => {
        orgId: string | null
    }
    closeExitModal: () => {
        value: true
    ...
    setTargetEmail: (targetEmail: string) => {
        targetEmail: string
    }
    submitDelegation: () => {
        value: true
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface onboardingExitLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        canSubmitDelegation: (targetEmail: string) => boolean
    }
}

export type onboardingExitLogicType = MakeLogicType<
    onboardingExitLogicValues,
    onboardingExitLogicActions,
    Record<string, any>,
    onboardingExitLogicMeta
>
...
export const onboardingExitLogic = kea<onboardingExitLogicType>([
    ...
    listeners(({ actions, values }) => ({
        openExitModal: () => {
            ...
            insights.capture('onboarding exit modal opened', { step_at_open: values.currentStepKey || null })
        ...
        submitDelegation: async () => {
            ...
            if (!orgId) {
                toast.error("Couldn't find your current organization. Please refresh and try again.")
                return
            }
            ...
            try {
                ...
                toast.success(`Invitation sent to ${values.targetEmail.trim()}`)
                ...
                toast.error(extractErrorDetail(error, "Couldn't send the invitation. Please try again."))
            } finally {
