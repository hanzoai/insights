...
import { CustomFunctionFilterGlobals, CustomFunctionInvocationGlobals, CustomFunctionType } from '../types'
import {
    convertClickhouseRawEventToFilterGlobals,
    convertToCustomFunctionFilterGlobal,
    filterFunctionInstrumented,
} from './custom-function-filtering'

describe('custom-function-filtering', () => {
    describe('convertToCustomFunctionFilterGlobal', () => {
        it('should correctly map groups to response including empty group indexes', () => {
            ...
            const response = convertToCustomFunctionFilterGlobal(globals)
    ...
    describe('convertClickhouseRawEventToFilterGlobals', () => {
        it('should convert RawClickHouseEvent to CustomFunctionFilterGlobals with basic event data', () => {
    ...
    describe('Pre-filtering on event name', () => {
        let mockCustomFunction: CustomFunctionType
        let mockFilterGlobals: CustomFunctionFilterGlobals
        ...
        it('should return false and skip bytecode when event does not match specific events', async () => {
            ...
            const result = await filterFunctionInstrumented({
                fn: mockCustomFunction,
                filters: mockCustomFunction.filters,
