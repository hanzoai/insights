...
class GoogleAnalyticsSource(ResumableSource[GoogleAnalyticsSourceConfig, GoogleAnalyticsResumeConfig], OAuthMixin):
    ...
    def get_non_retryable_errors(self) -> dict[str, str | None]:
        return {
            ...
            "403 Client Error": "Insights is not authorized to read this Google Analytics property. Please make sure the connected Google account has access to the property.",
    ...
    def validate_credentials(
        ...
        try:
            ...
            return (
                False,
                "Insights could not authenticate with Google Analytics. Your connection may have "
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/google-analytics",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldOauthConfig(
