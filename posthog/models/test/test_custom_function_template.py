...
class TestCustomFunctionTemplate(TestCase):
    def setUp(self):
    ...
    def test_get_template_by_id_and_sha(self):
        ...
        template = CustomFunctionTemplate.objects.create(
        ...
        retrieved_template = CustomFunctionTemplate.get_template("test-template", template.sha)
        ...
        latest_template = CustomFunctionTemplate.get_template("test-template")
        assert latest_template
        self.assertEqual(latest_template.template_id, template.template_id)

        # Test getting a non-existent template
        nonexistent_template = CustomFunctionTemplate.get_template("non-existent-template")
    ...
    def test_update_existing_template(self):
        ...
        original_dto = CustomFunctionTemplateDC(
            id="update-test",
        ...
        updated_dto = CustomFunctionTemplateDC(
        ...
        templates = CustomFunctionTemplate.objects.filter(template_id="update-test")
