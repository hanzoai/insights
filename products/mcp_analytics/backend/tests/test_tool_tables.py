...
from products.mcp_analytics.backend.insightsql_queries.tool_tables import (
...
class TestMCPToolTopUsersQueryRunner(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
    def _emit(
        self,
        *,
...
class TestMCPToolFailuresQueryRunner(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
    def _emit(
        self,
        *,
        tool_name: str = "query_run",
...
class TestMCPToolFailureOccurrencesQueryRunner(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
    def _emit(
        self,
        *,
        tool_name: str = "query_run",
...
class TestMCPToolStatsQueryRunner(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
    def _run(self, tool_name: str = "query_run") -> list[Any]:
...
class TestMCPToolDailyStatsQueryRunner(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
    def _run(self, tool_name: str = "query_run") -> list[Any]:
...
class TestMCPToolDescriptionsQueryRunner(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
    def _run(self, tool_name: str = "query_run") -> list[Any]:
...
class TestMCPToolSampleIntentsQueryRunner(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
    def _run(self, tool_name: str = "query_run") -> list[Any]:
    ...
    def test_resolves_harness_label_and_carries_source(self) -> None:
        ...
        # intent round-trips through Datastore JSON storage (re-serialized), so assert content not bytes.
        assert "goal" in rows[0].intent
...
class TestMCPToolNeighborsQueryRunner(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
