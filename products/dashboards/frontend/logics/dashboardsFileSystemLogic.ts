...
async function fetchAllFileSystemEntries(type: 'dashboard' | 'folder'): Promise<FileSystemEntry[]> {
    ...
    insights.capture('dashboards tree pagination ceiling hit', {
        entry_type: type,
...
export const dashboardsFileSystemLogic = kea<dashboardsFileSystemLogicType>([
    ...
    listeners(({ values, actions }) => ({
        ...
        loadDashboardFileSystemEntriesFailure: () => {
            ...
            toast.error('Could not load dashboard folders — they may appear unorganized. Refresh to retry.')
        },
        loadFolderEntriesFailure: () => {
            ...
            toast.error('Could not load folders — empty folders may not appear. Refresh to retry.')
        },
