"""InsightsQL assembly of a single PR's lifecycle over the curated query builders.
...
# constants), leaving the InsightsQL {value} placeholders untouched for parse_select.
