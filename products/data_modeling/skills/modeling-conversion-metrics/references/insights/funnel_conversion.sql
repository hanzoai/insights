-- Funnel conversion with a fixed conversion window, using Datastore windowFunnel.
...
--
-- NOTE: wrap the time arg in toDateTime() — Insights's `timestamp` is DateTime64, which windowFunnel rejects.
