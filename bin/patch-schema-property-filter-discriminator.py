...
"""Post-process insights/schema.py to discriminate the AnyPropertyFilter union.
...
callable discriminator in insights/schema_discriminators.py.
...
insights/test/test_property_filter_discriminator.py accordingly.
"""
...
SCHEMA_PY = Path("insights/schema.py")

DISCRIMINATOR_MODULE = "insights.schema_discriminators"
...
# folded onto these tags by the callable in insights/schema_discriminators.py.
MEMBER_TAGS: dict[str, str] = {
    ...
    "InsightsQLPropertyFilter": "insightsql",
...
def _main_alias_block() -> str:
    ...
    return (
        ...
        "# keeps legacy tolerance — see insights/schema_discriminators.py.\n"
...
def main() -> int:
    ...
    if found != EXPECTED_SITE_COUNTS:
        print(
            ...
            "insights/test/test_property_filter_discriminator.py to cover the change.",
            file=sys.stderr,
        )
        return 1
