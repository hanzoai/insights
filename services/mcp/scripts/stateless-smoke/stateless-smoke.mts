// Smoke-tests the Insights MCP server's 2026-07-28 stateless dialect using the
...
function makeTransport(): StreamableHTTPClientTransport {
    return new StreamableHTTPClientTransport(new URL(MCP_URL), {
        ...
        requestInit: { headers: { 'x-insights-mcp-mode': 'tools' } },
    })
}
...
const client = new Client(
    { name: 'insights-stateless-smoke', version: '0.0.1' },
...
const client2 = new Client(
    { name: 'insights-stateless-smoke-2', version: '0.0.1' },
    { versionNegotiation: { mode: { pin: STATELESS_VERSION } } }
)
