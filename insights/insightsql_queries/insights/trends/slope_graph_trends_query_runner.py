...
class SlopeGraphTrendsQueryRunner(TrendsQueryRunner):
    ...
    windows, so Datastore only reads those two buckets instead of the whole range. The series still
    ...
    def _end_buckets_filter(self) -> InsightsQLPropertyFilter:
        ...
        return InsightsQLPropertyFilter(key=expr)
