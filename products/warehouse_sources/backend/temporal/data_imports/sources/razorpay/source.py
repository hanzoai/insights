...
class RazorpaySource(ResumableSource[RazorpaySourceConfig, RazorpayResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Razorpay",
            caption="Enter your Razorpay API key pair to pull payments, orders, refunds, settlements, and subscription data into the Insights Data warehouse. Generate a key ID and key secret in the Razorpay Dashboard under Account & Settings → API keys. Use a `rzp_live_` key for live-mode data or a `rzp_test_` key for test-mode data.",
            docsUrl="https://hanzo.ai/docs/cdp/sources/razorpay",
