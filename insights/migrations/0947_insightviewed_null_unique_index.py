...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql="""
                CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS "insights_insightviewed_null_team_user_unique"
                ON "insights_insightviewed" ("insight_id")
                WHERE "team_id" IS NULL AND "user_id" IS NULL
            """,
            reverse_sql='DROP INDEX CONCURRENTLY IF EXISTS "insights_insightviewed_null_team_user_unique"',
        ),
    ]
