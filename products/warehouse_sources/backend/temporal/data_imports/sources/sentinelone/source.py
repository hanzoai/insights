...
class SentineloneSource(ResumableSource[SentineloneSourceConfig, SentinelOneResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your SentinelOne management console URL and an API token to pull your SentinelOne data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/sentinelone",
