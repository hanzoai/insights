...
from insights.models.file_system.user_product_list import DEFAULT_PRODUCT_PATHS, UserProductList
...
class TestUserProductListDefaults(BaseTest):
    ...
    def test_accepting_invite_adds_default_products_for_private_project_access(self):
        ...
        new_user = User.objects.create_user(email="newuser@hanzo.ai", password="password", first_name="New")
    ...
    def test_creating_team_adds_default_products_for_all_users_with_access(self):
        member = User.objects.create_user(email="member@hanzo.ai", password="password", first_name="Member")
        member.join(organization=self.organization)
        creator = User.objects.create_user(email="creator@hanzo.ai", password="password", first_name="Creator")
    ...
    def test_access_control_signal_adds_default_products(self):
        ...
        self._make_team_private(self.team)
        user = User.objects.create_user(email="signal@hanzo.ai", password="password", first_name="Signal")
