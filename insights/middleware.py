...
from insights.models import Action, Cohort, Dashboard, FeatureFlag, Insight, Team, User
...
from insights.utils import _is_valid_ip_address
    ...
    def __call__(self, request):
        ...
        if is_admin_view:
            ...
            csp_parts = [
                ...
                f"connect-src 'self' {resource_url} {connect_debug_url} https://raw.githubusercontent.com https://api.github.com",
