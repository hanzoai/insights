...
/**
 * Health-check signals are Insights-native instrumentation issues. They always carry a `kind`,
...
/** Severity → Tag tone for the header right slot. */
const SEVERITY_TAG_TYPE: Record<HealthCheckSignalExtraSeverityEnumApi, TagType> = {
    critical: 'danger',
    warning: 'warning',
    info: 'muted',
}
...
export function HealthCheckSignalCard({ signal }: SignalCardProps): JSX.Element {
    ...
    const severityTag = (
        <Tag size="small" type={SEVERITY_TAG_TYPE[extra.severity]}>
