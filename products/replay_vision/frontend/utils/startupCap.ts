...
export const STARTUP_CAP_EXPLANATION = `Startup credits are shared across all Insights products, so the startup program caps Replay vision spend at $${STARTUP_PROGRAM_BILLING_LIMIT_MAX.toLocaleString()} per month.`
