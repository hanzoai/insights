...
class UpPromoteSource(
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption=(
                ...
                "referrals, coupons, and payments into the Insights Data warehouse.\n\n"
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/uppromote",
            ...
            webhookSetupCaption=(
                "Insights subscribes to UpPromote's referral, affiliate, and payment webhook "
    ...
    def get_desired_webhook_events(
        ...
        # before a table was enabled; unmapped payloads are dropped by the script function.
