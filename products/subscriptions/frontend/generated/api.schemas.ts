...
export interface AIReportQueryDiagnosticApi {
    ...
    description: string
    /** The InsightsQL the assistant generated for this step. */
    insightsql: string
...
export interface SubscriptionDeliveryApi {
    ...
    /**
     * Per-step query diagnostics (generated InsightsQL + failure type) for this report. Null for non-AI deliveries or runs without persisted diagnostics.
     * @nullable
     */
