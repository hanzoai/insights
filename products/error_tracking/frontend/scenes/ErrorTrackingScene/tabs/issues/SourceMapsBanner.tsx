            ...
            <div className="mb-2">
                <div className="rounded-lg border border-border bg-bg-light pl-3 pr-4 py-3 mt-2">
                    <div className="flex items-center gap-4">
                        ...
                        <Button type="tertiary" size="small" to={SOURCE_MAPS_DOCS_URL} targetBlank>
                            Read docs
                        </Button>
                        <Button type="secondary" icon={<IconMagicWand />} onClick={() => openModal('issues_list')}>
                            <span className="rainbow-text rainbow-text-animating font-semibold">
                                Fix with AI wizard
                            </span>
                        </Button>
                        <Button size="xsmall" icon={<IconX />} onClick={dismiss} aria-label="Dismiss banner" />
                    </div>
                </div>
            </div>
            <SourceMapsFixModal />
