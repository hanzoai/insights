...
class TestListMCPSessions(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
    def setUp(self) -> None:
        super().setUp()
...
class TestGenerateIntentDigest(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
...
class TestActivityOverview(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
...
class TestGenerateSessionIntent(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
    def setUp(self) -> None:
        super().setUp()
        cache.clear()
...
class TestListMCPToolCalls(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
...
class TestSessionEventsLookbackBound(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
