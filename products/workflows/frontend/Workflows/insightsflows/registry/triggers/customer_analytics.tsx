...
import { accountCustomPropertyDefinitionsLogic } from 'products/workflows/frontend/Workflows/insightsflows/registry/triggers/accountCustomPropertyDefinitionsLogic'
import {
...
function StepTriggerConfigurationAccountCustomPropertyChanged({ node }: { node: any }): JSX.Element {
    ...
    return (
        <div className="flex flex-col gap-2 w-full">
            ...
            <Field.Pure label="Available in steps" help="Reference the change from any step, filter, or condition">
