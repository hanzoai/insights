...
import type { nonInsightsFunctionTemplatesLogicType } from './nonInsightsFunctionTemplatesLogicType'
...
export const nonInsightsFunctionTemplatesLogic = kea<nonInsightsFunctionTemplatesLogicType>([
    ...
    selectors({
        insightsFunctionTemplatesDataWarehouseSources: [
            ...
            (connectors, manualConnectors, featureFlags): InsightsFunctionTemplateType[] => {
