    ...
    return (
        <WidgetCardContent>
            <WidgetCardBodyMessage>
                ...
                >
                    <MascotExperiment className="size-20 shrink-0" />
                ...
                <ExperimentResultsWidgetMessage
                    ...
                    cta={
                        <Button
                            ...
                            targetBlank
                            onClick={() =>
                                insights.capture('dashboard widget create experiment clicked', {
            ...
            <div className="flex flex-col gap-3 p-2" data-attr="experiment-results-widget-body">
                <div className="flex items-center justify-between gap-2">
                    ...
                    <Link
                        ...
                        onClick={() =>
                            insights.capture('dashboard widget open experiment clicked', {
                                widget_type: 'experiment_results',
                                tile_id: tileId,
