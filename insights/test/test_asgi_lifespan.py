...
from insights.asgi import application
...
async def test_uvicorn_boots_insights_application_under_django_5() -> None:
    """Test that Insights ASGI application properly handles Django 5 lifespan events."""
