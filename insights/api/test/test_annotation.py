...
from insights.test.base import APIBaseTest, FuzzyInt, QueryMatchingTest, snapshot_postgres_queries_context
...
from insights.models import Annotation, Dashboard, Insight, Organization, Team, User


class TestAnnotation(APIBaseTest, QueryMatchingTest):
    @patch("insights.api.annotation.report_user_action")
