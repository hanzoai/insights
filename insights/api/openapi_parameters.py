...
Three semantics are easy to miss without reading insights/utils.py and
insights/api/insight_variable.py, so they're documented once here:
...
def make_variables_override_param(*, subject_label: str, tool_name: str) -> OpenApiParameter:
    ...
    Args:
        subject_label: e.g. "dashboard" or "the insight's InsightsQL" — appears as
