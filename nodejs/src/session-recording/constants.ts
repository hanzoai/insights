...
export const STREAM_CONSUMER_GROUP_ID = 'session-recordings-blob-v2'
export const STREAM_CONSUMER_GROUP_ID_OVERFLOW = 'session-recordings-blob-v2-overflow'
export const STREAM_CONSUMER_SESSION_TIMEOUT_MS = 90_000

// Re-export stream topics constants
export { STREAM_SESSION_RECORDING_SNAPSHOT_ITEM_EVENTS, STREAM_SESSION_RECORDING_SNAPSHOT_ITEM_OVERFLOW }
