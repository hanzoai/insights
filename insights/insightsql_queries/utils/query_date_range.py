...
from insights.schema import DateRange, IntervalType

from insights.insightsql.parser import ast

from insights.models.team import Team, WeekStartDay
from insights.queries.util import get_earliest_timestamp, get_trunc_func_ch
...
class QueryDateRangeWithIntervals(QueryDateRange):
    ...
    def get_start_of_interval_insightsql(self, *, source: ast.Expr = None) -> ast.Expr:
