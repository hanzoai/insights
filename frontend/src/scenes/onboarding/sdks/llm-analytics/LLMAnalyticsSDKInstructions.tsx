import { EmbeddingEvent } from '@hanzo/shared-onboarding/llm-analytics/_snippets/embedding-event'
import { GenerationEvent } from '@hanzo/shared-onboarding/llm-analytics/_snippets/generation-event'
import { NotableGenerationProperties } from '@hanzo/shared-onboarding/llm-analytics/_snippets/notable-generation-properties'
import { SpanEvent } from '@hanzo/shared-onboarding/llm-analytics/_snippets/span-event'
import { TraceEvent } from '@hanzo/shared-onboarding/llm-analytics/_snippets/trace-event'
import { AnthropicInstallation } from '@hanzo/shared-onboarding/llm-analytics/anthropic'
import { AutoGenInstallation } from '@hanzo/shared-onboarding/llm-analytics/autogen'
import { AzureOpenAIInstallation } from '@hanzo/shared-onboarding/llm-analytics/azure-openai'
import { CerebrasInstallation } from '@hanzo/shared-onboarding/llm-analytics/cerebras'
import { CohereInstallation } from '@hanzo/shared-onboarding/llm-analytics/cohere'
import { CrewAIInstallation } from '@hanzo/shared-onboarding/llm-analytics/crewai'
import { DeepSeekInstallation } from '@hanzo/shared-onboarding/llm-analytics/deepseek'
import { DSPyInstallation } from '@hanzo/shared-onboarding/llm-analytics/dspy'
import { FireworksAIInstallation } from '@hanzo/shared-onboarding/llm-analytics/fireworks-ai'
import { GoogleInstallation } from '@hanzo/shared-onboarding/llm-analytics/google'
import { GroqInstallation } from '@hanzo/shared-onboarding/llm-analytics/groq'
import { HeliconeInstallation } from '@hanzo/shared-onboarding/llm-analytics/helicone'
import { HuggingFaceInstallation } from '@hanzo/shared-onboarding/llm-analytics/hugging-face'
import { InstructorInstallation } from '@hanzo/shared-onboarding/llm-analytics/instructor'
import { LangChainInstallation } from '@hanzo/shared-onboarding/llm-analytics/langchain'
import { LangGraphInstallation } from '@hanzo/shared-onboarding/llm-analytics/langgraph'
import { LLMInstallation } from '@hanzo/shared-onboarding/llm-analytics/llm'
import { LlamaIndexInstallation } from '@hanzo/shared-onboarding/llm-analytics/llamaindex'
import { ManualInstallation } from '@hanzo/shared-onboarding/llm-analytics/manual'
import { MastraInstallation } from '@hanzo/shared-onboarding/llm-analytics/mastra'
import { MirascopeInstallation } from '@hanzo/shared-onboarding/llm-analytics/mirascope'
import { MistralInstallation } from '@hanzo/shared-onboarding/llm-analytics/mistral'
import { OllamaInstallation } from '@hanzo/shared-onboarding/llm-analytics/ollama'
import { OpenAIInstallation } from '@hanzo/shared-onboarding/llm-analytics/openai'
import { OpenAIAgentsInstallation } from '@hanzo/shared-onboarding/llm-analytics/openai-agents'
import { OpenRouterInstallation } from '@hanzo/shared-onboarding/llm-analytics/openrouter'
import { PerplexityInstallation } from '@hanzo/shared-onboarding/llm-analytics/perplexity'
import { PortkeyInstallation } from '@hanzo/shared-onboarding/llm-analytics/portkey'
import { PydanticAIInstallation } from '@hanzo/shared-onboarding/llm-analytics/pydantic-ai'
import { SemanticKernelInstallation } from '@hanzo/shared-onboarding/llm-analytics/semantic-kernel'
import { SmolagentsInstallation } from '@hanzo/shared-onboarding/llm-analytics/smolagents'
import { TogetherAIInstallation } from '@hanzo/shared-onboarding/llm-analytics/together-ai'
import { VercelAIInstallation } from '@hanzo/shared-onboarding/llm-analytics/vercel-ai'
import { VercelAIGatewayInstallation } from '@hanzo/shared-onboarding/llm-analytics/vercel-ai-gateway'
import { XAIInstallation } from '@hanzo/shared-onboarding/llm-analytics/xai'
