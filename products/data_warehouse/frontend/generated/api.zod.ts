...
export const InsightVariablesCreateBody = /* @__PURE__ */ zod.object({
    ...
    type: zod
        ...
        .describe(
            'Variable type. Controls how the value is rendered and substituted in InsightsQL.\n\n\* `String` - String\n\* `Number` - Number\n\* `Boolean` - Boolean\n\* `List` - List\n\* `Date` - Date'
        ),
...
export const warehouseSavedQueriesCreateBodyQueryKindDefault = `InsightsQLQuery`
...
export const WarehouseSavedQueriesCreateBody = /* @__PURE__ */ zod
    .object({
        ...
        name: zod
            ...
            .describe(
                'Unique name for the view. Used as the table name in InsightsQL queries and the node name in the data modeling Node.'
            ),
        query: zod
            .object({
                kind: zod.enum(['InsightsQLQuery']).default(warehouseSavedQueriesCreateBodyQueryKindDefault),
                query: zod.string(),
            })
            .describe(
                'InsightsQL query definition as a JSON object with a \"query\" key containing the SQL string and a \"kind\" key (always \"InsightsQLQuery\"). Format the SQL string multi-line with indentation and inline `--` comments for non-obvious logic — the SQL editor renders it verbatim, so avoid minified single-line SQL. Example: {\"kind\": \"InsightsQLQuery\", \"query\": \"SELECT\\n    event,\\n    count() AS cnt\\nFROM events\\nGROUP BY event\\nLIMIT 100\"}'
            ),
        description: zod
            .string()
            .nullish()
...
export const warehouseSavedQueriesUpdateBodyQueryKindDefault = `InsightsQLQuery`
...
export const WarehouseSavedQueriesUpdateBody = /* @__PURE__ */ zod
    .object({
        ...
        query: zod
            .object({
                kind: zod.enum(['InsightsQLQuery']).default(warehouseSavedQueriesUpdateBodyQueryKindDefault),
                query: zod.string(),
            })
            .describe(
                'InsightsQL query definition as a JSON object with a \"query\" key containing the SQL string and a \"kind\" key (always \"InsightsQLQuery\"). Format the SQL string multi-line with indentation and inline `--` comments for non-obvious logic — the SQL editor renders it verbatim, so avoid minified single-line SQL. Example: {\"kind\": \"InsightsQLQuery\", \"query\": \"SELECT\\n    event,\\n    count() AS cnt\\nFROM events\\nGROUP BY event\\nLIMIT 100\"}'
...
export const warehouseSavedQueriesPartialUpdateBodyQueryKindDefault = `InsightsQLQuery`
...
export const WarehouseSavedQueriesPartialUpdateBody = /* @__PURE__ */ zod
    .object({
        ...
        query: zod
            .object({
                kind: zod.enum(['InsightsQLQuery']).default(warehouseSavedQueriesPartialUpdateBodyQueryKindDefault),
                query: zod.string(),
            })
            .optional()
            .describe(
...
export const warehouseSavedQueriesAncestorsCreateBodyQueryKindDefault = `InsightsQLQuery`
...
export const WarehouseSavedQueriesAncestorsCreateBody = /* @__PURE__ */ zod
    .object({
        ...
        query: zod
            .object({
                kind: zod.enum(['InsightsQLQuery']).default(warehouseSavedQueriesAncestorsCreateBodyQueryKindDefault),
                query: zod.string(),
            })
            .describe(
                'InsightsQL query definition as a JSON object with a \"query\" key containing the SQL string and a \"kind\" key (always \"InsightsQLQuery\"). Format the SQL string multi-line with indentation and inline `--` comments for non-obvious logic — the SQL editor renders it verbatim, so avoid minified single-line SQL. Example: {\"kind\": \"InsightsQLQuery\", \"query\": \"SELECT\\n    event,\\n    count() AS cnt\\nFROM events\\nGROUP BY event\\nLIMIT 100\"}'
...
export const warehouseSavedQueriesCancelCreateBodyQueryKindDefault = `InsightsQLQuery`
...
export const WarehouseSavedQueriesCancelCreateBody = /* @__PURE__ */ zod
    .object({
        ...
        query: zod
            .object({
                kind: zod.enum(['InsightsQLQuery']).default(warehouseSavedQueriesCancelCreateBodyQueryKindDefault),
                query: zod.string(),
            })
            .describe(
                'InsightsQL query definition as a JSON object with a \"query\" key containing the SQL string and a \"kind\" key (always \"InsightsQLQuery\"). Format the SQL string multi-line with indentation and inline `--` comments for non-obvious logic — the SQL editor renders it verbatim, so avoid minified single-line SQL. Example: {\"kind\": \"InsightsQLQuery\", \"query\": \"SELECT\\n    event,\\n    count() AS cnt\\nFROM events\\nGROUP BY event\\nLIMIT 100\"}'
...
export const warehouseSavedQueriesDescendantsCreateBodyQueryKindDefault = `InsightsQLQuery`
...
export const WarehouseSavedQueriesDescendantsCreateBody = /* @__PURE__ */ zod
    .object({
        ...
        query: zod
            .object({
                kind: zod.enum(['InsightsQLQuery']).default(warehouseSavedQueriesDescendantsCreateBodyQueryKindDefault),
                query: zod.string(),
            })
            .describe(
                'InsightsQL query definition as a JSON object with a \"query\" key containing the SQL string and a \"kind\" key (always \"InsightsQLQuery\"). Format the SQL string multi-line with indentation and inline `--` comments for non-obvious logic — the SQL editor renders it verbatim, so avoid minified single-line SQL. Example: {\"kind\": \"InsightsQLQuery\", \"query\": \"SELECT\\n    event,\\n    count() AS cnt\\nFROM events\\nGROUP BY event\\nLIMIT 100\"}'
...
export const warehouseSavedQueriesMaterializeCreateBodyQueryKindDefault = `InsightsQLQuery`
...
export const WarehouseSavedQueriesMaterializeCreateBody = /* @__PURE__ */ zod
    .object({
        ...
        query: zod
            .object({
                kind: zod.enum(['InsightsQLQuery']).default(warehouseSavedQueriesMaterializeCreateBodyQueryKindDefault),
                query: zod.string(),
            })
            .describe(
                'InsightsQL query definition as a JSON object with a \"query\" key containing the SQL string and a \"kind\" key (always \"InsightsQLQuery\"). Format the SQL string multi-line with indentation and inline `--` comments for non-obvious logic — the SQL editor renders it verbatim, so avoid minified single-line SQL. Example: {\"kind\": \"InsightsQLQuery\", \"query\": \"SELECT\\n    event,\\n    count() AS cnt\\nFROM events\\nGROUP BY event\\nLIMIT 100\"}'
...
export const warehouseSavedQueriesRevertMaterializationCreateBodyQueryKindDefault = `InsightsQLQuery`
...
export const warehouseSavedQueriesRunCreateBodyQueryKindDefault = `InsightsQLQuery`
...
export const WarehouseSavedQueriesRunCreateBody = /* @__PURE__ */ zod
    .object({
        ...
        query: zod
            .object({
                kind: zod.enum(['InsightsQLQuery']).default(warehouseSavedQueriesRunCreateBodyQueryKindDefault),
                query: zod.string(),
            })
            .describe(
                'InsightsQL query definition as a JSON object with a \"query\" key containing the SQL string and a \"kind\" key (always \"InsightsQLQuery\"). Format the SQL string multi-line with indentation and inline `--` comments for non-obvious logic — the SQL editor renders it verbatim, so avoid minified single-line SQL. Example: {\"kind\": \"InsightsQLQuery\", \"query\": \"SELECT\\n    event,\\n    count() AS cnt\\nFROM events\\nGROUP BY event\\nLIMIT 100\"}'
...
export const warehouseSavedQueriesResumeSchedulesCreateBodyQueryKindDefault = `InsightsQLQuery`
...
export const WarehouseSavedQueryDraftsCreateBody = /* @__PURE__ */ zod.object({
    query: zod.unknown().optional().describe('InsightsQL query draft'),
...
export const WarehouseTablesCreateFromUploadCreateBody = /* @__PURE__ */ zod.object({
    ...
    table_name: zod.string().describe('Name the resulting table is queried by in InsightsQL.'),
})
...
export const WarehouseViewLinkCreateBody = /* @__PURE__ */ zod.object({
    ...
    source_table_key: zod
        ...
        .describe('Column or InsightsQL expression on the source table used as the join key.'),
    ...
    joining_table_key: zod
        ...
        .describe('Column or InsightsQL expression on the joining table used as the join key.'),
    field_name: zod
        .string()
