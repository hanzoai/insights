...
pub const PERSONFN_RESOLVE_ERRORS: &str = "prop_defs_personinsights_resolve_errors";
pub const PERSONFN_RESOLVE_DURATION: &str = "prop_defs_personinsights_resolve_duration_ms";
pub const PERSONFN_ERRORS_TOTAL: &str = "personinsights_errors_total";
pub const PERSONFN_RETRIES_TOTAL: &str = "personinsights_retries_total";
pub const PERSONFN_TERMINAL_ERRORS_TOTAL: &str = "personinsights_terminal_errors_total";
