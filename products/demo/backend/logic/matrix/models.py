...
# Refer to https://github.com/Insights/insights-ai-costs-app/tree/main/src/ai-cost-data for missing models
LLM_COSTS_BY_MODEL = {
...
class SimPerson(ABC):
    ...
    in_insights_id: Optional[UUID]  # Insights person ID (must be a UUID)
    country_code: str
    region: str
    city: str
    timezone: str
