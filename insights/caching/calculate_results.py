...
from insights.schema import CacheMissResponse, DashboardFilter

from insights.insightsql.constants import LimitContext

from insights.api.services.query import ExecutionMode, RawCachedQueryResponse, process_query_dict
from insights.datastore.query_tagging import get_team_query_tags, tag_queries
from insights.event_usage import AnalyticsProps
from insights.insightsql_queries.apply_dashboard_filters import resolve_effective_dashboard_filters
from insights.insightsql_queries.query_runner import get_query_runner_or_none, response_results_contain_models
...
def calculate_for_query_based_insight(
    ...
    *,
    ...
    from insights.caching.insight_result import InsightResult, NothingInCacheResult
    ...
    if isinstance(process_response, BaseModel):
        ...
        return InsightResult(
            ...
            insightsql=getattr(process_response, "insightsql", None),
