...
class HubplannerSource(ResumableSource[HubplannerSourceConfig, HubPlannerResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Hub Planner",
            caption="""Enter your Hub Planner API key to sync your resource-scheduling, project-planning and time-tracking data into the Insights Data warehouse.
...
Generate a **Read Only** API key in Hub Planner under **Settings → API** (admin access required).""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/hubplanner",
