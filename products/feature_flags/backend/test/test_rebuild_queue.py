...
def test_group_mapping_guard_skips_write_without_counting_failure(fake_redis):
    ...
    # The guard vetoed the write (e.g. personinsights lag would empty group_type_mapping):
...
def test_gauges_reflect_queue_and_circuit_state(fake_redis):
    ...
    age = REGISTRY.get_sample_value("insights_flag_definitions_rebuild_oldest_age_seconds")
    dead = REGISTRY.get_sample_value("insights_flag_definitions_rebuild_dead_letter_teams")
