...
from insights.models import SharePassword, SharingConfiguration
from insights.models.activity_logging.activity_log import ActivityLog
from insights.rate_limit import SharePasswordThrottle, SharePasswordVolumeThrottle
...
class TestSharePasswordAPI(APIBaseTest):
    ...
    @patch("insights.rate_limit.is_rate_limit_enabled")
