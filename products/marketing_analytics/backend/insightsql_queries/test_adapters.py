...
class TestMarketingAnalyticsAdapters(ClickhouseTestMixin, BaseTest):
    ...
    def setUpClass(cls):
        ...
        cls.test_data_configs = {
            ...
            "google_campaign": DataConfig(
                ...
                column_schema={
                    "campaign_id": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "campaign_name": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "campaign_status": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                },
            ),
            "google_stats": DataConfig(
                ...
                column_schema={
                    "campaign_id": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "segments_date": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "metrics_clicks": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "metrics_cost_micros": {
            ...
            "linkedin_campaigns": DataConfig(
                ...
                column_schema={
                    "id": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "name": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "type": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "locale": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "status": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "account": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "version": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "cost_type": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "unit_cost": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "account_id": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "created_time": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "daily_budget": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "run_schedule": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "campaign_group": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "campaign_group_id": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "last_modified_time": {
            ...
            "linkedin_stats": DataConfig(
                ...
                column_schema={
                    "clicks": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "follows": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "date_end": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "date_range": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "date_start": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "campaign_id": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "cost_in_usd": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "impressions": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "video_views": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "pivot_values": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "one_click_leads": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "total_engagements": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "video_completions": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "landing_page_clicks": {
                        "insightsql": "FloatDatabaseField",
                        "clickhouse": "Float64",
                        "schema_valid": True,
            ...
            "reddit_campaign": DataConfig(
                ...
                column_schema={
                    "id": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "name": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "app_id": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "goal_type": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "objective": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "spend_cap": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "created_at": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "goal_value": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "modified_at": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "ad_account_id": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "age_restriction": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "effective_status": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "configured_status": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
            ...
            "reddit_stats": DataConfig(
                ...
                column_schema={
                    "cpc": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "ctr": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "date": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "ecpm": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "hour": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "reach": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "spend": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "clicks": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "currency": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "frequency": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "campaign_id": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "impressions": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "video_started": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "conversion_roas": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "video_view_rate": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "app_install_revenue": {
                        "insightsql": "FloatDatabaseField",
                        "clickhouse": "Float64",
                        "schema_valid": True,
            ...
            "meta_campaigns": DataConfig(
                ...
                column_schema={
                    "id": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "account_id": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "name": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "status": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "effective_status": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "configured_status": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "objective": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "buying_type": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "budget_remaining": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "start_time": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "stop_time": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "created_time": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "updated_time": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "special_ad_categories": {
                        "insightsql": "StringDatabaseField",
                        "clickhouse": "String",
                        "schema_valid": True,
            ...
            "meta_campaign_stats": DataConfig(
                ...
                column_schema={
                    ...
                    "campaign_id": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "date_start": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "date_stop": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "impressions": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "clicks": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "unique_clicks": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "reach": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "frequency": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "spend": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "cpm": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "cpc": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "ctr": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "cpp": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "unique_ctr": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "cost_per_unique_click": {
                        "insightsql": "FloatDatabaseField",
                        "clickhouse": "Float64",
                        "schema_valid": True,
                    },
                    "actions": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "action_values": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
            ...
            "tiktok_campaigns": DataConfig(
                ...
                column_schema={
                    "advertiser_id": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "app_promotion_type": {
                        "insightsql": "StringDatabaseField",
                        "clickhouse": "String",
                        "schema_valid": True,
                    },
                    "bid_type": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "budget": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "budget_mode": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "budget_optimize_on": {
                        "insightsql": "StringDatabaseField",
                        "clickhouse": "String",
                        "schema_valid": True,
                    ...
                    "campaign_id": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "campaign_name": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "campaign_type": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "catalog_enabled": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "create_time": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "current_status": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "deep_bid_type": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    ...
                    "is_new_structure": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "is_search_campaign": {
                        "insightsql": "StringDatabaseField",
                        "clickhouse": "String",
                        "schema_valid": True,
                    ...
                    "modify_time": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "objective": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "objective_type": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "operation_status": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "optimization_goal": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "roas_bid": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "rta_bid_enabled": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "rta_id": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "rta_product_selection_enabled": {
                        "insightsql": "StringDatabaseField",
                        "clickhouse": "String",
                        "schema_valid": True,
                    },
                    "sales_destination": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "secondary_status": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
            ...
            "tiktok_campaign_report": DataConfig(
                ...
                column_schema={
                    ...
                    "billing_event": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "campaign_budget": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    ...
                    "comments": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "conversion": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "conversion_rate": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "conversion_rate_v2": {
                        "insightsql": "FloatDatabaseField",
                        "clickhouse": "Float64",
                        "schema_valid": True,
                    ...
                    "cost_per_result": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    ...
                    "ctr": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "currency": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "follows": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "frequency": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "gross_impressions": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "impressions": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "likes": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "profile_visits": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "profile_visits_rate": {
                        "insightsql": "FloatDatabaseField",
                        "clickhouse": "Float64",
                        "schema_valid": True,
                    ...
                    "real_time_result": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "real_time_result_rate": {
                        "insightsql": "FloatDatabaseField",
                        "clickhouse": "Float64",
                        "schema_valid": True,
                    },
                    "result": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "result_rate": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    ...
                    "shares": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "spend": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "split_test": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "stat_time_day": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "video_play_actions": {
                        "insightsql": "IntegerDatabaseField",
                        "clickhouse": "Int64",
                        "schema_valid": True,
                    },
                    "video_views_p100": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "video_views_p25": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "video_views_p50": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "video_views_p75": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "video_watched_2s": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "video_watched_6s": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                },
            ),
            "bing_campaigns": DataConfig(
                ...
                column_schema={
                    "id": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "name": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "status": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "budget_type": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "daily_budget": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "campaign_type": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "languages": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "time_zone": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                },
            ),
            "bing_campaign_performance_report": DataConfig(
                ...
                column_schema={
                    ...
                    "impressions": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "spend": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "conversions": {"insightsql": "IntegerDatabaseField", "clickhouse": "Int64", "schema_valid": True},
                    "currency_code": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "time_period": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True},
                    "average_cpc": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "ctr": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                    "conversion_rate": {"insightsql": "FloatDatabaseField", "clickhouse": "Float64", "schema_valid": True},
                },
            ),
    ...
    def _execute_and_snapshot(self, query: ast.SelectQuery | ast.SelectSetQuery) -> str:
        query_string = query.to_insightsql()
    ...
    def _execute_query_and_validate(self, query: ast.SelectQuery | ast.SelectSetQuery) -> list[tuple]:
        insightsql_query = query.to_insightsql()
        result = execute_insightsql_query(insightsql_query, self.team)
    ...
    def test_missing_csv_files_handling(self):
        ...
        self.test_data_configs["nonexistent_table"] = DataConfig(
            ...
            source_type="Test",
            bucket_suffix="test",
            column_schema={"test_col": {"insightsql": "StringDatabaseField", "clickhouse": "String", "schema_valid": True}},
        )
    ...
    def test_match_key_uses_campaign_id_when_configured(self):
        ...
        # Convert to InsightsQL to check the field used
        insightsql_query = query.to_insightsql()

        # Verify the match_key uses the id field, not the name field
        # The id field in Meta Ads is referenced as "metaads_campaigns.id"
        assert "metaads_campaigns.id" in insightsql_query, (
            f"match_key should use campaign id field (metaads_campaigns.id), but got: {insightsql_query}"
        )
        ...
        assert "AS match_key" in insightsql_query, "match_key alias should exist"
    ...
    def test_match_key_uses_campaign_name_by_default(self):
        ...
        assert "metaads_campaigns.name" in insightsql_query, (
            f"match_key should use campaign name field by default (metaads_campaigns.name), but got: {insightsql_query}"
        )
    ...
    def test_match_key_preference_per_integration(self):
        ...
        meta_insightsql = meta_query.to_insightsql()
        google_insightsql = google_query.to_insightsql()

        # Meta should use id field
        assert "metaads_campaigns.id" in meta_insightsql, f"MetaAds match_key should use id field, but got: {meta_insightsql}"

        # Google should use name field (default)
        assert "google_ads_campaign.campaign_name" in google_insightsql, (
            f"GoogleAds match_key should use campaign_name field by default, but got: {google_insightsql}"
        )
    ...
    def test_bigquery_build_query_with_nested_expressions(self):
        ...
        insightsql_query = query.to_insightsql()
        assert "granularity[1]" in insightsql_query
        assert "impressions" in insightsql_query
        assert "localSpend" in insightsql_query
    ...
    def test_self_managed_build_query_with_nested_expressions(self):
        ...
        insightsql_query = query.to_insightsql()
        assert "data[1]" in insightsql_query
    ...
    def test_source_field_with_constant_value(self):
        ...
        assert query is not None
        insightsql_query = query.to_insightsql()
        assert "toString('linkedin')" in insightsql_query
    ...
    def test_source_field_with_column_reference(self):
        ...
        assert query is not None
        insightsql_query = query.to_insightsql()
        assert "toString(utm_source)" in insightsql_query
    ...
    def test_cost_field_currency_handling(self, _name, currency_value, expected_in_query):
        ...
        assert query is not None
        insightsql_query = query.to_insightsql()
        assert "convertCurrency" in insightsql_query
        assert expected_in_query in insightsql_query
