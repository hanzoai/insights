...
from insights.models.feature_flag.feature_flag import FeatureFlagEvaluationTag
from insights.models.feature_flag.flags_cache import (
...
class TestServiceFlagsSignals(BaseTest):
    ...
    @patch("insights.tasks.feature_flags.update_team_service_flags_cache")
...
class TestServiceFlagsCeleryTasks(BaseTest):
    ...
    def test_update_team_service_flags_cache_task(self):
        ...
        from insights.tasks.feature_flags import update_team_service_flags_cache
...
class TestCacheStats(BaseTest):
    ...
    @patch("insights.storage.hypercache_manager.get_client")
    def test_get_cache_stats_basic(self, mock_get_client):
        """Test basic cache stats gathering with Redis pipelining."""
        from insights.models.feature_flag.flags_cache import get_cache_stats
        ...
        with patch("insights.models.team.team.Team.objects.count", return_value=5):
...
class TestGetTeamsWithExpiringCaches(BaseTest):
    ...
    @patch("insights.storage.cache_expiry_manager.time")
    ...
    def test_skips_teams_with_fresh_ttl(self, mock_time, mock_get_client):
        ...
        from insights.models.feature_flag.flags_cache import get_teams_with_expiring_flags_caches
...
class TestBatchOperations(BaseTest):
    ...
    @patch("insights.models.feature_flag.flags_cache.refresh_expiring_caches")
    ...
    def test_cleanup_stale_expiry_tracking(self, mock_get_client):
        ...
        from insights.models.feature_flag.flags_cache import FLAGS_CACHE_EXPIRY_SORTED_SET, cleanup_stale_expiry_tracking
    ...
    @patch("insights.storage.hypercache.time")
    def test_warm_without_stagger_tracks_expiry_with_default_ttl(self, mock_time, mock_get_client):
        ...
        from insights.storage.hypercache_manager import warm_caches
...
class TestManagementCommands(BaseTest):
    ...
    @patch("insights.management.commands.analyze_flags_cache_sizes._get_feature_flags_for_teams_batch")
    ...
    @patch("insights.storage.hypercache_manager.warm_caches")
    ...
    @patch("insights.models.feature_flag.flags_cache._get_feature_flags_for_teams_batch")
    ...
    def test_warm_batch_processing_with_failures(self):
        ...
        with patch(
            "insights.models.feature_flag.flags_cache.flags_hypercache.set_cache_value", side_effect=failing_set_cache
        ):
            out = StringIO()
    ...
    @patch("insights.models.feature_flag.flags_cache.update_flags_cache")
    ...
    def test_verify_cache_miss_detection_and_fix(self):
        ...
        from insights.models.feature_flag.flags_cache import clear_flags_cache
    ...
    def test_verify_cache_mismatch_detection_and_fix(self):
        ...
        from insights.models.feature_flag.flags_cache import update_flags_cache
    ...
    def test_verify_cache_detects_evaluation_tag_rename(self):
        ...
        from insights.models.feature_flag.flags_cache import update_flags_cache, verify_team_flags
    ...
    def test_verify_fix_failures_reported(self):
        ...
        with patch("insights.models.feature_flag.flags_cache.flags_hypercache.update_cache", return_value=False):
            out = StringIO()
            call_command("verify_flags_cache", f"--team-ids={self.team.id}", "--fix", stdout=out)
    ...
    @patch("insights.models.feature_flag.flags_cache.get_flags_from_cache")
    @patch("insights.models.feature_flag.flags_cache._get_feature_flags_for_teams_batch")
    ...
    def test_verify_batch_load_fallback(self):
        ...
        from insights.models.feature_flag.flags_cache import FLAGS_HYPERCACHE_MANAGEMENT_CONFIG
...
class TestVerifyFlagsCacheVerboseOutput(BaseTest):
    ...
    def test_verbose_unknown_diff_type_fallback(self):
        ...
        from insights.management.commands.verify_flags_cache import Command
