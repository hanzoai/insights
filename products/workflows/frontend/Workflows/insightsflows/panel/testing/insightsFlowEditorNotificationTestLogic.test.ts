...
describe('insightsFlowEditorNotificationTestLogic', () => {
    let logic: ReturnType<typeof insightsFlowEditorNotificationTestLogic.build>
    ...
    beforeEach(() => {
        ...
        logic = insightsFlowEditorNotificationTestLogic({ id: 'test-workflow-id' })
        logic.mount()
    })
    ...
    describe('persistence', () => {
        it('should persist emailAddressOverride, selectedPersonDistinctId, and sampleGlobals across unmount/remount', async () => {
            ...
            const newLogic = insightsFlowEditorNotificationTestLogic({ id: 'test-workflow-id' })
            newLogic.mount()
