...
import {
    checkFlowQuotaLimits,
    counterFlowQuotaLimited,
    shouldBlockFlowDueToQuota,
} from './flow-quota-limiting'

describe('Flow Quota Limiting', () => {
    ...
    describe('checkFlowQuotaLimits', () => {
        ...
        it('should not limit workflow when team has no quota limits', async () => {
            ...
            const result = await checkFlowQuotaLimits(flow, teamId, mockQuotaLimiting)
    ...
    describe('shouldBlockFlowDueToQuota', () => {
        ...
        beforeEach(() => {
            ...
            jest.spyOn(counterFlowQuotaLimited, 'labels').mockReturnValue({
                inc: jest.fn(),
            } as any)
        })
        ...
        it('should not block invocation when not quota limited', async () => {
            ...
            const item: CyclotronJobInvocationFlow = {
                ...baseItem,
                flow: {
                    ...baseItem.flow,
            ...
            const result = await shouldBlockFlowDueToQuota(item, {
            ...
            expect(counterFlowQuotaLimited.labels).not.toHaveBeenCalled()
        })
        ...
        it('should block invocation and emit metrics when quota limited', async () => {
            ...
            expect(counterFlowQuotaLimited.labels).toHaveBeenCalledWith({ team_id: teamId })
