...
from insights.schema import ActorsQuery, InsightsQLQuery
...
from insights.constants import LIMIT, OFFSET, PropertyOperatorType
from insights.event_usage import report_user_action
from insights.exceptions_capture import capture_exception
from insights.metrics import LABEL_TEAM_ID
from insights.models import Cohort, FeatureFlag, Person, User
...
from insights.models.cohort import DEFAULT_COHORT_INSERT_BATCH_SIZE, CohortOrEmpty
from insights.models.cohort.calculation_history import CohortCalculationHistory
from insights.models.cohort.cohort import REALTIME_COHORT_MAX_PERSON_COUNT, CohortType
from insights.models.cohort.util import get_all_cohort_dependencies, get_friendly_error_message, print_cohort_insightsql_query
from insights.models.cohort.validation import CohortTypeValidationSerializer
from insights.models.feature_flag.flag_matching import (
    FeatureFlagMatcher,
    FlagsMatcherCache,
...
from insights.models.person.sql import INSERT_COHORT_ALL_PEOPLE_THROUGH_PERSON_ID, PERSON_STATIC_COHORT_TABLE
from insights.models.property.property import Property, PropertyGroup
from insights.models.team.team import Team
from insights.models.utils import UUIDT
from insights.queries.actor_base_query import get_serialized_people
from insights.queries.base import property_group_to_Q
...
class CohortSerializer(serializers.ModelSerializer):
    ...
    def _handle_static(self, cohort: Cohort, context: dict, validated_data: dict, person_ids: list[str] | None) -> None:
        from insights.tasks.calculate_cohort import insert_cohort_from_feature_flag, insert_cohort_from_query
