...
class TestAlert(APIBaseTest, QueryMatchingTest):
    ...
    def test_delete_alert_cleans_up_custom_functions(self) -> None:
        creation_request = {
            "insight": self.insight["id"],
        ...
        linked_custom_function = CustomFunction.objects.create(
            team=self.team,
        ...
        unrelated_custom_function = CustomFunction.objects.create(
            team=self.team,
        ...
        linked_custom_function.refresh_from_db()
        assert linked_custom_function.deleted is True
        assert linked_custom_function.enabled is False

        unrelated_custom_function.refresh_from_db()
        assert unrelated_custom_function.deleted is False
        assert unrelated_custom_function.enabled is True
