    ...
    return [
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        We call DeepSeek through the OpenAI client and generate a response. We'll use Insights's OpenAI
                        ...
                        Insights client along with the DeepSeek config (the base URL and API key) to our OpenAI wrapper.
                    </Markdown>
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        Now, when you call DeepSeek with the OpenAI SDK, Insights automatically captures an
