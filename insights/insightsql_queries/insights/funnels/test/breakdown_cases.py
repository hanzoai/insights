...
from insights.constants import INSIGHT_FUNNELS, FunnelOrderType
from insights.insightsql_queries.insights.funnels.funnels_query_runner import FunnelsQueryRunner
from insights.insightsql_queries.insights.funnels.test.test_funnel_persons import get_actors, get_actors_legacy_filters
...
TEST_BUCKET = "test_storage_bucket-insights.insightsql_queries.insights.funnels.breakdown_cases"
...
def funnel_breakdown_test_factory(funnel_order_type: FunnelOrderType):
    class TestFunnelBreakdown(APIBaseTest):
        ...
        @also_test_with_materialized_columns(["$browser"])
        @skip('Using "Other" as a breakdown is not yet implemented in InsightsQL Actors Queries')
        ...
        def test_basic_funnel_default_funnel_days_breakdown_event(self):
            ...
            # See https://github.com/hanzoai/insights/pull/5496
            ...
            with freeze_time("2025-11-07"):
                ...
                self._assert_funnel_breakdown_result_is_correct(
                    ...
                    [
                        ...
                        FunnelStepResult(
                            name="insights_test_test_table_1.toUUID(user_id)",
                            count=1,
                            breakdown=["Chrome"],
                            type="data_warehouse",
                            action_id=None,
