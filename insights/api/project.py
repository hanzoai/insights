...
from insights.api.utils import validate_authorized_url_wildcards
...
from insights.models.group_type_mapping import cached_group_types_for_project
...
from insights.models.team.team import CURRENCY_CODE_CHOICES, Team
...
from insights.utils import get_instance_realm, get_ip_address, get_week_start_for_country_code
...
class ProjectBackwardCompatSerializer(
    ...
    class Meta:
        ...
        extra_kwargs = {
            ...
            "anonymize_ips": {"help_text": "When true, Insights drops the IP address from every ingested event."},
            "timezone": {
            ...
            "autocapture_opt_out": {"help_text": "Disables insights-js autocapture (clicks, page views) when true."},
            "autocapture_exceptions_opt_in": {
            ...
            "heatmaps_opt_in": {"help_text": "Enables heatmap recording on pages that host insights-js."},
            "surveys_opt_in": {"help_text": "Enables displaying surveys via insights-js on allowed origins."},
