...
import { isEmailAction, isPushAction } from './insightsflows/steps/types'
import type { InsightsFlow } from './insightsflows/types'
import { workflowLogic } from './workflowLogic'

// Each conversion is emitted as a `$workflows_conversion` Insights event carrying `$workflow_id`, so
...
> = {
    ...
    email_failed: {
        name: 'Failed',
        description:
            'Total number of emails that were not attempted to be sent. This typically indicates the Insights email service determined the email contained a virus.',
...
> = {
    ...
    // MX-validation skips log "Skipping send: …" at INFO (see InsightsFunctionHandler in the plugin server).
...
export interface workflowMetricsSummaryLogicMeta {
    ...
    __keaTypeGenInternalSelectorTypes: {
        ...
        emailActions: (workflow: InsightsFlow) => ({
            config: {
                inputs: Record<string, {
                    bytecode?: any;
                    order?: number | undefined;
        ...
        pushActions: (workflow: InsightsFlow) => ({
            config: {
                inputs: Record<string, {
                    bytecode?: any;
                    order?: number | undefined;
        ...
        messagingChannels: (workflow: InsightsFlow, appMetricsTrends: AppMetricsTimeSeriesResponse | null) => {
            hasEmail: boolean;
            hasPush: boolean;
        };
        sentSummaryLabel: (messagingChannels: {
            hasEmail: boolean;
            hasPush: boolean;
        }) => string;
        ...
        hasConversionGoal: (workflow: InsightsFlow) => boolean;
        ...
        , arg: string) => string;
        workflowSummaryTrends: (appMetricsTrends: AppMetricsTimeSeriesResponse | null, completedTrends: AppMetricsTimeSeriesResponse | null, metricNameBySummaryMetric: Record<WorkflowSummaryMetric, string>, getCompletedSingleTrendSeries: (name: string, previousPeriod?: boolean) => AppMetricsTimeSeriesResponse | null // appMetricsLogic
        , messagingChannels: {
            hasEmail: boolean;
            hasPush: boolean;
        }, sentSummaryLabel: string) => AppMetricsTimeSeriesResponse | null;
...
export const workflowMetricsSummaryLogic = kea<workflowMetricsSummaryLogicType>([
    ...
    selectors({
        ...
        emailActions: [
            (s) => [s.workflow],
            (workflow: import('./insightsflows/types').InsightsFlow) => workflow.actions.filter(isEmailAction),
        ],

        pushActions: [
            (s) => [s.workflow],
            (workflow: import('./insightsflows/types').InsightsFlow) => workflow.actions.filter(isPushAction),
        ],
        ...
        messagingChannels: [
            ...
            (
                workflow: import('./insightsflows/types').InsightsFlow,
        ...
        hasConversionGoal: [
            (s) => [s.workflow],
            (workflow: import('./insightsflows/types').InsightsFlow): boolean => {
