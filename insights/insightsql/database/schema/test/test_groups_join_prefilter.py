...
class TestGroupsJoinPrefilter(APIBaseTest):
    ...
    def _print(self, query: str) -> str:
        sql, _ = prepare_and_print_ast(parse_select(query), context=self.context, dialect="datastore")
        return sql
    ...
    @parameterized.expand(
        [
            ...
            # Table-qualified forms (`events.<alias>...`) are legal hand-written InsightsQL and name
