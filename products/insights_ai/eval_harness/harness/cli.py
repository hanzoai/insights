...
absorb parallel Datastore copies; ordinary local machines stay conservative."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m products.insights_ai.eval_harness.harness",
        description=(
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Force a rebuild of the insights-sandbox-base image before the run (docker only).",
    )
    parser.add_argument(
