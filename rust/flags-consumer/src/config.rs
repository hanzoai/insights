...
pub struct Config {
    // ── Database ──────────────────────────────────────────────────────────
    #[envconfig(default = "postgres://insights:insights@localhost:5432/flags_read_store")]
    ...
    #[envconfig(default = "datastore_person")]
    pub kafka_person_topic: String,

    #[envconfig(default = "datastore_person_distinct_id")]
...
impl Config {
    ...
    /// Build the consumer config for the `datastore_person` topic.
    ...
    /// Build the consumer config for the `datastore_person_distinct_id` topic.
...
mod tests {
    ...
    fn test_config() -> Config {
        Config {
            ...
            kafka_person_topic: "datastore_person".to_string(),
            kafka_person_distinct_id_topic: "datastore_person_distinct_id".to_string(),
            batch_size: 500,
