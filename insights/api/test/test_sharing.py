...
from insights.api.sharing import _log_share_password_attempt, shared_url_as_png
from insights.constants import AvailableFeature
from insights.models import ActivityLog, ExportedAsset
...
class TestSharing(APIBaseTest):
    ...
    @patch("insights.api.exports.exporter.export_asset.delay")
    @patch("insights.models.exported_asset.object_storage.get_presigned_url")
...
class TestExportCacheKeyFlow(APIBaseTest):
    ...
    @patch("insights.api.insight.fetch_cached_response_by_key")
