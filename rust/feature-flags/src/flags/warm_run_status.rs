...
/// ("insights:1:" in our config), so the Django-relative keys are
/// `feature_flags/warm_run/status` and `feature_flags/warm_run/cancel`.
pub const WARM_RUN_STATUS_KEY: &str = "insights:1:feature_flags/warm_run/status";
pub const WARM_RUN_CANCEL_KEY: &str = "insights:1:feature_flags/warm_run/cancel";
