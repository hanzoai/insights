...
export const FEATURE_SUPPORT: Record<Feature, PlatformSupportConfig> = {
    errorTrackingExceptionAutocapture: {
        ...
        ios: {
            ...
            note: (
                <>
                    <Link to="https://hanzo.ai/docs/error-tracking/installation/ios#set-up-exception-autocapture">
    ...
    sessionReplayLogCapture: {
        android: {
            ...
            note: (
                <>
                    <Link to="https://hanzo.ai/docs/session-replay/console-log-recording?tab=Android">
        ...
        ios: {
            ...
            note: (
                <>
                    <Link to="https://hanzo.ai/docs/session-replay/console-log-recording?tab=iOS">
        ...
        reactNative: {
            ...
            note: (
                <>
                    <Link to="https://hanzo.ai/docs/session-replay/console-log-recording?tab=React+Native">
    ...
    sessionReplayCaptureRequests: {
        android: {
            ...
            note: (
                <>
                    <Link to="https://hanzo.ai/docs/session-replay/network-recording?tab=Android">
        ...
        ios: {
            ...
            note: (
                <>
                    <Link to="https://hanzo.ai/docs/session-replay/network-recording?tab=iOS">
        ...
        reactNative: {
            ...
            note: (
                <>
                    <Link to="https://hanzo.ai/docs/session-replay/network-recording?tab=React+Native">
