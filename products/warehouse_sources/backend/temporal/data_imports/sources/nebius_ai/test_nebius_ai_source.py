...
class TestNebiusAISourceConfig:
    ...
    def test_docs_url_matches_published_doc_slug(self) -> None:
        # docsUrl must match the hanzo.ai doc filename so the docs link resolves.
        assert NebiusAISource().get_source_config.docsUrl == "https://hanzo.ai/docs/cdp/sources/nebius-ai"
