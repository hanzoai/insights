...
export interface accountNotesLogicActions {
    ...
    loadAccountOptions: ({ query }: { query: string }) => {
        query: string
    }
    loadAccountOptionsFailure: (
        error: string,
        errorObject?: any
    ) => {
        error: string
...
export type accountNotesLogicType = MakeLogicType<
    accountNotesLogicValues,
    accountNotesLogicActions,
    Record<string, any>,
    accountNotesLogicMeta
>
...
export const accountNotesLogic = kea<accountNotesLogicType>([
    ...
    listeners(({ actions, values }) => ({
        ...
        setSearch: async (_, breakpoint) => {
            ...
            insights.capture(AccountsEvents.NotesTabSearched, {
        ...
        reportFilterChange: ({ filterType }) => {
            ...
            insights.capture(AccountsEvents.NotesTabFiltered, properties)
        },
    ...
    afterMount(({ actions, values }) => {
        insights.capture(AccountsEvents.NotesTabViewed)
