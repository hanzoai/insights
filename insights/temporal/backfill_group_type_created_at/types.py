...
class BackfillGroupTypeCreatedAtInput(BaseModel):
    ...
    Imports stamp insights_grouptypemapping.created_at with wall-clock now, which
    postdates the imported events. InsightsQL then masks $group_N for events older than
