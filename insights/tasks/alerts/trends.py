...
from insights.schema import FunnelsQuery, IntervalType, TrendsAlertConfig, TrendsQuery

from insights.caching.insight_result import InsightResult
from insights.insightsql_queries.insights.utils.breakdowns import has_breakdown_filter
from insights.tasks.alerts.utils import NON_TIME_SERIES_DISPLAY_TYPES
