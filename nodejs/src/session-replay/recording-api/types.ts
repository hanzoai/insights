...
import {
    ...
    KAFKA_DATASTORE_SESSION_REPLAY_FEATURES,
...
/**
 * Recording API's outputs are Datastore-bound deletion tombstones on the warpstream-replay
...
export function getDefaultRecordingApiOutputsConfig(): RecordingApiOutputsConfig {
    return {
        RECORDING_API_OUTPUT_REPLAY_EVENTS_TOPIC: KAFKA_DATASTORE_SESSION_REPLAY_EVENTS,
        RECORDING_API_OUTPUT_REPLAY_EVENTS_PRODUCER: INGESTION_SESSIONREPLAY_PRODUCER,
        RECORDING_API_OUTPUT_SESSION_FEATURES_TOPIC: KAFKA_DATASTORE_SESSION_REPLAY_FEATURES,
