        ...
        .array(
            zod.object({
                ...
                expression: zod
                    ...
                    .optional()
                    .describe(
                        "Only meaningful for `type: custom`: a source-prefixed shorthand (`attributes.<key>`, `resource_attributes.<key>`, `body.<json.path>`) or a scalar InsightsQL expression, sent verbatim in the logs query's `customColumns`."
                    ),
                width: zod
                    .number()
                    .min(1)
