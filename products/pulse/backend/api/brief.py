...
class BriefSectionSerializer(serializers.Serializer):
    ...
    citations = BriefSectionCitationSerializer(many=True, help_text="Insights resources this section cites as evidence.")
...
class BriefConfigViewSet(TeamAndOrgViewSetMixin, viewsets.ModelViewSet):
    ...
    insights_feature_flag = PULSE_FEATURE_FLAG
