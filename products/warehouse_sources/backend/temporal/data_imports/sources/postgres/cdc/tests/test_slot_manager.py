...
class TestIsSlotInvalidationError:
        ...
        [
            (
                ...
                psycopg.errors.ObjectNotInPrerequisiteState(
                    'can no longer get changes from replication slot "insights_019e51352190"\n'
            ...
            (
                "slot_dropped",
                psycopg.errors.UndefinedObject('replication slot "insights_019e51352190" does not exist'),
                True,
            ),
            (
    ...
    def test_detects_error_in_exception_chain(self):
        cause = psycopg.errors.ObjectNotInPrerequisiteState(
            'can no longer get changes from replication slot "insights_x"'
        )
