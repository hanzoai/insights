...
class FusionAuthSource(ResumableSource[FusionAuthSourceConfig, FusionAuthResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your FusionAuth instance's base URL and an API key to pull your FusionAuth data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/fusionauth",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
