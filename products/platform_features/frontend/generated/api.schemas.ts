...
export interface StaticFiltersApi {
    ...
    /** API clients that have generated activity (from x-insights-client header). */
...
export type AdvancedActivityLogsListParams = {
    ...
    activities?: string[]
    /**
     * Filter by API clients that generated the activity (from x-insights-client header).
     */
    clients?: string[]
    /**
    ...
    end_date?: string
    /**
     * Reserved for future InsightsQL-based filtering.
     */
    insightsql_filter?: string
    /**
