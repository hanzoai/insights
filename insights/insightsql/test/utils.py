...
from insights.test.base import clean_varying_query_parts
...
def execute_insightsql_query_with_timings(*args, **kwargs):
    modifiers = kwargs.get("modifiers") or InsightsQLQueryModifiers()
