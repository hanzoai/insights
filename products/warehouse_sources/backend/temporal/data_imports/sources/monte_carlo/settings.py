...
ALERTS_QUERY = """
query InsightsGetAlerts($first: Int!, $after: String, $createdTime: DateTimeRangeInput, $updatedTime: DateTimeRangeInput) {
...
MONITORS_QUERY = """
query InsightsGetMonitors($limit: Int!, $offset: Int!) {
...
TABLES_QUERY = """
query InsightsGetTables($first: Int!, $after: String) {
...
USERS_QUERY = """
query InsightsGetUsers($first: Int!, $after: String) {
...
query InsightsValidateCredentials {
  getUser { email }
}
"""
