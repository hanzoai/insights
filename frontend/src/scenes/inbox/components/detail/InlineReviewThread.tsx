        ...
        <div className={`flex gap-2.5 px-3 py-2.5 ${sending ? 'opacity-60' : ''}`}>
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-1">
                <div className="flex min-w-0 items-center gap-x-2 text-xs text-tertiary">
                    ...
                    <div className="ml-auto flex items-center gap-0.5">
                        ...
                        {isMine && !comment.pending && !editing && (
                            ...
                            >
                                <Button size="xsmall" icon={<IconEllipsis />} tooltip="Comment actions" />
                            </Menu>
                        )}
                    </div>
                </div>
                {editing ? (
                    ...
                    <Markdown className="text-[0.8125rem] leading-relaxed text-primary break-words" disableImages>
                        {comment.body}
                    </Markdown>
                ) : (
    ...
    return (
        <div className="flex flex-col gap-1.5">
            ...
            <div className="flex items-center justify-end gap-1.5">
                <Button type="tertiary" size="xsmall" onClick={onCancel}>
                    Cancel
                </Button>
                <Button
                    type="primary"
