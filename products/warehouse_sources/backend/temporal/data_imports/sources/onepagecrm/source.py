...
class OnepagecrmSource(ResumableSource[OnepagecrmSourceConfig, OnepagecrmResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your OnePageCRM API credentials to pull your CRM data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/onepagecrm",
