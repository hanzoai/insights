...
class TestMappings(DatastoreTestMixin, BaseTest):
    ...
    def test_find_case_insensitive_function(self):
        ...
        self.assertEqual(self._get_insightsql_function("RAND").datastore_name, "rand")
    ...
    def test_to_float_or_default_with_integer_default(self):
        # Datastore's toFloat64OrDefault requires the default to be Float64;
    ...
    def test_to_float_or_default_single_arg(self):
        ...
        # preserved so saved InsightsQL queries written before #58714 keep working.
        response = execute_insightsql_query(
    ...
    def test_to_int_or_default_function_mapping(self):
        ...
        # Datastore: the Int64 default cast lets an integer default literal work, and empty /
