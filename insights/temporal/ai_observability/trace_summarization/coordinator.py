...
with temporalio.workflow.unsafe.imports_passed_through():
    from insights.temporal.ai_observability.coordinator_metrics import (
    ...
    from insights.temporal.ai_observability.team_discovery import (
...
class BatchTraceSummarizationCoordinatorWorkflow(InsightsWorkflow):
    ...
    async def run(self, inputs: BatchTraceSummarizationCoordinatorInputs) -> CoordinatorResult:
        ...
        # re-running expensive Datastore queries.
