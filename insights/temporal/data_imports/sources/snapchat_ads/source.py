...
from insights.temporal.data_imports.pipelines.pipeline.typings import SourceInputs, SourceResponse
from insights.temporal.data_imports.sources.common.base import FieldType, SimpleSource
from insights.temporal.data_imports.sources.common.mixins import OAuthMixin
from insights.temporal.data_imports.sources.common.registry import SourceRegistry
from insights.temporal.data_imports.sources.common.schema import SourceSchema
from insights.temporal.data_imports.sources.generated_configs import SnapchatAdsSourceConfig
from insights.temporal.data_imports.sources.snapchat_ads.settings import SNAPCHAT_ADS_CONFIG
from insights.temporal.data_imports.sources.snapchat_ads.snapchat_ads import snapchat_ads_source
...
class SnapchatAdsSource(SimpleSource[SnapchatAdsSourceConfig], OAuthMixin):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Snapchat Ads",
            caption="Collect campaign data, ad performance, and advertising metrics from Snapchat Ads. Ensure you have granted Insights access to your Snapchat Ads account, learn how to do this in [the documentation](https://hanzo.ai/docs/cdp/sources/snapchat-ads).",
            betaSource=True,
            unreleasedSource=True,
            featureFlag="snapchat-ads-source",
            iconPath="/static/services/snapchat.png",
            docsUrl="https://hanzo.ai/docs/cdp/sources/snapchat-ads",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
