...
describe('getDataWarehouseItemWithFieldDefaults', () => {
    ...
    it('prefers person_distinct_ids.person_id from joined fields for aggregation target defaults', () => {
        const warehouseItem = getDataWarehouseItemWithFieldDefaults({
            ...
            fields: {
                ...baseTable.fields,
                person_id: { name: 'person_id', insightsql_value: 'person_id', type: 'string', schema_valid: true },
                person_distinct_ids: {
                    name: 'person_distinct_ids',
                    insightsql_value: 'person_distinct_ids',
                    type: 'lazy_table',
                    schema_valid: true,
    ...
    const distinctIdCases: FieldDefaultCase[] = [
        ...
        },
        {
            ...
            fields: {
                ...baseTable.fields,
                user_uuid: { name: 'User_ID', insightsql_value: 'User_ID', type: 'string', schema_valid: true },
            },
            expected: 'User_ID',
        },
    ]
    ...
    const timestampCases: FieldDefaultCase[] = [
        ...
        },
        {
            ...
            fields: {
                id: { name: 'id', insightsql_value: 'id', type: 'integer', schema_valid: true },
                createdAt: { name: 'CreatedAt', insightsql_value: 'CreatedAt', type: 'string', schema_valid: true },
            },
            expected: 'CreatedAt',
        },
    ]
