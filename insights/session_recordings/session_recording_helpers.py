...
from insights.metrics import LABEL_RESOURCE_TYPE
from insights.session_recordings.models.metadata import SessionRecordingEventSummary
from insights.utils import flatten
