            ...
            <div className="flex flex-col justify-center items-center p-6 bg-surface-primary rounded m-6 gap-2 max-w-120 shadow-sm">
                ...
                <div className="text-secondary text-sm text-center">
                    {isMissingFullSnapshot
                        ? 'This part of the recording is missing the snapshot data needed to render it. The data never reached Insights, usually because the browser was closed or went offline before the recording finished uploading.'
                        : isUnauthorized
                ...
                {isUnauthorized && (
                    <Button to={urls.login()} type="primary" fullWidth center>
                        Sign in
                    </Button>
                )}
