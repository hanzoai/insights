...
from insights.api.capture import CaptureInternalError, capture_batch_internal, capture_internal
...
class TestCaptureInternal(BaseTest):
    ...
    @patch("insights.api.capture.Session")
    ...
    def test_capture_internal_replay(self, mock_session_class):
        ...
        test_replay_props = {
            ...
            "$screen_width": 1080,
            "$app_version": "1.0",
            "$app_namespace": "com.insights.android.sample",
            "$app_build": 1,
