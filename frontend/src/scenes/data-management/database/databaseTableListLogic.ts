...
export interface databaseTableListLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        ...
        insightsTables: (allInsightsTables: DatabaseSchemaTable[], connectionId: string | null) => DatabaseSchemaTable[]
...
export const databaseTableListLogic = kea<databaseTableListLogicType>([
        ...
        database: [
            null as Required<DatabaseSchemaQueryResponse> | null,
            {
                loadDatabase: async ({
                    ...
                    const requestKey = requestConnectionId ?? '__insights__'
    ...
    selectors({
        ...
        insightsTables: [
            (s) => [s.allInsightsTables, s.connectionId],
            (allInsightsTables: DatabaseSchemaTable[], connectionId: string | null): DatabaseSchemaTable[] => {
                if (connectionId) {
                    return []
                }
