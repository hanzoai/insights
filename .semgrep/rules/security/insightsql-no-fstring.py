...
# ============================================================================
# insightsql-injection-taint: SHOULD FIND (user data interpolated into f-strings)
# ============================================================================


class TestTaintVulnerable:
    def test_query_field_in_fstring(self):
        # ruleid: insightsql-injection-taint, insightsql-fstring-audit
    ...
    def test_series_math_in_fstring(self):
        # ruleid: insightsql-injection-taint, insightsql-fstring-audit
        parse_expr(f"SELECT {self.series.math_insightsql}")

    def test_indirect_fstring_flow(self):
        query = f"field = {self.query.expression}"
        # ruleid: insightsql-injection-taint
        parse_expr(query)


# ============================================================================
# insightsql-injection-taint: SHOULD NOT FIND (safe patterns)
# ============================================================================


class TestTaintSafe:
    def test_entire_expression_direct(self):
        # Safe: user provides entire InsightsQL expression (no context to escape)
        # ok: insightsql-injection-taint
    ...
    def test_series_math_direct(self):
        # ok: insightsql-injection-taint
        parse_expr(self.series.math_insightsql)
...
# ============================================================================
# insightsql-fstring-audit: SHOULD FIND (vulnerable patterns)
# ============================================================================
...
class TestFstringVulnerable:
    def test_unknown_var_parse_expr(self):
        ...
        # ruleid: insightsql-fstring-audit
...
# ============================================================================
# insightsql-fstring-audit: SHOULD NOT FIND - Step/Latest/Exclusion prefixes
# ============================================================================
...
# ============================================================================
# insightsql-fstring-audit: SHOULD NOT FIND - .pk and table_alias
# ============================================================================
...
# ============================================================================
# insightsql-fstring-audit: SHOULD NOT FIND - Loop indices {i}, {index}
# ============================================================================
...
# ============================================================================
# insightsql-fstring-audit: SHOULD NOT FIND - Funnel step integers
# ============================================================================
...
# ============================================================================
# insightsql-fstring-audit: SHOULD NOT FIND - Array indexing [{var}]
# ============================================================================
...
# ============================================================================
# insightsql-fstring-audit: SHOULD NOT FIND - Internal constants
# ============================================================================
...
# ============================================================================
# insightsql-fstring-audit: SHOULD NOT FIND - Computed SQL fragments
# ============================================================================
...
# ============================================================================
# insightsql-fstring-audit: SHOULD NOT FIND - Funnel computed values
# ============================================================================
...
# ============================================================================
# insightsql-fstring-audit: SHOULD NOT FIND - Interval/time patterns
# ============================================================================
...
# ============================================================================
# insightsql-fstring-audit: SHOULD NOT FIND - Method calls
# ============================================================================
...
# ============================================================================
# insightsql-fstring-audit: SHOULD NOT FIND - int() conversion
# ============================================================================
...
# ============================================================================
# insightsql-fstring-audit: SHOULD NOT FIND - Limit/offset/count
# ============================================================================
...
# ============================================================================
# insightsql-fstring-audit: SHOULD NOT FIND - Computed expressions
# ============================================================================
...
# ============================================================================
# insightsql-fstring-audit: SHOULD NOT FIND - Date filter patterns
# ============================================================================
...
# ============================================================================
# insightsql-fstring-audit: SHOULD NOT FIND - Inline ternary
# ============================================================================
...
# ============================================================================
# insightsql-injection-taint: SHOULD FIND - Nested self attribute access
# ============================================================================
...
# ============================================================================
# insightsql-injection-taint: SHOULD NOT FIND - Nested attr (sanitized / excluded)
# ============================================================================
