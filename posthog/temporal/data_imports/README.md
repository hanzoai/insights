...
More info on what partitioning options and the different modes can be found here: https://github.com/Insights/posthog/blob/master/posthog/temporal/data_imports/sources/README.md#partitioning
