...
describe('Dashboards', { concurrent: false }, () => {
    ...
    describe('dashboard-create tool', () => {
        ...
        it('should create a dashboard with minimal fields', async () => {
            ...
            expect(dashboardData._insightsUrl).toContain('/dashboard/')
    ...
    describe('dashboard-reorder-tiles tool', () => {
        ...
        it('should reorder tiles on a dashboard', async () => {
            ...
            expect(reorderResponse._insightsUrl).toContain('/dashboard/')
    ...
    describe('dashboard widget tools', () => {
        ...
        it('dashboard-widgets-batch-add and dashboard-widgets-run workflow', async () => {
            ...
            expect(batchResponse._insightsUrl).toContain(`/dashboard/${dashboard.id}`)
            ...
            expect(runResponse._insightsUrl).toContain(`/dashboard/${dashboard.id}`)
