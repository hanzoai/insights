...
class AirOpsSource(SimpleSource[AirOpsSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your AirOps workspace API key to sync your AirOps apps and their executions into the Insights Data warehouse.
...
You can create a workspace API key in your [AirOps workspace settings](https://app.airops.com). Regenerating the key immediately invalidates the previous one.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/airops",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
