...
describe('SqlLineGraph', () => {
    ...
    describe('legend', () => {
        ...
        it('renders no legend by default', async () => {
            ...
            await screen.findByLabelText(/chart with 2 data series/i)
            expect(container.querySelector('[data-attr="script-chart-timeseries-line-legend"]')).not.toBeInTheDocument()
        })
    ...
    describe('custom series label', () => {
        const legendText = (): string =>
            document.querySelector('[data-attr="script-chart-timeseries-line-legend"]')?.textContent ?? ''
