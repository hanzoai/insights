...
from insights.api.file_system.deletion import ModelRegistration, get_file_system_registration
...
def _is_access_controlled_type(file_system_type: str) -> bool:
    ...
    to an access level at all (folders, SQL views, script functions etc. have no access controls)."""
