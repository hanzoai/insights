...
from insights.settings import CLICKHOUSE_DATABASE, CLICKHOUSE_HTTP_URL, CLICKHOUSE_PASSWORD, CLICKHOUSE_USER
from insights.settings.data_stores import CLICKHOUSE_MIGRATIONS_CLUSTER

MIGRATIONS_PACKAGE_NAME = "insights.clickhouse.migrations"
