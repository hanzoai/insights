...
const meta: Meta<TaxonomicFilterProps> = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'Taxonomic Filter allows users to select from various categories of data in Insights, like events, actions, properties, etc.',
            },
        },
    },
    tags: ['autodocs'],
...
export const MCPToolCallContextLeadsWithMCPProperties: Story = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                story: 'When the picker is scoped to $mcp_tool_call, the known @hanzo/mcp schema is separated into a leading "MCP properties" group, and SuggestedFilters leads with the tool name (the event\'s primary property) and error state. Without an $mcp_* event in scope the group disappears entirely.',
            },
        },
    },
}
