...
export function HealthAlertsScene(): JSX.Element {
    ...
    return (
        <SceneContent>
            <SceneTitleSection
                name="Health alerts"
                description="Get notified when a Insights health check fires or recovers. Pick a destination (Slack, Discord, Teams, email, or webhook) and the kinds of checks you care about."
