...
SANDBOX_NODE_MODULES_ROOT = "/scripts/node_modules/@insights"
...
def get_local_insights_code_packages() -> tuple[LocalPackage, ...] | None:
    """Return local @hanzo/{agent,shared,git} packages, or None.
