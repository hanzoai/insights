...
These tests are intentionally light on Django/Datastore and heavy on the
...
from insights.api.embedding_worker import EmbeddingResponse
...
# Corpus queries (Datastore-backed) ---------------------------------------


class TestCorpusQueries(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, BaseTest):
    """End-to-end coverage of the Datastore corpus queries behind the v2 pipeline."""
    ...
    def test_advertised_catalog_is_bounded_per_list_and_per_session(self) -> None:
        ...
        # advertised-catalog aggregation arbitrarily large in Datastore memory.
    ...
    def test_corpus_queries_are_not_truncated_at_the_default_insightsql_limit(self) -> None:
