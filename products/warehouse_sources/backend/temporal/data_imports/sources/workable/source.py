...
class WorkableSource(ResumableSource[WorkableSourceConfig, WorkableResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Workable account subdomain and an SPI access token to pull your Workable recruiting data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/workable",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
