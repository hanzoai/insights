...
describe('insightsFunctionHclExporter test', () => {
    describe('sanitizes correctly', () => {
        const testCases = [
            ...
            { input: '', expected: 'insights_function_new' },
        ]
    ...
    "properties": [
      {
        ...
        it('includes import block for saved custom functions by default', () => {
            ...
            const result = generateInsightsFunctionHCL(insightsFunction, { projectId: 1 })
            const hcl = result.hcl
    ...
    describe('strips server-computed fields', () => {
        ...
        describe('stripMappingsServerFields', () => {
            it('strips inputs and filters within each mapping', () => {
                ...
                ] as InsightsFunctionMappingType[]
