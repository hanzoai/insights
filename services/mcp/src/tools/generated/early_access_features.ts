...
const earlyAccessFeatureCreate = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.EarlyAccessFeatureSerializerCreateOnly>
> => ({
...
const earlyAccessFeatureList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedEarlyAccessFeatureList>
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof EarlyAccessFeatureListSchema>) => {
        ...
        return await withInsightsUrl(context, result, '/early_access_features')
    },
})
...
const earlyAccessFeaturePartialUpdate = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.EarlyAccessFeature>
> => ({
