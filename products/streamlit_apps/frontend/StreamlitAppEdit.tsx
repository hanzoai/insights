...
import { Button, Input, Select, TextArea } from '@hanzo/elements'
        ...
        <div>
            ...
            <div className="max-w-xl space-y-6">
                <div className="space-y-2">
                    <Label htmlFor="streamlit-app-name">Name</Label>
                    <Input id="streamlit-app-name" value={name} onChange={setName} placeholder="My app" />
                </div>

                <div className="space-y-2">
                    <Label htmlFor="streamlit-app-description">Description</Label>
                    <TextArea
                ...
                <div className="space-y-2">
                    <Label>{isNew ? 'Upload' : 'Upload new version'}</Label>
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex gap-4">
                        <div className="flex-1 space-y-1">
                            ...
                            <Select value={cpuCores} onChange={setCpuCores} options={CPU_OPTIONS} fullWidth />
                        </div>
                        <div className="flex-1 space-y-1">
                            <span className="text-sm text-muted">Memory</span>
                            <Select value={memoryGb} onChange={setMemoryGb} options={MEMORY_OPTIONS} fullWidth />
                        </div>
                    </div>
                </div>
                ...
                <div className="flex justify-between pt-4">
                    ...
                    <div className="flex gap-2">
                        <Button type="secondary" to={urls.streamlitApps()}>
                            Cancel
                        </Button>
                        <Button
                            type="primary"
