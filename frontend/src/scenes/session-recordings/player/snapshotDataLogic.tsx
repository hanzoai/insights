...
import { keyForSource } from '@hanzo/replay-shared'
import { SnapshotSourceType, SnapshotStore, SourceLoadingState } from '@hanzo/replay-shared'
...
export interface snapshotDataLogicMeta {
    ...
    __keaTypeGenInternalSelectorTypes: {
        ...
        snapshotsLoaded: (snapshotSources: import("@hanzo/replay-shared").SessionRecordingSnapshotSource[] | null) => boolean;
        isLoadingSnapshots: (loadingSources: Pick<import("@hanzo/replay-shared").SessionRecordingSnapshotSource, "blob_key" | "end_timestamp" | "source" | "start_timestamp">[]) => boolean;
        allSourcesLoaded: (snapshotSources: import("@hanzo/replay-shared").SessionRecordingSnapshotSource[] | null, storeVersion: number) => boolean;
        storeVersion: (storeUpdateCount: number, snapshotSources: import("@hanzo/replay-shared").SessionRecordingSnapshotSource[] | null) => number;
