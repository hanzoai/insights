...
│   └── queries.py  # InsightsQL label SQL, embeddings SQL, stream merging
└── tests/
```

Registered via `insights/dags/locations/signals.py` (US only) and loaded locally through `.dagster_home/workspace.yaml`.
