...
export interface notebooksTableLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface notebooksTableLogicMeta {
...
export type notebooksTableLogicType = MakeLogicType<
    notebooksTableLogicValues,
    notebooksTableLogicActions,
    Record<string, any>,
    notebooksTableLogicMeta
>
...
export const notebooksTableLogic = kea<notebooksTableLogicType>([
    ...
    selectors(({ actions }) => ({
        ...
        notebooks: [
            ...
            (notebooksResponse: CountedPaginatedResponse<NotebookListItemType> | null): NotebookListItemType[] => {
