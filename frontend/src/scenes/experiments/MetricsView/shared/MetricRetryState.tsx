...
export const RECALCULATION_RETRY_DOCS_URL = 'https://hanzo.ai/docs/experiments/background-recalculation'

const RETRY_REASONS: Record<string, string> = {
    rate_limited: 'The Datastore cluster is busy right now.',
