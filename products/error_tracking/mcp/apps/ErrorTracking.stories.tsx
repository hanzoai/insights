...
import { McpThemeDecorator } from '@hanzo/mcp-ui/storybook/decorator'
...
const issueWithLinks: ErrorIssueData = {
    ...
    external_issues: [
        {
            external_url: 'https://github.com/Insights/insights/issues/12345',
...
const sampleListData: ErrorIssueListData = {
    ...
    _insightsUrl: 'https://us.hanzo.ai/project/1/error_tracking',
}
    ...
    stacktrace: {
        ...
        frames: [
            ...
            },
            {
                ...
                source: 'insights/api/capture.py',
                line: 89,
                in_app: true,
                lang: 'python',
                resolved: true,
    ...
    results: [
        {
            ...
            properties: {
                ...
                $os_version: '14.2',
                $lib: 'insights-js',
                $current_url: 'https://app.hanzo.ai/dashboard/1',
                $session_id: '019b4f6d-4a76-7000-8000-000000000001',
            },
        },
    ],
    _insightsUrl: 'https://us.hanzo.ai/project/1/error_tracking/issue-1',
}
