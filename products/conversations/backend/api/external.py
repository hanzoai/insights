...
from insights.models import Tag, Team
...
def _workflow_trigger_from_request(request: Request) -> Trigger | None:
    """Build an activity-log Trigger when the request originates from a InsightsFlow workflow step.
...
class ExternalTicketView(APIView):
    ...
    def patch(self, request: Request, ticket_id: str) -> Response:
        ...
        # When a InsightsFlow workflow step makes the change, it forwards its identity via
