...
export interface cohortCountWarningLogicMeta {
    ...
    __keaTypeGenInternalSelectorTypes: {
        shouldShowCountWarning: (response: ErrorTrackingQueryResponse | ScriptQueryResponse | InsightsQLAutocompleteResponse | InsightsQLMetadataResponse | InsightsQLQueryResponse<any[]> | LogAttributesQueryResponse | LogValuesQueryResponse | MetricsQueryResponse | Record<string, any> | SessionsQueryResponse | TraceSpansAggregationQueryResponse | TraceSpansAttributeBreakdownQueryResponse | TraceSpansQueryResponse | null, query: DataTableNode) => boolean;
    };
}

export type cohortCountWarningLogicType = MakeLogicType<cohortCountWarningLogicValues, {}, CohortCountWarningLogicProps, cohortCountWarningLogicMeta>;
