...
const INSIGHTSQL_DOCS_URL = 'https://hanzo.ai/docs/insightsql'
        ...
        <Modal
            ...
            footer={
                <>
                    ...
                    <SaveViewButton />
                    <Button type="primary" onClick={onClose} data-attr="accounts-columns-done">
                        Done
                    </Button>
                </>
            }
    ...
    return (
        <div className="w-full flex flex-col gap-2 p-3 border border-border rounded" data-attr="accounts-column-edit">
            <div className="flex items-center justify-between">
                ...
                <Button size="small" onClick={onClose} data-attr="accounts-column-edit-close">
    ...
    return (
        ...
        >
            <div className="SelectedColumn" data-attr={`accounts-column-row-${label}`}>
                ...
                {isMandatory ? null : (
                    <Tooltip title="Edit">
                        <Button onClick={() => onEdit(dataIndex)} size="small" active={isEditing}>
...
- concat(name, ' (', external_id, ')')`}
            ...
            <Button
                ...
                fullWidth
                center
                disabledReason={!value.trim() ? 'Enter a InsightsQL expression' : undefined}
                onClick={onAdd}
            ...
            <div className="flex justify-end">
                <Link to={INSIGHTSQL_DOCS_URL} target="_blank" className="text-xs flex items-center gap-1">
