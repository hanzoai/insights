...
URL_BOT_NAME = "Insights-BusinessKnowledge"
URL_USER_AGENT = f"{URL_BOT_NAME}/1.0 (+https://hanzo.ai)"
...
# Datastore per pass (oldest-emitted first), and the grace period a doc must
