...
const activePopover: SurveyData = {
    ...
    questions: [
        {
            type: 'nps',
            question: 'How likely are you to recommend Insights to a friend or colleague?',
        },
        {
            type: 'open',
    ...
    _insightsUrl: 'https://us.hanzo.ai/project/1/surveys/survey-1',
}
...
const completedSurvey: SurveyData = {
    ...
    _insightsUrl: 'https://us.hanzo.ai/project/1/surveys/survey-3',
}
...
const sampleListData: SurveyListData = {
    ...
    _insightsUrl: 'https://us.hanzo.ai/project/1/surveys',
}
