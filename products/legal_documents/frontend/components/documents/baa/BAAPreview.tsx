...
export function BAAPreview(): JSX.Element {
    ...
    return (
        <div className="legal-document-preview prose prose-sm dark:prose-invert max-w-none">
            <h3>Business Associate Agreement — Insights Inc.</h3>
            <p>
            ...
            <p>
                This BAA applies only to Insights's processing of PHI for Customer in Customer's capacity as a Covered
            ...
            <p>
                ...
                oral or recorded in any form or medium that is created, received, maintained, or transmitted by Insights
            ...
            <p>
                ...
                (https://hanzo.ai/platform-packages)).
            </p>
            ...
            <p>
                (c) That it will not request that Insights take any action that would violate HIPAA if performed by
                Customer; and
            </p>
            <p>
                (d) That it will not request Insights to use or disclose PHI in any manner that would violate applicable
                federal or state laws if such use or disclosure were made by Customer.
            </p>

            <h4>3. Insights's Assurances</h4>
            <p>
                (a) Insights (1) shall not use or disclose PHI, other than as permitted or required by this BAA and
                ...
                Customer agrees that Insights may rely on Customer's instructions to determine if uses and disclosures
            ...
            <p>
                ...
                Insights becomes aware, including breaches of Unsecured PHI subject to the following:
            </p>
            <p>
                ...
                constitutes notice by Insights to Customer for such unsuccessful attempts; and
            </p>
            <p>
                (ii) Communications by or on behalf of Insights with Customer in connection with this Section 3(c) shall
                not be construed as an acknowledgment by Insights of any fault or liability with respect to the breaches
                of Unsecured PHI.
            </p>
            <p>
                (d) Insights will ensure that any subcontractors that create, receive, maintain, or transmit PHI on
                Insights's behalf agree to the same restrictions and conditions that apply to Insights with respect to
                such PHI.
            </p>
            <p>
                (e) Upon request of Customer or an individual, Insights will promptly provide information to Customer as
                may be reasonably necessary to facilitate Customer's compliance with its obligation to: (i) make
                available to requesting individuals a copy of any PHI about such individuals held by Insights in a
                designated record set, in accordance with 45 CFR 164.524; (ii) amend PHI or records about the requesting
                individual held by Insights in a designated record set, in accordance with 45 CFR 164.526; and (iii)
            ...
            <p>
                (f) In the event that any individual requests from Insights access, amendment, or an accounting of PHI,
                Insights shall forward such request to Customer within five (5) business days. Customer shall be
                responsible for responding to the individual's request and Customer agrees that Insights may respond to
                the individual directing them to make such request to Customer.
            </p>
            <p>
                (g) Insights will comply with HIPAA security standards for electronic PHI. All Privacy and security
                measures are found at https://hanzo.ai/docs/privacy
            </p>
            <p>
                (h) Insights will make its internal practices, books, and records relating to the use and disclosure of
                PHI received from, or created or received by Insights on behalf of, Customer available to the Secretary
            ...
            <p>
                (j) Insights will use appropriate safeguards to prevent use or disclosure of the PHI other than as
            ...
            <h4>6. Termination</h4>
            <p>
                Customer may terminate this BAA upon written notice if Insights materially breaches a term of this BAA,
                and fails to cure the breach within thirty (30) days of receiving written notice of it. Insights may
                terminate this BAA upon written notice if Customer either: (i) agrees to restrictions that impact
                Insights's ability to perform its obligations under the Agreement; (ii) agrees to restrictions that
                increase Insights's cost of performance under this BAA or the Agreement; or (iii) fails to meet its
            ...
            <p>
                In the event that Customer reasonably determines that Insights has breached its obligations under this
                BAA, Customer may, in addition to its other rights set forth in this BAA, immediately stop all further
                disclosures of PHI to Insights until the breach has been resolved.
            </p>
            ...
            <p>
                ...
                in favor of a meaning that permits Insights to comply with HIPAA. If any of the regulations promulgated
