...
class UsersnapSource(ResumableSource[UsersnapSourceConfig, UsersnapResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Usersnap REST API credentials to pull your Usersnap projects and feedback items into the Insights Data warehouse.

The Usersnap REST API is a gated feature: it must be enabled on your plan by Usersnap (contact their customer success team). Once enabled, generate a JWT secret under **Settings → REST API** in Usersnap and copy both the secret and its JWT ID here — Insights signs the short-lived bearer tokens for you.""",
            iconPath="/static/services/usersnap.png",
            docsUrl="https://hanzo.ai/docs/cdp/sources/usersnap",
