...
from insights.datastore.traces.spans import TRACE_ATTRIBUTES_DISTRIBUTED_TABLE_SQL
from insights.datastore.traces.trace_attributes import TRACE_ATTRIBUTES_TABLE_SQL
...
class TestTracingAttributeValueSearch(DatastoreTestMixin, APIBaseTest):
    ...
    def setUpTestData(cls):
        ...
        # attribute_type values mirror the deployed MVs in bin/datastore-logs.sql.
        rows = [
