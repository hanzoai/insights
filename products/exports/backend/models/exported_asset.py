...
class ExportedAsset(models.Model):
    ...
    # Excluded from the per-team user-export quota in insights/api/exports.py.
    ...
    class Meta:
        db_table = "insights_exportedasset"
...
def get_content_response(asset: ExportedAsset, download: bool = False, direct: bool = False):
    ...
    # for API clients (e.g. sandboxed agents) that can reach Insights but not the storage host.
