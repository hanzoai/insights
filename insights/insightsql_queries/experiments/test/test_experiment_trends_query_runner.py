...
from insights.insightsql_queries.experiments.experiment_trends_query_runner import ExperimentTrendsQueryRunner
from insights.insightsql_queries.experiments.types import ExperimentMetricType
from insights.models.action.action import Action
from insights.models.cohort.cohort import Cohort
from insights.models.experiment import Experiment, ExperimentHoldout
...
class TestExperimentTrendsQueryRunner(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_get_metric_type(self):
        ...
        allowed_sum_math_types: list[Any] = [PropertyMathType.SUM, "insightsql"]
