        ...
        return (
            <div className="flex flex-col gap-3">
                <p className="text-sm text-muted m-0">
                    Install the Insights SDK for your framework and your product's context starts flowing in, ready for
                    agents to act on.
                </p>
                <Button type="primary" to="https://hanzo.ai/docs/getting-started/install" targetBlank>
