...
from insights.schema_enums import ProductIntentContext, ProductKey
...
from insights.utils import get_instance_realm, get_safe_cache, safe_cache_delete, safe_cache_set
...
class ProductIntent(UUIDTModel, RootTeamMixin):
    ...
    def has_activated_error_tracking(self) -> bool:
        ...
        # Local import: this module loads during django.setup() (via insights.models), and the
        # error_tracking facade pulls in insights.event_usage -> insights.models (circular).
    ...
    def has_activated_workflows(self) -> bool:
        ...
        return InsightsFlow.objects.filter(team=self.team, status=InsightsFlow.State.ACTIVE).exists()
