...
export interface _ProductBreakdownRowApi {
    /**
     * Value of the `ai_product` property on the event (e.g. `insights_code`, `background_agents`). Null when unset.
     * @nullable
     */
    product: string | null
...
export interface EvaluationRunRequestApi {
    ...
    /** ISO 8601 timestamp of the target event (needed for efficient Datastore lookup). */
    timestamp: string
...
export type EvaluationApiEvaluationConfig =
    ...
    | {
          /**
           * Script source code. Must return true (pass), false (fail), or null for N/A.
           * @minLength 1
           */
          source: string
      }
...
export interface TestHogResultItemApi {
    ...
    result: boolean | null
    /**
     * Script evaluation reasoning string, if any.
     * @nullable
     */
    reasoning: string | null
    /**
     * Error message if the Script code raised an exception.
     * @nullable
     */
    error: string | null
}
...
export interface ClusteringConfigApi {
    /** Insights property filters that scope automated clustering jobs. Empty array means no saved filters. */
...
export interface ScoreDefinitionApi {
    ...
    /**
     * UUID of the current version row. Matches `system.score_definitions.current_version_id` in InsightsQL.
     * @nullable
     */
...
export interface HogTaggerConfigApi {
     ...
     */
    source: string
    /** Optional tag whitelist. Leave empty to allow any tag returned by the Script code. */
    tags?: TagDefinitionApi[]
}
...
export interface TestHogTaggerResultItemApi {
    ...
    output_preview: string
    /** Tag names returned by the Script code. */
    tags: string[]
    /** Text written to stdout by the Script code. */
    reasoning: string
    /**
     * Error message if the Script code failed.
     * @nullable
     */
    error?: string | null
}
...
export type LlmAnalyticsPersonalSpendListParams = {
    ...
    product: string
    /**
     * If true, bypass the result cache and re-run the underlying queries against Datastore.
     */
    refresh?: boolean
}
