...
export interface miniFiltersLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface miniFiltersLogicActions {
    ...
    setGroupRepeatedItems: (groupRepeatedItems: boolean) => {
        groupRepeatedItems: boolean
    }
    setMiniFilter: (
        key: MiniFilterKey,
    ...
    setShowLineTooltips: (showLineTooltips: boolean) => {
        showLineTooltips: boolean
    }
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface miniFiltersLogicMeta {
...
export type miniFiltersLogicType = MakeLogicType<
    miniFiltersLogicValues,
    miniFiltersLogicActions,
    Record<string, any>,
    miniFiltersLogicMeta
>
...
export const miniFiltersLogic = kea<miniFiltersLogicType>([
    ...
    selectors({
        miniFiltersForType: [
            ...
            (selectedMiniFilters: string[]): ((tab: FilterableInspectorListItemTypes) => SharedListMiniFilter[]) => {
        ...
        hasEventsFiltersSelected: [
            ...
            (miniFiltersForType: (tab: FilterableInspectorListItemTypes) => SharedListMiniFilter[]) =>
                miniFiltersForType('events').some((x) => x.enabled),
        ],

        miniFilters: [
            (s) => [s.selectedMiniFilters],
            (selectedMiniFilters: string[]): SharedListMiniFilter[] => {
        ...
        miniFiltersByKey: [
            (s) => [s.miniFilters],
            (miniFilters: SharedListMiniFilter[]): { [key: string]: SharedListMiniFilter } => {
