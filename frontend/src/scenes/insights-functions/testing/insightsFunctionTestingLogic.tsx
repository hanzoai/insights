...
import { insightsFunctionConfigurationLogic, sanitizeConfiguration } from '../configuration/insightsFunctionConfigurationLogic'
import type { insightsFunctionTestingLogicType } from './insightsFunctionTestingLogicType'

export interface InsightsFunctionTestingLogicProps {
    id: string
}
...
export const insightsFunctionTestingLogic = kea<insightsFunctionTestingLogicType>([
    path((key) => ['scenes', 'pipeline', 'insightsFunctionTestingLogic', key]),
    props({} as InsightsFunctionTestingLogicProps),
    key(({ id }: InsightsFunctionTestingLogicProps) => id),
    connect(() => ({
        values: [
        ...
        retries: [
            [] as CyclotronJobTestInvocationResultWithEventId[],
            {
                retryInvocation: async ({
                    ...
                    try {
                        res = await api.insightsFunctions.createTestInvocation(props.id ?? 'new', {
                            globals,
