...
from insights.temporal.data_imports.external_data_job import (
    Any_Source_Errors,
...
from insights.temporal.data_imports.settings import import_data_activity_sync
...
from insights.temporal.data_imports.workflow_activities.calculate_table_size import calculate_table_size_activity
from insights.temporal.data_imports.workflow_activities.check_billing_limits import check_billing_limits_activity
from insights.temporal.data_imports.workflow_activities.create_job_model import (
    CreateExternalDataJobModelActivityInputs,
    create_external_data_job_model_activity,
)
from insights.temporal.data_imports.workflow_activities.import_data_sync import ImportDataActivityInputs
from insights.temporal.data_imports.workflow_activities.sync_new_schemas import (
...
async def test_run_stripe_job(activity_environment, team, minio_client, mock_stripe_client, **kwargs):
    ...
    with (
        ...
        mock.patch(
            ...
            return_value={
                ...
                "name": {"datastore": "string", "insightsql": "StringDatabaseField"},
            },
        ),
    ):
    ...
    with (
        ...
        mock.patch(
            ...
            return_value={
                "id": {"datastore": "string", "insightsql": "StringDatabaseField"},
                "customer": {"datastore": "string", "insightsql": "StringDatabaseField"},
            },
        ),
    ):
