...
const FAIRYTALE_IMG = {
    ...
    wizard: `${CLOUDINARY_BASE}/hanzo.ai/src/images/dpa/wizard.png`,
    gnomes: `${CLOUDINARY_BASE}/hanzo.ai/src/images/dpa/gnomes.png`,
    porridge: `${CLOUDINARY_BASE}/hanzo.ai/src/images/dpa/porridge.png`,
} as const
    ...
    return (
        <div className="legal-document-preview legal-document-preview--fairytale max-w-2xl mx-auto">
            ...
            <p>
                ...
                they reached out to the guardian wizards of <strong>Insights, Inc.</strong>, a famed group known for
            ...
            />
            <p>
                {Company} and the Insights wizards agreed to create a magical pact called the "Data Protection
