...
class Canvas(TeamScopedRootMixin, UUIDModel):
    ...
    # db_constraint=False: a real FK constraint to the hot insights_team table
...
class CanvasSourceVersion(TeamScopedRootMixin, UUIDModel):
    ...
    class Meta:
        db_table = "insights_canvas_source_version"
...
class CanvasBuild(TeamScopedRootMixin, UUIDModel):
    ...
    class Meta:
        db_table = "insights_canvas_build"
        indexes = [
