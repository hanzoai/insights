    ...
    if (selectionMode === 'single') {
        ...
        return (
            <div className="space-y-2 min-w-0">
                ...
                {selectedValue ? (
                    <div>
                        <Button type="tertiary" size="xsmall" onClick={() => setScoreValue(definition.id, null)}>
                            Clear
                        </Button>
                    </div>
                ) : null}
    ...
    return (
        <div className="flex items-center gap-2 min-w-0">
            ...
            {typeof value === 'string' && value ? (
                <Button type="tertiary" size="xsmall" onClick={() => setScoreValue(definition.id, '')}>
                    Clear
                </Button>
            ) : null}
        </div>
...
export function TraceReviewButton({
    ...
    return (
        <>
            ...
            <Modal isOpen={isOpen} onClose={closeModal} title={modalTitle} width={680}>
                {modalDataLoading ? (
