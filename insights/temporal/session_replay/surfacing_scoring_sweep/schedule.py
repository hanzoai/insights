...
from insights.temporal.session_replay.surfacing_scoring_sweep.types import ScoreSessionsBatchInputs
...
async def create_surfacing_scoring_sweep_schedule(client: Client) -> None:
    ...
    Registered in `insights/temporal/schedule.py`'s deploy-time `schedules` list,
