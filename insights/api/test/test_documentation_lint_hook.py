"""Tests for insights.api.documentation.lint_spec_consistency_hook."""

import pytest
from unittest.mock import patch

from insights.api.documentation import lint_spec_consistency_hook
...
def test_lint_spec_consistency_hook_operation_id_validation(operation_id: str, should_warn: bool) -> None:
    ...
    with patch("insights.api.documentation.spectacular_warn") as mock_warn:
