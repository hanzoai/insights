...
allocations, milestones, logged time, time off, and holidays into the Insights data warehouse so you
...
<!--
DRAFT — this user-facing doc belongs in the hanzo.ai repo at
contents/docs/cdp/sources/float-app.md (served at /docs/cdp/sources/float-app). No hanzo.ai
checkout was available when this was written, so it is committed alongside the source to travel with
the PR. Copy it to hanzo.ai (dropping this comment) and run
