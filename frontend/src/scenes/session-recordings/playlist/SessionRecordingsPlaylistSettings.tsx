...
function SortedBy({
    ...
    const changeSort = (sort: RecordingSort): void => {
        ...
        if (sortChangedEvent) {
            insights.capture('session recording list sort changed', sortChangedEvent)
        }
            ...
            {!isCreatingNewCollectionInModal ? (
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex justify-end gap-2 mt-8">
                        <Button type="secondary" onClick={() => setIsCreatingNewCollectionInModal(false)}>
                            Back
                        </Button>
                        <Button
                            type="primary"
...
function BulkScanMenuItem(): JSX.Element {
    ...
    const submenuItems: MenuItem[] = scannersLoading
