...
class SimplesatSource(ResumableSource[SimplesatSourceConfig, SimplesatResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Simplesat API key to pull your customer satisfaction survey data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/simplesat",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
