...
from insights.api.two_factor_reset import TwoFactorResetVerifier
...
from insights.tasks.email import send_password_reset, send_two_factor_reset_email
...
class UserAdmin(DjangoUserAdmin):
    ...
    def user_change_password(self, request, id, form_url=""):
        ...
        return HttpResponseRedirect(reverse("admin:insights_user_change", args=[id]))
