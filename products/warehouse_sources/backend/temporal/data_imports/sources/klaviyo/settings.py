...
KLAVIYO_ENDPOINTS: dict[str, KlaviyoEndpointConfig] = {
    ...
    # InsightsQL), so the many-to-many can't be joined. This table fans out one paginated request per list
    ...
    # so the many-to-many can't be joined from InsightsQL without materializing it. Opt-in because a fan
