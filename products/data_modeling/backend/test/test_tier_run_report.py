...
class TestTierRunReport(BaseTest):
    ...
    def _suspend(self, node: Node, *, engine: str = "datastore", reason: str = "Workflow was cancelled") -> None:
    ...
    def _job(
        ...
        *,
        ...
        status: str,
        error: str | None = None,
        engine: str = DataModelingJobEngine.DATASTORE,
    ) -> DataModelingJob:
    ...
    def test_only_the_serving_engine_counts_for_suspension_and_for_jobs(self):
        ...
        # change what the datastore run is reported to have done
