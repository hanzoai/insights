...
def _sanitize_context(
    ...
    *,
    ...
    insights-js handles over-long string properties, and unusable keys and excess entries are
...
class WidgetMessageSerializer(WidgetAuthSerializer):
    ...
    distinct_id = serializers.CharField(required=False, max_length=400, help_text="Insights distinct_id")
