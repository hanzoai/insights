...
from insights.models.event.sql import EVENT_JOIN_PERSON_SQL
...
from insights.models.property.util import get_property_string_expr, normalize_url_breakdown, parse_prop_grouped_clauses
from insights.models.team import Team
from insights.queries.breakdown_props import (
    ALL_USERS_COHORT_ID,
...
from insights.queries.event_query import EventQuery
...
from insights.queries.query_date_range import TIME_IN_SECONDS, QueryDateRange
from insights.queries.trends.sql import (
...
from insights.queries.trends.util import (
...
from insights.utils import encode_get_request_params, generate_short_id
...
class TrendsBreakdown:
    ...
    def get_query(self) -> tuple[str, dict, Callable]:
        ...
        if len(_params["values"]) == 0:
            ...
            # See https://github.com/hanzoai/insights/pull/5674 for context.
            return (
