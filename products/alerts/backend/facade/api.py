...
from insights.models.activity_logging.model_activity import ActingUserContext
...
def snooze_alert_from_slack(
    ...
    duration come from an untrusted Slack button value (user-editable script function config), so
    ...
    # Mirrors TeamMemberAccessPermission (insights/permissions.py): a non-admin member with no
