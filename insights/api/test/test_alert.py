...
from insights.schema import AlertState, InsightThresholdType

from insights.models import AlertConfiguration
from insights.models.alert import AlertCheck
...
class TestAlert(APIBaseTest, QueryMatchingTest):
    ...
    def test_alert_limit(self) -> None:
        with mock.patch("insights.api.alert.AlertConfiguration.ALERTS_ALLOWED_ON_FREE_TIER") as alert_limit:
