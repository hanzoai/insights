            ...
            <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                        ...
                        <Tag type={paused ? 'warning' : 'success'}>{paused ? 'Paused' : 'Active'}</Tag>
                    </div>
            ...
            <div className="flex flex-col gap-2">
                ...
                {visibleRecentCalls.length < recentCalls.length && (
                    <div className="flex justify-center">
                        <Button size="small" type="tertiary" onClick={showMoreRecentCalls}>
                            Show more
                        </Button>
                    </div>
                )}
    ...
    return (
        <div className={`flex items-center gap-3 p-2 ${shared ? '' : 'bg-surface-secondary opacity-70'}`}>
            ...
            {shared && connectionStatus && (
                <Tag type={connectionState === 'ready' ? 'success' : 'warning'} size="small">
