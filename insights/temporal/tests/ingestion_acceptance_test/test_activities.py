...
class TestRunIngestionAcceptanceTestsTimeout:
    @patch("insights.temporal.ingestion_acceptance_test.activities.send_slack_timeout_notification")
    @patch("insights.temporal.ingestion_acceptance_test.activities.send_slack_notification")
    @patch("insights.temporal.ingestion_acceptance_test.activities.InsightsClient")
    @patch("insights.temporal.ingestion_acceptance_test.activities.hanzo_insights.Insights")
    @patch("insights.temporal.ingestion_acceptance_test.activities.discover_tests", return_value=[])
    @patch("insights.temporal.ingestion_acceptance_test.activities.load_config")
    @patch("insights.temporal.ingestion_acceptance_test.activities.run_tests")
    @pytest.mark.asyncio
