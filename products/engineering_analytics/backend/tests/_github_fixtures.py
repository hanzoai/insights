...
TEST_BUCKET = "test_storage_bucket-insights.products.engineering_analytics.github_fixtures"
...
def pr_association_entry(number: int, *, base_repo: str = "Insights/insights") -> dict[str, Any]:
...
def pr_association(*numbers: int, base_repo: str = "Insights/insights") -> str:
...
def _pr_row(
    ...
    *,
    ...
    head_ref: str = "",
    base_ref: str = "",
    full_name: str = "Insights/insights",
    labels: tuple[str, ...] = (),
) -> dict[str, Any]:
    return {
        "id": 1000 + number,
