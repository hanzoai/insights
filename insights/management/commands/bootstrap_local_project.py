...
from insights.local_bootstrap import (
    BootstrapConfig,
...
from insights.local_bootstrap.config import SUPPORTED_FILE_FORMATS
...
class Command(BaseCommand):
    help = (
        "Bootstrap a local Insights project from an S3 dump of the events and/or persons tables. "
        "The dump must be in the Insights batch-export format (Parquet or JSONLines, optionally "
        "compressed). Events go to Datastore; persons go to Postgres and Datastore."
    )
