...
import { Banner, Button, CalendarSelectInput, Label, Tooltip } from '@hanzo/elements'
            ...
            <div className="flex gap-6">
                ...
                <div className="flex-1 space-y-4 max-w-md bg-bg-light p-6 rounded-lg border">
                    ...
                    <div className="space-y-3">
                        ...
                        {/* Wrapper keeps the control on its own line — both Label and the
                        ...
                        <p className="text-xs text-muted">
                            Search and select a person from your Insights instance. You can search by name, email, or
                            distinct ID.
                        </p>
                            ...
                            (hasMultipleDistinctIds ? (
                                <Banner type="warning">
                                    <div className="text-sm">
                                        ...
                                        runtime Insights buckets using the distinct ID from the incoming request.
                                    </div>
                                </Banner>
                            ) : (
                    ...
                    {/* Optional Timestamp */}
                    <div className="space-y-3">
                        <Label>Historical timestamp (optional)</Label>
                        <CalendarSelectInput
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button onClick={clearTestForm} disabled={isLoading}>
                            Clear
                        </Button>
                    </div>
                                    ...
                                    {resultsDiverge && (
                                        <Banner type="warning">
                                            <div className="text-sm">
                                                ...
                                                At runtime Insights buckets using the distinct ID from the incoming
                            ...
                            {result ? (
                                <>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        {bucketingDistinctId && (
                                            <div className="space-y-2">
                                                <Label>Bucketed using distinct ID</Label>
                                    ...
                                    <div className="grid grid-cols-1 xl:grid-cols-5 gap-6 flex-1 min-h-0">
                                        ...
                                        {hasConditions && (
                                            <div className="space-y-3 xl:col-span-2 flex flex-col min-h-0">
                                                <Label>Condition analysis</Label>
