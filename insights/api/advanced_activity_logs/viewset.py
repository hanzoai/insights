...
from insights.api.fields import JSONStringFilterField, JSONTolerantListField, OptionalBooleanField
from insights.api.routing import TeamAndOrgViewSetMixin
from insights.api.shared import UserBasicSerializer
from insights.constants import AvailableFeature
from insights.exceptions_capture import capture_exception
from insights.models import NotificationViewed
...
from insights.permissions import PremiumFeaturePermission
...
class AdvancedActivityLogFiltersSerializer(serializers.Serializer):
    ...
    clients = JSONTolerantListField(
        ...
        required=False,
        default=[],
        help_text="Filter by API clients that generated the activity (from x-insights-client header).",
    )
    ...
    insightsql_filter = serializers.CharField(
        required=False,
        allow_blank=True,
        help_text="Reserved for future InsightsQL-based filtering.",
    )
...
class StaticFiltersSerializer(serializers.Serializer):
    ...
    clients = serializers.ListField(
        ...
        help_text="API clients that have generated activity (from x-insights-client header).",
    )
