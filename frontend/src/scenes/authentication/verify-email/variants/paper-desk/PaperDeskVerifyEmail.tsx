...
import { ExplorerHog, SleepingHog } from 'lib/components/mascots'
...
const CHECKLIST = [
    ...
    'Channel your inner mascot and peek again',
]
...
function VerifyEmail(): JSX.Element {
            ...
            <PaperDeskScene notes={notes}>
                <PaperDeskCard>
                    <div className="flex flex-col items-center text-center">
                        ...
                        <p className="m-0 text-sm text-secondary text-center">Taking you to Insights…</p>
                    </div>
                </PaperDeskCard>
            </PaperDeskScene>
        )
    ...
    return (
        <PaperDeskScene notes={notes}>
            ...
            >
                <div className="flex flex-col items-center text-center">
                    <MascotMagnifyingGlass className="block w-auto mx-auto h-28" />
                    <h1 className="m-0 mt-3 font-title text-2xl font-extrabold leading-tight text-primary text-center tracking-tight">
                        Check your inbox
                    </h1>
