...
const MOCK_PERSONS = [
    {
        ...
        properties: { email: 'phil@hanzo.ai', name: 'Phil' },
    ...
    },
    {
        ...
        properties: { email: 'sarah@hanzo.ai', name: 'Sarah' },
...
describe('DistinctIdSelect', () => {
    ...
    it('renders person display names in the dropdown, not raw distinct_ids', async () => {
        ...
        await waitFor(() => {
            expect(screen.getByText('phil@hanzo.ai')).toBeInTheDocument()
            expect(screen.getByText('sarah@hanzo.ai')).toBeInTheDocument()
        })
    })
    ...
    it('stores the distinct_id as the value when selecting a person', async () => {
        ...
        await userEvent.click(screen.getByText('phil@hanzo.ai'))
    ...
    it('supports multi-select with exact operator', async () => {
        ...
        await userEvent.click(screen.getByText('sarah@hanzo.ai'))
