...
class PrintifySource(ResumableSource[PrintifySourceConfig, PrintifyResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Printify personal access token to pull your print-on-demand data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/printify",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
