...
@snapshot_datastore_queries
class TestRevenueAnalyticsTopCustomersQueryRunner(DatastoreTestMixin, APIBaseTest):
        ...
        *,
        ...
        with freeze_time(self.QUERY_TIMESTAMP):
            ...
            runner = RevenueAnalyticsTopCustomersQueryRunner(
                team=self.team, query=query, modifiers=InsightsQLQueryModifiers(formatCsvAllowDoubleQuotes=True)
            )
