    ...
    withUiApp('workflow', {
        ...
        handler: async (context: Context, params: z.infer<typeof WorkflowsCreateSchema>) => {
            ...
            const result = await context.api.request<Schemas.InsightsFlow>({
                method: 'POST',
                path: `/v1/projects/${encodeURIComponent(String(projectId))}/script_flows/`,
                body,
            })
...
const workflowsDiscardDraft = (): ToolBase<typeof WorkflowsDiscardDraftSchema, Schemas.InsightsFlow> =>
    withUiApp('workflow', {
        ...
        handler: async (context: Context, params: z.infer<typeof WorkflowsDiscardDraftSchema>) => {
            ...
            const result = await context.api.request<Schemas.InsightsFlow>({
                method: 'POST',
                path: `/v1/projects/${encodeURIComponent(String(projectId))}/script_flows/${encodeURIComponent(String(params.id))}/discard_draft/`,
            })
            return result
        },
    })
...
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof WorkflowsGetInvocationSchema>) => {
        ...
        const result = await context.api.request<Schemas.ScriptInvocationResultDetail>({
            method: 'GET',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/script_flows/${encodeURIComponent(String(params.id))}/invocation_results/${encodeURIComponent(String(params.invocation_id))}/`,
        })
        return result
    },
})
...
const workflowsGetRevision = (): ToolBase<typeof WorkflowsGetRevisionSchema, Schemas.InsightsFlowRevision> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof WorkflowsGetRevisionSchema>) => {
        ...
        const result = await context.api.request<Schemas.InsightsFlowRevision>({
            method: 'GET',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/script_flows/${encodeURIComponent(String(params.id))}/revisions/${encodeURIComponent(String(params.version))}/`,
        })
        return result
    },
})
...
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof WorkflowsGlobalStatsSchema>) => {
        ...
        const result = await context.api.request<Schemas.WorkflowStatsRow[]>({
            method: 'GET',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/script_flows/metrics/global/`,
            query: {
                after: params.after,
...
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof WorkflowsListBatchJobsSchema>) => {
        ...
        const result = await context.api.request<Schemas.InsightsFlowBatchJob[]>({
            method: 'GET',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/script_flows/${encodeURIComponent(String(params.id))}/batch_jobs/`,
        })
        return await withInsightsUrl(context, result, '/workflows')
    },
})
...
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof WorkflowsListInvocationsSchema>) => {
        ...
        const result = await context.api.request<Schemas.ScriptInvocationResult[]>({
            method: 'GET',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/script_flows/${encodeURIComponent(String(params.id))}/invocation_results/`,
            query: {
                after: params.after,
                before: params.before,
...
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof WorkflowsListRevisionsSchema>) => {
        ...
        const result = await context.api.request<Schemas.PaginatedInsightsFlowRevisionBasicList>({
            method: 'GET',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/script_flows/${encodeURIComponent(String(params.id))}/revisions/`,
            query: {
                limit: params.limit,
                offset: params.offset,
            },
...
const workflowsLogs = (): ToolBase<typeof WorkflowsLogsSchema, unknown> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof WorkflowsLogsSchema>) => {
        ...
        const result = await context.api.request<unknown>({
            method: 'GET',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/script_flows/${encodeURIComponent(String(params.id))}/logs/`,
            query: {
                after: params.after,
                before: params.before,
...
const workflowsPatchActionEmail = (): ToolBase<typeof WorkflowsPatchActionEmailSchema, Schemas.InsightsFlow> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof WorkflowsPatchActionEmailSchema>) => {
        ...
        const result = await context.api.request<Schemas.InsightsFlow>({
            method: 'PATCH',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/script_flows/${encodeURIComponent(String(id))}/actions/${encodeURIComponent(String(action_id))}/email/`,
            body,
        })
        return result
    },
...
const workflowsPatchGraph = (): ToolBase<typeof WorkflowsPatchGraphSchema, Schemas.InsightsFlow> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof WorkflowsPatchGraphSchema>) => {
        ...
        const result = await context.api.request<Schemas.InsightsFlow>({
            method: 'PATCH',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/script_flows/${encodeURIComponent(String(id))}/graph/`,
            body,
        })
        return result
    },
...
const workflowsPublish = (): ToolBase<typeof WorkflowsPublishSchema, Schemas.InsightsFlowPublishResponse> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof WorkflowsPublishSchema>) => {
        ...
        const result = await context.api.request<Schemas.InsightsFlowPublishResponse>({
            method: 'POST',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/script_flows/${encodeURIComponent(String(params.id))}/publish/`,
            body,
        })
        return result
    },
...
const workflowsRestoreRevision = (): ToolBase<typeof WorkflowsRestoreRevisionSchema, Schemas.InsightsFlow> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof WorkflowsRestoreRevisionSchema>) => {
        ...
        const result = await context.api.request<Schemas.InsightsFlow>({
            method: 'POST',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/script_flows/${encodeURIComponent(String(params.id))}/revisions/${encodeURIComponent(String(params.version))}/restore/`,
            body,
        })
        return result
    },
...
const workflowsStats = (): ToolBase<typeof WorkflowsStatsSchema, Schemas.AppMetricsResponse> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof WorkflowsStatsSchema>) => {
        ...
        const result = await context.api.request<Schemas.AppMetricsResponse>({
            method: 'GET',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/script_flows/${encodeURIComponent(String(params.id))}/metrics/`,
            query: {
                after: params.after,
                before: params.before,
...
const workflowsTestRun = (): ToolBase<typeof WorkflowsTestRunSchema, unknown> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof WorkflowsTestRunSchema>) => {
        ...
        const result = await context.api.request<unknown>({
            method: 'POST',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/script_flows/${encodeURIComponent(String(params.id))}/invocations/`,
            body,
        })
        return result
    },
...
const workflowsUpdateSchedule = (): ToolBase<typeof WorkflowsUpdateScheduleSchema, Schemas.InsightsFlowSchedule> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof WorkflowsUpdateScheduleSchema>) => {
        ...
        const result = await context.api.request<Schemas.InsightsFlowSchedule>({
            method: 'PATCH',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/script_flows/${encodeURIComponent(String(params.id))}/schedules/${encodeURIComponent(String(params.schedule_id))}/`,
            body,
        })
        return result
    },
