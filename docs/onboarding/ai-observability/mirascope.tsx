    ...
    return [
                ...
                <>
                    <CalloutBox type="info" icon="IconInfo" title="Full working examples">
                        <Markdown>
                            ...
                            example](https://github.com/Insights/insights-python/tree/master/examples/example-ai-mirascope)
                            on GitHub. If you're using the Insights SDK wrapper instead of OpenTelemetry, see the [Python
                            wrapper
                            example](https://github.com/Insights/insights-python/tree/7223c52/examples/example-ai-mirascope).
                        </Markdown>
                    </CalloutBox>
                    ...
                    <CodeBlock
                        language="bash"
                        code={dedent`
                            pip install "mirascope[openai]" opentelemetry-sdk "insights[otel]" opentelemetry-instrumentation-openai-v2
                        `}
                    />
                </>
            ),
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        Use Mirascope as normal. Insights automatically captures an `$ai_generation` event for each LLM
