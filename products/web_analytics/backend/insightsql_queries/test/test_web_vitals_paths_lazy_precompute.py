...
class TestWebVitalsPathsLazyPrecompute(DatastoreTestMixin, APIBaseTest):
    def setUp(self) -> None:
        super().setUp()
        ...
        # so precompute rows are "born expired" relative to the real Datastore
    ...
    def _enable_lazy(self):
        ...
        # manager the default `hanzo_insights.feature_enabled` returns False
    ...
    def test_stale_served_enqueues_background_revalidation(self):
        ...
        with (
            ...
            self._enable_lazy(),
            patch(
                "products.web_analytics.backend.insightsql_queries.web_vitals_paths_lazy_precompute.ensure_web_vitals_paths_precomputed",
