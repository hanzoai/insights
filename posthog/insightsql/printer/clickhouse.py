...
from posthog.insightsql.ast import AST
...
from posthog.insightsql.database.models import DANGEROUS_NoTeamIdCheckTable, DatabaseField, SavedQuery
from posthog.insightsql.database.s3_table import DataWarehouseTable, S3Table
from posthog.insightsql.errors import ImpossibleASTError, InternalInsightsQLError, QueryError
from posthog.insightsql.escape_sql import escape_clickhouse_identifier, escape_clickhouse_string, safe_identifier
from posthog.insightsql.printer.base import InsightsQLPrinter, resolve_field_type
from posthog.insightsql.printer.types import PrintableMaterializedColumn, PrintableMaterializedPropertyGroupItem
from posthog.insightsql.utils import ilike_matches, like_matches
from posthog.insightsql.visitor import GetFieldsTraverser, clone_expr
...
class ClickHousePrinter(InsightsQLPrinter):
    ...
    def visit_compare_operation(self, node: ast.CompareOperation):
        ...
        # :HACK: until the new type system is out: https://github.com/Insights/posthog/pull/17267
        ...
        if in_join_constraint or self.dialect == "insightsql" or not_nullable or in_index_hint:
            return op
