...
KAFKA_EVENTS_JSON = f"{settings.KAFKA_PREFIX}datastore_events_json"

# Original Kafka table schema - reads from datastore_events_json topic
...
""".format(
    engine=kafka_engine(topic=KAFKA_EVENTS_JSON, group="datastore_distinct_id_usage"),
)
