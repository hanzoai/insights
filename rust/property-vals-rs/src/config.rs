...
pub struct Config {
    ...
    #[envconfig(default = "datastore_property_values")]
    ...
    #[envconfig(default = "datastore-property-vals-rs-merger")]
    ...
    #[envconfig(default = "datastore_groups")]
    pub groups_kafka_consumer_topic: String,

    #[envconfig(default = "datastore-property-vals-rs-groups")]
...
impl Config {
    pub fn init_with_defaults() -> Result<Self, envconfig::Error> {
        ...
        ConsumerConfig::set_defaults(
            "datastore-property-vals-rs",
            "datastore_events_json",
            true,
        );
