...
from insights.otel_instrumentation import _otel_django_request_hook, _otel_django_response_hook, initialize_otel
...
class TestOtelInstrumentation(SimpleTestCase):
    ...
    @mock.patch("insights.otel_instrumentation.CeleryInstrumentor")
    @mock.patch("insights.otel_instrumentation.AIOKafkaInstrumentor")
    @mock.patch("insights.otel_instrumentation.KafkaInstrumentor")
    @mock.patch("insights.otel_instrumentation.PsycopgInstrumentor")
    @mock.patch("insights.otel_instrumentation.RedisInstrumentor")
    @mock.patch("insights.otel_instrumentation.DjangoInstrumentor")
    @mock.patch("insights.otel_instrumentation.BatchSpanProcessor")
    @mock.patch("insights.otel_instrumentation.OTLPSpanExporter")
    @mock.patch("insights.otel_instrumentation.TracerProvider")
    @mock.patch("insights.otel_instrumentation.Resource")
    ...
    @mock.patch("insights.otel_instrumentation.logger")
