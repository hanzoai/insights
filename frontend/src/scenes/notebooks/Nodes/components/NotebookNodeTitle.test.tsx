...
jest.mock('~/queries/utils', () => ({
    isInsightsQLQuery: jest.fn(() => false),
}))
...
const defaultNotebookLogicValues = {
    ...
    insightsqlSqlNodeIndices: new Map<string, number>(),
}
...
describe('getCellLabel', () => {
    test.each([
        ...
        { nodeIndex: 2, nodeType: NotebookNodeType.InsightsQLSQL, expected: 'SQL (InsightsQL) 2' },
