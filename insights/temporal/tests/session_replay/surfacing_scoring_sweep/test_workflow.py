...
from insights.temporal.session_replay.surfacing_scoring_sweep.constants import WORKFLOW_NAME
...
from insights.temporal.session_replay.surfacing_scoring_sweep.workflow import ScoreSessionsBatchWorkflow, _summarize
...
class TestSummarize:
    def test_aggregates_scored_and_failed_chunks(self) -> None:
        ...
        with (
            mock.patch("insights.temporal.session_replay.surfacing_scoring_sweep.workflow.workflow.logger"),
            mock.patch(
                "insights.temporal.session_replay.surfacing_scoring_sweep.workflow.record_tick_summary",
