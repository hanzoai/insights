...
class ChartMogulSource(ResumableSource[ChartMogulSourceConfig, ChartMogulResumeConfig]):
    ...
    default_version = "v1"
    api_docs_url = "https://dev.chartmogul.com/"
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="ChartMogul",
            caption="""Enter your ChartMogul API key to pull your subscription analytics data into the Insights Data warehouse.
...
You can find your API key in your [ChartMogul admin settings](https://app.chartmogul.com/#/admin/api).""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/chartmogul",
