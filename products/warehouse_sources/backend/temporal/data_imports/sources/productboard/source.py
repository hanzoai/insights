...
class ProductboardSource(ResumableSource[ProductboardSourceConfig, ProductboardResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Productboard",
            caption="""Enter your Productboard public API access token to sync your Productboard data into the Insights Data warehouse.
...
Grant read access for the resources you want to sync — for example `entities:read`, `notes:read`, `members:read`, and `teams:read`.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/productboard",
