...
from products.signals.backend.emission.conversations_tickets import (
    CONVERSATIONS_TICKETS_CONFIG,
    conversations_ticket_emitter,
)
from products.signals.backend.emission.fetchers.conversations import conversations_ticket_fetcher
...
class TestConversationsTicketFetcherMessages(BaseTest):
    ...
    def test_extracts_image_attachments_from_rich_content_with_author_attribution(self):
        _add_comment(
            ...
            rich_content=_rich_content_with_images("https://media.hanzo.ai/a.png"),
        )
        _add_comment(
            self.team,
            self.ticket,
            ...
            rich_content=_rich_content_with_images(
                "https://media.hanzo.ai/b.png", "https://media.hanzo.ai/c.png"
            ),
        )
        ...
        assert result[0]["image_attachments"] == [
            {"url": "https://media.hanzo.ai/a.png", "author": "customer"},
            {"url": "https://media.hanzo.ai/b.png", "author": "team"},
            {"url": "https://media.hanzo.ai/c.png", "author": "team"},
        ]
...
class TestConversationsTicketFetcherEmitterIntegration(BaseTest):
    ...
    def test_image_attachments_flow_from_rich_content_into_signal_extra(self):
        ...
        _add_comment(
            ...
            author_type="customer",
            rich_content=_rich_content_with_images("https://media.hanzo.ai/bug.png"),
        )
        _add_comment(
            self.team,
            ticket,
            ...
            author_type="team",
            rich_content=_rich_content_with_images("https://media.hanzo.ai/repro.png"),
        )
        ...
        assert output.extra["images"] == [
            {"url": "https://media.hanzo.ai/bug.png", "author": "customer"},
            {"url": "https://media.hanzo.ai/repro.png", "author": "team"},
        ]
