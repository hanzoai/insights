...
class BugherdSource(ResumableSource[BugherdSourceConfig, BugherdResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="BugHerd",
            caption="""Enter your BugHerd API key to sync your organization, projects, tasks, and users into the Insights Data warehouse.

Find your API key in BugHerd under **Settings > General Settings** (organization owner/admin access is required).""",
            docsUrl="https://hanzo.ai/docs/cdp/sources/bugherd",
