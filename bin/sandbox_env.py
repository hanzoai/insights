...
TEMPLATE = """\
# Secrets for your Insights dev sandboxes, injected as environment variables.
#
...
def render_context_markdown(env_vars: list[tuple[str, str]], tools: list[tuple[str, str]]) -> str:
    ...
    lines = [
        "## Sandbox environment",
        "",
        "You are running in an isolated Insights dev sandbox. The items below are provisioned for you.",
    ]
