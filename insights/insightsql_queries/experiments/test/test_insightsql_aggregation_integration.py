...
from insights.insightsql_queries.experiments.base_query_utils import get_metric_value
from insights.insightsql_queries.experiments.insightsql_aggregation_utils import extract_aggregation_and_inner_expr
...
class TestInsightsQLAggregationIntegration(BaseTest):
    ...
    def test_insightsql_aggregation_examples(self):
        """Test various InsightsQL aggregation examples that users might input."""
