...
from insights.models.utils import UUIDT, uuid7
...
class TestQuery(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_join_with_property_materialized_session_id(self):
        with freeze_time("2020-01-10"):
            ...
            assert pretty_print_response_in_tests(response, self.team.pk) == self.snapshot
            assert pretty_print_in_tests(response.insightsql, self.team.pk) == self.snapshot
    ...
    def test_insightsql_groupby_unnecessary_ifnull(self):
        # https://github.com/hanzoai/insights/issues/23077
        query = """
    ...
    def test_numbers_table(self):
        ...
        # Complex subqueries are not supported with `enable_analyzer=0` (see: https://github.com/hanzoai/insights/pull/45000)
