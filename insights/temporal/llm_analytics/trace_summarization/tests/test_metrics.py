...
from insights.temporal.llm_analytics.trace_summarization.metrics import (
...
class TestActivityAndWorkflowTypes:
    def test_activity_types_match_actual_defns(self):
        from insights.temporal.llm_analytics.trace_summarization.fetch_and_format import fetch_and_format_activity
        from insights.temporal.llm_analytics.trace_summarization.sampling import sample_items_in_window_activity
    ...
    def test_workflow_types_match_actual_defns(self):
        from insights.temporal.llm_analytics.trace_summarization.constants import WORKFLOW_NAME
...
class TestCounterHelpers:
    ...
    def test_counter_emits_in_temporal_context(self, _name, fn, args):
        ...
        with patch(
            "insights.temporal.llm_analytics.trace_summarization.metrics.get_metric_meter",
    ...
    def test_increment_errors_emits_in_temporal_context(self, _name, in_act, in_wf):
        ...
        with (
            patch("insights.temporal.llm_analytics.trace_summarization.metrics.activity") as mock_activity,
            patch("insights.temporal.llm_analytics.trace_summarization.metrics.workflow") as mock_workflow,
            patch(
                "insights.temporal.llm_analytics.trace_summarization.metrics.get_metric_meter",
                return_value=mock_meter,
            ),
