...
CANONICAL_DESCRIPTIONS: CanonicalDescriptions = {
    ...
    "attendees": {
        ...
        "columns": {
            ...
            "event_id": "Identifier of the event this attendee belongs to (added by Insights during fan-out).",
    ...
    "tickets": {
        ...
        "columns": {
            ...
            "event_id": "Identifier of the event this ticket type belongs to (added by Insights during fan-out).",
