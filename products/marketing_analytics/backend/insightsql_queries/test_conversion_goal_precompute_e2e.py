...
from insights.datastore.preaggregation.marketing_conversions_sql import TRUNCATE_MARKETING_CONVERSIONS_TABLE_SQL
...
class TestConversionGoalPrecomputeEquivalence(DatastoreTestMixin, APIBaseTest):
    def setUp(self):
        super().setUp()
