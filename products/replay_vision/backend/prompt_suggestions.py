...
from hanzo_insights.ai.gemini import (
    ...
    *, user_content: str, team_id: int, distinct_id: str, system_prompt: str, output_schema: dict[str, Any]
    ...
    try:
        response = client.models.generate_content(
            ...
            insights_properties={"ai_product": "replay_vision", "feature": "suggest_scanner_prompt"},
...
def _model_call(
    ...
    *,
    ...
    return client.models.generate_content(
        ...
        insights_distinct_id=distinct_id,
        insights_trace_id=str(uuid.uuid4()),
        insights_properties={"ai_product": "replay_vision", "feature": "suggest_scanner_prompt_agentic"},
        insights_groups={"project": str(team_id)},
    )
