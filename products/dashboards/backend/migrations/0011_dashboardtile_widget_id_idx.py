...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            sql=(
                'CREATE INDEX CONCURRENTLY IF NOT EXISTS "insights_dashboardtile_widget_id_idx" '
                'ON "insights_dashboardtile" ("widget_id") '
                'WHERE "widget_id" IS NOT NULL'
            ),
            reverse_sql='DROP INDEX CONCURRENTLY IF EXISTS "insights_dashboardtile_widget_id_idx"',
        ),
        migrations.RunSQL(
            sql=(
                'CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS "unique_dashboard_widget" '
                'ON "insights_dashboardtile" ("dashboard_id", "widget_id") '
                'WHERE "widget_id" IS NOT NULL'
            ),
