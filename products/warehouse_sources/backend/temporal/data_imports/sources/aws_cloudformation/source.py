...
from products.warehouse_sources.backend.temporal.data_imports.sources.generated_configs.awscloudformation import (
    AwsCloudformationSourceConfig,
)
...
class AwsCloudformationSource(SimpleSource[AwsCloudformationSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            name=SchemaExternalDataSourceType.AWS_CLOUDFORMATION,
