...
class LinearSource(ResumableSource[LinearSourceConfig, LinearResumeConfig], OAuthMixin):
    ...
    def get_non_retryable_errors(self) -> dict[str, str | None]:
        return {
            ...
            # The Linear OAuth app isn't configured on this Insights instance (missing client id/secret),
            # so the source can't refresh its access token. Deterministic — retrying never resolves it.
            "Linear app not configured": "The Linear app is not configured on this Insights instance. Please contact support.",
        }
