...
const engineeringAnalyticsFlakyTests = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.FlakyTestList>
> => ({
...
const engineeringAnalyticsSources = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.GitHubSource[]>
> => ({
...
const engineeringAnalyticsTeamCiHealth = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.TeamCIHealthList>
> => ({
...
const engineeringAnalyticsWorkflowJobs = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.WorkflowJob[]>
> => ({
...
const engineeringAnalyticsWorkflowRunnerCosts = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.WorkflowRunnerCost[]>
> => ({
...
const pullRequests = (): ToolBase<typeof PullRequestsSchema, WithInsightsUrl<Schemas.PullRequestList>> => ({
    name: 'pull-requests',
...
const workflowHealth = (): ToolBase<typeof WorkflowHealthSchema, WithInsightsUrl<Schemas.WorkflowHealthItem[]>> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof WorkflowHealthSchema>) => {
        ...
        return await withInsightsUrl(context, result, '/engineering-analytics/workflows')
    },
})
