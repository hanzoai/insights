 ...
 *
 * Insights API - MCP 24 enabled ops
...
export const errorTrackingAssignmentRulesCreateBodyFiltersOneValuesItemOnefourTypeDefault = `insightsql`
...
export const errorTrackingBypassRulesCreateBodyFiltersOneValuesItemOnefourTypeDefault = `insightsql`
...
export const errorTrackingBypassRulesUpdateBodyFiltersOneValuesItemOnefourTypeDefault = `insightsql`
...
export const ErrorTrackingExternalReferencesCreateBody = /* @__PURE__ */ zod.object({
    ...
    config: zod
        ...
        .describe(
            'Provider-specific fields describing the external issue to create. Required keys depend on the integration kind: github -> {repository, title, body}; gitlab -> {title, body}; linear -> {team_id, title, description}; jira -> {project_key, title, description}. Examples: github {\"repository\":\"insights\",\"title\":\"Checkout TypeError\",\"body\":\"Stack trace\"}; linear {\"team_id\":\"team-id\",\"title\":\"Checkout TypeError\",\"description\":\"Stack trace\"}; jira {\"project_key\":\"ENG\",\"title\":\"Checkout TypeError\",\"description\":\"Stack trace\"}.'
        ),
...
export const errorTrackingGroupingRulesCreateBodyFiltersOneValuesItemOnefourTypeDefault = `insightsql`
...
export const errorTrackingGroupingRulesUpdateBodyFiltersOneValuesItemOnefourTypeDefault = `insightsql`
...
export const ErrorTrackingQueryIssueEventsCreateBody = /* @__PURE__ */ zod.object({
    ...
    filterGroup: zod
        ...
        .optional()
        .describe('Advanced flat AND property filters applied to sampled events. InsightsQL filters are rejected.'),
    searchQuery: zod
        .string()
...
export const ErrorTrackingQueryIssuesListCreateBody = /* @__PURE__ */ zod.object({
    ...
    filterGroup: zod
        ...
        .optional()
        .describe(
            'Advanced flat AND property filters. Prefer typed shortcut fields when they fit. InsightsQL filters are rejected.'
        ),
    orderBy: zod
    ...
    library: zod
        ...
        .optional()
        .describe('Filter by SDK\/library value from event $lib, for example insights-js.'),
    release: zod
        .string()
    ...
    personId: zod.string().optional().describe('Filter by exact Insights person UUID.'),
    url: zod
        .string()
...
export const errorTrackingSuppressionRulesCreateBodyFiltersOneValuesItemOnefourTypeDefault = `insightsql`
...
export const errorTrackingSuppressionRulesUpdateBodyFiltersOneValuesItemOnefourTypeDefault = `insightsql`
