...
import { insightsTelemetry } from './snapshot-processing/process-all-snapshots'
...
// arrive. Past this grace period a missing full snapshot means the data never reached Insights.
...
export interface sessionRecordingDataCoordinatorLogicActions {
    ...
    loadRecordingCommentsSuccess: (sessionComments: CommentType[], payload?: {
        value: true;
    } | undefined) => {
        payload?: {
            value: true;
    ...
    loadRecordingNotebookCommentsSuccess: (sessionNotebookComments: RecordingComment[], payload?: {
        value: true;
    } | undefined) => {
        payload?: {
            value: true;
    ...
    loadFullEventDataSuccess: (sessionEventsData: RecordingEventType[] | null, payload?: {
        event: RecordingEventType | RecordingEventType[];
    } | undefined) => {
        payload?: {
            event: RecordingEventType | RecordingEventType[];
    ...
    loadRecordingMetaFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    }; // metaLogic
...
export interface sessionRecordingDataCoordinatorLogicMeta {
    ...
    __keaTypeGenInternalSelectorTypes: {
        snapshots: (processedSnapshots: any[]) => RecordingSnapshot[];
        start: (snapshots: any[], sessionPlayerMetaData: SessionRecordingType | null) => Dayjs | null;
        end: (snapshots: any[], sessionPlayerMetaData: SessionRecordingType | null) => Dayjs | null;
        durationMs: (start: Dayjs | null, end: Dayjs | null, sessionPlayerMetaData: SessionRecordingType | null, fullyLoaded: boolean) => number;
        segments: (snapshots: any[], start: Dayjs | null, end: Dayjs | null, trackedWindow: number | null, snapshotsByWindowId: Record<number, eventWithTime[]>, snapshotStore: SnapshotStore, storeVersion: number) => RecordingSegment[];
        snapshotsByWindowId: (snapshots: any[]) => Record<number, eventWithTime[]>;
        bufferedToTime: (segments: import("@hanzo/replay-shared").RecordingSegment[]) => number | null;
        windowIdForTimestamp: (segments: import("@hanzo/replay-shared").RecordingSegment[]) => (timestamp: number) => number | undefined;
        urls: (snapshots: any[]) => {
            timestamp: number;
            url: string;
        }[];
        windowsHaveFullSnapshot: (snapshotsByWindowId: Record<number, eventWithTime[]>) => Record<string, boolean>;
        snapshotsInvalid: (windowsHaveFullSnapshot: Record<string, boolean>, fullyLoaded: boolean, start: Dayjs | null, sessionRecordingId: string, currentTeam: TeamPublicType | TeamType | null) => boolean;
        ...
        createExportJSON: (sessionPlayerMetaData: SessionRecordingType | null, snapshots: any[]) => (() => ExportedSessionRecordingFileV2);
        customRRWebEvents: (snapshots: any[]) => customEvent[];
        effectiveSourceLoadingStates: (sourceLoadingStates: SourceLoadingState[], segments: import("@hanzo/replay-shared").RecordingSegment[]) => SourceLoadingState[];
        fullyLoaded: (snapshots: any[], segments: import("@hanzo/replay-shared").RecordingSegment[], sessionPlayerMetaDataLoading: boolean, snapshotsLoading: boolean, sessionEventsDataLoading: boolean, sessionCommentsLoading: boolean, sessionNotebookCommentsLoading: boolean) => boolean;
        sessionPlayerData: (sessionPlayerMetaData: SessionRecordingType | null, snapshotsByWindowId: Record<number, eventWithTime[]>, segments: import("@hanzo/replay-shared").RecordingSegment[], bufferedToTime: number | null, start: Dayjs | null, end: Dayjs | null, durationMs: number, fullyLoaded: boolean, sessionRecordingId: string) => SessionPlayerData;
    };
}

export type sessionRecordingDataCoordinatorLogicType = MakeLogicType<sessionRecordingDataCoordinatorLogicValues, sessionRecordingDataCoordinatorLogicActions, SessionRecordingDataCoordinatorLogicProps, sessionRecordingDataCoordinatorLogicMeta>;
