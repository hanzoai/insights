...
from llm_gateway.request_context import get_insights_properties
...
class TestChatCompletionsEndpoint:
    ...
    @patch("llm_gateway.api.openai.litellm.acompletion")
    def test_insights_property_headers_reach_request_context(
        self,
        mock_completion: MagicMock,
        ...
        # that apply_insights_context_from_headers mutates. The shared conftest app omits it.
        ...
        def _capture(*args: Any, **kwargs: Any) -> MagicMock:
            captured["properties"] = get_insights_properties()
