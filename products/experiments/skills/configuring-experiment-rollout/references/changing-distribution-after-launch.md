...
Further reading: https://hanzo.ai/docs/experiments/changing-distribution-after-rollout
...
**Analysis**: Users who experienced B and are now in A have behavior that can't be cleanly attributed to either variant — this is bias. Insights handles this with two options:
...
**This is not supported on running experiments** — Insights prevents adding or removing variants on non-draft experiments. Only rollout percentages between existing variants can change.
