# Test cases for datastore-sql-injection rule
...
def vuln_data_get(data):
    ...
    # ruleid: datastore-sql-injection, datastore-fstring-param-audit
...
def vuln_self_request(self):
    ...
    # ok: datastore-fstring-param-audit
    # ruleid: datastore-sql-injection
...
def safe_with_escape_identifier(data):
    column = escape_datastore_identifier(data.get("field"))
    # ok: datastore-sql-injection, datastore-fstring-param-audit
    sync_execute(f"SELECT max(`{column}`) FROM table")


def safe_with_escape_string(data):
    value = escape_datastore_string(data.get("value"))
    # ok: datastore-sql-injection, datastore-fstring-param-audit
...
# ============================================
# FUNCTION PARAMETER CASES - only datastore-fstring-param-audit should match
# ============================================


def vuln_param_str_typed(self, column: str):
    # ok: datastore-sql-injection
    # ruleid: datastore-fstring-param-audit
