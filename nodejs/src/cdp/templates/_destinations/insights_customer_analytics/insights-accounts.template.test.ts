...
import { template as createAccountTemplate } from './insights-create-account.template'
import { template as getAccountTemplate } from './insights-get-account.template'
import { template as tagAccountTemplate } from './insights-tag-account.template'
import { template as updateAccountPropertyTemplate } from './insights-update-account-property.template'
import { template as updateAccountRelationshipsTemplate } from './insights-update-account-relationships.template'
import { template as updateAccountTemplate } from './insights-update-account.template'

const REL_UUID = '0197f9f0-1111-0000-0000-000000000000'

describe('insights customer analytics account templates', () => {
    const cases = [
        {
            name: 'get account',
