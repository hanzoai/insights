...
Adoption is ProductIntent-based for v1. Extension path: plug Datastore usage
counters (insights/tasks/usage_report.py `get_teams_with_*_count_in_period`
...
from insights.models.product_intent.product_intent import ACTIVATION_CHECK_PRODUCT_KEYS, ProductIntent
