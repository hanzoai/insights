...
from products.warehouse_sources.backend.facade import api, contracts, insightsql, hooks, sources, temporal
...
def test_insightsql_reexports_are_the_model_classes() -> None:
    ...
    assert insightsql.ExternalDataSource is _Source
    assert insightsql.DataWarehouseTable is _Table
    assert callable(insightsql.get_view_or_table_by_name)
