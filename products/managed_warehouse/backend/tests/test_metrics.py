...
class TestTemporalMetricTwins:
    ...
    def test_records_temporal_and_insights_metrics(
        self,
        _name: str,
        getter_name: str,
        ...
        with (
            ...
            patch("products.managed_warehouse.backend.metrics.hanzo_insights.default_client", client),
        ):
        ...
        getattr(client.metrics, insights_method).assert_called_once_with(
            insights_name,
            value,
            unit=unit,
