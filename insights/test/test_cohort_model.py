...
from insights.helpers.batch_iterators import FunctionBatchIterator
...
class TestCohort(BaseTest):
    ...
    def test_insert_users_list_by_id_uuid_pairs_skip_validation(self):
        ...
        # The members must also land in the Datastore static cohort table, keyed by uuid.
    ...
    def test_get_static_cohort_size(self):
        ...
        # insights_person was a hot per-PK lookup on the write replica that we
