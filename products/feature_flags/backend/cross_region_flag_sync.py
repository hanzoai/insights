"""
Cross-region sync of Insights's own (team 2) flag definitions into EU's
HyperCache.
...
-- Insights's internal "self" team, used for our own local evaluation
...
import requests
import structlog
from hanzo_insights.request import US_INGESTION_ENDPOINT

from insights.utils import capture_exception_throttled, get_instance_region
...
# unexpected request error) to Insights error tracking, shared across the 30s schedule
