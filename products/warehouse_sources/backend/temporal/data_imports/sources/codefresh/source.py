...
class CodefreshSource(ResumableSource[CodefreshSourceConfig, CodefreshResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Codefresh API key to automatically pull your Codefresh CI/CD data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/codefresh",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
