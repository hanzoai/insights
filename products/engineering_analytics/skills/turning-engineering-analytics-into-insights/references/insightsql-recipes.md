# InsightsQL recipes over the GitHub warehouse tables
...
SELECT
    ...
    (author_handle LIKE '%[bot]'
        OR author_handle IN ('dependabot', 'github-actions', 'insights-bot', 'renovate')) AS is_bot,
...
Collapsing the layers hits Datastore's Array-inside-Nullable rejection and same-`SELECT` alias limits.
