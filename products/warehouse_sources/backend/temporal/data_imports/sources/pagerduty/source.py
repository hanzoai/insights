...
class PagerDutySource(ResumableSource[PagerDutySourceConfig, PagerDutyResumeConfig]):
    ...
    default_version = "2"
    api_docs_url = "https://developer.pagerduty.com/api-reference"
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="PagerDuty",
            caption="""Enter your PagerDuty REST API key to pull your PagerDuty data into the Insights Data warehouse.
...
You can create a read-only API key in your PagerDuty account under **Integrations → API Access Keys**. Select the **Read-only** option — that's all this source needs.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/pagerduty",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
