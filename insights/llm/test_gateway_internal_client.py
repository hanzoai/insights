...
class TestGetWallet:
    @patch("insights.llm.gateway_internal_client.settings")
    def test_parses_known_team_with_ledger_and_recent(self, mock_settings):
        ...
        with patch("insights.llm.gateway_internal_client.httpx.get", return_value=_response(200, payload)) as mock_get:
    ...
    def test_no_ledger_backend(self, mock_settings):
        ...
        with patch("insights.llm.gateway_internal_client.httpx.get", return_value=_response(200, payload)):
            wallet = get_wallet(42)
    ...
    def test_raises_on_http_error(self, mock_settings):
        _configured(mock_settings)
        with patch("insights.llm.gateway_internal_client.httpx.get", return_value=_response(500)):
    ...
    def test_raises_on_non_json_success_body(self, mock_settings):
        ...
        with patch("insights.llm.gateway_internal_client.httpx.get", return_value=non_json):
            with pytest.raises(AIGatewayInternalError, match="wallet read failed"):
                get_wallet(42)
...
class TestAddCredit:
    ...
    def test_posts_body_and_idempotency_header(self, mock_settings):
        ...
        with patch("insights.llm.gateway_internal_client.httpx.post", return_value=_response(200, payload)) as mock_post:
    ...
    def test_duplicate_replay(self, mock_settings):
        ...
        with patch("insights.llm.gateway_internal_client.httpx.post", return_value=_response(200, payload)):
    ...
    def test_raises_with_error_detail_on_4xx(self, mock_settings):
        ...
        with patch("insights.llm.gateway_internal_client.httpx.post", return_value=_response(400, body)):
    ...
    def test_raises_on_non_json_success_body(self, mock_settings):
        ...
        with patch("insights.llm.gateway_internal_client.httpx.post", return_value=non_json):
    ...
    def test_raises_on_success_body_missing_required_fields(self, mock_settings):
        _configured(mock_settings)
        with patch("insights.llm.gateway_internal_client.httpx.post", return_value=_response(200, {"team_id": 42})):
    ...
    def test_accepts_zero_balance(self, mock_settings):
        ...
        with patch("insights.llm.gateway_internal_client.httpx.post", return_value=_response(200, body)):
