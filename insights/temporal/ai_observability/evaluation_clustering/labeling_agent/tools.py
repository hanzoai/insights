...
def get_evaluator_config(
    ...
    """Fetch the full Evaluation config (name, description, prompt / script code, output shape).
    ...
    the evaluator's actual rubric — the llm_judge prompt, the script source, the N/A
    ...
    """
    from insights.models.team import Team
    from insights.temporal.ai_observability.evaluation_clustering.data import fetch_evaluator_configs
