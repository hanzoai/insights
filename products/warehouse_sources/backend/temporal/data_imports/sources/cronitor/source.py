...
class CronitorSource(ResumableSource[CronitorSourceConfig, CronitorResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Import your Cronitor monitors, their recent job invocations, and time-series reliability metrics into the Insights Data warehouse.
...
Create an API key with the `monitor:read` scope under **Settings → API keys** in your Cronitor account, and enter it here.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/cronitor",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
