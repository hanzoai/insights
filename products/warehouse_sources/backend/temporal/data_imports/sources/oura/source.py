...
class OuraSource(ResumableSource[OuraSourceConfig, OuraResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Oura personal access token to automatically pull your Oura Ring health data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/oura",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
