...
from insights.kafka_client.client import _AsyncKafkaProducer
from insights.kafka_client.topics import KAFKA_LOG_ENTRIES
from insights.temporal.common.logger import BACKGROUND_LOGGER_TASKS, configure_logger, resolve_log_source
...
async def producer():
    ...
    """
    from insights.kafka_client.routing import new_async_producer
...
def test_log_messages_renderer_event_level_log_source_override():
    ...
    """
    from insights.temporal.common.logger import LogMessagesRenderer
    ...
    from insights.temporal.common.logger import Logger
...
def test_log_messages_renderer_keeps_structured_fields_out_of_the_produce_message():
    ...
    """
    from insights.temporal.common.logger import Logger, LogMessagesRenderer

    renderer = LogMessagesRenderer(event_key="msg")
    event_dict = {
        "msg": "Running datastore query",
    ...
    assert json.loads(produced)["message"] == "Running datastore query"
