...
class PlanhatSource(ResumableSource[PlanhatSourceConfig, PlanhatResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Planhat API access token to pull your customer success data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/planhat",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
