...
from insights.models.person.util import get_persons_by_uuids
...
def _get_persons_by_email(
    ...
    """Batch look up persons by their properties.email value via Datastore.
    ...
    Uses the InsightsQL ``persons`` virtual table (argMax dedup handled
    automatically).
    """
    if not emails:
        return {}
    ...
    with personinsights_caller_tag("conversations/email-person-lookup"):
