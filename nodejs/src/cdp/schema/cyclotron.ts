...
// The invariants the cyclotron-script worker relies on when it enriches and
...
export const InsightsFunctionInvocationGlobalsSchema = z
    .object({
        project: z
            .object({
                id: z.number(),
...
// input-key references that the executor resolves against `InsightsFunction.inputs`
