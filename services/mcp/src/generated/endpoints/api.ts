...
export const EndpointsCreateBody = /* @__PURE__ */ zod
    .object({
        ...
        query: zod
            .unknown()
            .optional()
            .describe('InsightsQL or insight query this endpoint executes. Changing this auto-creates a new version.'),
...
/**
 * Ask AI to rewrite the endpoint's query into a semantically equivalent form that can be materialized. Only applicable to SQL (InsightsQL) endpoints that currently fail the materialization checks. The suggestion is validated against the live checks before being returned; nothing is saved. Requires the organization's AI data processing approval.
 */
...
export const endpointsRunCreateBodyFiltersOverrideOnePropertiesOneItemOnethreeTypeDefault = `insightsql`
...
export const EndpointsRunCreateBody = /* @__PURE__ */ zod.object({
    ...
    debug: zod
        ...
        .describe('Whether to include debug information (such as the executed InsightsQL) in the response.'),
