...
// Stub Tree: render each node (recursively) via renderItem, clickable to fire onFolderClick.
jest.mock('lib/elements/Tree/Tree', () => {
    ...
    return {
        Tree: ({ data, onFolderClick, renderItem }: any) => {
...
describe('DashboardsTree', () => {
    ...
    it('onFolderClick ignores an undefined folder — the null guard never throws or navigates', () => {
        ...
        render(<DashboardsTree />)
        // No click path produces undefined, but Tree's type allows it; the guard must hold.
