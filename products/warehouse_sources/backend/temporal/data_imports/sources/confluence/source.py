...
class ConfluenceSource(ResumableSource[ConfluenceSourceConfig, ConfluenceResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Atlassian Confluence Cloud credentials to pull your Confluence content into the Insights Data warehouse.
...
Only Confluence Cloud sites (`your-domain.atlassian.net`) are supported.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/confluence",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
