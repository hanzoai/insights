...
# definitely stopped.
LOCK_KEY = "insights:auth_token_verification:lock"
...
def verify_and_fix_auth_token_cache_task(self: PushGatewayTask) -> None:
    ...
    Runs every 6 hours. Scans all insights:auth_token:* keys in Redis,
    ...
    Metrics: insights_tombstone_total{namespace="auth_token", component="auth_token_cache_verifier"}
    """
    ...
    try:
        ...
        from insights.storage.auth_token_cache_verifier import verify_and_fix_auth_token_cache
