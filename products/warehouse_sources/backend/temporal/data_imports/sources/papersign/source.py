...
class PapersignSource(ResumableSource[PapersignSourceConfig, PapersignResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Paperform API key to sync your Papersign documents, folders, and spaces into the Insights Data warehouse.
...
The Papersign API requires a paid Paperform plan (Standard or Business tier).""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/papersign",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
