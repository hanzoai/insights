...
export interface UserInterviewTopicApi {
    ...
    /**
     * Insights distinct IDs of people to interview. May be combined with interviewee_emails.
     * @items.maxLength 400
     */
...
export interface IntervieweeIdentifierRequestApi {
    /**
     * Email address or Insights distinct ID for the interviewee. Email-shaped values (including the `Display Name <email@host>` form) are routed to `interviewee_emails`; everything else lands in `interviewee_distinct_ids`.
     * @maxLength 400
     */
    identifier: string
}
...
export interface PreviewInviteRequestApi {
    /**
     * Which targeted interviewee to render the preview for (an email or Insights distinct ID already on the topic). Leave blank to preview for the first targeted interviewee.
     * @maxLength 400
     */
    interviewee_identifier?: string
}
...
export interface IntervieweeContextApi {
    ...
    readonly created_at: string
    /**
     * Identifier for the interviewee — typically an email address or Insights distinct ID. Must match a value in the parent topic's interviewee_emails or interviewee_distinct_ids.
     * @maxLength 400
     */
    interviewee_identifier: string
    /**
...
export interface UserInterviewSearchResultApi {
    ...
    /** Email or Insights distinct ID of the interviewee. */
    interviewee_identifier: string
    /**
