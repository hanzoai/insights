    ...
    return [
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        We call Mistral through the OpenAI client and generate a response. We'll use Insights's OpenAI
                        ...
                        Insights client along with the Mistral config (the base URL and API key) to our OpenAI wrapper.
                    </Markdown>
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        Now, when you call Mistral with the OpenAI SDK, Insights automatically captures an
