...
- **Validator:** - **Checked:** the review-script-validation-criteria skill (v1), the current `products/stamphog/README.md`, and whether a documentation em dash clears the ReviewHog bar.
