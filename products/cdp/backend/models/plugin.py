...
from insights.plugins.access import can_install_plugins
from insights.plugins.plugin_server_api import populate_plugin_capabilities_on_workers, reload_plugins_on_workers
from insights.plugins.site import get_decide_site_apps, get_decide_site_functions
...
class PluginConfig(models.Model):
    team = models.ForeignKey("insights.Team", on_delete=models.CASCADE, null=True)
    ...
    class Meta:
        db_table = "insights_pluginconfig"
        indexes = [
...
class PluginAttachment(models.Model):
    ...
    class Meta:
        db_table = "insights_pluginattachment"
...
class PluginStorage(models.Model):
    ...
    class Meta:
        db_table = "insights_pluginstorage"
        constraints = [
...
def transpile(input_string: str, type: Literal["site", "frontend"] = "site") -> Optional[str]:
    from insights.settings.base_variables import BASE_DIR
...
class PluginSourceFile(UUIDTModel):
    class Meta:
        db_table = "insights_pluginsourcefile"
