...
export function WorkflowMetricsSummary({
    ...
    const emailColumns: TableColumns<EmailMetricRow> = useMemo(() => {
        return [
            {
                title: 'Step',
                key: 'step',
    ...
    const pushColumns: TableColumns<PushMetricRow> = useMemo(() => {
        return [
            {
                title: 'Step',
                key: 'step',
            ...
            <div className="flex flex-row gap-2 flex-wrap justify-center">
                <div className="flex flex-1 flex-col relative border rounded p-3 bg-surface-primary min-w-[16rem]">
                    <div className="flex flex-col h-full">
                        <Label info={WORKFLOW_SUMMARY_METRICS.in_progress.description}>
                        ...
                        <div className="flex flex-1 items-center justify-center">
                            {inProgressTotalLoading ? (
                                ...
                                <Label className="text-muted text-md mb-2">No workflows in progress</Label>
                            ) : (
                ...
                {hasConversionGoal && (
                    <div className="flex flex-1 flex-col relative border rounded p-3 bg-surface-primary min-w-[16rem]">
                        <div className="flex flex-col h-full">
                            <Label info="Share of started workflow runs that recorded a conversion (Converted ÷ Started) over the selected date range.">
                                Conversion rate
                            </Label>
                            <div className="flex flex-1 items-center justify-center">
                                {conversionStatsLoading ? (
                                    ...
                                    <Label className="text-muted text-md mb-2">No workflows started</Label>
                                ) : (
