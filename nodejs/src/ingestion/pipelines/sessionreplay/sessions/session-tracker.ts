...
export class SessionTracker {
     ...
     *   keeps the key prefix exactly `@hanzo/replay/session-seen` so existing sessions aren't seen as
    ...
    constructor(
        ...
        this.keyPrefix = keyNamespace ? `@hanzo/replay/${keyNamespace}/session-seen` : '@hanzo/replay/session-seen'
