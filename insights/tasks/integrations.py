...
from insights.models.integration import FirebaseIntegration, GitHubIntegration, GoogleCloudIntegration
...
def refresh_integrations() -> int:
    from insights.models.integration import Integration, OauthIntegration
