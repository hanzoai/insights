...
export interface dashboardTemplateModalLogicValues {
    createPayload: DashboardTemplateEditorType | null
    dashboardDescription: string
    editingTemplate: DashboardTemplateType | null
    isOpen: boolean
    mode: 'create' | 'edit'
    projectTemplateSave: boolean | null
    projectTemplateSaveLoading: boolean
    templateName: string
    templateTags: string[]
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface dashboardTemplateModalLogicActions {
    closeModal: () => CloseModalActionPayload
    openCreate: (payload: DashboardTemplateEditorType) => {
        payload: DashboardTemplateEditorType
    }
    openEdit: (template: DashboardTemplateType) => {
        template: DashboardTemplateType
    }
    saveProjectTemplate: () => any
    saveProjectTemplateFailure: (
        error: string,
        errorObject?: any
    ) => {
        error: string
    ...
    saveProjectTemplateSuccess: (
        projectTemplateSave: null | true,
        payload?: any
    ) => {
        projectTemplateSave: null | true
        payload?: any
    }
    setDashboardDescription: (dashboardDescription: string) => {
        dashboardDescription: string
    }
    setTemplateName: (name: string) => {
        name: string
    }
    setTemplateTags: (templateTags: string[]) => {
        templateTags: string[]
    }
}

export type dashboardTemplateModalLogicType = MakeLogicType<
    dashboardTemplateModalLogicValues,
    dashboardTemplateModalLogicActions
>
                    ...
                    try {
                        if (values.mode === 'create') {
                            if (!values.createPayload) {
                                toast.error('Missing template payload')
                                return null
                            }
