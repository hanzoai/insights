...
const urlMatchingAction: ActionData = {
    ...
    created_by: { first_name: 'Jane', email: 'jane@hanzo.ai' },
    steps: [
        {
            event: '$pageview',
            url: '/pricing',
    ...
    _insightsUrl: 'https://us.hanzo.ai/project/1/data-management/actions/1',
}
...
const multiStepAction: ActionData = {
    ...
    _insightsUrl: 'https://us.hanzo.ai/project/1/data-management/actions/2',
}
...
const sampleListData: ActionListData = {
    ...
    _insightsUrl: 'https://us.hanzo.ai/project/1/data-management/actions',
}
