...
export function SurveySidebar(): JSX.Element | null {
    ...
    const handleArchive = (): void => {
        ...
        if (
            window.confirm(
                'Archive this survey? It will be hidden from the toolbar list. You can restore it from the Insights surveys page.'
            )
        ) {
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-5">
                    ...
                    <p className="text-xs text-muted m-0 leading-snug">
                        ...
                        <Link to={joinWithUiHost(uiHost, urls.surveys())} target="_blank" subtle>
                            Open in Insights <IconExternal className="inline w-3 h-3" />
                        </Link>
                    </p>
                    <QuestionSection />
