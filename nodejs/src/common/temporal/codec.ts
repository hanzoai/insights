...
/**
 * Fernet-compatible encryption codec that matches Insights's Python EncryptionCodec.
 *
 * The Python side (insights/temporal/common/codec.py) derives each Fernet key by
