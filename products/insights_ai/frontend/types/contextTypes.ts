/**
 * Abstract, domain-agnostic attached-context shape for the Insights AI surface. The surface never
...
export interface AttachedContextItem {
     ...
     * is 'instructions': it renders into the trusted `<insights_trusted_context>` block the agent is
