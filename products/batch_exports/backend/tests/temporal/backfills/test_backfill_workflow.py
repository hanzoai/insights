...
from products.batch_exports.backend.tests.temporal.utils.datastore import truncate_events
...
@pytest_asyncio.fixture
async def events_batch_export(temporal_client, ateam, datastore_client, bucket_name, object_storage_client):
