...
use super::PersonInsightsBackend;

/// Backend implementation that forwards requests to a personinsights-replica service.
pub struct ReplicaBackend {
    client: PersonInsightsReplicaClient<Channel>,
}
...
impl ReplicaBackend {
    ...
    pub fn new(
        ...
        Ok(Self {
            client: PersonInsightsReplicaClient::new(channel),
        })
    }
}

#[async_trait]
impl PersonInsightsBackend for ReplicaBackend {
