...
class LaceworkSource(ResumableSource[LaceworkSourceConfig, LaceworkResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Link your Lacework FortiCNAPP account to pull alerts, vulnerabilities, and compliance data into the Insights Data warehouse.
...
Your account name is the first part of your FortiCNAPP URL: `https://<account name>.lacework.net`.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/lacework",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
