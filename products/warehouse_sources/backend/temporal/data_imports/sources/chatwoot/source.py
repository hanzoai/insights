...
class ChatwootSource(
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Sync conversations, messages, contacts, agents, and more from Chatwoot into the Insights Data warehouse.
...
For self-hosted Chatwoot, set your instance URL (for example `https://chatwoot.example.com`); leave it empty for Chatwoot Cloud.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/chatwoot",
