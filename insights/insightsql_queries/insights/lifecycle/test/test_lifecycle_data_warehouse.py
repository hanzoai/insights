...
from insights.insightsql_queries.legacy_compatibility.clean_properties import clean_entity_properties
...
TEST_BUCKET = "test_storage_bucket-insights.insightsql_queries.insights.lifecycle.lifecycle_data_warehouse"


class TestLifecycleDataWarehouse(DatastoreTestMixin, APIBaseTest):
    def setUp(self):
        super().setUp()
        self.cleanup_fns = []
        self.temp_dirs = []
        ...
        self.assertEqual(
            {
                ...
                "aggregation_target_field": "users.person_id",
                "created_at_field": "users.signed_up",
                "id": "insights_test_sent_messages",
            },
