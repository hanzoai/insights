...
export interface insightDataLogicMeta {
    ...
    __keaTypeGenInternalSelectorTypes: {
        ...
        canEditInSqlEditor: (insightsQL: string | null, query: Node<Record<string, any>> | null) => boolean
    }
}
...
export const insightDataLogic = kea<insightDataLogicType>([
    ...
    selectors({
        ...
        canEditInSqlEditor: [
            (s) => [s.insightsQL, s.query],
            (insightsQL: string | null, query: Node | null): boolean =>
