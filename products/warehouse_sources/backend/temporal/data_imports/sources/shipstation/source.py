...
class ShipStationSource(ResumableSource[ShipStationSourceConfig, ShipStationResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="ShipStation",
            caption="""Enter your ShipStation API credentials to pull your ShipStation shipping data into the Insights data warehouse.
...
API access requires a ShipStation plan tier that includes it.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/shipstation",
