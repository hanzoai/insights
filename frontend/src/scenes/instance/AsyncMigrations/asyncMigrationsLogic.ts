...
export interface asyncMigrationsLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface asyncMigrationsLogicActions {
    ...
    loadAsyncMigrationSettings: () => any
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface asyncMigrationsLogicMeta {
...
export type asyncMigrationsLogicType = MakeLogicType<
    asyncMigrationsLogicValues,
    asyncMigrationsLogicActions,
    Record<string, any>,
    asyncMigrationsLogicMeta
>
...
export const asyncMigrationsLogic = kea<asyncMigrationsLogicType>([
    ...
    selectors({
        ...
        actionableMigrations: [
            (s) => [s.asyncMigrations],
            (asyncMigrations: AsyncMigration[]) => asyncMigrations.filter((migration) => migration.is_available),
        ],
        futureMigrations: [
            (s) => [s.asyncMigrations],
            (asyncMigrations: AsyncMigration[]) => asyncMigrations.filter((migration) => !migration.is_available),
