...
export function AIObservabilityReviewQueues(): JSX.Element {
    ...
    const queueColumns: TableColumns<ReviewQueueApi> = [
        {
            title: 'Name',
            dataIndex: 'name',
            key: 'name',
    ...
    const queueItemColumns: TableColumns<ReviewQueueItemApi> = [
        {
            title: 'Trace',
            dataIndex: 'trace_id',
            key: 'trace_id',
    ...
    return (
        <div className="space-y-4">
                                ...
                                <div className="flex gap-3 items-start justify-between flex-wrap">
                                    <div className="space-y-2 min-w-0">
                                        <div className="flex items-start gap-2.5 flex-wrap">
                                            ...
                                            <Tag type="muted" className="mt-0.5 shrink-0">
            ...
            {queueEditorMode ? (
                <Modal isOpen onClose={closeQueueEditor} simple maxWidth="28rem">
                    <ModalHeader>{queueEditorTitle}</ModalHeader>
