...
import { Select, type SelectOptionLeaf } from 'lib/elements/Select'
...
export function SessionReplayWidgetTileFilters({
    ...
    const collectionSelectOptions = useMemo<SelectOptionLeaf<string>[]>(
        () => [
    ...
    const savedFilterSelectOptions = useMemo<SelectOptionLeaf<string>[]>(
        () => [
