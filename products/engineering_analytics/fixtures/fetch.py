...
Load the result into a local Insights stack with:

    python manage.py seed_engineering_analytics --team-id <id>

Usage:
    python products/engineering_analytics/fixtures/fetch.py
    python products/engineering_analytics/fixtures/fetch.py --repo Insights/insights --days 30 --max-prs 300
"""
...
def main() -> None:
    ...
    parser.add_argument("--repo", default="Insights/insights", help="owner/name repo to snapshot (default: %(default)s)")
