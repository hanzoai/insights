...
with the same name and attributes pushed into the Insights Metrics product via
insights/otel_metrics.py (no-op unless OTEL_METRICS_EXPORT_URL/TOKEN are configured).
