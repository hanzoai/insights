...
export type sessionRecordingFilePlaybackSceneLogicType = MakeLogicType<
    sessionRecordingFilePlaybackSceneLogicValues,
    sessionRecordingFilePlaybackSceneLogicActions,
    Record<string, any>,
    sessionRecordingFilePlaybackSceneLogicMeta
>
