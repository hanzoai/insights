...
export interface formLogicType extends Logic {
    ...
    actions: {
        ...
        resetMyForm: (values?: { email: string; name: string; pineappleOnPizza: false }) => void
        submitMyForm: () => void
        submitMyFormRequest: (myForm: { email: string; name: string; pineappleOnPizza: false }) => void
        submitMyFormSuccess: (myForm: { email: string; name: string; pineappleOnPizza: false }) => void
    ...
    asyncActions: {
        ...
        resetMyForm: (values?: { email: string; name: string; pineappleOnPizza: false }) => Promise<any>
        submitMyForm: () => Promise<any>
        submitMyFormRequest: (myForm: { email: string; name: string; pineappleOnPizza: false }) => Promise<any>
        submitMyFormSuccess: (myForm: { email: string; name: string; pineappleOnPizza: false }) => Promise<any>
