...
from insights.temporal.data_imports.sources.common import config
...
from insights.temporal.data_imports.sources.common.utils import dlt_source_to_source_response
from insights.temporal.data_imports.sources.generated_configs import HubspotSourceConfig
from insights.temporal.data_imports.sources.hubspot.auth import hubspot_refresh_access_token
from insights.temporal.data_imports.sources.hubspot.hubspot import hubspot
from insights.temporal.data_imports.sources.hubspot.settings import ENDPOINTS as HUBSPOT_ENDPOINTS
...
class HubspotSource(SimpleSource[HubspotSourceConfig | HubspotSourceOldConfig], OAuthMixin):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/hubspot",
            featured=True,
            fields=cast(
                list[FieldType],
                [
