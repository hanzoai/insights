...
class CanvasInsightsCapabilitiesSerializer(serializers.Serializer):
...
class CanvasCapabilitiesSerializer(serializers.Serializer):
    insights = CanvasInsightsCapabilitiesSerializer()
...
class CanvasSourceProjectSerializer(serializers.Serializer):
    ...
    dependencies = serializers.DictField(
        ...
        help_text=(
            ...
            "@hanzo/quill, recharts, lucide-react, dayjs) at their pinned versions."
        ),
    )
    ...
    capabilities = CanvasCapabilitiesSerializer(
        ...
        help_text=(
            ...
            "canvas loads, every event it captures, and inlineQueries when it runs ad-hoc InsightsQL — the "
...
class CanvasArtifactManifestSerializer(serializers.Serializer):
    ...
    capabilities = serializers.DictField(
        help_text="Declared Insights/network capabilities the artifact is held to at runtime.",
    )
