...
export interface teamLogicValues {
    ...
    currentTeamIdStrict: number | string
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface teamLogicActions {
    ...
    addProductIntent: (properties: ProductIntentProperties) => ProductIntentProperties
    ...
    addProductIntentForCrossSell: (properties: ProductCrossSellProperties) => ProductCrossSellProperties
    ...
    updateCurrentTeam: (payload: Partial<TeamType>) => Partial<TeamType>
...
export interface teamLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        ...
        currentTeamIdStrict: (currentTeam: TeamPublicType | TeamType | null) => number | string
        currentProjectId: (currentTeam: TeamPublicType | TeamType | null) => number | string
...
export type teamLogicType = MakeLogicType<teamLogicValues, teamLogicActions, Record<string, any>, teamLogicMeta>
...
export const teamLogic = kea<teamLogicType>([
    ...
    selectors(() => ({
        ...
        currentTeamId: [
            (selectors) => [selectors.currentTeam],
            (currentTeam: TeamPublicType | TeamType | null): number | null => (currentTeam ? currentTeam.id : null),
        ],
        ...
        currentTeamIdStrict: [
            (selectors) => [selectors.currentTeam],
            (currentTeam: TeamPublicType | TeamType | null): number | string => {
                if (!currentTeam || !currentTeam.id) {
                    ...
                    insights.captureException(new Error('currentTeamId accessed before team loaded'), {
                        severity: 'warning',
        ...
        currentProjectId: [
            ...
            (currentTeam: TeamPublicType | TeamType | null): number | string => {
                if (!currentTeam || !currentTeam.project_id) {
                    ...
                    // then restore the throw. Temporarily falling back to "@current" to avoid crashes.
                    insights.captureException(new Error('currentProjectId accessed before team loaded'), {
                        severity: 'warning',
                        tag: 'selector_accessed_before_loaded',
                    })
                    return '@current'
        ...
        isCurrentTeamUnavailable: [
            ...
            (currentTeam: TeamPublicType | TeamType | null, currentTeamLoading: boolean): boolean =>
        ...
        funnelCorrelationConfig: [
            (selectors) => [selectors.currentTeam],
            (currentTeam: TeamPublicType | TeamType | null): CorrelationConfigType => {
        ...
        weekStartDay: [
            (selectors) => [selectors.currentTeam],
            (currentTeam: TeamPublicType | TeamType | null): number => currentTeam?.week_start_day || 0,
        ],
        ...
        testAccountFilterFrequentMistakes: [
            (selectors) => [selectors.currentTeam],
            (currentTeam: TeamPublicType | TeamType | null): FrequentMistakeAdvice[] => {
                if (!currentTeam) {
                    return []
                }
