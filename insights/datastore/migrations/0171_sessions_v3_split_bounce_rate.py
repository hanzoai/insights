...
from insights.models.raw_sessions.migrations_v3 import SPLIT_BOUNCE_RATE
...
operations = [
    # this is a copy of migration 167, to apply the changes that were introduced at the same time as the migration verifier
