...
from insights.schema import DetectorType

if TYPE_CHECKING:
    from insights.tasks.alerts.detectors.base import BaseDetector
...
def _ensure_registered() -> None:
    ...
    from insights.tasks.alerts.detectors import ensemble, threshold  # noqa: F401

    # PyOD detectors (require pyod package, already a core dependency)
    from insights.tasks.alerts.detectors.pyod_detectors import (  # noqa: F401
        copod,
        ecod,
        hbos,
        isolation_forest,
    ...
    from insights.tasks.alerts.detectors.statistical import iqr, mad, zscore  # noqa: F401
