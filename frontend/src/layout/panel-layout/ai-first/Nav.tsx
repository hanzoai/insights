...
import { IconApps, IconChat, IconChevronRight, IconPlusSmall } from '@hanzo/icons'
        ...
        <div className="flex gap-0 relative">
            ...
            >
                        ...
                        {isLayoutNavCollapsed && (
                            <ButtonPrimitive
                                ...
                                onClick={() => {
                                    ...
                                    insights.capture('nav chat panel toggled', {
                                        is_open: isOpening,
                                    })
                ...
                {showCreateButton && (
                    <div className={cn('px-2 py-1', isLayoutNavCollapsed && 'flex justify-center px-0')}>
                        ...
                        <DropdownMenu
                            onOpenChange={(open) => {
                                if (open) {
                                    insights.capture('nav create button clicked')
                                }
                            }}
                        >
                ...
                <Tabs.Root
                    ...
                    onValueChange={(value) => {
                        insights.capture('nav tab clicked', { tab: value })
