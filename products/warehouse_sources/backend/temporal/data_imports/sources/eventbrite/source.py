...
class EventbriteSource(ResumableSource[EventbriteSourceConfig, EventbriteResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Eventbrite private token to automatically pull your Eventbrite data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/eventbrite",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
