...
class Hook(models.Model):
    ...
    user = models.ForeignKey("insights.User", related_name="rest_hooks", on_delete=models.CASCADE)
    team = models.ForeignKey("insights.Team", related_name="rest_hooks", on_delete=models.CASCADE)
