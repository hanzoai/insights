...
from insights.insightsql.ast import AST, AST_CLASSES, Constant, Expr, InsightsQLXAttribute, InsightsQLXTag
...
def deserialize_hx_tag(hog_tag: dict) -> InsightsQLXTag:
    ...
    for k, v in hog_tag.items():
        ...
        attributes.append(InsightsQLXAttribute(name=k, value=value))
