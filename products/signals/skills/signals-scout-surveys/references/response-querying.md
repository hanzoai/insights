...
Insights writes each answer under two property keys and the product reads them with a
...
- **id-based** (modern insights-js): `$survey_response_<question_id>` — the question's UUID.
