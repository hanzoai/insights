...
//   INGESTION_DOWNSTREAM — warpstream-ingestion cluster; Datastore-bound outputs
...
/** DOWNSTREAM — warpstream-ingestion cluster; Datastore-bound outputs. */
...
/** DOWNSTREAM — warpstream-ingestion cluster (Datastore-bound); in-cluster plaintext. */
