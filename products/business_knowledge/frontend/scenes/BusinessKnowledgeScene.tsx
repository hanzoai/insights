    ...
    return (
        <SceneContent>
            <SceneTitleSection
                ...
                description="Upload text, public URLs, or files so Insights AI can understand your business context, vision, and policies."
                resourceType={{ type: 'default_icon_type', forceIcon: <IconBook /> }}
                actions={
                    <Button type="primary" icon={<IconPlusSmall />} onClick={() => openCreateModal()}>
                        Add source
                    </Button>
                }
            />
            ...
            <Table<KnowledgeSource>
                ...
                columns={[
                    ...
                    },
                    {
                        title: 'Type',
                        key: 'source_type',
                        render: (_, row) => <Tag>{row.source_type}</Tag>,
                    },
                    {
                        title: 'Status',
                        key: 'status',
            ...
            panels={[
                {
                    ...
                    content: loading ? (
                        ...
                        <div className="space-y-2">
                            ...
                            {suggestions.map((gap) => (
                                <Card key={gap.normalized_topic} className="flex items-center justify-between p-3">
