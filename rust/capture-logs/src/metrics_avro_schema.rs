...
"fields": [
    ...
    "type": ["null", "long"],
    "default": null,
    "doc": "Stable per-series identity assigned at ingest (hash of metric_name, metric_type, service_name, and sorted resource/data-point attributes). Stored verbatim by Datastore, never recomputed. u64 bits carried as a signed long."
    }
]
}"#;
