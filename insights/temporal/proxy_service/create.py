...
from insights.temporal.proxy_service.monitor import MonitorManagedProxyInputs
from insights.temporal.proxy_service.proto import CertificateState_READY, CreateRequest, StatusRequest
