...
from insights.session.middleware import UserAuthSessionActivityMiddleware
...
class TestUserAuthSessionActivityMiddleware(BaseTest):
    ...
    def test_syncs_metadata_for_normal_responses(self):
        ...
        with patch("insights.session.middleware.sync_current_session_metadata") as mock_sync:
