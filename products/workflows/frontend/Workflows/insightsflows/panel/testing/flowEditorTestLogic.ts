...
import { escapePropertyAsInsightsQLIdentifier, insightsql } from '~/queries/utils'
import {
    AnyPropertyFilter,
...
export interface FlowTestInvocation {
    globals: string
...
// InsightsQL tuple columns appended to the events query so we can resolve each group type's
...
export interface flowEditorTestLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface flowEditorTestLogicActions {
    ...
    loadSampleEventByNameFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadSampleEventByNameSuccess: (sampleGlobals: CyclotronJobInvocationGlobals | null, payload?: {
        eventName: string;
        extendedSearch: boolean | undefined;
    }) => {
        sampleGlobals: CyclotronJobInvocationGlobals | null;
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface flowEditorTestLogicMeta {
    key: string;
    __keaTypeGenInternalSelectorTypes: {
        shouldLoadSampleGlobals: (triggerAction: ({
            config: {
                type: "schedule";
            } | {
                filters: {
        ...
        groupTypesForTest: (groupsEnabled: boolean, groupTypes: Map<GroupTypeIndex, GroupType>) => Map<GroupTypeIndex, GroupType>;
        matchingFilters: (triggerAction: ({
            config: {
                type: "schedule";
            } | {
                filters: {
            ...
            type: "trigger";
            updated_at?: number | undefined;
        } & Record<string, unknown>) | null) => PropertyGroupFilter;
        workflowVariableDefaults: (workflow: InsightsFlow) => Record<string, any>;
    };
}

export type flowEditorTestLogicType = MakeLogicType<flowEditorTestLogicValues, flowEditorTestLogicActions, WorkflowLogicProps, flowEditorTestLogicMeta>;

export const flowEditorTestLogic = kea<flowEditorTestLogicType>([
    path((key) => ['products', 'workflows', 'frontend', 'Workflows', 'insightsflows', 'actions', 'workflowTestLogic', key]),
    ...
    connect((props: WorkflowLogicProps) => ({
        ...
        actions: [flowEditorLogic, ['setSelectedNodeId', 'setAnimatingEdgePair']],
    })),
    actions({
                                    ...
                                    values: [
                                        {
                                            ...
                                            key: insightsql`event = ${eventName}`,
                                        },
                                    ],
                                },
                            ],
    ...
    selectors(() => ({
        ...
        // TODO(workflows): DRY up matchingFilters with implementation in insightsFunctionConfigurationLogic
        matchingFilters: [
            (s) => [s.triggerAction],
        ...
        workflowVariableDefaults: [
            (s) => [s.workflow],
            (workflow: import('../../types').InsightsFlow): Record<string, any> =>
