import type { PointClickData, TooltipConfig } from '@hanzo/quill-charts'
...
/** Identifies which breakdown variant a script-charts series maps back to, so click and
...
/** Maps the funnel steps onto grouped script-charts bar series — one series per breakdown
