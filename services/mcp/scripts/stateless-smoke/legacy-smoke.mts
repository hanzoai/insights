// Smoke-tests the Insights MCP server's legacy dialect (≤2025-11-25) — the
...
const client = new Client({ name: 'insights-legacy-smoke', version: '0.0.1' }, { capabilities: {} })
...
const fallback = await rawPost('initialize', {
    ...
    capabilities: {},
    clientInfo: { name: 'insights-legacy-smoke', version: '0.0.1' },
})
check(
