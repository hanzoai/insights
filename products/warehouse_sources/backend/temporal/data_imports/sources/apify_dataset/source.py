...
class ApifyDatasetSource(ResumableSource[ApifyDatasetSourceConfig, ApifyResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Apify API token and the ID of the dataset you want to import into the Insights Data warehouse.
...
The token needs read access to the dataset's storage.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/apify-dataset",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
