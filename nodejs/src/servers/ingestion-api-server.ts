...
export class IngestionApiServer implements NodeServer {
    ...
    // Held so shutdown cleanup can produce Datastore messages returned by a
    ...
    private async startServices(): Promise<void> {
        ...
        this.groupStore = new BatchWritingGroupStore(groupRepository, datastoreGroupRepository, {
        ...
        const joinedPipelineConfig: JoinedIngestionPipelineConfig = {
            ...
            cdpHogWatcherSampleRate: this.config.CDP_FN_WATCHER_SAMPLE_RATE,
            outputs: ingestionOutputs,
    ...
    private async handleIngestRequest(
        ...
        try {
            ...
            // Rust consumer, so all work must finish before responding. The script
