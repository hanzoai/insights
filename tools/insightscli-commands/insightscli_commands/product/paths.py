...
# product/ -> insightscli_commands/ -> insightscli-commands/ -> tools/ -> repo root
...
DJANGO_SETTINGS = REPO_ROOT / "insights" / "settings" / "web.py"
...
def find_views_path(backend_dir: Path) -> tuple[Path | None, bool]:
    ...
    # `insightscli product:isolate:move` relocates multi-viewset products into a
