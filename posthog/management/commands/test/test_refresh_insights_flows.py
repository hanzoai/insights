...
from posthog.management.commands.refresh_insights_flows import remove_event_filters_from_conditionals
...
class TestRefreshInsightsFlows(BaseTest):
    def setUp(self):
        ...
        with patch("posthog.models.insights_flow.insights_flow.reload_insights_flows_on_workers"):
            trigger_config_1 = {
                "type": "event",
                "filters": {
