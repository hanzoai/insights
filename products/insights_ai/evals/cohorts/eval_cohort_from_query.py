...
To run::
    ...
    flox activate -- bash -c "set -a; source .env; set +a; python -m products.insights_ai.eval_harness.harness eval_cohort_from_query"
"""
...
from products.insights_ai.evals.cohorts.scorers import (
