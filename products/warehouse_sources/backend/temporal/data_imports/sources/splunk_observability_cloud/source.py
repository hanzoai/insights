...
class SplunkObservabilityCloudSource(
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Sync your Splunk Observability Cloud (formerly SignalFx) detectors, alert history, dashboards, and metric metadata into the Insights Data warehouse.
...
To sync the optional `metric_time_series` table, also provide a [SignalFlow program](https://dev.splunk.com/observability/docs/signalflow/) whose published output is pulled incrementally by time window.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/splunk-observability-cloud",
