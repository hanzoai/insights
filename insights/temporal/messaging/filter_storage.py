...
from insights.temporal.messaging.types import BehavioralEventFilter, PersonPropertyFilter

from products.cohorts.backend.models.cohort import Cohort

from common.scriptvm.python.operation import INSIGHTSQL_BYTECODE_IDENTIFIER, Operation
...
def combine_filter_bytecodes(filters: list[PersonPropertyFilter]) -> list[Any]:
    ...
    """
    combined: list[Any] = [INSIGHTSQL_BYTECODE_IDENTIFIER, 1]
