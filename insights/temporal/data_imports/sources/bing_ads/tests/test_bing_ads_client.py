...
from insights.temporal.data_imports.sources.bing_ads.client import BingAdsClient
...
class TestBingAdsClient:
    ...
    @mock.patch("insights.temporal.data_imports.sources.bing_ads.client.ServiceClient")
