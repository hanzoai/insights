        ...
        <Modal
            ...
            footer={
                <>
                    ...
                    <Button type="secondary" onClick={onClose} data-attr="eng-analytics-quarantine-cancel">
                        Cancel
                    </Button>
                    <Button
                        type="primary"
                    ...
                    <div>
                        ...
                        {isExtend ? (
                            ...
                            <Input
                                ...
                                placeholder="insights/path/test.py::TestClass::test_method or product:my-product"
                                autoFocus
                            />
                        )}
                    </div>
