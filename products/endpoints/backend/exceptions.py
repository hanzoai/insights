...
class EndpointQueryTooExpensive(APIException):
    """A customer query hit a Datastore cost guardrail — deterministic, so 400 (not a retry-inviting 5xx)."""
...
class EndpointAtCapacity(APIException):
    """Shared Datastore pool momentarily at capacity — transient; materializing gives isolated compute."""
