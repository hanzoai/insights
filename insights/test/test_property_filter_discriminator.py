...
class TestPropertyFilterDiscriminator(SimpleTestCase):
    ...
    # now routes on `type` via the callable in insights/schema_discriminators.py, which
    ...
    @parameterized.expand(
        [
            ...
            ("insightsql", {"type": "insightsql", "key": "properties.x = 1"}, InsightsQLPropertyFilter),
    ...
    def test_unknown_type_returns_single_clean_tag_error(self) -> None:
        ...
        for tag in ("'event'", "'cohort'", "'insightsql'", "'empty'", "'workflow_variable'"):
