...
When a value changes, what should run? Insights has a hierarchy. Try each option in
...
- Commit [`ac783822712`](https://github.com/Insights/insights/commit/ac783822712) —
