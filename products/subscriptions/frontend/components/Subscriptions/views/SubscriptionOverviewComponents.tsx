...
export function SubscriptionEmptyState({
    ...
    if (!isFeatured) {
        return (
            <Card hoverEffect={false} className="p-2 bg-fill-secondary border-transparent">
                <div className="flex gap-2 items-center">
                    ...
                    <Button type="tertiary" size="xsmall" onClick={onAction} className="shrink-0">
                        {actionLabel}
                    </Button>
                </div>
            </Card>
        ...
        <Card hoverEffect={false} className="p-6">
            <div className="flex gap-3 items-start">
                ...
                <div className="flex flex-col gap-2 min-w-0">
                    ...
                    <Button type={actionType} size="small" onClick={onAction} className="self-start">
                        {actionLabel}
                    </Button>
                </div>
            </div>
...
export function AIPromptReportsLink(): JSX.Element {
    return (
        <Card hoverEffect={false} className="p-3 bg-fill-secondary border-transparent">
