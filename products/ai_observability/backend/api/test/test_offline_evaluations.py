...
class TestOfflineEvaluationItemsEndpoint(APIBaseTest):
    ...
    @patch("products.ai_observability.backend.api.offline_evaluations.execute_insightsql_query")
    ...
    def test_preflight_failure_returns_500(self, mock_preflight: MagicMock, mock_heavy: MagicMock) -> None:
        mock_preflight.side_effect = RuntimeError("datastore boom")
    ...
    def test_heavy_failure_returns_500(self, mock_preflight: MagicMock, mock_heavy: MagicMock) -> None:
        ...
        mock_heavy.side_effect = RuntimeError("datastore boom")
    ...
    def test_preflight_targets_events_and_heavy_targets_ai_events(
        ...
        # nosemgrep: insightsql-no-string-table-chain
        assert heavy_select.select_from.table.chain == ["insights", "ai_events"]  # type: ignore[union-attr]
