...
export interface annotationsOverlayLogicActions {
    createAnnotationGenerically: (annotationData: AnnotationData) => AnnotationData // annotationsModel
...
export type annotationsOverlayLogicType = MakeLogicType<
    annotationsOverlayLogicValues,
    annotationsOverlayLogicActions,
    AnnotationsOverlayLogicProps,
    annotationsOverlayLogicMeta
>
                        ...
                        .map((dateStr, index) => {
                            ...
                            if (dateInTimezone >= dateRange[0] && dateInTimezone < dateRange[1]) {
                                return {
                                    ...
                                    content:
                                        'Some person properties may have been set incorrectly on events between January 6, 20:01 UTC and January 7, 14:52 UTC. See https://status.hanzo.ai/ for more information.',
