...
from insights.caching.insight_caching_state import (
    LazyLoader,
    TargetCacheAge,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            create_insight,
            {"query": {"kind": "InsightsQLQuery", "query": ""}, "viewed_at_delta": timedelta(days=1)},
            TargetCacheAge.MID_PRIORITY,
            id="insight with InsightsQLQuery query viewed recently",
        ),
...
@patch("insights.caching.insight_caching_state.active_teams")
