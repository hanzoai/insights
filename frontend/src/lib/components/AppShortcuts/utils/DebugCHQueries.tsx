...
import { IconCodeInsert, IconCopy, IconRefresh } from '@hanzo/icons'
                ...
                <tbody>
                    ...
                    {git_commit && typeof git_commit === 'string' ? (
                        <tr>
                            ...
                            <td>
                                <LinkInsightsCommit commit={git_commit} />
                            </td>
                        </tr>
                    ) : null}
                    {service_name && typeof service_name === 'string' ? (
                        <tr>
                            <td>Service name</td>
                            <td>
                                <LinkInsightsService service={service_name} />
                            </td>
                        </tr>
                    ) : null}
                    <tr>
...
function LinkInsightsCommit({ commit }: { commit: string }): JSX.Element {
    return (
        <Link to={`https://www.github.com/hanzoai/insights/commit/${commit}`} target="_blank">
            {commit}
        </Link>
    )
}

function LinkInsightsService({ service }: { service: string }): JSX.Element {
    ...
    return (
        <Link
            to={`https://argocd-internal.internal.insights.dev/applications?search=${encodeURIComponent(service)}`}
            target="_blank"
        >
            {service}
        </Link>
...
function LinkMetabaseQuery({ queryId }: { queryId: string }): JSX.Element | null {
    ...
    const url =
        region === Region.US
            ? `https://metabase.prod-us.insights.dev/question?query_id=${queryId}#-`
            : `https://metabase.prod-eu.insights.dev/question?query_id=${queryId}#`
