...
import { InsightsQLQueryString, escapePropertyAsInsightsQLIdentifier, insightsql } from '~/queries/utils'
...
function buildPropertiesQuery(
    ...
    const selects = [
        ...
        .map(([source, property]) => {
            const identifier = escapePropertyAsInsightsQLIdentifier(property)
...
export interface sessionRecordingsListPropertiesLogicValues {
    ...
    unqueryableExtraProperties: string[] | null
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface sessionRecordingsListPropertiesLogicActions {
    ...
    markExtraPropertiesUnqueryable: (properties: string[]) => {
        properties: string[]
    }
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface sessionRecordingsListPropertiesLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        extraSessionProperties: (pinnedProperties: string[], unqueryableExtraProperties: string[] | null) => string[]
    }
}

export type sessionRecordingsListPropertiesLogicType = MakeLogicType<
    sessionRecordingsListPropertiesLogicValues,
    sessionRecordingsListPropertiesLogicActions,
    Record<string, any>,
    sessionRecordingsListPropertiesLogicMeta
>
...
export const sessionRecordingsListPropertiesLogic = kea<sessionRecordingsListPropertiesLogicType>([
        ...
        recordingProperties: [
            [] as SessionRecordingPropertiesType[],
            {
                loadPropertiesForSessions: async ({ sessions }, breakpoint) => {
                    ...
                    let response
                    try {
                        response = await api.queryInsightsQL(
                        ...
                        try {
                            ...
                            insights.captureException(fallbackError)
                            return values.recordingProperties
                        }
    ...
    selectors({
        extraSessionProperties: [
            ...
            (pinnedProperties: string[], unqueryableExtraProperties: string[] | null): string[] => {
