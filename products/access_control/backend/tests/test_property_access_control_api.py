...
class TestDatastoreEventSerializerPropertyAccess(BaseTest):
    def setUp(self):
        super().setUp()
    ...
    def test_no_restrictions_returns_all_properties(self):
        ...
        data = DatastoreEventSerializer(event, context={}).data
    ...
    def test_restricted_event_property_stripped_from_response(self):
        ...
        event = self._make_event()
        data = DatastoreEventSerializer(event, context={"restricted_event_properties": {"secret_event_prop"}}).data
...
class TestPersonSerializerPropertyAccess(BaseTest):
    ...
    def test_no_restrictions_returns_all_properties(self):
        from insights.api.person import PersonSerializer
