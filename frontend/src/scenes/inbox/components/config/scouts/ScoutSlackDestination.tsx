            ...
            {integrationsLoading && slackIntegrations === undefined ? (
                ...
                <div className="flex flex-col gap-2 max-w-md">
                    ...
                    <span className="text-[11.5px] text-muted">
                        {hasChannel
                            ? 'Insights must be in the channel. Invite it with '
                            : 'Pick a channel to turn notifications on. Insights must be in the channel. Invite it with '}
                        <code>/invite @Insights</code>.
                    </span>
                </div>
            )}
        </div>
