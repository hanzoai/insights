...
from insights.datastore.dictionaries import dictionary_source_datastore
...
def _escape_sql_string(s: str) -> str:
    # Escape backslashes before quotes — Datastore treats \X as an escape sequence in string literals,
    # so r"desktop\.script\.dev" would silently become "desktop.script.dev" (broader regex) without this.
...
PRIMARY KEY regexp
{dictionary_source_datastore(BOT_DEFINITION_TABLE_NAME)}
