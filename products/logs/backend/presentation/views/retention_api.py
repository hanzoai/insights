...
from insights.constants import LOGS_RETENTION_FEATURES_BY_DAYS
...
# `TeamSerializer` (`insights/api/team.py`): 14 is the always-available default, and every other
...
class LogsRetentionRuleViewSet(TeamAndOrgViewSetMixin, viewsets.ModelViewSet):
    ...
    lookup_field = "id"
    insights_feature_flag = "logs-settings-retention-rules"
