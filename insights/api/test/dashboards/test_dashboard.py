...
from insights.test.base import APIBaseTest, FuzzyInt, QueryMatchingTest, snapshot_postgres_queries
...
from insights.schema import DateRange, EventPropertyFilter, EventsNode, PropertyOperator, TrendsQuery
...
class TestDashboard(APIBaseTest, QueryMatchingTest):
    ...
    def test_streamed_tile_error_redacts_insight_metadata_for_restricted_user(self):
        ...
        restricted_user = self._create_user("restricted@hanzo.ai", level=OrganizationMembership.Level.MEMBER)
