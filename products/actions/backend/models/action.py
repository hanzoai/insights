...
from insights.plugins.plugin_server_api import drop_action_on_workers, reload_action_on_workers
...
class Action(FileSystemSyncMixin, ModelActivityMixin, RootTeamMixin, models.Model):
    ...
    project = models.ForeignKey("insights.Project", on_delete=models.CASCADE, null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True, blank=True)
    created_by = models.ForeignKey("insights.User", on_delete=models.SET_NULL, null=True, blank=True)
    deleted = models.BooleanField(default=False)
    events = models.ManyToManyField("insights.Event", blank=True)  # type: models.ManyToManyField
