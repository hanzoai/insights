...
from insights.schema import FunnelTimeToConvertResults
...
from insights.insightsql_queries.insights.funnels.base import FunnelBase
...
class FunnelTimeToConvertUDF(FunnelBase):
    ...
    def get_query(self, explicit_bins: list[int] | None = None) -> ast.SelectQuery:
        ...
        # nosemgrep: insightsql-fstring-audit (interpolated values are internal ints; {{timings}} is a InsightsQL placeholder)
        bins = parse_select(
            f"""
            SELECT
                timings,
