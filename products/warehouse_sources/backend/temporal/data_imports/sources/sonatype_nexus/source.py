...
class SonatypeNexusSource(
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Connect your Sonatype Nexus Repository instance to pull your artifact inventory into the Insights Data warehouse.
...
The tasks table additionally requires the `nx-tasks-read` privilege; deselect it if your user doesn't have it.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/sonatype-nexus",
