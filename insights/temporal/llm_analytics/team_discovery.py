...
def _get_llma_workflow_config() -> LLMAWorkflowConfig:
    ...
    try:
        payload: dict | None = hanzo_insights.get_feature_flag_payload(  # type: ignore[assignment]
...
async def get_team_ids_for_llm_analytics(inputs: TeamDiscoveryInput) -> list[int]:
    ...
    async with Heartbeater():
        ...
        try:
            ...
            from insights.tasks.llm_analytics_usage_report import get_teams_with_ai_events
