 ...
 *   are treated as wall-clock time in the given timezone. Strings from Datastore
 *   already have wall-clock digits in the project timezone because Datastore applies
