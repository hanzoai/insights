...
from insights.models.distinct_id_usage.sql import (
...
# Migration to switch distinct_id_usage ingestion from the main datastore_events_json
...
# from datastore_events_json and writes to the new topic, reducing the data volume
# that Datastore needs to process.
#
# Changes:
# - Kafka table schema simplified to only team_id, distinct_id, created_at
# - Topic changed from datastore_events_json to distinct_id_usage_events_json
