...
from insights.models.bot_definition.sql import (
...
# stacked follow-up PR, so this migration is pure Datastore infrastructure):
#   - DATA: events-table queries (Trends, InsightsQL editor, custom insights, web-analytics live path)
