...
const CLUSTER_SNAPSHOT = {
    ...
    last_computed_by_email: 'paul@hanzo.ai',
    computed_with: {
...
const ACTIVITY_CALLS: [string, string | null, number | null, string, string | null][] = [
    ...
    ['execute-sql', 'Break down tool errors by client to find which harness fails most.', 3525, 'insights-cli', null],
    [
        'feature-flag-list',
