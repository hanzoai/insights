...
from insights.caching.redis_cluster_connection_factory import QUERY_CACHE_ALIAS
from insights.query_cache import QueryCache, get_stale_insights
...
class TestQueryCacheFacade(BaseTest):
    ...
    def test_store_result_swallows_size_tracker_failures(self):
        ...
        with patch(
            "insights.query_cache.cache.TeamCacheSizeTracker.set",
