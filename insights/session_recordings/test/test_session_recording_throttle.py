...
from insights.session_recordings.session_recording_api import (
    LISTING_RATES,
...
class TestTierAwareSnapshotThrottle(BaseTest):
    @patch("insights.session_recordings.session_recording_api.get_cached_org_tier", side_effect=Exception("db gone"))
    ...
    @patch("insights.session_recordings.session_recording_api.get_cached_org_tier")
    ...
    @patch("insights.session_recordings.session_recording_api.get_cached_org_tier", return_value="paid")
...
def _counter_value(location: str, auth_type: str) -> float:
    from insights.session_recordings.session_recording_api import SESSION_RECORDING_THROTTLED
...
class TestSharingTokenReplayThrottle(BaseTest):
    ...
    @patch("insights.session_recordings.session_recording_api.is_rate_limit_enabled", return_value=False)
    ...
    @patch("insights.session_recordings.session_recording_api.is_rate_limit_enabled", return_value=True)
    @patch("insights.session_recordings.session_recording_api.team_is_allowed_to_bypass_throttle", return_value=True)
