...
import { DataVisualizationNode, FileSystemIconType, InsightsQLFilters, NodeKind } from '~/queries/schema/schema-general'
...
function setFiltersHashParam(url: URL, filters: InsightsQLFilters | null | undefined): void {
...
export const editorSceneLogic = kea<editorSceneLogicType>([
            ...
            (
                ...
                if (editingInsight) {
                    ...
                    return {
                        ...
                        resourceType: { type: 'insight/script' },
                    }
                }
    ...
    listeners(({ values }) => ({
        openHistoryModal: () => {
            insights.capture('sql-editor-history-modal-opened', {
