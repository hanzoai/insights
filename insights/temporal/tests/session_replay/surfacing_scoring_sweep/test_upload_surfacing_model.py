...
from insights.management.commands.upload_surfacing_model import Command
...
class TestUploadSurfacingModelCommand:
    ...
    def test_uploads_valid_booster(self, valid_booster_path: Path) -> None:
        with mock.patch(
            "insights.management.commands.upload_surfacing_model.object_storage.write_from_file"
        ) as write_mock:
