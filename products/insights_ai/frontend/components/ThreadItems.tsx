...
/** Inline `_insights/status` item — a spinner while compacting, a generic status line otherwise. */
...
/** Inline `_insights/compact_boundary` item — the post-compaction card. */
...
/** Inline `_insights/task_notification` item — a status card for a completed/failed/stopped task. */
