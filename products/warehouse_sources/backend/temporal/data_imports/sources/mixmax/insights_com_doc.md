...
[Mixmax](https://www.mixmax.com) is a sales-engagement and email-productivity platform for Gmail (sequences, meeting scheduling, snippets, and live email tracking). This connector syncs your Mixmax sequences, messages, snippets, rules, live feed, and related resources into the Insights Data warehouse so you can join outreach activity with your product and revenue data.
...
Insights authenticates every request with this token (sent as the `X-API-Token` header).
...
<!--
STAGING NOTE (delete when relocating): this file is the user-facing hanzo.ai doc for the Mixmax
source. It is staged in this repo because no hanzo.ai checkout was available during implementation.
Before shipping, move it to the hanzo.ai repo at contents/docs/cdp/sources/mixmax.md (served at
/docs/cdp/sources/mixmax and /docs/data-warehouse/sources/mixmax), then run from the insights repo:
