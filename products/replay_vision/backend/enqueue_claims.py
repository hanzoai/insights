...
atomically (single Lua eval, same shape as insights/datastore/client/limit.py) before the workflow
...
_TEAM_KEY_PREFIX = "@hanzo/replay-vision/enqueued-team"
_SCANNER_KEY_PREFIX = "@hanzo/replay-vision/enqueued-scanner"
