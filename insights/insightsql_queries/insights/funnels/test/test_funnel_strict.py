...
from insights.insightsql.constants import MAX_BYTES_BEFORE_EXTERNAL_GROUP_BY, InsightsQLGlobalSettings
...
from insights.insightsql_queries.insights.funnels.test.test_funnel_persons import get_actors
