...
class OpinionStageSource(ResumableSource[OpinionStageSourceConfig, OpinionStageResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Opinion Stage personal API key to pull your interactive content data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/opinion-stage",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
