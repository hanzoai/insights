...
class ScaleAISource(ResumableSource[ScaleAISourceConfig, ScaleAIResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Scale AI API key to sync your Scale data labeling data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/scale-ai",
