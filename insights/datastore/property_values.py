...
from insights.datastore.kafka_engine import CONSUMER_GROUP_PROPERTY_VALUES, kafka_engine
from insights.datastore.table_engines import AggregatingMergeTree, Distributed, ReplicationScheme
from insights.kafka_client.topics import KAFKA_DATASTORE_PROPERTY_VALUES
...
def KAFKA_PROPERTY_VALUES_TABLE_SQL_FN() -> str:
    return KAFKA_PROPERTY_VALUES_TABLE_SQL.format(
        ...
        engine=kafka_engine(
            topic=KAFKA_DATASTORE_PROPERTY_VALUES,
