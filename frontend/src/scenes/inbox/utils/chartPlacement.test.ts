...
describe('resolveChartPlacements', () => {
    ...
    it.each([
        ...
        // A chart is block-level and `Markdown` only unwraps the `<p>` around a paragraph whose
    ...
    it('places two references a hard break separates', () => {
        // A hard break renders as `<br>`, which `Markdown` counts as blank when it decides a
