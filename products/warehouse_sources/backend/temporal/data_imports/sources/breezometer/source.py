...
class BreezometerSource(SimpleSource[BreezometerSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your API key and the locations you want to track to pull air-quality and pollen data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/breezometer",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
