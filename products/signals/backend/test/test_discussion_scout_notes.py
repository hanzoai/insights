...
_PROMPT = (
    "Let's discuss this Insights Inbox report: https://us.hanzo.ai/project/2/inbox/reports/x\n\n"
...
class TestExtractQuestion(SimpleTestCase):
    ...
    @parameterized.expand(
        [
            ...
            ("single_newline_still_strips_prefix", "Let's discuss this Insights Inbox report: x\nWhy?", "Why?"),
            ("prefix_with_no_question_returns_blank", "Let's discuss this Insights Inbox report: x\n\n   ", ""),
        ]
    )
