...
from insights.queries.trends.util import offset_time_series_date_by_interval
...
PROPERTIES_TIMELINE_INSIGHTSQL = """
SELECT
    timestamp,
    properties,
...
class PropertiesTimeline:
    ...
    def run(
        ...
        # break `lagInFrame`, whose out-of-frame default is an empty tuple that Datastore refuses to
