        ...
        advancedActivityLogs: [
            { results: [], count: 0 } as CountedPaginatedResponse<ActivityLogItem>,
            {
                loadAdvancedActivityLogs: async (_, breakpoint) => {
                    ...
                    const response = await api.get(`v1/projects/@current/advanced_activity_logs/?${params}`)
                    return response
                },
            },
        ],
        ...
        availableFilters: [
            null as AvailableFilters | null,
            {
                loadAvailableFilters: async () => {
                    const response = await api.get('v1/projects/@current/advanced_activity_logs/available_filters/')
                    return response
                },
            },
        ],
        ...
        exports: [
            [] as ExportedAsset[],
            {
                loadExports: async () => {
                    ...
                    const response = await api.get(`v1/environments/@current/exports/?${params}`)
    ...
    listeners(({ actions, values, cache }) => ({
        ...
        exportLogs: async ({ format }) => {
            try {
                ...
                await api.create('v1/projects/@current/advanced_activity_logs/export/', {
                    format,
