...
export interface EndpointResponseApi {
    ...
    /** The InsightsQL or insight query definition (JSON object with 'kind' key). */
    query: unknown
    ...
    url: string | null
    /**
     * Absolute URL to view this endpoint in the Insights UI.
     * @nullable
     */
    ui_url: string | null
...
export interface EndpointRequestApi {
     ...
     */
    name?: string | null
    /** InsightsQL or insight query this endpoint executes. Changing this auto-creates a new version. */
    query?: unknown
    /**
