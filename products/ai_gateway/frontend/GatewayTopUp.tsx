...
import { Banner, Button, Input, Modal, Tag } from '@hanzo/elements'
...
export function GatewayTopUpModal(): JSX.Element {
    ...
    return (
        <Modal
            ...
            footer={
                <>
                    <Button type="secondary" onClick={closeTopUpModal}>
                        Cancel
                    </Button>
                    <Button
                        type="primary"
        ...
        >
            <div className="flex flex-col gap-3 max-w-md">
                <Banner type="info">Preview only — billing isn't wired up yet.</Banner>
