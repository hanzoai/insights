...
describe('matching tests', () => {
    ...
    `
        ...
        const cases: [string, string, string, string, boolean][] = [
            ['include matches', backendExceptDocs, 'backend', 'insights/models.py', true],
            ['second include matches', backendExceptDocs, 'backend', 'products/foo/backend/task.py', true],
            ['exclude vetoes a matched include', backendExceptDocs, 'backend', 'insights/README.md', false],
            [
                'exclude vetoes a matched second include',
                backendExceptDocs,
                'backend',
                'products/foo/backend/notes.md',
                false,
            ],
