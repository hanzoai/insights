...
export function MCPAnalyticsFirstLook(): JSX.Element | null {
    ...
    useEffect(() => {
        if (shouldShow && !shownRef.current) {
            ...
            insights.captureRaw('mcp analytics first look shown', eventProperties)
        }
        ...
        >
            <div className="flex flex-col gap-4 pr-6">
                ...
                <div className="flex flex-wrap items-center gap-2">
                    <Button type="primary" icon={<IconSparkles />} onClick={dismissAndAskMax}>
                        Ask Insights AI
                    </Button>
                    <Button
                        type="tertiary"
                ...
                {editorExpanded && (
                    <div className="flex flex-col gap-2 rounded border border-border bg-surface-primary p-3">
                        <p className="m-0 text-xs text-muted">
                            {editorPrompt.label}, or any agent with the Insights MCP installed:
                        </p>
                        ...
                        <p className="m-0 text-xs text-muted">
                            Needs the Insights MCP in your editor.{' '}
