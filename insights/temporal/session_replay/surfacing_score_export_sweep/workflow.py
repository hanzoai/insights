...
with workflow.unsafe.imports_passed_through():
    ...
    from insights.temporal.session_replay.surfacing_score_export_sweep.metrics import record_tick_summary
...
class ExportSurfacingScoresWorkflow(InsightsWorkflow):
