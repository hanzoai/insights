    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between gap-2">
                {onSkip && (
                    <Button type="secondary" size="small" onClick={onSkip}>
                        Skip question
                    </Button>
                )}
                <Button type="primary" size="small" onClick={handleSubmit} className="self-start ml-auto">
                    {submitLabel}
                </Button>
            </div>
        </div>
    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between gap-2">
                ...
                <Button type="primary" size="small" onClick={handleSubmit} className="self-end ml-auto">
                    {submitLabel}
                </Button>
            </div>
        </div>
...
function MultiFieldInput({
    ...
    switch (field.type) {
        case 'dropdown': {
            ...
            return (
                <div className={showError ? '[&_.Button]:border-danger' : undefined}>
                    <Select
                        options={options}
                        value={value as string | undefined}
