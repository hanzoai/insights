...
// Bucket key format matching Datastore dateTrunc's DateTime output, so the zero-fill keys we
...
// Truncate to the start of an interval bucket the way Datastore's dateTrunc does, so generated keys
...
// generated keys regardless of how Datastore rendered it. The value always carries the project-tz
