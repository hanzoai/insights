...
from insights.api.annotation import AnnotationSerializer
from insights.api.oauth.test_dcr import generate_rsa_key
from insights.api.routing import DefaultRouterPlusPlus, TeamAndOrgViewSetMixin
from insights.models.annotation import Annotation
...
class TestTeamAndOrgViewSetMixin(APIBaseTest):
    ...
    def test_environment_nested_filtering(self):
        response = self.client.get(f"/v1/environments/{self.team.id}/foos/")
...
class TestOAuthAccessTokenAuthentication(APIBaseTest):
    ...
    def setUp(self):
        ...
        self.access_token = OAuthAccessToken.objects.create(
            ...
            token="hia_test_oauth_access_token_123",
    ...
    def test_oauth_token_fails_with_expired_token(self):
        ...
        expired_token = OAuthAccessToken.objects.create(
            user=self.user,
            application=self.oauth_app,
            token="hia_expired_oauth_token_123",
            expires=timezone.now() - timedelta(hours=1),
            scope="annotation:read",
        )
