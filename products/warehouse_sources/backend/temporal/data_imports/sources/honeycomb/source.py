...
class HoneycombSource(ResumableSource[HoneycombSourceConfig, HoneycombResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter a Honeycomb configuration API key to pull your Honeycomb observability configuration — datasets, SLOs, burn alerts, triggers, markers, boards, and more — into the Insights Data warehouse.
...
Keys are region-specific — pick the region that matches your Honeycomb account.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/honeycomb",
