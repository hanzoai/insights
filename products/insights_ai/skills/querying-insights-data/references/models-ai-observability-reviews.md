...
- **Versions**: `current_version_id` points to the current immutable config; the version table itself is not exposed via InsightsQL — fetch full version detail through the REST API tools
