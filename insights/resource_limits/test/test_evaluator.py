...
from insights.resource_limits import LimitKey, check_count_limit, get_limit, get_organization_limit
from insights.resource_limits.registry import REGISTRY, LimitDefinition
...
class TestCheckCountLimit(BaseTest):
    ...
    def test_emit_at_boundary(
        ...
        with patch("insights.resource_limits.evaluator.report_user_action") as report:
            check_count_limit(
                team=self.team,
