...
from insights.insightsql.utils import deserialize_hx_ast, is_simple_value
from insights.insightsql.visitor import CloningVisitor, TraversingVisitor

from common.scriptvm.python.stl import BLOCKING_FUNCTIONS
...
class ReplacePlaceholders(CloningVisitor):
    ...
    def visit_placeholder(self, node):
        ...
        if (
            ...
            or isinstance(response.result, ast.InsightsQLXTag)
        ):
