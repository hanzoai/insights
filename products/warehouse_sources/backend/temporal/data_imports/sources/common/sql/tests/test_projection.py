...
class TestFilterDwhColumnsByEnabledColumns:
    dwh_columns: dict[str, dict[str, str]] = {
        "id": {"insightsql": "Integer"},
        "email": {"insightsql": "String"},
        "name": {"insightsql": "String"},
        "updated_at": {"insightsql": "DateTime"},
    }
    ...
    def test_source_namespace_keys_on_both_sides_still_filter(self) -> None:
        ...
        source_keyed = {"ID": {"insightsql": "Integer"}, "EMAIL": {"insightsql": "String"}, "NAME": {"insightsql": "String"}}
    ...
    def test_normalize_false_preserves_case_sensitive_selection(self) -> None:
        ...
        case_collision = {"Foo": {"insightsql": "String"}, "foo": {"insightsql": "String"}}
