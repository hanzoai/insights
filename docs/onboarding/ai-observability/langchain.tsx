    ...
    return [
        {
            ...
            content: (
                <>
                    ...
                    <Markdown>Install the Insights SDK and LangChain with OpenAI.</Markdown>
                        ...
                        blocks={[
                            {
                                ...
                                file: 'Python',
                                code: dedent`
                                    pip install insights "langchain>=1.0" langchain-core langchain-openai
                                `,
                            },
                            {
                                language: 'bash',
                                file: 'Node',
                                code: dedent`
                                    npm install insights-node @hanzo/ai langchain@^1.0 @langchain/core @langchain/openai zod
                                `,
                            },
                        ]}
                    />
                ...
                <>
                    ...
                    <Markdown>
                        {dedent`
                            ...
                            control the top-level trace ID instead of letting Insights generate one.
                        `}
                    </Markdown>
                </>
            ),
