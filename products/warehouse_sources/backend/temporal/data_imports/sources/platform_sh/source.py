...
class PlatformShSource(ResumableSource[PlatformShSourceConfig, PlatformShResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Platform.sh (or Upsun) API token to sync your organizations, projects, environments, and deploy activity into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/platform-sh",
