...
class TestProcessScheduledChanges(APIBaseTest, QueryMatchingTest):
    ...
    def test_recoverable_error_allows_retry(self) -> None:
        ...
        with (
            ...
            patch("insights.tasks.process_scheduled_changes.capture_exception") as mock_capture,
        ):
    ...
    def test_unrecoverable_error_prevents_retry(
        ...
        with (
            patch("insights.tasks.process_scheduled_changes.capture_exception") as mock_capture,
            patch("insights.tasks.process_scheduled_changes.logger") as mock_logger,
        ):
            process_scheduled_changes()
    ...
    def test_max_retries_exceeded(self) -> None:
        ...
        from insights.tasks.process_scheduled_changes import MAX_RETRY_ATTEMPTS
