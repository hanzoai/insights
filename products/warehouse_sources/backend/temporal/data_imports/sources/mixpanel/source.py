...
class MixpanelSource(ResumableSource[MixpanelSourceConfig, MixpanelResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Mixpanel",
            caption="""Connect your Mixpanel project to pull events, user profiles, cohorts and annotations into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/mixpanel",
