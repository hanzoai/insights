        ...
        sourceQuery: [
            {
                ...
                source: { kind: NodeKind.InsightsQLQuery, query: '' },
...
describe('NotebookSQLEditor', () => {
    it('adds notebook query tags to InsightsQL source queries', () => {
    ...
    it('preserves existing InsightsQL query tags', () => {
        const sourceQuery = getSqlEditorSourceQuery({
            kind: NodeKind.DataVisualizationNode,
            source: {
                kind: NodeKind.InsightsQLQuery,
    ...
    it('keeps the selected connection while the code cell is edited', async () => {
        ...
        // the user had picked — so the selector snapped back to Insights mid-typing.
        initKeaTests()
