"""Real-Datastore integration tests for the dmat slot-assignments dictionary.
...
`insights/temporal/tests/backfill_materialized_property/test_coercion_parity.py::TestDictBackedDispatchCoercion`.
...
# django_db_setup (insights/conftest.py) creates the Datastore test DB; without
