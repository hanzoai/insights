...
from insights.schema import TrendsAlertConfig, TrendsQuery
...
from insights.tasks.alerts.detector import (
...
from insights.tasks.alerts.detectors import get_detector
from insights.tasks.alerts.trends import (
    TrendResult,
    _has_breakdown,
...
from insights.tasks.alerts.utils import WRAPPER_NODE_KINDS, AlertEvaluationResult
from insights.utils import get_from_dict_or_attr, relative_date_parse
