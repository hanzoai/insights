...
export const SELF_DRIVING_WIZARD_COMMAND = 'npx -y @hanzo/wizard@latest self-driving'
            ...
            title={
                <>
                    ...
                    <p className="mb-0">
                        ...
                        with a very limited margin – similarly to our strategy with other Insights tools. Like with our
    ...
    return (
        <div className="flex flex-col items-start gap-3">
            ...
            <p className="m-0 max-w-prose text-sm text-secondary leading-relaxed">
                ...
                <br />
                <strong>Insights then ships quality PRs for you to merge.</strong> Prioritized by impact, assigned to
