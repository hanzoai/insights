...
class TestCombineIssues:
    def test_preserves_review_time_source_perspective_and_flattens_in_key_order(self) -> None:
        ...
        perspective_results = {
            (3, 5): IssuesReview(issues=[_issue("a", "review-script-perspective-performance-reliability")]),
            (1, 5): IssuesReview(
                issues=[
                    _issue("b", "review-script-perspective-logic-correctness"),
                    _issue("c", "review-script-perspective-logic-correctness"),
                ]
            ),
            (2, 5): IssuesReview(issues=[_issue("d", "review-script-perspective-contracts-security")]),
        }
        ...
        assert {i.id: i.source_perspective for i in combined} == {
            "1-5-1": "review-script-perspective-logic-correctness",
            "1-5-2": "review-script-perspective-logic-correctness",
            "2-5-1": "review-script-perspective-contracts-security",
            "3-5-1": "review-script-perspective-performance-reliability",
        }
