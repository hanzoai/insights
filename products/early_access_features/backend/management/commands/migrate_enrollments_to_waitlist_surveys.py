...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        # Imported here so InsightsQL and the analytics client load with the app ready.
        ...
        from insights.tasks.early_access_feature import capture_event
        ...
        for feature in features.iterator():
            ...
            enrolled = execute_insightsql_query(
                """
                SELECT
            ...
            responded = execute_insightsql_query(
                """
