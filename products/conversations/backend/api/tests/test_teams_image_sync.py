...
class TestTeamsImageIngest(SimpleTestCase):
    ...
    def test_extract_bot_attachments_copies_to_uploaded_media(
        ...
        mock_save.return_value = "https://app.hanzo.ai/uploaded_media/abc"
        ...
        assert len(images) == 1
        assert images[0]["url"] == "https://app.hanzo.ai/uploaded_media/abc"
    ...
    def test_extract_bot_attachments_keeps_non_image_file(self, mock_download: MagicMock, mock_save: MagicMock) -> None:
        ...
        mock_save.return_value = "https://app.hanzo.ai/uploaded_media/pdf"
    ...
    def test_extract_graph_images_from_hosted_contents(self, mock_download: MagicMock, mock_save: MagicMock) -> None:
        mock_download.return_value = VALID_PNG_BYTES
        mock_save.return_value = "https://app.hanzo.ai/uploaded_media/xyz"
        ...
        assert len(images) == 1
        assert images[0]["url"] == "https://app.hanzo.ai/uploaded_media/xyz"
    ...
    def test_extract_graph_images_accepts_reply_path(self, mock_download: MagicMock, mock_save: MagicMock) -> None:
        mock_download.return_value = VALID_PNG_BYTES
        mock_save.return_value = "https://app.hanzo.ai/uploaded_media/reply"
