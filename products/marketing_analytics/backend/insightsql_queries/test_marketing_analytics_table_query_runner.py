...
from insights.datastore.query_tagging import Feature, reset_query_tags, tags_context
...
from products.marketing_analytics.backend.insightsql_queries.marketing_lazy_precompute import REVALIDATION_TRIGGER
from products.warehouse_sources.backend.facade.models import DataWarehouseTable

_BASE_RUNNER = "products.marketing_analytics.backend.insightsql_queries.marketing_analytics_base_query_runner"
...
class TestMarketingAnalyticsTableQueryRunner(DatastoreTestMixin, BaseTest):
    ...
    def test_background_warming_bypasses_warehouse_access_control(self, _name, tags, expected_bypass, create_for):
        ...
        if tags is None:
            _ = runner._shared_insightsql_database
        else:
    ...
    @patch(
        "products.marketing_analytics.backend.insightsql_queries.marketing_analytics_base_query_runner.MarketingSourceFactory"
    )
    ...
    def test_calculate_basic(self):
        ...
        assert result.insightsql is not None
    ...
    def test_dw_goal_with_valid_columns_passes(self):
        ...
        DataWarehouseTable.raw_objects.create(
            ...
            columns={
                "id": {"insightsql": "StringDatabaseField", "datastore": "String", "valid": True},
                "timestamp": {"insightsql": "DateTimeDatabaseField", "datastore": "DateTime", "valid": True},
                "campaign_name": {"insightsql": "StringDatabaseField", "datastore": "String", "valid": True},
                "source_name": {"insightsql": "StringDatabaseField", "datastore": "String", "valid": True},
            },
            format="Parquet",
            url_pattern="https://example.com/data",
        )
    ...
    def test_channel_drill_down_classifies_adapter_source(self, source: str, expected_channel: str):
        ...
        response = execute_insightsql_query(query=cte_select, team=self.team)
    ...
    def test_channel_source_drill_down_joins_three_sides_with_a_conversion_goal(self):
        ...
        (coalesce over campaign_costs and the conversion CTE). Datastore rejects some multi-table
