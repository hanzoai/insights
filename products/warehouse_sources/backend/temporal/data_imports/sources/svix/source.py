...
class SvixSource(ResumableSource[SvixSourceConfig, SvixResumeConfig]):
    ...
    default_version = "v1"
    api_docs_url = "https://docs.svix.com"
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Svix API key to pull your webhook platform data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/svix",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
