...
import { InsightsApiError, InsightsValidationError } from '@/lib/errors'
...
describe('ApiClient.requestSSE', () => {
    ...
    it('should throw a typed InsightsValidationError on a backend validation_error response', async () => {
    ...
    it('should throw a typed InsightsApiError carrying the status on a 5xx response', async () => {
