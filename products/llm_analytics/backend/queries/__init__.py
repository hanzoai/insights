...
def get_errors_query(order_by: str = "last_seen", order_direction: str = "DESC") -> str:
    ...
    Returns:
        InsightsQL query string with ORDER BY placeholders substituted.
        The {filters} placeholder is left as-is for InsightsQL engine to handle.
    """
    ...
    # {filters} is left as-is - InsightsQL engine will handle it
