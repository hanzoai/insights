...
from insights.session_recordings.recordings.recording_api_client import recording_api_client

logger = structlog.get_logger(__name__)

BLOCK_LISTING_CACHE_HIT_COUNTER = Counter(
    "insights_session_recording_v2_block_listing_cache_hit",
...
def listing_cache_key(recording: SessionRecording) -> str | None:
    try:
        ...
        return f"@hanzo/v2-blob-snapshots/v2/recording_block_listing_{recording.team_id}_{recording.session_id}"
