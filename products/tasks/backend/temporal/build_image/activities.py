...
def _judge_spec_safety(
    ...
    from insights.llm.gateway_client import get_llm_client  # noqa: PLC0415 — keeps the OpenAI SDK off startup paths
...
def _resolve_build_github_token(team_id: int) -> str | None:
    from insights.models.integration import Integration  # noqa: PLC0415
