...
class TogetherAISource(SimpleSource[TogetherAISourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Together AI API key to sync your fine-tuning jobs, batch inference jobs, files, dedicated endpoints, evaluations, and the model catalog into the Insights Data warehouse.
...
You can find or create an API key in your [Together AI settings](https://api.together.xyz/settings/api-keys).""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/together-ai",
