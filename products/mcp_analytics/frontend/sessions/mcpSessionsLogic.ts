...
export interface mcpSessionsLogicValues {
    ...
    selectedSession: MCPSessionApi | null
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface mcpSessionsLogicActions {
    ...
    loadToolCalls: (sessionId: string) => string
    ...
    setFilters: (filters: Partial<MCPSessionsFilters>) => {
        filters: Partial<MCPSessionsFilters>
    }
    setHasNext: (hasNext: boolean) => {
        hasNext: boolean
    }
    setSorting: (sorting: MCPSessionSorting | null) => {
        sorting: MCPSessionSorting | null
    }
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface mcpSessionsLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        selectedSession: (sessions: MCPSessionApi[], selectedSessionId: string | null) => MCPSessionApi | null
...
export type mcpSessionsLogicType = MakeLogicType<
    mcpSessionsLogicValues,
    mcpSessionsLogicActions,
    Record<string, any>,
    mcpSessionsLogicMeta
>
...
export const mcpSessionsLogic = kea<mcpSessionsLogicType>([
    ...
    selectors({
        ...
        isSelectedSessionGenerating: [
            ...
            (
                ...
                generatingSessionId: string | null,
                selectedSessionId: string | null
            ): boolean => generatedIntentLoading && generatingSessionId === selectedSessionId,
        ],
    ...
    listeners(({ actions, values }) => ({
        ...
        generateIntentFailure: () => {
            toast.error('Could not generate the session intent. Please try again.')
        },
