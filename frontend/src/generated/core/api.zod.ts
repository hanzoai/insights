...
export const InvitesDelegateCreateBody = /* @__PURE__ */ zod.object({
    target_email: zod
        .email()
        .describe(
            "Email of the teammate who should complete setup on the inviter's behalf. Receives a Insights-branded delegation invite granting admin-level membership on accept."
        ),
    message: zod
        .string()
...
export const OrganizationsProjectsCreateBody = /* @__PURE__ */ zod
    .object({
        ...
        anonymize_ips: zod
            .boolean()
            .optional()
            .describe('When true, Insights drops the IP address from every ingested event.'),
        ...
        data_attributes: zod
            ...
            .optional()
            .describe(
                "Element attributes that insights-js should capture as action identifiers (e.g. `['data-attr']`)."
            ),
        ...
        autocapture_opt_out: zod
            .boolean()
            .nullish()
            .describe('Disables insights-js autocapture (clicks, page views) when true.'),
        ...
        surveys_opt_in: zod
            .boolean()
            .nullish()
            .describe('Enables displaying surveys via insights-js on allowed origins.'),
        heatmaps_opt_in: zod.boolean().nullish().describe('Enables heatmap recording on pages that host insights-js.'),
        ...
        workflows_config: zod
            .object({
                capture_workflows_engagement_events: zod
                    ...
                    .optional()
                    .describe(
                        'When enabled, workflows engagement activity (email sends, opens, clicks, bounces, spam reports, unsubscribes) is captured as standard Insights events ($workflows_email_\*) alongside the existing workflow metrics.'
                    ),
...
export const UsersUpdateBody = /* @__PURE__ */ zod.object({
    ...
    anonymize_data: zod
        .boolean()
        .nullish()
        .describe('Whether Insights should anonymize events captured for this user when identified.'),
    ...
    theme_mode: zod
        ...
        .optional(),
    mascot_config: zod.unknown().optional(),
    ...
    hide_mcp_hints: zod
        ...
        .optional()
        .describe(
            'When true, the user has opted out of in-app hints promoting the Insights MCP integration after taking actions.'
        ),
...
export const usersMascotConfigPartialUpdateBodyFirstNameMax = 150

export const usersMascotConfigPartialUpdateBodyLastNameMax = 150

export const usersMascotConfigPartialUpdateBodyEmailMax = 254

export const usersMascotConfigPartialUpdateBodyPasswordMax = 128

export const UsersMascotConfigPartialUpdateBody = /* @__PURE__ */ zod.object({
    first_name: zod.string().max(usersMascotConfigPartialUpdateBodyFirstNameMax).optional(),
    last_name: zod.string().max(usersMascotConfigPartialUpdateBodyLastNameMax).optional(),
    email: zod.email().max(usersMascotConfigPartialUpdateBodyEmailMax).optional(),
    notification_settings: zod
        .record(zod.string(), zod.unknown())
        .optional()
        .describe(
    ...
    set_current_organization: zod.string().optional(),
    set_current_team: zod.string().optional(),
    password: zod.string().max(usersMascotConfigPartialUpdateBodyPasswordMax).optional(),
    current_password: zod
        .string()
        .optional()
        .describe(
...
export const UsersIntegrationsGithubStartCreateBody = /* @__PURE__ */ zod.object({
    team_id: zod
        .number()
        .nullish()
        .describe("Optional team\/project id (e.g. Insights Desktop); web UI uses the session's current team."),
    connect_from: zod
        .string()
        .optional()
        .describe('Optional client hint (e.g. insights_code) for return routing after OAuth.'),
})
