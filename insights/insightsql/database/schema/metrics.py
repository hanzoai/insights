...
# 50GB - limit for user-provided InsightsQL queries on metrics tables to prevent expensive full scans
INSIGHTSQL_MAX_BYTES_TO_READ_FOR_METRICS_USER_QUERIES = 50_000_000_000
