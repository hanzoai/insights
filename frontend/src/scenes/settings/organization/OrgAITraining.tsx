...
function AITrainingDescription({ isHipaa, isLocked }: { isHipaa: boolean; isLocked: boolean }): JSX.Element {
    ...
    return (
        <div className="mb-2 text-sm text-secondary">
            <p>
                Enable Insights to use anonymized aggregated data to train AI features that benefit all Insights
                customers. <strong>Your and your customers' data stays with Insights.</strong>
            </p>
...
export function OrganizationAITrainingOptOut(): JSX.Element {
    ...
    return (
        <div className="max-w-160">
            ...
            <Button type="primary" className="inline-block" sideIcon={<IconExternal />} to={AI_TRAINING_URL}>
                What's this?
            </Button>
        </div>
    )
