...
class TestTeamMergeTrendAPI(DatastoreTestMixin, APIBaseTest):
...
class TestTeamMergeTrendQuery(DatastoreTestMixin, BaseTest):
    ...
    def test_membership_join_bot_exclusion_and_window(self):
        # Guards the freshly written InsightsQL: the daily median/average must cover exactly the
