...
// mirrors how insights-js decides target_fixed when recording heatmap points, so an area
    ...
    listeners(({ actions, values, cache }) => ({
        processElements: async ({ trigger }, breakpoint) => {
            ...
            try {
                ...
                toolbarInsightsJS.capture('toolbar clickmap processed', {
        ...
        startAreaSelection: () => {
            ...
            toolbarInsightsJS.capture('toolbar heatmap area selection started', {
        ...
        selectHeatmapAreaFilter: ({ element }) => {
            ...
            toolbarInsightsJS.capture('toolbar heatmap area filter changed', {
                enabled: !!element,
