...
from insights.temporal.ai.session_summary.summarize_session import (
...
from insights.temporal.tests.ai.conftest import AsyncRedisTestContext, SyncRedisTestContext
...
class TestSummarizeSingleSessionStreamWorkflow:
    ...
    def test_execute_summarize_session_stream_compression_decompression(
        ...
        with (
            ...
            patch(
                "insights.temporal.ai.session_summary.summarize_session._start_single_session_summary_workflow_stream",
            ...
            patch(
                "insights.temporal.ai.session_summary.summarize_session.decompress_redis_data",
                side_effect=decompress_redis_data,
            ) as mock_decompress,
            # Mock time.sleep to speed up test
            patch("insights.temporal.ai.session_summary.summarize_session.time.sleep"),
        ):
    ...
    async def test_summarize_session_workflow(
        ...
        with patch("insights.sync.database_sync_to_async") as mock_sync_to_async:
