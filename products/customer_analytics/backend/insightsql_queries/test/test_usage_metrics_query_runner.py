...
class TestUsageMetricsQueryRunner(DatastoreTestMixin, APIBaseTest):
    ...
    def test_datetime_now_shared_between_query_build_and_post_process(self):
        ...
        with patch(
            "products.customer_analytics.backend.insightsql_queries.usage_metrics_query_runner.datetime",
...
@override_settings(IN_UNIT_TESTING=True)
class TestUsageMetricsQueryRunnerDataWarehouse(DatastoreTestMixin, APIBaseTest):
    group_key = "acme"
    test_metric_id = "19bda517-7081-4004-8c1d-30d0b2b11bf5"
