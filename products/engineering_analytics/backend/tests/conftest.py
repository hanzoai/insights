...
def _enable_engineering_analytics_flag():
    # The viewset is gated on InsightsFeatureFlagPermission; without this every endpoint test 403s.
    with patch("hanzo_insights.feature_enabled", side_effect=_only_engineering_analytics_flag):
        yield
