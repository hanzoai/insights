...
from insights.tasks.usage_report import ExternalDataJob
from insights.temporal.data_imports.row_tracking import (
    finish_row_tracking,
    increment_rows,
    setup_row_tracking,
...
@mock.patch("insights.temporal.data_imports.row_tracking.database_sync_to_async_pool", database_sync_to_async)
