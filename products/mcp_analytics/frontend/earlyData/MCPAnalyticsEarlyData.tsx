                        ...
                        },
                        {
                            ...
                            render: (_, row) => (
                                <span className="flex items-center gap-1 font-mono text-sm">
                                    {row.tool}
                                    {row.isError ? <Tag type="danger">error</Tag> : null}
                                </span>
                            ),
                        },
                        {
...
//
// Progress needs an explicit bgColor here: its default is `var(--color-bg-primary)`, which is a
// neutral in UI but brand orange inside a quill Card, so the unfilled remainder renders as a
// second, larger-looking value. Applies to every Progress under a quill Card.
