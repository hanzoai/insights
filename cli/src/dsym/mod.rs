...
use clap::Subcommand;
use insights_symbol_data::{write_symbol_data, AppleDsym};
...
fn extract_dsym_uuids(dsym_path: &PathBuf) -> Result<Vec<(String, String, String)>> {
    ...
    // Parse output like: "UUID: 12345678-1234-1234-1234-123456789ABC (arm64) /path/to/DWARF/InsightsExample"
...
fn thin_if_fat(path: &Path, arch: &str) -> Result<Vec<u8>> {
    ...
    let tmp_file = tempfile::Builder::new()
        .prefix(&format!("insights_lipo_{arch}_"))
        .suffix(".dwarf")
        .tempfile()
