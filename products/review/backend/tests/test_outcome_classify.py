...
from products.review.backend.reviewer.outcomes.classify import (
    _ClassifiedOutcome,
...
from products.review.backend.reviewer.outcomes.judge import OutcomeJudgeVerdict
from products.signals.backend.artefact_attribution import ArtefactAttribution

_CLASSIFY = "products.review.backend.reviewer.outcomes.classify"
...
class TestClassifyReportDecision:
    ...
    def test_the_judges_reasoning_is_persisted_with_the_outcome(self):
        ...
        # explanation is durable without shipping free text to Datastore per finding.
        with (
    ...
    def test_event_uuid_is_deterministic_per_finding(self):
        # The uuid is the consumer-side dedup key: Datastore never collapses duplicate uuids (the
