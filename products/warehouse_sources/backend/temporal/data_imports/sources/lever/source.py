...
class LeverSource(ResumableSource[LeverSourceConfig, LeverResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Lever API key to automatically pull your Lever recruiting data into the Insights Data warehouse.
...
The key has full read access to your account's data; no individual scopes need to be granted.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/lever",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
