...
AI-assisted PR approval for Insights.
...
```bash
# run from anywhere inside the insights repo
...
Tier thresholds and deny categories calibrated against 356 PRs that received quick human approval (stamp) in the Insights repo over ~90 days:
