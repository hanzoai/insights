...
from insights.security.pinned_requests import SSRFBlockedError
    ...
    @parameterized.expand(
        [
            ...
            (
                ...
                {"x-frame-options": "DENY", "content-security-policy": "frame-ancestors 'self' *.hanzo.ai"},
                "allowed",
                None,
            ),
            ...
            (
                "csp_exact_origin",
                {"content-security-policy": "frame-ancestors https://us.hanzo.ai"},
                "allowed",
                None,
            ),
            (
                "csp_scheme_mismatch",
                {"content-security-policy": "frame-ancestors http://us.hanzo.ai"},
                "blocked",
                "frame_ancestors",
            ),
            (
            ...
            (
                ...
                {"content-security-policy": "frame-ancestors https://us.hanzo.ai:8443"},
                "blocked",
                "frame_ancestors",
            ),
            (
                "csp_spelled_out_default_port",
                {"content-security-policy": "frame-ancestors https://us.hanzo.ai:443"},
                "allowed",
                None,
            ),
            (
