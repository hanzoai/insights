...
from insights.temporal.session_replay.session_summary.activities.video_based.a3_slice_session_data_for_segments import (
...
async def test_slice_writes_one_redis_key_per_segment_with_filtered_events():
    ...
    with (
        patch(
            "insights.temporal.session_replay.session_summary.activities.video_based."
