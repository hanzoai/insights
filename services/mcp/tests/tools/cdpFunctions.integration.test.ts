...
describe('Script Functions', { concurrent: false }, () => {
    let context: Context
    ...
    describe('cdp-functions-list tool', () => {
        it('should return paginated structure', async () => {
            ...
            expect(typeof data._insightsUrl).toBe('string')
            expect(data._insightsUrl).toContain('/pipeline')
        })
    ...
    describe('cdp-functions-create tool', () => {
        it('should create a destination script function', async () => {
            const params = {
        ...
        it('should create a transformation script function with execution_order', async () => {
            const params = {
    ...
    describe('cdp-functions-retrieve tool', () => {
        it('should retrieve a specific script function by ID', async () => {
    ...
    describe('cdp-functions-partial-update tool', () => {
        it('should enable and disable a script function', async () => {
            const created = await createTool.handler(context, {
        ...
        it('should update the name of a script function', async () => {
            const created = await createTool.handler(context, {
        ...
        it('should soft-delete a script function via the delete tool', async () => {
            const created = await createTool.handler(context, {
    ...
    describe('cdp-functions-invocations-create tool', () => {
        // The tool schema correctly uses InsightsFunctionInvocationSerializer (configuration, globals, etc.).
        ...
        it('should reject an invocation with the generated schema (missing configuration)', async () => {
            ...
            // The generated tool sends InsightsFunction body fields — Django rejects with 400
            // because `configuration` is required by InsightsFunctionInvocationSerializer.
            await expect(
    ...
    describe('cdp-functions-rearrange-partial-update tool', () => {
        // The tool schema correctly includes the `orders` field from InsightsFunctionRearrangeSerializer.
    ...
    describe('Script Functions workflow', () => {
