...
from insights.temporal.data_imports.sources.generated_configs import KlaviyoSourceConfig
from insights.temporal.data_imports.sources.klaviyo.klaviyo import (
    klaviyo_source,
    validate_credentials as validate_klaviyo_credentials,
)
from insights.temporal.data_imports.sources.klaviyo.settings import ENDPOINTS, INCREMENTAL_FIELDS
...
class KlaviyoSource(SimpleSource[KlaviyoSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Klaviyo",
            betaSource=True,
            caption="""Enter your Klaviyo API key to automatically pull your Klaviyo data into the Insights Data warehouse.
