...
from insights.temporal.data_imports.sources.tiktok_ads.tiktok_ads import get_tiktok_resource, tiktok_ads_source
from insights.temporal.data_imports.sources.tiktok_ads.utils import TikTokDateRangeManager, TikTokReportResource
...
class TestTikTokAdsSource:
    ...
    @patch("insights.temporal.data_imports.sources.tiktok_ads.tiktok_ads.rest_api_resources")
