...
/**
 * Collects and flushes warehouse source webhook payloads produced by script function
 * invocations. Lifecycle mirrors `InsightsFunctionMonitoringService`: callers push
