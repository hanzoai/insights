...
class IP2WhoisSource(SimpleSource[IP2WhoisSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your IP2WHOIS API key and the domains you want to look up to pull WHOIS registration data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/ip2whois",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
