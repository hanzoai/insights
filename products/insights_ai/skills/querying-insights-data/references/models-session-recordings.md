...
Metadata for session recordings captured by the Insights SDK. The actual replay data lives in Datastore and object storage; this Postgres table stores recording-level metadata used for listing and filtering.
...
- Activity data (click_count, duration, etc.) is populated from Datastore and may be NULL for older recordings
