...
# by Insights during ingestion; `type` and `timestamp` come from the Attentive webhook payload.
_COMMON_COLUMNS = {
    "event_id": "Stable hash of the webhook payload, synthesized by Insights to dedupe retried deliveries.",
