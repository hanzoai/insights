        ...
        it('handles retention insights with a breakdown', () => {
            ...
            const tiles = [
                retentionTile([
                    ...
                    { breakdown_value: 'Chrome' },
                    { breakdown_value: '$$_insights_breakdown_other_$$' },
            ...
            expect(extractBreakdownValues(tiles, null)).toEqual([
                { breakdownValue: '$$_insights_breakdown_other_$$', breakdownType: 'event' },
                { breakdownValue: 'Chrome', breakdownType: 'event' },
                { breakdownValue: 'Firefox', breakdownType: 'event' },
            ])
        })
    ...
    describe('computeAutoBreakdownColors', () => {
        ...
        it('skips sentinel values', () => {
            const assigned = computeAutoBreakdownColors(
                [
                    value('Baseline'),
                    value('$$_insights_breakdown_other_$$'),
                    value('$$_insights_breakdown_null_$$'),
                    value('Chrome'),
                ],
                []
            )
