...
import { CyclotronJobFiltersType, InsightsFunctionType, Survey, SurveyEventName, SurveyEventProperties } from '~/types'
...
export interface surveyNotificationsListLogicValues {
    ...
    allNotifications: InsightsFunctionType[]
...
export type surveyNotificationsListLogicType = MakeLogicType<
    surveyNotificationsListLogicValues,
    surveyNotificationsListLogicActions,
    Record<string, any>,
    surveyNotificationsListLogicMeta
>
    ...
    selectors({
        ...
        notifications: [
            ...
            (
                ...
                const linkedSurveyCreatedAt = (notification: InsightsFunctionType): string => {
