...
Capsule CRM is a CRM for small and medium businesses covering contacts, the sales pipeline, and project management. This connector syncs your Capsule contacts, opportunities, projects, tasks, and supporting reference data into the Insights data warehouse so you can join CRM records with your product and revenue data.
...
3. Paste the token into the **Personal Access Token** field in Insights.
