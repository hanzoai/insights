...
_PERMISSION_DENIED_MESSAGE = "Spreadsheet access denied. Please share the spreadsheet with the Insights service account."
...
_SPREADSHEET_NOT_FOUND_MESSAGE = (
    ...
    "moved, or is no longer shared with the Insights service account."
)
    ...
    for header in headers:
        ...
        if previous is not None and previous != header:
            raise Exception(
                ...
                f'"{normalized}" when synced. Column headers must stay unique after Insights normalizes '
