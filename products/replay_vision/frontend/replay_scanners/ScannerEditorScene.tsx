...
const STEP_HEADERS: Record<
    ...
    { mascot: JSX.Element; title: string; subtitle: string }
> = {
    configure: {
        mascot: <MascotMagnifyingGlass className="h-16 sm:h-24 w-auto shrink-0" />,
        title: 'Configure your scanner',
        subtitle: 'What it looks for and how it analyzes recordings.',
    },
    triggers: {
        mascot: <MascotConstruction2 className="h-16 sm:h-24 w-auto shrink-0" />,
        title: 'Set up scan conditions',
        subtitle: 'Pick which recordings to scan, and how often.',
    },
    self_driving: {
        mascot: <MascotImTheDriver className="h-16 sm:h-24 w-auto shrink-0" />,
        title: 'Self-driving',
                        ...
                        <>
                            <div className="text-center space-y-3">
                                <div className="flex justify-center mb-2">
                                    <MascotXRay className="w-32 h-32" />
                                </div>
    ...
    return (
        <div className="flex flex-col gap-4">
            <Field name="name" label="Name">
                <Input placeholder="e.g. Confused checkout flow" />
            </Field>

            <Field name="description" label="Description (optional)">
                <TextArea placeholder="What this scanner looks for and why." minRows={2} />
            </Field>

            {isTypeSelectable ? (
                <Field name="scanner_type" label="Scanner type" className="items-start">
                    <Select
            ...
            <div className="flex flex-col gap-1 items-start">
                <Field name="model" label="Model" className="items-start">
                    <Select className="max-w-full" value={scanner.model} options={MODEL_OPTIONS} />
                </Field>
                <div className="text-xs text-muted">
    ...
    return (
        <div className="flex flex-col gap-4">
            <p className="text-sm text-muted m-0">
                ...
                Insights Signals, where agents dig into the root cause and draft a pull request. You stay in control of
                what ships.{' '}
                <Link to="https://hanzo.ai/self-driving" target="_blank">
                    Learn more about Insights self-driving
                </Link>
                .
            </p>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-muted">
                                ...
                                Insights Signals to feed the self-driving loop.
                            </div>
                        </div>
                    </div>
                )}
        ...
        <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                {isNew && step === 'configure' ? (
                    <Button type="tertiary" to={urls.replayVisionTemplates()} data-attr="vision-editor-back">
                        Back to templates
                    </Button>
                ) : prevStep ? (
