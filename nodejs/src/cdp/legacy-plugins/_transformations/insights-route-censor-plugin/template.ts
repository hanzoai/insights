...
export const insightsRouteCensorPlugin: LegacyTransformationPlugin = {
    processEvent,
        ...
        inputs_schema: [
            {
                ...
                description:
                    '[Example Here](https://github.com/ava-labs/insights-route-censor-plugin/blob/main/src/assets/exampleRoutes.json).  See package [README](https://github.com/ava-labs/insights-route-censor-plugin) for more details.',
                type: 'json',
                required: true,
            },
            {
