...
`insights.tasks.usage_report` facade (org-report aggregation, instance
...
from insights.tasks.usage_report import get_instance_metadata
...
async def aggregate_and_chunk_org_reports(inputs: AggregateInputs) -> AggregateResult:
    ...
    async with Heartbeater():
        with ExecutionTimeRecorder(
            ...
            # TODO(usage-reports-v2): re-enable Insights product-analytics
