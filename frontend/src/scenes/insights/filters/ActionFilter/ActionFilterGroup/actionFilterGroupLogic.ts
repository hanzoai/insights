...
export interface actionFilterGroupLogicActions {
    ...
    setMath: (
        ...
        defaultMathInsightsQLExpression: string
    ) => {
        defaultMathInsightsQLExpression: string
        selectedMath: string | undefined
    }
...
export const actionFilterGroupLogic = kea<actionFilterGroupLogicType>([
    ...
    actions({
        ...
        setMath: (selectedMath: string | undefined, defaultMathInsightsQLExpression: string) => ({
            selectedMath,
            defaultMathInsightsQLExpression,
        }),
    ...
    listeners(({ actions, values, props }) => {
        ...
        return {
            ...
            setMath: ({ selectedMath, defaultMathInsightsQLExpression }) => {
                const groupFilter = values.groupFilter
                if (!groupFilter) {
                    return
                }
                    ...
                    mathProps = {
                        ...
                        math_insightsql:
                            mathDef?.category === MathCategory.InsightsQLExpression
                                ? (groupFilter.math_insightsql ?? defaultMathInsightsQLExpression)
                                : undefined,
