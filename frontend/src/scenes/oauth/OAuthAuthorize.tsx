...
import { IconCheck, IconCheckCircle, IconPlus, IconWarning } from '@hanzo/icons'
    ...
    return (
        <div className="flex flex-col gap-2 p-3 border border-border rounded bg-bg-light">
            ...
            <div className="flex gap-2">
                ...
                <Button type="secondary" size="small" onClick={onCancel} disabled={loading}>
                    Cancel
                </Button>
            </div>
        </div>
...
export const OAuthAuthorize = (): JSX.Element => {
    ...
    // The name is HTML-escaped at ingestion (see insights/api/oauth/client_name.py). Decode it
            ...
            <div className="max-w-2xl mx-auto py-8 px-4 sm:py-12 sm:px-6">
                ...
                {scopesWereDefaulted && isMcpResource && (
                    <Banner type="info" className="mb-4">
                        ...
                        Showing all permissions the Insights MCP server supports.
                    </Banner>
                )}
