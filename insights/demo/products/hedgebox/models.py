...
from insights.demo.matrix.models import EVENT_AUTOCAPTURE, Effect, SimPerson, SimSessionIntent
...
if TYPE_CHECKING:
    from insights.demo.products.hedgebox.matrix import HedgeboxCluster
