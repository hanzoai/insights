...
from insights.api.proxy_record_diagnostics import diagnose as diagnose_proxy_record
...
from insights.temporal.proxy_service import CreateManagedProxyInputs, DeleteManagedProxyInputs
            ...
            return Response(
                {
                    "detail": (
                        ...
                        "if this keeps happening, contact Insights support."
                    )
                },
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
