...
def calculate_probabilities_v2_count(
    ...
    >>> from insights.insightsql_queries.experiments.trends_statistics_v2_count import calculate_probabilities_v2_count
...
def calculate_credible_intervals_v2_count(variants, lower_bound=0.025, upper_bound=0.975):
    ...
    --------
    >>> from insights.schema import ExperimentVariantTrendsBaseStats
    >>> from insights.insightsql_queries.experiments.trends_statistics_v2_count import calculate_credible_intervals_v2_count
    >>> variants = [
