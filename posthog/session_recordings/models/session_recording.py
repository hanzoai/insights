...
class SessionRecording(UUIDTModel):
    ...
    # Note: UUIDT is the Insights standard, but session_id's are generated with a different util in posthog-js
    # https://github.com/Insights/posthog-js/blob/e0dc2c005cfb5dd62b7c876676bcffe1654417a7/src/utils.ts#L457-L458
