...
from insights.temporal.session_replay.session_summary.activities.video_based.a4_analyze_video_segment import (
...
ACTIVITY_MODULE = "insights.temporal.session_replay.session_summary.activities.video_based.a4_analyze_video_segment"
