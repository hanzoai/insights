...
/**
 * List wizard sessions for the project, ordered by started_at desc. This should only be called by the Insights Wizard. Optional filters: ?workflow_id=<id> and ?skill_id=<id>.
 */
