...
describe('CdpCyclotronWorkerInsightsFlow with PersonHog', () => {
    let hub: Hub
    let team: Team
    ...
    beforeEach(async () => {
        ...
        hogFlow = await insertInsightsFlow(
            hub.postgres,
    ...
    it('resolves person by distinct_id via personinsights', async () => {
        ...
        const processor = new CdpCyclotronWorkerInsightsFlow(
            hub,
        ...
        const invocations = [
            createSerializedInsightsFlowInvocation(hogFlow, {
