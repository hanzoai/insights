...
const dashboardCreate = (): ToolBase<typeof DashboardCreateSchema, WithInsightsUrl<Schemas.Dashboard>> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof DashboardCreateSchema>) => {
        ...
        return await withInsightsUrl(context, filtered, `/dashboard/${filtered.id}`)
    },
})
...
const dashboardCreateTextTile = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.DashboardTile>
> => ({
...
const dashboardGet = (): ToolBase<typeof DashboardGetSchema, WithInsightsUrl<Schemas.Dashboard>> => ({
    name: 'dashboard-get',
...
const dashboardInsightsRun = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.RunInsightsResponse>
> => ({
...
const dashboardReorderTiles = (): ToolBase<typeof DashboardReorderTilesSchema, WithInsightsUrl<Schemas.Dashboard>> => ({
...
const dashboardTemplatesList = (): ToolBase<
    ...
    WithInformationalResponse<WithInsightsUrl<Schemas.PaginatedDashboardTemplateList>>
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof DashboardTemplatesListSchema>) => {
        ...
        return withInformationalResponse(
            await withInsightsUrl(context, filtered, '/dashboard'),
...
const dashboardTileCopy = (): ToolBase<typeof DashboardTileCopySchema, WithInsightsUrl<Schemas.Dashboard>> => ({
...
const dashboardUpdate = (): ToolBase<typeof DashboardUpdateSchema, WithInsightsUrl<Schemas.Dashboard>> => ({
...
const dashboardWidgetsBatchAdd = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.AddDashboardWidgetsBatchResponse>
> => ({
...
const dashboardWidgetsBatchUpdate = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.UpdateDashboardWidgetsBatchResponse>
> => ({
...
const dashboardWidgetsRun = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.RunWidgetsResponse>
> => ({
...
const dashboardsGetAll = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedDashboardBasicList>
> => ({
        ...
        return await withInsightsUrl(
            context,
            {
                ...
                results: await Promise.all(
                    (result.results ?? []).map((item) => withInsightsUrl(context, item, `/dashboard/${item.id}`))
                ),
            },
            '/dashboard'
        )
...
const dashboardsMoveTilePartialUpdate = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.Dashboard>
> => ({
