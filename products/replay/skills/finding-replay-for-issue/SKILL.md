...
| `insights:session-recording-get`         | Get full details for the selected recording                |
...
| `insights:vision-scanners-scan-session`  | Run a summarizer scanner on the recording (optional, slow) |
...
```json
insights:query-session-recordings-list
{
