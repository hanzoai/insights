                ...
                <CalloutBox type="fyi" title="Remote configuration">
                    <Markdown>
                        {dedent`
                            ...
                            [error tracking settings](https://app.hanzo.ai/settings/project-error-tracking#exception-autocapture).
                        `}
                    </Markdown>
                </CalloutBox>
                    ...
                    blocks={[
                        {
                            ...
                            code: dedent`
                              ...
                              do {
                                  ...
                                  InsightsSDK.shared.captureException(error)
                              }
                            `,
                        },
                    ]}
                    ...
                    blocks={[
                        {
                            ...
                            code: dedent`
                              ...
                              @try {
                                  ...
                                  [[InsightsSDK shared] captureExceptionWithNSException:exception properties:nil];
                              }
                            `,
                        },
                    ]}
                    ...
                    blocks={[
                        {
                            ...
                            code: dedent`
                              do {
                                  ...
                                  InsightsSDK.shared.captureException(error, properties: [
                                      "endpoint": "/api/users",
                                      "retry_count": 3
                                  ])
                              }
    ...
    const inAppConfigStep: StepDefinition = {
        ...
        content: (
            <>
                <Markdown>
                    {dedent`
                        By default, Insights automatically marks your app's code as "in-app" in stack traces to help you focus on your code rather than system frameworks.
