...
class TerraformCloudSource(ResumableSource[TerraformCloudSourceConfig, TerraformCloudResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Sync organizations, projects, teams, workspaces, runs, and state versions from HCP Terraform (formerly Terraform Cloud) into the Insights Data warehouse to analyze infrastructure change frequency, plan/apply durations, and failure rates.
...
Only the SaaS API at `app.terraform.io` is supported; self-hosted Terraform Enterprise is not currently supported.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/terraform-cloud",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
