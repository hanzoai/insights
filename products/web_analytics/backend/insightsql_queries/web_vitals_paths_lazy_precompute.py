...
if TYPE_CHECKING:
    from products.web_analytics.backend.insightsql_queries.web_vitals_path_breakdown import WebVitalsPathBreakdownQueryRunner
...
# 1-based Datastore `arrayElement` index into the quantiles tuple stored in
...
def execute_read_query(
    *,
    ...
    """Read the precomputed rows via InsightsQL. Returns the raw `(band, path, value)`
