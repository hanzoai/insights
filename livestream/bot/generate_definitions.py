...
Reads from products/web_analytics/backend/insightsql_queries/bot_definitions.py (single source of truth)
...
from products.web_analytics.backend.insightsql_queries.bot_definitions import BOT_DEFINITIONS  # noqa: E402
