...
class TestSQLResultsFormatter(BaseTest):
    ...
    def test_format_single_column(self):
        query = AssistantInsightsQLQuery(query="SELECT count()")
    ...
    def test_format_with_none_values(self):
        query = AssistantInsightsQLQuery(query="SELECT id, name")
        results: list[Any] = [
            {"id": 1, "name": "test"},
            {"id": 2, "name": None},
        ]
    ...
    def test_format_with_numeric_values(self):
        query = AssistantInsightsQLQuery(query="SELECT count, avg")
        results = [
            {"count": 100, "avg": 15.5},
            {"count": 200, "avg": 25.75},
        ]
    ...
    def test_format_truncates_large_dict(self):
        query = AssistantInsightsQLQuery(query="SELECT properties")
    ...
    def test_format_truncates_large_list(self):
        query = AssistantInsightsQLQuery(query="SELECT items")
    ...
    def test_format_truncation_at_boundary(self):
        query = AssistantInsightsQLQuery(query="SELECT data")
    ...
    def test_format_truncates_stringified_json_dict(self):
        query = AssistantInsightsQLQuery(query="SELECT json_data")
    ...
    def test_format_does_not_truncate_long_regular_string(self):
        query = AssistantInsightsQLQuery(query="SELECT description")
