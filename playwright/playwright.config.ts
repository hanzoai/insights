...
export default defineConfig({
    ...
    // playwright/live/** stays outside both roots on purpose: it targets a DEPLOYED
    // insights via its own config (live/live.config.ts), and collecting it here would
    // point production tests at localhost and fail the local suite.
    testDir: '..',
