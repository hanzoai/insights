    ...
    return [
            ...
            content: (
                <>
                    <CalloutBox type="info" icon="IconInfo" title="Full working examples">
                        <Markdown>
                            See the complete
                            [Node.js](https://github.com/Insights/insights-js/tree/main/examples/example-ai-openrouter)
                            and
                            [Python](https://github.com/Insights/insights-python/tree/master/examples/example-ai-openrouter)
                            examples on GitHub. If you're using the Insights SDK wrapper instead of OpenTelemetry, see
                            the [Node.js
                            wrapper](https://github.com/Insights/insights-js/tree/e08ff1be/examples/example-ai-openrouter)
                            and [Python
                            wrapper](https://github.com/Insights/insights-python/tree/7223c52/examples/example-ai-openrouter)
                            examples.
                        </Markdown>
                    </CalloutBox>
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        Now, when you use the OpenAI SDK to call OpenRouter, Insights automatically captures
