...
const DASHBOARD_SUBSCRIPTIONS = [
    ...
    createMockSubscription({
        ...
        target_type: 'email',
        target_value: 'leadership@hanzo.ai,finance@hanzo.ai,product@hanzo.ai',
        created_by: mockBasicUser,
    }),
    createMockSubscription({
        id: 14,
...
const INSIGHT_SUBSCRIPTIONS = [
    ...
    createMockSubscription({
        ...
        target_type: 'email',
        target_value: 'success@hanzo.ai,product@hanzo.ai',
        summary: 'sent every month on the first day',
        created_by: mockBasicUser,
    }),
    createMockSubscription({
...
const AI_PROMPT_SUBSCRIPTIONS = [
    ...
    createMockSubscription({
        ...
        summary: 'sent every day',
        created_by: { ...mockBasicUser, first_name: 'Ada', email: 'ada@hanzo.ai' },
    }),
]
