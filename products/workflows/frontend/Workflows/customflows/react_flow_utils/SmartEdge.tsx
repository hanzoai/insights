...
import { CustomFlowEdge } from '../types'
    ...
    const calculateHorizontalOffset = (): number => {
        ...
        if (conflictingEdges.length > 0) {
            ...
            const sortedEdges = conflictingEdges.sort((a, b) => {
                const aEdgeData = a.data!.edge as CustomFlowEdge
                const bEdgeData = b.data!.edge as CustomFlowEdge
...
export function SmartEdge({
    ...
    const { animatingEdgePair, mode } = useValues(customFlowEditorLogic)
