...
from posthog.insightsql_queries.insightsql_cohort_query import InsightsQLCohortQuery, InsightsQLRealtimeCohortQuery
...
class TestInsightsQLRealtimeCohortQuery(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_sibling_single_property_groups_under_or_merge(self) -> None:
        ...
        # The pattern will be: tuple(%(insightsql_val_X)s, %(insightsql_val_Y)s, %(insightsql_val_Z)s)
