...
Cache invalidation implementations live in insights/tasks/team_access_cache_tasks.py.
"""
...
def _update_team_authentication_cache(instance: Team, created: bool):
    ...
    try:
        ...
        from insights.tasks.team_access_cache_tasks import invalidate_token_sync
...
def user_saved(sender, instance: "User", created, **kwargs):
    ...
    from insights.tasks.team_access_cache_tasks import invalidate_user_tokens_sync
...
def clear_project_secret_api_key_cache_on_delete(sender: type["Team"], instance: "Team", **kwargs) -> None:
    ...
    """
    from insights.storage.team_access_cache import token_auth_cache
