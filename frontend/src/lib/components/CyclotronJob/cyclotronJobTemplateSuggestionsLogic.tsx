...
export interface cyclotronJobTemplateSuggestionsLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface cyclotronJobTemplateSuggestionsLogicActions {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface cyclotronJobTemplateSuggestionsLogicMeta {
    key: "liquid" | "script";
    __keaTypeGenInternalSelectorTypes: {
        allOptions: (templating: "liquid" | "script") => CyclotronJobTemplateOption[];
        optionsFuse: (allOptions: CyclotronJobTemplateOption[]) => Fuse;
        optionsFiltered: (allOptions: CyclotronJobTemplateOption[], optionsFuse: Fuse, search: string) => CyclotronJobTemplateOption[];
    };
}

export type cyclotronJobTemplateSuggestionsLogicType = MakeLogicType<cyclotronJobTemplateSuggestionsLogicValues, cyclotronJobTemplateSuggestionsLogicActions, CyclotronJobTemplateSuggestionsLogicProps, cyclotronJobTemplateSuggestionsLogicMeta>;
...
export const cyclotronJobTemplateSuggestionsLogic = kea<cyclotronJobTemplateSuggestionsLogicType>([
    ...
    selectors({
        ...
        optionsFuse: [
            (s) => [s.allOptions],
            (allOptions: CyclotronJobTemplateOption[]): Fuse => {
