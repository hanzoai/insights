                ...
                {metric.is_drifted && (
                    <Banner type="warning">
                        ...
                        <div className="flex gap-2 mt-2">
                            {sourceShortId && (
                                <Button type="secondary" size="small" onClick={refreshMetricFromInsight}>
...
function StatusRow({ metric }: { metric: DataCatalogMetricApi }): JSX.Element {
    return (
        <div className="flex items-center gap-1">
            ...
            <Tag type="option">{humanizeDefinitionKind(metric.definition_kind)}</Tag>
        </div>
    )
}
    ...
    return (
        <Field.Pure label="Unit" info="How the result is measured, like users, dollars, or percent.">
            <div className="flex items-center gap-2 max-w-md">
                <Input value={value} onChange={setValue} placeholder="users" />
                <Button
                    type="secondary"
                    size="small"
    ...
    if (kind === 'MarkdownDefinition') {
        return (
            <Section title="Definition">
                {editingDefinition ? (
                    <>
                        <TextAreaMarkdown value={draftMarkdown} onChange={onDraftMarkdown} />
                        <div className="flex gap-2">
                            <Button
                                type="primary"
                                size="small"
                            ...
                            <Button type="secondary" size="small" onClick={() => onEdit(false)}>
                                Cancel
                            </Button>
                        </div>
                    </>
    ...
    return (
        <div className="flex flex-col gap-2">
            {runResult.instructions ? (
                <Markdown disableImages>{runResult.instructions}</Markdown>
            ) : (
