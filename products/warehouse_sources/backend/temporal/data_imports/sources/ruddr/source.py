...
class RuddrSource(ResumableSource[RuddrSourceConfig, RuddrResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Ruddr API key to pull your professional services data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/ruddr",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
