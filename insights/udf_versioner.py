...
ACTIVE_XML_CONFIG = "user_defined_function.xml"
...
def prepare_version(force=False):
    ...
    comment = Comment(
        f" Version: {VERSION_STR}. Generated at: {datetime.datetime.now(datetime.UTC).isoformat()}\nThis file is autogenerated by udf_versioner.py. Do not edit this, only edit the version at insights/user_scripts/user_defined_function.xml"
    )
