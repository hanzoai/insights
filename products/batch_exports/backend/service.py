...
SUPPORTED_FILTER_TYPES = {"event", "person", "insightsql"}
...
class BatchExportModel:
    ...
    insightsql_query: str | None = None
...
class BatchExportInsertInputs:
    ...
    # Total rows staged for this run (from Datastore), used to report export progress
