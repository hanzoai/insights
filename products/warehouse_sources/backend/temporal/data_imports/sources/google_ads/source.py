...
class GoogleAdsSource(
    ...
    def get_non_retryable_errors(self) -> dict[str, str | None]:
        ...
        return {
            "ACCESS_TOKEN_SCOPE_INSUFFICIENT": "Your Google Ads connection is missing the access Insights needs. Reconnect your Google Ads account and allow access to your Google Ads data.",
    ...
    def validate_credentials(
        ...
        try:
            ...
            if "PERMISSION_DENIED" in error_message or "caller does not have permission" in error_message:
                return (
                    False,
                    "Insights doesn't have permission to access this Google Ads account. Verify the "
