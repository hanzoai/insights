...
- On the group: `math` / `math_property` / `math_property_type` / `math_multiplier` / `math_group_type_index` / `math_insightsql`, plus `name`. The engine reads aggregation from here.
