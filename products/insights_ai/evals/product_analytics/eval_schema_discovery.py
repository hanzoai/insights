...
is ``ee/scriptai/eval/ci/eval_trends.py``'s job. This eval grades ordering
and discovery hygiene.

To run:
    flox activate -- bash -c "set -a; source .env; set +a; python -m products.insights_ai.eval_harness.harness eval_schema_discovery"
"""
...
from products.insights_ai.evals.product_analytics.scorers import INSIGHT_WRITE_TOOLS, SchemaDiscoveryOrder
