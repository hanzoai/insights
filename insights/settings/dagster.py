...
from insights.settings.base_variables import CLOUD_DEPLOYMENT
...
_QUERY_LOG_ARCHIVE_EXPORT_BUCKETS = {
    "US": "insights-query-log-archive-export-us-east-1",
    "EU": "insights-query-log-archive-export-eu-central-1",
}
...
DATASTORE_BACKUPS_MAX_BANDWIDTH: int = int(os.getenv("DATASTORE_BACKUPS_MAX_BANDWIDTH", "100000000"))
...
PART_BREAKER_SSH_KEY: str | None = os.getenv("DATASTORE_SSH_PRIVATE_KEY")
