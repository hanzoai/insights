...
_PUBLISH = "insights.management.commands.setup_local_gateway_credential.project_gateway_credential"
...
class TestSetupLocalGatewayCredentialCommand(BaseTest):
    ...
    @patch("insights.management.commands.setup_local_gateway_credential.settings")
