...
def suggest_retention_rule_name(retention_days: int, filter_group: Any, *, distinct_id: str, team_id: int) -> str:
    ...
    try:
        ...
        # The hanzo_insights wrapper adds insights_* kwargs that OpenAI's stubs don't know about.
        response = client.chat.completions.create(  # type: ignore[call-overload]
            ...
            insights_properties={"ai_product": "logs", "ai_feature": "retention-rule-name-suggestion"},
        )
