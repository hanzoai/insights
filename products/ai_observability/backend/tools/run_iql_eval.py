...
from insights.schema import AssistantTool
...
class RunHogEvalTestTool(MaxTool):
    ...
    async def _arun_impl(
        ...
        # Read from ai_events with native heavy columns so the Script body still
        ...
        # into `properties` so the Script body can read `properties.$ai_input` etc.
