...
def suppress_report_from_slack(
    ...
    `user_id` is the Insights user the clicking Slack identity resolved to — the caller already
    ...
    with transaction.atomic():
        ...
        # Attribute to the resolved Insights user when the caller mapped the Slack click to one;
