...
export const onboardingLogic = kea<onboardingLogicType>([
    ...
    selectors({
        ...
        flow: [
            ...
            (
                ...
                // Collapse functionally-identical steps (e.g. multiple insights-js install
    ...
    listeners(({ actions, values, props, selectors }) => ({
        ...
        completeSelfDrivingOnboarding: async () => {
            ...
            // The insights-js install always backs product analytics; credit the extra context sources
