...
The env0 connector syncs your infrastructure-as-code data — organizations, projects, environments, deployment history, teams, templates, and per-environment cloud cost — into Insights, so you can attribute cloud spend to teams and projects and analyze deployment activity alongside your product data.
...
3. Paste them into the Insights source setup form.
