...
class DataWarehouseManagedViewSet(CreatedMetaFields, UpdatedMetaFields, UUIDTModel):
    ...
    def sync_views(self) -> None:
        ...
        # it builds a InsightsQL Database context, parses, and resolves each query. Doing
        ...
        # Internal managed-view construction (no user); bypass warehouse InsightsQL access control.
        ...
        # locks on insights_datawarehousesavedquery aren't held across synchronous
        # Temporal RPCs.
        ...
        if saved_queries_to_schedule:
            maybe_reconcile_dag(managed_dag)
    ...
    def to_saved_query_metadata(self, name: str) -> dict[str, Any]:
        # Called from DataWarehouseSavedQuery.insightsql_definition for every managed view, so it must
