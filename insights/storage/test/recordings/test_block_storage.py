...
from insights.storage.recordings.block_storage import ClearTextBlockStorage, cleartext_block_storage
from insights.storage.recordings.errors import BlockFetchError
...
class TestAsyncSessionRecordingV2Storage(APIBaseTest):
    ...
    @patch("insights.storage.recordings.block_storage.aioboto3")
    async def test_client_constructor_uses_correct_settings(self, patched_aioboto3) -> None:
        ...
        import insights.storage.recordings.block_storage as storage_module
