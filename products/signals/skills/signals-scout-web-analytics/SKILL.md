...
description: >
  Signals scout for Insights web traffic. Watches per-channel session volume, attribution
...
Insights has no native 404 event — teams instrument their own. Discover the project's convention once (then carry it in memory):
