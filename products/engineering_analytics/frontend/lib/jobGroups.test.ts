...
// Names below are taken verbatim from real Insights/insights runs (see run 28576193541: a
...
const DJANGO_CORE = 'Django tests – Core (persons-on-events off), Py 3.13.13, datastore:26.3.10'
const DJANGO_TEMPORAL = 'Django tests – Temporal (persons-on-events off), Py 3.13.13, datastore:26.3.10'
