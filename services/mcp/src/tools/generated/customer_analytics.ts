...
const accountRelationshipDefinitionsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedAccountRelationshipDefinitionList>
> => ({
...
const accountsCustomPropertyValuesList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.CustomPropertyValue[]>
> => ({
...
const accountsList = (): ToolBase<typeof AccountsListSchema, WithInsightsUrl<Schemas.PaginatedAccountList>> => ({
    name: 'accounts-list',
...
const accountsNotebooksList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedAccountNotebookList>
> => ({
...
const accountsRelationshipsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.AccountRelationship[]>
> => ({
...
const accountsSummariesList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedAccountChannelSummaryList>
> => ({
...
const announcementsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedAnnouncementList>
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof AnnouncementsListSchema>) => {
        ...
        return await withInsightsUrl(context, filtered, '/customer_analytics')
    },
})
...
const customPropertyDefinitionsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedCustomPropertyDefinitionList>
> => ({
...
const customPropertySourcesList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedCustomPropertySourceList>
> => ({
...
const customPropertySourcesRunsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedCustomPropertySyncRunList>
> => ({
...
const UsageMetricsCreateSchema = GroupsTypesMetricsCreateParams.omit({ project_id: true })
    ...
    .extend({
        ...
        math_property: GroupsTypesMetricsCreateBody.shape['math_property'].describe(
            'Required when `math` is `sum`; must be empty when `math` is `count`. For events metrics this is an event property name. For data warehouse metrics this is the column name (or InsightsQL expression) to sum on the DW table.'
        ),
    })
...
const usageMetricsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedGroupUsageMetricList>
> => ({
