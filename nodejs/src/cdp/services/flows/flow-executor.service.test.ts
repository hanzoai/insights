...
import { FlowExecutorService, createFlowInvocation } from './flow-executor.service'
...
describe('Scriptflow Executor', () => {
    ...
    describe('actions', () => {
        const createFlow = (flow: SimpleFlowRepresentation): Flow => {
            return new FixtureFlowBuilder()
        ...
        describe('follow-live contract: edits picked up on wake', () => {
            ...
            describe('delay duration edits', () => {
                const buildDelayFlow = (duration: string): Flow =>
                    createFlow({
            ...
            describe('wait_until_time_window edits', () => {
                ...
                const buildWindowFlow = (config: Record<string, any>): Flow =>
                    createFlow({
