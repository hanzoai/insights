...
""".strip(),
    inputs_schema=[
        ...
        },
        {
            ...
            "description": "Phone number to receive SMS alerts, in E.164 format (e.g. +61412345678). You can also use Insights variables like {person.properties.phone} or {event.properties.oncall_number} for dynamic routing.",
            "default": "",
            "secret": False,
            "required": True,
        },
        {
            ...
            "description": "The text body of your alert message. Use Insights variables inside curly braces, e.g.: ⚠️ {event.properties.insight_name} is {event.properties.current_value} (threshold: {event.properties.threshold_value}). Messages over 160 characters will be split automatically.",
