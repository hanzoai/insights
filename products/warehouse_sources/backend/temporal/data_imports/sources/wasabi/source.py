...
class WasabiSource(ResumableSource[WasabiSourceConfig, WasabiResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Wasabi",
            caption="""Import sub-account, usage, and invoice data from the Wasabi Account Control API (WACA) into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/wasabi",
