...
from insights.temporal.delete_teams.activities import delete_team_records_activity
...
async def test_delete_team_records_activity_converts_recursion_error():
    ...
    with patch("insights.models.team.util.delete_team_records", raise_recursion):
