...
import { CustomFunctionConfigurationLogicProps, customFunctionConfigurationLogic } from '../customFunctionConfigurationLogic'
import type { customFunctionSourceWebhookTestLogicType } from './customFunctionSourceWebhookTestLogicType'

export type CustomFunctionSourceWebhookTestForm = {
    method: string
    headers: string
    query: string
    body: string
...
export type CustomFunctionSourceWebhookTestResult = {
    status: number
    body: string
}

export const customFunctionSourceWebhookTestLogic = kea<customFunctionSourceWebhookTestLogicType>([
    props({} as CustomFunctionConfigurationLogicProps),
    key(({ id, templateId }: CustomFunctionConfigurationLogicProps) => {
    ...
    actions({
        setTestResult: (result: CustomFunctionSourceWebhookTestResult | null) => ({ result }),
    ...
    reducers({
        ...
        testResult: [
            null as CustomFunctionSourceWebhookTestResult | null,
            {
  ...
  "distinct_id": "webhook-test-123"
            ...
            } as CustomFunctionSourceWebhookTestForm,
