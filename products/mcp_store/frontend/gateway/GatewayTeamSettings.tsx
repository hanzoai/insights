            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="border rounded p-3 flex items-center justify-between gap-3">
                    <div>
                        ...
                        <div className="text-sm text-secondary">
                            Members can share connections with Insights agents and choose which tools those agents may
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="border rounded p-3 flex items-center justify-between gap-3">
                    <div>
                        ...
                        <div className="text-sm text-secondary">
                            Turning this off disables every server, including catalog servers Insights adds later.
