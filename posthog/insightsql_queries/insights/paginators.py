...
class InsightsQLHasMorePaginator:
    """
    ...
    def __init__(
        ...
        self.response: InsightsQLQueryResponse | None = None
...
class InsightsQLCursorPaginator:
    """
    ...
    def get_next_cursor(self) -> str | None:
        ...
        # Handle different result types: dict (from InsightsQL), tuple, or object
