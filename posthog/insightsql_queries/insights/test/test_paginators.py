...
from posthog.insightsql.ast import And, CompareOperation, Constant, SelectQuery
...
from posthog.insightsql_queries.actors_query_runner import ActorsQueryRunner
...
class TestInsightsQLHasMorePaginator(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_response_params_consistency(self):
        ...
        paginator = InsightsQLHasMorePaginator(limit=5, offset=10)
        paginator.response = paginator.execute_insightsql_query(
    ...
    def test_handle_none_response(self):
        ...
        paginator = InsightsQLHasMorePaginator(limit=5, offset=0)
    ...
    def test_limit_context_variations(self):
        ...
        for case in test_cases:
            with self.subTest(case=case):
                paginator = InsightsQLHasMorePaginator.from_limit_context(
    ...
    @patch("posthog.insightsql_queries.insights.paginators.execute_insightsql_query")
    def test_passes_limit_context(self, mock_execute_insightsql_query: MagicMock):
        limit_context = LimitContext.EXPORT
        paginator = InsightsQLHasMorePaginator.from_limit_context(limit_context=limit_context, limit=5, offset=10)
        paginator.execute_insightsql_query(
...
class TestInsightsQLCursorPaginator(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_cursor_encoding_decoding(self):
        ...
        paginator = InsightsQLCursorPaginator(
    ...
    def test_cursor_extraction_from_tuple_results_with_field_indices(self):
        ...
        paginator2 = InsightsQLCursorPaginator(
            limit=3,
    ...
    def test_from_limit_context_with_field_indices(self):
        ...
        paginator = InsightsQLCursorPaginator.from_limit_context(
            limit_context=LimitContext.QUERY,
            limit=5,
            order_field="start_time",
            order_direction="DESC",
