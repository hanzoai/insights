...
class TestResolveIntegration:
    ...
    def test_debug_workspace_user_resolution_uses_seeded_local_user(self):
        local_user = User.objects.create(email="test@hanzo.ai", distinct_id="u-local")
...
class TestLoadIntegrationsAuthStateFilter:
    ...
    def setup(self, db):
        ...
        with patch("insights.models.integration.WebClient") as mock_webclient_class:
