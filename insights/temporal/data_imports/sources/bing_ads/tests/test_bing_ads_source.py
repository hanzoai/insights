...
from insights.temporal.data_imports.sources.bing_ads.source import BingAdsSource
from insights.temporal.data_imports.sources.generated_configs import BingAdsSourceConfig
...
class TestBingAdsSource:
    ...
    @mock.patch("insights.temporal.data_imports.sources.bing_ads.source.bing_ads_source")
    @mock.patch.object(BingAdsSource, "get_oauth_integration")
