...
class EConomicSource(ResumableSource[EConomicSourceConfig, EConomicResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Visma e-conomic API tokens to pull your accounting data into the Insights Data warehouse.
...
Both tokens grant read access to the whole agreement; e-conomic has no per-resource scopes.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/e-conomic",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
