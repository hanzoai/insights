...
import { Button, Divider, Tabs, Tag, Spinner, Tooltip } from '@hanzo/elements'
            ...
            >
                ...
                <div className="ActivityLogRow__details flex-grow">
                    ...
                    <div className="text-secondary flex items-center gap-1.5">
                        ...
                        {logItem.client && (
                            <Tooltip title="Self-reported by the API client in the x-insights-client request header">
