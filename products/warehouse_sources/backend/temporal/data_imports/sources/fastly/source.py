...
class FastlySource(ResumableSource[FastlySourceConfig, FastlyResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Fastly API token to automatically pull your Fastly account and service configuration into the Insights Data warehouse.
...
A read-only token with **global** scope is sufficient to sync every table.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/fastly",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
