...
class TestCreateNotification(BaseTest):
    ...
    @patch("products.notifications.backend.logic.hanzo_insights.feature_enabled", return_value=True)
    ...
    @patch("products.notifications.backend.logic.hanzo_insights.feature_enabled", return_value=False)
...
class TestPublishResourceEdited(BaseTest):
    ...
    def test_publishes_transient_event_without_persisting(self, mock_get_producer, mock_ff):
        ...
        assert payload["resource_type"] == "InsightsFlow"
