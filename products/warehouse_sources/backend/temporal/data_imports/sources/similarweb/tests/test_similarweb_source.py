...
from insights.schema import ReleaseStatus, SourceFieldInputConfig, SourceFieldInputConfigType, SourceFieldSelectConfig
...
class TestSimilarwebSource:
    def setup_method(self) -> None:
        ...
        self.team_id = 123
        self.config = SimilarwebSourceConfig(api_key="key-123", domains="hanzo.ai")
    ...
    def test_validate_credentials_rejects_bad_settings_without_calling_the_api(
        ...
        config = SimilarwebSourceConfig(**{"api_key": "key-123", "domains": "hanzo.ai", **overrides})
    ...
    def test_source_for_pipeline_drops_the_watermark_on_a_full_refresh(self) -> None:
        ...
        assert build.call_args.kwargs["domains"] == "hanzo.ai"
