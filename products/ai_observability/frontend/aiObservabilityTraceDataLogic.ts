...
export interface aiObservabilityTraceDataLogicMeta {
    ...
    __keaTypeGenInternalSelectorTypes: {
        ...
        metricsAndFeedbackEvents: (metricEvents: LLMTraceEvent[], feedbackEvents: LLMTraceEvent[]) => {
            metric: string;
            value: any;
        }[];
        ...
        enrichedTree: (filteredTree: TraceTreeNode[], feedbackAttachmentMap: FeedbackAttachmentMap) => EnrichedTraceTreeNode[];
