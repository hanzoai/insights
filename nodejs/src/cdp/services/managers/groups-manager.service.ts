...
import { GroupType, InsightsFunctionInvocationGlobals } from '../../types'
...
export class GroupsManagerService {
     ...
     */
    public async addGroupsToGlobals(globals: InsightsFunctionInvocationGlobals): Promise<void> {
        if (globals.groups) {
            return
        }
    ...
    public async addGroupsToGlobalsList(globalsList: InsightsFunctionInvocationGlobals[]): Promise<void> {
