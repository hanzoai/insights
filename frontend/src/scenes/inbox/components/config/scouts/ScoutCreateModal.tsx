...
import { Button, Input, Modal, Select, Switch, TextArea } from '@hanzo/elements'
        ...
        >
            ...
            >
                <div className="flex flex-col gap-4">
                    ...
                    <Field name="body" label="Instructions" help="This markdown prompt is executed on every run.">
                        <TextArea
                            minRows={8}
                            maxRows={16}
                    ...
                    <div className="flex flex-col gap-3 border-t border-primary pt-4">
                        ...
                        {scheduleMode === SCOUT_DAILY_AT_SCHEDULE_MODE ? (
                            <Field.Pure label="Run time" help={`Uses the project timezone (${projectTimezone})`}>
                                <Input
                                    type="time"
                                    step={60}
                        ...
                        <Field name="config.output_destinations">
                            {({ value, onChange }) => (
