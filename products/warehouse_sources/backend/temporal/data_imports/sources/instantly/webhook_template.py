...
# on the webhook. `create_webhook` attaches a generated secret in the x-insights-webhook-secret
...
if (not inputs.bypass_secret_check) {
  ...
  let providedSecret := request.headers['x-insights-webhook-secret']
    ...
    inputs_schema=[
        {
            ...
            "secret": True,
            "hidden": False,
            "description": "Shared secret sent by Instantly in the x-insights-webhook-secret header, used to verify the delivery came from your webhook",
        },
        {
            "type": "boolean",
            "key": "bypass_secret_check",
            "label": "Bypass secret check",
            "description": "If set, the x-insights-webhook-secret header will not be checked. Only use this for manually created webhooks without the secret header configured.",
            "default": False,
            "required": False,
            "secret": False,
        },
