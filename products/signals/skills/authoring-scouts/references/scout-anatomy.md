...
Attach bundled files to a per-team scout with `insights:skill-file-create`; in the repo, drop them in `references/` and they're collected automatically.
...
name: signals-scout-<scope>
description: >
  Signals scout for Insights <surface>. Watches <event/metric> for <the shapes: bursts /
