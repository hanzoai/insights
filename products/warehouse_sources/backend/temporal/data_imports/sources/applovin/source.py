...
class AppLovinSource(ResumableSource[AppLovinSourceConfig, AppLovinResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="AppLovin",
            caption="""Connect your AppLovin account to pull MAX mediation revenue, campaign spend, and cohort reporting into the Insights Data warehouse.
...
AppLovin only serves the last 45 days of report data, so anything older than that can't be backfilled.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/applovin",
