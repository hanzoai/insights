...
from insights.caching.query_cache_routing import QUERY_CACHE_ALIAS, get_query_cache, use_cluster_cache
...
class TestQueryCacheRouting(BaseTest):
    ...
    @patch("insights.caching.query_cache_routing.posthoganalytics.feature_enabled", return_value=True)
    ...
    @patch("insights.caching.query_cache_routing.posthoganalytics.feature_enabled", return_value=False)
    ...
    @patch("insights.caching.query_cache_routing.posthoganalytics.feature_enabled", side_effect=[True, False])
