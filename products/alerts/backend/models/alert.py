...
from insights.schema_enums import AlertCalculationInterval, AlertState
...
class AlertConfiguration(ModelActivityMixin, CreatedMetaFields, UUIDTModel):
    ...
    # (anomaly) alerts. See insights/temporal/alerts/workflows.py for the trigger logic.
    ...
    # real fire. See insights/temporal/alerts/workflows.py (RunInvestigationSafetyNetWorkflow).
    ...
    class Meta:
        db_table = "insights_alertconfiguration"
    ...
    def is_high_frequency_interval(self) -> bool:
        # Real-time counts as high frequency so its checks always run fresh Datastore
    ...
    def _get_event_properties(self) -> dict:
        ...
        is_insightsql_config = alert_config.get("type") == "InsightsQLAlertConfig"
        ...
        return {
            ...
            "insightsql_evaluation": (alert_config.get("evaluation") or "last_row") if is_insightsql_config else None,
            "insightsql_has_explicit_column": bool(alert_config.get("column")) if is_insightsql_config else None,
            "insightsql_has_label_column": bool(alert_config.get("label_column")) if is_insightsql_config else None,
...
class AlertSubscription(ModelActivityMixin, CreatedMetaFields, UUIDTModel):
    ...
    class Meta:
        ...
        db_table = "insights_alertsubscription"
