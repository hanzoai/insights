...
class TestInsightsFlowTemplateAPI(APIBaseTest):
    def setUp(self):
        super().setUp()
        ...
        self.template_with_defaults = InsightsFunctionTemplate.objects.create(
    ...
    def _create_insights_flow_data(self, include_metadata: bool = False, custom_inputs: Any = None) -> dict[str, Any]:
        """Helper to create script flow data for template creation"""
        trigger_action = {
            "id": "trigger_node",
            "name": "trigger_1",
            "type": "trigger",
        ...
        insights_flow_data: dict[str, Any] = {
    ...
    def test_template_filtering_returns_global_and_team_templates(self):
        ...
        other_team_template = InsightsFlowTemplate.objects.create(
    ...
    def test_updating_team_template_to_global_is_blocked(self):
        ...
        template = InsightsFlowTemplate.objects.get(id=template_id)
        assert template.scope == "team"
    ...
    def test_org_scoped_template_visible_to_other_teams_in_same_org(self):
        ...
        org_template = InsightsFlowTemplate.objects.create(
            name="Org Template",
            team=self.team,
            scope="organization",
            trigger={"type": "event"},
    ...
    def test_org_scoped_template_not_visible_to_other_orgs(self):
        ...
        InsightsFlowTemplate.objects.create(
            name="Org Template",
            team=self.team,
            scope="organization",
            trigger={"type": "event"},
    ...
    def test_cannot_update_org_scoped_template_from_other_org(self):
        ...
        template = InsightsFlowTemplate.objects.get(pk=template_id)
