 ...
 * app via the `insights-code(-dev)://` custom scheme; for visitors without the app it
        ...
        <BridgePage view="code-canvas-link">
            <div className="flex flex-col items-center gap-4 text-center max-w-lg mx-auto">
                ...
                <p className="text-muted mb-0">
                    Canvases live in the Insights Desktop app. If it's installed, it should open automatically. If it
