    ...
    listeners(({ actions, values, key, props }) => ({
        ...
        loadSearchResultsSuccess: ({ searchResults, payload }) => {
            ...
            if (searchResults.searchTerm && (!payload || !payload.offset)) {
                insights.capture('project tree searched', {
        ...
        moveCheckedItems: ({ path }) => {
            ...
            insights.capture('project tree items moved', {
                root: props.root ?? 'project://',
                count: movedCount,
                is_bulk: true,
            })
        ...
        rename: ({ value, item }) => {
            ...
            if (splits.length > 0) {
                if (value) {
                    insights.capture('project tree item renamed', {
                        root: props.root ?? 'project://',
        ...
        deleteItem: ({ item }) => {
            insights.capture('project tree item deleted', {
                root: props.root ?? 'project://',
                item_type: item.type ?? null,
            })
        },
        createFolder: ({ parentPath, editAfter, callback }) => {
            insights.capture('project tree folder created', {
                root: props.root ?? 'project://',
        ...
        setSortMethod: ({ sortMethod }) => {
            insights.capture('project tree sort changed', {
                root: props.root ?? 'project://',
