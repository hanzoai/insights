...
describe('PersonState.processEvent()', () => {
    ...
    beforeAll(async () => {
        ...
        // Pre-create every topic Datastore's Kafka engine tables subscribe to. Otherwise any
        // table whose topic is missing keeps retrying "Can't get assignment", which saturates
        // Datastore's background scheduler and intermittently starves the consumers this suite
