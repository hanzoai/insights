...
export interface insightDataLogicValues {
    ...
    hogQL: string | null;
    hogQLVariables: Record<string, InsightsQLVariable> | undefined;
...
export interface insightDataLogicActions {
    ...
    setInsight: (insight: Partial<QueryBasedInsightModel<Node<Record<string, any>>>>, options: SetInsightOptions) => {
        insight: Partial<QueryBasedInsightModel<Node<Record<string, any>>>>;
        options: SetInsightOptions;
    }; // insightLogic
    setInsightMetadata: (metadataUpdate: Partial<Pick<QueryBasedInsightModel<Node<Record<string, any>>>, "description" | "favorited" | "name" | "tags">>) => {
        metadataUpdate: Partial<Pick<QueryBasedInsightModel<Node<Record<string, any>>>, "description" | "favorited" | "name" | "tags">>;
    }; // insightLogic
    ...
    generateInsightMetadataFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    ...
    setQuery: (query: Node | null, fromUrl?: boolean) => {
        fromUrl: boolean;
        query: Node<Record<string, any>> | null;
    };
...
export interface insightDataLogicMeta {
    ...
    __keaTypeGenInternalSelectorTypes: {
        query: (propsQuery: QuerySchema | null | undefined, insight: Partial<QueryBasedInsightModel<Node<Record<string, any>>>>, internalQuery: Node<Record<string, any>> | null, filterTestAccountsDefault: boolean, isDataWarehouseQuery: boolean) => Node | null;
        isDataWarehouseQuery: (arg: any) => boolean;
        propsQuery: (arg: any) => QuerySchema | null | undefined;
        exportContext: (query: Node<Record<string, any>> | null, insight: Partial<QueryBasedInsightModel<Node<Record<string, any>>>>) => ExportContext | undefined;
        queryChanged: (query: Node<Record<string, any>> | null, savedInsight: Partial<QueryBasedInsightModel<Node<Record<string, any>>>>, filterTestAccountsDefault: boolean) => boolean;
        insightData: (insightDataRaw: ErrorTrackingQueryResponse | HogQueryResponse | InsightsQLAutocompleteResponse | InsightsQLMetadataResponse | InsightsQLQueryResponse<any[]> | LogAttributesQueryResponse | LogValuesQueryResponse | MetricsQueryResponse | Record<string, any> | SessionsQueryResponse | TraceSpansAggregationQueryResponse | TraceSpansAttributeBreakdownQueryResponse | TraceSpansQueryResponse | null) => Record<string, any>;
        hogQL: (insightData: Record<string, any>, query: Node<Record<string, any>> | null) => string | null;
        hogQLVariables: (query: Node<Record<string, any>> | null) => Record<string, InsightsQLVariable> | undefined;
        canEditInSqlEditor: (hogQL: string | null, query: Node<Record<string, any>> | null) => boolean;
    };
}

export type insightDataLogicType = MakeLogicType<insightDataLogicValues, insightDataLogicActions, InsightLogicProps, insightDataLogicMeta>;
...
export const insightDataLogic = kea<insightDataLogicType>([
    ...
    selectors({
        ...
        hogQLVariables: [
            (s) => [s.query],
            (query: Node | null): Record<string, InsightsQLVariable> | undefined => {
                if (isDataVisualizationNode(query) && isInsightsQLQuery(query.source)) {
        ...
        canEditInSqlEditor: [
            ...
            (hogQL: string | null, query: Node | null): boolean =>
                // We need a resolved insightsql string, and the insight must not already be SQL-authored
    ...
    afterMount(({ actions, props }) => {
        ...
        } else if (isInsightsQLQuery(source)) {
