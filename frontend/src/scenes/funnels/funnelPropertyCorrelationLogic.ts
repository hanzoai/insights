...
// https://github.com/Insights/insights/issues/6474#issuecomment-952044722
...
export interface funnelPropertyCorrelationLogicValues {
    querySource: FunnelsQuery | null // funnelCorrelationLogic
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface funnelPropertyCorrelationLogicActions {
    excludePropertyFromProject: (propertyName: string) => {
        propertyName: string
    }
    loadPropertyCorrelations: (_: any) => any
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface funnelPropertyCorrelationLogicMeta {
    key: string
    __keaTypeGenInternalSelectorTypes: {
        ...
        excludedPropertyNames: (currentTeam: TeamPublicType | TeamType | null) => string[]
        isPropertyExcludedFromProject: (excludedPropertyNames: string[]) => (propertyName: string) => boolean
    }
}

export type funnelPropertyCorrelationLogicType = MakeLogicType<
    funnelPropertyCorrelationLogicValues,
    funnelPropertyCorrelationLogicActions,
    InsightLogicProps,
    funnelPropertyCorrelationLogicMeta
>
...
export const funnelPropertyCorrelationLogic = kea<funnelPropertyCorrelationLogicType>([
    ...
    selectors({
        ...
        isPropertyExcludedFromProject: [
            ...
            (excludedPropertyNames: string[]) => (propertyName: string) =>
