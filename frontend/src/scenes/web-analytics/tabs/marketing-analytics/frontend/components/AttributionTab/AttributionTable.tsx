...
import { Banner, Table, TableColumn, TableColumnGroup, Tooltip } from '@hanzo/elements'
...
export function AttributionTable({
    ...
    const buildColumns = (): TableColumnGroup<MarketingAnalyticsAttributionRow>[] => {
        const numericColumn = (
            title: string,
            tooltip: string,
        ...
        ): TableColumn<MarketingAnalyticsAttributionRow, keyof MarketingAnalyticsAttributionRow | undefined> => ({
            title,
            tooltip,
            key,
            align: 'right',
    ...
    return (
        <div className="flex flex-col gap-4">
            {!responseLoading && allModelsAgree && (
                <Banner type="info" dismissKey="marketing-attribution-models-identical">
