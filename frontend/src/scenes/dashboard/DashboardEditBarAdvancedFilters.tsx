    ...
    return (
            ...
            overlay={
                <div className="flex w-80 flex-col gap-2 p-2">
                    ...
                    <div className="flex items-center justify-between gap-2">
                        <Label info="Force test account filtering on or off for every insight, or let each insight keep its own setting.">
                    ...
                    <SegmentedButton<TestAccountFilterChoice>
                        fullWidth
                        size="small"
                        value={choice}
                        onChange={(next) => {
                    ...
                    {showColors && (
                        <>
                            <Divider className="my-0" />
                            <Label info="Pin a breakdown value to a color, or pick a color theme, so every insight on this dashboard draws it the same way.">
                                Breakdown colors
                            </Label>
                            <Button
                                type="secondary"
        ...
        >
            <Button
                ...
                sideIcon={overrideCount ? <Badge.Number count={overrideCount} size="small" /> : undefined}
