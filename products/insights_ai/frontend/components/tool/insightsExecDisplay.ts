/**
 * Shared display helpers for the Insights single-exec MCP tool. The `insights` MCP server exposes one
...
export interface InsightsExecDisplay {
    label: string
    input?: string
}
 ...
 */
export function getInsightsExecDisplay(toolInput: unknown): InsightsExecDisplay | null {
...
export function formatInsightsExecBody(input: string | undefined): string | undefined {
    if (!input) {
        return undefined
    }
    try {
