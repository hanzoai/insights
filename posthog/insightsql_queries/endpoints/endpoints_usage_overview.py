...
from posthog.insightsql_queries.endpoints.endpoints_usage_query_runner import EndpointsUsageQueryRunner
...
class EndpointsUsageOverviewQueryRunner(EndpointsUsageQueryRunner[EndpointsUsageOverviewQueryResponse]):
    ...
    def _row_to_metrics_dict(self, row: list) -> dict[str, float]:
        ...
        from posthog.insightsql_queries.endpoints.endpoints_usage_query_runner import safe_float
