...
class OncehubSource(ResumableSource[OncehubSourceConfig, OncehubResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your OnceHub API key to pull your scheduling and booking data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/oncehub",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
