...
from posthog.insightsql.constants import (
...
from posthog.insightsql.database.models import DateDatabaseField, StringDatabaseField
from posthog.insightsql.errors import ExposedInsightsQLError, ImpossibleASTError, QueryError
from posthog.insightsql.insightsqlx import convert_tag_to_hx
from posthog.insightsql.parser import parse_expr, parse_select
from posthog.insightsql.printer import prepare_and_print_ast, prepare_ast_for_printing, print_prepared_ast, to_printed_insightsql
...
class TestPrinter(BaseTest):
    ...
    @patch("posthog.insightsql.printer.base.get_materialized_column_for_property")
    ...
    def test_s3_tables_global_join_with_cte(self, name, using_global_joins, optimize_projections):
        with mock.patch("posthog.insightsql.resolver.USE_GLOBAL_JOINS", using_global_joins):
