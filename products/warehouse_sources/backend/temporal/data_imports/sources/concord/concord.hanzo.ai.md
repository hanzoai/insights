...
folders, clauses, tags, reports, organization members, and audit events into the Insights data
...
contents/docs/cdp/sources/concord.md (served at /docs/cdp/sources/concord). No hanzo.ai checkout
was available when this was written, so it is committed alongside the source to travel with the PR.
Copy it to hanzo.ai (dropping this comment) and run
