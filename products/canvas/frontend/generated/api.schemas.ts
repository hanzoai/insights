...
/**
 * Declared Insights/network capabilities the artifact is held to at runtime.
 */
...
export interface CanvasInsightsCapabilitiesApi {
    /**
     * @maxItems 100
     * @items.maxLength 128
     */
...
export interface CanvasCapabilitiesApi {
    insights: CanvasInsightsCapabilitiesApi
...
/**
 * Exact-version dependencies, restricted to the platform-supported set (react, react-dom, @hanzo/quill, recharts, lucide-react, dayjs) at their pinned versions.
 */
