...
func TestFilterEquivalence(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var roundTripped InsightsEvent
			...
			case "event":
				...
				directEvt, ok := directResult.(ResponseInsightsEvent)
				require.True(t, ok, "direct result should be ResponseInsightsEvent")
				pubsubEvt, ok := pubsubResult.(ResponseInsightsEvent)
				require.True(t, ok, "pubsub result should be ResponseInsightsEvent")
