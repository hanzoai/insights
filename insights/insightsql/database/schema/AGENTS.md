# InsightsQL schema definitions

This directory defines the tables and columns available in InsightsQL (events, persons, sessions,
...
`data_types` — so agents can discover and disambiguate the schema with plain InsightsQL:
