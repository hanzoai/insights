    ...
    operations = [
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                migrations.RunSQL(
                    sql="""
                        ALTER TABLE "insights_resourcenotebook"
                        ADD COLUMN "account_id" uuid NULL
                        CONSTRAINT "insights_resourcenotebook_account_id_fk"
                        REFERENCES "customer_analytics_account"("id")
                        DEFERRABLE INITIALLY DEFERRED; -- existing-table-constraint-ignore
                        SET CONSTRAINTS "insights_resourcenotebook_account_id_fk" IMMEDIATE; -- existing-table-constraint-ignore
                    """,
                    reverse_sql="""
                        ALTER TABLE "insights_resourcenotebook" DROP COLUMN IF EXISTS "account_id";
                    """,
                ),
                migrations.RunSQL(
                    sql="""
                        ALTER TABLE "insights_resourcenotebook" DROP CONSTRAINT IF EXISTS "exactly_one_notebook_related_resource";
                        ALTER TABLE "insights_resourcenotebook" ADD CONSTRAINT "exactly_one_notebook_related_resource" CHECK ( /* -- existing-table-constraint-ignore */
                            (
                ...
                migrations.RunSQL(
                    sql="""
                        ALTER TABLE "insights_resourcenotebook" DROP CONSTRAINT IF EXISTS "insights_resourcenotebook_notebook_id_group_id_88c0a30b_uniq";
                    """,
