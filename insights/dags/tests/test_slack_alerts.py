...
from insights.dags.slack_alerts import (
...
class TestSendSlackAlert:
    ...
    def test_success_sends_blocks_with_text_fallback(self):
        ...
        send_slack_alert(context, client, "#alerts-datastore", self._blocks(), "fallback")

        client.chat_postMessage.assert_called_once_with(
            channel="#alerts-datastore", blocks=self._blocks(), text="fallback"
        )
