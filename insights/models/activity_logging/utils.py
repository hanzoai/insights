...
if TYPE_CHECKING:
    from insights.models.activity_logging.activity_log import ActivityLog, Trigger

logger = structlog.get_logger(__name__)

ACTIVITY_LOG_CLIENT_HEADER = "x-insights-client"
...
class ActivityLogVisibilityManager:
    ...
    def _get_restrictions(cls) -> list[dict[str, Any]]:
        from insights.models.activity_logging.activity_log import activity_visibility_restrictions
