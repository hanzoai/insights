...
_WINDOW_COLUMNS = {
    "window_start_date": "First day of the calendar-month window this row was exported for (added by Insights).",
    "window_end_date": "Last day of the calendar-month window this row was exported for (added by Insights).",
}
...
CANONICAL_DESCRIPTIONS: CanonicalDescriptions = {
    ...
    "deliverables": {
        ...
        "docs_url": "https://github.com/Jellyfish-AI/jellyfish-mcp",
        "columns": {
            "work_category_slug": "Slug of the work category this deliverable was exported from (added by Insights).",
