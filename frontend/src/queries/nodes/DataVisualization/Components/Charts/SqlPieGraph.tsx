...
import { ColorGlyph } from '@hanzo/elements'
import { PieChart, TooltipSurface, TooltipSwatch } from '@hanzo/quill-charts'
import type { PieChartConfig, TooltipContext } from '@hanzo/quill-charts'
...
/**
 * SQL pie graph on @hanzo/quill-charts' {@link PieChart}. The chart core lives in quill; the
                    ...
                    return (
                        <div key={slice.label} className="flex items-center justify-between gap-3 px-3 py-2 text-sm">
                            <div className="flex items-center gap-2 min-w-0">
                                <ColorGlyph color={slice.color} className="shrink-0" />
