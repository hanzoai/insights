...
def _build_context(
    *,
    ...
    repository: str | None = "insights/insights-js",
...
class TestProcessTaskWorkflowUnit:
    ...
    async def test_get_sandbox_for_repository_injects_fresh_tokens_on_resume(self, monkeypatch):
        ...
        assert inject_call_args["input"].repository == "insights/insights-js"
    ...
    async def test_get_sandbox_for_repository_clones_every_repository(self, monkeypatch):
        ...
        workflow._context = _build_context(
            github_integration_id=123,
            state={"repositories": ["insights/insights", "insights/code"]},
        )
        prepared = PrepareSandboxForRepositoryOutput(
            sandbox_name="sandbox-name",
        ...
        assert cloned == ["insights/insights", "insights/code"]
...
class TestContinueAsNew:
    ...
    def test_build_and_restore_round_trips_loop_state(self) -> None:
        ...
        assert resumed_input.insights_mcp_scopes == "full"
