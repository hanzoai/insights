...
class MetabaseSource(SimpleSource[MetabaseSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Metabase instance URL and credentials to pull your Metabase data into the Insights Data warehouse.
...
The API key (or user) needs read access to the data you want to sync.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/metabase",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
