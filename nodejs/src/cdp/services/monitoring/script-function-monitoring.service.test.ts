...
import { InsightsFunctionMonitoringService, MonitoringOutput } from './script-function-monitoring.service'

describe('InsightsFunctionMonitoringService', () => {
    let service: InsightsFunctionMonitoringService
    ...
    beforeEach(() => {
        ...
        service = new InsightsFunctionMonitoringService(
    ...
    const unmirroredCases: { name: string; source: MetricLogSource; overrides: Partial<MinimalAppMetric> }[] = [
        ...
        {
            name: 'a versioned script function',
