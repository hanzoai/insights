...
describe('logs utils', () => {
    describe.each([
        ...
        ['distinctId', true],
        ['distinctID', true],
        ['insightsDistinctId', true],
        ['insightsDistinctID', true],
        ['insights_distinct_id', true],
        ['insights.distinct.id', true],
        ['insights.distinct_id', true],
        // Dotted paths
        ['foo.distinct_id', true],
        ['foo.bar.insightsDistinctId', true],
        ['foo.bar.insights_distinct_id', true],
    ...
    describe.each([
        ...
        ['sessionID', true],
        ['$session_id', true],
        ['insightsSessionId', true],
        ['insightsSessionID', true],
        ['insights_session_id', true],
        ['insights.session.id', true],
        ['insights.session_id', true],
        // Dotted paths
        ['foo.session_id', true],
        ['foo.bar.insightsSessionId', true],
        ['foo.bar.insights_session_id', true],
