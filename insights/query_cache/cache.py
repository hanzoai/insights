...
from insights.cache_utils import OrjsonJsonSerializer
from insights.query_cache.failures import Budget, FailureKind, QueryFailureCache, QueryFailureRecord
from insights.query_cache.freshness_index import remove_last_refresh, update_target_age
from insights.query_cache.metrics import count_cache_write_data
from insights.query_cache.results import fetch_entry
from insights.query_cache.serialization import CachedEntry, encode_split_cached_response
...
class QueryCache:
    ...
    the freshness index, and the failure circuit breaker. Code outside insights/query_cache
