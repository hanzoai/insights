...
Commands:
  login      Interactively authenticate with Insights, storing a personal API token locally. You can also use the environment variables `POSTHOG_CLI_API_KEY`, `POSTHOG_CLI_PROJECT_ID` and `POSTHOG_CLI_HOST`
...
Options:
      --host <HOST>  The Insights host to connect to [default: https://us.posthog.com]
  -h, --help         Print help
...
- `POSTHOG_CLI_HOST`: The Insights host to connect to [default: https://us.posthog.com]
