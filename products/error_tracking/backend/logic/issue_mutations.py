...
These encapsulate the transaction boundaries, activity logging, Datastore sync and
...
def update_issue(
    ...
    if changes:
        ...
        sync_issues_to_datastore(issue_ids=[issue.id], team_id=team_id)
...
def bulk_update_issues(
    ...
    *,
    ...
    sync_issues_to_datastore(issue_ids=[issue.id for issue in issues], team_id=team_id)
