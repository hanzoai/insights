...
from insights.models.utils import SHA256_HASH_PREFIX, generate_random_token, generate_random_token_secret, hash_key_value
from insights.redis import get_client
from insights.settings.utils import generate_rsa_private_key_pem
from insights.storage.gateway_credential_cache import (
...
from insights.tasks.gateway_credential import (
...
class TestGatewayCredentialTasks(GatewayCredentialTestMixin):
    ...
    @patch("insights.tasks.gateway_credential.settings")
...
class TestGatewayCredentialSignals(GatewayCredentialTestMixin):
    @patch("insights.storage.gateway_credential_signal_handlers.transaction")
    @patch("insights.storage.gateway_credential_signal_handlers.settings")
    @patch("insights.tasks.gateway_credential.update_gateway_credential_cache_task.delay")
    ...
    @patch("insights.storage.gateway_credential_signal_handlers.settings")
    @patch("insights.tasks.gateway_credential.update_gateway_credential_cache_task.delay")
    @patch("insights.storage.gateway_credential_signal_handlers.clear_gateway_credential")
    ...
    @patch("insights.storage.gateway_credential_signal_handlers.transaction")
    @patch("insights.storage.gateway_credential_signal_handlers.settings")
    @patch("insights.tasks.gateway_credential.reproject_user_gateway_credentials_task.delay")
    ...
    @patch("insights.storage.gateway_credential_signal_handlers.transaction")
    @patch("insights.storage.gateway_credential_signal_handlers.settings")
    @patch("insights.tasks.gateway_credential.reproject_user_gateway_credentials_task")
    ...
    def test_user_deactivation_clears_blob_synchronously(self):
        ...
        with (
            patch("insights.storage.gateway_credential_signal_handlers.settings") as mock_settings,
            patch("insights.storage.gateway_credential_signal_handlers.transaction") as mock_transaction,
            patch("insights.tasks.gateway_credential.reproject_user_gateway_credentials_task.delay") as mock_delay,
        ):
            mock_settings.AI_GATEWAY_REDIS_URL = "redis://localhost"
            mock_transaction.on_commit.side_effect = lambda fn: fn()
            user = User.objects.get(pk=self.user.pk)
    ...
    @patch("insights.storage.gateway_credential_signal_handlers.transaction")
    @patch("insights.storage.gateway_credential_signal_handlers.settings")
    @patch("insights.tasks.gateway_credential.reproject_team_gateway_credentials_task.delay")
