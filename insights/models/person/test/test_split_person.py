...
@patch("insights.models.person.util.create_person")
@patch("insights.models.person.util.create_person_distinct_id")
class TestSplitPerson(BaseTest):
    """split_person reads and writes person data exclusively through personinsights.
    ...
    def test_split_does_not_write_orm(self, mock_create_pdi, mock_create_person):
        with fake_personinsights_client() as fake:
            ...
            # The write went through the RPC — reads resolve via personinsights, not the ORM.
    ...
    def test_split_pre_existing_person_keeps_created_at_and_bumps_version(self, mock_create_pdi, mock_create_person):
        ...
        # must carry both so Datastore converges on the Postgres state.
    ...
    def test_split_paginates_fetch_and_splits(self, mock_create_pdi, mock_create_person):
        with fake_personinsights_client() as fake:
            ...
            with patch("insights.models.person.person.PERSONFN_SPLIT_BATCH_SIZE", 2):
            ...
            for call in fetch_calls:
                assert call.request.limit == 3  # PERSONFN_SPLIT_BATCH_SIZE + 1
    ...
    def test_split_person_not_found_in_personinsights(self, mock_create_pdi, mock_create_person):
    ...
    def test_max_splits_caps_across_pages(self, mock_create_pdi, mock_create_person):
        with fake_personinsights_client() as fake:
            ...
            with patch("insights.models.person.person.PERSONFN_SPLIT_BATCH_SIZE", 3):
