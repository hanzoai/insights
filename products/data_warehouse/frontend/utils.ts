...
export const buildSelectAllQuery = (tableName: string, limitOffsetClause?: string | null): string => {
    ...
    return `SELECT * FROM ${escapeDottedInsightsQLIdentifier(tableName)}${limitClause}`
}
...
export const StatusTagSetting: Record<ExternalDataJobStatus | ExternalDataSchemaStatus, TagType> = {
