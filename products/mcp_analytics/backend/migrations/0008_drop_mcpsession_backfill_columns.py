...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunSQL(
            sql="""
                DROP INDEX IF EXISTS insights_mcp_team_id_b561f4_idx;
                ALTER TABLE insights_mcp_session
            ...
            reverse_sql="""
                ...
                CREATE INDEX IF NOT EXISTS insights_mcp_team_id_b561f4_idx
                    ON insights_mcp_session (team_id, session_end DESC);
            """,
        ),
    ]
