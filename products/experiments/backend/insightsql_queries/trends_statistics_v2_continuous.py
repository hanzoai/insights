...
from insights.schema import ExperimentSignificanceCode, ExperimentVariantTrendsBaseStats

from insights.exceptions_capture import capture_exception

from products.experiments.backend.insightsql_queries import (
...
def calculate_probabilities_v2_continuous(
    ...
    Example:
    --------
    >>> from insights.schema import ExperimentVariantTrendsBaseStats
    >>> from products.experiments.backend.insightsql_queries.trends_statistics_v2_continuous import calculate_probabilities_v2_continuous
...
def calculate_credible_intervals_v2_continuous(variants, lower_bound=0.025, upper_bound=0.975):
    ...
    --------
    >>> from insights.schema import ExperimentVariantTrendsBaseStats
    >>> from products.experiments.backend.insightsql_queries.trends_statistics_v2_continuous import calculate_credible_intervals_v2_continuous
    >>> variants = [
