    ...
    const calculateHorizontalOffset = (): number => {
        ...
        if (conflictingEdges.length > 0) {
            ...
            const sortedEdges = conflictingEdges.sort((a, b) => {
                const aEdgeData = a.data!.edge as InsightsFlowEdge
                const bEdgeData = b.data!.edge as InsightsFlowEdge
...
export function SmartEdge({
    ...
    const { animatingEdgePair, mode } = useValues(insightsFlowEditorLogic)
