...
/**
 * Check whether the authenticated user has access to Insights Desktop and to Loops.
...
/**
 * Insights-internal debug tool. Resolves a Slack permalink to the linked task, its runs, the task-processing and mention-dispatch Temporal workflow ids/URLs, and presigned log URLs.
