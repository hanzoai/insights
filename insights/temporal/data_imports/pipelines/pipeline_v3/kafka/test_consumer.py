...
from insights.temporal.data_imports.pipelines.pipeline_v3.kafka.consumer import KafkaConsumerService
...
class TestKafkaConsumerServiceConfig:
    def test_consumer_uses_latest_offset_reset(self):
        ...
        with patch(
            "insights.temporal.data_imports.pipelines.pipeline_v3.kafka.consumer.ConfluentConsumer"
...
class TestKafkaConsumerServiceCallbacks:
    ...
    def test_on_assign_logs_partition_info(self, _name, partition_data):
        ...
        with patch("insights.temporal.data_imports.pipelines.pipeline_v3.kafka.consumer.logger") as mock_logger:
