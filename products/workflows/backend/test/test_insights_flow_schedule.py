...
class TestInsightsFlowScheduleAPI(APIBaseTest):
    ...
    def test_update_schedule_resets_next_run_at(self):
        ...
        schedule = InsightsFlowSchedule.objects.get(id=schedule_id)
    ...
    def test_delete_schedule(self):
        ...
        assert InsightsFlowSchedule.objects.filter(id=schedule_id).count() == 0
    ...
    def test_schedule_with_variable_overrides(self):
        ...
        schedule = InsightsFlowSchedule.objects.get(id=response.json()["id"])
