...
// Use .map() to generate the full InsightsFunctionTemplate objects
// The common properties are now defined directly within the map.
export const allComingSoonTemplates: InsightsFunctionTemplate[] = destinationDefinitions.map((def) => ({
    ...def,
