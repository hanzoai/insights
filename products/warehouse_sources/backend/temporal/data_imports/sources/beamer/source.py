...
class BeamerSource(ResumableSource[BeamerSourceConfig, BeamerResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Beamer API key to sync your changelog posts, feature requests, comments, votes, reactions, and NPS responses into the Insights Data warehouse.
...
- Some post queries need the API key's **Read posts (ignore filters)** permission.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/beamer",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
