...
from insights.schema import CachedPathsQueryResponse, PathsLink

from insights.constants import FUNNEL_PATH_BETWEEN_STEPS, INSIGHT_FUNNELS
...
class TestDatastorePathsFunnelSource(DatastoreTestMixin, APIBaseTest):
