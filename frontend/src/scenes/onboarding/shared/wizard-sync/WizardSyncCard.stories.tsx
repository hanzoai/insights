    ...
    args: {
        ...
        progress: progress({
            steps: [
                ...
                { id: 'install', label: 'Install Insights', status: 'in_progress', detail: null },
...
export const CompletedLocal: Story = {
    args: {
        ...
        progress: progress({
            ...
            handoffText: '# Insights setup report\n\nInstalled `insights-js` and wired up event capture.',
        }),
