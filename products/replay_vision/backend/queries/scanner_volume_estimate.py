...
def estimate_scanner_session_volume(
    *,
    ...
    ch_user: DatastoreUser = DatastoreUser.APP,
    ...
    cost-preview widget never pays for two sequential InsightsQL queries.
    """
    ...
    response = execute_insightsql_query(
        ...
        settings=InsightsQLGlobalSettings(max_execution_time=max_execution_seconds),
        ch_user=ch_user,
    )
