...
from insights.schema import LLMTrace, TraceQueryResponse
...
class TestFetchTrace:
    def test_returns_llmtrace_when_runner_has_results(self, team):
        ...
        with patch("insights.temporal.ai_observability.trace_summarization.queries.TraceQueryRunner") as mock_runner_cls:
    ...
    def test_runner_handles_heavy_columns(self, team):
        ...
        from insights.schema import LLMTraceEvent
