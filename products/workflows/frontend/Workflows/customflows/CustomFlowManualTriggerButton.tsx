...
import { customFlowManualTriggerButtonLogic } from './CustomFlowManualTriggerButtonLogic'
...
const TriggerPopover = ({
    ...
    const logic = customFlowManualTriggerButtonLogic(props)
...
export const CustomFlowManualTriggerButton = (props: WorkflowLogicProps = {}): JSX.Element => {
    const logic = customFlowManualTriggerButtonLogic(props)
