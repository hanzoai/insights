...
import { ComposerSeed, composerSeedLogic } from 'products/insights_ai/frontend/api/logics'
...
/**
 * Bridges the legacy `initialMaxPrompt` side-panel option into the new Insights AI composer. `openMax` (and any
