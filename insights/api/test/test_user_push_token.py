...
class TestUserPushTokenEndpoints(APIBaseTest):
    ...
    def test_per_user_token_cap_evicts_oldest(self):
        ...
        from insights.api.user_push_token import MAX_TOKENS_PER_USER
...
class TestPushNotifications(APIBaseTest):
    ...
    @patch("insights.push_notifications.requests.post")
    def test_send_push_to_user_calls_expo(self, mock_post):
        ...
        self.assertEqual(payload[0]["title"], "Insights Desktop")
    ...
    @patch("insights.push_notifications.logger.warning")
    @patch("insights.push_notifications.requests.post")
