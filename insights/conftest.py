...
def reset_clickhouse_tables():
    ...
    from insights.models.event.sql import TRUNCATE_EVENTS_RECENT_TABLE_SQL, TRUNCATE_EVENTS_TABLE_SQL
...
def mock_email_mfa_verifier(request, mocker):
    ...
    """
    from insights.helpers.two_factor_session import EmailMFACheckResult

    if "disable_mock_email_mfa_verifier" in request.keywords:
        return

    mocker.patch(
        "insights.helpers.two_factor_session.EmailMFAVerifier.should_send_email_mfa_verification",
