...
SELF_DRIVING_REPORT_FILE = "insights-self-driving-report.md"
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--wizard-log",
            type=str,
            default="/tmp/insights-wizard.log",
    ...
    def handle(self, *args, **options):
        ...
        # 1. Emitted findings/reports + Datastore rows + Temporal workflows. Delegated to
        #    cleanup_signals because it owns the Datastore mutations and workflow termination;
        ...
        # 3. Filesystem artifacts (wizard-side, outside the insights repo).
