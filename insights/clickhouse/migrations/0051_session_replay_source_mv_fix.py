...
from insights.session_recordings.sql.session_replay_event_migrations_sql import DROP_SESSION_REPLAY_EVENTS_TABLE_MV_SQL
from insights.session_recordings.sql.session_replay_event_sql import SESSION_REPLAY_EVENTS_TABLE_MV_SQL
