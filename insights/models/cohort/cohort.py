...
class Cohort(FileSystemSyncMixin, RootTeamMixin, models.Model):
    ...
    def _insert_users_list_with_batching(
        ...
        *,
        ...
        """
        from insights.models.cohort.util import get_static_cohort_size, insert_static_cohort
    ...
    def remove_user_by_uuid(self, user_uuid: str, *, team_id: int) -> bool:
        ...
        """
        from insights.models.cohort.util import get_static_cohort_size, remove_person_from_static_cohort
...
def cohort_people_changed(sender, instance: "CohortPeople", **kwargs):
    from insights.models.cohort.util import get_static_cohort_size
