...
fn parse_request(params: HashMap<String, String>) -> Params {
    ...
    // https://github.com/Insights/insights/blob/master/insights/taxonomy/property_definition_api.py#L463
    // https://github.com/Insights/insights/blob/master/insights/taxonomy/property_definition_api.py#L504-L508
    ...
    // DIVERGES FROM DJANGO API: the new Rust API will accept lists as space-separated query param values
    // https://github.com/Insights/insights/blob/master/insights/taxonomy/property_definition_api.py#L214
...
impl Params {
    // https://github.com/Insights/insights/blob/master/insights/taxonomy/property_definition_api.py#L81-L96
