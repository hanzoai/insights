...
from insights.temporal.data_imports.sources.salesforce import auth
...
def test_salesforce_refresh_access_token_raises_on_client_failure():
    ...
    with (
        unittest.mock.patch(
            "insights.temporal.data_imports.sources.salesforce.auth.requests.post", return_value=response
        ),
