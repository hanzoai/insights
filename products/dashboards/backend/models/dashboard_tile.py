...
from insights.models.utils import UUIDModel, build_unique_relationship_check
...
class DashboardTile(models.Model):
    ...
    # Denormalized from `dashboard.team_id` so this table can be exposed via InsightsQL,
    ...
    class Meta:
        ...
        db_table = "insights_dashboardtile"
