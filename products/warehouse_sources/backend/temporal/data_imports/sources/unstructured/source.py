...
class UnstructuredSource(ResumableSource[UnstructuredSourceConfig, UnstructuredResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Unstructured API key to pull your [Unstructured](https://unstructured.io) document-pipeline metadata into the Insights Data warehouse.
...
Leave **API host** blank unless Unstructured provisioned your account with a custom API URL.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/unstructured",
