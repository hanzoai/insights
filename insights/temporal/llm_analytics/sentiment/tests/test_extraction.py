...
class TestExtractUserMessagesIndividually:
    ...
    def test_limits_to_max_user_messages(self):
        from insights.temporal.llm_analytics.sentiment.constants import MAX_USER_MESSAGES
...
class TestTruncateToTokenLimit:
    ...
    def test_default_max_chars_from_constants(self):
        from insights.temporal.llm_analytics.sentiment.constants import MAX_MESSAGE_CHARS
