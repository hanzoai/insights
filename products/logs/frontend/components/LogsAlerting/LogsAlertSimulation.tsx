...
import { Button, Select, Skeleton, Tag } from '@hanzo/elements'
    ...
    return (
        <div className="space-y-4 p-4">
            <div className="flex gap-2 items-center">
                ...
                />
                <Button type="primary" size="small" onClick={simulateAlert} loading={simulationResultLoading}>
                    Run simulation
                </Button>
            </div>
            ...
            {simulationResultLoading && !simulationResult && (
                <div className="space-y-3">
                    ...
                    <Skeleton className="h-8" repeat={3} />
                </div>
            )}
