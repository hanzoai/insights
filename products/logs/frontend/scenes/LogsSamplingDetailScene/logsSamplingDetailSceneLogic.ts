...
import type { LogsSamplingFormType } from '../../components/LogsSampling/logsSamplingFormLogic'
...
export interface logsSamplingDetailSceneLogicActions {
    resetSamplingForm: (values?: LogsSamplingFormType | undefined) => {
...
export const logsSamplingDetailSceneLogic = kea<logsSamplingDetailSceneLogicType>([
    ...
    listeners(({ actions, values, props }) => ({
        ...
        loadRuleDropImpact24hFailure: () => {
            ...
            toast.error('Could not refresh drop impact')
        },
        deleteRule: async () => {
            try {
