...
export interface sidepanelTicketsLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        isEnabled: (featureFlags: FeatureFlagsSet) => boolean
...
export const sidepanelTicketsLogic = kea<sidepanelTicketsLogicType>([
    ...
    selectors({
        ...
        // the account isn't — free plans can end up with tickets via billing questions or Insights AI
    ...
    listeners(({ actions, values, cache }) => ({
        ...
        sendMessage: async ({ content, onSuccess }) => {
            ...
            try {
                ...
                toast.error('Failed to send message. Please try again.', { button: EMAIL_SUPPORT_BUTTON })
            } finally {
        ...
        restoreFromUrlToken: async ({ token }) => {
            ...
            try {
                ...
                // because insights-js clears the token from the URL during its own
                ...
                // Token may have been consumed by insights-js already — that's OK,
