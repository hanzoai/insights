...
from insights.temporal.data_imports.sources.linkedin_ads.linkedin_ads import (
    LinkedinAdsSchema,
...
@mock.patch("insights.temporal.data_imports.sources.linkedin_ads.linkedin_ads.Integration")
...
@mock.patch("insights.temporal.data_imports.sources.linkedin_ads.linkedin_ads.linkedin_ads_client")
