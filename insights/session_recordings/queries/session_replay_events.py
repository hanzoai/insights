...
from insights.session_recordings.models.metadata import ONGOING_SESSION_WINDOW_MINUTES, RecordingMetadata
...
def _latest_session_event_properties_between(
    ...
    from insights.insightsql_queries.insightsql_query_runner import (
        InsightsQLQueryRunner,  # noqa: PLC0415 — breaks a circular import, matching this file's other InsightsQLQueryRunner imports
    )
