...
from insights.temporal.ai_observability.evaluation_clustering.labeling_agent.graph import (
    _apply_fallbacks,
...
from insights.temporal.ai_observability.evaluation_clustering.labeling_agent.tools import (
    bulk_set_labels,
    finalize_labels,
...
class TestEvalLabelingTools:
    ...
    def test_get_eval_reasoning_returns_full_content(self):
        ...
        assert by_id["e3"]["runtime"] == "script"
...
class TestRunEvalLabelingAgent:
    @patch("insights.temporal.ai_observability.evaluation_clustering.labeling_agent.graph.get_labeling_llm")
    @patch("insights.temporal.ai_observability.evaluation_clustering.labeling_agent.graph.create_react_agent")
