...
export interface insightsFunctionConfigurationLogicActions {
    ...
    loadInsightsFunctionFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadInsightsFunctionSuccess: (insightsFunction: InsightsFunctionType | null, payload?: any) => {
        insightsFunction: InsightsFunctionType | null;
        payload?: any;
    };
    ...
    loadSampleGlobalsFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    ...
    loadSurvey: () => any;
    loadSurveyFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadSurveySuccess: (survey: Survey | null, payload?: any) => {
        survey: Survey | null;
        payload?: any;
    };
    loadTemplate: () => any;
    ...
    loadTemplateSuccess: (template: InsightsFunctionTemplateType | null, payload?: any) => {
        template: InsightsFunctionTemplateType | null;
        payload?: any;
    };
    persistForUnload: () => {
    ...
    sparklineQueryChangedFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    sparklineQueryChangedSuccess: (sparkline: {
        count: any;
        data: {
            color: string;
            name: string;
    ...
    upsertInsightsFunctionFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    upsertInsightsFunctionSuccess: (insightsFunction: InsightsFunctionType, payload?: {
        configuration: InsightsFunctionConfigurationType;
    }) => {
...
export interface insightsFunctionConfigurationLogicMeta {
    ...
    __keaTypeGenInternalSelectorTypes: {
        ...
        hasGroupsAddon: (hasAvailableFeature: (feature: AvailableFeature, currentUsage?: number | undefined) => boolean // userLogic
        ) => boolean;
        useMapping: (insightsFunction: InsightsFunctionType | null, template: InsightsFunctionTemplateType | null) => number | true | undefined;
        defaultFormState: (template: InsightsFunctionTemplateType | null, insightsFunction: InsightsFunctionType | null) => InsightsFunctionConfigurationType | null;
        templateId: (template: InsightsFunctionTemplateType | null, insightsFunction: InsightsFunctionType | null) => string | undefined;
        ...
        willReEnableOnSave: (configuration: InsightsFunctionConfigurationType, insightsFunction: InsightsFunctionType | null) => boolean;
        willChangeEnabledOnSave: (configuration: InsightsFunctionConfigurationType, insightsFunction: InsightsFunctionType | null) => boolean;
        exampleInvocationGlobals: (configuration: InsightsFunctionConfigurationType, currentProject: ProjectType | null, groupTypes: Map<GroupTypeIndex, GroupType>, contextId: InsightsFunctionConfigurationContextId, survey: Survey | null) => CyclotronJobInvocationGlobals;
        sampleGlobalsWithInputs: (sampleGlobals: CyclotronJobInvocationGlobals | null, exampleInvocationGlobals: CyclotronJobInvocationGlobals, configuration: InsightsFunctionConfigurationType) => CyclotronJobInvocationGlobalsWithInputs;
        matchingFilters: (configuration: InsightsFunctionConfigurationType, useMapping: number | true | undefined) => PropertyGroupFilter;
        ...
        sparklineQuery: (configuration: InsightsFunctionConfigurationType, matchingFilters: PropertyGroupFilter, sourceUsesEvents: boolean) => TrendsQuery | null;
        baseEventsQuery: (configuration: InsightsFunctionConfigurationType, matchingFilters: PropertyGroupFilter, groupTypes: Map<GroupTypeIndex, GroupType>, sourceUsesEvents: boolean) => EventsQuery | null;
        ...
        templateHasChanged: (insightsFunction: InsightsFunctionType | null, configuration: InsightsFunctionConfigurationType) => boolean | "" | undefined;
        ...
        canLoadSampleGlobals: (lastEventQuery: EventsQuery | null, contextId: InsightsFunctionConfigurationContextId) => boolean;
        ...
        canEditSource: (type: InsightsFunctionTypeType, template: InsightsFunctionTemplateType | null, insightsFunction: InsightsFunctionType | null) => boolean;
        showTesting: (type: InsightsFunctionTypeType) => boolean;
        isLegacyPlugin: (template: InsightsFunctionTemplateType | null, insightsFunction: InsightsFunctionType | null) => boolean | undefined;
    };
}

export type insightsFunctionConfigurationLogicType = MakeLogicType<insightsFunctionConfigurationLogicValues, insightsFunctionConfigurationLogicActions, InsightsFunctionConfigurationLogicProps, insightsFunctionConfigurationLogicMeta>;
