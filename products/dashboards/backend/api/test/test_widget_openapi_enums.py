...
from insights.openapi.enum_collisions import EnumCollision, find_unresolved_enum_collisions
...
def _format_widget_enum_collisions(collisions: list[EnumCollision]) -> str:
    lines = [
        ...
        "Add suggested entries to ENUM_NAME_OVERRIDES in insights/settings/web.py",
        "",
    ]
