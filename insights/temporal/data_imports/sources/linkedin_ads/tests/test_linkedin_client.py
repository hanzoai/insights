...
from insights.temporal.data_imports.sources.linkedin_ads.client import LinkedinAdsClient, LinkedinAdsPivot
...
class TestLinkedinAdsClient:
    ...
    @mock.patch("insights.temporal.data_imports.sources.linkedin_ads.client.RestliClient")
