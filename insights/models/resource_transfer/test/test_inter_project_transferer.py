...
from insights.models import Dashboard, Insight, Project, Team
from insights.models.dashboard_tile import DashboardTile, Text
...
from insights.models.resource_transfer.types import ResourceKind, ResourceTransferVertex
...
class TestBuildResourceDuplicationGraph(BaseTest):
    ...
    def test_raises_for_unvisitable_model(self) -> None:
        from insights.models import Annotation
...
class TestDuplicateResourceToNewTeam(BaseTest):
    ...
    def test_transaction_rolls_back_on_failure(self) -> None:
        ...
        with patch(
            "insights.models.resource_transfer.resource_transfer.ResourceTransfer.objects.bulk_create",
