...
export const accountRelationshipsLogic = kea<accountRelationshipsLogicType>([
    ...
    listeners(({ actions, props, values }) => ({
        loadRelationshipsFailure: ({ error }) => {
            ...
            insights.captureException(error, { scope: 'accountRelationshipsLogic.loadRelationships' })
        },
        assignRelationship: async ({ definition, user }) => {
            ...
            try {
                ...
                insights.captureException(error as Error, { scope: 'accountRelationshipsLogic.assignRelationship' })
                toast.error(`Failed to assign ${definition.name}`)
            } finally {
        ...
        endRelationship: async ({ relationship }) => {
            ...
            try {
                ...
                insights.captureException(error as Error, { scope: 'accountRelationshipsLogic.endRelationship' })
                toast.error(`Failed to end ${relationship.definition.name}`)
            } finally {
                actions.relationshipSaveFinished()
            }
        },
