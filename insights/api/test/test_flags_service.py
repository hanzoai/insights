...
from insights.api.services.flags_service import (
...
class TestBatchEvaluateFlagForTeam(SimpleTestCase):
    ...
    @patch("insights.api.services.flags_service._FLAGS_SERVICE_SESSION.post")
...
class TestGetFlagsFromServiceRetries(SimpleTestCase):
    @patch("insights.api.services.flags_service.time.sleep")
    @patch("insights.api.services.flags_service._FLAGS_SERVICE_SESSION.post")
