...
export const clusterDetailLogic = kea<clusterDetailLogicType>([
        ...
        filteredItemIds: [
            null as Set<string> | null,
            {
                loadFilteredItemIds: async (_, breakpoint) => {
                    ...
                    // raw InsightsQL `where` clause: `properties.$ai_generation_id` doesn't parse cleanly
                    ...
                    const eventsQuery: EventsQuery = {
                        ...
                        // and `DISTINCT col` is not a valid InsightsQL select expression anyway (it's a
    ...
    listeners(({ actions, values, props }) => ({
        ...
        loadClusterMetricsForCluster: async () => {
            ...
            // directly rather than re-computing via the InsightsQL items query. Matches
