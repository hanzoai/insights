...
from insights.models.user_integration import ReauthorizationRequired, UserIntegration
...
def _deliver_followup(input: SendFollowupToSandboxInput) -> str | None:
    ...
    if result.success:
        ...
        # _insights/turn_complete through the event stream when the turn
...
def _write_turn_complete(run_id: str, stop_reason: str = STOP_REASON_END_TURN, use_dedicated: bool = False) -> None:
    ...
    event = {
        ...
        "notification": {
            ...
            "params": {"source": "insights", "stopReason": stop_reason},
        },
    }
