...
class MCPHarnessBreakdownQueryRunner(AnalyticsQueryRunner[MCPHarnessBreakdownQueryResponse]):
    ...
    def _where(self) -> ast.Expr:
        exprs: list[ast.Expr] = [
            ...
            parse_expr("timestamp <= {date_to}", placeholders={"date_to": self.query_date_range.date_to_as_insightsql()}),
        ]
    ...
    def to_query(self) -> ast.SelectQuery | ast.SelectSetQuery:
        # The harness label and token are InsightsQL fragments from mcp_harness; parse them
