...
class TestWebhookManagement:
    ...
    def test_create_webhook_creates_one_per_store_with_shared_secret(self, mock_session):
        ...
        result = create_webhook("key", "https://us.hanzo.ai/webhooks/abc")
        ...
        for payload in payloads:
            ...
            assert attributes["url"] == "https://us.hanzo.ai/webhooks/abc"
            assert attributes["events"] == ALL_WEBHOOK_EVENTS
            # A single secret across stores — the script function only stores one.
    ...
    def test_delete_webhook_removes_only_matching_urls(self, mock_session):
        ...
        session.get.return_value = _list_response(
            [
                {"type": "webhooks", "id": "10", "attributes": {"url": "https://us.hanzo.ai/webhooks/abc"}},
                {"type": "webhooks", "id": "11", "attributes": {"url": "https://elsewhere.example.com"}},
            ]
        )
        session.delete.return_value = _webhook_api_response(204)

        result = delete_webhook("key", "https://us.hanzo.ai/webhooks/abc")
    ...
    def test_get_external_webhook_info(self, mock_session):
            ...
            [
                {
                    ...
                    "id": "10",
                    "attributes": {
                        "url": "https://us.hanzo.ai/webhooks/abc",
        ...
        info = get_external_webhook_info("key", "https://us.hanzo.ai/webhooks/abc")
    ...
    def test_sync_webhook_events_merges_missing_events(self, mock_session):
        ...
        result = sync_webhook_events("key", "https://us.hanzo.ai/webhooks/abc", ["order_created", "order_refunded"])
            ...
            [
                {
                    "type": "webhooks",
                    "id": "10",
                    "attributes": {"url": "https://us.hanzo.ai/webhooks/abc", "events": ["order_created"]},
                },
            ]
        )

        result = sync_webhook_events("key", "https://us.hanzo.ai/webhooks/abc", ["order_created"])
