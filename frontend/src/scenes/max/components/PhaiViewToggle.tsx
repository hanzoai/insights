...
/**
 * Switches the Max scene between the new insights_ai/frontend surface and the legacy Max chat. Only
...
export function PhaiViewToggle({ variant = 'lemon' }: { variant?: 'lemon' | 'primitive' }): JSX.Element | null {
    ...
    const tooltip = switchingToLegacy ? 'Switch to legacy Insights AI' : 'Switch to new Insights AI'
    ...
    return (
        <Button size="small" type="secondary" sideIcon={<Icon />} onClick={onClick} tooltip={tooltip}>
