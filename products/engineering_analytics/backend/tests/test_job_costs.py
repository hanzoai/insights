...
TEST_BUCKET = "test_storage_bucket-insights.products.engineering_analytics.job_costs"
...
class TestJobCostsViewParity(DatastoreTestMixin, BaseTest):
    ...
    def test_view_matches_python_cost_model(self) -> None:
        ...
        rows = execute_insightsql_query(query=sql, team=self.team, query_type="engineering_analytics.test").results
