...
from insights.api.csp import CSP_REPORT_REJECTED
...
class TestCspReport(BaseTest):
    ...
    def test_oversized_csp_report_is_rejected_before_expansion(
        ...
        with (
            ...
            patch("insights.api.report.capture_batch_internal") as mock_batch_capture,
            patch("insights.api.report.capture_internal") as mock_capture,
            patch("insights.api.report.csp_report_buffer") as mock_buffer,
        ):
    ...
    @patch("insights.api.report.capture_batch_internal")
    ...
    def test_csp_report_never_logs_request_headers(self):
        with capture_logs() as logs, patch("insights.api.report.capture_internal") as mock_capture:
            mock_capture.return_value = MagicMock(raise_for_status=MagicMock())
    ...
    @patch("insights.api.report.capture_internal")
    ...
    def test_safari_single_csp_violation_with_csp_report_content_type(self, mock_capture):
        ...
        safari_report = {
            "type": "csp-violation",
            "url": "https://us.hanzo.ai/signup?next=%2F&__insights.debug=true",
            "body": {
                "documentURL": "https://us.hanzo.ai/signup?next=%2F&__insights.debug=true",
                "disposition": "report",
                "referrer": "",
                "effectiveDirective": "script-src-elem",
                "blockedURL": "inline",
                ...
                "statusCode": 200,
                "sample": "",
                "sourceFile": "https://us.hanzo.ai/signup?next=%2F&__insights.debug=true",
                "lineNumber": 53,
                "columnNumber": 1,
            },
        }
