...
from insights.temporal.health_checks.detectors import DEFAULT_EXECUTION_POLICY
...
class MaterializedViewFailureCheck(HealthCheck):
    ...
    remediation = Remediation(
        ...
        agent="""
            ...
            stored in Insights Data modeling rather than the user's codebase, so the edit happens there —
