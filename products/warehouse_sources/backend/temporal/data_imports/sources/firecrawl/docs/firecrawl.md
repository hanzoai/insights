...
[Firecrawl](https://www.firecrawl.dev) is a web scraping and crawling API. This connector syncs your Firecrawl account's operational data - job activity, credit and token usage, active crawls, and change-detection monitors - into the Insights Data warehouse, so you can track your scraping usage and spend alongside the rest of your data.
