...
from insights.dags.common import chunk_ranges
...
_FF = "products.marketing_analytics.backend.insightsql_queries.marketing_analytics_config.feature_enabled_or_false"
...
class TestConversionWarming(APIBaseTest):
    """Touchpoints + conversions orchestration; ensure_precomputed is patched so no Datastore traffic."""
...
class TestSchedule:
    def test_skips_when_datastore_kill_switch_engaged(self):
        # Production safety: never add warming load to Datastore while a kill switch is engaged.
