...
from insights.insightsql.database.schema.event_sessions import CleanTableNameFromChain, WhereClauseExtractor
...
class TestWhereClauseExtractor(BaseTest):
    def setUp(self):
        ...
        self.context = InsightsQLContext(database=self.database, team_id=self.team.pk)
