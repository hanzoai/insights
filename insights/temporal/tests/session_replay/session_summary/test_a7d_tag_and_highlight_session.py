...
from insights.temporal.session_replay.session_summary.activities.video_based.a7d_tag_and_highlight_session import (
...
ACTIVITY_MODULE = "insights.temporal.session_replay.session_summary.activities.video_based.a7d_tag_and_highlight_session"
