    ...
    return [
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        We call Together AI through the OpenAI client and generate a response. We'll use Insights's OpenAI
                        ...
                        Insights client along with the Together AI config (the base URL and API key) to our OpenAI wrapper.
                    </Markdown>
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        Now, when you call Together AI with the OpenAI SDK, Insights automatically captures an
