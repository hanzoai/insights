...
def test_generate_survey_translation_preserves_manual_translations(mock_generate_structured_output: Mock) -> None:
    ...
    assert mock_generate_structured_output.call_args.kwargs["insights_properties"]["ai_product"] == "surveys"
    assert mock_generate_structured_output.call_args.kwargs["insights_properties"]["ai_feature"] == "survey_translation"
