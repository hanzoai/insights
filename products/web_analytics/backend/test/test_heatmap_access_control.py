...
@pytest.mark.ee
class TestHeatmapAccessControl(DatastoreTestMixin, APIBaseTest):
    def setUp(self):
        super().setUp()
    ...
    def test_creator_list_filters_out_object_blocked_heatmap(self):
        ...
        other_user = User.objects.create_and_join(self.organization, "otheruser@hanzo.ai", "testtest")
...
@pytest.mark.ee
class TestHeatmapAggregateQueryAccessControl(DatastoreTestMixin, APIBaseTest):
    """
    ...
    `HeatmapViewSet`/`LegacyHeatmapViewSet` (Datastore aggregate queries with no object to bind
    ...
    def setUp(self):
        ...
        self.viewer_user = User.objects.create_and_join(self.organization, "viewer2@hanzo.ai", "testtest")
    ...
    def _insert_heatmap_click(self, url: str) -> None:
        ...
        p.produce(
            ...
            data={
                ...
                "distinct_id": "user1",
                "timestamp": format_datastore_timestamp("2023-03-08T09:00:00"),
                "x": 10,
                "y": 20,
                "scale_factor": 16,
                "viewport_width": 100,
    ...
    def test_object_grant_still_allows_aggregate_data_for_the_authorized_url(self):
        ...
        # was granted access to. Row counts depend on the heatmaps Datastore table, which is
