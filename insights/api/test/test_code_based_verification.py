...
from insights.api.authentication import CodeBasedVerificationSerializer
from insights.helpers.email_utils import ESPSuppressionResult
from insights.helpers.two_factor_session import CODE_MAX_ATTEMPTS
...
def enable_code_sending():
    ...
    with (
        ...
        patch("insights.tasks.email.send_code_based_verification") as mock_send,
    ):
        yield mock_send
