...
if TYPE_CHECKING:
    from insights.schema import AccessControlFilterWarning
...
def build_access_control_warning(resources: Iterable["APIScopeObject"]) -> Optional["AccessControlFilterWarning"]:
    ...
    from insights.schema import (
        AccessControlFilterWarning,  # noqa: PLC0415 — keeps insights.schema off django.setup() via this module
    )

    from insights.rbac.user_access_control import resource_to_display_name  # noqa: PLC0415
