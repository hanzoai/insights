...
from insights.schema import ActionsNode, DataWarehouseNode, DateRange, EventsNode, IntervalType
...
from insights.insightsql_queries.utils.timestamp_utils import (
...
class TestTimestampUtils(APIBaseTest, DatastoreDestroyTablesMixin):
    ...
    def test_data_warehouse_all_time_resolves_string_timestamp(self, _name, raw_value, expected):
        ...
        with patch("insights.insightsql_queries.utils.timestamp_utils.execute_insightsql_query") as mock_execute:
    ...
    @patch("insights.insightsql_queries.utils.timestamp_utils._get_earliest_timestamp_from_node")
    ...
    def test_single_path_query_tags(self, _name, caller_product, caller_feature, expected_product, expected_feature):
        ...
        with tags_context(product=caller_product, feature=caller_feature):
            with patch(
                "insights.insightsql_queries.utils.timestamp_utils.execute_insightsql_query",
                side_effect=capture,
            ):
