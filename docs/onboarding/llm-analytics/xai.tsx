    ...
    return [
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        We call xAI through the OpenAI-compatible API and generate a response. We'll use Insights's OpenAI
                        ...
                        Insights client along with the xAI config (the base URL and API key) to our OpenAI wrapper.
                    </Markdown>
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        Now, when you call xAI with the OpenAI SDK, Insights automatically captures an
