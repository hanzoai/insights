...
class PinterestAdsSource(ResumableSource[PinterestAdsSourceConfig, PinterestAdsResumeConfig], OAuthMixin):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Pinterest Ads",
            caption="Collect campaign data, ad performance, and advertising metrics from Pinterest Ads. Ensure you have granted Insights access to your Pinterest Ads account, learn how to do this in [the documentation](https://hanzo.ai/docs/cdp/sources/pinterest-ads).",
            releaseStatus=ReleaseStatus.GA,
            iconPath="/static/services/pinterest_ads.png",
            docsUrl="https://hanzo.ai/docs/cdp/sources/pinterest-ads",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldOauthConfig(
