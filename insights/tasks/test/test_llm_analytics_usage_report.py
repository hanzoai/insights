...
class TestLLMAnalyticsUsageReport(APIBaseTest, DatastoreTestMixin, DatastoreDestroyTablesMixin):
    ...
    @patch("insights.tasks.llm_analytics_usage_report.capture_exception")
    @patch("insights.tasks.llm_analytics_usage_report.get_llm_prompt_fetched_counts", side_effect=Exception("boom"))
