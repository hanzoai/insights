...
impl PersonSettings {
    ...
    /// `persons_per_chunk / (seeds_per_sec / concurrency)` — and the Datastore cursor stays open
...
mod tests {
    ...
    /// half the Datastore execution-time budget must refuse at startup, not at hour four.
    #[test]
    fn person_chunk_sizing_must_fit_the_datastore_scan_budget() {
