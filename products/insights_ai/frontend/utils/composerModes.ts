...
/** The permission modes exposed by the Insights AI composer. */
...
export const MODE_OPTIONS: ComposerModeOption[] = [
    {
        ...
        label: 'Auto',
        description:
            'Accepts file edits and shell commands automatically. Always asks before Insights tools that change live data. Creating or publishing content asks only while you watch the run.',
    },
    {
