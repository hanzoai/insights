...
class GatewayAgentAccessSerializer(serializers.Serializer):
    ...
    handle = serializers.CharField(help_text="Agent identity handle, e.g. insights-support.")
...
class MCPServiceAccountSerializer(serializers.ModelSerializer):
    agent_key = serializers.SerializerMethodField(help_text="Stable Insights agent identifier.")
    ...
    class Meta:
        ...
        extra_kwargs = {
            "handle": {"help_text": "Stable internal identity handle for this Insights agent."},
