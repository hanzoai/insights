...
different from Insights's global ``relative_date_parse`` grammar in one place: here a
...
# Map the friendly unit onto the token that insights.utils.relative_date_parse understands.
...
# The global relative-date grammar (kept in sync with insights.utils.relative_date_parse).
