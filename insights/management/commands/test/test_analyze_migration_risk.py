...
class TestAnalyzeMigrationRisk(TestCase):
    def test_check_missing_migrations_when_none_needed(self):
        ...
        from insights.management.commands.analyze_migration_risk import Command
    ...
    def test_command_outputs_missing_migration_warning(self):
        ...
        try:
            ...
            with patch(
                "insights.management.commands.analyze_migration_risk.Command.get_unapplied_migrations"
            ) as mock_get:
    ...
    def test_command_silent_when_no_migrations_and_no_missing(self):
        ...
        with patch("insights.management.commands.analyze_migration_risk.Command.get_unapplied_migrations") as mock_get:
            mock_get.return_value = []
