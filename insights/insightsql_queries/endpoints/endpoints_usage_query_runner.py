...
from insights.schema import EndpointsUsageOverviewQuery, EndpointsUsageTableQuery, EndpointsUsageTrendsQuery
...
class EndpointsUsageQueryRunner(AnalyticsQueryRunner[EAR], ABC):
    ...
    def _get_base_where_conditions(self) -> list[ast.Expr]:
        ...
        # The 'name' field in InsightsQL maps to lc_request_name in the underlying table.
        # Non-endpoint queries (like regular InsightsQL queries) have empty/null names.
        conditions.append(
            ast.Call(
                name="isNotNull",
    ...
    def _get_materialization_filter(self) -> ast.Expr | None:
        ...
        from insights.schema import MaterializationType
    ...
    def _get_breakdown_expression(
        ...
        """
        from insights.schema import EndpointsUsageBreakdown
