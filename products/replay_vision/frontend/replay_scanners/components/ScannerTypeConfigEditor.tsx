        ...
        <div className="space-y-2">
            <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                {openMax && (
                    ...
                    >
                        Write with Insights AI
                    </Button>
                )}
            </div>
            <Field name="scanner_config.prompt">
        ...
        return (
            <div className="space-y-4">
                ...
                <Field name="scanner_config.length" label="Summary length">
                    <SegmentedButton className="max-w-full overflow-x-auto" options={SUMMARIZER_LENGTH_OPTIONS} />
                </Field>
            </div>
        )
    }
