...
class TicketTailorSource(ResumableSource[TicketTailorSourceConfig, TicketTailorResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Ticket Tailor API key to pull your event ticketing data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/tickettailor",
