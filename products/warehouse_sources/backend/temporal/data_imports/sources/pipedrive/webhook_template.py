    ...
    inputs_schema=[
        {
            ...
            "description": (
                ...
                "every delivery as HTTP basic auth, which is how Insights verifies the delivery."
            ),
        },
        {
            "type": "string",
            ...
            "hidden": False,
            "description": (
                "The HTTP auth password set on the Pipedrive webhook. Insights rejects deliveries "
