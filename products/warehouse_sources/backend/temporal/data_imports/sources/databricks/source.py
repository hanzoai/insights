...
DatabricksErrors = {
    ...
    "is blocked by Databricks IP ACL for workspace": "Insights's IP address is blocked by your Databricks workspace's IP access control list. Add Insights's IP addresses to the workspace's IP ACL, then try again.",
}
...
class DatabricksSource(SQLSource[DatabricksSourceConfig], ValidateDatabaseHostMixin):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Databricks",
            caption="Enter your Databricks SQL warehouse credentials to automatically pull your Databricks data into the Insights Data warehouse. Requires a Unity Catalog catalog.",
            iconPath="/static/services/databricks.png",
            docsUrl="https://hanzo.ai/docs/cdp/sources/databricks",
    ...
    def get_non_retryable_errors(self) -> dict[str, str | None]:
        return {
            **self.default_non_retryable_errors(),
            ...
            "is blocked by Databricks IP ACL for workspace": "Insights's IP address is blocked by your Databricks workspace's IP access control list. Add Insights's IP addresses to the workspace's IP ACL, then resync.",
        }
