...
export interface billingLogicActions {
    ...
    deactivateProductFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    deactivateProductSuccess: (billing: BillingType | null, payload?: string) => {
        billing: BillingType | null;
        payload?: string;
    };
    ...
    loadBilling: () => any;
    loadBillingFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    ...
    loadCreditOverviewFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadCreditOverviewSuccess: (creditOverview: {
        cc_last_four: null;
        collection_method: null;
        credit_brackets: never[];
        eligible: false;
    ...
    loadInvoices: () => any;
    loadInvoicesFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadInvoicesSuccess: (billingError: {
        action: {
            children: string;
            targetBlank: boolean;
            to: any;
    ...
    loadProducts: () => any;
    loadProductsFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadProductsSuccess: (products: BillingProductV2Type[], payload?: any) => {
        products: BillingProductV2Type[];
        payload?: any;
    };
    ...
    setActivateLicenseValue: (key: FieldName, value: any) => {
        name: FieldName;
        value: any;
    };
    setActivateLicenseValues: (values: DeepPartial<{
        license: string;
    }>) => {
        values: DeepPartial<{
            license: string;
    ...
    setCreditFormValue: (key: FieldName, value: any) => {
        name: FieldName;
        value: any;
    };
    setCreditFormValues: (values: DeepPartial<{
        collectionMethod: string;
        creditInput: string;
    }>) => {
        values: DeepPartial<{
    ...
    submitActivateLicenseFailure: (error: Error, errors: Record<string, any>) => {
        error: Error;
        errors: Record<string, any>;
    };
    submitActivateLicenseRequest: (activateLicense: {
        license: string;
    }) => {
        activateLicense: {
            license: string;
    ...
    submitActivateLicenseSuccess: (activateLicense: {
        license: string;
    }) => {
        activateLicense: {
            license: string;
    ...
    submitCreditFormFailure: (error: Error, errors: Record<string, any>) => {
        error: Error;
        errors: Record<string, any>;
    };
    submitCreditFormRequest: (creditForm: {
        collectionMethod: string;
        creditInput: string;
    }) => {
        creditForm: {
    ...
    submitCreditFormSuccess: (creditForm: {
        collectionMethod: string;
        creditInput: string;
    }) => {
        creditForm: {
    ...
    switchFlatrateSubscriptionPlanFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    switchFlatrateSubscriptionPlanSuccess: (billing: BillingType, payload?: SwitchPlanPayload) => {
        billing: BillingType;
    ...
    updateBillingLimitsFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
...
export interface billingLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        ...
        unusedPlatformAddonAmount: (currentPlatformAddon: BillingProductV2AddonType | null, timeRemainingInSeconds: number, timeTotalInSeconds: number) => number;
        ...
        showBillingHero: (billing: BillingType | null, billingPlan: BillingPlan | null, showCreditCTAHero: boolean) => boolean;
...
export type billingLogicType = MakeLogicType<billingLogicValues, billingLogicActions, Record<string, any>, billingLogicMeta>;
            ...
            null as BillingType | null,
            {
                ...
                deactivateProduct: async (key: string, breakpoint) => {
                    ...
                    try {
                        ...
                        toast.success(
                            "You have been unsubscribed. We're sad to see you go. May the mascots be ever in your favor."
                        )
