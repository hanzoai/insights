...
skill untouched.
    ...
    insightscli ci:insights search "<error>"     # match insights to a failure string
    insightscli ci:insights view <id> [--json]   # one insight + its remediation actions
    insightscli ci:insights plan <id>            # print the recommended remediation plan
