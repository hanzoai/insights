...
class TestValidateCredentials:
    def test_valid_credentials(self):
        with mock.patch("insights.temporal.data_imports.sources.github.github.requests.get") as mock_get:
...
class TestGithubSourceSortMode:
    ...
    def _make_source(self, endpoint, should_use_incremental_field, db_incremental_field_last_value=None):
        with mock.patch("insights.temporal.data_imports.sources.github.github.rest_api_resources") as mock_resources:
