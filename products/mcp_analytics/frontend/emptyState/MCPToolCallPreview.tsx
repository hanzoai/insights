...
import insightsCodeLogo from 'public/insights-icon.svg'
...
// Clients shown under the sparkline (the Insights Code link is rendered separately, first).
        ...
        <div className="flex flex-col gap-3">
            <div className="MCPPreview">
                ...
                <div className="MCPPreview__head">
                    ...
                    <Tag size="small">example data</Tag>
                </div>
            ...
            <div className={cn('MCPSpark', isStatic && 'MCPSpark--static')}>
                ...
                <div className="MCPSpark__clients">
                    <Link
                        ...
                        to="https://hanzo.ai/code?utm_medium=in-product&utm_campaign=mcp-analytics-empty-state"
                        target="_blank"
                        title="Insights Code"
                    >
                        <img src={insightsCodeLogo} alt="Insights Code" />
                    </Link>
