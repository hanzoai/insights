...
CLICKHOUSE_HOGQL_RDSPROXY_READ_HOST: str | None = os.getenv("DATASTORE_HOGQL_RDSPROXY_READ_HOST", os.getenv("CLICKHOUSE_HOGQL_RDSPROXY_READ_HOST"))
CLICKHOUSE_HOGQL_RDSPROXY_READ_PORT: str | None = os.getenv("DATASTORE_HOGQL_RDSPROXY_READ_PORT", os.getenv("CLICKHOUSE_HOGQL_RDSPROXY_READ_PORT"))
CLICKHOUSE_HOGQL_RDSPROXY_READ_DATABASE: str | None = os.getenv("DATASTORE_HOGQL_RDSPROXY_READ_DATABASE", os.getenv("CLICKHOUSE_HOGQL_RDSPROXY_READ_DATABASE"))
CLICKHOUSE_HOGQL_RDSPROXY_READ_USER: str | None = os.getenv("DATASTORE_HOGQL_RDSPROXY_READ_USER", os.getenv("CLICKHOUSE_HOGQL_RDSPROXY_READ_USER"))
CLICKHOUSE_HOGQL_RDSPROXY_READ_PASSWORD: str | None = os.getenv("DATASTORE_HOGQL_RDSPROXY_READ_PASSWORD", os.getenv("CLICKHOUSE_HOGQL_RDSPROXY_READ_PASSWORD"))
