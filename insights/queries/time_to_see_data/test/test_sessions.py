...
def test_sessions_condition(query, expected_condition):
    from insights.queries.time_to_see_data.serializers import SessionsQuerySerializer
    from insights.queries.time_to_see_data.sessions import _sessions_condition
