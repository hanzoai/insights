...
describe('OtherRegionHint', () => {
    ...
    test.each([
        ['US with no query lands on eu login', Region.US, '', 'https://eu.hanzo.ai/login'],
        ['EU with no query lands on us login', Region.EU, '', 'https://us.hanzo.ai/login'],
        ['preserves the next query param', Region.US, '?next=/home', 'https://eu.hanzo.ai/login?next=/home'],
