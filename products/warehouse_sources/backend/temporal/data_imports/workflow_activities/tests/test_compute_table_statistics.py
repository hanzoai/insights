...
class TestAggregateAddActionStats:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ({"datastore": "Nullable(Int64)"}, "Int64"),
            ({"datastore": "Int64", "insightsql": "IntegerDatabaseField"}, "Int64"),
            ("String", "String"),
            ({"insightsql": "StringDatabaseField"}, "StringDatabaseField"),
        ],
    )
...
class TestComputeTableStatisticsSync:
    ...
    def _schema_table_job(self, team: Team, *, columns: dict | None = None):
        ...
        table = DataWarehouseTable.objects.create(
            ...
            columns=columns or {"amount": {"datastore": "Nullable(Int64)"}},
        )
