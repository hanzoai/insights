...
class TestLinkModel(BaseTest):
    ...
    def test_unique_constraint_violation(self):
        # Create a link
        Link.objects.create(
            redirect_url="https://example.com", short_link_domain="script.gg", short_code="unique_test", team=self.team
        )
    ...
    def test_unique_constraint_valid_cases(self):
        # Create initial link
        Link.objects.create(
            redirect_url="https://example.com", short_link_domain="script.gg", short_code="different_test", team=self.team
        )
        ...
        Link.objects.create(
            redirect_url="https://example.com", short_link_domain="script.gg", short_code="different_code", team=self.team
        )
