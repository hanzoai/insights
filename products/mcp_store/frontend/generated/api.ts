 ...
 */
export const mcpGatewayConfigSetAllServersEnabledCreate = async (
    projectId: string,
    setAllServersEnabledApi: SetAllServersEnabledApi,
    options?: RequestInit
): Promise<TeamMCPGatewayConfigApi> => {
    return apiMutator<TeamMCPGatewayConfigApi>(getMcpGatewayConfigSetAllServersEnabledCreateUrl(projectId), {
        ...options,
        method: 'POST',
        headers: { 'Content-Type': 'application/json', ...options?.headers },
        body: JSON.stringify(setAllServersEnabledApi),
    })
}
 ...
 */
export const mcpGatewayServersSetTemplateEnabledCreate = async (
    projectId: string,
    setTemplateEnabledApi: SetTemplateEnabledApi,
    options?: RequestInit
): Promise<MCPGatewayServerApi> => {
    return apiMutator<MCPGatewayServerApi>(getMcpGatewayServersSetTemplateEnabledCreateUrl(projectId), {
        ...options,
        method: 'POST',
        headers: { 'Content-Type': 'application/json', ...options?.headers },
        body: JSON.stringify(setTemplateEnabledApi),
    })
}
