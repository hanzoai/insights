...
/**
 * Region-aware hint for users who may be authenticating on the wrong Insights Cloud region (US vs EU).
 *
...
export function OtherRegionHint(): JSX.Element | null {
    ...
    return (
        <Banner type="info">
            Already have a Insights Cloud account? It may live in our {otherRegion} region. You're currently on{' '}
            {preflight.region}.{' '}
            <Link
