...
from insights.api.cohort import get_cohort_actors_for_feature_flag
from insights.api.feature_flag import FeatureFlagSerializer, extract_etag_from_header
from insights.models import Experiment, FeatureFlag, GroupTypeMapping, Tag, TaggedItem, User
from insights.models.cohort import Cohort
from insights.models.dashboard import Dashboard
from insights.models.feature_flag import FeatureFlagDashboards, get_feature_flags_for_team_in_cache
from insights.models.feature_flag.feature_flag import FeatureFlagHashKeyOverride
from insights.models.feature_flag.flag_status import FeatureFlagStatus
...
class TestFeatureFlag(APIBaseTest, ClickhouseTestMixin):
    ...
    @patch("insights.api.feature_flag.LocalEvaluationThrottle.rate", new="7/minute")
    @patch("insights.rate_limit.BurstRateThrottle.rate", new="5/minute")
    ...
    def test_local_evaluation_caching_basic(self):
        ...
        from insights.models.feature_flag.local_evaluation import clear_flag_caches
    ...
    def test_local_evaluation_cache_invalidation_on_feature_flag_delete(self, mock_on_commit):
        ...
        from insights.models.feature_flag.local_evaluation import flags_hypercache, flags_without_cohorts_hypercache
...
class TestFeatureFlagEvaluationTags(APIBaseTest):
    ...
    def test_evaluation_tags_in_minimal_serializer(self):
        from insights.api.feature_flag import MinimalFeatureFlagSerializer
        from insights.models.feature_flag.feature_flag import FeatureFlagEvaluationTag
    ...
    def test_evaluation_tags_cache_invalidation(self):
        ...
        from insights.models.feature_flag import get_feature_flags_for_team_in_cache, set_feature_flags_for_team_in_cache
