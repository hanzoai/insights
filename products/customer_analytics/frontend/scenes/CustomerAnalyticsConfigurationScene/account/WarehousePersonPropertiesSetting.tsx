...
const RUN_TRIGGERS: Record<string, { label: string; type: TagType }> = {
    ...
    const columns: TableColumns<CustomPropertySyncRunApi> = [
        ...
        },
        {
            ...
            render: (_, run) => {
                ...
                return <Tag type={trigger?.type ?? 'default'}>{trigger?.label ?? run.trigger}</Tag>
            },
        },
        {
            title: 'Rows read',
