...
export const droppedBloatPropertyCounter = new Counter({
    ...
    help: 'Count of deprecated insights-js persistence-cache properties stripped from event payloads before Datastore write (see strip-bloat-properties.ts BLOAT_PROPERTIES).',
    labelNames: ['property'],
})
