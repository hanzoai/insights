 ...
 *
 * Insights API - MCP 2 enabled ops
 * OpenAPI spec version: 1.0.0
 */
import * as zod from 'zod'

export const InsightsFunctionTemplatesListParams = /* @__PURE__ */ zod.object({
    project_id: zod
        .string()
        .describe(
...
export const InsightsFunctionTemplatesListQueryParams = /* @__PURE__ */ zod.object({
...
export const InsightsFunctionTemplatesRetrieveParams = /* @__PURE__ */ zod.object({
    project_id: zod
        .string()
        .describe(
            "Project ID of the project you're trying to access. To find the ID of the project, make a call to \/api\/projects\/."
