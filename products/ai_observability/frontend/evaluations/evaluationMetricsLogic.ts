...
import { EVALUATION_PASSED_INSIGHTSQL } from './constants'
                    ...
                    const query: InsightsQLQuery = {
                        ...
                        query: `
                            SELECT
                                ...
                                countIf(${EVALUATION_PASSED_INSIGHTSQL}) as pass_count
                            FROM events
    ...
    selectors({
        ...
        chartQuery: [
            ...
            (
                ...
                const enabledEvaluations = evaluationsForMetrics.filter((e) => e.enabled && !e.deleted)
                ...
                return {
                    ...
                    series: enabledEvaluations.slice(0, 10).map((evaluation) => ({
                        ...
                        math_insightsql: `if(countIf(properties.$ai_evaluation_id = '${evaluation.id}' AND properties.$ai_evaluation_result IS NOT NULL) > 0, countIf(properties.$ai_evaluation_id = '${evaluation.id}' AND ${EVALUATION_PASSED_INSIGHTSQL}) / countIf(properties.$ai_evaluation_id = '${evaluation.id}' AND properties.$ai_evaluation_result IS NOT NULL) * 100, 0)`,
                    })),
                    trendsFilter: {
