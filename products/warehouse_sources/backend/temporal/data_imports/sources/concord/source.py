...
class ConcordSource(ResumableSource[ConcordSourceConfig, ConcordResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Concord API key to pull your contract lifecycle data into the Insights Data warehouse.
...
Leave **Organization ID** blank to use the first organization your API key can access.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/concord",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
