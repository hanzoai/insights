        ...
        const testCases: Array<{ uiHost: string; path: string; expected: string }> = [
            {
                ...
                expected: 'https://us.hanzo.ai/settings/project',
            },
            {
                uiHost: 'https://us.hanzo.ai/',
                path: '/settings/project',
            ...
            },
            {
                ...
                expected: 'https://us.hanzo.ai/settings/project#heatmaps',
            },
            { uiHost: 'https://us.hanzo.ai', path: '?a=1', expected: 'https://us.hanzo.ai/?a=1' },
            { uiHost: 'https://us.hanzo.ai', path: '#hash', expected: 'https://us.hanzo.ai/#hash' },
            { uiHost: 'https://us.hanzo.ai', path: 'https://example.com/x', expected: 'https://example.com/x' },
            { uiHost: 'https://us.hanzo.ai', path: '//example.com/x', expected: '//example.com/x' },
