...
export interface BuildToolResultOptions {
    ...
    /**
     * For inline-exec UI-app hosts (Insights Desktop, Claude Code, Cowork): when a compact
    ...
    /** Insights distinctId for analytics metadata (only read when a UI resource is present). */
