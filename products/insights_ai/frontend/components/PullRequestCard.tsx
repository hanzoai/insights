 ...
 * `GitActionResult`, adapted to UI. Plain props, `React.memo`'d — `prUrl` is required, so the
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-wrap items-center gap-2">
                ...
                <Button type="secondary" size="xsmall" icon={<IconExternal />} to={prUrl} targetBlank>
                    Open on GitHub
                </Button>
            </div>
        </div>
