...
class TestEnsurePersonJoin(BaseTest):
    ...
    def test_creates_join(self, prefix):
        ...
        assert join.source_table_key == "JSONExtractString(metadata, 'insights_person_distinct_id')"
    ...
    def test_tolerates_preexisting_duplicates(self):
        ...
        join_attrs = {
            ...
            "source_table_key": "JSONExtractString(metadata, 'insights_person_distinct_id')",
