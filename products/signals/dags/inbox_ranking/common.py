...
# The explicit +00:00 offset is load-bearing: InsightsQL's toDateTime parses bare datetime strings in
...
def ensure_utc(value: datetime.datetime | None) -> datetime.datetime | None:
    """Datastore drivers return naive UTC datetimes; Parquet timestamp columns want aware ones."""
    if value is None:
        return None
