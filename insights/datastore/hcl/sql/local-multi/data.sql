...
) ENGINE = ReplicatedReplacingMergeTree('/datastore/tables/noshard/insights.adhoc_events_deletion', '{replica}-{shard}', deleted_at, is_deleted) ORDER BY (team_id, uuid) TTL deleted_at + toIntervalMonth(3) SETTINGS index_granularity = 8192;
