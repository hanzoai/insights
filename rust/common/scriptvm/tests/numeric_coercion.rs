...
use scriptvm::{sync_execute, ExecutionContext, Program, VmFailure};
...
fn both_strings_compare_lexicographically() {
    // Residual divergence from Datastore: two strings compare lexicographically (matching Python/TS),
