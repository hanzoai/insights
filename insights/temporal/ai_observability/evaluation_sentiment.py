...
from insights.temporal.ai_observability.sentiment.extraction import extract_sentiment_eval_messages
from insights.temporal.ai_observability.sentiment.schema import PendingClassification, SentimentResult
from insights.temporal.ai_observability.sentiment.utils import build_generation_result
...
async def execute_sentiment_eval_activity(
    ...
    from insights.temporal.ai_observability.sentiment.model import classify  # noqa: PLC0415 -- loads ONNX deps lazily
