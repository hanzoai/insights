...
class WebflowSource(
    ...
    def get_non_retryable_errors(self) -> dict[str, str | None]:
        return {
            ...
            "Webflow collection for schema": "A Webflow CMS collection Insights was syncing no longer exists on your site. It was deleted or renamed in Webflow. Refresh this source's schemas to pick up your current collections, then remove the table for the collection that's gone.",
        }
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Webflow",
            caption="""Enter your Webflow v2 API token and Site ID to pull your Webflow site data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/webflow",
            ...
            webhookSetupCaption=(
                "Insights registers a Webflow webhook for each order event using your API token, "
                "which needs the `sites:write` scope. Webflow returns a secret key for each "
                "registration, and Insights uses those to verify deliveries.\n\n"
                ...
                "Insights can verify deliveries\n\n"
                "Webhooks created from Webflow's site settings are not signed, so Insights cannot "
            ...
            webhookFields=cast(
                ...
                [
                    SourceFieldInputConfig(
                        ...
                        placeholder="",
                        caption=(
                            "The `secretKey` Webflow returned when the webhook was created. Insights "
