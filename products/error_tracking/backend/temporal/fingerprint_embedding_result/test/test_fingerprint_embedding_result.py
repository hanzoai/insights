...
class TestFingerprintEmbeddingResultActivity:
    ...
    def test_query_closest_fingerprints_returns_distances(self) -> None:
        ...
        with patch(
            "products.error_tracking.backend.temporal.fingerprint_embedding_result.activities.execute_insightsql_query",
            return_value=closest_response,
        ) as execute_insightsql_query:
        ...
        assert execute_insightsql_query.call_args.kwargs["team"] == team
        assert execute_insightsql_query.call_args.kwargs["query_type"] == (
            "ErrorTrackingFingerprintEmbeddingResultClosestFingerprints"
        )
        assert execute_insightsql_query.call_args.kwargs["workload"] == Workload.OFFLINE
        assert execute_insightsql_query.call_args.kwargs["ch_user"] == DatastoreUser.ERROR_TRACKING
