...
import { IconBell, IconBuilding, IconClock, IconDownload, IconLeave, IconNotification } from '@hanzo/icons'
            ...
            (
                ...
                if (logicKey === 'command') {
                    items.push({
                        ...
                        category: 'create',
                        productCategory: null,
                        itemType: 'insight/script',
                        searchKeywords: ['sql', 'insightsql', 'query', 'blank sql', 'new tab'],
                        record: { type: 'insight', iconType: 'insight/script' },
                        onSelect: () => {
                            const onSqlEditor =
