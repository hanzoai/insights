...
class StickinessQueryRunner(AnalyticsQueryRunner[StickinessQueryResponse]):
    ...
    def _aggregation_expressions(self, series: EventsNode | ActionsNode | DataWarehouseNode) -> ast.Expr:
        if series.math == "insightsql" and series.math_insightsql is not None:
            return parse_expr(series.math_insightsql)
    ...
    def date_to_start_of_interval_insightsql(self, date: ast.Expr) -> ast.Expr:
        if self.query.intervalCount is None:
            return self.query_date_range.date_to_start_of_interval_insightsql(ast.Field(chain=["e", "timestamp"]))
        ...
        age = parse_expr(
            ...
            placeholders={
                ...
                "from_date": date,
                "to_date": self.query_date_range.date_to_as_insightsql(),
            },
        )
    ...
    def _events_query(self, series_with_extra: SeriesWithExtras) -> ast.SelectQuery:
        ...
        inner_query = parse_select(
            ...
            """,
            {
                ...
                "start_of_interval": self.date_to_start_of_interval_insightsql(ast.Field(chain=["e", "timestamp"])),
    ...
    def to_actors_query(
        ...
        for series in self.series:
            ...
            if series.series.math == "insightsql" and series.series.math_insightsql is not None:
                aggregation_alias = "actor_id"
