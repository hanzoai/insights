...
from insights.schema import AttributionMode

from products.marketing_analytics.backend.insightsql_queries.marketing_analytics_config import (
    MULTI_TOUCH_MODES,
...
class TestMarketingAnalyticsConfig(BaseTest):
    ...
    @patch(
        "products.marketing_analytics.backend.insightsql_queries.marketing_analytics_config.feature_enabled_or_false",
        return_value=True,
    )
