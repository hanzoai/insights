...
from insights.api.dashboards.dashboard import Dashboard
...
from insights.api.services.flags_service import get_flags_from_service
from insights.api.shared import UserBasicSerializer
from insights.api.tagged_item import TaggedItemSerializerMixin, TaggedItemViewSetMixin, tagify
from insights.api.utils import ClassicBehaviorBooleanFieldSerializer, action
from insights.approvals.decorators import approval_gate
from insights.approvals.mixins import ApprovalHandlingMixin
...
from insights.constants import PRODUCT_TOUR_TARGETING_FLAG_PREFIX, SURVEY_TARGETING_FLAG_PREFIX, FlagRequestType
from insights.date_util import thirty_days_ago
...
from insights.helpers.encrypted_flag_payloads import (
    REDACTED_PAYLOAD_VALUE,
    encrypt_flag_payloads,
    get_decrypted_flag_payloads_protected,
)
from insights.models import FeatureFlag, Tag, Team
from insights.models.activity_logging.activity_log import Detail, changes_between, load_activity, log_activity
from insights.models.activity_logging.activity_page import ActivityLogPaginatedResponseSerializer, activity_page_response
from insights.models.activity_logging.model_activity import ImpersonatedContext, is_impersonated_session
from insights.models.cohort import Cohort
from insights.models.cohort.util import get_all_cohort_dependencies
from insights.models.experiment import Experiment
from insights.models.feature_flag import (
    FeatureFlagDashboards,
    FeatureFlagEvaluationTag,
    get_user_blast_radius,
    set_feature_flags_for_team_in_cache,
)
from insights.models.feature_flag.flag_analytics import increment_request_count
from insights.models.feature_flag.flag_status import FeatureFlagStatus, FeatureFlagStatusChecker
from insights.models.feature_flag.flag_validation import check_flag_evaluation_query_is_ok
from insights.models.feature_flag.local_evaluation import (
    DATABASE_FOR_LOCAL_EVALUATION,
    _get_flag_properties_from_filters,
    get_flags_response_if_none_match,
)
from insights.models.feature_flag.types import PropertyFilterType
...
from insights.rate_limit import BurstRateThrottle
...
from insights.settings.feature_flags import LOCAL_EVAL_RATE_LIMITS, REMOTE_CONFIG_RATE_LIMITS
...
class EvaluationTagSerializerMixin(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        if evaluation_tags is not None and evaluation_tags:
            from insights.api.tagged_item import tagify
...
class FeatureFlagSerializer(
    ...
    def get_surveys(self, feature_flag: FeatureFlag) -> dict:
        from insights.api.survey import SurveyAPISerializer
...
class FeatureFlagViewSet(
    ...
    def safely_get_queryset(self, queryset) -> QuerySet:
        ...
        from insights.models.feature_flag import FeatureFlagEvaluationTag
    ...
    def bulk_delete(self, request: request.Request, **kwargs):
        ...
        from insights.models.feature_flag.feature_flag import set_feature_flags_for_team_in_cache
        from insights.rbac.user_access_control import access_level_satisfied_for_resource
        from insights.tasks.feature_flags import update_team_flags_cache, update_team_service_flags_cache
...
def handle_feature_flag_change(
    ...
    **kwargs,
    ...
    if is_scheduled_change:
        from insights.models.activity_logging.activity_log import Trigger
