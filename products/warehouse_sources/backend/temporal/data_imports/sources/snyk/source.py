...
class SnykSource(ResumableSource[SnykSourceConfig, SnykResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Connect your Snyk account to sync organizations, projects, targets, and vulnerability issues into the Insights Data warehouse.
...
Pick the region your Snyk account is hosted on — Snyk's regional stacks are independent and a token only works on its own region.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/snyk",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
