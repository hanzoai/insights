...
export function PropertyGroupModal({ logicKey, onAfterSave }: PropertyGroupModalProps = {}): JSX.Element {
    ...
    const columns: TableColumns<SchemaPropertyGroupProperty> = [
        ...
        {
            title: (
                <Tooltip title="When enabled, this property will be optional in generated SDK types even if required. Use this for properties automatically added to all events (e.g., set globally via insights.register()).">
