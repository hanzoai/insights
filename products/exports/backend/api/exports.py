...
from insights.event_usage import EventSource, get_event_source, groups
...
class ExportedAssetSerializer(UserAccessControlSerializerMixin, serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        timeout = (
            ...
            else timedelta(seconds=INSIGHTSQL_INCREASED_MAX_EXECUTION_TIME)
        )
    ...
    def _create_asset(
        ...
        if insight_id and not dashboard_id:  # logged against the insight's own activity history
            ...
            # Dashboard, session recording, heatmap and SQL/InsightsQL query exports aren't tied to a
