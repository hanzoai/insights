...
export function GroupsIntroduction(): JSX.Element {
    return (
        <PayGateMini
            ...
            className="py-8"
            docsLink="https://hanzo.ai/docs/user-guides/group-analytics"
        >
        ...
        <div className="text-sm bg-primary rounded p-2 max-w-60">
            {needsUpgrade ? (
                ...
                <>
                    ...
                    <Link
                        className="font-medium"
                        to="https://hanzo.ai/docs/product-analytics/group-analytics?utm_medium=in-product&utm_campaign=group-analytics-get-started"
                        target="_blank"
