...
class AhaIdeasSource(ResumableSource[AhaIdeasSourceConfig, AhaIdeasResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Aha! account domain and API key to pull your Aha! Ideas portal data — ideas, votes, comments, submitters, and portals — into the Insights Data warehouse.
...
Create an API key under **Settings → Personal → Developer → API keys** in your Aha! account. The key inherits your account permissions, so it can read every record you can see.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/aha-ideas",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
