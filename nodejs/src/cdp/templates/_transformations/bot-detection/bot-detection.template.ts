...
export const template: InsightsFunctionTemplate = {
    ...
    code: `
// Insights's curated bot UA and IP lists are tuned for browser traffic. Server-side
// SDKs (insights-python, insights-node, ...) send HTTP-client UAs like 'python-httpx'
