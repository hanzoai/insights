<!--
This is the user-facing hanzo.ai documentation for the E2B source. It lives here because no
hanzo.ai checkout was available when the source was implemented. Before release, move it to
`hanzo.ai/contents/docs/cdp/sources/e2b.md` (served at /docs/cdp/sources/e2b) and run
