...
class GeminiConfig:
    ...
    # Models available in the Insights-funded playground. Excludes older/preview
...
class GeminiAdapter:
    ...
    def complete(
        ...
        client: Any
        if analytics.capture and insights_client:
            client = insights_genai.Client(
                api_key=effective_api_key, insights_client=insights_client, http_options=http_options
            )
        else:
