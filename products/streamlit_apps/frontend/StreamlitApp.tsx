    ...
    if (!streamlitApp) {
        return (
            <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <Button type="primary" to={urls.streamlitApps()}>
                    Back to apps
                </Button>
            </div>
        )
            ...
            <div className="flex-1 min-h-0">
                ...
                {appStatus === 'running' && iframeSrc && (
                    <iframe
                        ...
                        // Insights is a different origin, so the proxy's scope check is the real boundary.
                ...
                {appStatus === 'running' && !iframeSrc && connectError && (
                    <div className="flex flex-col items-center justify-center py-20 text-center">
                        ...
                        <Button type="primary" onClick={() => loadConnectInfo()}>
                            Retry
                        </Button>
                    </div>
                )}
                ...
                {appStatus === 'error' && (
                    <div className="flex flex-col items-center justify-center py-20 text-center">
                        ...
                        <div className="flex gap-2">
                            <Button type="primary" onClick={restartApp}>
                                Try again
                            </Button>
                            <Button type="secondary" to={urls.streamlitAppEdit(streamlitApp.short_id)}>
                                View settings
                            </Button>
                        </div>
                    </div>
                ...
                {appStatus === 'stopped' && !streamlitApp.active_version && (
                    <div className="flex flex-col items-center justify-center py-20 text-center">
                        ...
                        <Button type="primary" to={urls.streamlitAppEdit(streamlitApp.short_id)}>
                            Upload
                        </Button>
                    </div>
                )}
                ...
                {appStatus === 'stopped' && streamlitApp.active_version && (
                    <div className="flex flex-col items-center justify-center py-20 text-center">
                        ...
                        <Button type="primary" onClick={startApp}>
                            Start app
                        </Button>
                    </div>
                )}
