"""InsightsQL for the agent LLM token spend attributed to one PR.
...
# One pass over candidates (Datastore re-evaluates a WITH subquery per reference, so a UNION of
