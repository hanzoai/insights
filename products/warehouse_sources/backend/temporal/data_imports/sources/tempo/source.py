...
class TempoSource(ResumableSource[TempoSourceConfig, TempoResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Tempo API token to pull your time-tracking and resource-planning data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/tempo",
