...
from insights.cdp.templates.aws_kinesis.template_aws_kinesis import template as template_aws_kinesis
from insights.cdp.templates.helpers import BaseInsightsFunctionTemplateTest


class TestTemplateAwsKinesis(BaseInsightsFunctionTemplateTest):
    ...
    def test_function_works(self):
        ...
        # The Script template now hands signing off to the Node.js cyclotron fetch executor,
        # which re-signs on every attempt. The aws_sigv4 bag carries input-key references,
        # not credential values — the executor resolves them from InsightsFunction.inputs at
