...
from posthog.insightsql.database.schema.channel_type import DEFAULT_CHANNEL_TYPES, ChannelTypeExprs, create_channel_type_expr
from posthog.insightsql.database.schema.sessions_v1 import DEFAULT_BOUNCE_RATE_DURATION_SECONDS, null_if_empty
from posthog.insightsql.database.schema.util.where_clause_extractor import SessionMinTimestampWhereClauseExtractorV2
...
# NOTE: Keep the AD IDs in sync with `posthog.insightsql_queries.web_analytics.session_attribution_explorer_query_runner.py`
