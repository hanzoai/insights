...
class LifecycleQueryRunner(AnalyticsQueryRunner[LifecycleQueryResponse]):
    ...
    def _calculate(self) -> LifecycleQueryResponse:
        ...
        # e.g. the LifecycleQuery with InsightsQLQuery, while keeping the chart logic the same.
            ...
            events_query = parse_select(
                ...
                placeholders={
                    **self.query_date_range.to_placeholders(),
                    ...
                    "trunc_timestamp": self.query_date_range.date_to_start_of_interval_insightsql(
