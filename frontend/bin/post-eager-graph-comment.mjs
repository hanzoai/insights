...
lines.push('')
lines.push(
    '<sub>Posted automatically by [check-eager-graph](https://github.com/Insights/insights/blob/master/frontend/bin/check-eager-graph.mjs) · sizes are eager output bytes (shipped, post-tree-shake) from the esbuild metafile · part of #32479</sub>'
)
