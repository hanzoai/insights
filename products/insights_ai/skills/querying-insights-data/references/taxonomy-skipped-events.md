...
These are events marked as `system` or `ignored_in_assistant` in Insights's core taxonomy definitions.
...
`$feature_view` | insights-js/react specific, niche
`$feature_interaction` | insights-js/react specific, niche
