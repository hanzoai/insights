...
const VARIANTS: { label: string; step: ActionStepType }[] = [
    ...
    },
    {
        ...
        step: { event: '$autocapture', href: 'https://hanzo.ai/pricing', href_matching: 'contains' },
    },
    {
    ...
    },
    {
        ...
        step: { event: '$pageview', url: 'hanzo.ai/pricing', url_matching: 'contains' },
    },
    {
        label: 'Page view — URL matches regex',
        step: { event: '$pageview', url: 'insights\\.com/blog/.*', url_matching: 'regex' },
    },
    {
