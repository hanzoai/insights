//! Middleware shared by all v1 endpoints. Applied by `v1::router`; individual
//! feature routers (e.g. `v1::analytics`) only declare routes.
...
pub async fn v1_track_response_time(req: Request, next: Next) -> Response {
