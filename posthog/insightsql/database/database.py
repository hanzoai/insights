...
from posthog.insightsql.database.schema.app_metrics2 import AppMetrics2Table
from posthog.insightsql.database.schema.channel_type import create_initial_channel_type, create_initial_domain_type
from posthog.insightsql.database.schema.cohort_membership import CohortMembershipTable
from posthog.insightsql.database.schema.cohort_people import CohortPeople, RawCohortPeople
from posthog.insightsql.database.schema.document_embeddings import (
    INSIGHTSQL_MODEL_TABLES,
    DocumentEmbeddingsTable,
    RawDocumentEmbeddingsTable,
)
from posthog.insightsql.database.schema.error_tracking_issue_fingerprint_overrides import (
...
from posthog.insightsql.database.schema.events import EventsTable
from posthog.insightsql.database.schema.exchange_rate import ExchangeRateTable
from posthog.insightsql.database.schema.experiment_exposures_preaggregated import ExperimentExposuresPreaggregatedTable
from posthog.insightsql.database.schema.groups import GroupsTable, RawGroupsTable
from posthog.insightsql.database.schema.groups_revenue_analytics import GroupsRevenueAnalyticsTable
from posthog.insightsql.database.schema.heatmaps import HeatmapsTable
from posthog.insightsql.database.schema.log_entries import (
    BatchExportLogEntriesTable,
    LogEntriesTable,
    ReplayConsoleLogsLogEntriesTable,
)
from posthog.insightsql.database.schema.logs import LogAttributesTable, LogsKafkaMetricsTable, LogsTable
from posthog.insightsql.database.schema.numbers import NumbersTable
from posthog.insightsql.database.schema.person_distinct_id_overrides import (
    PersonDistinctIdOverridesTable,
    RawPersonDistinctIdOverridesTable,
    join_with_person_distinct_id_overrides_table,
)
from posthog.insightsql.database.schema.person_distinct_ids import PersonDistinctIdsTable, RawPersonDistinctIdsTable
from posthog.insightsql.database.schema.persons import PersonsTable, RawPersonsTable, join_with_persons_table
from posthog.insightsql.database.schema.persons_revenue_analytics import PersonsRevenueAnalyticsTable
from posthog.insightsql.database.schema.pg_embeddings import PgEmbeddingsTable
from posthog.insightsql.database.schema.preaggregation_results import PreaggregationResultsTable
from posthog.insightsql.database.schema.precalculated_events import PrecalculatedEventsTable
from posthog.insightsql.database.schema.precalculated_person_properties import PrecalculatedPersonPropertiesTable
from posthog.insightsql.database.schema.query_log_archive import QueryLogArchiveTable, RawQueryLogArchiveTable
from posthog.insightsql.database.schema.session_replay_events import (
    RawSessionReplayEventsTable,
    SessionReplayEventsTable,
    join_replay_table_to_sessions_table_v2,
    join_replay_table_to_sessions_table_v3,
)
from posthog.insightsql.database.schema.sessions_v1 import RawSessionsTableV1, SessionsTableV1
from posthog.insightsql.database.schema.sessions_v2 import (
    RawSessionsTableV2,
    SessionsTableV2,
    join_events_table_to_sessions_table_v2,
)
from posthog.insightsql.database.schema.sessions_v3 import (
    RawSessionsTableV3,
    SessionsTableV3,
    join_events_table_to_sessions_table_v3,
)
from posthog.insightsql.database.schema.static_cohort_people import StaticCohortPeople
from posthog.insightsql.database.schema.system import SystemTables
from posthog.insightsql.database.schema.web_analytics_preaggregated import (
    WebPreAggregatedBouncesTable,
    WebPreAggregatedStatsTable,
)
from posthog.insightsql.database.utils import get_join_field_chain
from posthog.insightsql.errors import QueryError, ResolutionError
    ...
    def create_for(
        ...
        *,
        ...
        with timings.measure("team"):
            ...
            # Set team_id for the create_insightsql_database tracing span
            ...
            try:
                ...
                for endpoint_saved_query in endpoint_saved_queries:
                    with timings.measure(f"endpoint_saved_query_{endpoint_saved_query.name}"):
                        views.add_child(
                            TableNode(
                                name=endpoint_saved_query.name, table=endpoint_saved_query.insightsql_definition(modifiers)
                            ),
                            table_conflict_mode="ignore",
                        )
        ...
        with timings.measure("data_warehouse_tables"):
            ...
            class WarehousePropertiesVirtualTable(VirtualTable):
                ...
                parent_table: InsightsQLDataWarehouseTable
...
def serialize_fields(
    ...
    from posthog.insightsql.resolver import resolve_types_from_table
