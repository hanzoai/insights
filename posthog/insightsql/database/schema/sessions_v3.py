...
from posthog.insightsql.database.schema.sessions_v1 import DEFAULT_BOUNCE_RATE_DURATION_SECONDS
from posthog.insightsql.database.schema.util.where_clause_extractor import SessionMinTimestampWhereClauseExtractorV3
