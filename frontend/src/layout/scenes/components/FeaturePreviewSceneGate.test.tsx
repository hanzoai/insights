...
const BASE_CONFIG: FeaturePreviewGateConfig = {
    ...
    docsURL: 'https://hanzo.ai/docs/customer-analytics',
}
...
describe('FeaturePreviewSceneGate', () => {
    ...
    describe('gate UI rendering', () => {
        ...
        test('reflects enabled state on the toggle switch', () => {
            ...
            // Switch uses CSS class to indicate checked state, not aria-checked
            const switchWrapper = document.querySelector('.Switch')
            expect(switchWrapper).toHaveClass('Switch--checked')
        })
        ...
        test('reflects disabled state on the toggle switch', () => {
            ...
            const switchWrapper = document.querySelector('.Switch')
            expect(switchWrapper).not.toHaveClass('Switch--checked')
        })
