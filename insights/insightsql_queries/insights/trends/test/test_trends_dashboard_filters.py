...
class TestTrendsDashboardFilters(BaseTest):
    ...
    def test_dashboard_breakdown_filter_updates_data_warehouse_series_when_valid(self):
        self._create_data_warehouse_table(
            {
                "order_id": {"datastore": "String", "insightsql": "StringDatabaseField"},
                "customer_id": {"datastore": "String", "insightsql": "StringDatabaseField"},
                "created_at": {"datastore": "DateTime64(3, 'UTC')", "insightsql": "DateTimeDatabaseField"},
                "status": {"datastore": "String", "insightsql": "StringDatabaseField"},
            }
        )
