...
export type SurveysStatsRetrieveParams = {
    ...
    date_to?: string
    /**
     * When true, also return per-question response counts and answer distributions. Adds one extra InsightsQL query per question, so leave off unless you need the breakdown.
     */
