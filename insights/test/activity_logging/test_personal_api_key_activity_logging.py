...
from insights.models.activity_logging.personal_api_key_utils import calculate_scope_change_logs
...
class TestPersonalAPIKeyActivityLogging(ActivityLogTestHelper):
    ...
    def test_org_level_api_key_broadcasts_to_subscribed_teams(self):
        ...
        with patch("insights.tasks.activity_log.produce_internal_event") as mock_produce:
...
class TestPersonalAPIKeyScopeChanges(ActivityLogTestHelper):
    ...
    def test_global_to_org_scoped(self):
        ...
        with patch.object(Team.objects, "filter", side_effect=self._mock_team_filter(teams)):
            ...
            with patch(
                "insights.models.activity_logging.personal_api_key_utils.UserPermissions",
