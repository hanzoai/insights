...
// Insights's Salesforce instance origin; append a record id to deep-link to that record (account or opportunity).
export const SALESFORCE_ORIGIN = 'https://insights.my.salesforce.com'
...
// event in Insights and breaks reporting without any error. Keep in sync with the
