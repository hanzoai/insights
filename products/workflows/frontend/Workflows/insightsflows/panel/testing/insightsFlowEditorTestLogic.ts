...
import type { insightsFlowEditorTestLogicType } from './insightsFlowEditorTestLogicType'
...
export interface InsightsFlowTestInvocation {
    globals: string
...
export const insightsFlowEditorTestLogic = kea<insightsFlowEditorTestLogicType>([
    ...
    connect((props: WorkflowLogicProps) => ({
        values: [
            ...
            insightsFlowEditorLogic,
            ['selectedNodeId'],
        ],
        actions: [insightsFlowEditorLogic, ['setSelectedNodeId', 'setAnimatingEdgePair']],
    })),
    actions({
