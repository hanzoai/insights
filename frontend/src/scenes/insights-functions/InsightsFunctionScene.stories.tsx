...
const MOCK_FN_FUNCTION_ID = '0196b144-1f82-0000-0d0d-a01de54d674d'
...
const MOCK_BATCH_EXPORT = {
    ...
    destination: {
        type: 'Workflows',
        config: { insights_function_id: MOCK_FN_FUNCTION_ID },
    },
    interval: 'day',
    paused: true,
    created_at: '2024-01-01T00:00:00Z',
...
const MOCK_FN_FUNCTION_TEMPLATING_WARNING_ID = '0196b144-1f82-0000-0d0d-a01de54d6750'
...
const MOCK_FN_FUNCTION_TEMPLATING_WARNING = {
    ...MOCK_FN_FUNCTION,
    id: MOCK_FN_FUNCTION_TEMPLATING_WARNING_ID,
...
const meta: Meta = {
    component: App,
    title: 'Scenes-App/InsightsFunctions/Destination',
    parameters: {
        layout: 'fullscreen',
        viewMode: 'story',
        mockDate: '2024-01-15',
...
export const BackfillsWithData: Story = {
    parameters: {
        pageUrl: urls.insightsFunction(MOCK_FN_FUNCTION_ID, 'backfills'),
    },
    decorators: [
        mswDecorator({
            ...commonMocks,
...
export const RunsWithData: Story = {
    parameters: {
        pageUrl: urls.insightsFunction(MOCK_FN_FUNCTION_ID, 'runs'),
    },
    decorators: [
        mswDecorator({
            ...commonMocks,
...
export const Configuration: Story = {
    parameters: {
        pageUrl: urls.insightsFunction(MOCK_FN_FUNCTION_ID),
    },
}

export const ConfigurationWithTemplatingWarning: Story = {
    parameters: {
        pageUrl: urls.insightsFunction(MOCK_FN_FUNCTION_TEMPLATING_WARNING_ID),
    },
}
