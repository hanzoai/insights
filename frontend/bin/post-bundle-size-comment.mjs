...
lines.push(
    '<sub>Posted automatically by [build-bundle-size-report](https://github.com/Insights/insights/blob/master/frontend/bin/build-bundle-size-report.mjs) · uncompressed bytes from dist-report</sub>'
)
