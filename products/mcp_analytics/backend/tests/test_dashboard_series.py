...
class TestMCPToolCallsAndErrorsQueryRunner(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
    def setUp(self) -> None:
        super().setUp()
...
class TestMCPToolCallBreakdownQueryRunner(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
    def setUp(self) -> None:
        super().setUp()
        self.team.timezone = "US/Pacific"
        self.team.save()
...
class TestMCPDashboardSeriesGate(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
