...
TRIGGERS: dict[str, tuple[str, ...]] = {
    ...
    "build:grammar": ("insights/insightsql/grammar/*",),
    "build:taxonomy-json": ("insights/taxonomy/*",),
...
def build(force: bool, dry_run: bool, list_all: bool) -> None:
    ...
    for cmd in commands:
        ...
        result = subprocess.run([bin_insightscli, cmd], cwd=REPO_ROOT)
