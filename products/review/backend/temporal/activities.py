...
from products.review.backend.models import ReviewReport, ReviewUserSettings
from products.review.backend.reviewer.constants import (
    CHUNKING_MODEL,
...
from products.review.backend.reviewer.lazy_seed import (
    sync_canonical_authoring,
    sync_canonical_blind_spots,
    sync_canonical_perspectives,
    sync_canonical_validation,
)
from products.review.backend.reviewer.models import generate_all_schemas
from products.review.backend.reviewer.models.github_meta import PRFile, PRMetadata
from products.review.backend.reviewer.models.issue_validation import IssueValidation
from products.review.backend.reviewer.models.issues_review import Issue, IssuePriority, IssuesReview
from products.review.backend.reviewer.models.perspective_selection import PerspectiveSelection
from products.review.backend.reviewer.models.split_pr_into_chunks import Chunk, ChunksList
from products.review.backend.reviewer.persistence import (
...
from products.review.backend.reviewer.sandbox.direct_llm import run_oneshot_review
from products.review.backend.reviewer.sandbox.executor import (
    MultiTurnSession,
...
from products.review.backend.reviewer.skill_loader import (
    load_blind_spots_skill_for_run,
    load_perspectives_for_run,
    load_validation_skill_for_run,
)
from products.review.backend.reviewer.status_comment import (
    ensure_status_comment,
    fail_status_comment,
    finalize_status_comment,
    maybe_refresh_status_comment,
)
from products.review.backend.reviewer.tools.github_meta import (
    PRFetcher,
    fetch_branch_compare,
    find_open_pr_for_branch,
)
from products.review.backend.reviewer.tools.issue_cleaner import clean_issues
from products.review.backend.reviewer.tools.issue_combination import combine_issues
from products.review.backend.reviewer.tools.issue_deduplicator import deduplicate_issues
from products.review.backend.reviewer.tools.issue_validation import (
    VALIDATION_SYSTEM_PROMPT,
    build_validation_followup_prompt,
    build_validation_prompt,
)
from products.review.backend.reviewer.tools.issues_review import REVIEW_SYSTEM_PROMPT, build_review_prompt
from products.review.backend.reviewer.tools.prepare_validation_markdown import build_review_body
from products.review.backend.reviewer.tools.publish_review import publish_persisted_review
from products.review.backend.reviewer.tools.select_perspectives import (
...
from products.review.backend.reviewer.tools.split_pr_into_chunks import (
...
from products.review.backend.temporal.types import TRIGGER_LABEL, TRIGGER_MANUAL
...
class ResolveActingUserResult:
    ...
    # chain maps to a Insights org user — the parent then skips the review.
...
def _resolve_acting_user(
    ...
    if resolved_from == "default":
        logger.info("PR author %r has no Insights user; acting as the default user %s", author_login, acting_user_id)
...
async def resolve_acting_user_activity(input: ResolveActingUserInput) -> ResolveActingUserResult:
    ...
    Production: the PR author, mapped GitHub-login → Insights org user (`resolve_org_github_login_to_users`).
