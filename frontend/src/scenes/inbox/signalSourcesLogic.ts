    ...
    listeners(({ actions, values }) => {
        ...
        return {
            loadCiSignalsConfigFailure: ({ error, errorObject }) => {
                ...
                toast.error(errorObject?.detail || error || 'Failed to load CI signals status')
            },
            openSourcesModal: () => {
            ...
            initiateDataWarehouseSourceToggle: async ({ source }) => {
                ...
                try {
                    ...
                    toast.error(error?.detail || error?.message || completion.enableErrorMessage)
                } finally {
            ...
            toggleCiSignals: async ({ viaSetupWizard }, breakpoint) => {
                ...
                if (desiredEnabled && !viaSetupWizard) {
                    ...
                    try {
                        ...
                        actions.toggleCiSignalsComplete()
                        toast.error(error?.detail || error?.message || 'Failed to enable GitHub CI signals')
                        return
                    }
                }
                try {
            ...
            saveSessionAnalysisFilters: async ({ filters }) => {
                try {
                    ...
                    toast.success('Session analysis filters saved')
                    actions.loadSourceConfigs()
            ...
            clearSessionAnalysisFilters: async () => {
                try {
                    ...
                    if (
                        ...
                        toast.success('Session analysis filters cleared')
                    }
                    actions.loadSourceConfigs()
                } catch (error: any) {
