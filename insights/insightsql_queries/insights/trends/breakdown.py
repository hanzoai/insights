...
from insights.insightsql.constants import BREAKDOWN_VALUE_MAX_LENGTH, LimitContext
...
from insights.insightsql_queries.insights.trends.utils import get_properties_chain
...
class Breakdown:
    ...
    def _get_actors_query_where_expr(
        ...
        if is_numeric_breakdown:
            ...
            # InsightsQL toFloat maps to accurateCastOrNull, so non-numeric values
    ...
    def _get_breakdown_col_expr(
        ...
        if histogram_bin_count is not None:
            ...
            # InsightsQL toFloat maps to accurateCastOrNull, so a stray non-numeric
