...
class TestRunEvaluationWorkflow:
    ...
    async def test_fetch_evaluation_activity(self, setup_data):
        ...
        with patch("insights.temporal.llm_analytics.run_evaluation.Evaluation.objects.get") as mock_get:
    ...
    async def test_execute_llm_judge_activity(self, setup_data):
        ...
        with patch("insights.temporal.llm_analytics.run_evaluation.Client") as mock_client_class:
    ...
    async def test_emit_evaluation_event_activity(self, setup_data):
        ...
        with patch("insights.temporal.llm_analytics.run_evaluation.Team.objects.get") as mock_team_get:
            with patch("insights.temporal.llm_analytics.run_evaluation.create_event") as mock_create:
