...
def get_duckgres_shadow_row_count_match_metric(matched: bool) -> MetricCounter:
    return (
        ...
        .create_counter(
            ...
            "Row count comparison between Datastore and duckgres shadow materializations.",
        )
    )
...
def get_datastore_materialization_duration_metric() -> MetricHistogramFloat:
    return workflow.metric_meter().create_histogram_float(
        "datastore_materialization_duration_seconds",
        "Duration of Datastore materialization in seconds.",
        "s",
    )
