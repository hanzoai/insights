...
// but CI installs only @hanzo/storybook's dependency closure. So a bare dep can be
...
// `@hanzo/mcp-ui`, and services/mcp is not in the closure) is installed under
// `@hanzo/quill`, which the app depends on. The old webpack config papered over
...
//
// Source packages aliased to their checkout (e.g. `@hanzo/quill`, `@hanzo/mcp-ui`)
