...
class DatadogSource(ResumableSource[DatadogSourceConfig, DatadogResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Connect your Datadog account to sync logs, events, monitors, dashboards, and more into the Insights Data warehouse.
...
Logs, audit logs, and events read access is governed by your Datadog account's data retention.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/datadog",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldSelectConfig(
