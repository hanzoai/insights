...
// Persistence cache keys that leak from older insights-js versions into event
// payloads. The SDK stopped sending these in insights-js#3392; this server-side
