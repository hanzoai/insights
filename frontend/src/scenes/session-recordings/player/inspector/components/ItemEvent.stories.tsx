...
const renderBasic = (props: Partial<ItemEventProps>): JSX.Element => {
...
export const Default: Story = { render: renderBasic as any, args: {} }

export const PageViewWithPath: Story = {
...
export const SentryErrorEvent: Story = {
    render: renderBasic as any,
    args: {
        item: makeItem(
            {},
...
export const WebVitalsEvent: Story = {
    render: renderBasic as any,
    args: {
        item: makeItem(
            {},
    ...
    args: {
        item: makeItem(
            ...
            { event: '$groupidentify' },
            {
                ...
                $browser: 'Chrome',
                $device_type: 'Desktop',
                $current_url: 'https://us.hanzo.ai/project/2/insights/new',
                $host: 'us.hanzo.ai',
                $pathname: '/project/2/insights/new',
                $initial_person_info: {
                    r: '$direct',
                    u: 'https://us.hanzo.ai/project/2',
                },
                $groups: {
                    ...
                    instance: 'https://us.hanzo.ai',
                },
                $group_type: 'instance',
                $group_key: 'https://us.hanzo.ai',
                $group_set: {
...
export const AISpanEvent: Story = {
    render: renderBasic as any,
    args: {
        item: makeItem(
            {},
...
export const AIGenerationEvent: Story = {
    render: renderBasic as any,
    args: {
        item: makeItem(
            {},
...
export const AITraceEvent: Story = {
    render: renderBasic as any,
    args: {
        item: makeItem(
            {},
