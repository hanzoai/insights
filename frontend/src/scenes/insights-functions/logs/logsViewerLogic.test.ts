...
describe('logsViewerLogic', () => {
    describe('toAbsoluteDatastoreTimestamp', () => {
        ...
        it('falls back to UTC when teamLogic is not mounted', () => {
            ...
            expect(toAbsoluteDatastoreTimestamp(input)).toBe('2024-01-15 10:30:45.123')
        })
        ...
        it('formats in team timezone when teamLogic is mounted', () => {
            ...
            expect(toAbsoluteDatastoreTimestamp(input)).toBe('2024-01-15 05:30:45.123')
        })
