...
from insights.temporal.data_imports.sources.stripe.constants import ACCOUNT_RESOURCE_NAME
from insights.temporal.data_imports.sources.stripe.stripe import (
    StripePermissionError,
    StripeResumeConfig,
    validate_credentials,
)
from insights.temporal.tests.data_imports.conftest import run_external_data_job_workflow
...
def test_validate_credentials():
    ...
    with mock.patch("insights.temporal.data_imports.sources.stripe.stripe.StripeClient", return_value=mock_client):
...
def test_validate_credentials_with_missing_table_name():
    ...
    with (
        mock.patch("insights.temporal.data_imports.sources.stripe.stripe.StripeClient", return_value=mock_client),
