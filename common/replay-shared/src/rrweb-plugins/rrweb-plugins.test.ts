...
describe('CorsPlugin', () => {
    ...
    it.each([
        `@font-face { font-display: fallback; font-family: "Roboto Condensed"; font-weight: 400; font-style: normal; src: url("https://hanzo.ai/assets/fonts/roboto/roboto_condensed_reg-webfont.woff2?11012022") format("woff2"), url("https://hanzo.ai/assets/fonts/roboto/roboto_condensed_reg-webfont.woff?11012022")`,
        `url("https://app.hanzo.ai/fonts/my-font.woff2")`,
    ])('should replace font urls in stylesheets', (content: string) => {
        expect(CorsPlugin._replaceFontCssUrls(content)).toMatchSnapshot()
    })

    it.each(['https://app.hanzo.ai/fonts/my-font.woff2?t=1234', 'https://app.hanzo.ai/fonts/my-font.ttf'])(
    ...
    it.each([
        'https://app.hanzo.ai/my-image.jpeg',
        // ttf substring was matching in a previous version
        'https://app-static.eu.hanzo.ai/static/index-EBVVDttf.css',
    ...
    it('can replace a modulepreload js link', () => {
        ...
        el.href = 'https://app.hanzo.ai/my-image.js'
        CorsPlugin.onBuild?.(el, { id: 1, replayer: null as unknown as any })
        expect(el.href).toEqual(`https://replay.ph-proxy.com/proxy?url=https://app.hanzo.ai/my-image.js`)
    })
})
                                ...
                                childNodes: [
                                    {
                                        ...
                                        childNodes: [
                                            { type: 2, tagName: 'meta' },
                                            {
                                                ...
                                                attributes: {},
                                                childNodes: [
                                                    { id: 123456789, type: 3, textContent: 'Recordings • Insights' },
                                                ],
                                            },
                                        ],
                                    },
                                ...
                                childNodes: [
                                    {
                                        ...
                                        childNodes: [
                                            { type: 2, tagName: 'meta' },
                                            {
                                                ...
                                                tagName: 'title',
                                                attributes: {},
                                                childNodes: [{ type: 3, textContent: 'Recordings • Insights' }],
                                            },
                                        ],
                                    },
                                ],
