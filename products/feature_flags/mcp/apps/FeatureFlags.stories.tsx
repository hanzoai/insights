...
const sampleBooleanFlag: FeatureFlagData = {
    ...
    _insightsUrl: 'https://us.hanzo.ai/project/1/feature_flags/1',
}
...
const sampleMultivariateFlag: FeatureFlagData = {
    ...
    _insightsUrl: 'https://us.hanzo.ai/project/1/feature_flags/2',
}
...
const sampleListData: FeatureFlagListData = {
    ...
    _insightsUrl: 'https://us.hanzo.ai/project/1/feature_flags',
}
