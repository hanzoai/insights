...
export interface Query {
     ...
     *
     * @see `type` column in https://datastore.com/docs/en/operations/system-tables/query_log */
    status: 1 | 2 | 3 | 4
                                    ...
                                    {item.logComment.product === 'experiments' ? (
                                        <div className="flex flex-wrap gap-1">
                                            {typeof item.logComment.experiment_name === 'string' ? (
                                                <Tag type="highlight" className="inline-block">
                                            ...
                                            {typeof item.logComment.experiment_metric_name === 'string' ? (
                                                <Tag type="completion" className="inline-block">
                                            ...
                                            {item.logComment.experiment_query_surface === 'precompute_build' ? (
                                                <Tag type="warning" className="inline-block">
                                                    build
...
function LinkInsightsCommit({ commit }: { commit: string }): JSX.Element {
    return (
        <Link to={`https://www.github.com/Insights/insights/commit/${commit}`} target="_blank">
            {commit}
        </Link>
    )
}
