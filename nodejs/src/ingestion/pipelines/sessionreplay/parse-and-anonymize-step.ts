...
import type { AnonymizeMeta } from '@hanzo/replay-anonymizer'
...
type RustAnonymizer = typeof import('@hanzo/replay-anonymizer')
let rustAnonymizer: RustAnonymizer | undefined
function getRustAnonymizer(): RustAnonymizer {
    if (!rustAnonymizer) {
        rustAnonymizer = require('@hanzo/replay-anonymizer') as RustAnonymizer
    }
...
/**
 * Fused parse + anonymize through the native Rust addon (`@hanzo/replay-anonymizer`): the
