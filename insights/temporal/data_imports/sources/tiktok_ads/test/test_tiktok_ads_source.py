...
from insights.temporal.data_imports.sources.tiktok_ads.source import TikTokAdsSource
...
class TestTikTokAdsSource:
    ...
    @patch("insights.temporal.data_imports.sources.tiktok_ads.source.tiktok_ads_source")
