    ...
    return (
        <>
            <tr
                ...
                className={clsx(
                    rowClassNameDetermined,
                    rowStatusDetermined && `Table__row--status-${rowStatusDetermined}`,
                            ...
                            return (
                                <td
                                    ...
                                    className={clsx(
                                        ...
                                        isSticky && 'Table__cell--sticky',
                                        isColumnSticky && 'Table__cell--pinned',
            ...
            {expandable && !!rowExpandable && isRowExpanded && (
                <tr className={clsx('Table__expansion', expandedRowClassNameDetermined)}>
...
// Without `memo` all rows get rendered when anything in the parent component (Table) changes.
