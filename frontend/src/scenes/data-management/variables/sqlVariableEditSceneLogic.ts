...
export interface sqlVariableEditSceneLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface sqlVariableEditSceneLogicActions {
    loadInsightsUsingVariable: () => any
...
export type sqlVariableEditSceneLogicType = MakeLogicType<
    sqlVariableEditSceneLogicValues,
    sqlVariableEditSceneLogicActions,
    SqlVariableEditSceneLogicProps,
    sqlVariableEditSceneLogicMeta
>
