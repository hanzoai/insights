    ...
    return [
        {
            ...
            content: (
                <>
                    <Markdown>
                        {dedent`
                            If your services already expose a Prometheus \`/metrics\` endpoint, run the Insights
                            metrics agent. It scrapes those endpoints and forwards them to Insights, so your
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        {dedent`
                            If you instrument your application directly, Insights accepts metrics from any
                            OpenTelemetry client over OTLP HTTP. There is no Insights-specific package to install,
