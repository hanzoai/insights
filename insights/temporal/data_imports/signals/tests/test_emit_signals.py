...
from insights.temporal.data_imports.signals.registry import SignalEmitterOutput, SignalSourceTableConfig
...
MODULE_PATH = "insights.temporal.data_imports.workflow_activities.emit_signals"
