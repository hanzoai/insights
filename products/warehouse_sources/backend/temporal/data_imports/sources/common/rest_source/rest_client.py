...
class RESTClientRetryableError(NonReportableError):
    ...
    clear, not a Insights defect. Subclasses NonReportableError, like ``RESTClientNonRetryableError``,
...
class RESTClientNonRetryableError(NonReportableError):
    ...
    error page, plain text) — always a customer/upstream condition, never a Insights defect.
