...
const BROKEN_TESTS: BrokenTestsResultApi = {
    rows: [
        ...
        {
            fingerprint: 'insights/api/test_serializer.py::test_contract | KeyError: N',
            test_id: 'insights/api/test_serializer.py::test_contract',
        ...
        {
            fingerprint: 'insights/temporal/test_async.py::test_race | ConnectionResetError',
            test_id: 'insights/temporal/test_async.py::test_race',
        ...
        {
            fingerprint: 'insights/flags/test_rollout.py::test_flag | Timeout',
            test_id: 'insights/flags/test_rollout.py::test_flag',
