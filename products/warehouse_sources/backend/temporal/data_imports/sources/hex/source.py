...
class HexSource(ResumableSource[HexSourceConfig, HexResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Hex API token to pull your Hex projects, run history, users, groups, and collections into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/hex",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
