database "insights" {
  table "channel_definition" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/sessions/noshard/insights.channel_definition"
  ...
  table "raw_sessions" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/sessions/noshard/insights.raw_sessions"
  ...
  table "raw_sessions_v3" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/sessions/noshard/insights.raw_sessions_v3"
      replica_name = "{shard}-{replica}"
    }
  }
  ...
  table "sessions" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/sessions/noshard/insights.sessions"
      replica_name = "{shard}-{replica}"
    }
  }
