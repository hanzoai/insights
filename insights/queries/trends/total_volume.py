...
from insights.models.event.sql import NULL_SQL
...
from insights.queries.trends.trends_event_query import TrendsEventQuery
...
from insights.queries.util import TIME_IN_SECONDS, get_interval_func_ch, get_start_of_interval_sql
            ...
            return [
                {
                    ...
                    "persons": {
                        "filter": extra_params,
                        "url": f"v1/projects/{team_id}/persons/trends/?{urllib.parse.urlencode(parsed_params)}&cache_invalidation_key={cache_invalidation_key}",
                    },
                }
            ]
