...
class Migration(migrations.Migration):
    dependencies = [
        ("insights", "0737_experiment_deleted"),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(models.F("team_id"), models.F("user_id"), name="insights_pf_team_user"),
                    models.Index(
                        models.F("team_id"), models.F("user_id"), models.F("type"), name="insights_pf_team_user_type"
                    ),
                ],
