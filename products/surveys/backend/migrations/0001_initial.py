...
def update_content_types(apps, schema_editor):
    _move_content_types(apps, schema_editor, "insights", "surveys")


def reverse_content_types(apps, schema_editor):
    _move_content_types(apps, schema_editor, "surveys", "insights")
            ...
            state_operations=[
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        (
                            "response_uuid",
                            models.UUIDField(help_text="UUID of the Datastore event representing the survey response"),
                        ),
                    ...
                    options={
                        ...
                        "indexes": [
                            ...
                            models.Index(
                                ...
                                name="insights_sur_team_id_2c59a2_idx",
                            ),
                        ],
                    },
                ),
