...
Usage:
    ...
    python manage.py clear_wizard_sessions --user 42 --workflow insights-integration
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser: ArgumentParser) -> None:
        ...
        parser.add_argument("--workflow", type=str, help="Filter by workflow_id (e.g. insights-integration).")
        ...
        parser.add_argument(
            ...
            action="store_true",
            help="Required alongside --all when running against Insights Cloud / DEBUG=False.",
        )
        parser.add_argument(
            "--dry-run",
            action="store_true",
    ...
    def handle(self, *args: Any, **opts: Any) -> None:
        ...
        # Prod guard for --all: Insights Cloud and any non-DEBUG instance refuse
