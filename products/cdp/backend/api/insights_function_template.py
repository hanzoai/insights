...
class InsightsFunctionMappingTemplateSerializer(serializers.Serializer):
...
class InsightsFunctionTemplateSerializer(serializers.ModelSerializer):
    mapping_templates = InsightsFunctionMappingTemplateSerializer(
        many=True,
        required=False,
        allow_null=True,
    ...
    class Meta:
        model = InsightsFunctionTemplate
        fields = [
            "id",
            "name",
            "description",
        ...
        extra_kwargs = {
            ...
            "code_language": {"help_text": "Programming language: 'script' or 'javascript'."},
            "inputs_schema": {
...
@extend_schema(tags=["insights_function_templates"], extensions={"x-product": "cdp"})
class PublicInsightsFunctionTemplateViewSet(
    mixins.ListModelMixin,
    mixins.RetrieveModelMixin,
    viewsets.GenericViewSet,
):
    scope_object = "insights_function"
    serializer_class = InsightsFunctionTemplateSerializer
    queryset = InsightsFunctionTemplate.objects.all()
    ...
    def filter_queryset(self, queryset: QuerySet) -> QuerySet:
        if self.action == "list":
            ...
            # Hidden templates (e.g. template-insights-capture, template-insights-update-person-properties,
    ...
    def list(self, request: Request, *args, **kwargs):
        ...
        template_usage = (
            InsightsFunction.objects.filter(deleted=False, enabled=True, template_id__in=template_ids)
            .values("template_id")
