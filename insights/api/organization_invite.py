...
from insights.event_usage import report_bulk_invited, report_team_member_invited
from insights.helpers.email_utils import EmailNormalizer, validate_display_name, validate_message_body
from insights.models import OrganizationDomain, OrganizationInvite, OrganizationMembership
from insights.models.onboarding_delegation import (
...
from insights.rbac.user_access_control import UserAccessControl, ordered_access_levels
...
class OrganizationInviteDelegateSerializer(serializers.Serializer):
    target_email = serializers.EmailField(
        ...
        help_text=(
            ...
            "Insights-branded delegation invite granting admin-level membership on accept."
        ),
    )
...
class OrganizationInviteViewSet(
    ...
    def _delegation_flag_enabled(user: User) -> Optional[bool]:
        ...
        try:
            ...
            # internal hanzo_insights exception. Fail open — delegation should not
    ...
    def delegate(self, request: request.Request, **kwargs) -> response.Response:
        ...
        if flag_enabled is False:
            raise exceptions.PermissionDenied(
                ...
                "Insights support if you need help.",
