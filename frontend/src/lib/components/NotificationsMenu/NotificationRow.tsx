...
import { IconOpenInNew, IconRadioButtonUnchecked } from 'lib/elements/icons'
...
export const REALTIME_NOTIFICATION_TYPE_META: Record<string, { label: string; description: string }> = {
    ...
    subscription_nudge: {
        ...
        description: 'When Insights suggests subscribing to a dashboard you keep coming back to',
    },
}
