...
from products.web_analytics.backend.insightsql_queries.web_analytics_query_runner import (
...
CROSS JOIN {sessions_agg} AS sessions_agg
    ...
    def get_pre_aggregated_response(self):
        ...
        try:
            ...
            pre_agg_modifiers = self.modifiers.model_copy() if self.modifiers else InsightsQLQueryModifiers()
    ...
    def _calculate(self) -> WebOverviewQueryResponse:
        ...
        if (
            ...
            execution_modifiers = self.modifiers.model_copy() if self.modifiers else InsightsQLQueryModifiers()
...
HAVING {inside_start_timestamp_period}
    ...
    def outer_select(self) -> ast.SelectQuery:
        ...
        def metric_pair(
            ...
            # This could also be done using tuples like the stats_table but I will keep the protocol as close as possible: https://github.com/Insights/insights/blob/26588f3689aa505fbf857afcae4e8bd18cf75606/insights/insightsql_queries/web_analytics/stats_table.py#L390-L399
