...
> **Note:** This page refers to our [main product repository](https://github.com/hanzoai/insights), not our website.
...
See the [products README](https://github.com/hanzoai/insights/blob/main/products/README.md) for detailed conventions.
...
Enterprise edition licensed features. This directory has a [separate license](https://github.com/hanzoai/insights/blob/main/ee/LICENSE) - not MIT. For 100% FOSS code, see [Insights/insights-foss](https://github.com/hanzoai/insights-foss).
