...
class RaycastClientMetadataView(View):
    """
    Serves a static CIMD (Client ID Metadata Document) for the Insights Raycast extension.
    ...
    def get(self, request):
        ...
        metadata = {
            "client_id": client_id,
            "client_name": "Raycast extension for Insights",
            "redirect_uris": [
            ...
            "com.insights": {"scopes": RAYCAST_SCOPES},
        }
