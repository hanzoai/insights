import { IconBook, IconCode } from '@hanzo/icons'
...
// surface drives an agent that writes code), followed by Insights's analytics categories. Pass your own
// array to override.
export const DEFAULT_SUGGESTIONS_DATA: readonly SuggestionGroup[] = [
    {
        ...
        tooltip: 'Insights AI can write code in your repository — instrument events, fix bugs, and explore code.',
    },
    {
    ...
    {
        label: 'SQL',
        icon: iconForType('insight/script'),
        suggestions: [
            {
