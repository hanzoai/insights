...
// The disabled-reason copy shows through Button's Tooltip, which has a 400ms open
    ...
    describe('at the trends 3-breakdown cap', () => {
        ...
        it('embeds the docs link inline in the tooltip', async () => {
            ...
            await waitFor(() => {
                ...
                expect(docsLink).toHaveAttribute('href', 'https://hanzo.ai/docs/product-analytics/trends/breakdowns')
            })
        })
                    ...
                    mockResponses: [
                        {
                            ...
                            response: { results: [], insightsql: 'SELECT count() FROM events' } as any,
                        },
                    ],
                },
            })
