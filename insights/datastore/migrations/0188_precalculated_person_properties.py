...
""".format(
        ...
        engine=kafka_engine(
            topic="datastore_precalculated_person_properties", group="datastore_precalculated_person_properties"
        ),
    )
...
operations = [
    ...
    run_sql_with_exceptions(PRECALCULATED_PERSON_PROPERTIES_DISTRIBUTED_TABLE_SQL_V1(), node_roles=[NodeRole.DATA]),
