...
class TestDashboardDuplicationAccessControl(APIBaseTest):
    def setUp(self) -> None:
        ...
        self.member = User.objects.create_and_join(self.organization, "member@hanzo.ai", "testtest")
    ...
    def test_denied_source_dashboard_also_blocks_direct_retrieve(self) -> None:
        # Baseline: the duplication block is a way around this denied retrieve.
