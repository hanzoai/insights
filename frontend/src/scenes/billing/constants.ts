...
export const USAGE_TYPES = [
    ...
    { label: 'Insights AI', value: 'ai_credits_used_in_period' },
    { label: 'Inbox credits', value: 'signals_credits_used_in_period' },
    { label: 'Insights Desktop credits', value: 'insights_code_credits_used_in_period' },
...
export const CODE_PRODUCT_KEY = 'insights_code'
// TODO: Replace hardcoded plan keys with dynamic plan metadata from billing service
export const CODE_PLAN_ALPHA_PRO = 'insights-code-pro-0-20260422'

export const CODE_PRO_PLAN_PREFIX = 'insights-code-pro-'
export const CODE_FREE_PLAN_PREFIX = 'insights-code-free'
