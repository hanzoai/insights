...
from insights.temporal.data_imports.sources.bing_ads.bing_ads import bing_ads_source
from insights.temporal.data_imports.sources.bing_ads.schemas import BingAdsResource
from insights.temporal.data_imports.sources.bing_ads.utils import fetch_data_in_yearly_chunks, parse_csv_to_dicts
...
2024-01-02,456,--,1000,50"""
    ...
    @patch("insights.temporal.data_imports.sources.bing_ads.utils.logger")
...
class TestBingAdsSource:
    ...
    @patch("insights.temporal.data_imports.sources.bing_ads.bing_ads.BingAdsClient")
    @patch("insights.temporal.data_imports.sources.bing_ads.bing_ads.integrations")
    ...
    @patch("insights.temporal.data_imports.sources.bing_ads.bing_ads.fetch_data_in_yearly_chunks")
    @patch("insights.temporal.data_imports.sources.bing_ads.bing_ads.BingAdsClient")
    @patch("insights.temporal.data_imports.sources.bing_ads.bing_ads.integrations")
