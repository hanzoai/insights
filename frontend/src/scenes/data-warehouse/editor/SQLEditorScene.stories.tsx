...
const SQL_RESULTS = {
    ...
    hasMore: false,
    results: [
        ['insights', 'execute-sql', 1480, 3525, 144],
        ['insights', 'read-data-schema', 760, 1298, 3],
        ['insights', 'query-trends', 540, 2122, 5],
        ['insights', 'insight-create', 410, 727, 8],
        ['insights', 'dashboard-create', 260, 940, 2],
        ['insights', 'feature-flag-list', 180, 510, 1],
        ['insights', 'cohort-create', 95, 1620, 6],
...
// Skeleton until availableSourcesLogic resolves. Without this mock the skeletons never settle and
...
export const ManagedWarehouseConnection: Story = {
    parameters: {
        ...
        // instead of the default "Insights (Datastore)".
