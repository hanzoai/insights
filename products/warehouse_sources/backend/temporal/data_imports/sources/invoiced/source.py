...
class InvoicedSource(ResumableSource[InvoicedSourceConfig, InvoicedResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Invoiced API key to pull your accounts receivable and billing data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/invoiced",
