...
from insights.insightsql.parser import parse_string_template

from insights.cdp.templates.helpers import BaseInsightsFunctionTemplateTest
from insights.cdp.templates.meta_ads.template_meta_ads import template as template_meta_ads
...
class TestTemplateMetaAds(BaseInsightsFunctionTemplateTest):
