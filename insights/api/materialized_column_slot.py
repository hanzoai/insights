...
from insights.models import MaterializedColumnSlot, MaterializedColumnSlotState, PropertyDefinition, Team
...
class MaterializedColumnSlotViewSet(TeamAndOrgViewSetMixin, viewsets.ModelViewSet):
    ...
    def slot_usage(self, request, **kwargs):
        ...
        breakdown because dmat is string-only (InsightsQL casts at read time).
        """
    ...
    def assign_slot(self, request, **kwargs):
        ...
        transitions the slot to READY. Until then InsightsQL falls back to JSON extraction
        for this property.
        """
