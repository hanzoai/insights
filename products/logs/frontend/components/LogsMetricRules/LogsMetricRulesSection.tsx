                    ...
                    },
                    {
                        ...
                        render: (_, rule: LogsMetricRuleApi) =>
                            rule.value_attribute ? (
                                <Tag type="highlight">{rule.value_attribute}</Tag>
                            ) : (
                                <Tag>count</Tag>
                            ),
                    },
                    ...
                    },
                    {
                        ...
                        render: (_, rule: LogsMetricRuleApi) => (
                            <More
                                overlay={
                                    <>
                                        <Button fullWidth onClick={() => openEditRuleModal(rule)}>
                                            Edit
                                        </Button>
                                        <Button fullWidth status="danger" onClick={() => deleteRule(rule)}>
                                            Delete
                                        </Button>
                                    </>
                                }
    ...
    return (
        <Form logic={logsMetricRuleFormLogic} props={{ rule }} formKey="metricRuleForm" enableFormOnSubmit>
            <div className="space-y-4">
                ...
                >
                    <Input placeholder="log.api_errors" disabled={isEdit} />
                </Field>
                <Field
                ...
                >
                    <Input placeholder="attributes.duration_ms" disabled={isEdit} />
                </Field>
