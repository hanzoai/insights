...
type TimeToConvertColumn = TableColumn<TimeToConvertCompareRow, keyof TimeToConvertCompareRow | undefined>
...
export function FunnelTimeToConvertTable(): JSX.Element | null {
    ...
    const columns: TableColumns<TimeToConvertCompareRow> = isComparing
        ? [
