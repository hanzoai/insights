...
class TestRenderSignalForResearch:
    def test_renders_attached_images_with_author_prefix(self):
        ...
        assert (
            "- images: [customer] https://media.hanzo.ai/a.png, [team] https://media.hanzo.ai/b.png"
        ) in rendered
    ...
    def test_skips_image_entries_without_url(self):
        signal = _make_signal(
            {
                "images": [
                    {"url": "", "author": "customer"},
                    {"author": "team"},
                    {"url": "https://media.hanzo.ai/ok.png", "author": "customer"},
                ]
            }
        )
        ...
        assert "- images: [customer] https://media.hanzo.ai/ok.png" in rendered
