...
from insights.utils import absolute_uri as util_absolute_uri
...
def absolute_asset_url(path: str) -> str:
    ...
    Example:
      {% absolute_asset_url 'dist/insights.css' %}
      =>  "http://insights.example.com/_static/74d127b78dc7daf2c51f/dist/insights.css"
    """
