...
export const organizationLogic = kea<organizationLogicType>([
        ...
        currentOrganizationId: [
            ...
            (currentOrganization: OrganizationType | null): string => {
                if (!currentOrganization || !currentOrganization.id) {
                    ...
                    insights.captureException(new Error('currentOrganizationId accessed before organization loaded'), {
                        severity: 'warning',
    ...
    listeners(({ actions, values }) => ({
        ...
        updateOrganizationFailure: ({ error, errorObject }: { error: string; errorObject?: unknown }) => {
            ...
            toast.error(`Failed to update organization: ${apiError?.detail || error || 'Unknown error'}`)
        },
        ...
        deleteOrganizationSuccess: ({ redirectPath }) => {
            toast.success('Organization deletion has been initiated', {
