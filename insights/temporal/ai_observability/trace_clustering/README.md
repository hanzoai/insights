...
```text
insights/temporal/ai_observability/trace_clustering/
...
```bash
pytest insights/temporal/ai_observability/trace_clustering/test_workflow.py -v
```
...
- Main clustering issue: [#40787](https://github.com/Insights/insights/issues/40787)
- Trace summarization workflow: `insights/temporal/ai_observability/trace_summarization/`
