...
listed in its parent ModelAdmin, and core admins live in insights/admin/ — so a product
...
(not by importing the parent ModelAdmin) keeps the dependency one-way (product -> insights)
