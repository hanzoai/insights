...
from products.review.backend.reviewer.constants import published_priorities_for
from products.review.backend.reviewer.models.issues_review import IssuePriority, LineRange
...
_REQUEST = "products.review.backend.reviewer.tools.publish_review.github_api_request"
_PAGINATED = "products.review.backend.reviewer.tools.publish_review.github_api_get_paginated"
_REPORT = "products.review.backend.reviewer.tools.publish_review.ReviewReport"
_LOAD_FINDINGS = "products.review.backend.reviewer.tools.publish_review.load_valid_findings"
_POST = "products.review.backend.reviewer.tools.publish_review._post_github_review"
...
class TestPostGithubReview:
    ...
    def test_skips_when_a_review_with_our_marker_is_already_present(
        ...
        _wire_readbacks(
            mock_paginated,
            reviews=[{"body": "an earlier review\n\nmarker-xyz", "user": {"login": "insights[bot]", "type": "Bot"}}],
        )
...
class TestPublishReviewGate:
    def _wire_report(self, mock_report_cls: MagicMock) -> None:
        ...
        mock_report.report_markdown = "# Review Report"
