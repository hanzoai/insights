...
class PartnerStackSource(ResumableSource[PartnerStackSourceConfig, PartnerStackResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your PartnerStack Vendor API keys to pull your partner program data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/partnerstack",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
