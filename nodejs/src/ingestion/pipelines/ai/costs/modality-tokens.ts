 ...
 * snake_cased through insights-python (protobuf to_dict / vars). Both shapes are
 ...
 * properties after extraction so it does not get persisted to Datastore.
 */
export const extractModalityTokens = (event: EventWithProperties): EventWithProperties => {
    ...
    try {
        ...
        // snake_cased through insights-python; check both forms for each key.
        ...
        // @hanzo/ai preserves raw Vercel usage under usage.raw.
