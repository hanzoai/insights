...
describe('prefetchInsightsFunctionsStep', () => {
    ...
    // work to prefetchTransformationStatesForTeams (covered by the script-transformer service tests).
    ...
    it('refreshes transformation states for the batch team IDs', async () => {
        const step = createPrefetchInsightsFunctionsStep(mockHogTransformer, 1)
    ...
    describe('sampling rate', () => {
        ...
        it('prefetches when random value is below sample rate', async () => {
            ...
            const step = createPrefetchInsightsFunctionsStep(mockHogTransformer, 0.3)
        ...
        it('skips prefetching when sample rate is 0', async () => {
            ...
            const step = createPrefetchInsightsFunctionsStep(mockHogTransformer, 0)
