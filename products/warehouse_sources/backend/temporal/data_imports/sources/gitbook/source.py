...
class GitBookSource(ResumableSource[GitBookSourceConfig, GitBookResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your GitBook API token to pull your documentation workspace into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/gitbook",
