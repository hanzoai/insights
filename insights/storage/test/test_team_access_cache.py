...
from insights.storage.team_access_cache import (
...
class TestTeamAccessCacheIntegration(TestCase):
    ...
    @patch("insights.models.team.team.Team.objects.get")
    ...
    @patch("insights.storage.team_access_cache.team_access_tokens_hypercache.get_from_cache")
...
class TestGetTeamsForPersonalAPIKey(TestCase):
    ...
    def test_get_teams_for_scoped_personal_api_key_nonexistent_team_ids(self):
        ...
        from insights.models import Organization, OrganizationMembership, PersonalAPIKey, User
        from insights.models.personal_api_key import hash_key_value
...
class TestWarmUserTeamsCacheTask(TestCase):
    ...
    def test_user_activated_warms_affected_team_caches(self):
        ...
        from insights.tasks.team_access_cache_tasks import warm_user_teams_cache_task
        ...
        with patch("insights.tasks.team_access_cache_tasks.warm_team_token_cache", side_effect=track_warm_cache):
    ...
    def test_user_deleted_removes_all_personal_api_keys_from_caches(self, mock_on_commit):
        ...
        from insights.models.user import User
        from insights.models.utils import generate_random_token_personal, mask_key_value
        from insights.storage.team_access_cache import team_access_tokens_hypercache
        ...
        from insights.storage.team_access_cache import warm_team_token_cache
    ...
    def test_warm_user_teams_cache_task_handles_warm_cache_failures(self):
        ...
        with self.assertLogs("insights.tasks.team_access_cache_tasks", level=logging.WARNING) as log_context:
            with patch(
                "insights.tasks.team_access_cache_tasks.warm_team_token_cache",
    ...
    @patch("django.db.transaction.on_commit", side_effect=lambda func: func())
    @patch("insights.tasks.team_access_cache_tasks.warm_personal_api_key_teams_cache_task.delay")
...
class TestSignalHandlerCacheWarming(TestCase):
    ...
    def test_personal_api_key_signal_handlers_warm_caches(self):
        ...
        from insights.models.user import User
        from insights.models.utils import generate_random_token_personal, mask_key_value
        from insights.tasks.team_access_cache_tasks import warm_personal_api_key_teams_cache_task
        ...
        with patch("insights.tasks.team_access_cache_tasks.warm_team_token_cache", side_effect=track_warm_cache_save):
            # Test Celery task
    ...
    @patch("insights.storage.team_access_cache_signal_handlers.warm_team_token_cache")
    def test_team_signal_handlers_warm_caches(self, mock_warm_cache):
        ...
        from insights.storage.team_access_cache_signal_handlers import update_team_authentication_cache
    ...
    def test_team_deletion_invalidates_cache_and_removes_access(self):
        ...
        from insights.models.user import User
        from insights.models.utils import generate_random_token_personal, mask_key_value
        from insights.storage.team_access_cache_signal_handlers import update_team_authentication_cache_on_delete
    ...
    def test_personal_api_key_with_deleted_team_references(self):
        ...
        from insights.storage.team_access_cache import get_teams_for_single_personal_api_key
...
class TestTeamAPITokenRegeneration(TestCase):
    ...
    def setUp(self):
        ...
        from insights.models.team.team import Team
        from insights.models.user import User
        from insights.models.utils import generate_random_token_personal, generate_random_token_project, mask_key_value
