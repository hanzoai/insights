...
with temporalio.workflow.unsafe.imports_passed_through():
    from insights.temporal.warehouse_sources_queue_partition_management.activities import (
        manage_warehouse_sources_queue_partitions,
    )
    from insights.temporal.warehouse_sources_queue_partition_management.types import PartitionManagementInput


@temporalio.workflow.defn(name="warehouse-sources-queue-partition-management")
class WarehouseSourcesQueuePartitionManagementWorkflow(InsightsWorkflow):
    @staticmethod
