...
3. **No expensive recompute on retry.** Embeddings are cached (PR #3) and
   Datastore fetches are idempotent. A retry costs O(seconds) of cache
...
from insights.temporal.mcp_analytics.intent_clustering.metrics import record_clusters_generated, record_intents_analyzed
