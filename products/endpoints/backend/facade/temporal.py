...
endpoint-backed saved queries: rebuilding the executable InsightsQL before each
materialization run, and updating the materialization-readiness cache on
completion/failure. Heavy imports (InsightsQL) ride along, same as the direct
