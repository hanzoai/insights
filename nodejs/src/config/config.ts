import { STREAM_CONSUMER_GROUP_ID as SESSION_RECORDING_DEFAULT_GROUP_ID } from '../session-recording/constants'
...
import {
    STREAM_APP_METRICS_2,
    STREAM_DATASTORE_HEATMAP_EVENTS,
    STREAM_EVENTS_JSON,
    STREAM_EVENTS_PLUGIN_INGESTION,
    STREAM_EVENTS_PLUGIN_INGESTION_DLQ,
    STREAM_EVENTS_PLUGIN_INGESTION_OVERFLOW,
    STREAM_LOGS_DATASTORE,
    STREAM_LOGS_INGESTION,
    STREAM_LOGS_INGESTION_DLQ,
    STREAM_LOGS_INGESTION_OVERFLOW,
    STREAM_LOG_ENTRIES,
    STREAM_SESSION_RECORDING_SNAPSHOT_ITEM_DLQ,
    STREAM_SESSION_RECORDING_SNAPSHOT_ITEM_EVENTS,
    STREAM_SESSION_RECORDING_SNAPSHOT_ITEM_OVERFLOW,
} from './stream-topics'
...
export function getDefaultConfig(): PluginsServerConfig {
    return {
        ...
        STREAM_BATCH_START_LOGGING_ENABLED: false,
        ...
        STREAM_HOSTS: 'stream:9092', // KEEP IN SYNC WITH insights/settings/data_stores.py
        STREAM_CLIENT_CERT_B64: undefined,
        STREAM_CLIENT_CERT_KEY_B64: undefined,
        STREAM_TRUSTED_CERT_B64: undefined,
        STREAM_SECURITY_PROTOCOL: undefined,
        STREAM_SASL_MECHANISM: undefined,
        STREAM_SASL_USER: undefined,
        STREAM_SASL_PASSWORD: undefined,
        ...
        DATASTORE_JSON_EVENTS_STREAM_TOPIC: STREAM_EVENTS_JSON,
        DATASTORE_HEATMAPS_STREAM_TOPIC: STREAM_DATASTORE_HEATMAP_EVENTS,
        ...
        CDP_CYCLOTRON_JOB_QUEUE_CONSUMER_MODE: 'stream',
        CDP_CYCLOTRON_JOB_QUEUE_PRODUCER_MAPPING: '*:stream',
        ...
        INSIGHTS_FUNCTION_MONITORING_APP_METRICS_TOPIC: STREAM_APP_METRICS_2,
        INSIGHTS_FUNCTION_MONITORING_LOG_ENTRIES_TOPIC: STREAM_LOG_ENTRIES,
        ...
        INGESTION_CONSUMER_CONSUME_TOPIC: STREAM_EVENTS_PLUGIN_INGESTION,
        INGESTION_CONSUMER_OVERFLOW_TOPIC: STREAM_EVENTS_PLUGIN_INGESTION_OVERFLOW,
        INGESTION_CONSUMER_DLQ_TOPIC: STREAM_EVENTS_PLUGIN_INGESTION_DLQ,

        // PropertyDefsConsumer config
        PROPERTY_DEFS_CONSUMER_GROUP_ID: 'property-defs-consumer',
        PROPERTY_DEFS_CONSUMER_CONSUME_TOPIC: STREAM_EVENTS_JSON,
        ...
        SESSION_RECORDING_V2_REPLAY_EVENTS_STREAM_TOPIC: 'datastore_session_replay_events',
        SESSION_RECORDING_V2_CONSOLE_LOG_ENTRIES_STREAM_TOPIC: 'log_entries',
        ...
        INGESTION_SESSION_REPLAY_CONSUMER_CONSUME_TOPIC: STREAM_SESSION_RECORDING_SNAPSHOT_ITEM_EVENTS,
        INGESTION_SESSION_REPLAY_CONSUMER_GROUP_ID: SESSION_RECORDING_DEFAULT_GROUP_ID,
        INGESTION_SESSION_REPLAY_CONSUMER_OVERFLOW_TOPIC: STREAM_SESSION_RECORDING_SNAPSHOT_ITEM_OVERFLOW,
        INGESTION_SESSION_REPLAY_CONSUMER_DLQ_TOPIC: STREAM_SESSION_RECORDING_SNAPSHOT_ITEM_DLQ,
        ...
        LOGS_INGESTION_CONSUMER_CONSUME_TOPIC: STREAM_LOGS_INGESTION,
