...
from insights.test.base import BaseTest, DatastoreTestMixin, _create_event, _create_person, flush_persons_and_events
...
class TestSessionsAggregation(DatastoreTestMixin, BaseTest):
