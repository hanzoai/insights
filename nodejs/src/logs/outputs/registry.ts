 ...
 *
 * - `LOGS_OUTPUT` — main log data path → topic from `LOGS_INGESTION_CONSUMER_DATASTORE_TOPIC`.
 ...
 * - `LOG_ENTRIES_OUTPUT` — script function logs (UI log viewer) → topic from `LOGS_INGESTION_OUTPUT_LOG_ENTRIES_TOPIC`.
 *
...
export function createLogsOutputsRegistry() {
    return new IngestionOutputsBuilder()
        ...
        .register(LOGS_OUTPUT, {
            topicKey: 'LOGS_INGESTION_CONSUMER_DATASTORE_TOPIC',
...
export function createTracesOutputsRegistry() {
    return new IngestionOutputsBuilder()
        ...
        .register(LOGS_OUTPUT, {
            topicKey: 'TRACES_INGESTION_CONSUMER_DATASTORE_TOPIC',
            producerKey: 'LOGS_INGESTION_OUTPUT_LOGS_PRODUCER',
        })
        .register(LOGS_DLQ_OUTPUT, {
