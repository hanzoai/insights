...
from insights.management.commands.rerun_google_ads_failed_invocations import MAX_WINDOW_DAYS

from products.cdp.backend.models.insights_functions.insights_function import InsightsFunction, InsightsFunctionState
...
class RerunGoogleAdsFailedInvocationsForm(forms.Form):
    ...
    dry_run = forms.BooleanField(
        required=False,
        initial=True,
        help_text="Preview which script functions would be targeted, without firing rerun requests.",
    )
