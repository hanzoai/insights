...
class FlexmailSource(ResumableSource[FlexmailSourceConfig, FlexmailResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Flexmail account ID and personal access token to pull your email marketing data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/flexmail",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
