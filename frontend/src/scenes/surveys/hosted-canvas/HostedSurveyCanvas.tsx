...
import { IconPlus, IconThumbsDown, IconThumbsUp, IconTrash } from '@hanzo/icons'
...
// Per-scale lists mirroring insights-js emojiScaleLists; scale 2 (thumbs) renders icons instead.
...
export function HostedSurveyCanvas({
    ...
    const frameClassName =
        viewport === 'mobile'
            ? 'InsightsHostedSurvey HostedSurveyPreviewFrame HostedSurveyPreviewFrame--mobile'
            : 'InsightsHostedSurvey HostedSurveyPreviewFrame'
        ...
        <div className="HostedSurveyCanvasStage">
            ...
            <div className={frameClassName} style={styles}>
                ...
                <div className="survey-stage">
                    <div className="insights-survey-container">
                        {isConfirmation ? (
                ...
                {!appearance.whiteLabel ? <div className="footer-branding">Survey by Insights</div> : null}
            </div>
        </div>
    )
}
...
// hint set rendered by `insights/templates/surveys/public_survey.html` so the
