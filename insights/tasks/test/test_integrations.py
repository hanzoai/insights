...
from insights.tasks.integrations import refresh_integration, refresh_integrations
...
class TestIntegrationsTasks(APIBaseTest):
    ...
    def test_refresh_integrations_schedules_refreshes_for_expired(self) -> None:
        ...
        with patch("insights.tasks.integrations.refresh_integration.delay") as refresh_integration_mock:
    ...
    def test_refresh_integration_skips_resend(self) -> None:
        ...
        with patch("insights.models.integration.OauthIntegration.refresh_access_token") as refresh_mock:
    ...
    def test_refresh_integration_mints_only_when_still_expired(
        ...
        with patch("insights.models.integration.GitHubIntegration.refresh_access_token") as refresh_mock:
            refresh_integration(integration.id)
