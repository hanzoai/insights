...
export const downsamplingPlugin: LegacyTransformationPlugin = {
    ...
    template: {
        ...
        icon_url: 'https://raw.githubusercontent.com/insights/downsampling-plugin/main/logo.png',
        category: ['Custom'],
        ...
        inputs_schema: [
            ...
            },
            {
                ...
                description:
                    "A comma-separated list of Insights events you want to downsample (e.g.: '$identify,mycustomevent'). If empty, all events will be downsampled.",
