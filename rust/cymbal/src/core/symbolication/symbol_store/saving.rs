...
impl SymbolSetRecord {
        ...
        E: sqlx::Executor<'c, Database = sqlx::Postgres>,
    {
        ...
        self.id = sqlx::query_scalar!(
            r#"
            INSERT INTO insights_errortrackingsymbolset (id, team_id, ref, storage_ptr, failure_reason, created_at, content_hash, last_used)
        ...
        E: sqlx::Executor<'c, Database = sqlx::Postgres>,
    {
        ...
        let id = sqlx::query_scalar::<_, Uuid>(
            ...
            WHERE insights_errortrackingsymbolset.storage_ptr IS NULL
            RETURNING id
            "#,
        )
        .bind(self.id)
