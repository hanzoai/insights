...
from insights.product_db_config import ProductDBRoute, load_product_db_routes
from insights.product_db_router import ProductDBRouter, check_product_db_routes, get_product_db_routes
...
class TestProductDBRouter(SimpleTestCase):
    ...
    def test_does_not_route_other_apps(self) -> None:
        model = SimpleNamespace(_meta=SimpleNamespace(app_label="insights", model_name="person"))
