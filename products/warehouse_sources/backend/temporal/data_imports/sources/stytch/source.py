...
class StytchSource(ResumableSource[StytchSourceConfig, StytchResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Stytch project ID and secret to pull your Stytch users and sessions into the Insights Data warehouse.
...
The `organizations` and `members` tables are only available for Stytch B2B projects.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/stytch",
