...
class EvaluationContext(UUIDModel):
    ...
    team = models.ForeignKey("insights.Team", on_delete=models.CASCADE, related_name="evaluation_context_set")
    ...
    class Meta:
        ...
        db_table = "insights_evaluationcontext"
...
class FeatureFlagEvaluationContext(UUIDModel):
    ...
    class Meta:
        ...
        db_table = "insights_featureflagevaluationcontext"
...
class TeamDefaultEvaluationContext(UUIDModel):
    ...
    team = models.ForeignKey("insights.Team", on_delete=models.CASCADE, related_name="default_evaluation_context_set")
    evaluation_context = models.ForeignKey(
    ...
    class Meta:
        ...
        db_table = "insights_teamdefaultevaluationcontext"
