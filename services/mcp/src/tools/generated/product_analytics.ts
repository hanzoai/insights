...
const AssistantDataVisualizationNode = z.object({
    ...
    source: z.record(z.string(), z.unknown()).describe('InsightsQL query object that produces the rows to visualize.'),
...
const elementsStatsRetrieve = (): ToolBase<typeof ElementsStatsRetrieveSchema, Schemas.ElementStatsResponse> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof ElementsStatsRetrieveSchema>) => {
        ...
        const result = await context.api.request<Schemas.ElementStatsResponse>({
            method: 'GET',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/elements/stats/`,
            query: {
...
const insightCreate = (): ToolBase<typeof InsightCreateSchema, WithInsightsUrl<Schemas.Insight>> => ({
    name: 'insight-create',
    ...
    handler: async (context: Context, params: z.infer<typeof InsightCreateSchema>) => {
        ...
        const result = await context.api.request<Schemas.Insight>({
            method: 'POST',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/insights/`,
            body,
        })
        ...
        return await withInsightsUrl(context, filtered, `/insights/${filtered.short_id}`)
    },
})
...
const insightDelete = (): ToolBase<typeof InsightDeleteSchema, Schemas.Insight> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof InsightDeleteSchema>) => {
        ...
        const result = await context.api.request<Schemas.Insight>({
            method: 'PATCH',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/insights/${encodeURIComponent(String(params.id))}/`,
            body: { deleted: true },
        })
        return result
    },
...
const insightGet = (): ToolBase<typeof InsightGetSchema, WithInsightsUrl<Schemas.Insight>> => ({
    name: 'insight-get',
...
const insightUpdate = (): ToolBase<typeof InsightUpdateSchema, WithInsightsUrl<Schemas.Insight>> => ({
    name: 'insight-update',
...
const insightsActivityRetrieve = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.ActivityLogPaginatedResponse>
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof InsightsActivityRetrieveSchema>) => {
        ...
        const result = await context.api.request<Schemas.ActivityLogPaginatedResponse>({
            method: 'GET',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/insights/${encodeURIComponent(String(params.id))}/activity/`,
            query: {
                limit: params.limit,
                page: params.page,
            },
        ...
        return await withInsightsUrl(context, filtered, '/insights')
    },
})
...
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof InsightsAllActivityRetrieveSchema>) => {
        ...
        const result = await context.api.request<Schemas.ActivityLogPaginatedResponse>({
            method: 'GET',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/insights/activity/`,
            query: {
                limit: params.limit,
                page: params.page,
            },
...
const insightsList = (): ToolBase<typeof InsightsListSchema, WithInsightsUrl<Schemas.PaginatedInsightList>> => ({
    name: 'insights-list',
        ...
        return await withInsightsUrl(
            context,
            {
                ...
                results: await Promise.all(
                    (filtered.results ?? []).map((item) => withInsightsUrl(context, item, `/insights/${item.short_id}`))
                ),
            },
            '/insights'
        )
...
const insightsTrendingRetrieve = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedTrendingInsightList>
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof InsightsTrendingRetrieveSchema>) => {
        ...
        const result = await context.api.request<Schemas.PaginatedTrendingInsightList>({
            method: 'GET',
            path: `/v1/projects/${encodeURIComponent(String(projectId))}/insights/trending/`,
            query: {
                days: params.days,
                include_dashboards: params.include_dashboards,
                limit: params.limit,
