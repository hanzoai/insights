 ...
 *
 * Mirrors the operator semantics in `insights/insightsql/property.py` (`_expr_to_compare_op`)
...
// Mirrors `is_truthy_or_falsy_property_value` in insights/queries/base.py.
