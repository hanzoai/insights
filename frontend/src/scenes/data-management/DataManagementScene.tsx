import { MakeLogicType, actions, connect, kea, path, reducers, selectors, useValues } from 'kea'
...
export interface dataManagementSceneLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface dataManagementSceneLogicActions {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface dataManagementSceneLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        breadcrumbs: (tab: DataManagementTab) => Breadcrumb[]
        enabledTabs: (featureFlags: FeatureFlagsSet) => DataManagementTab[]
        sidePanelContext: (tab: DataManagementTab) => SidePanelSceneContext | null
    }
}

export type dataManagementSceneLogicType = MakeLogicType<
    dataManagementSceneLogicValues,
    dataManagementSceneLogicActions,
    Record<string, any>,
    dataManagementSceneLogicMeta
>
...
const dataManagementSceneLogic = kea<dataManagementSceneLogicType>([
    ...
    selectors({
        breadcrumbs: [
            (s) => [s.tab],
            (tab: DataManagementTab): Breadcrumb[] => {
