...
class MentionSource(ResumableSource[MentionSourceConfig, MentionResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Mention API access token to pull your monitored accounts, alerts, mentions, and tags into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/mention",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
