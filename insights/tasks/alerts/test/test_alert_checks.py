...
from insights.models.alert import AlertCheck, AlertSubscription
...
from insights.tasks.alerts.utils import send_notifications_for_breaches
...
class TestAlertChecks(APIBaseTest, DatastoreDestroyTablesMixin):
    ...
    def test_send_error_while_calculating(
        ...
        with patch(
            "insights.tasks.alerts.trends.calculate_for_query_based_insight"
    ...
    @patch("insights.tasks.alerts.utils.EmailMessage")
