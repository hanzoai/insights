"""Datastore statements for the session surfacing scoring pipeline.
...
CTE evaluation note: Datastore inlines `WITH ... AS` as a subquery, so
...
# `insights/session_recordings/sql/session_replay_event_sql.py` and
# `insights/session_recordings/sql/session_replay_feature_sql.py`.
