...
class InsightsQLTimings:
    timings: dict[str, float]
    _timing_starts: dict[str, float]
    _timing_pointer: str

    def __init__(self, _timing_pointer: str = "."):
        # Completed time in seconds for different parts of the InsightsQL query
        self.timings = {}
    ...
    def clone_for_subquery(self, series_index: int):
        return InsightsQLTimings(f"{self._timing_pointer}/series_{series_index}")
    ...
    def to_list(self, back_out_stack=True) -> list["QueryTiming"]:
        ...
        # insightsql.context.
        from insights.schema import QueryTiming  # noqa: PLC0415
