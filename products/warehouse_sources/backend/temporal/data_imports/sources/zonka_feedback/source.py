...
class ZonkaFeedbackSource(ResumableSource[ZonkaFeedbackSourceConfig, ZonkaFeedbackResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Zonka Feedback auth token to pull your survey and feedback data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/zonka-feedback",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
