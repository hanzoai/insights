database "insights" {
  table "adhoc_events_deletion" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path          = "/datastore/tables/noshard/insights.adhoc_events_deletion"
  ...
  table "channel_definition" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.channel_definition"
      replica_name = "{replica}-{shard}"
    }
  }
  ...
  table "cohort_membership" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.cohort_membership"
      replica_name   = "{replica}-{shard}"
  ...
  table "cohortpeople" {
    ...
    engine "replicated_collapsing_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.cohortpeople"
      replica_name = "{replica}-{shard}"
      sign_column  = "sign"
    }
  }
  ...
  table "distributed_events_recent" {
    ...
    engine "distributed" {
      cluster_name    = "insights_primary_replica"
      remote_database = "insights"
  ...
  table "distributed_insights_document_embeddings" {
    column "team_id" {
      type = "Int64"
    }
    column "product" {
    ...
    engine "distributed" {
      cluster_name    = "insights"
      remote_database = "insights"
      remote_table    = "partitioned_sharded_insights_document_embeddings"
      sharding_key    = "cityHash64(document_id)"
    }
  }

  table "distributed_insights_document_embeddings_text_embedding_3_large_3072" {
    column "team_id" {
      type = "Int64"
    }
    column "product" {
    ...
    engine "distributed" {
      cluster_name    = "insights"
      remote_database = "insights"
      remote_table    = "sharded_insights_document_embeddings_text_embedding_3_large_3072"
      sharding_key    = "cityHash64(document_id)"
    }
  }

  table "distributed_insights_document_embeddings_text_embedding_3_small_1536" {
    column "team_id" {
      type = "Int64"
    }
    column "product" {
    ...
    engine "distributed" {
      cluster_name    = "insights"
      remote_database = "insights"
      remote_table    = "sharded_insights_document_embeddings_text_embedding_3_small_1536"
      sharding_key    = "cityHash64(document_id)"
    }
  }
  ...
  table "duplicate_events" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.duplicate_events"
      replica_name = "{replica}-{shard}"
    }
  }
  ...
  table "error_tracking_issue_fingerprint_overrides" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.error_tracking_issue_fingerprint_overrides"
      replica_name   = "{replica}-{shard}"
  ...
  table "events_dead_letter_queue" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.events_dead_letter_queue"
      replica_name   = "{replica}-{shard}"
  ...
  table "exchange_rate" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.exchange_rate"
      replica_name   = "{replica}-{shard}"
      version_column = "version"
    }
  }
  ...
  table "groups" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.groups"
      replica_name   = "{replica}-{shard}"
      version_column = "_timestamp"
    }
  }
  ...
  table "kafka_events_json" {
    ...
    engine "kafka" {
      ...
      topic_list           = "kafka_topic_list = 'datastore_events_json'"
  ...
  table "kafka_performance_events" {
    ...
    engine "kafka" {
      broker_list = "msk_cluster"
      topic_list  = "kafka_topic_list = 'datastore_performance_events'"
      group_name  = "kafka_group_name = 'group1'"
      format      = "kafka_format = 'JSONEachRow'"
    }
  }
  ...
  table "kafka_person_distinct_id" {
    ...
    engine "kafka" {
      broker_list = "msk_cluster"
      topic_list  = "kafka_topic_list = 'datastore_person_unique_id'"
      group_name  = "kafka_group_name = 'group1'"
      format      = "kafka_format = 'JSONEachRow'"
    }
  }
  ...
  table "kafka_person_overrides" {
    ...
    engine "kafka" {
      ...
      topic_list  = "datastore_person_override"
      group_name  = "datastore-person-overrides"
      format      = "JSONEachRow"
    }
  }
  ...
  table "llma_metrics_daily" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.llma_metrics_daily"
      replica_name = "{replica}-{shard}"
    }
  }
  ...
  table "partitioned_sharded_insights_document_embeddings" {
    ...
    index "kafka_timestamp_minmax_partitioned_sharded_insights_document_embeddings" {
      expr        = "_timestamp"
      type        = "minmax"
      granularity = 3
    }
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.partitioned_sharded_insights_document_embeddings"
  ...
  table "person" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.person"
      replica_name   = "{replica}-{shard}"
      version_column = "version"
    }
  }
  ...
  table "person_distinct_id" {
    ...
    engine "replicated_collapsing_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.person_distinct_id"
      replica_name = "{replica}-{shard}"
      sign_column  = "_sign"
    }
  }
  ...
  table "person_distinct_id2" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.person_distinct_id2"
      replica_name   = "{replica}-{shard}"
      version_column = "version"
    }
  }
  ...
  table "person_distinct_id_overrides" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.person_distinct_id_overrides"
      replica_name   = "{replica}-{shard}"
      version_column = "version"
    }
  }
  ...
  table "person_overrides" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.person_overrides"
      replica_name   = "{replica}-{shard}"
      version_column = "version"
    }
  }
  ...
  table "person_static_cohort" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.person_static_cohort"
      replica_name   = "{replica}-{shard}"
      version_column = "_timestamp"
    }
  }
  ...
  table "pg_embeddings" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path          = "/datastore/tables/noshard/insights.pg_embeddings"
      replica_name      = "{replica}-{shard}"
  ...
  table "plugin_log_entries" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.plugin_log_entries"
      replica_name   = "{replica}-{shard}"
      version_column = "_timestamp"
    }
  }
  ...
  table "property_definitions" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.property_definitions"
      replica_name   = "{replica}-{shard}"
      version_column = "version"
    }
  }
  ...
  table "query_log_archive_v2" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.query_log_archive_new"
      replica_name = "{replica}-{shard}"
    }
  }
  ...
  table "sharded_app_metrics" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.sharded_app_metrics"
      replica_name = "{replica}"
    }
  }
  ...
  table "sharded_app_metrics2" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.sharded_app_metrics2"
      replica_name = "{replica}"
    }
  }
  ...
  table "sharded_distinct_id_usage" {
    ...
    engine "replicated_summing_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.distinct_id_usage"
      replica_name = "{replica}"
  ...
  table "sharded_events" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.events"
      replica_name   = "{replica}"
      version_column = "_timestamp"
    }
  }
  ...
  table "sharded_events_json" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.events_json"
      replica_name   = "{replica}"
      version_column = "_timestamp"
    }
  }
  ...
  table "sharded_events_recent" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.sharded_events_recent"
      replica_name   = "{replica}"
      version_column = "_timestamp"
    }
  }
  ...
  table "sharded_experiment_exposures_preaggregated" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.experiment_exposures_preaggregated"
      replica_name   = "{replica}"
  ...
  table "sharded_flag_evaluations" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.flag_evaluations"
      replica_name = "{replica}"
    }
  }
  ...
  table "sharded_heatmaps" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.heatmaps"
      replica_name = "{replica}"
    }
  }
  ...
  table "sharded_ingestion_warnings" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.sharded_ingestion_warnings"
      replica_name = "{replica}"
    }
  }
  ...
  table "sharded_log_entries" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.sharded_log_entries"
      replica_name   = "{replica}"
      version_column = "_timestamp"
    }
  }
  ...
  table "sharded_performance_events" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.performance_events"
      replica_name = "{replica}"
    }
  }

  table "sharded_insights_document_embeddings_buffer" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.sharded_insights_document_embeddings_buffer"
      replica_name   = "{replica}"
      version_column = "inserted_at"
    }
  }

  table "sharded_insights_document_embeddings_text_embedding_3_large_3072" {
    ...
    index "kafka_timestamp_minmax_sharded_insights_document_embeddings_text_embedding_3_large_3072" {
      expr        = "_timestamp"
      type        = "minmax"
      granularity = 3
    }
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.sharded_insights_document_embeddings_text_embedding_3_large_3072"
      replica_name   = "{replica}"
      version_column = "inserted_at"
    }
  }

  table "sharded_insights_document_embeddings_text_embedding_3_small_1536" {
    order_by     = ["team_id", "toDate(timestamp)", "product", "document_type", "rendering", "cityHash64(document_id)"]
    partition_by = "toMonday(timestamp)"
    ttl          = "timestamp + toIntervalMonth(3)"
    settings = {
    ...
    index "kafka_timestamp_minmax_sharded_insights_document_embeddings_text_embedding_3_small_1536" {
      expr        = "_timestamp"
      type        = "minmax"
      granularity = 3
    }
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.sharded_insights_document_embeddings_text_embedding_3_small_1536"
      replica_name   = "{replica}"
      version_column = "inserted_at"
    }
  }
  ...
  table "sharded_preaggregation_results" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.preaggregation_results"
      replica_name = "{replica}"
    }
  }
  ...
  table "sharded_precalculated_events" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.sharded_precalculated_events"
      replica_name   = "{replica}"
      version_column = "_timestamp"
    }
  }
  ...
  table "sharded_precalculated_person_properties" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/{shard}/insights.sharded_precalculated_person_properties"
      replica_name   = "{replica}"
      version_column = "_timestamp"
    }
  }
  ...
  table "sharded_query_log_archive_old" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.sharded_query_log_archive"
      replica_name = "{replica}"
    }
  }
  ...
  table "sharded_raw_sessions" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.raw_sessions"
      replica_name = "{replica}"
    }
  }
  ...
  table "sharded_raw_sessions_v3" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.raw_sessions_v3"
      replica_name = "{replica}"
    }
  }
  ...
  table "sharded_session_replay_embeddings" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.session_replay_embeddings"
      replica_name = "{replica}"
    }
  }
  ...
  table "sharded_session_replay_events" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.session_replay_events"
      replica_name = "{replica}"
    }
  }
  ...
  table "sharded_sessions" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/{shard}/insights.sessions"
      replica_name = "{replica}"
    }
  }
  ...
  table "web_pre_aggregated_bounces" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.web_pre_aggregated_bounces"
      replica_name = "{replica}-{shard}"
    }
  }
  ...
  table "web_pre_aggregated_bounces_staging" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.web_pre_aggregated_bounces_staging"
      replica_name = "{replica}-{shard}"
    }
  }
  ...
  table "web_pre_aggregated_stats" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.web_pre_aggregated_stats"
      replica_name = "{replica}-{shard}"
    }
  }
  ...
  table "web_pre_aggregated_stats_staging" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.web_pre_aggregated_stats_staging"
      replica_name = "{replica}-{shard}"
    }
  }
  ...
  table "web_pre_aggregated_teams" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/tables/noshard/insights.web_analytics_team_selection"
      replica_name   = "{replica}-{shard}"
      version_column = "version"
    }
  }
  ...
  table "writable_events_recent" {
    ...
    engine "distributed" {
      cluster_name    = "insights_writable"
      remote_database = "insights"
      remote_table    = "sharded_events_recent"
      sharding_key    = "sipHash64(distinct_id)"
    }
  ...
  table "writable_insights_document_embeddings_text_embedding_3_large_3072" {
    column "team_id" {
      type = "Int64"
    }
    column "product" {
  ...
  table "writable_insights_document_embeddings_text_embedding_3_small_1536" {
    column "team_id" {
      type = "Int64"
    }
    column "product" {
  ...
  materialized_view "events_json_mv" {
    to_table = "insights.writable_events"
    query    = <<SQL
SELECT
  uuid,
  event,
...
FROM insights.kafka_events_json
SQL
  ...
  materialized_view "events_recent_json_mv" {
    to_table = "insights.writable_events_recent"
    query    = <<SQL
SELECT
  uuid,
  event,
...
SQL
  ...
  materialized_view "ops_query_log_archive_mv" {
    to_table = "insights.writable_query_log_archive"
    query    = <<SQL
SELECT
  hostname,
  user,
...
SQL
  ...
  materialized_view "performance_events_mv" {
    to_table = "insights.writeable_performance_events"
    query    = <<SQL
SELECT
  uuid,
  session_id,
  ...
  _offset,
  _partition
FROM insights.kafka_performance_events
SQL
  ...
  materialized_view "person_distinct_id_mv" {
    to_table = "insights.person_distinct_id"
    query    = <<SQL
SELECT
  distinct_id,
  person_id,
...
SQL
  ...
  materialized_view "insights_document_embeddings_text_embedding_3_large_3072_mv" {
    to_table = "insights.writable_insights_document_embeddings_text_embedding_3_large_3072"
    query    = <<SQL
SELECT
  team_id,
  product,
  ...
  _offset,
  _partition
FROM insights.sharded_insights_document_embeddings_buffer
...
SQL
  ...
  materialized_view "insights_document_embeddings_text_embedding_3_small_1536_mv" {
    to_table = "insights.writable_insights_document_embeddings_text_embedding_3_small_1536"
    query    = <<SQL
SELECT
  team_id,
  product,
...
SQL
  ...
  materialized_view "raw_sessions_mv" {
    to_table = "insights.writable_raw_sessions"
    query    = <<SQL
SELECT
  team_id,
...
SQL
  ...
  materialized_view "sessions_mv" {
    to_table = "insights.writable_sessions"
    query    = <<SQL
SELECT
...
SQL
  ...
  view "persons_batch_export" {
    query = <<SQL
WITH
  new_persons AS (SELECT id, max(version) AS version, argMax(_timestamp, person.version) AS _timestamp2 FROM insights.person WHERE (team_id = {team_id: Int64}) AND (id IN (SELECT id FROM insights.person WHERE (team_id = {team_id: Int64}) AND (_timestamp >= {interval_start: DateTime64}) AND (_timestamp < {interval_end: DateTime64}))) GROUP BY id HAVING (_timestamp2 >= {interval_start: DateTime64}) AND (_timestamp2 < {interval_end: DateTime64})),
  new_distinct_ids AS (SELECT argMax(person_id, person_distinct_id2.version) AS person_id FROM insights.person_distinct_id2 WHERE (team_id = {team_id: Int64}) AND (distinct_id IN (SELECT distinct_id FROM insights.person_distinct_id2 WHERE (team_id = {team_id: Int64}) AND (_timestamp >= {interval_start: DateTime64}) AND (_timestamp < {interval_end: DateTime64}))) GROUP BY distinct_id HAVING (argMax(_timestamp, person_distinct_id2.version) >= {interval_start: DateTime64}) AND (argMax(_timestamp, person_distinct_id2.version) < {interval_end: DateTime64})),
  all_new_persons AS (SELECT id, version FROM new_persons UNION ALL SELECT id, max(version) FROM insights.person WHERE (team_id = {team_id: Int64}) AND (id IN (new_distinct_ids)) GROUP BY id)
SELECT
...
FROM
  insights.person AS p INNER JOIN (SELECT distinct_id, max(version) AS version, argMax(person_id, person_distinct_id2.version) AS person_id2, argMax(_timestamp, person_distinct_id2.version) AS _timestamp FROM insights.person_distinct_id2 WHERE (team_id = {team_id: Int64}) AND (person_id IN (SELECT id FROM all_new_persons)) GROUP BY distinct_id) AS pd ON p.id = pd.person_id2
WHERE
  (team_id = {team_id: Int64})
AND
...
SQL
  ...
  view "insights_document_embeddings_union_view" {
    query = <<SQL
SELECT
  team_id,
  product,
...
FROM insights.distributed_insights_document_embeddings_text_embedding_3_small_1536
UNION ALL
SELECT
  team_id,
  product,
...
FROM insights.distributed_insights_document_embeddings_text_embedding_3_large_3072
SQL
...
SQL
  ...
  dictionary "exchange_rate_dict" {
    ...
    source "datastore" {
      user  = "default"
      query = "SELECT currency, date AS start_date, leadInFrame(date::Nullable(Date), 1, NULL::Nullable(Date)) OVER w AS end_date, argMax(rate, version) AS rate FROM `insights`.`exchange_rate` GROUP BY date, currency WINDOW w AS ( PARTITION BY currency ORDER BY date ASC ROWS BETWEEN 1 FOLLOWING AND 1 FOLLOWING )"
    }
  ...
  dictionary "person_distinct_id_overrides_dict" {
    ...
    source "datastore" {
      user  = "default"
      query = "SELECT team_id, distinct_id, argMax(person_id, version) AS person_id FROM insights.person_distinct_id_overrides GROUP BY team_id, distinct_id"
    }
    layout "complex_key_hashed" {
    }
  }
  ...
  dictionary "web_pre_aggregated_teams_dict" {
    ...
    source "datastore" {
      user  = "default"
      query = "SELECT     team_id FROM     `insights`.`web_pre_aggregated_teams` FINAL WHERE version > 0"
    }
    layout "hashed" {
    }
  }
