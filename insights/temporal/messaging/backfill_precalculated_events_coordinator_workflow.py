...
from insights.temporal.messaging.backfill_precalculated_events_workflow import BackfillPrecalculatedEventsInputs
...
class BackfillPrecalculatedEventsCoordinatorWorkflow(InsightsWorkflow):
    ...
    async def _start_child_workflow_for_day(
        ...
        child_inputs = BackfillPrecalculatedEventsInputs(
            ...
            # Datastore's DateTime64 parser rejects ISO 8601 timezone suffixes (e.g. "+00:00"),
