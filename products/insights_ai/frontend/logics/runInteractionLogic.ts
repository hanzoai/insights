...
import {
    ...
    getModeOption,
    type PermissionMode,
} from 'products/insights_ai/frontend/utils/composerModes'
 ...
 * as one `user_message` when the turn completes. This mirrors the Insights AI sandbox flush path without any
 * conversation/Max coupling.
 */
export const runInteractionLogic = kea<runInteractionLogicType>([
    path(['products', 'insights_ai', 'frontend', 'logics', 'runInteractionLogic']),
            ...
            sendNow: async ({ content, source }) => {
                ...
                try {
                    ...
                    await tasksRunsCommandCreate(String(values.currentProjectId), props.taskId, props.runId, {
                        jsonrpc: '2.0',
                        method: 'user_message',
                        params: { content: wrapWithInsightsContext(content, pendingContext) },
                    })
            ...
            startNewRun: async ({ content }) => {
                ...
                try {
                    ...
                    const createRequest: ClaudeTaskRunCreateSchemaApi = {
                        ...
                        pending_user_message: wrapWithInsightsContext(content, pendingContext),
                    }
                    ...
                    toast.error('Failed to start a new run. Please try again.')
                } finally {
