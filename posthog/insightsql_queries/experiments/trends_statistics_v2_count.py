...
def calculate_probabilities_v2_count(
    ...
    >>> from posthog.insightsql_queries.experiments.trends_statistics_v2_count import calculate_probabilities_v2_count
...
def calculate_credible_intervals_v2_count(variants, lower_bound=0.025, upper_bound=0.975):
    ...
    --------
    >>> from posthog.schema import ExperimentVariantTrendsBaseStats
    >>> from posthog.insightsql_queries.experiments.trends_statistics_v2_count import calculate_credible_intervals_v2_count
    >>> variants = [
