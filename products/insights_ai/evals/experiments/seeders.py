...
# Verbatim string Insights writes onto a feature flag's `properties[].description`
...
def seed_ended_experiment_with_flag_flip(context: CustomPromptSandboxContext) -> dict[str, Any]:
    ...
    experiment is ended via `experiment-ship-variant`, Insights rewrites the
    ...
    """
    from insights.models.activity_logging.activity_log import ActivityLog, Change, Detail
