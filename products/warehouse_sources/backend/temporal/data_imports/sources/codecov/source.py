...
class CodecovSource(ResumableSource[CodecovSourceConfig, CodecovResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Codecov API token to automatically pull your code coverage data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/codecov",
