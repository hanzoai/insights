...
class ResultsFormatter:
    ...
    def format(
        ...
        body_parts = [
            f"🧠 **AI eval results** for dataset [{self.dataset_name}](https://us.hanzo.ai/ai-evals/datasets/{self.dataset_id})",
    ...
    def _build_traces_url(self, result: dict[str, Any]) -> str:
        ...
        return f"https://us.hanzo.ai/ai-observability/traces?filters={urllib.parse.quote(json.dumps(traces_filter))}"
