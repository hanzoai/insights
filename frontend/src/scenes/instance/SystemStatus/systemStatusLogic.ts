...
export interface systemStatusLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface systemStatusLogicActions {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface systemStatusLogicMeta {
...
export type systemStatusLogicType = MakeLogicType<
    systemStatusLogicValues,
    systemStatusLogicActions,
    Record<string, any>,
    systemStatusLogicMeta
>
...
export const systemStatusLogic = kea<systemStatusLogicType>([
    ...
    selectors(() => ({
        ...
        editableInstanceSettings: [
            ...
            (instanceSettings: InstanceSetting[]): InstanceSetting[] =>
