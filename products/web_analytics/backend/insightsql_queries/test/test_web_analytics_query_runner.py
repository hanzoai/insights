...
from insights.schema import DateRange, InsightsQLQueryModifiers, WebOverviewQuery, WebStatsBreakdown, WebStatsTableQuery
...
class TestWebStatsTableQueryRunner(DatastoreTestMixin, APIBaseTest):
    ...
    @parameterized.expand(
        [
            ...
            (
                ...
                False,
                False,
                InsightsQLQueryModifiers(useWebAnalyticsPreAggregatedTables=True),
    ...
    def test_stats_table_query_type_tracks_strategy(
        ...
        modifiers: InsightsQLQueryModifiers | None,
        ...
        self.assertEqual(runner.datastore_query_type(), expected_query_type)


class TestWebAnalyticsBreakdownTagging(DatastoreTestMixin, APIBaseTest):
    @parameterized.expand(
        [
    ...
    def test_calculate_tags_breakdown_by_for_stats_table_query(
        ...
        with mock.patch(
            "products.web_analytics.backend.insightsql_queries.web_analytics_query_runner.tag_queries",
            wraps=tag_queries,
        ) as spy:
            runner.calculate()
