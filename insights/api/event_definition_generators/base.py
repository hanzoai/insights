...
from insights.models import EventDefinition, EventSchema, SchemaPropertyGroupProperty
from insights.taxonomy.taxonomy import CORE_EVENTS
...
class EventDefinitionGenerator(ABC):
    ...
    def fetch_event_definitions_and_schemas(
        ...
        """
        # Include core Insights events (from the taxonomy), verified events, and
        ...
        event_definitions = (
            ...
            .filter(
                Q(name__in=CORE_EVENTS)  # Core Insights events from the taxonomy
