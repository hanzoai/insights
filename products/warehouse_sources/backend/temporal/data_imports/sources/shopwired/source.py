...
class ShopWiredSource(ResumableSource[ShopWiredSourceConfig, ShopWiredResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your ShopWired API credentials to pull your store data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/shopwired",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
