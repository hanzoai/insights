...
from insights.schema import QueryIndexUsage

from insights.datastore.explain import (
    ReadIndexUsage,
...
test_cases: list[DataTestCase] = [
    DataTestCase(
        ...
        reads=1,
        reads_use=[ReadIndexUsage(table="insights.sharded_events", use=QueryIndexUsage.YES)],
              ...
              "Plans": [
                {
                  ...
                  "Description": "insights.sharded_events",
                  "Indexes": [
                    {
                      "Type": "MinMax",
                      "Keys": [
...
""",
    ...
    DataTestCase(
        ...
        reads=1,
        reads_use=[ReadIndexUsage(table="insights.sharded_events", use=QueryIndexUsage.NO)],
...
""",
    ...
    DataTestCase(
        query="production query often failing cause Datastore not using index",
        reads=2,
        reads_use=[
            ReadIndexUsage(table="insights.sharded_events", use=QueryIndexUsage.NO),
            ReadIndexUsage(table="insights.person_distinct_id_overrides", use=QueryIndexUsage.YES),
        ],
                                                              ...
                                                              "Plans": [
                                                                {
                                                                  ...
                                                                  "Plans": [
                                                                    {
                                                                      "Node Type": "ReadFromMergeTree",
                                                                      "Description": "insights.person_distinct_id_overrides",
                                                                      "Indexes": [
                                                                        {
                                                                          "Type": "PrimaryKey",
                                                                          "Keys": [
...
""",
    ...
    DataTestCase(
        ...
        reads=1,
        reads_use=[ReadIndexUsage(table="insights.sharded_raw_sessions", use=QueryIndexUsage.PARTIAL)],
        use=QueryIndexUsage.PARTIAL,
        plan="""
[
   {
                                                   ...
                                                   "Plans" : [
                                                      {
                                                         ...
                                                         "Plans" : [
                                                            {
                                                               "Description" : "insights.sharded_raw_sessions",
                                                               "Indexes" : [
                                                                  {
                                                                     "Condition" : "true",
