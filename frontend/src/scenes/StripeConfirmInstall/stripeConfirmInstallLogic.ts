...
export type stripeConfirmInstallLogicType = MakeLogicType<
    stripeConfirmInstallLogicValues,
    stripeConfirmInstallLogicActions,
    Record<string, any>,
    stripeConfirmInstallLogicMeta
>
...
export const stripeConfirmInstallLogic = kea<stripeConfirmInstallLogicType>([
    ...
    selectors({
        hasRequiredParams: [
            (s) => [s.params],
            (params: StripeConfirmInstallParams): boolean => !!params.code && !!params.stripe_user_id,
        ],
    }),
    ...
    listeners(({ actions, values }) => ({
        confirmInstall: async () => {
            ...
            try {
                ...
                toast.success('Stripe integration connected.')
                ...
                toast.error(detail || 'Failed to connect Stripe. The install link may have expired.')
                actions.setSubmitting(false)
            }
        },
        cancelInstall: () => {
            toast.info('Stripe install cancelled.')
