...
class TestDeleteEventsRetry:
    ...
    @patch("insights.dags.events_backfill_to_duckling.attach_catalog")
    @patch("insights.dags.events_backfill_to_duckling.configure_cross_account_connection")
    @patch("insights.dags.events_backfill_to_duckling._connect_duckdb")
    @patch("insights.dags.events_backfill_to_duckling.get_team_config")
...
class TestFullBackfillSensorEarliestDate:
    ...
    @patch("insights.dags.events_backfill_to_duckling.get_earliest_event_date_for_team")
    @patch("insights.dags.events_backfill_to_duckling.DuckLakeCatalog")
    @patch("insights.dags.events_backfill_to_duckling.timezone")
