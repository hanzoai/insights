                    ...
                    {!isEnabled && (
                        <>
                            <ul className="text-sm flex flex-col gap-1.5 mb-0 pl-5 list-disc">
                                ...
                                <li>
                                    <strong>Email</strong> — forward customer emails to Insights and reply directly from
                                    the inbox.
                                </li>
                                <li>
                    ...
                    <SceneSection
                        ...
                        description={
                            <>
                                ...
                                <Link to="https://hanzo.ai/docs/support/javascript-api" target="_blank">
                                    Docs
                                </Link>
                            </>
                        }
                    ...
                    >
                        <Card hoverEffect={false} className="max-w-[800px] px-4 py-3">
                            <p className="mb-2">
                                ...
                                below (server-side) and pass both values to <code>insights.init()</code>:
                            </p>
