...
To run:
    ...
    flox activate -- bash -c "set -a; source .env; set +a; python -m products.insights_ai.eval_harness.harness eval_empty_experiment"
"""
...
from products.insights_ai.evals.experiments.seeders import (
...
async def eval_empty_experiment(ctx: EvalContext) -> None:
    cases: list[SandboxedEvalCase] = [
        ...
        SandboxedEvalCase(
            ...
            expected={
                "diagnosis_group": (
                    "The custom exposure event is missing the variant-value property. Insights needs "
        ...
        SandboxedEvalCase(
            ...
            expected={
                "diagnosis_group": (
                    ...
                    "the internal teammates. Insights's experiments apply "
