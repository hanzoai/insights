...
shrinkray lives in the optional `insightsql-parser-parity` dependency group, not
...
module therefore require that group — `uv sync --group insightsql-parser-parity`
