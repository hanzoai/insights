...
use personinsights_coordination::error::{Error, Result};
...
///     consumes the `personinsights_updates` topic for the partition and
...
mod tests {
    ...
    fn handler() -> LeaderHandoffHandler {
        ...
        let pools = Arc::new(WarmClientPools::new(&kafka, "test", "personinsights-writer"));
