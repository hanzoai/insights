...
export interface HeatmapPreflightResponseApi {
    ...
    /**
     * HTTP status the page returned to us. A 4xx or 5xx here points at the customer's host or CDN rather than at Insights. Null when the page could not be reached at all.
     * @nullable
     */
