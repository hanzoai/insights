...
class DockerhubSource(ResumableSource[DockerhubSourceConfig, DockerhubResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Docker Hub username and a personal access token to pull your container repositories and tags into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/dockerhub",
            keywords=["docker"],
            fields=cast(
                list[FieldType],
                [
