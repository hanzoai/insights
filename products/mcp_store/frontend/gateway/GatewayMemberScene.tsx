...
export function GatewayMemberScene(): JSX.Element {
    ...
    return (
        <SceneContent>
            <Button size="small" onClick={() => router.actions.push(urls.mcpGatewayTab('team'))}>
                ‹ Back to team & agents
            </Button>
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    <div className="flex items-center gap-2">
                        ...
                        {member.is_org_admin && <Tag type="highlight">admin</Tag>}
                    </div>
                ...
                {allServers.map((server) => {
                    ...
                    return (
                        <div key={server.id} className="flex items-center gap-3 p-2">
                            ...
                            {isConnected && (
                                <Button size="xsmall" type="secondary" to={urls.mcpGatewayServer(server.id)}>
                                    Tool policies
                                </Button>
                            )}
                            <Switch
