...
def gitea_source(
    ...
    def items() -> Iterator[Any] | AsyncIterator[Any]:
        if webhook_enabled:
            ...
            # The Script template lands the nested issue/pull_request object as the row, which
...
def create_repo_webhook(
    ...
    if response.status_code in (200, 201):
        ...
        # extra_inputs — the framework persists it onto the script function's signing_secret
