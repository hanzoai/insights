...
class TestBuildEmitExtra:
    ...
    def test_skill_version_cast_to_float(self) -> None:
        extra = self._minimal()
        # SignalsScoutSignalExtra.skill_version is float in insights/schema.py.
...
class TestBuildCharts:
    ...
    def test_unrenderable_query_kind_raises_before_any_write(self) -> None:
        chart = ReportChartInput(chart_id="sql", title="t", query={"kind": "InsightsQLQuery", "query": "SELECT 1"})
