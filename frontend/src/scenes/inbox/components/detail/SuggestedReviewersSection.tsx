...
export function SuggestedReviewersSection({ report }: { report: SignalReport }): JSX.Element | null {
    ...
    return (
        <DetailSection
            ...
            collapsible
            afterTitle={
                <Tooltip title="Suggested reviewers are tracked in Insights. To request a review on GitHub, add them on the pull request directly.">
                ...
                title={
                    reviewer.user
                        ? githubUrl
                            ...
                            : undefined
                        : `${displayName} hasn't connected their GitHub account to Insights. Ask them to do so in Settings!`
                }
            >
