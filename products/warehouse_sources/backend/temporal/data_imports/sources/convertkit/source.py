...
class ConvertKitSource(ResumableSource[ConvertKitSourceConfig, ConvertKitResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            keywords=["kit"],
            label="ConvertKit",
            caption="""Enter your Kit (formerly ConvertKit) API key to pull your Kit data into the Insights Data warehouse.
...
You can create a v4 API key in your [Kit account settings](https://app.kit.com/account_settings/developer_settings).""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/convertkit",
