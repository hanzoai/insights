...
export interface batchExportBackfillModalLogicMeta {
    ...
    __keaTypeGenInternalSelectorTypes: {
        isInsightsFunction: (arg: any) => boolean
...
export const batchExportBackfillModalLogic = kea<batchExportBackfillModalLogicType>([
    ...
    selectors({
        isInsightsFunction: [
            () => [(_, props) => props],
            (props: BatchExportBackfillModalLogicProps): boolean => props.context === 'insights_function',
        ],
        interval: [
    ...
    forms(({ props, actions, values }) => ({
        backfillForm: {
            ...
            submit: async ({ start_at, end_at, earliest_backfill }) => {
                ...
                toast.success('Backfill created')
