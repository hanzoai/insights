...
# The activity-log post_save signal lazily imports insights.api.advanced_activity_logs
# (-> insights.tasks.usage_report) the first time an ActivityLog row is created. In these
...
import insights.api.advanced_activity_logs  # noqa: F401, E402 — warm import; see comment above
