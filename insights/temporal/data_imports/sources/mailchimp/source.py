...
from insights.temporal.data_imports.sources.generated_configs import MailchimpSourceConfig
from insights.temporal.data_imports.sources.mailchimp.mailchimp import (
    mailchimp_source,
    validate_credentials as validate_mailchimp_credentials,
)
from insights.temporal.data_imports.sources.mailchimp.settings import ENDPOINTS, INCREMENTAL_FIELDS
