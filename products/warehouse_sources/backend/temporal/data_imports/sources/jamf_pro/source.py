...
class JamfProSource(ResumableSource[JamfProSourceConfig, JamfProResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Jamf Pro instance URL and credentials to pull your device inventory into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/jamf-pro",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
