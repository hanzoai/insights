...
from insights.api.product_enablement import ProductEnablementViewSet
from insights.api.query_performance_proxy import QueryPerformanceProxyViewSet
...
# `register_routes(routers)`. See insights/api/routing.py:RouterRegistry.
...
# Insights Desktop invites (not project-scoped)
...
projects_router.register(
    r"insights_connections",
    insights_connection.InsightsConnectionViewSet,
    "project_insights_connections",
    ["team_id"],
)
projects_router.register(
...
from insights.api.cohort import CohortViewSet, LegacyCohortViewSet  # noqa: E402
from insights.api.element import ElementViewSet, LegacyElementViewSet  # noqa: E402
from insights.api.event import EventViewSet, LegacyEventViewSet  # noqa: E402
from insights.api.person import LegacyPersonViewSet, PersonViewSet  # noqa: E402
from insights.api.web_experiment import WebExperimentViewSet  # noqa: E402
...
#     `insights/urls.py` imports this module, so the whole API surface loads at first
...
#     import of `insights.api` (i.e. first request) keeps the API out of setup().
#   - Net: core still triggers registration (via the existing `insights.api` import) rather
