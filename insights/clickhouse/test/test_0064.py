...
from insights.test.base import BaseTest, ClickhouseDestroyTablesMixin, _create_event
from insights.clickhouse.client import sync_execute

module = importlib.import_module("insights.clickhouse.migrations.0064_materialize_elements_chain")
