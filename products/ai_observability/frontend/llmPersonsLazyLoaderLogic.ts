...
export interface llmPersonsLazyLoaderLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface llmPersonsLazyLoaderLogicActions {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface llmPersonsLazyLoaderLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        isDistinctIdLoading: (loadingDistinctIds: Set<string>) => (distinctId: string) => boolean
    }
}

export type llmPersonsLazyLoaderLogicType = MakeLogicType<
    llmPersonsLazyLoaderLogicValues,
    llmPersonsLazyLoaderLogicActions,
    Record<string, any>,
    llmPersonsLazyLoaderLogicMeta
>

export const llmPersonsLazyLoaderLogic = kea<llmPersonsLazyLoaderLogicType>([
    path(['products', 'ai_observability', 'frontend', 'llmPersonsLazyLoaderLogic']),
    ...
    selectors({
        isDistinctIdLoading: [
            ...
            (loadingDistinctIds: Set<string>): ((distinctId: string) => boolean) => {
