...
from posthog.insightsql_queries.insights.funnels.test.test_funnel_persons import get_actors, get_actors_legacy_filters
...
TEST_BUCKET = "test_storage_bucket-posthog.insightsql_queries.insights.funnels.breakdown_cases"
