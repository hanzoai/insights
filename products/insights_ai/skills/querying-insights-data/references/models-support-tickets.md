...
`distinct_id` | varchar(400) | NOT NULL | Insights distinct_id linking the ticket to a person
...
`session_id` | varchar(64) | NULL | Insights session ID captured at ticket creation
