...
// Datastore only returns buckets that had events, so `bucketKeys` (built from the window at the
...
export const mcpAnalyticsToolQualityLogic = kea<mcpAnalyticsToolQualityLogicType>([
    ...
    selectors({
        ...
        // Grouping interval for the daily chart — Insights's standard auto-choice, so a sub-day window
