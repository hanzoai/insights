...
from insights.ph_client import get_client
...
class SandboxedEvalHarness:
    ...
    def __init__(self, options: HarnessOptions) -> None:
        ...
        self._insights_client: Insights | None = None
    ...
    def _bootstrap(self, required: frozenset[Infra]) -> None:
        ...
        if Infra.PERSONHOG in required:
            ...
            self._stack.callback(start_personinsights())
        ...
        self._insights_client = get_client("US")
        if self._insights_client is not None:
            self._stack.callback(self._insights_client.shutdown)
    ...
    async def _run_suites(
        ...
        async with AsyncExitStack() as stack:
            ...
            stack.enter_context(patch.object(hanzo_insights, "feature_enabled", return_value=True))
    ...
    def _build_context(self, required: frozenset[Infra], reporter: ProgressReporter) -> EvalContext:
        ...
        return EvalContext(
            ...
            insights_client=self._insights_client,
