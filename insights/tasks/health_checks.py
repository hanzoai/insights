...
def evaluate_health_check_for_team(kind: str, team_id: int) -> None:
    # Deferred: insights.dags.__init__ calls django.setup() and would re-enter if loaded during boot.
    from insights.temporal.health_checks.processing import _process_batch_detection
    from insights.temporal.health_checks.registry import ensure_registry_loaded, get_detect_fn
