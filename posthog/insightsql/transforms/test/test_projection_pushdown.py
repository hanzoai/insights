...
from posthog.insightsql.printer import prepare_ast_for_printing
...
class TestProjectionPushdown(BaseTest):
    ...
    def _optimize(self, query_str: str):
        ...
        modifiers = InsightsQLQueryModifiers(optimizeProjections=False)  # Disable automatic optimization
        ...
        prepared = prepare_ast_for_printing(query, context, dialect="insightsql")
    ...
    def test_simple_pushdown(self):
        ...
        assert optimized.to_insightsql() == self.snapshot
