...
def flag_on():
    with patch(
        "products.slack_app.backend.feature_flags.hanzo_insights.feature_enabled",
        return_value=True,
    ):
        yield
...
class TestTasksCard:
    ...
    def _item(self, **overrides) -> TaskItem:
        defaults = {
            ...
            "insights_url": "https://app/project/1/tasks/abc",
            "status": "in_progress",
    ...
    def test_first_use_state_invites_user_to_mention(self):
        ...
        assert "Mention @Insights" in text
    ...
    def test_each_task_renders_as_title_section_plus_context_meta(self):
        state = TasksState(
            ...
            available_repos=("insights/insights",),
            has_any_tasks=True,
            page=0,
            total_pages=1,
            total_filtered=2,
        ...
        assert "`insights/insights`" in sub
        assert "<https://slack.com/archives/C1/p1234567890123456|Thread>" in sub
        assert "<https://github.com/insights/insights/pull/123|PR>" in sub
    ...
    def test_failed_task_renders_title_then_error_then_meta(self):
        ...
        assert "`insights/insights`" in sub_rows[1]
        assert "<https://slack.com/archives/C1/p1234567890123456|Thread>" in sub_rows[1]
        assert "<https://github.com/insights/insights/pull/123|PR>" in sub_rows[1]
    ...
    def test_repo_dropdown_renders_with_single_repo_and_includes_all_option(self):
        ...
        assert labels == ["All repos", "insights/insights"]
