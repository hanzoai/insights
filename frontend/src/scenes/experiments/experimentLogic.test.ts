...
describe('experimentLogic', () => {
    ...
    describe('refreshExperimentResults', () => {
        it('waits for metric refreshes to complete before resolving', async () => {
            ...
            useMocks({
                post: {
                    '/v1/environments/:team/query': async () => {
                ...
                get: {
                    '/v1/environments/:team/query/:id': async () => {
                        await new Promise((resolve) => setTimeout(resolve, 30))
    ...
    describe('currentRefresh tracking', () => {
        it('marks the refresh as in_progress while running and completed when it succeeds', async () => {
            ...
            useMocks({
                ...
                get: {
                    '/v1/environments/:team/query/:id': () => [200, experimentMetricResultsSuccessJson],
                },
            })
    ...
    describe('optimistic concurrency', () => {
        ...
        it('reloads fresh state but keeps the rejected scalar edit on a version conflict', async () => {
            ...
            expect(toast.error).toHaveBeenCalledWith('The experiment was changed since you loaded it.')
