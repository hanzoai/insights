 ...
 * the live path wraps context client-side (`products/insights_ai/frontend/utils/insightsContextBlock.ts`).
 */
...
export interface SandboxOpenApi {
    ...
    trace_id?: string
    /** Typed Insights entities (and free text) attached to this message. */
...
export interface TicketApi {
    ...
    /**
     * Customer's Insights organization group key, resolved at ticket creation. Null when unknown.
     * @nullable
     */
...
export interface ComposeTicketApi {
    ...
    /**
     * Insights distinct_id to link the ticket to a person. Falls back to recipient_email.
     * @maxLength 400
     */
