...
from products.mcp_analytics.backend.insightsql_queries.base import mcp_query_date_range, validate_mcp_analytics_access
...
class MCPToolQualityRowsQueryRunner(AnalyticsQueryRunner[MCPToolQualityRowsQueryResponse]):
    ...
    def _calculate(self) -> MCPToolQualityRowsQueryResponse:
        ...
        return MCPToolQualityRowsQueryResponse(
            results=results, timings=response.timings, insightsql=response.insightsql, modifiers=self.modifiers
        )
