...
import {
    INBOX_PRODUCT_TYPE,
    creditsPerPr as deriveCreditsPerPr,
    freePrs as deriveFreePrs,
    pricePerPrUsd as derivePricePerPrUsd,
} from 'scenes/billing/inboxPricing'
...
export const inboxUsageLogic = kea<inboxUsageLogicType>([
    ...
    selectors({
        // The refunds flag is keyed on the organization group, so insights-js only resolves it
