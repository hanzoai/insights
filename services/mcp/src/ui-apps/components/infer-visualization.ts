 ...
 */
export function isInsightsQLResult(results: unknown): results is InsightsQLResult {
...
export function inferVisualizationType(data: unknown): VisualizationType | null {
    ...
    // Resolve the query kind up front. Wrapper nodes (`DataVisualizationNode` for InsightsQL/SQL
 ...
 * query on `source.kind`: `DataVisualizationNode` (InsightsQL/SQL insights) and `InsightVizNode`
