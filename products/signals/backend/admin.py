...
class SignalScoutRunAdmin(admin.ModelAdmin):
    ...
    def team_link(self, run: SignalScoutRun):
        return format_html(
            '<a href="{}">{}</a>',
            reverse("admin:insights_team_change", args=[run.team.pk]),
            run.team.name,
        )
...
class SignalScratchpadAdmin(admin.ModelAdmin):
    ...
    def team_link(self, scratchpad: SignalScratchpad):
        return format_html(
            '<a href="{}">{}</a>',
            reverse("admin:insights_team_change", args=[scratchpad.team.pk]),
...
class SignalScoutNoteAdmin(admin.ModelAdmin):
    ...
    def team_link(self, note: SignalScoutNote):
        return format_html(
            '<a href="{}">{}</a>',
            reverse("admin:insights_team_change", args=[note.team.pk]),
            note.team.name,
        )
