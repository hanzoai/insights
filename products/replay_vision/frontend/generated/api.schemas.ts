...
export interface ScannerResultApi {
    ...
    /**
     * Number of Insights Signals emitted from this observation.
     * @minimum 0
     */
...
export interface CreateTaskFromObservationResponseApi {
    /** ID of the Insights Task holding this observation's finding, created now (201) or by an earlier call (200). */
    task_id: string
}
...
export interface ReplayScannerApi {
    ...
    enabled?: boolean
    /** When true, the prompt is augmented with the Signal side mission and the scanner emits Insights Signals. */
    emits_signals?: boolean
