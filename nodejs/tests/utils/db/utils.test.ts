...
describe('personInitialAndUTMProperties()', () => {
    it('adds initial and utm properties', () => {
        const properties = {
            ...
            $referrer: 'https://google.com/?q=insights',
            utm_medium: 'twitter',
            gclid: 'GOOGLE ADS ID',
            msclkid: 'BING ADS ID',
            $elements: [
            ...
            $app_build: 2,
            $app_name: 'my app',
            $app_namespace: 'com.insights.myapp',
            $app_version: '1.2.3',
        ...
        expect(personInitialAndUTMProperties(properties)).toMatchInlineSnapshot(
            `
            {
              ...
              "$set_once": {
                ...
                "$initial_app_namespace": "com.insights.myapp",
                ...
                "$initial_referrer": "https://google.com/?q=insights",
    ...
    it.each([
        ...
        ['client mobile via $os_name', { $lib: 'insights-ios', $os_name: 'iOS' }, 'iOS'],
