...
from insights.datastore.preaggregation.web_bounces_dimensional_preaggregated_sql import (
    DISTRIBUTED_WEB_BOUNCES_DIMENSIONAL_PREAGGREGATED_TABLE_SQL,
    SHARDED_WEB_BOUNCES_DIMENSIONAL_PREAGGREGATED_TABLE_SQL,
)
from insights.datastore.preaggregation.web_stats_dimensional_preaggregated_sql import (
