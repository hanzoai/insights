...
> &
    Pick<
        ...
        | 'INSIGHTS_FUNCTION_MONITORING_APP_METRICS_PRODUCER'
        | 'INSIGHTS_FUNCTION_MONITORING_LOG_ENTRIES_TOPIC'
        | 'INSIGHTS_FUNCTION_MONITORING_LOG_ENTRIES_PRODUCER'
        | 'INSIGHTS_INVOCATION_RESULTS_TOPIC'
        | 'INSIGHTS_INVOCATION_RESULTS_PRODUCER'
        | 'INSIGHTS_INVOCATION_RESULTS_ENABLED'
