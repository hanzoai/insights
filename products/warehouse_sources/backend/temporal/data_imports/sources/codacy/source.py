...
class CodacySource(SimpleSource[CodacySourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Codacy account API token to automatically pull your Codacy code quality data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/codacy",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
