...
from products.warehouse_sources.backend.temporal.data_imports.sources.generated_configs.trello import TrelloSourceConfig
...
class TrelloSource(ResumableSource[TrelloSourceConfig, TrelloResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Trello API key and token to sync your boards, cards, lists and more into the Insights Data warehouse.
