"""Shared wiring for the MCP analytics InsightsQL query runners.
...
# require, so the generic /query/ endpoint can't bypass either (see InsightsFeatureFlagPermission
...
# Marker the insights-node MCP analytics SDK stamps on the events it sends.
