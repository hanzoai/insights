database "insights" {
  ...
  table "log_attributes" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.log_attributes"
  ...
  table "log_attributes2" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.log_attributes2"
      replica_name = "{replica}-{shard}"
    }
  }
  ...
  table "log_attributes_distributed" {
    ...
    engine "distributed" {
      cluster_name    = "insights_single_shard"
...
SQL
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.logs32"
      replica_name = "{replica}-{shard}"
    }
  }
  table "logs34" {
...
SQL
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.logs34"
      replica_name = "{replica}-{shard}"
    }
  }
  table "logs_billing_metrics" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.logs_billing_metrics"
      replica_name = "{replica}-{shard}"
    }
  }
  ...
  table "logs_kafka_metrics" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.logs_kafka_metrics"
      replica_name = "{replica}-{shard}"
    }
  }
...
SQL
  ...
  materialized_view "logs32_to_log_attributes" {
    to_table = "insights.log_attributes"
    query    = <<SQL
SELECT
  team_id,
  time_bucket,
...
SQL
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.trace_spans"
      replica_name = "{replica}-{shard}"
    }
  }
  table "trace_attributes" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.trace_attributes"
      replica_name = "{replica}-{shard}"
    }
  }
  table "trace_attributes2" {
    ...
    engine "replicated_aggregating_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.trace_attributes2"
      replica_name = "{replica}-{shard}"
    }
  }
  table "trace_spans_kafka_metrics" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.trace_spans_kafka_metrics"
      replica_name = "{replica}-{shard}"
    }
  }
...
SQL
  ...
  materialized_view "trace_span_to_attributes2" {
    to_table = "insights.trace_attributes2"
    query    = <<SQL
SELECT
  team_id,
  original_expiry_time_bucket,
