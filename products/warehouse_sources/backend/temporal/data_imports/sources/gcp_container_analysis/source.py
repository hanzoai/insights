...
from products.warehouse_sources.backend.temporal.data_imports.sources.generated_configs.gcpcontaineranalysis import (
    GcpContainerAnalysisSourceConfig,
)
...
class GcpContainerAnalysisSource(SimpleSource[GcpContainerAnalysisSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            name=SchemaExternalDataSourceType.GCP_CONTAINER_ANALYSIS,
