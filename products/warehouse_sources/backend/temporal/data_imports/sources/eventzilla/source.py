...
class EventzillaSource(ResumableSource[EventzillaSourceConfig, EventzillaResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Eventzilla API key to automatically pull your Eventzilla data into the Insights Data warehouse.
...
You can generate an API key in your Eventzilla account under **Settings > App Management**.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/eventzilla",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
