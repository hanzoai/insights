...
from insights.schema_enums import CustomChannelField, CustomChannelOperator, DefaultChannelTypes

if TYPE_CHECKING:
    from insights.schema import CustomChannelRule

from insights.insightsql import ast
from insights.insightsql.database.models import ExpressionField
...
def create_initial_domain_type(
    name: str, timings: Optional[InsightsQLTimings] = None, properties_path: Optional[list[str]] = None
) -> ExpressionField:
...
# Default channel-type classification; the resolver expands it to SQL (never a real Datastore function).
