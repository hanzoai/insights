...
class CalendlySource(
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Calendly personal access token to pull your Calendly data into the Insights Data warehouse.
...
You can create a personal access token in Calendly under **Integrations → API & Webhooks**. A personal access token requires a paid Calendly plan.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/calendly",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
            ...
            webhookSetupCaption="""Insights registers an organization-wide webhook subscription with your personal access token, using a generated signing key to verify every delivery. Webhooks need a Calendly Standard plan or higher, and an organization-wide subscription needs an admin or owner token.
...
Paste the same signing key into the field below so Insights can verify deliveries.""",
            webhookFields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
                        ...
                        placeholder="",
                        caption=(
                            "The signing key set on the Calendly webhook subscription. Insights uses it to "
