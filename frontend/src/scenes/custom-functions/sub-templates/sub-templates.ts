...
export const CUSTOM_FUNCTION_SUB_TEMPLATE_COMMON_PROPERTIES: Record<
    CustomFunctionSubTemplateIdType,
    Pick<CustomFunctionSubTemplateType, 'sub_template_id' | 'type' | 'context_id'> &
        Omit<Partial<CustomFunctionSubTemplateType>, 'sub_template_id' | 'type' | 'context_id'>
> = {
    'survey-response': {
...
export const CUSTOM_FUNCTION_SUB_TEMPLATES: Record<CustomFunctionSubTemplateIdType, CustomFunctionSubTemplateType[]> = {
    'survey-response': [
        {
            ...CUSTOM_FUNCTION_SUB_TEMPLATE_COMMON_PROPERTIES['survey-response'],
    ...
    'early-access-feature-enrollment': [
        {
            ...CUSTOM_FUNCTION_SUB_TEMPLATE_COMMON_PROPERTIES['early-access-feature-enrollment'],
            template_id: 'template-webhook',
    ...
    'activity-log': [
        {
            ...CUSTOM_FUNCTION_SUB_TEMPLATE_COMMON_PROPERTIES['activity-log'],
            template_id: 'template-webhook',
    ...
    'discussion-mention': [
        {
            ...CUSTOM_FUNCTION_SUB_TEMPLATE_COMMON_PROPERTIES['discussion-mention'],
            template_id: 'template-webhook',
    ...
    'error-tracking-issue-created': [
        {
            ...CUSTOM_FUNCTION_SUB_TEMPLATE_COMMON_PROPERTIES['error-tracking-issue-created'],
            template_id: 'template-webhook',
    ...
    'error-tracking-issue-reopened': [
        {
            ...CUSTOM_FUNCTION_SUB_TEMPLATE_COMMON_PROPERTIES['error-tracking-issue-reopened'],
            template_id: 'template-webhook',
    ...
    'error-tracking-issue-spiking': [
        {
            ...CUSTOM_FUNCTION_SUB_TEMPLATE_COMMON_PROPERTIES['error-tracking-issue-spiking'],
            template_id: 'template-discord',
...
[View issue]({project.url}/error_tracking/{event.distinct_id})`,
    ...
    [INSIGHT_ALERT_FIRING_SUB_TEMPLATE_ID]: [
        {
            ...CUSTOM_FUNCTION_SUB_TEMPLATE_COMMON_PROPERTIES[INSIGHT_ALERT_FIRING_SUB_TEMPLATE_ID],
            template_id: 'template-webhook',
...
): CustomFunctionSubTemplateType | null => {
    return CUSTOM_FUNCTION_SUB_TEMPLATES[subTemplateId].find((x) => x.template_id === template.id) || null
}

export const eventToCustomFunctionContextId = (event: string | undefined): CustomFunctionConfigurationContextId => {
    switch (event) {
