...
class RechargeSource(ResumableSource[RechargeSourceConfig, RechargeResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Recharge",
            caption="""Enter your Recharge API token to automatically pull your Recharge subscription data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/recharge",
