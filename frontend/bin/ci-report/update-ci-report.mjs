...
export const MARKER = '<!-- insights-ci-report -->'
...
export const SECTIONS = [
    ...
    { id: 'ch-migration-sql', title: 'Datastore migration SQL' },
    { id: 'insightsql-parser-py', title: 'insightsql-parser version' },
    { id: 'insightsql-parser-npm', title: '@hanzo/insightsql-parser version' },
    { id: 'insightsql-parser-rs', title: 'insightsql-parser-rs version' },
    { id: 'replay-anonymizer-crate', title: 'insights-replay-anonymizer version' },
