 ...
 * Exposed on the host page as `window.insightsToolbarController`.
 */
export class InsightsToolbarController {
...
export const insightsToolbarController = new InsightsToolbarController()
