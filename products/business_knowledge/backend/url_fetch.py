...
Responsibilities:
- Validate URL (reuses `insights.security.url_validation`) before each hop.
...
from insights.security.pinned_requests import PinnedIPAdapter
from insights.security.url_validation import strip_userinfo, validate_url_and_pin_ips
