...
from insights.admin.admins.backfill_precalculated_events_admin import backfill_precalculated_events_view
...
class TestBackfillPrecalculatedEventsAdmin(BaseTest):
    ...
    def test_ignore_backfilled_dates_checkbox_controls_command_flag(self, ignore_backfilled_dates: bool) -> None:
        ...
        with (
            patch("insights.admin.admins.backfill_precalculated_events_admin.call_command") as mock_call_command,
            patch("insights.admin.admins.backfill_precalculated_events_admin.redirect") as mock_redirect,
        ):
