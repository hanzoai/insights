...
import { IconExternal, IconSidePanel, IconSparkles } from '@hanzo/icons'
import {
    Badge,
    Button,
    Menubar,
        ...
        <>
            <div
                ...
                className={cn(
                    ...
                    // When Tabs is the immediately preceding sibling it already bleeds with
    ...
    return (
        <div className="flex items-center gap-px pr-1">
            <Button
                ...
                render={<LinkPrimitive to="https://hanzo.ai/docs" target="_blank" />}
            >
                Docs
                <IconExternal />
            </Button>
 ...
 * consistent across Insights scenes. Render only the menus your scene actually needs.
 *
 ...
 *
 * Right cluster is universal: Insights AI / Docs / Support.
 *
 ...
 * visual signal (red text + icon) is consistent across Insights scenes.
 */
