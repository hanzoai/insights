...
export const Linear = defineIntegration(
    {
        ...
        name: 'Linear',
        logo: ICONS.linear,
        subtitle: 'Turn issues into Linear tickets without leaving Insights',
        description: 'Connect Linear to create and link issues directly from Insights error tracking and replays.',
        capabilities: [
            'Create Linear issues from error tracking',
            'Link existing Linear issues to Insights',
