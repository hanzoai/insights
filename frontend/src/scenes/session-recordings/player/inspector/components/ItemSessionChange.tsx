        ...
        <div className="w-full text-xs items-center justify-center flex">
            ...
            <div className="flex-1 flex px-2">
                <LemonButton
                    ...
                    tooltip="Insights might split user sessions, for example if a session has been idle for a long time. You can jump between these sessions to see the continued journey for the user."
