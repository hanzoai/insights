...
def duration_bucket_expr() -> ast.Expr:
    ...
    The mantissa expression repeats the decade rather than referencing its alias so InsightsQL
    resolution never depends on sibling aliases; Datastore collapses the common subexpression.
