...
class GoogleWebfontsSource(SimpleSource[GoogleWebfontsSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter a Google API key to pull the Google Fonts catalog into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/google-webfonts",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
