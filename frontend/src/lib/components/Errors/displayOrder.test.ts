...
describe('isStoredCrashFirst', () => {
    it.each([
        ['insights-go', '2026-07-01T00:00:00Z', true],
        ['insights-go', '2026-07-15T00:00:00Z', false],
        // events after the deploy moment on rollout day are stored canonical
        ['insights-go', '2026-07-09T20:00:00Z', false],
        ['insights-go', '2026-07-09T12:00:00Z', true],
        // API timestamp forms that do not sort lexically against the cutoff
        ['insights-go', '2026-07-09T16:10:00.500000+00:00', false],
        ['insights-go', '2026-07-09T12:00:00.123456+00:00', true],
        ['insights-go', 'not-a-date', false],
        ['insights-python', '2026-07-01T00:00:00Z', false], // python frames were always bottom-up
        ['web', '2026-07-01T00:00:00Z', false],
        [undefined, '2026-07-01T00:00:00Z', false],
        ['insights-android', undefined, false],
