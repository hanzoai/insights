...
/**
 * Per-priority color, mirroring `PRIORITY_TAG_TYPE`'s Tag semantics but as raw CSS vars
 ...
 * and a tight radius. Built bespoke since no Tag variant gives this filled-square look.
