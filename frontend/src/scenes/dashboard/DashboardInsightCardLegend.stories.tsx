...
const meta: Meta = {
    ...
    decorators: [
        mswDecorator({
            get: {
                '/v1/environments/:team_id/dashboards/1/': require('./__mocks__/dashboard_insight_card_legend_query.json'),
                '/v1/environments/:team_id/dashboards/2/': require('./__mocks__/dashboard_insight_card_legend_legacy.json'),
            },
        }),
    ],
    parameters: {
