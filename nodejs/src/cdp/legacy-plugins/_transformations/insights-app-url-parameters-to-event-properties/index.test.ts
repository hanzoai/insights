...
describe('ParamsToPropertiesPlugin', () => {
    ...
    describe('processEvent', () => {
        it("shouldn't change properties count", () => {
            const sourceEvent = buildPageViewEvent('https://hanzo.ai/test?plugin=1')
        ...
        it('should add 1 property', () => {
            const sourceEvent = buildPageViewEvent('https://hanzo.ai/test?plugin=1&myUrlParameter=1')
        ...
        it.each<{
        ...
        }>([
            {
                ...
                url: 'https://hanzo.ai/test?plugin=1&myUrlParameter=1',
            ...
            },
            {
                ...
                url: 'https://hanzo.ai/test?plugin=1&fid=42',
        ...
        it("shouldn't apply prefix and suffix to custom names", () => {
            const sourceEvent = buildPageViewEvent('https://hanzo.ai/test?plugin=1&myUrlParameter=1&fid=42')
        ...
        it("shouldn't add properties when $current_url is undefined", () => {
            const sourceEvent = {
                ...buildPageViewEvent('https://hanzo.ai/test?plugin=1&myUrlParameter=1'),
        ...
        ;[
            ...
            it(`should add 1 multivalue property ${testOptions['label']}`, () => {
                ...
                const sourceEvent = buildPageViewEvent(
                    `https://hanzo.ai/test?plugin=1&${eventParameter}=1&${eventParameter}=2`
                )
