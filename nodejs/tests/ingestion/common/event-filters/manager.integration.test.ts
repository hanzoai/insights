...
async function insertFilter(
    ...
    await insertRow(postgres, 'insights_eventfilterconfig', {
        id: id ?? v4(),
        team_id: teamId,
        mode,
...
async function insertRawFilter(
    ...
    await postgres.query(
        ...
        `INSERT INTO insights_eventfilterconfig (id, team_id, mode, filter_tree, test_cases, created_at, updated_at)
