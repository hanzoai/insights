...
import { BannerProps } from 'lib/elements/Banner/Banner'
...
// (label + docs) and PRODUCT_PUSH_DISPLAY (script illustration), mirroring the welcome dialog's showcase.
...
export function ProvisionedWelcomeMessage(): JSX.Element {
    return (
        <div className="flex flex-col gap-1">
            <span>
                <b>Welcome to Insights!</b> We're setting up Insights in your repo in the background. In the meantime,
            ...
            (
                ...
                switch (variant) {
                    ...
                    case 'internet_connection_issue':
                        return {
                            message:
                                'Insights is having trouble connecting to the server. Please check your connection.',
                            type: 'warning',
                            action: {
