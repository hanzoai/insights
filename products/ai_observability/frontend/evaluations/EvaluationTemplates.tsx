...
function getTemplateTypeTag(evaluationType: EvaluationTemplate['evaluation_type']): {
    ...
    switch (evaluationType) {
        case 'script':
            return { label: 'Script', type: 'option' }
        case 'sentiment':
...
function StartWithAiRow(): JSX.Element {
    ...
    const handleClick = (): void => {
        insights.capture('llm evaluation template selected', { template_key: 'start_with_ai' })
        openAi(
    ...
    return (
        <PickerRow
            ...
            description="Let Insights AI explore your traces and build an evaluation for you"
                ...
                <div className="space-y-8">
                    <div className="text-center space-y-3">
                        <div className="flex justify-center mb-4">
                            <MascotJudge className="w-32 h-32" />
                        </div>
...
export function EvaluationTemplatesEmptyState(): JSX.Element {
    return (
        <TemplatePicker
            ...
            description="Select a pre-configured template to get started quickly, or create your own from scratch."
            showBackButton={false}
            learnMoreUrl="https://hanzo.ai/docs/ai-evals/evaluations"
            minHeight="60vh"
        />
    )
}
