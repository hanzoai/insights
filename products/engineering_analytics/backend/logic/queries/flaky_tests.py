"""InsightsQL aggregation of per-test CI run evidence into the active test-health queue.
...
Reads the ``insights.trace_spans`` table on the LOGS Datastore cluster, not the warehouse.
"""
...
def query_flaky_tests(
    *,
    ...
    response = curated.run(
        ...
        # trace_spans lives on the LOGS Datastore cluster, not the warehouse default.
