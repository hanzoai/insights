...
from products.review.backend.reviewer.constants import DEFAULT_REVIEW_ARM, REVIEW_MODEL
...
class TestTrackReviewCompleted(BaseTest):
    def _review_report(self) -> str:
        ...
        with patch("products.review.backend.reviewer.persistence.draw_review_arm", return_value=DEFAULT_REVIEW_ARM):
    ...
    def test_captures_the_turn_with_review_scoped_properties(self, published: bool) -> None:
        ...
        with patch("products.review.backend.temporal.activities.hanzo_insights.capture") as capture:
    ...
    def test_capture_failure_is_swallowed(self) -> None:
        ...
        with patch(
            "products.review.backend.temporal.activities.hanzo_insights.capture",
