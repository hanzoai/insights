...
Django-free so the InsightsQL engine and the materialized-columns layer can import them without
booting Django; insights.models.property re-exports them for existing callers.
"""
