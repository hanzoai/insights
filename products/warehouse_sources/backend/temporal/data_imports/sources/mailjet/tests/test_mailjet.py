...
WEBHOOK_URL = "https://webhooks.us.hanzo.ai/public/webhooks/dwh/script-fn-1"
...
class TestWebhookCallbackUrl:
    def test_credentials_round_trip(self) -> None:
        ...
        assert authed.startswith("https://insights:p@ss@webhooks.us.hanzo.ai/")
    ...
    def test_expected_header_matches_the_registered_credentials(self) -> None:
        ...
        assert base64.b64decode(header.removeprefix("Basic ")).decode() == "insights:p@ss"
...
class TestCreateWebhook:
    ...
    def test_registers_every_event_type_with_authenticated_url(self, mock_session) -> None:
        ...
        password = registered_url.split("insights:", 1)[1].rsplit("@", 1)[0]
