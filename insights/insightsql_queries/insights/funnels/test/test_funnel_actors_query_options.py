...
from insights.insightsql_queries.insights.insight_actors_query_options_runner import InsightActorsQueryOptionsRunner
...
class TestFunnelActorsQueryOptions(DatastoreTestMixin, APIBaseTest):
    maxDiff = None
