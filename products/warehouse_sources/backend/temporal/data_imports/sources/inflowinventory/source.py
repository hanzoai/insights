...
class InflowinventorySource(ResumableSource[InflowinventorySourceConfig, InflowInventoryResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your inFlow Inventory company ID and API key to pull your inventory and order data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/inflowinventory",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
