...
from insights.queries.base import handle_compare
from insights.queries.insight import insight_sync_execute
from insights.queries.trends.breakdown import TrendsBreakdown
from insights.queries.trends.lifecycle import Lifecycle
from insights.queries.trends.total_volume import TrendsTotalVolume
...
class Trends(TrendsTotalVolume, Lifecycle):
    ...
    def _run_query(self, filter: Filter, team: Team, entity: Entity) -> list[dict[str, Any]]:
        ...
        with hanzo_insights.new_context():
            ...
            hanzo_insights.tag("filter", filter.to_dict())
            hanzo_insights.tag("team_id", str(team.pk))
            query_params = {**params, **adjusted_filter.insightsql_context.values}
            hanzo_insights.tag("query", {"sql": sql, "params": query_params})
    ...
    def _run_query_for_threading(
        ...
        with hanzo_insights.new_context():
            hanzo_insights.tag("query", {"sql": sql, "params": params})
