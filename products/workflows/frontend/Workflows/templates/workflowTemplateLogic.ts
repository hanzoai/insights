...
export type workflowTemplateLogicType = MakeLogicType<
    workflowTemplateLogicValues,
    workflowTemplateLogicActions,
    WorkflowTemplateLogicProps,
    workflowTemplateLogicMeta
>
