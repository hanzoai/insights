...
from insights.email import is_email_available, is_http_email_service_available
from insights.helpers.email_utils import ESPSuppressionReason, check_esp_suppression
from insights.models.user import User
from insights.models.webauthn_credential import WebauthnCredential
from insights.settings.web import AUTHENTICATION_BACKENDS
...
class EmailMFAVerifier:
    ...
    def should_send_email_mfa_verification(self, user: User) -> EmailMFACheckResult:
        ...
        try:
            ...
            feature_enabled = hanzo_insights.feature_enabled(
                "email-mfa",
    ...
    def create_token_and_send_email_mfa_verification(self, request: HttpRequest, user: User) -> bool:
        from insights.tasks import email
