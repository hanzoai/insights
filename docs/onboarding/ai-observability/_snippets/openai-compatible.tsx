                ...
                <>
                    <CalloutBox type="info" icon="IconInfo" title="Full working examples">
                        <Markdown>
                            {dedent`
                                See the complete
                                [Node.js](https://github.com/Insights/insights-js/tree/main/examples/example-ai-${config.slug}) and
                                [Python](https://github.com/Insights/insights-python/tree/master/examples/example-ai-${config.slug})
                                examples on GitHub.
                            `}
                        </Markdown>
                    </CalloutBox>
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        {dedent`
                            Create a Insights client, then swap in Insights's OpenAI wrapper, pointed at ${config.label}.
                        `}
                    </Markdown>
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        {dedent`
                            When you use the wrapped client to call ${config.label}, Insights automatically captures
