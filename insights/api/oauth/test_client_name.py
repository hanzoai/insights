...
from insights.api.oauth.client_name import CLIENT_NAME_MAX_LENGTH, sanitize_client_name, validate_client_name
...
class TestValidateClientName(TestCase):
    @parameterized.expand(
        [
            ("prefix_insights", "Insights Client"),
            ("prefix_insights_lowercase", "insights-integration"),
    ...
    @parameterized.expand(
        [
            ("contains_but_not_prefixed_by_insights", "Claude Code (insights-local)"),
