...
// Wildcard request: a single "All Insights data" row where Read expands to every grantable
...
// A long optional list (every scope the Insights MCP server supports) — the case the bulk
// actions exist for.
