...
class StiggSource(ResumableSource[StiggSourceConfig, StiggResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Stigg server API key to pull your pricing, packaging, and monetization data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/stigg",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
