...
describe('Script Executor', () => {
    ...
    let executor: ScriptExecutorService
    let hub: Hub
    ...
    beforeEach(async () => {
        ...
        hub = await createHub()
        executor = new ScriptExecutorService(hub)
    })
    ...
    describe('mappings', () => {
        ...
        it('can build mappings', async () => {
            const pageviewGlobals = createScriptExecutionGlobals({
                event: {
                    event: '$pageview',
                    properties: {
                        $current_url: 'https://hanzo.ai',
    ...
    describe('executeFetch', () => {
        ...
        it('replaces access token placeholders in body, headers, and url', async () => {
            ...
            jest.spyOn(executor['scriptInputsService'], 'loadIntegrationInputs').mockResolvedValue(mockIntegrationInputs)
