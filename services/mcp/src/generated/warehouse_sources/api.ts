 ...
 *
 * Insights API - MCP 26 enabled ops
...
export const ExternalDataSourcesCreateBody = /* @__PURE__ */ zod.object({
    ...
    prefix: zod.string().max(externalDataSourcesCreateBodyPrefixMax).nullish().describe('Table name prefix in InsightsQL.'),
    description: zod
        .string()
...
export const ExternalDataSourcesSetupCreateBody = /* @__PURE__ */ zod.object({
    ...
    prefix: zod
        ...
        .nullish()
        .describe("Table name prefix in InsightsQL, e.g. 'stripe' produces stripe_charges. Defaults to the source type."),
    description: zod
        .string()
