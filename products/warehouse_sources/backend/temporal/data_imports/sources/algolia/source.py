...
class AlgoliaSource(ResumableSource[AlgoliaSourceConfig, AlgoliaResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Algolia Application ID and an API key to pull your Algolia data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/algolia",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
