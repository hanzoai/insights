...
class TestSlackImageOutbound(SimpleTestCase):
    ...
    def test_post_reply_to_slack_uploads_rich_images(
            ...
            "content": [
                {
                    ...
                    "content": [
                        ...
                        {"type": "image", "attrs": {"src": "https://app.hanzo.ai/uploaded_media/a", "alt": "a.png"}},
                    ],
                }
            ],
        }
        ...
        post_reply_to_slack(
            ticket_id="ticket-1",
            team_id=1,
            content="Hello\n\n![a.png](https://app.hanzo.ai/uploaded_media/a)",
    ...
    def test_post_reply_to_slack_continues_when_image_upload_fails(
        ...
        rich_content = {
            ...
            "content": [
                {
                    "type": "paragraph",
                    "content": [{"type": "image", "attrs": {"src": "https://app.hanzo.ai/uploaded_media/a"}}],
                }
            ],
        }
