...
from insights.models.activity_logging.activity_log import Change, Detail, LogActivityEntry, Trigger, bulk_log_activity
...
def _flags_referencing_cohort(cohort: Cohort) -> list[FeatureFlag]:
    ...
    not). Mirrors the used_in/deletion-protection lookup in ``insights/api/cohort.py``,
