...
class CallRailSource(ResumableSource[CallRailSourceConfig, CallRailResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your CallRail API key to automatically pull your CallRail call-tracking data into the Insights Data warehouse.
...
Leave **Account ID** blank to use the first account your key can access, or set it to sync a specific account.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/callrail",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
