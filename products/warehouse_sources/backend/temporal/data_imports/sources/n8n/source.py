...
class N8nSource(ResumableSource[N8nSourceConfig, N8nResumeConfig], ValidateDatabaseHostMixin):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="n8n",
            caption="""Connect your n8n instance to pull your workflow automation data into the Insights Data warehouse.
...
Some tables (users, projects, variables) require an owner/admin key or an Enterprise plan; deselect them if your key can't access them.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/n8n",
    ...
    def validate_credentials(
        self, config: N8nSourceConfig, team_id: int, schema_name: Optional[str] = None, api_version: str | None = None
    ) -> tuple[bool, str | None]:
        try:
