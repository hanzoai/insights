...
describe('ThreadView connection state', () => {
    ...
    // A folded _insights/error frame renders inline through ThreadRow's RunAlertActivity swap (agent_error kind).
    it('renders an inline agent-error card for a _insights/error frame', async () => {
        logic.actions.ingestAcpFrame(notification('_insights/error', { message: 'boom' }), 'replay')
