...
from insights.models.team.production_event_activation import RECHECK_BACKOFF
...
# candidate filter and Datastore's `now()` both use it, so freezing time here
...
class TestDetectFirstTeamProductionEventJob(DatastoreTestMixin, BaseTest):
    def test_no_unflagged_teams_skips_evaluation(self) -> None:
        ...
        with patch("insights.models.team.production_event_activation._teams_meeting_criterion") as mock_criterion:
