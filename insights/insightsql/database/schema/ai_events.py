from insights.insightsql.database.lazy_join_tags import PERSON_DISTINCT_IDS
...
class AiEventsTable(Table):
    ...
    fields: dict[str, FieldOrTable] = {
        ...
        "_timestamp": DateTimeDatabaseField(
            ...
            hidden=True,
            description="When this row was written to Datastore (Kafka consumer processing time, UTC). "
        ...
        # Heavy columns (JSON strings — use StringJSONDatabaseField so InsightsQL
