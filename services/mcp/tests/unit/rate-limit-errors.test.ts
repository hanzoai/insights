...
import { handleToolError, parseRetryAfterSeconds, InsightsApiError, InsightsRateLimitError } from '@/lib/errors'
...
describe('outbound 429 handling', () => {
    ...
    describe('InsightsRateLimitError', () => {
    ...
    describe('ApiClient on 429', () => {
        ...
        const expectRateLimitFailure = (result: Result<unknown>): InsightsRateLimitError => {
            ...
            expect(result.error).toBeInstanceOf(InsightsRateLimitError)
            return result.error as InsightsRateLimitError
        }
        ...
        it('returns InsightsRateLimitError after exhausting retries', async () => {
    ...
    describe('handleToolError on InsightsRateLimitError', () => {
