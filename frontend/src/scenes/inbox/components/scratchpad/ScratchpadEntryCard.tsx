...
const KIND_TAG_TYPE: Record<string, TagType> = {
    pattern: 'highlight',
    dedupe: 'muted',
    noise: 'muted',
    baseline: 'success',
    ...
    return (
        <div className="flex flex-col rounded border border-primary bg-bg-light">
            ...
            >
                ...
                />
                {kind && (
                    <Tag type={KIND_TAG_TYPE[kind] ?? 'muted'} size="small" className="shrink-0">
                        {kind}
                    </Tag>
                )}
            ...
            <div className="px-3 pb-2 pl-9">
                ...
                {expanded && isLoadingContent && <Skeleton className="h-4 w-2/3 mt-1" />}
