...
class FileSystem(models.Model):
    ...
    class Meta:
        indexes = [
            ...
            models.Index(F("team_id"), F("surface"), F("path"), name="insights_fs_team_s_path"),
            models.Index(F("team_id"), F("surface"), F("depth"), name="insights_fs_team_s_depth"),
            models.Index(F("team_id"), F("surface"), F("type"), F("ref"), name="insights_fs_team_s_typeref"),
        ]
