from posthog.insightsql.ast import ArrayType, BooleanType, DateTimeType, DateType, DecimalType, IntegerType, StringType
...
INSIGHTSQL_POSTCUSTOM_FUNCTIONS: dict[str, InsightsQLFunctionMeta] = {
    ...
    # posthog/models/channel_type/sql.py and posthog/insightsql/database/schema/channel_type.py
