    ...
    return (
        <div className="flex flex-col gap-6 min-w-0">
            <div className="flex flex-col gap-1">
                ...
                <p className="mb-0 text-secondary">Control access for your team members and Insights agents.</p>
            </div>
                ...
                <div className="border rounded divide-y overflow-hidden">
                    {serviceAccountsLoading ? (
                        ...
                        <div className="p-4 text-sm text-secondary">
                            No Insights agents are available for this project.
                        </div>
                    ) : (
            ...
            <div className="flex flex-col gap-2">
                ...
                <Table
                    ...
                    columns={[
                        ...
                        },
                        {
                            ...
                            key: 'role',
                            render: (_, member) => (
                                <Tag type={member.is_org_admin ? 'highlight' : 'muted'}>
                ...
                {filteredMembers.length > MEMBER_PREVIEW_LIMIT && (
                    <Button size="small" type="tertiary" fullWidth onClick={toggleMembersExpanded}>
