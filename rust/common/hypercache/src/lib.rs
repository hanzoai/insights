...
pub const HYPERCACHE_COUNTER_NAME: &str = "insights_hypercache_get_from_cache";
...
pub const HYPERCACHE_REDIS_OP_MS: &str = "insights_hypercache_redis_op_ms";

/// Per-tier latency histogram for the S3 read inside `get_typed_with_source`.
/// Labels: `namespace`, `value`, `outcome` (hit | miss | timeout | error).
pub const HYPERCACHE_S3_OP_MS: &str = "insights_hypercache_s3_op_ms";
