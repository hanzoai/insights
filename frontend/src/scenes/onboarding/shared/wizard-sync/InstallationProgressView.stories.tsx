...
const SAMPLE_REPORT = [
    '# Insights setup report',
    '',
    'Installed `insights-js` and wired up event capture in `app/providers.tsx`.',
    '',
    ...
    args: {
        progress: progress({
            ...
            steps: [
                ...
                { id: 'b', label: 'Installed the Insights SDK', status: 'completed', detail: null },
    ...
    args: {
        progress: progress({
            ...
            steps: [
                ...
                { id: 'setup:wizard', label: 'Ran Insights setup wizard', status: 'completed', detail: null },
...
export const FailedWizard: Story = {
    args: {
        progress: progress({
            ...
            error: { title: 'Installation failed', detail: 'Insights setup wizard failed with exit code 1.' },
        }),
    },
}
