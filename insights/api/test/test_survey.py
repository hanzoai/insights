...
from insights.api.survey import nh3_clean_with_allow_list
from insights.api.test.test_personal_api_keys import PersonalAPIKeysBaseTest
from insights.constants import AvailableFeature
from insights.models import Action, FeatureFlag, Person, Team
from insights.models.cohort.cohort import Cohort
from insights.models.organization import Organization
from insights.models.surveys.survey import MAX_ITERATION_COUNT, Survey, surveys_hypercache
...
class TestSurvey(APIBaseTest):
    ...
    @patch("insights.api.survey.report_user_action")
    @freeze_time("2023-05-01 12:00:00")
