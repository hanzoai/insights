        ...
        <>
            <Markdown>
                {dedent`
                    ...
                    | [[...]](https://hanzo.ai/docs/ai-observability/generations#event-properties) | See [full list](https://hanzo.ai/docs/ai-observability/generations#event-properties) of properties|
                `}
            </Markdown>
        </>
    )
