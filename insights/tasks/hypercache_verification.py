...
from insights.storage.hypercache_verifier import _run_verification_for_cache
...
def _run_flag_definitions_verification() -> None:
    ...
    """
    lock_key = f"insights:hypercache_verification:{FLAG_DEFINITIONS_CACHE_TYPE}:lock"
...
def verify_and_fix_flag_definitions_cache_task(self: PushGatewayTask) -> None:
    ...
    Metrics: insights_hypercache_verify_fixes_total{cache_type="flag_definitions", issue_type="..."}
    """
