...
from insights.temporal.session_replay.session_summary.activities.video_based.a5_cleanup_gemini_file import (
...
async def test_deletes_file_via_gemini_client_and_clears_tracking(gemini_redis):
    ...
    with patch(
        "insights.temporal.session_replay.session_summary.activities.video_based.a5_cleanup_gemini_file.RawGenAIClient",
