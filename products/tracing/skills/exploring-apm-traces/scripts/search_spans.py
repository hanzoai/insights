...
insights:apm-attributes-list and insights:apm-attribute-values-list, then re-issue
insights:query-apm-spans with a filterGroup of type 'span_attribute' or
...
if hits == 0:
    ...
    print("in each span's `attributes` map — or filter the dataset via insights:query-apm-spans filterGroup.")
