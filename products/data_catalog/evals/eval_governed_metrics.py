...
To run a single case::
    ...
    flox activate -- bash -c "insightscli evals eval_governed_metrics --eval governed_metric_approved"
"""
...
async def eval_governed_metrics(ctx: EvalContext) -> None:
    ...
    cases: list[SandboxedEvalCase] = [
        ...
        SandboxedEvalCase(
            name="metric_listing",
            prompt="What are the metrics that I have available in Insights?",
            expected={
                "metrics_catalog_queried": {},
                "governed_behavior_correctness": {
                    "expected_behavior": (
