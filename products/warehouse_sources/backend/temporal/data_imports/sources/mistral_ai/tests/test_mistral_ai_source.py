...
class TestSourceConfig:
    ...
    def test_alpha_and_docs_url(self) -> None:
        ...
        # docsUrl filename must match the hanzo.ai doc (kebab-case) for the source page to resolve.
        assert config.docsUrl == "https://hanzo.ai/docs/cdp/sources/mistral-ai"
...
class TestGetSchemas:
    ...
    def test_documented_tables_render_without_credentials(self) -> None:
        # lists_tables_without_credentials must stay True so hanzo.ai renders the Supported tables section.
