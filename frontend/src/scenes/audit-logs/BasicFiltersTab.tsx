                    ...
                    <div className="flex gap-4 flex-start flex-wrap pt-2">
                        <div className="flex flex-col gap-1">
                            <div className="flex items-center gap-1 mb-1">
                                ...
                                <Tooltip title="During support, Insights team members may act as a specific user to help troubleshoot issues. These impersonated actions are logged and can be filtered here.">
                        ...
                        <div className="flex flex-col gap-1">
                            <div className="flex items-center gap-1 mb-1">
                                ...
                                <Tooltip title="Activities performed automatically by Insights's system, such as scheduled tasks, background processes, or automated workflows.">
                                    <IconInfo className="w-4 h-4 text-muted-alt cursor-help" />
                                </Tooltip>
                            </div>
                            <Select
