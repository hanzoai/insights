        ...
        <SceneSection
            title={
                isDirectQuerySource
                    ...
                    : "You're all set! We'll import the data in the background, and after it's done, you will be able to query it in Insights."
            }
            actions={
                !isWrapped && (
                    <Button type="primary" onClick={closeWizard} data-attr="sync-progress-return">
                        {nextButtonText}
                    </Button>
                )
            }
