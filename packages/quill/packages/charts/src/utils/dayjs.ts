// Self-contained dayjs setup for script-charts. Registers only the plugins this library
// needs so it can move into a standalone UI package without depending on Insights's
// `lib/dayjs`. The wider Insights app also extends dayjs, but `dayjs.extend` is
