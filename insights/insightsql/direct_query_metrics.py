...
latency and failure modes are independent of Datastore. These low-cardinality
...
DirectQueryDialect = Literal["postgres", "mysql", "snowflake", "redshift", "datastore"]
DirectQueryStatus = Literal["success", "error"]

DIRECT_QUERY_TOTAL = PromCounter(
    "insightsql_direct_query_total",
...
DIRECT_QUERY_DURATION_SECONDS = Histogram(
    "insightsql_direct_query_duration_seconds",
