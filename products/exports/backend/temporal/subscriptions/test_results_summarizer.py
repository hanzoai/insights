...
@parameterized_class(
    ...
    [
        ...
        (
            "insightsql_list_rows_do_not_crash",
            "InsightsQLQuery",
            [
        ...
        (
            "insightsql_tuple_rows_do_not_crash",
            "InsightsQLQuery",
            [("a", 1), ("b", 2)],
...
class TestBuildResultsSummaryColumns:
    """Column labels from the InsightsQL result payload are used to label list-shaped rows."""
    ...
    def test_named_columns_are_used_for_list_rows(self):
        ...
        summary = build_results_summary("InsightsQLQuery", results, columns=columns)
    ...
    def test_missing_columns_fall_back_to_positional(self):
        results = [["a", "b"]]
        summary = build_results_summary("InsightsQLQuery", results, columns=None)
...
class TestBuildResultsSummaryUnexpectedShape:
    ...
    def test_unexpected_shape_emits_log(self):
        with structlog.testing.capture_logs() as captured_logs:
            summary = build_results_summary("InsightsQLQuery", ["a bare string", 42])
