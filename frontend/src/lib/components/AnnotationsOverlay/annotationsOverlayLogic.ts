                        ...
                        .map((dateStr, index) => {
                            ...
                            if (dateInTimezone >= dateRange[0] && dateInTimezone < dateRange[1]) {
                                return {
                                    ...
                                    content:
                                        'Some user properties may have been set incorrectly on events between January 6, 20:01 UTC and January 7, 14:52 UTC. See https://status.posthog.com/ for more information.',
