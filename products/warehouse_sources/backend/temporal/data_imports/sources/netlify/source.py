...
class NetlifySource(ResumableSource[NetlifySourceConfig, NetlifyResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Netlify personal access token to sync your Netlify data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/netlify",
