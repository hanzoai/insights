...
export const defaultEvaluationContextsLogic = kea<defaultEvaluationContextsLogicType>([
        ...
        defaultEvaluationContexts: [
            null as DefaultEvaluationContextsResponse | null,
            {
                loadDefaultEvaluationContexts: async () => {
                    ...
                    const response = await api.get(`/v1/environments/${teamId}/default_evaluation_contexts/`)
                ...
                addContext: async ({ contextName }) => {
                    ...
                    try {
                        const response = await api.create(`/v1/environments/${teamId}/default_evaluation_contexts/`, {
                        ...
                        toast.error(error.error || error.detail || 'Failed to add context')
                        throw error
                    }
                },
                ...
                removeContext: async ({ contextName }) => {
                    ...
                    try {
                        await api.delete(
                            `/v1/environments/${teamId}/default_evaluation_contexts/?context_name=${encodeURIComponent(contextName)}`
                        )
                        ...
                        toast.error(error.error || error.detail || 'Failed to remove context')
                        throw error
                    }
                },
                ...
                hideContext: async ({ contextName }) => {
                    ...
                    try {
                        await api.create(`/v1/environments/${teamId}/evaluation_context_suggestions/`, {
                            context_name: contextName,
                        })
                        ...
                        toast.error(error.error || error.detail || 'Failed to hide suggestion')
                        throw error
                    }
                },
                ...
                unhideContext: async ({ contextName }) => {
                    ...
                    try {
                        await api.delete(
                            `/v1/environments/${teamId}/evaluation_context_suggestions/?context_name=${encodeURIComponent(contextName)}`
                        )
                        ...
                        toast.error(error.error || error.detail || 'Failed to restore suggestion')
                        throw error
                    }
                },
            },
    ...
    listeners(({ actions }) => ({
        ...
        addContextSuccess: () => {
            toast.success('Context added to default evaluation contexts')
        },

        removeContextSuccess: () => {
            toast.success('Context removed from default evaluation contexts')
        },

        hideContextSuccess: () => {
            toast.success('Context hidden from suggestions')
        },

        unhideContextSuccess: () => {
            toast.success('Context restored to suggestions')
        },
    })),
