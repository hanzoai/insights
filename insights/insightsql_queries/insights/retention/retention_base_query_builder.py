...
from insights.schema import EntityType
...
from insights.insightsql_queries.insights.retention.utils import breakdown_extract_expr

if TYPE_CHECKING:
    from insights.schema import RetentionEntity, RetentionQuery
