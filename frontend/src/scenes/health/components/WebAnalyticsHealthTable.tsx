...
const CHECK_META: Record<string, CheckMeta> = {
    no_live_events: {
        title: '$pageview',
        description: 'No pageview events detected recently. Complete the Insights installation to start seeing events.',
    ...
    scroll_depth: {
        ...
        docsUrl: 'https://hanzo.ai/tutorials/scroll-depth',
    },
    authorized_urls: {
...
export function WebAnalyticsHealthTable({
    ...
    const columns: TableColumns<HealthIssue> = [
        {
            title: 'Check',
            key: 'check',
    ...
    return <Table dataSource={issues} columns={columns} embedded size="small" rowClassName="group" />
}
