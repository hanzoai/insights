...
Intent mirrors ``ee/scriptai/eval/ci/eval_funnel.py`` — the CI version asserts
...
To run:
    flox activate -- bash -c "set -a; source .env; set +a; python -m products.insights_ai.eval_harness.harness eval_funnel"
"""
...
from products.insights_ai.eval_harness.scorers import LastToolCallNot, NoToolCall, RequiredToolCall
        ...
        _funnel_case(
            ...
            query=AssistantFunnelsQuery(
                ...
                funnelsFilter=AssistantFunnelsFilter(
                    binCount=None,
                    exclusions=[],
                    funnelAggregateByInsightsQL="properties.$session_id",
