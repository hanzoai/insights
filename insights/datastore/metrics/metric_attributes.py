...
from insights.datastore.table_engines import AggregatingMergeTree, ReplicationScheme

TABLE_NAME = "metric_attributes"


def METRIC_ATTRIBUTES_TABLE_SQL():
    return f"""
...
ENGINE = {AggregatingMergeTree("metric_attributes", replication_scheme=ReplicationScheme.REPLICATED)}
