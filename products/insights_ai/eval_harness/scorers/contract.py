"""The Insights-owned scorer contract.
...
A later flip replaces these with pure Insights classes carrying the same surface
...
class Scorer(_UpstreamScorer):
    """Insights's scorer base. An empty subclass of braintrust's base for now."""
