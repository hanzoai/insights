...
import type { EmailTemplate } from '../../../../frontend/src/scenes/insights-functions/email-templater/types'
...
export interface messageTemplateLogicActions {
    ...
    loadMessageSuccess: (message: InsightsFunctionType | null, payload?: any) => {
