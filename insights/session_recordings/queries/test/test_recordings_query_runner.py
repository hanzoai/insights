...
from insights.schema import RecordingsQuery, SessionRecordingType, SnapshotSource
...
class TestRecordingsQueryRunner(DatastoreTestMixin, APIBaseTest):
    def setUp(self):
        super().setUp()
    ...
    def test_result_field_mapping(self):
        self._produce_replay("session-1", first_url="https://hanzo.ai")
        ...
        assert recording.start_url == "https://hanzo.ai"
    ...
    def test_generates_valid_insightsql(self):
        self._produce_replay("session-1")
