...
from insights.api.insight import InsightSerializer
...
from insights.models.subscription import Subscription
...
from insights.tasks.exports import image_exporter
from insights.tasks.exports.failure_handler import (
    FAILURE_TYPE_SYSTEM,
    FAILURE_TYPE_TIMEOUT_GENERATION,
    FAILURE_TYPE_USER,
)
from insights.tasks.exports.image_exporter import export_image
...
class TestExports(APIBaseTest):
    ...
    def test_swallow_missing_schema_and_allow_front_end_to_poll(self, mock_exporter_task) -> None:
        # regression test see https://github.com/hanzoai/insights/issues/11204
    ...
    @patch("insights.tasks.exports.image_exporter._export_to_png")
    @patch("insights.api.exports.exporter")
    ...
    def test_can_create_new_valid_export_insight(self, mock_exporter_task, mock_export_to_png) -> None:
        ...
        with patch("insights.tasks.exports.image_exporter.calculate_for_query_based_insight") as mock_calculate:
    ...
    @patch("insights.tasks.exports.csv_exporter.requests.request")
    ...
    @patch("insights.api.exports.async_to_sync")
    @patch("insights.api.exports.async_connect")
    @patch("insights.api.exports.exporter")
    ...
    @patch("insights.tasks.exports.image_exporter.export_image")
...
class TestExportAssetCounters(APIBaseTest):
    ...
    def test_export_counter_behavior(
        ...
        with (
            patch("insights.tasks.exports.image_exporter.export_image", side_effect=error),
