...
from insights.insightsql_queries.insights.utils.aggregations import FirstTimeForUserDataWarehouseConfig
from insights.insightsql_queries.insights.utils.breakdowns import NOT_IN_COHORT_ID, strip_user_aliases
from insights.insightsql_queries.insights.utils.data_warehouse_schema_mixin import DataWarehouseSchemaMixin
from insights.insightsql_queries.insights.utils.properties import Properties
from insights.insightsql_queries.utils.query_date_range import QueryDateRange
from insights.models.property.property import PropertyName
...
class FunnelEventQuery(DataWarehouseSchemaMixin):
    ...
    def _get_breakdown_expr(self) -> ast.Expr:
        ...
        elif breakdownType == "insightsql" or breakdownType == "event_metadata":
    ...
    def _aggregation_target_expr(self) -> ast.Expr:
        ...
        # Aggregating by InsightsQL
        elif funnelsFilter.funnelAggregateByInsightsQL and funnelsFilter.funnelAggregateByInsightsQL != "person_id":
            tag_contains_user_insightsql()
            aggregation_target = parse_expr(funnelsFilter.funnelAggregateByInsightsQL)
    ...
    def _aggregation_target_filter(self) -> ast.Expr | None:
        ...
        # Float64 directly to '' makes Datastore try to parse '' as a number.
