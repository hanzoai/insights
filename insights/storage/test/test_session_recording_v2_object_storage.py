...
from insights.storage.session_recording_v2_object_storage import (
...
class TestSessionRecordingV2Storage(APIBaseTest):
    ...
    @patch("insights.storage.session_recording_v2_object_storage.boto3_client")
    def test_client_constructor_uses_correct_settings(self, patched_boto3_client) -> None:
        ...
        import insights.storage.session_recording_v2_object_storage as storage_module
...
class TestAsyncSessionRecordingV2Storage(APIBaseTest):
    ...
    @patch("insights.storage.session_recording_v2_object_storage.aioboto3")
