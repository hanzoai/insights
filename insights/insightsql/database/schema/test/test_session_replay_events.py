...
@freeze_time("2021-01-01T13:46:23")
class TestSelectAggregatedArrayColumns(DatastoreTestMixin, APIBaseTest):
    """Regression coverage for `groupUniqArrayArray` columns on the session_replay_events lazy table.

    Before the InsightsQL registry knew about `groupUniqArrayArray`, selecting any of these three
