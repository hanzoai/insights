...
class Migration(migrations.Migration):
    ...
    operations = [
        # insights_conversations_ticket is an existing, populated table, so the partial unique
        ...
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                CreateIndexConcurrently(
                    index_name="insights_con_zendesk_ticket_uniq",
                    table_name="insights_conversations_ticket",
