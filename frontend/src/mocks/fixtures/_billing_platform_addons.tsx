...
const scim = feature('scim', 'SCIM', 'Automatically sync users and roles from your identity provider to Insights.')
...
const invoicePayments = feature(
    ...
    'Pay for your Insights subscription via invoice.'
)
...
const makePlatformAddon = (type: AddonType): BillingProductV2AddonType => {
    ...
    const plan: BillingPlanType = {
        ...
        image_url: null,
        docs_url: spec.legacy ? 'https://hanzo.ai/pricing' : 'https://hanzo.ai/platform-addons',
        note: null,
        unit: 'month',
        flat_rate: true,
    ...
    return {
        ...
        docs_url: plan.docs_url ?? 'https://hanzo.ai/pricing',
        type,
        tiers: [],
        tiered: false,
