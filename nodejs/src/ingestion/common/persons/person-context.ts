...
export type PersonlessRolloutConfig = {
     ...
     * Datastore override) instead of consulting insights_personlessdistinctid.
     */
    mergeAlwaysV1: boolean
    /**
     * Stop-reading/stop-writing: merges skip the insights_personlessdistinctid upserts entirely.
