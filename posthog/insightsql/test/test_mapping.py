...
from posthog.insightsql.ast import DateType, FloatType, IntegerType, StringLiteralType, StringType
from posthog.insightsql.base import UnknownType
from posthog.insightsql.context import InsightsQLContext
from posthog.insightsql.functions.aggregations import generate_combinator_suffix_combinations
from posthog.insightsql.functions.core import InsightsQLFunctionMeta, compare_types
...
class TestMappings(ClickhouseTestMixin, BaseTest):
    ...
    def _get_insightsql_function(self, name: str) -> InsightsQLFunctionMeta:
        return self._return_present_function(find_insightsql_function(name))
