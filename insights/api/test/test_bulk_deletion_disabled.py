...
class TestBulkDeletionDisabled(APIBaseTest):
    ...
    @patch("insights.api.team.settings.DISABLE_BULK_DELETES", True)
    ...
    @patch("insights.api.team.settings.DISABLE_BULK_DELETES", False)
    ...
    @patch("insights.api.project.settings.DISABLE_BULK_DELETES", True)
    ...
    @patch("insights.api.organization.settings.DISABLE_BULK_DELETES", True)
