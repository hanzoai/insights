...
from insights.kafka_client.client import _AsyncKafkaProducer, _KafkaProducer
...
from insights.settings.kafka import KafkaProfileSettings
...
_DEFAULT_TOPIC_ROUTING: dict[str, KafkaClusterProfile] = {
    ...
    KAFKA_CDP_DATASTORE_PRECALCULATED_PERSON_PROPERTIES: KafkaClusterProfile.CALCULATED_EVENTS,
    KAFKA_CDP_DATASTORE_PREFILTERED_EVENTS: KafkaClusterProfile.CALCULATED_EVENTS,
    KAFKA_COHORT_MEMBERSHIP_CHANGED: KafkaClusterProfile.CALCULATED_EVENTS,
    # --- REPLAY (Session replay) ---
    KAFKA_DATASTORE_SESSION_RECORDING_EVENTS: KafkaClusterProfile.REPLAY,
    KAFKA_DATASTORE_SESSION_REPLAY_EVENTS: KafkaClusterProfile.REPLAY,
}
