...
def _filter_existing_team_ids(team_ids: set[int]) -> set[int]:
    """Return the subset of team_ids that still exist in insights_team.
    ...
    # Inline import — insights.models.__init__ imports HealthIssue before Team,
    # so a module-level `from insights.models.team import Team` here would
