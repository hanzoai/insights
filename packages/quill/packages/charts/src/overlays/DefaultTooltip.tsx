...
export function DefaultTooltip<Meta = unknown>({
    ...
    return (
        <TooltipSurface>
            {showHeader && (
                <div data-attr="script-chart-tooltip-label" className="font-semibold mb-1 opacity-60">
                    ...
                    return (
                        ...
                        >
                            ...
                            <span className="flex-1 min-w-0 overflow-hidden grid">
                                ...
                                <span data-attr="script-chart-tooltip-series" className="truncate [grid-area:1/1]">
                                    {labelContent}
                                </span>
                            </span>
                            <strong data-attr="script-chart-tooltip-value" className="tabular-nums">
                                {format(s.value, s)}
                            </strong>
                        </div>
                    )
            ...
            {renderTotal && (
                ...
                >
                    ...
                    <strong data-attr="script-chart-tooltip-value">{formatTotal(total)}</strong>
                </div>
            )}
            {footer && (
