...
from insights.settings.data_stores import DATABASE_URL, PRODUCT_DB_WRITER_URLS
...
# Falls back to the central Hanzo KV host/port pair. Note neither is set in the
# fleet, which configures KV by URL (KV_URL), so this resolves to localhost
# unless DATA_WAREHOUSE_REDIS_HOST is given explicitly.
DATA_WAREHOUSE_REDIS_HOST: str | None = os.getenv("DATA_WAREHOUSE_REDIS_HOST", os.getenv("INSIGHTS_KV_HOST", "localhost"))
DATA_WAREHOUSE_REDIS_PORT: str | None = os.getenv("DATA_WAREHOUSE_REDIS_PORT", os.getenv("INSIGHTS_KV_PORT", "6379"))

DATASTORE_INSIGHTSQL_RDSPROXY_READ_HOST: str | None = os.getenv("DATASTORE_INSIGHTSQL_RDSPROXY_READ_HOST")
DATASTORE_INSIGHTSQL_RDSPROXY_READ_PORT: str | None = os.getenv("DATASTORE_INSIGHTSQL_RDSPROXY_READ_PORT")
DATASTORE_INSIGHTSQL_RDSPROXY_READ_DATABASE: str | None = os.getenv("DATASTORE_INSIGHTSQL_RDSPROXY_READ_DATABASE")
DATASTORE_INSIGHTSQL_RDSPROXY_READ_USER: str | None = os.getenv("DATASTORE_INSIGHTSQL_RDSPROXY_READ_USER")
DATASTORE_INSIGHTSQL_RDSPROXY_READ_PASSWORD: str | None = os.getenv("DATASTORE_INSIGHTSQL_RDSPROXY_READ_PASSWORD")
...
# Warehouse-pipeline and cyclotron Kafka config live in `insights/settings/kafka.py`
