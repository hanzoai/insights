...
from insights.clickhouse.query_log_archive import (
    ...
    MV_SELECT_SQL,
    QUERY_LOG_ARCHIVE_ADD_MODIFIERS_COLUMN_SQL,
...
operations = [
    ...
    run_sql_with_exceptions(
        QUERY_LOG_ARCHIVE_ADD_MODIFIERS_COLUMN_SQL(SHARDED_QUERY_LOG_ARCHIVE_TABLE),
    ...
    run_sql_with_exceptions(
        QUERY_LOG_ARCHIVE_ADD_MODIFIERS_COLUMN_SQL(SHARDED_QUERY_LOG_ARCHIVE_WRITABLE_TABLE),
        node_roles=[NodeRole.COORDINATOR, NodeRole.ENDPOINTS],
        sharded=False,
    ...
    run_sql_with_exceptions(
        QUERY_LOG_ARCHIVE_ADD_MODIFIERS_COLUMN_SQL(QUERY_LOG_ARCHIVE_DATA_TABLE),
