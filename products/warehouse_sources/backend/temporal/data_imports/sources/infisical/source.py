...
class InfisicalSource(ResumableSource[InfisicalSourceConfig, InfisicalResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Connect an Infisical machine identity to pull your organization's audit logs, projects, identities, and memberships into the Insights Data warehouse. Secret values are never synced.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/infisical",
