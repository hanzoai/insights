...
from insights.dags.tests.conftest import refresh_person_from_persons_db

# Exercises the persons DB directly (raw reads and writes against the persons writer), so it must
# run against the real persons DB rather than the personinsights fake.
...
class TestBatchCommits:
    ...
    def test_batch_commits_correct_number_of_times(self, num_persons: int, batch_size: int, expected_commits: int):
        ...
        Total: 3 commits
        """
        from insights.dags.person_property_reconciliation import process_persons_in_batches
...
class TestCompareRawUpdatesWithPersonState:
    ...
    @patch("insights.dags.person_property_reconciliation.PERSON_STATE_BATCH_SIZE", 2)
    @patch("insights.dags.person_property_reconciliation.sync_execute")
...
class TestKafkaDatastoreRoundTrip:
    ...
    def test_full_dagster_job_with_real_kafka(self, team, cluster: DatastoreCluster):
        ...
        from insights.dags.person_property_reconciliation import person_property_reconciliation_job
        from insights.kafka_client.client import _KafkaProducer
        from insights.test.persons import create_person
...
class TestReconcileSingleTeamErrorHandling:
    ...
    def test_team_failure_does_not_crash_chunk(self):
        ...
        with patch(
            "insights.dags.person_property_reconciliation.reconcile_single_team",
            ...
            from insights.dags.person_property_reconciliation import reconcile_team_chunk
...
class TestReconciliationSchedulerSensor:
    ...
    def test_sensor_no_cursor_returns_skip_reason(self):
        ...
        from insights.dags.person_property_reconciliation import person_property_reconciliation_scheduler
