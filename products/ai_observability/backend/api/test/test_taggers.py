...
def _setup_team():
    ...
    User.objects.create_and_join(org, "test-taggers@hanzo.ai", "testpassword123")
    return team
...
class TestTaggersAccessControl(APIBaseTest):
    ...
    # insights/rbac/user_access_control.py), independent of the `llm_analytics` resource
    ...
    def setUp(self) -> None:
        ...
        self.viewer_user = User.objects.create_and_join(self.organization, "tagger-viewer@hanzo.ai", "testtest")
        self.editor_user = User.objects.create_and_join(self.organization, "tagger-editor@hanzo.ai", "testtest")
        self.no_access_user = User.objects.create_and_join(self.organization, "tagger-noaccess@hanzo.ai", "testtest")
