...
import products.data_warehouse.backend.presentation.views.fix_insightsql as fix_insightsql
...
def register_routes(routers: RouterRegistry) -> None:
    ...
    routers.projects.register(r"fix_insightsql", fix_insightsql.FixInsightsQLViewSet, "project_fix_insightsql", ["team_id"])
    routers.projects.register(
