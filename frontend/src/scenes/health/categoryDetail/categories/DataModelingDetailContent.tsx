...
export default function DataModelingDetailContent({
    ...
    return (
        <div className="flex flex-col gap-4 max-w-3xl">
            <Banner type={statusSummary.isHealthy ? 'success' : 'warning'}>
            ...
            <div className="flex items-center gap-3 text-xs text-muted">
                <Link to="https://hanzo.ai/docs/data-warehouse">Documentation</Link>
                <span>&middot;</span>
                <Link to="https://hanzo.ai/support">Contact support</Link>
            </div>
        </div>
    )
}
