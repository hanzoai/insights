database "insights" {
  ...
  materialized_view "insights_document_embeddings_text_embedding_3_large_3072_mv" {
    ...
    query    = file("sql/insights_document_embeddings_text_embedding_3_large_3072_mv.sql")
  ...
  materialized_view "insights_document_embeddings_text_embedding_3_small_1536_mv" {
    ...
    query    = file("sql/insights_document_embeddings_text_embedding_3_small_1536_mv.sql")
