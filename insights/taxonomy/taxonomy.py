...
CORE_FILTER_DEFINITIONS_BY_GROUP: dict[str, dict[str, CoreFilterDefinition]] = {
    ...
    "event_properties": {
        ...
        "$mcp_error_field": {
            ...
            "description": "Field path the Insights API's validation error pointed at, with array indexes normalized to N so one failure mode groups to one value. Only set for validation failures.",
