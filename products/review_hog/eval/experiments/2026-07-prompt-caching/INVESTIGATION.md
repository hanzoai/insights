...
| V0  | No warm-up stage exists in Review's workflow — nothing runs before the per-chunk fan-out.                                                                                                                                                                                                   | this repo, `products/review_hog/backend/temporal/workflow.py`                             | The build itself.                                                                                                                                                              |
