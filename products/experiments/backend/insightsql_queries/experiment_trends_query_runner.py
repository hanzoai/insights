...
from insights.queries.trends.util import ALL_SUPPORTED_MATH_FUNCTIONS

from products.experiments.backend.insightsql_queries import CONTROL_VARIANT_KEY
from products.experiments.backend.insightsql_queries.trends_statistics_v2_continuous import (
    are_results_significant_v2_continuous,
    calculate_credible_intervals_v2_continuous,
    calculate_probabilities_v2_continuous,
)
from products.experiments.backend.insightsql_queries.trends_statistics_v2_count import (
    are_results_significant_v2_count,
    calculate_credible_intervals_v2_count,
    calculate_probabilities_v2_count,
)
from products.experiments.backend.insightsql_queries.types import ExperimentMetricType
...
class ExperimentTrendsQueryRunner(QueryRunner):
    ...
    def _get_metric_type(self) -> ExperimentMetricType:
        ...
        match self.query.count_query.series[0].math:
            case PropertyMathType.SUM | "insightsql":
