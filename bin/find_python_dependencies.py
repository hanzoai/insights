...
Usage:
    ...
    python bin/find_python_dependencies.py products.exports.backend.temporal.subscriptions --check-changes "insights/utils.py insights/unrelated_file.py"
...
def module_to_file(module: str) -> str | None:
    """
    Convert a module name (insights.utils) to its file path (insights/utils/__init__.py).
    """
    path = module.replace(".", "/")
