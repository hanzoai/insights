...
from insights.constants import FILTER_TEST_ACCOUNTS
from insights.models import Cohort, Filter, Person, Team
from insights.models.property import Property
from insights.queries.base import properties_to_Q, property_group_to_Q
...
class TestDjangoPropertiesToQ(property_to_Q_test_factory(_filter_persons, _create_person), QueryMatchingTest):  # type: ignore
    ...
    def test_broken_person_filter_never_matching(self):
        ...
        # This broken filter came from this issue: https://github.com/hanzoai/insights/issues/23213
        filter = Filter(
            data={
                "properties": {
                    "type": "OR",
