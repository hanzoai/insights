...
To run:
    ...
    flox activate -- bash -c "set -a; source .env; set +a; python -m products.insights_ai.eval_harness.harness eval_midrun_changes"
"""
...
async def eval_midrun_changes(ctx: EvalContext) -> None:
    cases: list[SandboxedEvalCase] = [
        SandboxedEvalCase(
            ...
            expected={
                "diagnosis_group": (
                    "The flag was rewritten when the experiment was ended via ship-variant — Insights "
