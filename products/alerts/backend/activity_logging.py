...
stack (insights.tasks.alerts -> numpy). The Temporal/celery alert-check paths mutate these
...
def cleanup_alert_insights_functions(sender, instance: AlertConfiguration, **kwargs) -> None:
