...
describe('FlowActionRunnerWaitUntilTimeWindow', () => {
    let action: Extract<FlowAction, { type: 'wait_until_time_window' }>
    ...
    beforeEach(() => {
        ...
        const flow = new FixtureFlowBuilder()
            ...
            .build()
        action = findActionByType(flow, 'wait_until_time_window')!
    })
