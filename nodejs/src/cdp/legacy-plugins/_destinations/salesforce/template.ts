...
export const salesforcePlugin: LegacyDestinationPlugin = {
    ...
    template: {
        ...
        icon_url: 'https://raw.githubusercontent.com/hanzoai/salesforce-plugin/main/logo.png',
        category: [],
        ...
        inputs_schema: [
            ...
            },
            {
                ...
                type: 'json',
                description:
                    '⚠️ For advanced uses only ⚠️ Allows you to map events to different SalesForce endpoints. See https://github.com/hanzoai/salesforce-plugin/blob/main/README.md for an example.',
                default: '',
                required: false,
                secret: false,
            },
            {
                ...
                type: 'json',
                description:
                    "SalesForce can be strict about field names, if your insights event property names don't match then you can map them using this. See https://github.com/hanzoai/salesforce-plugin/blob/main/README.md for an example.",
                default: '',
                required: false,
                secret: false,
            },
