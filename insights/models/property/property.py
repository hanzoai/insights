...
# Relocated to the Django-free insights.property_columns module so the InsightsQL engine can use them
# without booting Django; re-exported here for existing callers.
from insights.property_columns import PropertyName, TableColumn, TableWithProperties  # noqa: F401
...
# BehavioralPropertyType strings (e.g. InsightsQLCohortQuery._get_condition_for_property)
