...
import { escapeInsightsQLString } from '~/queries/utils'
...
// plenty and keeps the Datastore aggregation state + network payload bounded.
...
function eventsTableQuery(sessionIds: string, dateFrom: string, dateTo: string | null): InsightsQLQuery {
    return {
...
function aiEventsTableQuery(sessionIds: string): InsightsQLQuery {
    return {
        kind: NodeKind.InsightsQLQuery,
...
async function fetchSessionTitles(
    ...
    const sessionIds = batch.map((id) => escapeInsightsQLString(id)).join(',')
...
export interface llmSessionTitleLazyLoaderLogicValues {
    getSessionTitle: (sessionId: string) => string | null | undefined
    loadingSessionIds: Set<string>
    titlesBySessionId: Map<string, string | null>
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface llmSessionTitleLazyLoaderLogicActions {
    ...
    loadSessionTitlesBatchFailure: (requestedSessionIds: string[]) => {
        requestedSessionIds: string[]
    }
    loadSessionTitlesBatchSuccess: (
    ...
    markSessionIdsLoading: (sessionIds: string[]) => {
        sessionIds: string[]
    }
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface llmSessionTitleLazyLoaderLogicMeta {
...
export type llmSessionTitleLazyLoaderLogicType = MakeLogicType<
    llmSessionTitleLazyLoaderLogicValues,
    llmSessionTitleLazyLoaderLogicActions,
    Record<string, any>,
    llmSessionTitleLazyLoaderLogicMeta
>
...
export const llmSessionTitleLazyLoaderLogic = kea<llmSessionTitleLazyLoaderLogicType>([
    ...
    selectors({
        getSessionTitle: [
            ...
            (titlesBySessionId: Map<string, string | null>): ((sessionId: string) => string | null | undefined) => {
