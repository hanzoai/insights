    ...
    if (!recap) {
        return (
            <div className="flex flex-col items-center justify-center h-full gap-2 text-center px-4">
                ...
                <Button type="primary" onClick={() => goToWebAnalytics('go_to_web_analytics')}>
                    Go to web analytics
                </Button>
            </div>
        )
                    ...
                    <Reveal>
                        <div className="rounded-3xl bg-surface-primary shadow-xl p-10 min-h-[56vh] flex flex-col items-center justify-center">
                            ...
                            <p className="text-secondary mt-2">
                                Insights AI can explain what changed this week and what to look at next.
                            </p>
                            <Button
                                type="primary"
                                ...
                                icon={<IconSparkles />}
                                onClick={() => {
                                    recordCtaClicked('ask_insights_ai')
                                    openSidePanel(SidePanelTab.Max, buildRecapMaxPrompt(recap))
                                }}
                            >
                                Ask Insights AI about your week
                            </Button>
                        </div>
                    </Reveal>
                </Section>
                    ...
                    <Reveal>
                        <WhitePanel>
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-2 mt-6">
                                <Button type="secondary" icon={<IconLink />} onClick={copyRecapLink}>
                                    Copy link
                                </Button>
                                <Button type="secondary" icon={<IconSlack />} onClick={copyRecapForSlack}>
                                    Copy for Slack
                                </Button>
                                <Button type="secondary" icon={<IconAtSign />} onClick={copyRecapForEmail}>
                                    Copy for email
                                </Button>
                                <Button
                                    type="primary"
