...
class TestLLMSkillAPI(APIBaseTest):
    ...
    def test_create_stamps_category_from_name_prefix(self, _label, name, expected_category):
        ...
        # the serializer) — without the create-time stamp, a custom scout / review-script skill never
    ...
    # write scope implies read in Insights's scope check (see permissions.py), so a write-scoped
...
# insights/rbac/user_access_control.py) - same as TestSkillMarketplaceRBAC in
