...
Insights's UI primitives, components, and design tokens, bundled as one
...
@import '@hanzo/quill/tokens.css'; /* design tokens — :root + .dark CSS vars + @theme inline */
@import '@hanzo/quill/base.css'; /* one-line preflight reset (`* { @apply border-border outline-ring/50 }`) */
@import '@hanzo/quill/primitives.css'; /* BEM component styles (.quill-popover__content, .quill-menu__content, …) */
@import '@hanzo/quill/tailwind.css'; /* @source directive — tells Tailwind to scan quill's compiled JS */
```
 ...
 * your app's `node_modules/@hanzo/quill/dist`. */
...
@import '@hanzo/quill/primitives.css';
...
```css
@import '@hanzo/quill/tokens.scoped.css';
@import '@hanzo/quill/base.scoped.css';
@import '@hanzo/quill/color-system.scoped.css';
```
...
```tsx
import { Button, Combobox, Dialog, Tabs } from '@hanzo/quill'
...
`@hanzo/quill-tokens` is published independently and re-exported from
