...
import { IconRocket, IconServer } from '@hanzo/icons'
...
export const INTENT_METADATA: Record<FlagIntent, IntentMetadata> = {
    'local-eval': {
        ...
        docUrl: 'https://hanzo.ai/docs/feature-flags/local-evaluation#restriction-on-local-evaluation',
    },
    'first-page-load': {
        ...
        docUrl: 'https://hanzo.ai/docs/feature-flags/bootstrapping',
    },
}
