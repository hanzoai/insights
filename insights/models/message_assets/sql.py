...
from insights.kafka_client.topics import KAFKA_MESSAGE_ASSETS
...
# Created on both AUX (so AUX-local queries work) and DATA (so InsightsQL queries
...
ENGINE = {Distributed(data_table=MESSAGE_ASSETS_DATA_TABLE, cluster=settings.DATASTORE_AUX_CLUSTER)}
"""
)
