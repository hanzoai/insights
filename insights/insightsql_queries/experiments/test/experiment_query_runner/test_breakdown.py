...
from insights.insightsql_queries.experiments.breakdown_injector import BREAKDOWN_NULL_STRING_LABEL
...
class TestExperimentBreakdown(ExperimentQueryRunnerBaseTest):
    ...
    def test_funnel_metric_breakdown_query_builds_without_ambiguity_error(self):
        ...
        Tests that the query can be built and printed to InsightsQL without
        "Ambiguous query. Found multiple sources for field: breakdown_value_1" error.

        The error occurs during to_printed_insightsql() when the resolver tries to resolve
        ...
        # The error happens during _evaluate_experiment_query when it calls to_printed_insightsql
