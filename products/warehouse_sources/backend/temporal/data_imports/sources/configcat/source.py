...
class ConfigCatSource(SimpleSource[ConfigCatSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your ConfigCat Public API credentials to pull your feature-flag account structure into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/configcat",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
