...
from posthog.insightsql.constants import ConstantDataType
...
class AST:
    ...
    def to_insightsql(self):
        from posthog.insightsql.context import InsightsQLContext
        from posthog.insightsql.printer import print_prepared_ast

        return print_prepared_ast(
            node=self,
            context=InsightsQLContext(enable_select_queries=True, limit_top_select=False),
            dialect="insightsql",
        )
    ...
    def __str__(self):
        ...
        return f"sql({self.to_insightsql()})"
