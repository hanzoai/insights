...
Pattern lifted from
``insights/temporal/ai_observability/trace_clustering/metrics.py`` — same
...
from insights.temporal.ai_observability.metrics import ExecutionTimeRecorder, get_metric_meter
from insights.temporal.mcp_analytics.intent_clustering.constants import COORDINATOR_WORKFLOW_NAME, WORKFLOW_NAME
