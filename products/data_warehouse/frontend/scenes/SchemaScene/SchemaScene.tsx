...
function SchemaSceneContent({ sourceId, schemaId }: SchemaSceneProps): JSX.Element {
            ...
            content: (
                <div className="flex flex-col gap-2">
                    <div className="flex justify-end">
                        <Button type="secondary" size="small" to={urls.dataWarehouseSource(sourceId, 'syncs')}>
    ...
    return (
        <SceneContent>
            ...
            />
            <Tabs activeKey={activeTab} tabs={tabs} onChange={setCurrentTab} sceneInset />
        </SceneContent>
    )
}
