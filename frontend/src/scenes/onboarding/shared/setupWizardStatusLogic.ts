import { MakeLogicType, actions, afterMount, connect, getContext, kea, path, reducers, selectors } from 'kea'
...
import type { CloudRunHandle } from './wizard-sync/activeCloudRunLogic'
import {
    InstallationMode,
...
export interface setupWizardStatusLogicValues {
    ...
    discoveredRunLoading: boolean
    liveProgress: InstallationProgress | null
    liveRunHandle: SetupRunHandle | null
    setupStatus: SetupWizardStatus | null
    setupStatusLoading: boolean
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface setupWizardStatusLogicActions {
    liveProgressUpdated: (progress: InstallationProgress | null) => {
        progress: InstallationProgress | null
    }
    loadDiscoveredRun: () => any
    loadDiscoveredRunFailure: (
        error: string,
        errorObject?: any
    ) => {
        error: string
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface setupWizardStatusLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        ...
        setupStatusLoading: (discoveredRunLoading: boolean) => boolean
    }
}

export type setupWizardStatusLogicType = MakeLogicType<
    setupWizardStatusLogicValues,
    setupWizardStatusLogicActions,
    Record<string, any>,
    setupWizardStatusLogicMeta
>

/**
 * App-wide status of the onboarding wizard's setup task run (the cloud run that installs Insights
...
export const setupWizardStatusLogic = kea<setupWizardStatusLogicType>([
    ...
    selectors({
        ...
        setupStatusLoading: [
            (s) => [s.discoveredRunLoading],
            (discoveredRunLoading: boolean): boolean => discoveredRunLoading,
        ],
    }),
