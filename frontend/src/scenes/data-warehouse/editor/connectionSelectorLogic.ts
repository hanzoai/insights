...
import IconDatastore from 'public/services/datastore.png'
...
export const INSIGHTS_WAREHOUSE = '__insights_warehouse__'
...
type ConnectionEngine = 'duckdb' | 'postgres' | 'mysql' | 'snowflake' | 'redshift' | 'datastore'
                ...
                return [
                    {
                        options: [
                            {
                                value: INSIGHTS_WAREHOUSE,
                                label: 'Insights (Datastore)',
