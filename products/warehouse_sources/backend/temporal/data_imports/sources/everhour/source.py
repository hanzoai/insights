...
class EverhourSource(ResumableSource[EverhourSourceConfig, EverhourResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Everhour API key to pull your Everhour time-tracking data into the Insights Data warehouse.
...
Using the API requires a paid Everhour plan.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/everhour",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
