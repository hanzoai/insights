...
def _make_config(
    ...
    targets: str = "example.com, hanzo.ai",
...
class TestDataForSEOSource:
    ...
    def test_source_config_is_released_alpha(self) -> None:
        ...
        assert config.docsUrl == "https://hanzo.ai/docs/cdp/sources/dataforseo"
    ...
    def test_source_for_pipeline_plumbs_config(self) -> None:
        ...
        manager = MagicMock()
        config = _make_config(targets="https://www.Example.com/, hanzo.ai")
        ...
        assert kwargs["targets"] == ["example.com", "hanzo.ai"]
