...
from insights.temporal.health_checks.models import BatchResult
    ...
    try:
        with pushed_metrics_registry(f"health_check_{kind}") as registry:
            duration_gauge = Gauge(
                "insights_health_check_duration_seconds",
                "Duration per phase",
            ...
            teams_per_second_gauge = Gauge(
                "insights_health_check_teams_per_second",
            ...
            error_rate_gauge = Gauge(
                "insights_health_check_error_rate",
            ...
            last_run_gauge = Gauge(
                "insights_health_check_last_run_timestamp",
