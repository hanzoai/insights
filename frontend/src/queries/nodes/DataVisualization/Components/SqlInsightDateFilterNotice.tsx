 ...
 * Mirrors the affected shapes of ReplaceFilters in insights/insightsql/filters.py. */
export function isAffectedByDateFilterResolutionChange(source: InsightsQLQuery): boolean {
...
export function SqlInsightDateFilterNotice({ source }: { source: InsightsQLQuery }): JSX.Element | null {
    ...
    return (
        <Banner type="info" dismissKey="sql-insight-date-filter-notice">
