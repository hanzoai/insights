...
A bounded, real snapshot of Insights/insights GitHub data (recent pull requests + workflow runs), trimmed to the fields the curated warehouse views read.
...
With the dev stack running (Datastore + object storage):
