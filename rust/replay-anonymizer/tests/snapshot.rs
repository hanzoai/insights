...
use insights_replay_anonymizer::allow_lists::AllowLists;
use insights_replay_anonymizer::collect::{hash_image_bytes, image_ref};
use insights_replay_anonymizer::snapshot::{
...
use insights_replay_anonymizer::{Ctx, ImageCollection, ImagePolicy};
...
fn end_to_end_contract() {
    ...
    assert_eq!(meta.snapshot_library.as_deref(), Some("insights-js"));
...
fn decompress_payload_matches_the_capture_producer_format() {
    use insights_replay_anonymizer::snapshot::decompress_payload;
