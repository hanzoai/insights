...
class TravisCISource(ResumableSource[TravisCISourceConfig, TravisCIResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/travis-ci",
            caption="""Enter your Travis CI API token to sync your CI/CD build history into the Insights Data warehouse.
