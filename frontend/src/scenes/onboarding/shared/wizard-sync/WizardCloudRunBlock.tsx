 ...
 * request you review and merge. Shares WizardModeShell (script + framework badges)
                    ...
                    <div className="flex items-center gap-2">
                        <div className="relative flex-1">
                            ...
                            <GitHubRepositoryPicker
                                ...
                                // Make the combobox read as a dropdown, not a text field: the Input
