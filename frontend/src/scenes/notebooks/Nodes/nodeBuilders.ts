...
// pulling in the node modules themselves. The node modules import `createInsightsWidgetNode` from
...
// `createInsightsWidgetNode is not a function` at module-evaluation time.
