...
class DirectSnowflakeTable(DirectSQLTable):
    ...
    # We quote every identifier (quoted names are case-sensitive in Snowflake), so resolve a InsightsQL
    ...
    def to_printed_datastore(self, context) -> str:
        raise QueryError("Direct Snowflake tables cannot be printed into Datastore SQL")
