...
const WideTemplate: StoryFn<typeof Banner> = (props: BannerProps) => {
...
const NarrowTemplate: StoryFn<typeof Banner> = (props: BannerProps) => {
    // We need to explicitly set size on the banner's parent, because Banner is a CSS container
    // See: https://stackoverflow.com/a/73980194/3515268
    return (
...
const SceneWidthTemplate: StoryFn<typeof Banner> = (props: BannerProps) => {
    return (
