...
export const ConversationsOpenCreateBody = /* @__PURE__ */ zod
    .object({
        ...
        attached_context: zod
            ...
            .optional()
            .describe('Typed Insights entities (and free text) attached to this message.'),
...
export const ConversationsTicketsComposeCreateBody = /* @__PURE__ */ zod.object({
    ...
    recipient_distinct_id: zod
        ...
        .optional()
        .describe('Insights distinct_id to link the ticket to a person. Falls back to recipient_email.'),
    email_subject: zod
        .string()
