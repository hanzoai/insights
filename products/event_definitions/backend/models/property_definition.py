...
from insights.utils import invalidate_has_person_email_cache

# Relocated to the Django-free products.event_definitions.backend.property_type module so the
# InsightsQL engine can use it without booting Django; re-exported here for existing callers.
...
class PropertyDefinition(UUIDTModel):
    ...
    class Meta:
        db_table = "insights_propertydefinition"
        indexes = [
