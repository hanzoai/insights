...
from Insights's external_table_definitions.py for that resource type."""
...
def make_invoice_line_item(idx: int, **overrides: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "amount": amount,
        "currency": currency,
        "description": overrides.pop("description", "Hedgebox subscription"),
        "discount_amounts": [],
        "discountable": True,
        "discounts": [],
        "livemode": False,
...
def make_charge(idx: int, created: datetime, **overrides: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "statement_descriptor": "HEDGEBOX",
        "payment_method_details": {"type": "card", "card": {"brand": "visa", "last4": "4242"}},
        "calculated_statement_descriptor": "HEDGEBOX",
        **overrides,
    }
...
def make_account(idx: int, created: datetime, **overrides: Any) -> dict[str, Any]:
    return {
        "id": f"acct_{idx:012d}",
        "object": "account",
        "business_profile": {"name": "Hedgebox Inc.", "url": "https://hedgebox.example.com"},
        ...
        "email": "billing@hedgebox.example.com",
