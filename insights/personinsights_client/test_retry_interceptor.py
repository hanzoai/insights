...
from insights.personinsights_client.interceptor import RetryInterceptor, _MutableClientCallDetails
...
class TestRetryInterceptorBehavior:
    ...
    @patch("insights.personinsights_client.interceptor.time.sleep")
...
class TestRetryInterceptorMetrics:
    @patch("insights.personinsights_client.interceptor.PERSONFN_RETRIES_TOTAL")
    @patch("insights.personinsights_client.interceptor.PERSONFN_TERMINAL_ERRORS_TOTAL")
    @patch("insights.personinsights_client.interceptor.time.sleep")
