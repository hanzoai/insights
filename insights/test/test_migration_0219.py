import pytest
from insights.test.base import TestMigrations
...
class TagsTestCase(TestMigrations):
    ...
    def test_tags_migrated(self):
        Tag = self.apps.get_model("insights", "Tag")  # type: ignore
        TaggedItem = self.apps.get_model("insights", "TaggedItem")  # type: ignore
        Dashboard = self.apps.get_model("insights", "Dashboard")  # type: ignore
        Insight = self.apps.get_model("insights", "Insight")  # type: ignore
    ...
    def tearDown(self):
        ...
        Team = self.apps.get_model("insights", "Team")  # type: ignore
        Team.objects.get(id=self.team2.id).delete()
        Organization = self.apps.get_model("insights", "Organization")  # type: ignore
