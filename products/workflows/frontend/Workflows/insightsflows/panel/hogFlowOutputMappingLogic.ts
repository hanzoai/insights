...
export interface hogFlowOutputMappingLogicValues {
    selectedNode: InsightsFlowActionNode | null // hogFlowEditorLogic
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface hogFlowOutputMappingLogicActions {
    addMapping: () => {
        value: true
    }
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface hogFlowOutputMappingLogicMeta {
    key: string
...
export type hogFlowOutputMappingLogicType = MakeLogicType<
    hogFlowOutputMappingLogicValues,
    hogFlowOutputMappingLogicActions,
    WorkflowLogicProps,
    hogFlowOutputMappingLogicMeta
>
