...
class DevinAISource(ResumableSource[DevinAISourceConfig, DevinAIResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Devin service user API key and organization ID to sync your Devin data into the Insights Data warehouse.
...
Your organization ID is the `org-...` identifier shown in your Devin organization settings.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/devin-ai",
