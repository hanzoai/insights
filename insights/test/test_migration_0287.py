...
class CreatingSessionRecordingModelMigrationTestCase(NonAtomicTestMigrations):
    ...
    def test_migrate_to_create_session_recordings(self):
        SessionRecording = self.apps.get_model("insights", "SessionRecording")  # type: ignore
        SessionRecordingPlaylist = self.apps.get_model("insights", "SessionRecordingPlaylist")  # type: ignore
        SessionRecordingPlaylistItem = self.apps.get_model("insights", "SessionRecordingPlaylistItem")  # type: ignore
