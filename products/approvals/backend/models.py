...
class ChangeRequest(UUIDModel, CreatedMetaFields, UpdatedMetaFields):
    ...
    class Meta:
        db_table = "insights_changerequest"  # pinned to pre-move physical table name, do not rename
        indexes = [
...
class Approval(UUIDModel, CreatedMetaFields, UpdatedMetaFields):
    ...
    class Meta:
        db_table = "insights_approval"  # pinned to pre-move physical table name, do not rename
...
class ApprovalPolicy(UUIDModel, CreatedMetaFields, UpdatedMetaFields):
    ...
    class Meta:
        db_table = "insights_approvalpolicy"  # pinned to pre-move physical table name, do not rename
