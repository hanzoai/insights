...
class RollbarSource(ResumableSource[RollbarSourceConfig, RollbarResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Rollbar",
            caption="""Enter your Rollbar project access token to pull your Rollbar error data into the Insights Data warehouse.

You can find or create a project access token in your Rollbar project under Settings > Project Access Tokens. A token with the `read` scope is sufficient. Each Insights source connects to one Rollbar project — add one source per project.""",
            iconPath="/static/services/rollbar.png",
            docsUrl="https://hanzo.ai/docs/cdp/sources/rollbar",
