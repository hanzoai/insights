...
# Maps Insights resource name -> Stripe API object type (as it appears in webhook data.object.object)
#
# This is what the webhook InsightsFunction routes on: it reads `data.object.object` off the incoming
