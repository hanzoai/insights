...
class RoarkSource(ResumableSource[RoarkSourceConfig, RoarkResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Roark API key to sync your voice and chat AI observability data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/roark",
