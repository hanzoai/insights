...
import { IconWarning, IconWrench } from '@hanzo/icons'
import { Button, Drawer, Tag, Spinner, SpinnerOverlay, Tooltip } from '@hanzo/elements'
...
function TurnBody({
    ...
    if (!turn.isLoaded) {
        return (
            <div className="py-2">
                <Button size="small" type="secondary" onClick={onLoad}>
                    Show conversation
                </Button>
            </div>
        )
