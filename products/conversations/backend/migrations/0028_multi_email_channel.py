...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # orphaned table so TRUNCATE insights_team doesn't fail in tests.
                    ...
                    sql="""
                        ...
                        BEGIN
                            FOR r IN (
                                ...
                                WHERE conrelid = 'insights_conversations_email_config'::regclass
                                AND contype = 'f'
                            ) LOOP
                                EXECUTE format(
                                    'ALTER TABLE insights_conversations_email_config DROP CONSTRAINT %I', r.conname
                                );
                            END LOOP;
        ...
        migrations.CreateModel(
            ...
            options={
                "db_table": "insights_conversations_email_channel",
                "constraints": [
