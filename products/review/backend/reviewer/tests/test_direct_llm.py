...
from products.review.backend.reviewer.constants import ONESHOT_MODEL, ONESHOT_REASONING_EFFORT
...
_MODULE = "products.review.backend.reviewer.sandbox.direct_llm"
...
async def test_oneshot_call_pins_model_effort_schema_and_stage() -> None:
    ...
    assert kwargs["extra_headers"] == {"x-insights-property-ai_stage": "dedup"}
