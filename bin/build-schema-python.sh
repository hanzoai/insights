...
# Move enum classes to insights/schema_enums.py (importable without the pydantic model cost)
python3 bin/split-schema-enums.py

# Format and lint
ruff format insights/schema.py insights/schema_enums.py
ruff check --fix insights/schema.py insights/schema_enums.py
