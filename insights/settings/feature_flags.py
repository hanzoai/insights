...
# Temporal's keys (insights/settings/temporal.py) so the two rotate independently.
...
FEATURE_FLAG_LAST_CALLED_AT_SYNC_DATASTORE_LIMIT: int = get_from_env(
    "FEATURE_FLAG_LAST_CALLED_AT_SYNC_DATASTORE_LIMIT", 100000, type_cast=int
)
