    ...
    operations = [
        migrations.SeparateDatabaseAndState(
            state_operations=[
                ...
                migrations.AddConstraint(
                    ...
                    constraint=models.CheckConstraint(
                        condition=insights.models.utils.build_unique_relationship_check(
            ...
            database_operations=[
                migrations.RunSQL(
                    sql="""
                        ALTER TABLE "insights_dashboardtile" DROP CONSTRAINT IF EXISTS "dash_tile_exactly_one_related_object";
                        ALTER TABLE "insights_dashboardtile" ADD CONSTRAINT "dash_tile_exactly_one_related_object" -- existing-table-constraint-ignore
                        CHECK (
