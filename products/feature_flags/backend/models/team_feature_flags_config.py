...
class TeamFeatureFlagsConfig(models.Model):
    ...
    # lock on insights_team (a hot table) while migrating.
    team = models.OneToOneField("insights.Team", on_delete=models.CASCADE, primary_key=True, db_constraint=False)
