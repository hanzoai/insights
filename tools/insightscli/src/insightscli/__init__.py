...
For adding new Insights-specific commands, use:
- tools/insightscli-commands/insightscli_commands/ - for Python Click commands
- insightscli.yaml - for bin scripts, shell commands, and compositions
"""
