...
export interface surveyWizardLogicValues {
    survey: NewSurvey | Survey // surveyLogic
    surveyChanged: boolean // surveyLogic
    ...
    templateMode: SurveyTemplateMode
}
...
export interface surveyWizardLogicActions {
    ...
    loadSurvey: () => any // surveyLogic
    resetSurvey: (values?: NewSurvey | Survey | undefined) => {
    ...
    setTemplateMode: (mode: SurveyTemplateMode) => {
        mode: SurveyTemplateMode
    }
    updateSurvey: () => {
        value: true
    }
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface surveyWizardLogicMeta {
    key: string
    __keaTypeGenInternalSelectorTypes: {
        coreTemplates: (templateMode: SurveyTemplateMode) => SurveyTemplate[]
...
export type surveyWizardLogicType = MakeLogicType<
    surveyWizardLogicValues,
    surveyWizardLogicActions,
    SurveyWizardLogicProps,
    surveyWizardLogicMeta
>
