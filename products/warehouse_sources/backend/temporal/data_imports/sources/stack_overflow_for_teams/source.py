...
class StackOverflowForTeamsSource(
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Stack Overflow for Teams team name and a Personal access token to pull your internal Q&A knowledge base — questions, answers, articles, tags, users, and collections — into the Insights Data warehouse.
...
Create a token under **Account Settings → Personal access tokens**, scoped to this team. Read-only (Basic) access is sufficient — you don't need to grant write access.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/stack-overflow-for-teams",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
