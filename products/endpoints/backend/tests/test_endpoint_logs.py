...
from insights.api.test.test_log_entries import create_log_entry
...
class TestEndpointExecutionLogs(DatastoreTestMixin, APIBaseTest):
    def _create_insightsql_endpoint(self, name: str, query: str):
    ...
    def test_successful_run_emits_info_log(self):
        endpoint = self._create_insightsql_endpoint("logs_ok", "SELECT 1")
    ...
    def test_failed_run_emits_error_log(self):
        endpoint = self._create_insightsql_endpoint("logs_fail", "SELECT nonexistent_column_xyz FROM events")
    ...
    def test_successful_run_returns_execution_id_matching_log(self):
        endpoint = self._create_insightsql_endpoint("logs_exec_id", "SELECT 1")
    ...
    def test_invalid_refresh_mode_emits_error_log_and_clean_message(self):
        endpoint = self._create_insightsql_endpoint("logs_bad_refresh", "SELECT 1")
    ...
    def test_rejected_run_params_emit_error_log(self, _name, body, expected_status):
        ...
        endpoint = self._create_insightsql_endpoint(f"logs_reject_{_name}", "SELECT 1")
    ...
    def test_validate_run_request_failure_emits_error_log(self):
        ...
        endpoint = self._create_insightsql_endpoint("logs_bad_validate", "SELECT 1")
    ...
    def test_logs_action_returns_endpoint_entries(self):
        endpoint = self._create_insightsql_endpoint("logs_read", "SELECT 1")
        create_log_entry(
    ...
    def test_logs_action_filters_by_level(self):
        endpoint = self._create_insightsql_endpoint("logs_levels", "SELECT 1")
