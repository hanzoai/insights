...
from insights.tasks.exports import video_exporter
from insights.tasks.exports.video_exporter import RecordReplayToFileOptions
...
class TestVideoExporter(APIBaseTest):
    ...
    @patch("insights.tasks.exports.video_exporter.sync_playwright")
    @patch("insights.tasks.exports.video_exporter.shutil.which")
    def test_record_replay_to_file_mp4_success(self, mock_which: Mock, mock_playwright: Mock) -> None:
        ...
        with patch("insights.tasks.exports.video_exporter.subprocess.run") as mock_subprocess:
    ...
    def test_record_replay_to_file_webm_success(self, mock_which: Mock, mock_playwright: Mock) -> None:
        ...
        with patch("insights.tasks.exports.video_exporter.shutil.move") as mock_move:
