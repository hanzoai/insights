            ...
            where=[
                ...
                (
                    (
                        ...
                        AND (insights_featureflag.filters->>'multivariate' IS NULL
                            OR insights_featureflag.filters->'multivariate' = '{}'::jsonb
                            OR jsonb_array_length(insights_featureflag.filters->'multivariate'->'variants') = 0)
                    )
                    OR
                    (
                        EXISTS (
