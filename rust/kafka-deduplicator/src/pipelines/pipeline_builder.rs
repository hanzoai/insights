...
impl PipelineBuilder {
    ...
    pub async fn build_assigner(
        ...
        match self.pipeline_type {
            ...
            PipelineType::DatastoreEvents => {
                self.build_assigner_datastore_events(
                    offset_tracker,
                    assigner_endpoint,
                    consumer_name,
                    shutdown_rx,
    ...
    async fn build_assigner_datastore_events(
        self,
        offset_tracker: Arc<OffsetTracker>,
        assigner_endpoint: &str,
        consumer_name: String,
        ...
        info!("Building assigner datastore_events pipeline");
        ...
        .await
        .context("Failed to create assigner consumer for datastore events")?;
