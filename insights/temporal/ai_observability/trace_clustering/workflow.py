...
from insights.temporal.ai_observability.trace_clustering.aggregates import compute_cluster_aggregates_activity
...
class DailyTraceClusteringWorkflow(InsightsWorkflow):
    ...
    4. Emit: Write clustering results to Datastore
    ...
    async def run(self, inputs: ClusteringWorkflowInputs) -> ClusteringResult:
        ...
        # Activity 4: Emit events to Datastore
