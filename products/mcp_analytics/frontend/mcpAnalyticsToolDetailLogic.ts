...
// (Datastore only returns buckets with data). `bucketKeys` covers the whole window at the active
...
export const mcpAnalyticsToolDetailLogic = kea<mcpAnalyticsToolDetailLogicType>([
    ...
    selectors({
        ...
        // Grouping interval for the daily series — Insights's standard auto-choice, matching the query's
