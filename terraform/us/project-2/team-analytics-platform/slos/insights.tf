locals {
  ...
  region_tables = {
    us = {
      exports_table = "postgres.insights_exportedasset"
      history_table = "system.cohort_calculation_history"
    }
    eu = {
      exports_table = "eu_insights_exportedasset"
      history_table = "eu_insights_cohortcalculationhistory"
    }
  }
...
resource "insights_insight" "slo" {
  ...
  dashboard_ids = [insights_dashboard.team_analytics_platform_slos.id]
...
# ---------------------------------------------------------------------------
resource "insights_insight" "slo_success_rates" {
