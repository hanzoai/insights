...
_LAZY = {
    ...
    "delete_webhook_and_insights_function": "logic.external_data_source.webhooks",
    "get_or_create_webhook_insights_function": "logic.external_data_source.webhooks",
    ...
    "ensure_managed_warehouse_direct_source": "managed_warehouse_connection",
    "reconcile_managed_warehouse_tables": "managed_warehouse_connection",
    "soft_delete_managed_warehouse_sources": "managed_warehouse_connection",
    "update_managed_warehouse_root_password": "managed_warehouse_connection",
    "schedule_managed_warehouse_tables_reconcile": "tasks.tasks",
    "schedule_soft_delete_managed_warehouse_sources": "tasks.tasks",
    "InsightsQLQueryFixerTool": "max_tools",
    ...
    "DirectQueryEngine": "direct_query_engines",
