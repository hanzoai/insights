...
class LeexiSource(ResumableSource[LeexiSourceConfig, LeexiResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter a Leexi API key pair to pull your Leexi calls, notes, meeting events, users, and teams into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/leexi",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
