...
/** Mock ResizeObserver and getBoundingClientRect so script-charts components
 ...
 *  `renderScriptChart` so simple tests don't need a beforeEach for the mocks; they're installed
