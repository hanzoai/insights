...
from insights.schema import FunnelsQuery, LifecycleQuery, TrendsQuery

from insights.schema_migrations.upgrade import upgrade


def _get_migration():
    migration_module = importlib.import_module("insights.schema_migrations.0004_entity_node_kind")
