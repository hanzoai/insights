...
import { Action, DatastoreTimestamp, Hook, Hub, ISOTimestamp, PostIngestionEvent, ProjectId, Team } from '../../types'
...
describe('LegacyWebhookService', () => {
    ...
    describe('processBatch', () => {
        ...
        it('posts an identical payload regardless of group_analytics and never adds a groups key', async () => {
            ...
            const fixedTimestamp = '2024-01-01 00:00:00.000' as DatastoreTimestamp
