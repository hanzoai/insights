    ...
    it('validates placeholders and translated link URLs', async () => {
        const survey = createSurveyWithLinkQuestion({
            translations: {
                ...
                de: { question: 'Dokumentation offnen', link: 'https://hanzo.ai/docs' },
...
describe('survey filters', () => {
    ...
    it('collapses newlines in question text so the generated InsightsQL select stays single-line', async () => {
        ...
        // column, turning the trailing (often accented) text into invalid InsightsQL.
...
describe('surveyLogic archived response refresh', () => {
    ...
    beforeEach(async () => {
        ...
        jest.spyOn(api, 'queryInsightsQL').mockResolvedValue({ results: [] } as any)
