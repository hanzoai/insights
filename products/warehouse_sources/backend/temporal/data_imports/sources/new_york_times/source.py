...
class NewYorkTimesSource(ResumableSource[NewYorkTimesSourceConfig, NewYorkTimesResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption=(
                "Enter your New York Times API key to pull New York Times content into the Insights Data warehouse.\n\n"
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/new-york-times",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
