...
Pulls one bucket of unscored sessions from Datastore, runs the XGBoost booster,
        ...
        try:
            ...
            self.stdout.write(
                self.style.ERROR(
                    ...
                    "Run `pytest insights/temporal/tests/session_replay/surfacing_scoring_sweep/test_sql_alignment.py` "
