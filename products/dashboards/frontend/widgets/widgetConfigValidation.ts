/** Shared Zod helpers for per-widget config validation modules (form parse, API errors, InsightsQL filters). */
...
/** Converts persisted widget `config.widgetFilters` into a InsightsQL/universal filter group. */
