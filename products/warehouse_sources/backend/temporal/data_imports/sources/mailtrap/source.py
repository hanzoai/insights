...
class MailtrapSource(ResumableSource[MailtrapSourceConfig, MailtrapResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Mailtrap API token to pull your email sending data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/mailtrap",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
