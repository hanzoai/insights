...
from insights.insightsql.database.schema.persons import PersonsTable, RawPersonsTable, join_with_persons_table
...
class Database(BaseModel):
    ...
    def serialize(
        ...
        # Insights tables
        insights_table_names = self.get_insights_table_names(include_hidden=include_hidden_insights_tables)
