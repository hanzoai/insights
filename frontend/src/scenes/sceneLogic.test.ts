...
describe('sceneLogic', () => {
    describe('isOnboardingNotRequiredForPath', () => {
        // Regression guard: mid-onboarding users hitting an account round-trip (credential
        // review) must not be bounced to /onboarding before the scene's own logic can run, or
        // the flow is swallowed and never completes.
