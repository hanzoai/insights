...
class PaperformSource(ResumableSource[PaperformSourceConfig, PaperformResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Paperform API key to pull your forms and submissions data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/paperform",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
