...
class UserTeamPermissions:
    ...
    def effective_membership_level_for_parent_membership(
        ...
        # `_object_access_level_from_rows` in `insights/rbac/user_access_control.py`.
        ...
        # No access control row in the database, admin by default. See: `default_access_level()` in `insights/rbac/user_access_control.py`
