...
/**
 * Two-segment scope toggle built on `SegmentedButton`. Left segment is
 ...
 * + combobox), in UI. Scope is persisted via `inboxFiltersLogic`; teammates
...
export function InboxScopeSelect(): JSX.Element {
    ...
    // context, so Button doesn't auto-add its own dropdown chevron to each segment.
