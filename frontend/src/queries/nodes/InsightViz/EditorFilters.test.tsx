...
import { attachedContextLogic } from 'products/insights_ai/frontend/api/logics'
...
describe('EditorFilters', () => {
    ...
    it('disables query-time person properties for data warehouse insights', async () => {
        ...
        const disabledArea = screen.getByText('Use person properties from query time').closest('.DisabledArea')
