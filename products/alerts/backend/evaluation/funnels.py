...
from insights.schema import AlertCondition, AlertConditionType, FunnelsAlertConfig, FunnelsQuery, IntervalType
...
from insights.tasks.alerts.trends import query_excludes_incomplete_periods
