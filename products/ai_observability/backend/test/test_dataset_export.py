...
class TestDatasetExport(APIBaseTest):
    ...
    @patch("products.ai_observability.backend.dataset_export.insights_feature_flag_value", return_value=True)
    ...
    def test_export_rechecks_access(
        ...
        with (
            ...
            patch(
                "products.ai_observability.backend.dataset_export.insights_feature_flag_value",
    ...
    @patch("products.ai_observability.backend.dataset_export.insights_feature_flag_value", return_value=None)
