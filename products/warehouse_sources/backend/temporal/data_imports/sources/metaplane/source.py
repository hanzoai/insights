...
class MetaplaneSource(ResumableSource[MetaplaneSourceConfig, MetaplaneResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Metaplane API key to pull your data observability monitors and their evaluation history into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/metaplane",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
