...
# This model loads at django.setup() in every process; insights.schema (the pydantic
...
class ReplayScanner(UUIDModel):
    ...
    query = models.JSONField(
        default=dict,
        help_text="Persisted `insights.schema.RecordingsQuery` shape; date_from/date_to stripped on save.",
    )
    ...
    def recordings_query(self) -> "RecordingsQuery":
        ...
        from insights.schema import RecordingsQuery  # noqa: PLC0415
