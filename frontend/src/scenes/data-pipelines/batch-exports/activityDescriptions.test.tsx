...
describe('batch export activity descriptions', () => {
    ...
    describe('batchExportActivityDescriber', () => {
        it('describes creation', () => {
            ...
            expect(text).toContain(`Max Script created batch export 'My S3 Export' (S3)`)
        })
        ...
        it('describes deletion', () => {
            ...
            expect(text).toContain(`Max Script deleted batch export 'My S3 Export' (S3)`)
        })
        ...
        it('describes enabling (paused=false)', () => {
            ...
            expect(text).toContain(`Max Script enabled batch export 'My S3 Export' (S3)`)
        })
        ...
        it('describes disabling (paused=true)', () => {
            ...
            expect(text).toContain(`Max Script disabled batch export 'My S3 Export' (S3)`)
        })
        ...
        it('describes a name change with before and after', () => {
            ...
            expect(text).toContain(
                `Max Script changed the name from 'Old Name' (S3) to 'New Name' (S3) for batch export 'New Name' (S3)`
            )
        })
        ...
        it('describes a model change', () => {
            ...
            expect(text).toContain(
                `Max Script changed the model from events to persons for batch export 'My S3 Export' (S3)`
            )
        })
        ...
        it('shows multiple non-schedule changes as a bulleted list', () => {
            ...
            expect(text).toContain(`Max Script updated batch export 'My S3 Export' (S3)`)
