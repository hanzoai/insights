...
from insights.models.ingestion_warnings.sql_v2 import (
...
operations = [
    ...
    # 2. Kafka engine table on aux (consumes the datastore_ingestion_warnings topic via a v2 consumer group)
    run_sql_with_exceptions(
        KAFKA_INGESTION_WARNINGS_V2_TABLE_SQL(),
        node_roles=[NodeRole.AUX],
    ),
