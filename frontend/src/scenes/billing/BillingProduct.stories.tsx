...
import { INSIGHTS_CODE_USAGE_PRODUCT_KEY, STARTUP_PROGRAM_BILLING_LIMIT_MAX } from './billingLimitConfig'
...
const makeInsightsCodeUsageBilling = ({
    currentLimitUsd,
    nextPeriodLimitUsd,
}: {
    ...
    const product: BillingProductV2Type = {
        ...sourceProduct,
        name: 'Insights Desktop (usage-based)',
        ...
        docs_url: 'https://hanzo.ai/docs/insights-desktop',
        subscribed: true,
...
const renderInsightsCodeUsageBillingProduct = ({
    currentLimitUsd,
    nextPeriodLimitUsd,
}: {
    currentLimitUsd: number
    ...
    const { billing, product } = makeInsightsCodeUsageBilling({ currentLimitUsd, nextPeriodLimitUsd })
...
export const BillingProductInsightsCodeLimit: Story = {
    render: () =>
        renderInsightsCodeUsageBillingProduct({
            currentLimitUsd: 50,
        }),
}

export const BillingProductInsightsCodeLimitEditing: Story = {
    render: () =>
        renderInsightsCodeUsageBillingProduct({
            currentLimitUsd: 50,
        }),
...
export const BillingProductInsightsCodeLimitNextPeriodCapped: Story = {
    render: () =>
        renderInsightsCodeUsageBillingProduct({
