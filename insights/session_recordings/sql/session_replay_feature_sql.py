...
from insights.kafka_client.topics import KAFKA_DATASTORE_SESSION_REPLAY_FEATURES
...
def KAFKA_SESSION_REPLAY_FEATURES_TABLE_SQL(on_cluster=True):
    return KAFKA_SESSION_REPLAY_FEATURES_TABLE_BASE_SQL.format(
        ...
        on_cluster_clause=ON_CLUSTER_CLAUSE(on_cluster),
        engine=kafka_engine(
            topic=KAFKA_DATASTORE_SESSION_REPLAY_FEATURES,
...
def KAFKA_SESSION_REPLAY_FEATURES_WS_TABLE_SQL(on_cluster=False):
    return KAFKA_SESSION_REPLAY_FEATURES_TABLE_BASE_SQL.format(
        ...
        engine=kafka_engine(
            ...
            named_collection=settings.DATASTORE_KAFKA_WARPSTREAM_REPLAY_NAMED_COLLECTION,
        ),
    )
