...
// `@hanzo/brand/logo` directly. The raw package is presentation-only (its gradient wordmark
...
import type { LogoProps, LogomarkProps } from '@hanzo/brand/logo'
...
/**
 * The Insights logo, adapted to the app's theme. With no explicit `variant` it renders the
...
/**
 * The mascot logomark, theme-aware like {@link Logo}, and dressed for the current holiday
