...
from insights.models.property import PropertyGroup, PropertyName
from insights.models.property.util import parse_prop_grouped_clauses
...
class EventQuery(metaclass=ABCMeta):
    ...
    def _determine_should_join_persons(self) -> None:
        ...
        # Can be simplified significantly after https://github.com/hanzoai/insights/issues/5854
