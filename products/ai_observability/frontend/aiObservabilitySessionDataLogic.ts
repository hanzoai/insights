...
export interface aiObservabilitySessionDataLogicActions {
    setDateRange: (dateFrom: string | null, dateTo?: string | null | undefined) => {
        dateFrom: string | null;
    ...
    loadCachedSummariesSuccess: (summaries: Array<{
        title: string;
        trace_id: string;
    }>) => {
        summaries: {
    ...
    openStepsDrawer: (traceId: string, focusEventKey?: string | null) => {
    ...
    summarizeTrace: (traceId: string, forceRefresh?: boolean) => {
        forceRefresh: boolean;
        traceId: string;
    };
    summarizeTraceFailure: (traceId: string, error: string) => {
        error: string;
        traceId: string;
    };
    summarizeTraceSuccess: (traceId: string, title: string) => {
        title: string;
        traceId: string;
    };
...
export type aiObservabilitySessionDataLogicType = MakeLogicType<aiObservabilitySessionDataLogicValues, aiObservabilitySessionDataLogicActions, SessionDataLogicProps, aiObservabilitySessionDataLogicMeta>;
