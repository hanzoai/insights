...
from insights.tasks.alerts.checks import check_alert
...
class TestTimeSeriesTrendsRelativeAlerts(APIBaseTest, DatastoreDestroyTablesMixin):
    def setUp(self) -> None:
        super().setUp()
    ...
    @patch("insights.tasks.alerts.trends.calculate_for_query_based_insight", wraps=calculate_for_query_based_insight)
