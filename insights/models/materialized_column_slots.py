...
class MaterializedColumnSlotState(models.TextChoices):
    ...
    # READY: backfill complete; InsightsQL serves reads from the dmat column.
    READY = "READY", "Ready"
...
class MaterializedColumnSlot(UUIDTModel):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["team", "state"], name="insights_mat_team_st_idx"),
            models.Index(fields=["team", "property_definition"], name="insights_mat_team_pr_idx"),
            models.Index(fields=["team", "slot_index"], name="insights_mat_team_sl_idx"),
            models.Index(fields=["backfill_temporal_run_id"], name="insights_mat_run_id_idx"),
        ]
