...
const Template: StoryFn<typeof Select> = (props: SelectProps<any>) => {
    return (
...
MixedValuesTypes.args = {
    ...
    ] as SelectOptions<string | number>,
}
...
export const FullWidth: StoryFn<typeof Select> = (props: SelectProps<any>) => {
    return (
        <div className="items-center w-full border p-4 gap-2">
            <Select {...props} fullWidth={true} allowClear={true} value="poodle" />
        </div>
    )
}
...
export const WithAccessControl = (): JSX.Element => {
    ...
    return (
        <div className="flex gap-4 items-center">
            ...
            >
                <Select options={options} placeholder="Enabled (editor ≥ viewer)" />
            </AccessControlAction>
            <AccessControlAction
                resourceType={AccessControlResourceType.Dashboard}
            ...
            >
                <Select options={options} placeholder="Disabled (viewer < editor)" />
            </AccessControlAction>
        </div>
    )
}
