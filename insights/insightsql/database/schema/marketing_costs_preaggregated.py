...
class MarketingCostsPreaggregatedTable(Table):
    description: str = (
        ...
        "materialized from external data-warehouse tables into native Datastore for the marketing analytics dashboard."
    )
    ...
    fields: dict[str, FieldOrTable] = {
        ...
        "reported_conversions": FloatDatabaseField(
            ...
            description="Conversions reported by the ad source itself (not Insights-attributed).",
        ),
