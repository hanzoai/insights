    ...
    return [
        {
            ...
            content: (
                <>
                    ...
                    <Markdown>Install the Insights SDK and LangGraph with OpenAI.</Markdown>
                        ...
                        blocks={[
                            {
                                ...
                                file: 'Python',
                                code: dedent`
                                    pip install insights langgraph langchain-core langchain-openai
                                `,
                            },
                            {
                                language: 'bash',
                                file: 'Node',
                                code: dedent`
                                    npm install insights-node @hanzo/ai @langchain/langgraph @langchain/openai @langchain/core zod
                                `,
                            },
                        ]}
                    />
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        {dedent`
                        Create a Insights client once, then build a callback handler for each request or
                    ...
                    <CodeBlock
                        blocks={[
                            ...
                            },
                            {
                                ...
                                import { LangChainCallbackHandler } from '@hanzo/ai/langchain'
                ...
                <>
                    <Markdown>
                        {dedent`
                            ...
                            run, Insights nests each tool call as an \`$ai_span\` under the trace automatically,
                            with real latency.
                        `}
                    </Markdown>
                    ...
                    <Markdown>
                        {dedent`
                            ...
                            too, to control the top-level trace ID instead of letting Insights generate one.
                        `}
                    </Markdown>
                </>
            ),
