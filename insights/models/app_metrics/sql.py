# DEPRECATED: superseded by `insights.models.app_metrics2`. No producer writes to the
# v1 `datastore_app_metrics` topic anymore (the legacy-plugin Node.js producer was
...
# follow-up Datastore migration once you're sure no historical reads are needed,
# then delete this file along with KAFKA_APP_METRICS in insights/kafka_client/topics.py
# and CONSUMER_GROUP_APP_METRICS in insights/datastore/kafka_engine.py.
