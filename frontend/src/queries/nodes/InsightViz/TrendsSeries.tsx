...
const lifecycleDataWarehousePopoverFields: DataWarehousePopoverField[] = [
    { key: 'timestamp_field', label: 'Timestamp', allowInsightsQL: true },
    { key: 'created_at_field', label: 'Created at', allowInsightsQL: true },
    { key: 'aggregation_target_field', label: 'Aggregation target', allowInsightsQL: true },
]
