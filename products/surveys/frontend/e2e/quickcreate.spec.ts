...
test.describe('Quick create survey from feature flag', () => {
    ...
    test.beforeEach(async ({ page, playwrightSetup }) => {
        ...
        await page.evaluate(() => {
            window.insights?.featureFlags?.override({})
        })
    ...
    test('survey responses visible in feature flag feedback tab', async ({ page }) => {
        ...
        // Don't wait for networkidle — Insights polls continuously, so it rarely settles. goto
    ...
    test('warning shown when surveys are disabled', async ({ page }) => {
        ...
        // The team data comes from INSIGHTS_APP_CONTEXT which is server-rendered into HTML.
