...
class LinkedInAdsSource(ResumableSource[LinkedinAdsSourceConfig, LinkedInAdsResumeConfig], OAuthMixin):
    ...
    def get_non_retryable_errors(self) -> dict[str, str | None]:
        return {
            ...
            "RESOURCE_NOT_FOUND": "LinkedIn could not find the requested ad account. It may have been deleted, the configured Account ID may be wrong, or Insights may have lost access. Check the Account ID and re-authorize the LinkedIn Ads integration.",
            ...
            "RESTRICTED_MEMBER": "LinkedIn has restricted the account that authorized this integration, so Insights can no longer access your ad data. Resolve the restriction with LinkedIn, then re-authorize the LinkedIn Ads integration.",
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="LinkedIn Ads",
            caption="Ensure you have granted Insights access to your LinkedIn Ads account, learn how to do this in [the documentation](https://hanzo.ai/docs/cdp/sources/linkedin-ads).",
            releaseStatus=ReleaseStatus.GA,
            iconPath="/static/services/linkedin.png",
            docsUrl="https://hanzo.ai/docs/cdp/sources/linkedin-ads",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldOauthConfig(
