...
(`NODE_ENV==='test'`) but not in the built visual-regression Storybook. insights-js loads
...
> Do **not** try to fix this by disabling insights-js flags (e.g. `advanced_disable_feature_flags`).
