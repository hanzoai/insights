...
describe('CdpCyclotronWorkerFlow with PersonFn', () => {
    ...
    beforeEach(async () => {
        ...
        flow = await insertFlow(
            hub.postgres,
            new FixtureFlowBuilder()
                .withName('Test Script Flow')
                .withTeamId(team.id)
                .withStatus('active')
                .withSimpleWorkflow()
                .build()
    ...
    it('resolves person by distinct_id via personinsights', async () => {
        ...
        const processor = new CdpCyclotronWorkerFlow(
            hub,
        ...
        const invocations = [
            createSerializedFlowInvocation(flow, {
    ...
    it('resolves person by personId via personinsights', async () => {
    ...
    it('propagates error when personinsights is unavailable', async () => {
        const mockRepo = createMockPersonReadRepository({
