...
class TestCohort(BaseTest):
    ...
    def test_calculate_people_ch_clears_realtime_type_when_exceeding_threshold(self):
        ...
        from insights.models.cohort.cohort import REALTIME_COHORT_MAX_PERSON_COUNT
        ...
        with patch("insights.models.cohort.util.recalculate_cohortpeople") as mock_recalc:
