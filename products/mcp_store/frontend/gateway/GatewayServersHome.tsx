...
export function GatewayServersLoadError({
    ...
    return (
        <Banner type="error" action={{ children: 'Try again', onClick: onRetry }}>
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className="flex items-start justify-between gap-4 flex-wrap">
                <div>
                    ...
                    <p className="mb-0 text-secondary">
                        Connect tools for yourself, your teammates, and Insights agents.
                    </p>
                </div>
                <Button
                    type="primary"
            ...
            <div className="flex items-center gap-2 flex-wrap">
                ...
                >
                    All <Snack className="ml-1">{mergedServers.length}</Snack>
                </Button>
                <Button
                    size="small"
                ...
                >
                    Connected <Snack className="ml-1">{connectedServerCount}</Snack>
                </Button>
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                    ...
                    {recommended && <Tag type="highlight">Recommended</Tag>}
                    {connected && <Tag type="success">Connected</Tag>}
                    {connection?.pending_oauth && <Tag type="warning">Finishing setup</Tag>}
                    {connection?.needs_reauth && <Tag type="danger">Needs reauth</Tag>}
                    {connection && !connection.is_enabled && <Tag type="muted">Off for you</Tag>}
                    {server.is_revoked_for_you && <Tag type="danger">Access revoked</Tag>}
                    {disabled && (
                        <Tooltip
                            title={
                                recommended
            ...
            <div className="shrink-0">
                {needsReconnect && connection ? (
                    ...
                    connecting ? (
                        <Button size="small" disabledReason="Authorizing…" icon={<Spinner />} stopPropagation>
                            Authorizing…
                        </Button>
                    ) : (
                        <Button
...
function GatewayConnectionModal(): JSX.Element | null {
    ...
    return (
        ...
        >
            ...
            >
                {isCustomServer && (
                    <Field.Pure label="Authentication" htmlFor="mcp-gateway-connection-authentication">
                                    ...
                                    content: (
                                        <div className="flex flex-col gap-3">
                                            <Field.Pure
                                                ...
                                                help="Leave blank to let Insights register a client for you."
