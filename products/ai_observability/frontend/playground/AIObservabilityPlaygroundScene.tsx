        ...
        <div className="mb-4 border rounded p-4 bg-transparent h-[30vh] min-w-0 flex flex-col">
            ...
            {!item ? (
                ...
                <>
                    ...
                    >
                        {item.response ? (
                            <Markdown className="whitespace-pre-wrap break-words [&_img]:max-w-full [&_img]:h-auto [&_img]:rounded [&_img]:my-2">
                                {item.response}
                            </Markdown>
                        ) : isStreaming ? (
        ...
        <>
            <ModelPicker
                ...
                onSelect={(modelId, providerKeyId) => {
                    ...
                    insights.capture('llma playground model changed', {
                        model: modelId,
        ...
        <div className="flex flex-wrap items-center gap-3">
            ...
            <Dropdown
                ...
                onVisibilityChange={(visible) => {
                    if (!visible && prompt) {
                        insights.capture('llma playground parameters configured', {
            ...
            <Modal
                ...
                footer={
                    <div className="flex justify-end gap-2">
                        ...
                        <Button type="secondary" onClick={() => setEditModal(null)}>
                            Close
                        </Button>
                    </div>
                }
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        {!hasTools && (
                            <button
                                ...
                                onClick={() => {
                                    insights.capture('llma playground tools example inserted')
...
function SystemMessageDisplay({ promptId }: { promptId: string }): JSX.Element {
    ...
    const copySystemPromptToOtherPrompts = (): void => {
        ...
        insights.capture('llma playground system prompt synced', {
        ...
        <>
            <div className="border rounded p-4 py-2 relative group">
                <div className="absolute top-2 right-2 flex items-center gap-1">
                    ...
                    <Divider vertical className="h-5 mx-0.5" />
                    <Button
                        size="small"
                        icon={<IconCopy />}
                        ...
                        noPadding
                        onClick={() => {
                            insights.capture('llma playground response copied', { content_type: 'system_prompt' })
                ...
                >
                    ...
                    {linkedContextLabel ? (
                        <Tag type="highlight" size="small" className="max-w-[260px] truncate">
...
function MessageDisplay({
    ...
    const handleRoleChange = (newRole: MessageRole): void => {
        insights.capture('llma playground message role changed', { from: message.role, to: newRole })
            ...
            <div className="border rounded p-4 py-2 relative group">
                <div className="absolute top-4 right-4 flex items-center gap-1">
                    <Button
                        ...
                        noPadding
                        onClick={() => {
                            insights.capture('llma playground response copied', {
