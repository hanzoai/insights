...
from products.review.backend.reviewer.tools.github_client import is_app_bot_author
...
def engagement_method(*, comment: dict[str, Any], review_comments: list[dict[str, Any]]) -> str | None:
    ...
    `REVIEWFN_GITHUB_BOT_LOGIN` is set; unset it fails open to "any bot", which degrades this to the
