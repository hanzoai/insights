...
- `data-attr` — Insights's default data attribute (configurable per team)
...
Insights converts CSS selectors to regex patterns matched against `elements_chain`:
...
In InsightsQL, use `elements_chain =~ '{regex}'` for matching.
