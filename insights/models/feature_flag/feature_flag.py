...
from insights.constants import ENRICHED_DASHBOARD_INSIGHT_IDENTIFIER, PropertyOperatorType
...
from insights.models.utils import RootTeamMixin, UUIDModel
...
class FeatureFlag(FileSystemSyncMixin, ModelActivityMixin, RootTeamMixin, models.Model):
    ...
    def transform_cohort_filters_for_easy_evaluation(
        ...
        from insights.models.property.util import clear_excess_levels
    ...
    def get_cohort_ids(
        ...
        from insights.models.cohort.util import get_all_cohort_dependencies, sort_cohorts_topologically
