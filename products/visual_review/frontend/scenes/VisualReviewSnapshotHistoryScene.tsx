...
import { Banner, Button, Skeleton, Tag, Link } from '@hanzo/elements'
        ...
        <article className="flex gap-4">
            ...
            <div className="flex-1 min-w-0 pb-6">
                <div className="flex items-center gap-2 flex-wrap mb-1">
                    {isCurrent && <Tag type="primary">Current baseline</Tag>}
                    <Tag type={reason.type}>{reason.label}</Tag>
            ...
            <div className="w-full max-w-4xl mx-auto flex flex-col gap-4">
                <div className="border rounded bg-bg-light flex flex-wrap items-center gap-x-10 gap-y-3 px-4 py-3">
                    {runType && (
                        <Stat
                            value={
                                <Tag type="default" className="uppercase tracking-wider">
                                    {runType}
                                </Tag>
                            }
                            label="Type"
                ...
                {historyLoading || repoLoading ? (
                    ...
                    <Banner type="info">No history yet for this snapshot.</Banner>
                ) : (
