...
class TestSourceConfig:
    ...
    def test_docs_url_matches_published_doc_slug(self) -> None:
        assert MixMaxSource().get_source_config.docsUrl == "https://hanzo.ai/docs/cdp/sources/mixmax"
...
class TestGetSchemas:
    ...
    def test_documented_tables_render_for_public_docs(self) -> None:
        # `lists_tables_without_credentials` lets the hanzo.ai Supported tables section render
