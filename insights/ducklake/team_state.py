...
:mod:`insights.ducklake.cp_teams`). This module is the single read seam for that
...
from insights.ducklake.common import _get_org_id_for_team, validate_duckgres_identifier
...
def data_imports_schema(team_id: int) -> str:
    ...
    if row is None:
        ...
        return f"insights_data_imports_team_{team_id}"
