...
from insights.temporal.data_imports.sources.common.base import FieldType, ResumableSource, WebhookSource
...
from insights.temporal.data_imports.sources.generated_configs import StripeSourceConfig
...
from insights.temporal.data_imports.sources.stripe.settings import (
...
class StripeSource(ResumableSource[StripeSourceConfig, StripeResumeConfig], WebhookSource[StripeSourceConfig]):
    ...
    def webhook_template(self) -> Optional["InsightsFunctionTemplateDC"]:
        from insights.temporal.data_imports.sources.stripe.webhook_template import template
