...
class SimpleCastSource(ResumableSource[SimpleCastSourceConfig, SimpleCastResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Simplecast API token to pull your podcast data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/simplecast",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
    ...
    def source_for_pipeline(
        ...
        return simplecast_source(
            ...
            db_incremental_field_last_value=None,  # every Simplecast endpoint is full refresh
        )
