...
} from './script-function-filtering'

describe('script-function-filtering', () => {
    describe('convertToInsightsFunctionFilterGlobal', () => {
        it('should correctly map groups to response including empty group indexes', () => {
            ...
            const response = convertToInsightsFunctionFilterGlobal(globals)
    ...
    describe('Pre-filtering on event name', () => {
        let mockInsightsFunction: InsightsFunctionType
        let mockFilterGlobals: InsightsFunctionFilterGlobals

        beforeEach(() => {
            mockInsightsFunction = {
                id: 'test-function',
                team_id: 1,
                name: 'Test Function',
        ...
        it('should return false and skip bytecode when event does not match specific events', async () => {
            ...
            const result = await filterFunctionInstrumented({
                fn: mockInsightsFunction,
                filters: mockInsightsFunction.filters,
