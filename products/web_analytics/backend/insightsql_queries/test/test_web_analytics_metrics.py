...
from insights.schema import WebAnalyticsPreComputeStrategy, WebStatsBreakdown
...
from products.web_analytics.backend.insightsql_queries.web_analytics_query_runner import WebAnalyticsQueryRunner
...
def _make_runner(
    ...
    cast(MagicMock, runner.datastore_query_type).return_value = (
...
class TestWebAnalyticsMetrics(TestCase):
    ...
    @patch(
        "products.web_analytics.backend.insightsql_queries.web_analytics_query_runner.get_query_tag_value",
    ...
    @patch(
        "products.web_analytics.backend.insightsql_queries.web_analytics_query_runner.get_query_tag_value", return_value=None
    )
    ...
    def test_canonical_log_line_emitted(self, _mock_tag):
        ...
        with (
            ...
            patch("products.web_analytics.backend.insightsql_queries.web_analytics_query_runner.logger") as mock_logger,
        ):
            WebAnalyticsQueryRunner.calculate(runner)
        ...
        assert kw["datastore_query_type"] is None
    ...
    def test_stats_table_log_line_includes_query_strategy(self, _mock_tag):
        ...
        cast(MagicMock, runner.datastore_query_type).return_value = "stats_table_path_bounce_query"
        ...
        assert mock_logger.info.call_args[1]["datastore_query_type"] == "stats_table_path_bounce_query"
    ...
    def test_strategy_resolution_failure_still_emits_error_metrics(self, _mock_tag):
        ...
        cast(MagicMock, runner.datastore_query_type).side_effect = RuntimeError("strategy boom")
