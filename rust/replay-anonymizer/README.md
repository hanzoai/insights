# insights-replay-anonymizer

PII scrubber for rrweb session-replay events: text/URL redaction, native image blur, and canvas/`cv` neutralization. This is the scrub core behind Insights's ml-mirror pipelines.
