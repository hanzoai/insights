...
import dataVisualizationInsightsQLJson from '../../../../frontend/src/mocks/fixtures/api/projects/team_id/insights/dataVisualizationInsightsQL.json'
...
export const insightResults = {
    ...
    insightsqlTable: { columns: dataVisualizationInsightsQLJson.columns, results: dataVisualizationInsightsQLJson.result },
} as const
