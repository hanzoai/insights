...
// status page and writes here) and Toast (which reads it to decorate error toasts).
// Deliberately logic-free: Toast is imported by virtually every bundle, and importing
...
export const STATUS_PAGE_BASE = 'https://www.insightsstatus.com'
