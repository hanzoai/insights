...
export const urls = {
    ...
    /**
     * Insights Desktop / web return page after connecting an account. Use `github-login` (social SSO),
     * `github-integration` (user GitHub App integration), or `slack-integration` (team Slack integration);
     * see `AccountConnected` and `insights/api/authentication.py` / `user_integration.py`.
     */
