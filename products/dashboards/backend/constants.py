...
# session_ids IN clause sent to Datastore and the Python list we materialize, matching the saved-filter
...
# Preset relative ranges only — widgets don't accept arbitrary InsightsQL date strings.
# Note: `M` is minutes, `m` would be months (see insights.utils relative-date parsing).
