...
_FAN_OUT_COLUMNS = {
    "deployment_id": "Unique numerical identifier of the Semgrep deployment this row belongs to (added by Insights).",
    "deployment_slug": "Machine-readable slug of the Semgrep deployment this row belongs to (added by Insights).",
}
