//! Stateright `Model` for the personinsights partition handoff protocol.
//!
...
use personinsights_coordination::pod::{desired_state, DesiredState};
use personinsights_coordination::protocol::{
    drain_satisfied, freeze_quorum_met, plan_partial_rebalance, warm_satisfied,
};
use personinsights_coordination::strategy::{AssignmentStrategy, StickyBalancedStrategy};
