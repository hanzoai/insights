...
export type InsightsFlowStepNodeProps = NodeProps & {
    data: InsightsFlowAction
    type: InsightsFlowAction['type']
}
...
export const InsightsFlowTriggerSchema = z.discriminatedUnion('type', [
    z.object({
