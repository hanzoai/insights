...
# Re-exported for the many existing `from insights.tasks.utils import CeleryQueue` consumers.
# The enum lives in insights.celery_queues so import-light modules can use it at decorator-eval
# time without triggering the insights.tasks package init (which imports every task module).
from insights.celery_queues import CeleryQueue as CeleryQueue
