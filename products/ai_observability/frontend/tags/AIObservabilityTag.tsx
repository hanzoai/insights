    ...
    return (
        <div className="space-y-2">
            <div className="flex justify-between items-center">
                ...
                <Button type="secondary" size="small" icon={<IconPlus />} onClick={addTag}>
                    Add tag
                </Button>
            </div>
...
function AIObservabilityTaggerForm({ id }: { id: string }): JSX.Element {
        ...
        <BindLogic logic={llmTaggerLogic} props={{ id }}>
            <Form logic={llmTaggerLogic} props={{ id }} formKey="taggerForm">
                <div className="space-y-6 max-w-3xl">
                    ...
                    <div className="border-t pt-4 space-y-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted text-sm mt-1">
                                {taggerForm.tagger_type === 'script'
                                    ? 'Run deterministic Script code against each generation. No LLM cost, instant results.'
                        ...
                        {taggerForm.tagger_type !== 'script' && <TagDefinitionsEditor id={id} />}
                    ...
                    {taggerForm.tagger_type !== 'script' && <TaggerModelPicker id={id} />}
                    ...
                    <div className="flex gap-2 pt-4 border-t">
                        ...
                        <Button type="secondary" to={urls.aiObservabilityTags()}>
                            Cancel
                        </Button>
                        {id !== 'new' && (
                            <AccessControlAction
            ...
            render: (_, run) =>
                run.trace_id && run.target_event_id ? (
                    <div className="font-mono text-sm">
                        <Link
                            to={urls.aiObservabilityTrace(run.trace_id, { event: run.target_event_id })}
    ...
    return (
        <div className="space-y-4">
            <div className="flex justify-between items-center">
                ...
                <Button type="secondary" size="small" onClick={loadTagRuns}>
                    Refresh
                </Button>
            </div>
            <Table
...
function getTaggerProviderKeyIssue(tagger: Tagger | null, providerKeys: LLMProviderKey[]): LLMProviderKey | null {
    if (!tagger || tagger.tagger_type === 'script') {
        return null
    }
            ...
            <div className="space-y-6">
                ...
                <div className="flex justify-between items-start pb-4 border-b">
                    <div className="space-y-2">
                        ...
                        {!isNew && tagger && (
                            <div className="flex items-center gap-2">
                                <Tag type={tagger.enabled ? 'success' : 'default'}>
                    ...
                    <Button type="secondary" icon={<IconArrowLeft />} to={urls.aiObservabilityTags()}>
                        Back
                    </Button>
                </div>
                ...
                <Tabs
                    ...
                    tabs={[
                            ...
                            : []),
                        {
                            key: 'configuration',
                            label: 'Configuration',
                            content: <AIObservabilityTaggerForm id={taggerId} />,
                        },
                    ]}
                />
            </div>
