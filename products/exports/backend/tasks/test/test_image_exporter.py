    ...
    @parameterized.expand(
        [
            (
                ...
                {"kind": "InsightsQLQuery", "query": "SELECT 1"},
                False,
            ),
            (
...
@patch("os.remove")
@override_settings(BROWSERLESS_CDP_URL="wss://chrome.browserless.example")
class TestImageExporterQueryOverrideE2E(DatastoreTestMixin, APIBaseTest):
    ...
    @parameterized.expand(
        [
            ...
            (
                ...
                "page.goto: net::ERR_ABORTED at https://app.hanzo.ai/exporter?t=1700000000503",
                False,
            ),
