...
class FrillSource(ResumableSource[FrillSourceConfig, FrillResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Frill API key to sync your Frill ideas, votes, comments, and announcements into the Insights Data warehouse.
...
Find your API key under **Settings → Company** in your [Frill dashboard](https://app.frill.co/settings/company).""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/frill",
