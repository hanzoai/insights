...
class TemporalIOSource(ResumableSource[TemporalIOSourceConfig, TemporalIOResumeConfig]):
    ...
    def get_non_retryable_errors(self) -> dict[str, str | None]:
        ...
        return {
            ...
            # can never recover.
            "CertificateParseError": "Insights could not parse the TLS certificate or key configured for this source. Check that the client certificate, client private key, and server client root CA are valid PEM and were pasted in full, including the BEGIN and END lines.",
