/**
 * InsightsQL Parser WebAssembly Module
 *
 * High-performance InsightsQL parser compiled to WebAssembly.
...
/**
 * InsightsQL Parser instance
 */
export interface InsightsQLParser {
    /**
     * Parse a InsightsQL expression
     *
     * @param input - The InsightsQL expression string to parse
...
/**
 * Factory function to create a InsightsQL Parser instance
 *
 * @returns Promise that resolves to a InsightsQLParser instance
 *
 * @example
 * ```typescript
 ...
 * ```
 */
export default function createInsightsQLParser(): Promise<InsightsQLParser>
