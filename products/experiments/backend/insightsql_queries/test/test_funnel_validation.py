...
from insights.schema import EventsNode, ExperimentDataWarehouseNode
...
class TestFunnelDWValidationIntegration(BaseTest):
    ...
    def test_query_builder_builds_union_query_for_dw_funnels(self):
        ...
        # Note: We can't call to_printed_insightsql() because it will try to resolve the DW table
