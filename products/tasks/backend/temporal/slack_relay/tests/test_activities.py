...
class TestMarkdownToSlackMrkdwn(unittest.TestCase):
    @parameterized.expand(
        [
            ...
            (
                "bold_markdown_link",
                "**[pr-shepherd](https://us.hanzo.ai/project/2/llm-analytics/skills/pr-shepherd)**",
                "*<https://us.hanzo.ai/project/2/llm-analytics/skills/pr-shepherd|pr-shepherd>*",
            ),
            ...
            (
                ...
                "**<https://us.hanzo.ai/project/2/llm-analytics/skills/pr-shepherd**>",
                "*<https://us.hanzo.ai/project/2/llm-analytics/skills/pr-shepherd>*",
            ),
            (
            ...
            (
                ...
                "Draft PR opened: **https://github.com/Insights/hanzo.ai/pull/17450**",
                "Draft PR opened: *<https://github.com/Insights/hanzo.ai/pull/17450>*",
            ),
            (
    ...
    @parameterized.expand(
        [
            ...
            (
                ...
                "**https://github.com/Insights/hanzo.ai/pull/17450?foo=bar**",
                "**<https://github.com/Insights/hanzo.ai/pull/17450?foo=bar>**",
            ),
            (
...
class TestRelaySlackMessageChunking(TestCase):
    ...
    def test_long_text_posts_multiple_chunks_with_prefix_only_on_first(
        ...
        mock_update.assert_called_once_with("mascot")
