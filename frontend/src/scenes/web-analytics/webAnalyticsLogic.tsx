...
export const webAnalyticsLogic = kea<webAnalyticsLogicType>([
    ...
    selectors(({ actions }) => ({
        ...
        tiles: [
            ...
            (
                ...
                const includeHostMenuItem: MenuItem | null =
                    ...
                    },
                    {
                        ...
                        tabs: [
                            ...
                            createTableTab(
                                ...
                                {
                                    docs: {
                                        url: 'https://hanzo.ai/docs/web-analytics/dashboard#channels-referrers-utms',
                                        title: 'Referrers',
    ...
    urlToAction(({ actions, values, cache }) => {
        const applyUrlState = (
            ...
            const stampKey = `ph_last_web_analytics_stamp_${insights.get_distinct_id()}`
            const oneDayMs = 24 * 60 * 60 * 1000
            const lastStamp = Number(localStorage.getItem(stampKey) || 0)
            if (Date.now() - lastStamp > oneDayMs) {
                insights.setPersonProperties({ last_used_web_analytics_at: new Date().toISOString() })
