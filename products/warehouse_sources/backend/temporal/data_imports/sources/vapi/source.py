...
class VapiSource(ResumableSource[VapiSourceConfig, VapiResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Vapi private API key to automatically pull your Vapi voice agent data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/vapi",
