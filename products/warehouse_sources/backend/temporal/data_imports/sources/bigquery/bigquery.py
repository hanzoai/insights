"""BigQuery driver for Insights's data-warehouse import pipeline.
...
a thin Insights-layer wrapper that just holds an instance and validates
credentials.
"""
...
class BigQueryImplementation(SQLSourceImplementation[BigQuerySourceConfig, bigquery.Client, Any]):
    ...
    def get_columns(
        ...
        # Filter out Insights's own temp destination tables — they live in
