...
class WritesonicSource(ResumableSource[WritesonicSourceConfig, WritesonicResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Writesonic",
            caption="""Connect Writesonic to pull your GEO (generative engine optimization) data — brand visibility, rank, and mentions across AI platforms like ChatGPT and Perplexity — into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/writesonic",
