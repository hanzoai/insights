...
block or fail signup — see insights/temporal/signup_enrichment/trigger.py.
"""
...
async def enrich_signup_organization_activity(
    ...
    if is_recheck:
        ...
        from insights.models import Organization  # noqa: PLC0415 — heavy import kept off the workflow module path
...
class SignupEnrichmentWorkflow(InsightsWorkflow):
