...
import { Label, Modal, Select, SelectOptions } from '@hanzo/elements'
...
export function RegionField(): JSX.Element | null {
    ...
    const options: SelectOptions<Region> = REGIONS.map((region) => ({
        value: region.value,
        label: (
    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-2">
                <Label onExplanationClick={() => setModalOpen(true)}>Data region</Label>
                <Select<Region>
                    value={activeRegion}
                    options={options}
                    fullWidth
