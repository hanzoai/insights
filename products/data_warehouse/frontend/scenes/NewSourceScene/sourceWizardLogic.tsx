        ...
        getDatabaseSchemas: async () => {
            ...
            try {
                ...
                const errorMessage =
                    apiMessage ??
                    (e.status >= 500
                        ? 'Insights could not validate your connection in time. This can happen with a very large schema or a slow or unreachable database — please check your connection details and try again.'
                        : e.message)
