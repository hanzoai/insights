"""Callable discriminator for the AnyPropertyFilter union in the generated insights/schema.py.

bin/patch-schema-property-filter-discriminator.py rewrites every inlined property-filter
union in insights/schema.py into a tagged union discriminated by this function. A callable
...
Keep this module dependency-free: insights/schema.py imports it, so it must not import
insights.* (or anything heavy) back.
"""
