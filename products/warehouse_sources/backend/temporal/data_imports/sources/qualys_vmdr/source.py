...
class QualysVmdrSource(ResumableSource[QualysVmdrSourceConfig, QualysVmdrResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Qualys API credentials to sync your VMDR vulnerability management data into the Insights Data warehouse.
...
The `knowledge_base` table additionally requires the KnowledgeBase download option to be enabled on your Qualys subscription.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/qualys-vmdr",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
