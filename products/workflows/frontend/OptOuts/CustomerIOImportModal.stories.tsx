...
const syncConfigEndpoint = '/v1/environments/:team_id/messaging_categories/optout_sync_config/'
...
BothStepsNotCompleted.parameters = { testOptions: { waitForSelector: '.Collapse' } }
...
Step1FailedInvalidKey.parameters = { testOptions: { waitForSelector: '.Collapse' } }

export const Step1Completed: StoryFn<StoryProps> = Template.bind({})
Step1Completed.args = { syncConfig: step1CompletedConfig }
Step1Completed.parameters = { testOptions: { waitForSelector: '.Collapse' } }
...
Step1CompletedButKeyDeleted.parameters = { testOptions: { waitForSelector: '.Collapse' } }
...
BothStepsCompleted.parameters = { testOptions: { waitForSelector: '.Collapse' } }

export const Step2Failed: StoryFn<StoryProps> = Template.bind({})
Step2Failed.args = { syncConfig: step2FailedConfig }
Step2Failed.parameters = { testOptions: { waitForSelector: '.Collapse' } }
...
Step3WebhookNotConfigured.parameters = { testOptions: { waitForSelector: '.Collapse' } }
...
Step3WebhookEnabled.parameters = { testOptions: { waitForSelector: '.Collapse' } }
...
Step3WebhookDisabled.parameters = { testOptions: { waitForSelector: '.Collapse' } }
