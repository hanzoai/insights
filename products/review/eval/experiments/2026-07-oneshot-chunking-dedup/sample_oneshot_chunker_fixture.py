...
renders the current chunking prompt, and fires N direct gateway calls.
    ...
    N_SAMPLES=5 python manage.py shell -c "exec(open('products/review/eval/experiments/2026-07-oneshot-chunking-dedup/sample_oneshot_chunker_fixture.py').read())"
...
from products.review.backend.reviewer.tools.github_meta import PRFilter, PRParser
...
_FIXTURES = Path("products/review/eval/experiments/2026-07-reviewer-topology/fixtures")
