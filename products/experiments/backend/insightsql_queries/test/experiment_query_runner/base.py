...
from products.experiments.backend.insightsql_queries.experiment_query_runner import MIN_PRECOMPUTATION_DURATION_SECONDS
from products.experiments.backend.models.experiment import Experiment
from products.experiments.backend.models.team_experiments_config import TeamExperimentsConfig
from products.feature_flags.backend.models.feature_flag import FeatureFlag
from products.warehouse_sources.backend.facade.testing import create_data_warehouse_table_from_csv

TEST_BUCKET = "test_storage_bucket-insights.insightsql.experiments.queryrunner"
...
class ExperimentQueryRunnerBaseTest(DatastoreTestMixin, APIBaseTest):
    ...
    def _clean_preaggregation_data(self):
        """Clean precomputation data from Datastore and PostgreSQL"""
    ...
    def _setup_precomputation_test(self, use_precomputation: bool):
        ...
        if use_precomputation:
            self._clean_preaggregation_data()
            # Disable TTL merges so Datastore 26.3 doesn't immediately drop
