...
_metrics = EgressMetrics(
    ...
    # installation, and several Insights integration rows can share one installation. Keying by the row
...
def _normalize_github_endpoint(url: str | None) -> str:
    ...
    ``.../repos/insights/insights/actions/runs/42/jobs`` becomes ``/repos/{owner}/{repo}/actions/runs/{id}/jobs``
