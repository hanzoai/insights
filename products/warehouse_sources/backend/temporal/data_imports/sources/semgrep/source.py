...
class SemgrepSource(ResumableSource[SemgrepSourceConfig, SemgrepResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Semgrep API token to sync your static analysis data — deployments, projects, code (SAST) and supply chain (SCA) findings, and secrets — into the Insights Data warehouse.
...
Create a token in Semgrep AppSec Platform under **Settings → Tokens** and grant it the **Web API** scope. The API requires a Semgrep Team or Enterprise plan.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/semgrep",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
