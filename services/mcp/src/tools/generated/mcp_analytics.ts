...
const mcpAnalyticsSessionsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedMCPSessionList>
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof McpAnalyticsSessionsListSchema>) => {
        ...
        return await withInsightsUrl(context, result, '/mcp-analytics')
    },
})
...
const mcpAnalyticsSessionsToolCalls = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedMCPToolCallList>
> => ({
...
const InsightsQLPropertyFilter = z.object({
    key: z.string(),
    label: z.string().optional(),
    type: z.literal('insightsql').default('insightsql'),
    value: PropertyFilterValue.optional(),
})
