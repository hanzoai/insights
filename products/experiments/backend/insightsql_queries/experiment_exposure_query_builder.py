...
from insights.schema import ExperimentEventExposureConfig, MultipleVariantHandling
...
from products.experiments.backend.insightsql_queries.experiment_query_context import ExperimentQueryContext
...
class ExposureQueryBuilder:
    ...
    def daily_exposures_from_precomputed(self, job_ids: list[str]) -> ast.SelectQuery:
        ...
        query = parse_select(
            ...
            placeholders={
                ...
                "date_from": self.context.date_range_query.date_from_as_insightsql(),
                "date_to": self.context.date_range_query.date_to_as_insightsql(),
            },
        )
    ...
    def precomputation_query(self) -> tuple[str, dict[str, ast.Expr]]:
        ...
        placeholders = {
            ...
            "variant_property": self.build_variant_property(),
            "variants": ast.Constant(value=list(self.context.variants)),
            "experiment_date_from": self.context.date_range_query.date_from_as_insightsql(),
            "experiment_date_to": self.context.date_range_query.date_to_as_insightsql(),
        }
