...
The workflow stays tiny on purpose:
    ...
    * Inputs/outputs are summary counts only — the actual scores are written
      to Datastore from inside the activity, never returned through the
...
with workflow.unsafe.imports_passed_through():
    ...
    from insights.temporal.session_replay.surfacing_scoring_sweep.metrics import record_tick_summary


@workflow.defn(name=WORKFLOW_NAME)
class ScoreSessionsBatchWorkflow(InsightsWorkflow):
