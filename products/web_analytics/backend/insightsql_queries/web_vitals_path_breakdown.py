...
from insights.queries.trends.util import PROPERTY_MATH_FUNCTIONS
...
HAVING value >= 0
    ...
    def _percentile_expr(self) -> ast.Expr:
        ...
        # nosemgrep: insightsql-injection-taint - percentile_function from dict lookup, metric from enum
