...
from insights.egress.github.observability import (
    _normalize_github_endpoint,
    record_github_api_exception,
    record_github_api_response,
)
from insights.egress.observability.observability import (
...
def _response(
    *,
    ...
    method: str = "GET",
    url: str = "https://api.github.com/repos/insights/insights/commits",
) -> requests.Response:
...
class TestGithubObservability(SimpleTestCase):
    @parameterized.expand(
        [
            ("https://api.github.com/repos/insights/insights/commits", "/repos/{owner}/{repo}/commits"),
            (
