...
use personinsights_replica::config::Config;
use personinsights_replica::service::PersonHogReplicaService;
use personinsights_replica::storage::postgres::PostgresStorage;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tracing::info!("Starting personinsights-replica service");
    ...
    let mut manager = Manager::builder("personinsights-replica").build();
    ...
    tokio::spawn(async move {
        ...
        let recorder_handle = PrometheusBuilder::new()
            .add_global_label("service", "personinsights-replica")
            .set_buckets(BUCKETS)
            .unwrap()
            .install_recorder()
