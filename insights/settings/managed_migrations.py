...
from insights.settings.object_storage import OBJECT_STORAGE_REGION
...
MANAGED_MIGRATIONS_TRIAL_S3_BUCKET = os.getenv("MANAGED_MIGRATIONS_TRIAL_S3_BUCKET", "insights" if TEST or DEBUG else "")
MANAGED_MIGRATIONS_TRIAL_S3_PREFIX = os.getenv("MANAGED_MIGRATIONS_TRIAL_S3_PREFIX", "trial_runs")

# ARN of the Insights-owned IAM role the batch import worker runs as. Customers grant this
