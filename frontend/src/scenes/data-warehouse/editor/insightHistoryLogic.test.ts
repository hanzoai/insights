        ...
        changes: [
            {
                ...
                field: 'query',
                action: 'changed',
                before: { kind: 'DataVisualizationNode', source: { kind: 'InsightsQLQuery', query: 'SELECT 1' } },
                after: { kind: 'DataVisualizationNode', source: { kind: 'InsightsQLQuery', query: 'SELECT 2' } },
            },
        ],
    },
        ...
        changes: [
            {
                ...
                before: {
                    ...
                    source: { kind: 'InsightsQLQuery', query: 'SELECT 2' },
...
describe('insightHistoryLogic', () => {
    describe('getChangeSql', () => {
        it.each([
            [{ kind: 'DataVisualizationNode', source: { kind: 'InsightsQLQuery', query: 'SELECT 1' } }, 'SELECT 1'],
            [{ source: { query: '   ' } }, null],
            [{ source: {} }, null],
            [{}, null],
            [null, null],
