...
export interface insightsModelActions {
    ...
    updateInsightDirect: (
        ...
        updates: Partial<QueryBasedInsightModel>
    ) => {
        item: QueryBasedInsightModel<Node<Record<string, any>>>
        updates: Partial<QueryBasedInsightModel<Node<Record<string, any>>>>
    }
}

export type insightsModelType = MakeLogicType<{}, insightsModelActions>
