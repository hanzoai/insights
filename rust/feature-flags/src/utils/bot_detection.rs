//! Bot detection for `/flags`. UA-substring matcher mirrors insights-js
...
mod tests {
    ...
    #[case("insights-js/1.374.3")]
    #[case("insights-python/3.0.0")]
    #[case("insights-node/5.34.7")]
    #[case("insights-go/1.0.0")]
