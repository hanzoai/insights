...
class TestAccountViewSet(APIBaseTest):
    ...
    _EXTERNAL_IDENTIFIER_PROPERTIES = {
        ...
        "usage_dashboard_link": "https://us.hanzo.ai/project/2/dashboard/12345",
    }
...
class TestCustomPropertyDefinitionAccessControl(APIBaseTest):
    ...
    def setUp(self):
        ...
        self.viewer_user = User.objects.create_and_join(self.organization, "def-viewer@hanzo.ai", "testtest")
        self.editor_user = User.objects.create_and_join(self.organization, "def-editor@hanzo.ai", "testtest")
        self.no_access_user = User.objects.create_and_join(self.organization, "def-noaccess@hanzo.ai", "testtest")
...
class TestAccountNotesViewSet(APIBaseTest):
    ...
    def test_list_filter_by_assigned_to(self):
        ...
        other_user = User.objects.create_and_join(self.organization, "other-holder@hanzo.ai", None)
    ...
    def test_list_filter_by_created_by(self, _name, created_by_query):
        other_user = User.objects.create_and_join(self.organization, "note-author@hanzo.ai", None)
    ...
    def test_list_hides_notes_of_accounts_the_caller_cannot_read(self):
        ...
        self.organization.save()
        viewer = User.objects.create_and_join(self.organization, "notes-viewer@hanzo.ai", None)
        AccessControl.objects.create(
            team=self.team,
            resource="account",
...
class TestAccountRelationshipDefinitionViewSet(APIBaseTest):
    ...
    def test_viewer_access_can_list_but_not_write(self):
        ...
        self.organization.save()
        viewer = User.objects.create_and_join(self.organization, "rel-viewer@hanzo.ai", "testtest")
        AccessControl.objects.create(
            team=self.team,
...
class TestAccountRelationshipViewSet(APIBaseTest):
    ...
    def test_include_history_returns_full_timeline(self):
        ...
        successor = User.objects.create_and_join(self.organization, "successor@hanzo.ai", "testtest")
        relationships_logic.assign(
...
class TestAccountSupportTicketViewSet(APIBaseTest):
    ...
    def test_account_viewer_denied_tickets_cannot_read_them(self):
        ...
        self.organization.save()
        viewer = User.objects.create_and_join(self.organization, "ticket-denied@hanzo.ai", "testtest")
