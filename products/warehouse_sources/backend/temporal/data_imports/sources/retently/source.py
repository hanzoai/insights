...
class RetentlySource(ResumableSource[RetentlySourceConfig, RetentlyResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Retently API key to pull your customer feedback data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/retently",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
