...
class SavvyCalSource(ResumableSource[SavvyCalSourceConfig, SavvyCalResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your SavvyCal personal access token to pull your scheduling data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/savvycal",
