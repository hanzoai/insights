...
import { FunnelsDefinitionFields, InsightsQLDefinitionFields, TrendsDefinitionFields } from './AlertDefinitionFields'
...
export interface InsightsQLDefinitionProps {
...
export interface AlertDefinitionSectionProps {
    ...
    insightsql: InsightsQLDefinitionProps
...
export function AlertDefinitionSection({
    ...
    } else if (isInsightsQLAlertConfig(alertForm.config)) {
        definitionFields = (
            <InsightsQLDefinitionFields
                alertForm={alertForm}
                insightsqlPreview={insightsql.preview}
                insightsqlColumns={insightsql.columns}
                insightsqlValueColumnOptions={insightsql.valueColumnOptions}
                insightsqlLabelColumnOptions={insightsql.labelColumnOptions}
                showInlinePreview={!twoColumnLayout}
                onSetAlertFormValue={onSetAlertFormValue}
            />
        )
