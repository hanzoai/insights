...
from insights.schema import ExperimentDataWarehouseNode
...
class TestInsightsQLInjectionPrevention(BaseTest):
    """Verify that user-controlled table_name and timestamp_field from
    ExperimentDataWarehouseNode cannot inject arbitrary InsightsQL when used
