...
import type { SegmentedButtonOption, SelectOptions } from '@hanzo/elements'
import { Checkbox, Input, SegmentedButton } from '@hanzo/elements'
        ...
        <div className="max-w-3xl border rounded bg-surface-primary">
            <Form logic={alertEditorStoryLogic} formKey="alertForm" enableFormOnSubmit>
                <AlertEditor
                    ...
                    leadingActions={
                        <Button type="secondary" onClick={() => setLastAction('Selected delete')}>
                            Delete alert
                        </Button>
                    }
                >
...
const DEFINITION_MODE_OPTIONS: SegmentedButtonOption<DefinitionMode>[] = [
    ...
    return (
        <div className="max-w-2xl space-y-5 border rounded bg-surface-primary p-4">
            <AlertDefinitionRow label="Alert if event count is">
                <SegmentedButton value={mode} options={DEFINITION_MODE_OPTIONS} onChange={setMode} size="small" />
                <Input value={threshold} onChange={setThreshold} className="w-24" />
            </AlertDefinitionRow>
    ...
    return (
        <div className="max-w-2xl border rounded bg-surface-primary p-4">
            <AlertAdvancedOptions enabledCount={enabledCount}>
                <Checkbox checked={skipWeekends} onChange={setSkipWeekends} label="Skip weekend evaluations" />
                <Checkbox
                    checked={quietHours}
...
const NOTIFICATION_TYPE_OPTIONS: SelectOptions<StoryNotificationType> = [
...
const STORY_SLACK_WORKSPACES: IntegrationType[] = [
    {
        ...
        config: { team: { id: 'T11111', name: 'Insights' } },
...
const STORY_EXISTING_FN_FUNCTIONS = [
    {
        id: 'hf1',
