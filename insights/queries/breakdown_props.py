...
from insights.constants import BREAKDOWN_TYPES, MONTHLY_ACTIVE, WEEKLY_ACTIVE, PropertyOperatorType
from insights.models.cohort import Cohort
from insights.models.cohort.util import format_filter_query
from insights.models.entity import Entity
from insights.models.entity.util import get_entity_filtering_params
...
from insights.models.property.util import (
    get_property_string_expr,
    get_single_or_multi_property_string_expr,
    parse_prop_grouped_clauses,
)
from insights.models.team import Team
from insights.queries.column_optimizer.column_optimizer import ColumnOptimizer
from insights.queries.groups_join_query import GroupsJoinQuery
...
from insights.queries.person_on_events_v2_sql import PERSON_DISTINCT_ID_OVERRIDES_JOIN_SQL
from insights.queries.person_query import PersonQuery
from insights.queries.query_date_range import QueryDateRange
from insights.queries.trends.sql import HISTOGRAM_ELEMENTS_ARRAY_OF_KEY_SQL, TOP_ELEMENTS_ARRAY_OF_KEY_SQL
from insights.queries.util import PersonPropertiesMode, alias_poe_mode_for_legacy
from insights.session_recordings.queries.session_query import SessionQuery
...
def get_breakdown_prop_values(
    ...
    if use_all_funnel_entities:
        from insights.queries.funnels.funnel_event_query import FunnelEventQuery
