...
export const buildAccountExternalIdInputs = (
    ...
    // via doubling) without breaking out of the Script expression.
    ...
    nodes: [
        {
            ...
            config: { template_id: 'template-insights-create-account', inputs: {} },
        ...
        },
        {
            ...
            config: { template_id: 'template-insights-get-account', inputs: {} },
            getDefaultInputs: getAccountExternalIdDefaultInputs,
        ...
        },
        {
            ...
            config: { template_id: 'template-insights-tag-account', inputs: {} },
            getDefaultInputs: getAccountExternalIdDefaultInputs,
        ...
        },
        {
            ...
            config: { template_id: 'template-insights-update-account-relationships', inputs: {} },
            getDefaultInputs: getAccountExternalIdDefaultInputs,
            output_variable: { key: 'account', result_path: null },
        },
        {
            ...
            config: { template_id: 'template-insights-update-account-property', inputs: {} },
            getDefaultInputs: getAccountExternalIdDefaultInputs,
            output_variable: { key: 'account', result_path: null },
        },
    ],
