...
export interface PropertiesTableProps extends BasePropertyType {
    ...
    className?: string
    /* only event types are detected and so describe-able. see https://github.com/Insights/insights/issues/9245 */
    useDetectedPropertyType?: boolean
...
export function PropertiesTable({
    ...
    const objectProperties = useMemo(() => {
        ...
        return entries
    }, [properties, sortProperties, searchTerm, hideInsightsPropertiesInTable, hideNullValues, type]) // oxlint-disable-line react-hooks/exhaustive-deps
