...
from insights.admin.admins.conversation_admin import ConversationAdmin
...
class TestConversationAdminCompactView(BaseTest):
    def setUp(self) -> None:
        ...
        self.compact_url = f"/admin/insights_ai/conversation/{self.conversation.id}/compact/"
    ...
    @patch("insights.admin.admins.conversation_admin.compact_conversation")
