...
export const evaluationReportLogic = kea<evaluationReportLogicType>([
    ...
    listeners(({ actions, values, props }) => ({
        ...
        generateReportSuccess: () => {
            toast.success('Report is being generated and will be delivered to your configured targets shortly.')
        },
        generateReportFailure: () => {
            toast.error('Failed to trigger report generation. Please try again.')
        },
        createReportSuccess: () => {
            actions.loadReports()
        },
        ...
        saveDraft: () => {
            ...
            if (values.configError) {
                toast.error(values.configError)
                return
            }
