...
import type { customFlowEditorTestLogicType } from './customFlowEditorTestLogicType'
...
export interface CustomFlowTestInvocation {
    globals: string
...
export const customFlowEditorTestLogic = kea<customFlowEditorTestLogicType>([
    path((key) => ['products', 'workflows', 'frontend', 'Workflows', 'customflows', 'actions', 'workflowTestLogic', key]),
    ...
    connect((props: WorkflowLogicProps) => ({
        values: [
            ...
            customFlowEditorLogic,
            ['selectedNodeId'],
        ],
        actions: [customFlowEditorLogic, ['setSelectedNodeId', 'setAnimatingEdgePair']],
    })),
    actions({
    ...
    selectors(() => ({
        ...
        // TODO(workflows): DRY up matchingFilters with implementation in customFunctionConfigurationLogic
        matchingFilters: [
            (s) => [s.triggerAction],
