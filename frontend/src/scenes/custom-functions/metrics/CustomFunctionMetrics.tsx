...
export function CustomFunctionMetrics({ id }: { id: string }): JSX.Element {
    const logic = appMetricsLogic({
        logicKey: `custom-function-metrics-${id}`,
        loadOnMount: true,
        loadOnChanges: true,
        forceParams: {
    ...
    return (
        <div className="flex flex-col gap-2">
            <div className="flex flex-row gap-2 flex-wrap justify-end">
                <AppMetricsFilters logicKey={`custom-function-metrics-${id}`} />
            </div>
