...
class QualarooSource(ResumableSource[QualarooSourceConfig, QualarooResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Qualaroo API key and secret to pull your survey (nudge) data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/qualaroo",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
