    ...
    return [
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        We call Cerebras through the OpenAI client and generate a response. We'll use Insights's OpenAI
                        ...
                        Insights client along with the Cerebras config (the base URL and API key) to our OpenAI wrapper.
                    </Markdown>
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        Now, when you call Cerebras with the OpenAI SDK, Insights automatically captures an
