...
class MarketoSource(ResumableSource[MarketoSourceConfig, MarketoResumeConfig]):
    ...
    def get_non_retryable_errors(self) -> dict[str, str | None]:
        return {
            "Marketo authentication failed": "Insights could not authenticate with Marketo. Check the client ID and secret on your Marketo custom service, and make sure the service is still active.",
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Marketo",
            caption="""Connect Adobe Marketo Engage to pull your leads, activities, campaigns, and program assets into the Insights Data warehouse.
...
Leads and activities come through Marketo's Bulk Extract API, so the first sync backfills from the start date you set below.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/marketo",
