...
from insights.temporal.ingestion_acceptance_test.schedule import WORKFLOW_NAME, _build_schedule, _lane_schedule_id
...
class TestDeployRegistry:
    def test_schedule_is_wired_into_deploy_registry(self) -> None:
        ...
        from insights.temporal.ingestion_acceptance_test.schedule import (  # noqa: PLC0415
            create_ingestion_acceptance_test_schedule,
        )
        from insights.temporal.schedule import schedules  # noqa: PLC0415 — heavy registry import, kept off module load
