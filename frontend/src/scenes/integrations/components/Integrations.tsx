        ...
        <Integration kind="github">
            <div className="flex flex-col gap-y-2">
                <div className="flex flex-wrap gap-2">
                    {/* This leaves Insights entirely, and a GitHub App installs at most once per
                ...
                {isConnected && (
                    <p className="text-secondary text-xs mb-0">
                        Install the Insights app on another GitHub account, or change which repositories this
...
export function GitHubInstallationLink({
    ...
    if (installations.length === 1) {
        return (
            <Button type="secondary" loading={loading} onClick={() => onLink()}>
    ...
    return (
        ...
        >
            <Button type="secondary" loading={loading} sideIcon={<IconChevronDown />}>
                Link existing installation
            </Button>
        </Menu>
    )
