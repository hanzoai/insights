...
class TestMessageSuppressionViewSetScope(SimpleTestCase):
    ...
    insights_flow RBAC and let any project member manage suppressions regardless of workflow permissions.
    """

    def test_scope_object_is_insights_flow(self) -> None:
        assert MessageSuppressionViewSet.scope_object == "insights_flow"
    ...
    def test_mutating_actions_are_declared_as_writes(self) -> None:
        ...
        # listed here they'd default to a read scope and slip past insights_flow:write enforcement.
