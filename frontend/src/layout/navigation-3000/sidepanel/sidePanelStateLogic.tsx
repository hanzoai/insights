...
export interface sidePanelStateLogicValues {
    modalMode: boolean
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface sidePanelStateLogicActions {
...
export type sidePanelStateLogicType = MakeLogicType<sidePanelStateLogicValues, sidePanelStateLogicActions>
