...
class JudgeMeReviewsSource(ResumableSource[JudgeMeReviewsSourceConfig, JudgeMeReviewsResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your shop domain and private API token to pull your Judge.me product reviews into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/judgeme-reviews",
            keywords=["judgeme"],
            fields=cast(
                list[FieldType],
                [
