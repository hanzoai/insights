...
# The underlying Datastore table is a sharded ReplacingMergeTree keyed by
...
#
# Access scope: this table is registered with InsightsQL under the standard team_id
...
class ScriptInvocationResultsTable(Table):
