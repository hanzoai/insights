//! Shared person-storage primitives used by the personinsights services that read
...
impl From<Person> for personinsights_proto::personinsights::types::v1::Person {
    fn from(person: Person) -> Self {
        personinsights_proto::personinsights::types::v1::Person {
            id: person.id,
