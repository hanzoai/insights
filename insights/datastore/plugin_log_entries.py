...
from insights.kafka_client.topics import KAFKA_PLUGIN_LOG_ENTRIES
...
def PLUGIN_LOG_ENTRIES_WRITABLE_TABLE_SQL():
    return PLUGIN_LOG_ENTRIES_TABLE_BASE_SQL.format(
        ...
        engine=Distributed(data_table=PLUGIN_LOG_ENTRIES_TABLE, cluster=settings.DATASTORE_SINGLE_SHARD_CLUSTER),
        extra_fields=KAFKA_COLUMNS,
    )
