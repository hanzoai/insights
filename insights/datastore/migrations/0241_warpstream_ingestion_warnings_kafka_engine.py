...
from insights.models.ingestion_warnings.sql import INGESTION_WARNINGS_WS_MV_SQL, KAFKA_INGESTION_WARNINGS_WS_TABLE_SQL

# Re-apply of migration 0234, which did not get applied in cloud environments.
# Creates the WarpStream Kafka engine table and MV for datastore_ingestion_warnings.
#
...
#
# Tables (INGESTION_SMALL, matching existing MSK table from migration 0157):
