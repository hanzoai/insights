...
import { SegmentedButton, Tag, TagType, Link, Spinner, Tooltip } from '@hanzo/elements'
...
const STATUS_META: Partial<Record<CompareRowStatus, { label: string; tagType?: TagType }>> = {
            ...
            >
                ...
                <Cell>
                    <span className="inline-flex items-center gap-1.5 max-w-full">
                        ...
                        {statusTag && (
                            <Tag type={statusTag.tagType} size="small">
                                {statusTag.label}
                            </Tag>
                        )}
                    </span>
