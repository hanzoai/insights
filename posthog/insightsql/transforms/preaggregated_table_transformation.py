...
from posthog.insightsql.helpers.timestamp_visitor import (
...
def is_to_start_of_day_timestamp_field(expr: ast.Call, context: InsightsQLContext) -> bool:
...
def is_to_start_of_hour_timestamp_field(expr: ast.Call, context: InsightsQLContext) -> bool:
...
def _try_transform_timestamp_comparison_with_start_of_day_time_constant(
    expr: ast.Call, context: InsightsQLContext
) -> Optional[ast.Call]:
    """
...
def _shallow_transform_select(node: ast.SelectQuery, context: InsightsQLContext) -> ast.SelectQuery:
...
def do_preaggregated_table_transforms(node: _T_AST, context: InsightsQLContext) -> _T_AST:
    """
