...
import { attachedContextLogic, runStreamLogic } from 'products/insights_ai/frontend/api/logics'
...
describe('maxThreadLogic', () => {
    ...
    beforeEach(() => {
        useMocks({
            ...
            get: {
                ...maxMocks.get,
                '/v1/environments/:team_id/conversations/:conversation_id/': MOCK_IN_PROGRESS_CONVERSATION,
                ...
                '/v1/environments/:team_id/conversations/:conversation_id/queue': {
                    messages: [],
    ...
    describe('error tracking capture gating', () => {
        ...
        it.each([
            ...
            const captureExceptionSpy = jest
                .spyOn(insights, 'captureException')
