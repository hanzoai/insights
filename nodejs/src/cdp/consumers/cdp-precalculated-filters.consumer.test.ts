...
import { KAFKA_CDP_DATASTORE_PREFILTERED_EVENTS } from '~/common/config/kafka-topics'
...
describe('CdpPrecalculatedFiltersConsumer', () => {
    ...
    describe('cohort filter matching and Kafka publishing', () => {
        ...
        it('should process person property filters and emit to person properties topic', async () => {
            ...
            expect(precalculatedPersonProperties[0].payload).toMatchObject({
                ...
                matches: true,
                source: 'cohort_filter_person_prop_test_001',
            })
        })
