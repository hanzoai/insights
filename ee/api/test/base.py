...
class LicensedTestMixin:
    """
    Test API using Django REST Framework test suite, for licensed Insights (mainly enterprise edition).
    """
    ...
    def license_required_response(
        self,
        message: str = "This feature is part of the premium Insights offering. Self-hosted licenses are no longer available for purchase. Please contact sales@posthog.com to discuss options.",
