...
const insightsqlMath = { math: 'insightsql', math_insightsql: 'sum(toInt(properties.$revenue))' }

export const TrendsGroupCustomNameInsightsQL: Story = {
    render: renderGroupStory({
        insight: InsightType.TRENDS,
        groups: [
            group(0, [groupEvent('$pageview', '$pageview', 0, insightsqlMath)], {
                custom_name: 'My custom name (InsightsQL)',
                math: insightsqlMath,
            }),
        ],
    }),
