...
def test_serialize_insight_result_strips_null_bytes():
    # Regression witness: Datastore result strings can carry NUL (\x00). Django's JSONField
...
def test_serialize_insight_result_handles_decimal_and_date():
    ...
    # raises on bare date. Both used to live on the Datastore result path for revenue /
    # analytics queries.
    result = _build_insight_result(
