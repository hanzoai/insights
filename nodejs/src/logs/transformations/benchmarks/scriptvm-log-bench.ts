...
// Micro-benchmark: TS ScriptVM cost per log record per transformation program.
//
// Run with:
//   cd nodejs && pnpm exec tsx src/logs/transformations/benchmarks/scriptvm-log-bench.ts
//
...
// scriptvm upgrades or when changing the globals shape.
...
async function main(): Promise<void> {
    ...
    console.info(`\nScriptVM per-record execution cost (${ITERATIONS} iterations each, µs):\n`)
