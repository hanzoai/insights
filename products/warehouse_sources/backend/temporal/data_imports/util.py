...
from insights.exceptions import capture_exception
...
class InsightsInternalDatabaseError(Exception):
    """Raised when shared pipeline code fails to reach Insights's own database.
