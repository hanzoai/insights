...
from insights.schema import AlertConditionType, AlertState, InsightThresholdType
...
class TestRunAlertCheck(APIBaseTest):
    ...
    @patch("insights.tasks.alerts.utils.send_notifications_for_breaches", return_value=["user1@example.com"])
    @patch("insights.tasks.alerts.test.alert_check_helpers.check_alert_for_insight")
