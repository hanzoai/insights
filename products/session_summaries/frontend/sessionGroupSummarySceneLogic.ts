...
export interface sessionGroupSummarySceneLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface sessionGroupSummarySceneLogicActions {
    closeSessionDetails: () => {
        value: true
    }
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface sessionGroupSummarySceneLogicMeta {
    key: string
...
export type sessionGroupSummarySceneLogicType = MakeLogicType<
    sessionGroupSummarySceneLogicValues,
    sessionGroupSummarySceneLogicActions,
    SessionGroupSummarySceneLogicProps,
    sessionGroupSummarySceneLogicMeta
>
...
export const sessionGroupSummarySceneLogic = kea<sessionGroupSummarySceneLogicType>([
    ...
    selectors({
        sessionGroupSummaryMissing: [
            ...
            (sessionGroupSummary: SessionGroupSummaryType | null, sessionGroupSummaryLoading: boolean): boolean => {
        ...
        breadcrumbs: [
            ...
            (sessionGroupSummary: SessionGroupSummaryType | null): Breadcrumb[] => [
                {
