...
import type { insightsFunctionTestLogicType } from './insightsFunctionTestLogicType'
...
export const insightsFunctionTestLogic = kea<insightsFunctionTestLogicType>([
    ...
    path((id) => ['scenes', 'pipeline', 'customfunctions', 'insightsFunctionTestLogic', id]),
    ...
    forms(({ props, actions, values }) => ({
        testInvocation: {
            ...
            submit: async (data) => {
                ...
                configuration.fn = values.currentScriptCode
