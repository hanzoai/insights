...
@patch("insights.tasks.alerts.utils.send_notifications_for_errors", return_value=[])
@patch("insights.tasks.alerts.utils.send_notifications_for_breaches", return_value=[])
class TestAlertEvaluation(APIBaseTest, DatastoreDestroyTablesMixin):
    def setUp(self) -> None:
        super().setUp()
