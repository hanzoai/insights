...
from insights.models.user_push_token import UserPushToken
from insights.push_notifications import send_push_to_user
...
def _flag_check_factory():
    ...
    def check_flag(flag_name, *_args, **_kwargs):
        return flag_name in {"tasks", "insights-code-mobile-push"}
...
class PresenceAPITestCase(TestCase):
    def setUp(self) -> None:
        ...
        self.flag_patcher = patch("hanzo_insights.feature_enabled", side_effect=_flag_check_factory())
...
class PresencePushHelperSuppressionTestCase(TestCase):
    ...
    @patch("insights.push_notifications._send_batch")
