...
export interface taxonomicFilterPinnedPropertiesLogicValues {
    featureFlags: FeatureFlagsSet // featureFlagLogic
    isPinned: (groupType: TaxonomicFilterGroupType, value: TaxonomicFilterValue) => boolean
    pinnedFilterItems: TaxonomicDefinitionTypes[]
    pinnedFilters: PinnedTaxonomicFilter[]
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface taxonomicFilterPinnedPropertiesLogicActions {
    clearPinnedFilters: () => {
        value: true
    }
    setPinnedFilters: (filters: PinnedTaxonomicFilter[]) => {
        filters: PinnedTaxonomicFilter[]
    }
    togglePin: (
        groupType: TaxonomicFilterGroupType,
        groupName: string,
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface taxonomicFilterPinnedPropertiesLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        pinnedFilterItems: (pinnedFilters: PinnedTaxonomicFilter[]) => TaxonomicDefinitionTypes[]
        isPinned: (
            pinnedFilters: PinnedTaxonomicFilter[]
...
export type taxonomicFilterPinnedPropertiesLogicType = MakeLogicType<
    taxonomicFilterPinnedPropertiesLogicValues,
    taxonomicFilterPinnedPropertiesLogicActions,
    Record<string, any>,
    taxonomicFilterPinnedPropertiesLogicMeta
>
...
export const taxonomicFilterPinnedPropertiesLogic = kea<taxonomicFilterPinnedPropertiesLogicType>([
    ...
    listeners(({ values }) => ({
        togglePin: ({ groupType, value }) => {
            ...
            insights.capture('taxonomic filter pin toggled', {
                groupType,
                value: String(value),
    ...
    events(({ actions, values }) => ({
        afterMount: () => {
            ...
            const seedDefaultPinnedFilters = (): void => {
                ...
                insights.capture('taxonomic filter default pins seeded', {
