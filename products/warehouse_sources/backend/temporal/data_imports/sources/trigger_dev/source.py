...
class TriggerDevSource(ResumableSource[TriggerDevSourceConfig, TriggerDevResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Trigger.dev secret API key to sync your task run history into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/trigger-dev",
