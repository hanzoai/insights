...
from insights.temporal.data_imports.sources.generated_configs import MetaAdsSourceConfig
from insights.temporal.data_imports.sources.meta_ads.meta_ads import meta_ads_source
from insights.temporal.data_imports.sources.meta_ads.schemas import ENDPOINTS, INCREMENTAL_FIELDS
...
class MetaAdsSource(SimpleSource[MetaAdsSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Meta Ads",
            caption="Ensure you have granted Insights access to your Meta Ads account, learn how to do this in the [documentation](https://hanzo.ai/docs/cdp/sources/meta-ads).",
