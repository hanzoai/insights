...
AnyAssistantGeneratedQuery = (
    AssistantTrendsQuery | AssistantFunnelsQuery | AssistantRetentionQuery | AssistantInsightsQLQuery
)
...
class InsightArtifact(TaskArtifact):
    ...
    query: Union[AssistantTrendsQuery, AssistantFunnelsQuery, AssistantRetentionQuery, AssistantInsightsQLQuery]
...
class AssistantNodeName(StrEnum):
    ...
    INSIGHTSQL_GENERATOR = "insightsql_generator"
    INSIGHTSQL_GENERATOR_TOOLS = "insightsql_generator_tools"
