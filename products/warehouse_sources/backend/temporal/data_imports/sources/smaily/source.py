...
class SmailySource(ResumableSource[SmailySourceConfig, SmailyResumeConfig]):
    ...
    api_docs_url = "https://smaily.com/help/api/"
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Smaily API credentials to pull your email marketing data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/smaily",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
