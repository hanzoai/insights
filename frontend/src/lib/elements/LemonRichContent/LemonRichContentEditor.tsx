...
export function RichContentEditor({
    ...
    disabled = false,
    minRows,
}: RichContentEditorProps): JSX.Element {
    ...
    return (
        <div ref={dropRef} className="RichContentEditor flex flex-col border rounded divide-y mt-4 input-like">
            ...
            <div className="flex justify-between p-0.5">
                ...
                <div className="flex items-center gap-0.5">
                    <Button size="small" active={!isPreviewShown} onClick={() => setIsPreviewShown(false)}>
                        <IconPencil />
                    </Button>
                    <Button size="small" active={isPreviewShown} onClick={() => setIsPreviewShown(true)}>
                        <IconEye />
                    </Button>
                </div>
            </div>
