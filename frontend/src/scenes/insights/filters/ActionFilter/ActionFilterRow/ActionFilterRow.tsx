...
import { InsightsQLMathEditorDropdown } from './InsightsQLMathEditor'
import { MathSelector } from './MathSelector'
import { getDefaultMathInsightsQLExpression } from './mathUtils'
        ...
        if (selectedMath) {
            ...
            const math_insightsql =
                mathDefinitions[selectedMath]?.category === MathCategory.InsightsQLExpression
                    ? (mathInsightsQL ?? defaultMathInsightsQLExpression)
                    : undefined
            mathProperties = {
                                ...
                                mathAvailability !== MathAvailability.FunnelsOnly && (
                                    <>
                                        ...
                                        {mathDefinitions[math || BaseMathType.TotalCount]?.category ===
                                            ...
                                            <InsightsQLMathEditorDropdown
                                                mathInsightsQL={mathInsightsQL}
                                                index={index}
                                                onMathInsightsQLSelect={onMathInsightsQLSelect}
                                            />
                                        )}
                                    </>
                                )}
