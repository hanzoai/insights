...
class CapsuleCRMSource(ResumableSource[CapsuleCRMSourceConfig, CapsuleCRMResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Capsule CRM Personal Access Token to automatically pull your Capsule CRM data into the Insights Data warehouse.
...
The token inherits your user's permissions, so make sure your user can see the records you want to sync (parties, opportunities, projects, tasks).""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/capsule-crm",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
