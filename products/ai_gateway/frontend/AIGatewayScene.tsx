...
const AI_GATEWAY_DESCRIPTION =
    ...
    'Insights tracks its usage, cost, and spend for you. Any project secret key with the llm_gateway:read scope ' +
            ...
            <SceneSection
                ...
                description={
                    <>
                        ...
                        with no SDK instrumentation needed. Already sending generations through a Insights LLM SDK?
...
function GatewayIntro(): JSX.Element {
    return (
        <div className="border-2 border-dashed border-primary w-full p-6 rounded flex items-center gap-6">
            <MascotRobot className="w-32 hidden md:block shrink-0" />
