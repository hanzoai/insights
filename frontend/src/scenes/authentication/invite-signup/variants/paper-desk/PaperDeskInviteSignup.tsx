    ...
    const inviteHeader = (
        <div className="flex flex-col gap-3 items-center mb-5">
            ...
            <div className="text-center">
                ...
                <p className="m-0 mt-1.5 text-sm text-secondary">on Insights</p>
            </div>
        </div>
    )
        ...
        <PaperDeskScene notes={["// you've been invited", `// ${org.toLowerCase()} is waiting`]}>
            <PaperDeskCard top={inviteHeader} footer={footer}>
                ...
                <Form logic={inviteSignupLogic} formKey="signup" enableFormOnSubmit className="flex flex-col gap-4">
                    <Field.Pure label="Email" help="The invite is tied to this address.">
                        <Input type="email" value={invite.target_email} disabled fullWidth />
                    </Field.Pure>
    ...
    return (
        <PaperDeskScene notes={['// hey, welcome back', '// one more org for you']}>
            <PaperDeskCard>
                ...
                <CardTitle
                    title={`Join ${org}`}
                    sub="You'll accept this invite with your existing Insights account:"
                    className="mb-4"
                />
                {user && (
                    <div
        ...
        <PaperDeskScene notes={['// hmm', "// this invite isn't right"]}>
            <PaperDeskCard footer={footer}>
                <div className="flex flex-col items-center text-center">
                    <MascotJudge className="block w-auto mx-auto h-28" />
                    ...
                    <div className="flex flex-col gap-2.5 w-full">
                        {user ? (
                            <Button size="large" center fullWidth type="primary" to={urls.default()}>
                                Go back to Insights
                            </Button>
