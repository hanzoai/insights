...
pub const HOGVM_ERRORS: &str = "seeder_scriptvm_errors_total";
...
pub const PERSON_HOGVM_ERRORS: &str = "seeder_person_scriptvm_errors_total";
...
/// this spans all three, where the behavioral metric times the Datastore scan alone and accounts
