...
// Claims extracted from a insights:stream_read JWT (GET /v1/runs/:run/stream leg)
...
// Claims extracted from a insights:sandbox_event_ingest JWT (POST /v1/runs/:run/ingest leg)
