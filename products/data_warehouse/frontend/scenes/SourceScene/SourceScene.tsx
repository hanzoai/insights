...
export interface sourceSceneLogicActions {
    _setCurrentTab: (tab: SourceSceneTab) => {
        tab: 'configuration' | 'history' | 'metrics' | 'schemas' | 'syncs' | 'webhook'
    }
...
function ManagedSourceTabs({
    ...
    const tabs: Tab<SourceSceneTab | 'access-control'>[] = [
...
export function ApiVersionDeprecationBanner({
    ...
    return (
        <Banner type="warning">
            ...
            {cta ??
                `Contact Insights support to migrate this source to version ${deprecation.default_version} before syncs stop working.`}
        </Banner>
    )
}
