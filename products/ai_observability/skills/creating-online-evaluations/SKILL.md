...
description: >
  Author continuously-running online evaluations in Insights AI observability, grounded in a real failure
  ...
  "turn this failure into an eval". Covers choosing the target and eval type (script / llm_judge / sentiment),
...
New Script source should use the globals shared by both targets:
