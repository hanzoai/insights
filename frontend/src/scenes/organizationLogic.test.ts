...
describe('organizationLogic', () => {
    ...
    describe('if INSIGHTS_APP_CONTEXT is undefined', () => {
    ...
    describe('if organization not in INSIGHTS_APP_CONTEXT', () => {
        // In production INSIGHTS_APP_CONTEXT is always present (server-rendered in insights/templates/head.html),
