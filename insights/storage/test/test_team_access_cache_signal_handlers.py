...
from insights.storage.team_access_cache_signal_handlers import (
...
class TestCaptureOldPakSecureValue(TestCase):
    @patch("insights.storage.team_access_cache_signal_handlers.PersonalAPIKey")
...
class TestCaptureOldPsakSecureValue(TestCase):
    @patch("insights.storage.team_access_cache_signal_handlers.ProjectSecretAPIKey")
...
class TestCaptureOldSecretTokens(TestCase):
    ...
    @patch("insights.storage.team_access_cache_signal_handlers.Team")
...
class TestUserSavedSignalHandler(TestCase):
    ...
    @patch("insights.tasks.team_access_cache_tasks.invalidate_user_tokens_sync")
    @patch("django.db.transaction.on_commit")
...
class TestPersonalApiKeySavedSignalHandler(TestCase):
    ...
    @patch("insights.tasks.team_access_cache_tasks.invalidate_token_cache_task")
    @patch("insights.tasks.team_access_cache_tasks.token_auth_cache")
    @patch("django.db.transaction.on_commit")
