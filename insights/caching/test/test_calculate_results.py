...
from insights.api.services.query import ExecutionMode, RawCachedQueryResponse
...
class TestCalculateForQueryBasedInsight(BaseTest):
    def _calculate(self, response, allow_raw_results: bool = False):
        ...
        with patch("insights.caching.calculate_results.process_query_dict", return_value=response):
