...
from insights.management.commands.backfill_precalculated_events import (
    MAX_BACKFILL_DAYS,
    Command,
...
class TestBackfillPrecalculatedEventsCommand(BaseTest):
    ...
    def test_cross_cohort_deduplication(self):
        ...
        with patch(
            "insights.management.commands.backfill_precalculated_events.Command.run_temporal_workflow"
        ) as mock_workflow:
...
class TestRunTemporalWorkflow(BaseTest):
    ...
    def test_starts_workflow_with_expected_inputs_and_task_queue(self):
        ...
        with (
            patch(
                "insights.management.commands.backfill_precalculated_events.async_connect",
                new=AsyncMock(return_value=mock_client),
            ),
            patch(
                "insights.management.commands.backfill_precalculated_events.store_event_filters",
