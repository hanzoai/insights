...
const DOCS = {
    intent: 'https://hanzo.ai/docs/mcp-analytics/intent',
    conversationId: 'https://hanzo.ai/docs/mcp-analytics/conversation-id',
    missingCapability: 'https://hanzo.ai/docs/mcp-analytics/missing-capability',
}
