...
class TestClassifyPostgresCDCError:
    @parameterized.expand(
        [
            (
                ...
                psycopg.errors.InvalidPassword('password authentication failed for user "insights"'),
            ...
            (
                "slot_missing",
                psycopg.errors.UndefinedObject('replication slot "insights_slot" does not exist'),
                CDCErrorCategory.SLOT_MISSING,
            ),
            (
                "publication_missing",
                psycopg.errors.UndefinedObject('publication "insights_pub" does not exist'),
                CDCErrorCategory.PUBLICATION_MISSING,
            ),
            (
                "slot_in_use",
                psycopg.errors.ObjectInUse('replication slot "insights_slot" is active for PID 123'),
    ...
    def test_slot_in_use_takes_precedence_over_does_not_exist_wording(self):
        ...
        exc = psycopg.errors.ObjectInUse('replication slot "insights_slot" is active for PID 99')
