...
class GridlySource(ResumableSource[GridlySourceConfig, GridlyResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Gridly API key and a View ID to pull that view's records into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/gridly",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
