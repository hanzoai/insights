...
class TestResolveTableAndFolderNames:
    ...
    def test_table_name_unchanged_for_camelcase_source(self) -> None:
        # The regression guard: a populated (snake_cased) folder must NOT rename the InsightsQL table.
    ...
    @parameterized.expand(
        [
            ...
            # InsightsQL `github.insights_insights__issues`. A bare slash surviving here produces an
            # unqueryable table name.
            ("github_qualified", "GitHub", "insights/insights.issues", "github_insights_insights__issues"),
            ("github_legacy_bare", "GitHub", "issues", "github_issues"),
            ("github_dotted_repo", "GitHub", "insights/next.js.issues", "github_insights_next__js__issues"),
        ]
    )
