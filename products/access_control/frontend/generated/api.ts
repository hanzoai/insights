...
export const getPropertyAccessControlsRetrieveUrl = (
    ...
    return stringifiedParams.length > 0
        ? `/v1/projects/${projectId}/property_access_controls/?${stringifiedParams}`
        : `/v1/projects/${projectId}/property_access_controls/`
}
...
export const getPropertyAccessControlsCreateUrl = (projectId: string) => {
    return `/v1/projects/${projectId}/property_access_controls/`
}
