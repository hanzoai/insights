...
describe('clustersTabContentLogic', () => {
    ...
    describe('initialization', () => {
        it('uses traceId as key', () => {
            mockApi.queryInsightsQL = jest.fn().mockResolvedValue({ results: [] })
        ...
        it('loads clusters on mount', async () => {
            ...
            expect(mockApi.queryInsightsQL).toHaveBeenCalled()
        })
    })
    ...
    describe('loaders', () => {
        describe('loadClusters', () => {
            ...
            it('finds clusters containing the trace', async () => {
                mockApi.queryInsightsQL = jest.fn().mockResolvedValue({
