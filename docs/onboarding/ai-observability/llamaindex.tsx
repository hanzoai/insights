    ...
    return [
                ...
                <>
                    <CalloutBox type="info" icon="IconInfo" title="Full working examples">
                        <Markdown>
                            ...
                            example](https://github.com/Insights/insights-python/tree/master/examples/example-ai-llamaindex)
                            on GitHub. If you use the Insights SDK wrapper instead of OpenTelemetry, see this example
                            instead: [Python wrapper
                            example](https://github.com/Insights/insights-python/tree/7223c52/examples/example-ai-llamaindex).
                        </Markdown>
                    </CalloutBox>
                    ...
                    <CodeBlock
                        language="bash"
                        code={dedent`
                            pip install llama-index llama-index-llms-openai opentelemetry-sdk "insights[otel]" opentelemetry-instrumentation-openai-v2
                        `}
                    />
                </>
            ),
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        Configure OpenTelemetry to auto-instrument LlamaIndex calls and export traces to Insights.
                    ...
                    <CalloutBox type="fyi" icon="IconInfo" title="What gets captured">
                        <Markdown>
                            ...
                            [manual capture](https://hanzo.ai/docs/ai-observability/installation/manual-capture).
                        </Markdown>
                    </CalloutBox>
                </>
            ),
