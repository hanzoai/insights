...
from products.warehouse_sources.backend.temporal.data_imports.sources.generated_configs.usbls import UsBlsSourceConfig
...
class UsBlsSource(SimpleSource[UsBlsSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            name=SchemaExternalDataSourceType.US_BLS,
