...
from insights.models import EventDefinition, ObjectMediaPreview, UploadedMedia
    ...
    def create(self, validated_data):
        ...
        if uploaded_media_id:
            try:
                ...
                raise ValidationError("Uploaded media not found or does not belong to this project")
        ...
        if exported_asset_id:
            ...
            try:
                ...
                raise ValidationError("Exported asset not found or does not belong to this project")

        try:
            event_definition = EventDefinition.objects.get(id=event_definition_id, team=team)
        except EventDefinition.DoesNotExist:
            raise ValidationError("Event definition not found or does not belong to this project")
