...
/// `_serialize_cohort()` in insights/models/feature_flag/flags_cache.py. Field changes
...
/// property filter. Mirrors `FilterOrGroup` in insights/api/cohort.py — the cohort UI
