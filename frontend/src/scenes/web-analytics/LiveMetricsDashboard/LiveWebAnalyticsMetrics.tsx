    ...
    const filtersContent = (
        <div className="w-96 max-w-[90vw] p-3">
            <div className="space-y-4">
                ...
                {hasFilters && (
                    <Button size="small" type="tertiary" fullWidth icon={<IconX />} onClick={resetFilters}>
                        Clear filters
                    </Button>
                )}
            </div>
        ...
        <FilterBar
            ...
            right={
                <>
                    {isEditing ? (
                        <>
                            <Button type="secondary" size="small" onClick={() => resetLayout()}>
                                Reset layout
                            </Button>
                            <Button type="primary" size="small" onClick={() => setEditing(false)}>
                                Done
                            </Button>
                        </>
                    ) : (
    ...
    return (
        <div className="LivePageviews">
            ...
            {unstreamableTestAccountFilterCount > 0 && (
                <Banner type="warning" className="mb-2" dismissKey="live-web-analytics-test-account-stream-limit">
