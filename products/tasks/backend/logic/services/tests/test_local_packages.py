...
class TestGetLocalInsightsCodePackages:
    ...
    def test_returns_packages_when_everything_present(self, fake_monorepo: Path) -> None:
        ...
        assert packages[0].sandbox_install_path == "/scripts/node_modules/@hanzo/agent"
        assert packages[0].sandbox_build_output_path == "/scripts/node_modules/@hanzo/agent/dist"
