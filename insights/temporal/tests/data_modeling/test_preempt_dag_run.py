...
from insights.temporal.data_modeling.activities.preempt_dag_run import (
    ABANDONED_ERROR,
    PREEMPTED_ERROR,
    PreemptDAGRunInputs,
...
async def _run_activity(
    ...
    with unittest.mock.patch(
        "insights.temporal.data_modeling.activities.preempt_dag_run.async_connect",
...
async def test_owned_workflows_are_cancelled_even_if_reaping_blows_up(ateam, tier_jobs) -> None:
    ...
    with unittest.mock.patch(
        "insights.temporal.data_modeling.activities.preempt_dag_run._abandoned_jobs",
