...
class TestSessionLookupUsesUuidv7Bound(DatastoreTestMixin, APIBaseTest):
...
class TestBatchExists(DatastoreTestMixin, APIBaseTest):
...
class TestGetLatestSessionEventProperties(DatastoreTestMixin, APIBaseTest):
