...
import { IconBolt, IconDatabaseBolt } from '@hanzo/icons'
...
const QUERY_ENGINE_DOCS_URL = 'https://hanzo.ai/docs/web-analytics/faq#what-does-the-pre-computed-badge-mean'
