...
from insights.insightsql_queries.web_analytics.external.summary_query_runner import (
    QueryResult,
...
class TestWebAnalyticsExternalSummaryQueryRunner(APIBaseTest):
    ...
    @patch("insights.insightsql_queries.web_analytics.external.summary_query_runner.chdb")
    ...
    @patch("insights.insightsql_queries.web_analytics.external.summary_query_runner.build_function_call")
