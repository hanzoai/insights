    ...
    return (
        <div className="deprecated-space-y-2">
            <div className="flex items-center gap-1">
                ...
                <Tooltip
                    title="An optional AI agent that investigates anomaly fires against this insight's own data. It runs read-only InsightsQL queries, looks at the metric chart, and writes its findings to a notebook linked from the alert history. You can also have it gate notifications so false positives don't page you."
                    placement="right"
                    delayMs={0}
                >
                    <IconInfo />
