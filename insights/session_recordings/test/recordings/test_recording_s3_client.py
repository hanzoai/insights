...
from insights.session_recordings.recordings.errors import FileFetchError, FileUploadError
from insights.session_recordings.recordings.recording_s3_client import (
...
class TestRecordingS3Client(APIBaseTest):
    ...
    @patch("insights.session_recordings.recordings.recording_s3_client.boto3_client")
...
class TestAsyncRecordingS3Client(APIBaseTest):
    ...
    @patch("insights.session_recordings.recordings.recording_s3_client.aioboto3")
