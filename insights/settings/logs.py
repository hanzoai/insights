...
from insights.settings.base_variables import DEBUG, IS_INTERACTIVE_SHELL, TEST
...
# insights/management/commands/shell.py. Startup is forced to ERROR below so app-ready
...
LOGGING: dict[str, Any] = {
    ...
    "filters": {
        "filter_statsd": {
            "()": "insights.settings.logs.FilterStatsd",
        },
        "max_level_info": {
            "()": "insights.settings.logs.MaxLevelFilter",
            "level": logging.INFO,
        },
    },
    "handlers": {
    ...
    "loggers": {
        ...
        "insights.caching.warming": {"level": "INFO", "handlers": ["console"], "propagate": False},
        "insights.tasks.alerts": {"level": "INFO", "handlers": ["console"], "propagate": False},
        "insights.tasks.split_person": {"level": "INFO", "handlers": ["console"], "propagate": False},
        "insights.tasks.email": {"level": "INFO", "handlers": ["console"], "propagate": False},
        "products.exports.backend.tasks": {"level": "INFO", "handlers": ["console"], "propagate": False},
        "insights.tasks.ai_observability_usage_report": {"level": "INFO", "handlers": ["console"], "propagate": False},
        ...
        "insights.tasks.hypercache_verification": {
            "level": "INFO",
            "handlers": ["console_stdout_info", "console_stderr_warning"],
            "propagate": False,
        },
        "insights.storage.hypercache_verifier": {
            "level": "INFO",
            "handlers": ["console_stdout_info", "console_stderr_warning"],
            "propagate": False,
        },
        ...
        "insights.auth.mfa": {"level": "INFO", "handlers": ["console"], "propagate": False},
        "insights.security.command_exec_audit": {"level": "INFO", "handlers": ["console"], "propagate": False},
        "products.warehouse_sources.backend.temporal.data_imports.pipelines.pipeline_v3.load": {
            "level": "DEBUG",
            "handlers": ["console"],
            "propagate": False,
        },
        "insights.models.resource_transfer.inter_project_transferer": {
            "level": "INFO",
            "handlers": ["console"],
            "propagate": False,
        },
