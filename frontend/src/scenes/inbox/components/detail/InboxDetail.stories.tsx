    ...
    checks: [
        {
            ...
            status: 'completed',
            conclusion: 'failure',
            url: 'https://github.com/Insights/insights/actions/runs/12001/jobs/1',
        },
        {
            name: 'Backend CI / Django tests – Core (persons-on-events off), Python 3.13, Datastore 26.3',
            status: 'in_progress',
            conclusion: null,
            url: 'https://github.com/Insights/insights/actions/runs/12001/jobs/2',
        },
        {
            name: 'Product analytics / Jest',
            status: 'completed',
            conclusion: 'success',
            url: 'https://github.com/Insights/insights/actions/runs/12001/jobs/3',
        },
        {
            name: 'Visual regression',
            status: 'completed',
            conclusion: 'cancelled',
            url: 'https://github.com/Insights/insights/actions/runs/12001/jobs/4',
        },
        {
            name: 'Dependency review',
            status: 'completed',
            conclusion: 'stale',
            url: 'https://github.com/Insights/insights/actions/runs/12001/jobs/5',
        },
        {
            name: 'Codecov / project',
            status: 'completed',
            conclusion: 'neutral',
            url: 'https://app.codecov.io/gh/Insights/insights',
        },
    ],
}
...
const successfulPrChecks = {
    checks: [
        ...
        status: 'completed',
        conclusion: 'success',
        url: `https://github.com/Insights/insights/actions/runs/12002/jobs/${index + 1}`,
    })),
}
...
const reviewComment = (
    ...
    url: `https://github.com/Insights/insights/pull/12001#discussion_r${overrides.id}`,
    comment_type: 'review',
