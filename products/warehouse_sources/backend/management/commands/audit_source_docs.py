...
# Matches the slug in a hanzo.ai source docsUrl, e.g.
# https://hanzo.ai/docs/cdp/sources/active-campaign -> "active-campaign".
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser: Any) -> None:
        parser.add_argument(
            "--docs-dir",
            required=True,
            help="Path to hanzo.ai/contents/docs/cdp/sources in a local hanzo.ai checkout.",
        )
