...
function BundledMarkdown({ content }: { content: string }): JSX.Element {
    ...
    return (
        <>
            ...
            <MarkdownWithMermaid className="text-sm" generateHeadingIds>
                {body}
            </MarkdownWithMermaid>
        </>
    )
                ...
                <div className="border-t bg-bg-light px-3 py-2">
                    {contentLoading ? (
                        <div className="space-y-2">
                            <Skeleton active className="h-3 w-full" />
                            <Skeleton active className="h-3 w-3/4" />
...
function SkillEditForm({
    ...
    const onDrop = (e: React.DragEvent): void => {
        ...
        void collectFilesFromDrop(e.dataTransfer)
            ...
            .catch(() => {
                toast.error('Couldn\'t read the dropped files. Try the "Upload files" button instead.')
            })
    }
    ...
    return (
        <div className="mt-4 max-w-3xl space-y-4">
            ...
            <Field name="license" label="License" help="Optional. License name or reference.">
                <Input data-attr="llma-skill-license-input" placeholder="Apache-2.0" maxLength={255} fullWidth />
            </Field>
            ...
            >
                ...
                {fileContentsLoading ? (
                    <div className="space-y-2 rounded border p-3">
                        <Skeleton active className="h-3 w-1/3" />
                        <Skeleton active className="h-3 w-full" />
                        <Skeleton active className="h-3 w-2/3" />
                    </div>
