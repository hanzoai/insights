...
from products.exports.backend.temporal.subscriptions.snapshot_activities import (
    MAX_SUMMARY_IMAGES,
...
def test_loads_bytes_from_object_storage_when_content_empty(team, user):
    ...
    with patch(
        "products.exports.backend.temporal.subscriptions.snapshot_activities.object_storage.read_bytes",
...
def _over_image_size_cap_scenario(team, user):
    from products.exports.backend.temporal.subscriptions import snapshot_activities
