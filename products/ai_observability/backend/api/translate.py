...
from insights.rate_limit import (
    AIObservabilityTranslationBurstThrottle,
    AIObservabilityTranslationDailyThrottle,
    AIObservabilityTranslationSustainedThrottle,
)
...
class AIObservabilityTranslateViewSet(TeamAndOrgViewSetMixin, viewsets.GenericViewSet):
