...
CANONICAL_DESCRIPTIONS: CanonicalDescriptions = {
    ...
    "tags": {
        ...
        "columns": {
            ...
            "namespace": "Namespace (user or organization) that owns the repository. Added by Insights to every row.",
            "repository_name": "Name of the repository the tag belongs to. Added by Insights to every row.",
