...
from insights.datastore.query_tagging import Feature, Product, tag_queries, tags_context
...
# Relocated to the Django-free insights.week_start_day module so the InsightsQL engine can use it
# without booting Django; re-exported here for existing callers.
from insights.week_start_day import WeekStartDay  # noqa: F401
...
if TYPE_CHECKING:
    from insights.schema import PathCleaningFilter
...
DEPRECATED_ATTRS = (
    ...
    # Replaced by the `revenue_analytics_config` extension; only the raw-SQL Postgres->Datastore
...
class TeamManager(models.Manager):
    ...
    def create_with_data(self, *, initiating_user: Optional["User"], **kwargs) -> "Team":
        ...
        from insights.helpers.dashboard_templates import create_from_template  # noqa: PLC0415 — breaks team import cycle
        ...
        from insights.tasks.tasks import sync_user_product_lists_for_new_team
...
class Team(UUIDTClassicModel):
    ...
    # the InsightsQL hot path. Default 84 (7 years) grandfathers existing teams. db_default because insights_team is also
    ...
    def path_cleaning_filter_models(self) -> list["PathCleaningFilter"]:
        from insights.schema import PathCleaningFilter  # noqa: PLC0415
    ...
    def kick_off_demo_data_generation(self, initiating_user: "User") -> None:
        from insights.tasks.demo_create_data import create_data_for_demo_team
