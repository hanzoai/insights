...
logo.dev meters usage per account, and each Insights instance configures the image and Search API
...
:mod:`insights.cdp.services.icons` directs — steady-state traffic tracks unique (user, icon) first
...
from insights.egress.limiter.policies import Priority, RatePolicy, register_policy
