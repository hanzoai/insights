...
} from './flow-batch-person-query.service'
...
describe('FlowBatchPersonQueryService', () => {
    ...
    const createService = (): FlowBatchPersonQueryService => {
        return new FlowBatchPersonQueryService({ fetch: fetchMock } as any)
    }
    ...
    describe('getBlastRadius', () => {
        it('calls the Django endpoint and returns parsed response', async () => {
            ...
            expect(fetchMock).toHaveBeenCalledWith({
                urlPath: '/v1/projects/123/internal/insights_flows/user_blast_radius',
                fetchParams: {
                    method: 'POST',
                    body: JSON.stringify({
                        filters,
    ...
    describe('getBlastRadiusPersons', () => {
        it("uses the first page's cursor for the next page request", async () => {
            ...
            expect(fetchMock).toHaveBeenNthCalledWith(1, {
                urlPath: '/v1/projects/123/internal/insights_flows/user_blast_radius_persons',
                fetchParams: {
                    method: 'POST',
                    body: JSON.stringify({
                        filters,
    ...
    describe('getAccountAudiencePage', () => {
        ...
        it('calls the Django endpoint and returns parsed response', async () => {
            ...
            expect(fetchMock).toHaveBeenCalledWith({
                urlPath: '/v1/projects/123/internal/insights_flows/account_audience',
                fetchParams: {
                    method: 'POST',
                    body: JSON.stringify({
