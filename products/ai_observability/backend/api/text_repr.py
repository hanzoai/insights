...
from insights.rate_limit import AIObservabilityTextReprBurstThrottle, AIObservabilityTextReprSustainedThrottle
...
from products.ai_observability.backend.text_repr.formatters.constants import DEFAULT_MAX_LENGTH
...
class AIObservabilityTextReprViewSet(TeamAndOrgViewSetMixin, viewsets.GenericViewSet):
    """
    ...
    def get_throttles(self):
        ...
        return [AIObservabilityTextReprBurstThrottle(), AIObservabilityTextReprSustainedThrottle()]
