...
import { Banner, Card, Input, SegmentedButton, Tag } from '@hanzo/elements'
        ...
        <div className="space-y-6">
            <Field name="query">
                {({ value, onChange }) => {
                    ...
                    return (
                        <Card hoverEffect={false} className="p-3 space-y-3">
                            <div className="flex items-start justify-between gap-2">
                                <div className="space-y-1">
                                    <Label>Recording filters</Label>
                            ...
                            {groupHasEventProperty(universal.filter_group) && (
                                <Banner type="info" dismissKey="replay-vision-event-vs-person-property-hint">
                                    <span className="text-xs">
                                ...
                                <div className="space-y-1">
                                    <div className="flex flex-wrap items-center gap-2">
                                        ...
                                        <Tooltip title="Recordings with more than 1 hour of active interaction take too long to analyze well, so Vision always skips them. This limit can't be changed.">
                                            <Tag type="muted" className="cursor-default">
            ...
            <Field name="sampling_mode">
                {({ value, onChange }) => {
                    ...
                    return (
                        <Card hoverEffect={false} className="p-3 space-y-3">
                            <div className="space-y-1">
                                <Label info="Filters which matching recordings this scanner watches, based on how much activity a recording has (interactions, errors, navigation). Narrower options skip low-activity recordings so your budget goes to recordings worth watching.">
                                    Session coverage
                                </Label>
                            </div>
                            <div className="space-y-1">
