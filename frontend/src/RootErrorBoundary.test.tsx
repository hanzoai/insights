...
describe('RootErrorBoundary', () => {
    ...
    it('reports render crashes to the capture API and shows crash copy', () => {
        ...
        expect(screen.getByRole('alert')).toHaveTextContent('Insights crashed while starting.')
    ...
    it('shows load-failure copy for chunk-load errors', () => {
        ...
        expect(screen.getByRole('alert')).toHaveTextContent('Insights failed to load.')
