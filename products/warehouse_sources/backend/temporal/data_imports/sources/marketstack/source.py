...
class MarketstackSource(ResumableSource[MarketstackSourceConfig, MarketstackResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Marketstack access key to pull end-of-day, intraday, splits, and dividends data plus market reference tables (tickers, exchanges, currencies, timezones) into the Insights Data warehouse.
...
Note: Marketstack pricing is a monthly request quota tied to your plan. Some tables (e.g. intraday) require a paid plan.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/marketstack",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
