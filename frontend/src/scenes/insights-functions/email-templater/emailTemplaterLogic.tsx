...
export interface EmailTemplaterLogicProps {
    ...
    onChangeTemplating?: (templating: 'script' | 'liquid') => void
    /**
...
export interface emailTemplaterLogicValues {
    ...
    templatingEngine: "liquid" | "script";
...
export interface emailTemplaterLogicActions {
    ...
    loadPersonPropertyDefinitionsFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadPersonPropertyDefinitionsSuccess: (personPropertyDefinitions: PropertyDefinition[], payload?: any) => {
        personPropertyDefinitions: PropertyDefinition[];
        payload?: any;
    };
    loadTemplates: () => any;
    ...
    setEmailTemplateValue: (key: FieldName, value: any) => {
        name: FieldName;
        value: any;
    };
    ...
    setTemplatingEngine: (templating: "liquid" | "script") => {
        templating: "liquid" | "script";
    };
    submitEmailTemplate: () => {
        value: boolean;
    };
    submitEmailTemplateFailure: (error: Error, errors: Record<string, any>) => {
        error: Error;
        errors: Record<string, any>;
    };
...
export type emailTemplaterLogicType = MakeLogicType<emailTemplaterLogicValues, emailTemplaterLogicActions, EmailTemplaterLogicProps, emailTemplaterLogicMeta>;
...
export const emailTemplaterLogic = kea<emailTemplaterLogicType>([
    ...
    actions({
        ...
        setTemplatingEngine: (templating: 'script' | 'liquid') => ({ templating }),
