...
from products.review.backend.reviewer.tools.github_meta import PRFetcher, PRFilter, PRParser

_META = "products.review.backend.reviewer.tools.github_meta"
...
class TestIsTestFile:
    @parameterized.expand(
        [
            ...
            ("nested_test_prefix", "insights/api/test_dashboard.py", True),
            ...
            ("latest_underscore_migration", "insights/migrations/0116_plugin_latest_tag.py", False),
            ("test_infix_migration", "insights/migrations/0132_team_test_account_filters.py", False),
