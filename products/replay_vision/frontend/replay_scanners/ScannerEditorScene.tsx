...
> = {
    configure: {
        mascot: <MascotMagnifyingGlass className="h-24 w-auto shrink-0" />,
        title: 'Configure your scanner',
        subtitle: 'What it looks for and how it analyzes recordings.',
    },
    triggers: {
        mascot: <MascotConstruction2 className="h-24 w-auto shrink-0" />,
        title: 'Set up scan conditions',
        subtitle: 'Pick which recordings to scan, and how often.',
    },
    self_driving: {
        mascot: <MascotImTheDriver className="h-24 w-auto shrink-0" />,
        title: 'Self-driving',
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1 items-start">
                <Field name="model" label="Model" className="items-start">
                    <Select value={scanner.model} options={MODEL_OPTIONS} />
                </Field>
                <div className="text-xs text-muted">
