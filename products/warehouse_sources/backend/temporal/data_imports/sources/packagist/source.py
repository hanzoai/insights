...
class PackagistSource(ResumableSource[PackagistSourceConfig, PackagistResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Pull metadata, download statistics, and security advisories for PHP packages from [Packagist](https://packagist.org) (the Composer package registry) into the Insights Data warehouse.
...
Download statistics sync incrementally per day; the other tables sync as a full refresh.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/packagist",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
