...
from insights.web_memory_sampler import current_rss_mb
...
_RUN_KEY_PREFIX = "insights:data_warehouse:workload:run:"
_HOST_KEY_PREFIX = "insights:data_warehouse:workload:host:"
    ...
    def _capture_high_watermark(self, outcome: str) -> None:
        ...
        try:
            ...
            if threshold <= 0 or self._peak_buffer_bytes < threshold:
                return
            import hanzo_insights  # noqa: PLC0415 — keeps the analytics client off this module's import path
