    ...
    const captureStep: StepDefinition = {
        ...
        content: (
            <>
                <Markdown>
                    {dedent`
                        Use \`NewDefaultException\` when you have an error value and want Insights to group it in Error tracking.
                    `}
                </Markdown>
                <CodeBlock
                    blocks={[
                        {
                            ...
                            code: dedent`
                                ...
                                if err != nil {
                                    client.Enqueue(insights.NewDefaultException(
                                        time.Now(),
                                        "user_distinct_id",
                                        "RuntimeError",
                                        err.Error(),
                ...
                <Markdown>
                    {dedent`
                        If you want to attach custom properties, enqueue a \`insights.Exception\` instead.
                    `}
                </Markdown>
                <CodeBlock
                    blocks={[
                        {
                            ...
                            file: 'Go',
                            code: dedent`
                                client.Enqueue(insights.Exception{
