...
_MODEL_TABLE = f"distributed_insights_document_embeddings_{EMBEDDING_MODEL.value.replace('-', '_')}"
_EMBEDDING = [0.0] * 1536


class _SignalEmbeddingsTestBase(DatastoreTestMixin, APIBaseTest):
    def _emit_version(
        self,
        *,
        document_id: str,
