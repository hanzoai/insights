---
name: review-script-perspective-performance-reliability
description: >
  The Performance & Reliability review perspective for Review. Verifies that changed code will
...
- Code style or formatting → not a Review concern
