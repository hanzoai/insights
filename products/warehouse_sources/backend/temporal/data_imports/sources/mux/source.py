...
class MuxSource(ResumableSource[MuxSourceConfig, MuxResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Mux Access Token ID and Secret Key to pull your Mux Video and Mux Data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/mux",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
