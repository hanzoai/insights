...
from insights.dags.common.loggers import structlog_console_logger
from insights.dags.locations import loggers

# Every code location module under `insights/dags/locations/`. The sweep below
...
def test_every_location_wires_the_shared_console_logger(module_name):
    module = importlib.import_module(f"insights.dags.locations.{module_name}")
