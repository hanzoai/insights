...
from insights.admin.authorization import can_trigger_admin_deletion
from insights.admin.inline_registry import extra_inlines_for
...
class OrganizationAdmin(admin.ModelAdmin):
    ...
    def get_inlines(self, request, obj=None):
        ...
        # this page without core importing it. See insights.admin.inline_registry.
    ...
    def trigger_deletion_view(self, request, organization_id):
        ...
        from insights.event_usage import report_organization_deleted, report_organization_deletion_initiated
        from insights.temporal.delete_teams.dispatch import start_delete_organization_workflow

        change_url = reverse("admin:insights_organization_change", args=[organization_id])
    ...
    def send_ai_observability_usage_report_view(self, request):
        ...
        return render(request, "admin/insights/organization/send_ai_observability_usage_report.html", {"form": form})
