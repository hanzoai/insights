...
class TestFilterDwhColumnsByEnabledColumns:
    dwh_columns = {
        "id": {"insightsql": "IntegerDatabaseField", "datastore": "Int64"},
        "email": {"insightsql": "StringDatabaseField", "datastore": "String"},
        "updated_at": {"insightsql": "DateTimeDatabaseField", "datastore": "DateTime"},
        "secret": {"insightsql": "StringDatabaseField", "datastore": "String"},
    }
