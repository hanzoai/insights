...
INVOICE_TEST_BUCKET = "test_storage_bucket-insights.revenue_analytics.overview_query_runner.stripe_invoices"
PRODUCT_TEST_BUCKET = "test_storage_bucket-insights.revenue_analytics.overview_query_runner.stripe_products"
CHARGES_TEST_BUCKET = "test_storage_bucket-insights.revenue_analytics.overview_query_runner.stripe_charges"
...
class TestRevenueAnalyticsOverviewQueryRunner(ClickhouseTestMixin, APIBaseTest):
    ...
    def test_convertToProjectTimezone_date_range_sql_snapshot(self):
        ...
        modifiers_with_tz = InsightsQLQueryModifiers(formatCsvAllowDoubleQuotes=True, convertToProjectTimezone=True)
        ...
        modifiers_utc = InsightsQLQueryModifiers(formatCsvAllowDoubleQuotes=True, convertToProjectTimezone=False)
