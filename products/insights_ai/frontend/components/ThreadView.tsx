 ...
 * instance is bound above it — a live Insights AI conversation or a read-only run viewer — and
...
export function ThreadView({
    ...
    // gated by !hasActiveProgressItem so real `_insights/progress` boot steps take precedence.
    const showThinking =
 ...
 * `_insights/progress` message when present; during `provisioning` (the conversations/open POST / cold
