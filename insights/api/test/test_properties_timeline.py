...
from insights.models.filters.mixins.base import BreakdownType
from insights.queries.properties_timeline.properties_timeline import PropertiesTimelineResult
