"""OTLP metrics push into the Insights Metrics product (Python twin of nodejs/src/common/metrics/otel-metrics.ts).
...
def _build_provider() -> "MeterProvider | None":
    ...
    from insights.security.outbound_proxy import internal_requests_session  # noqa: PLC0415
    ...
    resource = Resource.create(
        {
            "service.name": os.environ.get("OTEL_SERVICE_NAME") or "insights-python",
