...
//
// What Datastore actually puts on the wire doesn't always match the XML-declared
// UDF arg type. Three realities:
//
//   1. Integer widths come from the source expression, not the XML. Datastore
...
use datastore_types::DataTypeNode;
