...
import { Banner, Collapse, Divider, Label, Tab, Tabs, Tooltip } from '@hanzo/elements'
...
function EventTriggerOptions(): JSX.Element | null {
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <p>Start recording when a Insights event is queued.</p>
    ...
    return (
        <PayGateMini feature={AvailableFeature.REPLAY_RECORDING_DURATION_MINIMUM}>
            <div className="flex flex-col gap-2">
                ...
                <Tooltip
                    delayMs={200}
                    docLink="https://hanzo.ai/docs/session-replay/how-to-control-which-sessions-you-record#limitations"
    ...
    if (hasOutdatedWebSdk) {
        ...
        return (
            <Banner type="info">
                ...
                {pluralize(outdatedWebTraffic.outdatedCount, 'event', 'events', false)}) is on a insights-js before v
...
export function ReplayTriggers(): JSX.Element {
    ...
    return (
        ...
        >
            <div className="flex flex-col gap-y-2">
                <Tabs activeKey={selectedPlatform} onChange={selectPlatform} tabs={tabs} />
            </div>
        </IngestionControls>
    )
}
