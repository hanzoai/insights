...
CANONICAL_DESCRIPTIONS: CanonicalDescriptions = {
    ...
    "revisions": {
        ...
        "columns": {
            ...
            "app_id": "Identifier of the app this revision belongs to (added by Insights when fanning out over apps).",
            "app_slug": "Slug of the app this revision belongs to (added by Insights).",
    ...
    "analytics": {
        ...
        "columns": {
            "app_id": "Identifier of the app the metrics belong to (added by Insights when fanning out over apps).",
            "app_slug": "Slug of the app the metrics belong to (added by Insights).",
    ...
    "logs": {
        ...
        "docs_url": "https://docs.deno.com/deploy/api/",
        "columns": {
            "id": "Synthesized content-hash identifier (added by Insights so log lines can be deduplicated on re-sync).",
            "app_id": "Identifier of the app that emitted the log (added by Insights when fanning out over apps).",
            "app_slug": "Slug of the app that emitted the log (added by Insights).",
