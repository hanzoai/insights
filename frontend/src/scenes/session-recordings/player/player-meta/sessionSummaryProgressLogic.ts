...
export interface sessionSummaryProgressLogicValues {
    autoExpandSummary: boolean
    errorBySessionId: Record<string, string | null>
    feedbackBySessionId: Record<string, boolean>
    ...
    summaryIdBySessionId: Record<string, string | null>
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface sessionSummaryProgressLogicActions {
    cancelSummarization: (sessionId: SessionRecordingType['id']) => {
        sessionId: string
    }
    ...
    startSummarization: (sessionId: SessionRecordingType['id']) => {
        sessionId: string
    }
}

export type sessionSummaryProgressLogicType = MakeLogicType<
    sessionSummaryProgressLogicValues,
    sessionSummaryProgressLogicActions
>
