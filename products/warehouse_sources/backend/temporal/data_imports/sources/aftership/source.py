...
class AftershipSource(ResumableSource[AftershipSourceConfig, AftershipResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your AfterShip API key to pull your shipment tracking data into the Insights Data warehouse.
...
""",
            docsUrl="https://hanzo.ai/docs/cdp/sources/aftership",
