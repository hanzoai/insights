...
const threeRecordings = [
    {
        ...
        start_url: 'https://insights.hanzo.ai/signup/test-page-1',
        person: {
            id: 99999999999,
            name: 'test@hanzo.ai',
            distinct_ids: ['person-distinct-id-001'],
            properties: { $os: 'Mac OS X', email: 'test@hanzo.ai' },
    ...
    },
    {
        ...
        start_url: 'https://insights.hanzo.ai/dashboard',
        person: {
            id: 99999999999,
            name: 'test@hanzo.ai',
            distinct_ids: ['person-distinct-id-001'],
    ...
    },
    {
        ...
        start_url: 'https://insights.hanzo.ai/settings',
        person: {
            id: 99999999999,
            name: 'test@hanzo.ai',
            distinct_ids: ['person-distinct-id-001'],
...
const personQueryResponse = {
    ...
    results: [
        [
            ...
            '{"$os": "Mac OS X", "email": "test@hanzo.ai"}',
            1,
