...
describe('ResourceCatalog', () => {
    ...
    describe('readResource', () => {
        ...
        it('returns empty contents for unknown URI', async () => {
            ...
            const result = await catalog.readResource({ uri: 'insights://nonexistent' })
