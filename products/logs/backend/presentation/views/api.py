...
from insights.schema import DateRange, LogAttributesQuery, LogsOrderBy, LogsQuery, LogValuesQuery, PropertyGroupFilter
...
from insights.insightsql_queries.utils.time_sliced_query import time_sliced_results
...
from insights.tasks.exporter import export_asset
...
class _LogsQueryBodySerializer(serializers.Serializer):
    ...
    customColumns = serializers.ListField(
        ...
        help_text=(
            ...
            "(`attributes.<key>`, `resource_attributes.<key>`, `body.<json.path>`) or a scalar InsightsQL expression "
...
class _LogEntrySerializer(serializers.Serializer):
    ...
    level = serializers.CharField(help_text="Datastore alias for severity_text. Redundant; prefer severity_text.")
...
class LogsViewSet(TeamAndOrgViewSetMixin, PydanticModelMixin, viewsets.ViewSet):
    ...
    def get_throttles(self) -> list[BaseThrottle]:
        ...
        # Datastore work of a single patterns query, so it uses the tighter Datastore-specific
