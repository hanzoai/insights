...
from insights.temporal.ai.video_segment_clustering.activities import (
...
async def test_video_segment_clustering_workflow_creates_reports(ateam, test_segments_and_embeddings):
    ...
    async with await WorkflowEnvironment.start_time_skipping() as env:
        ...
        with patch(
            "insights.temporal.ai.video_segment_clustering.activities.a3_cluster_segments._fetch_embeddings_by_document_ids",
