...
from insights.temporal.ai_observability.evaluation_clustering.coordinator import _evaluation_jobs_for_team
...
from insights.temporal.ai_observability.evaluation_clustering.workflow import AIObservabilityEvaluationSamplerWorkflow
from insights.temporal.ai_observability.shared_activities import JobConfig
...
async def _run_sampler_with_mock_activity(
    ...
    against the derived window and forwarded fields without touching Datastore.
    """
