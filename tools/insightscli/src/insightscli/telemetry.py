"""Anonymous opt-out telemetry for insightscli CLI.

Events are queued in-process and sent as batch POSTs to a Insights-compatible
...
class TelemetryConfig(TypedDict, total=False):
    ...
    is_insights_org_member: bool
    org_check_timestamp: float


def get_config_path() -> Path:
    return Path.home() / ".config" / "insights" / "insightscli_telemetry.json"
...
class TelemetryClient:
    ...
    def show_first_run_notice_if_needed(self) -> None:
        ...
        click.echo(
            "\n"
            "insightscli collects anonymous usage data to help improve the developer experience.\n"
