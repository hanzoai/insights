...
# Mirrors frontend `SLACK_ARCHIVES_ORIGIN` in accountLinksLogic.ts. Insights-internal: hardcodes our
...
SLACK_ARCHIVES_ORIGIN = "https://insights.slack.com/archives"
...
# warehouse-synced billing data to report an account's Insights consumption (events ingested, rows
# synced, recordings, etc.) and spend (MRR, per-product cost). Insights-internal: they only resolve
...
# channel summaries. Hardcodes Insights's workspace — pre-GA compromise, see COMPROMISES.md.
