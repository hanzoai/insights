...
class ReplicateSource(ResumableSource[ReplicateSourceConfig, ReplicateResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Replicate API token to automatically pull your Replicate data into the Insights Data warehouse.
...
You can create an API token in your [Replicate account settings](https://replicate.com/account/api-tokens).""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/replicate",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
