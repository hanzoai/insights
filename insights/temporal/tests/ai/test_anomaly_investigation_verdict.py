...
import pytest
from insights.test.base import NonAtomicBaseTest
...
from insights.temporal.ai.anomaly_investigation.runner import InvestigationRunResult
from insights.temporal.ai.anomaly_investigation.workflow import (
...
class TestInvestigationVerdictPersistence(NonAtomicBaseTest):
    ...
    @pytest.mark.asyncio
    @patch("insights.temporal.ai.anomaly_investigation.workflow.run_investigation")
    ...
    @pytest.mark.asyncio
    @patch("insights.temporal.ai.anomaly_investigation.workflow.signals.emit_signal")
    @patch("insights.temporal.ai.anomaly_investigation.workflow.run_investigation")
    @patch("temporalio.activity.heartbeat")
    @patch("temporalio.activity.info")
