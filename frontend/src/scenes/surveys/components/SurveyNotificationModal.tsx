...
function TestResultPanel({
    ...
    return (
        <Banner type={bannerType} className="flex flex-col gap-2">
    ...
    return (
        <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-1.5">
                <Button size="xsmall" type="secondary" onClick={onReset}>
                    Use suggested format
                </Button>
                <Button size="xsmall" type="tertiary" onClick={onInsertSurveyName}>
                    Insert survey name
                </Button>
                <Button size="xsmall" type="tertiary" onClick={onInsertRespondentDetails}>
            ...
            footer={
                <>
                    {editingNotification ? (
                        <Button
                            type="secondary"
                            to={urls.insightsFunction(editingNotification.id)}
                            icon={<IconExternal />}
                        >
                            Open full editor
                        </Button>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="text-xs text-muted">
                                    ...
                                    survey notifications list to use the full Script function editor.
                                </div>
                            </div>
