...
describe('CdpRerunWorkerConsumer', () => {
    ...
    beforeEach(async () => {
        ...
        hub.CYCLOTRON_NODE_DATABASE_URL = 'postgres://insights:insights@localhost:5432/test_cyclotron_node'
        ...
        // ack/reschedule/fail decisions without hitting Datastore. The catch
