...
// Customer-authored templates (team- or organization-scoped) as opposed to Insights's official/global ones.
...
export const dashboardTemplateChooserLogic = kea<dashboardTemplateChooserLogicType>([
    ...
    listeners(({ actions, values, props }) => ({
        templateTileClicked: ({ template, tileLocation }) => {
            ...
            insights.capture('dashboard template chooser template clicked', {
