...
class EndpointRequestSerializer(serializers.Serializer):
    ...
    query = serializers.JSONField(
        required=False,
        allow_null=True,
        help_text="InsightsQL or insight query this endpoint executes. Changing this auto-creates a new version.",
    )
...
class EndpointResponseSerializer(serializers.Serializer):
    ...
    query = serializers.JSONField(
        help_text="The InsightsQL or insight query definition (JSON object with 'kind' key).",
    )
    is_active = serializers.BooleanField(
    ...
    ui_url = serializers.CharField(
        allow_null=True,
        help_text="Absolute URL to view this endpoint in the Insights UI.",
    )
