...
class TestEngineeringAnalyticsViews(DatastoreTestMixin, BaseTest):
    ...
    def _select(self, sql: str) -> list[tuple]:
        return execute_insightsql_query(query=sql, team=self.team, query_type="engineering_analytics.test").results
    ...
    def test_pull_requests_view_maps_columns(self) -> None:
        ...
        # bot detection from the [bot] suffix (Datastore Bool comes back as 1/0)
    ...
    def test_workflow_runs_view_maps_columns(self) -> None:
        ...
        assert rows[0][:6] == ("CI", "completed", "success", 1800, "Insights", "insights")
        assert rows[1][3] == 2700
        assert rows[2][:6] == ("Deploy", "in_progress", None, None, "Insights", "insights")
    ...
    def test_pull_requests_view_handles_null_user(self) -> None:
        ...
        head_json = '{"sha": "sha5"}'
        base_json = '{"repo": {"full_name": "Insights/insights"}}'
        raw = (
    ...
    def test_workflow_runs_view_handles_null_pull_requests(self) -> None:
        ...
        repo_json = '{"full_name": "Insights/insights"}'
        raw = (
        ...
        assert rows[0] == (0, "Insights", "insights", 0)
    ...
    def test_workflow_runs_view_attributes_only_own_repo_prs_and_falls_back_to_the_merge_commit(self) -> None:
        ...
        own, fork = "Insights/insights", "Mu-L/insights-1"
