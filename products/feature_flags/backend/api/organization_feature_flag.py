...
from insights.api.utils import ErrorResponseSerializer, action
from insights.constants import AvailableFeature
from insights.models import Team, User
from insights.models.filters.filter import Filter
from insights.rate_limit import CopyFlagsBurstRateThrottle, CopyFlagsSustainedRateThrottle
...
class OrganizationFeatureFlagView(
    ...
    @action(
        ...
        url_path="copy_flags",
        required_scopes=["feature_flag:write"],
        # See CopyFlagsBurstRateThrottle in insights/rate_limit.py for why this needs its own throttle pair.
        throttle_classes=[
