...
describe('SSE to MCP redirect', () => {
    it.each([
        { from: 'https://mcp.hanzo.ai/sse', toPath: '/mcp' },
        { from: 'https://mcp.hanzo.ai/sse/', toPath: '/mcp/' },
        { from: 'https://mcp.hanzo.ai/sse/message', toPath: '/mcp/message' },
        { from: 'https://mcp.hanzo.ai/sse?features=flags', toPath: '/mcp' },
        { from: 'https://mcp.hanzo.ai/sse?features=flags&region=eu', toPath: '/mcp' },
    ...
    it('does not affect /mcp requests', async () => {
        const response = await SELF.fetch('https://mcp.hanzo.ai/mcp', { redirect: 'manual' })
