...
const savedQueryColumnAnnotationsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedDataWarehouseSavedQueryColumnAnnotationList>
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof SavedQueryColumnAnnotationsListSchema>) => {
        ...
        return await withInsightsUrl(context, result, '/sql')
    },
})
...
const ViewCreateSchema = WarehouseSavedQueriesCreateBody.extend({
    name: WarehouseSavedQueriesCreateBody.shape['name'].describe(
        'Unique name for the view. Used as the table name in InsightsQL queries. Must not conflict with existing table names.'
    ),
})

const viewCreate = (): ToolBase<typeof ViewCreateSchema, WithInsightsUrl<Schemas.DataWarehouseSavedQuery>> => ({
    name: 'view-create',
...
const viewGet = (): ToolBase<typeof ViewGetSchema, WithInsightsUrl<Schemas.DataWarehouseSavedQuery>> => ({
    name: 'view-get',
...
const viewList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedDataWarehouseSavedQueryMinimalList>
> => ({
    name: 'view-list',
        ...
        return await withInsightsUrl(
            context,
            {
                ...
                results: await Promise.all(
                    (result.results ?? []).map((item) => withInsightsUrl(context, item, `/sql?open_view=${item.id}`))
                ),
            },
            '/sql'
        )
...
const viewMaterialize = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.DataWarehouseSavedQuery>
> => ({
...
const viewRun = (): ToolBase<typeof ViewRunSchema, WithInsightsUrl<Schemas.DataWarehouseSavedQuery>> => ({
    name: 'view-run',
...
const viewRunHistory = (): ToolBase<typeof ViewRunHistorySchema, WithInsightsUrl<Schemas.DataWarehouseSavedQuery>> => ({
...
const viewUpdate = (): ToolBase<typeof ViewUpdateSchema, WithInsightsUrl<Schemas.DataWarehouseSavedQuery>> => ({
    name: 'view-update',
...
const warehouseColumnAnnotationsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedWarehouseColumnAnnotationList>
> => ({
