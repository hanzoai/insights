...
from insights.models.property import OperatorType, PropertyType
...
class InsightsAutoSchema(AutoSchema):
...
class PersonalAPIKeyScheme(OpenApiAuthenticationExtension):
    target_class = "insights.auth.PersonalAPIKeyAuthentication"
