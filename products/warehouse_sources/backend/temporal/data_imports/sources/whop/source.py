    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption=(
                ...
                "invoices, refunds, and disputes into Insights. Create a company API key in the "
                f"[Developer tab]({WHOP_API_KEYS_URL}) of your Whop dashboard."
            ),
            iconPath="/static/services/whop.png",
            docsUrl="https://hanzo.ai/docs/cdp/sources/whop",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
                        ...
                        caption=(
                            ...
                            "`invoice:basic:read`, plus `developer:manage_webhook` if you want Insights to "
            ...
            webhookSetupCaption=(
                "Insights tries to register a Whop webhook for you using your API key, which needs the "
                ...
                "5. Copy the webhook secret into the field below so Insights can verify deliveries"
            ),
            webhookFields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
                        ...
                        placeholder="",
                        caption=(
                            "The webhook secret shown in your Whop dashboard. Insights uses it to verify the "
