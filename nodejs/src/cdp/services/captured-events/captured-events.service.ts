...
/**
 * Collects and flushes Insights capture events emitted by script function
 * invocations via `insights.capture()`. Lifecycle mirrors the sibling
...
export class CapturedEventsService {
    ...
    /**
     * Extract `capturedInsightsEvents` from each result, resolve the team
