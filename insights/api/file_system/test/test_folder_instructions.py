...
from insights.api.file_system.folder_instructions_service import FOLDER_INSTRUCTIONS_MAX_BYTES
from insights.models import Organization, Team, User
from insights.models.file_system.file_system import FileSystem
from insights.models.file_system.folder_instructions import FileSystemFolderInstructions
...
class TestDesktopFolderInstructionsAPI(APIBaseTest):
    ...
    def test_me_folder_and_instructions_are_private_to_the_creator(self):
        ...
        other_user = User.objects.create_and_join(self.organization, "other@hanzo.ai", "testpass")
