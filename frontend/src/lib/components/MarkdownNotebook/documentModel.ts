...
export function getAskAIInlineNotebookQuery(
    ...
    return [
        'The user is writing in a markdown notebook and asked Insights AI to continue inline.',
...
export function getAskAISelectionQuery(
    ...
    return [
        'The user highlighted content in a markdown notebook and asked Insights AI to help with it.',
