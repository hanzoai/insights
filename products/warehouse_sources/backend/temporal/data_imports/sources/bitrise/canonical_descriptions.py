...
CANONICAL_DESCRIPTIONS: CanonicalDescriptions = {
    ...
    "builds": {
        ...
        "columns": {
            "app_slug": "Identifier of the app the build belongs to (added by Insights during sync).",
    ...
    "workflows": {
        ...
        "docs_url": "https://api-docs.bitrise.io/#/builds",
        "columns": {
            "app_slug": "Identifier of the app the workflow belongs to (added by Insights during sync).",
    ...
    "artifacts": {
        ...
        "columns": {
            "app_slug": "Identifier of the app the artifact belongs to (added by Insights during sync).",
            "build_slug": "Identifier of the build that produced the artifact (added by Insights during sync).",
            "build_triggered_at": "When the build that produced the artifact was triggered (added by Insights during sync).",
