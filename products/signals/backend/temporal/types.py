...
class SignalData:
    ...
    Datastore-backed instances include `inserted_at`; synthetic or adapted instances may omit it.
    """
...
def _render_remediation_to_text(remediation: dict) -> list[str]:
    ...
    lines = ["- Remediation (authoritative guidance — follow it, then verify via the Insights MCP):"]
