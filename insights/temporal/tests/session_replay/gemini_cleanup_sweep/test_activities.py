...
from insights.temporal.session_replay.gemini_cleanup_sweep.activities import sweep_gemini_files_activity
...
from insights.temporal.session_replay.gemini_cleanup_sweep.types import CleanupSweepInputs, CleanupSweepResult
...
def fixed_now():
    ...
    with patch(
        "insights.temporal.session_replay.gemini_cleanup_sweep.activities.datetime",
        _FixedDatetime,
    ):
        yield
...
def _patch_clients(raw_client: _StubRawClient, temporal: _StubTemporal):
    return (
        patch(
            "insights.temporal.session_replay.gemini_cleanup_sweep.activities.RawGenAIClient",
            return_value=raw_client,
        ),
        patch(
            "insights.temporal.session_replay.gemini_cleanup_sweep.activities.async_connect",
