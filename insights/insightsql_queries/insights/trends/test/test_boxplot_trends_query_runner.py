...
from insights.insightsql_queries.insights.trends.boxplot_trends_query_runner import BoxPlotTrendsQueryRunner
from insights.models.utils import uuid7

from products.warehouse_sources.backend.facade.testing import create_data_warehouse_table_from_csv

TEST_BUCKET = "test_storage_bucket-insights.insightsql.datawarehouse.boxplot"


@freeze_time("2024-01-01T00:00:00Z")
class TestBoxPlotTrendsQueryRunner(DatastoreTestMixin, APIBaseTest):
    ...
    def test_session_duration_produces_boxplot_data(self):
        from insights.schema import PropertyMathType
...
class TestBoxPlotTrendsQueryRunnerDataWarehouse(DatastoreTestMixin, APIBaseTest):
    ...
    def test_data_warehouse_series_returns_distribution(self):
        table, _source, _credential, _df, self.cleanUpDataWarehouse = create_data_warehouse_table_from_csv(
            ...
            table_columns={
                ...
                "revenue": {"datastore": "Float64", "insightsql": "FloatDatabaseField"},
            },
