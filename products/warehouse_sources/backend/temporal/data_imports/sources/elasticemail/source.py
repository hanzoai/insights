...
class ElasticemailSource(ResumableSource[ElasticemailSourceConfig, ElasticEmailResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Elastic Email API key to pull your Elastic Email data into the Insights Data warehouse.
...
Grant the key read access to the data you want to sync (Contacts, Campaigns, Templates, Reports, etc.).""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/elasticemail",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
