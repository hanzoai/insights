...
def get_insightsql_column_name_mapping(table_name_without_prefix: str) -> dict[str, str]:
    """Map each raw synced column name to the InsightsQL-visible field name it surfaces as.

    Curated sources (Stripe, etc.) rename or wrap some raw columns when exposing them via InsightsQL — for
