...
export function ReplayScannersScene(): JSX.Element {
    ...
    const columns: TableColumns<ReplayScanner> = [
        {
            title: 'Name',
            key: 'name',
            sorter: true,
    ...
    return (
        <SceneContent>
            ...
            {(scannerStats?.total ?? 0) - (scannerStats?.enabled ?? 0) > 0 && (
                <Banner type="warning" dismissKey="replay-vision-launch-beta-scanners">
                    ...
                    <Link to="https://hanzo.ai/docs/replay-vision/quota-and-limits" target="_blank">
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="flex flex-wrap items-center gap-2">
                            ...
                            <div className="ml-auto flex flex-wrap items-center gap-2">
                                ...
                                />
                                {hasActiveFilters && (
                                    <Button type="tertiary" size="small" onClick={() => clearFilters()}>
                                        Clear filters
                                    </Button>
                                )}
                                <Button
