...
the heavy `input` / `output` from `insights.ai_events` native columns.
"""
...
from insights.temporal.ai_observability.trace_summarization.fetch_and_format import _fetch_and_format_generation
