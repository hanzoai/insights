...
export const productScenes: Record<string, () => Promise<any>> = {
    ...
    TaskTracker: () => import('../../products/insights_ai/frontend/scenes/TaskTracker/TaskTracker'),
    ...
    CodeReview: () => import('../../products/review/frontend/CodeReviewScene'),
    ...
    Stamp: () => import('../../products/stamp/frontend/scenes/StampScene/StampScene'),
