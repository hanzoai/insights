...
function MetricComparisonResults({
    ...
    const columns: TableColumns<ComparisonRow> = [
        {
            title: 'Variant',
            dataIndex: 'variant',
            key: 'variant',
    ...
    return (
        <div className="mt-2">
            <div className="flex gap-4 mb-2">
                <div className="flex items-center gap-1">
                    ...
                    {direct.loading ? (
                        ...
                        <Tag type="default">{direct.durationMs}ms</Tag>
                    )}
                </div>
                <div className="flex items-center gap-1">
                    ...
                    {precomputed.loading ? (
                        ...
                        <Tag type="default">{precomputed.durationMs}ms</Tag>
                    )}
                </div>
                {direct.durationMs && precomputed.durationMs && (
                    <div className="flex items-center gap-1">
                        <span className="text-muted">Speedup:</span>
                        <Tag type={precomputed.durationMs < direct.durationMs ? 'success' : 'warning'}>
            ...
            {directSig && precomputedSig && (
                <div className="flex gap-4 mb-2">
                    <div className="flex items-center gap-1">
                        ...
                        <Tag type={directSig.significant ? 'success' : 'default'}>
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <Tag type={precomputedSig.significant ? 'success' : 'default'}>
            ...
            {comparisonRows.length > 0 && <Table dataSource={comparisonRows} columns={columns} size="small" />}
        </div>
    )
}
