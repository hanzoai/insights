...
from insights.api.test.batch_exports.conftest import describe_schedule
from insights.api.test.test_organization import create_organization
from insights.api.test.test_team import create_team
from insights.management.commands.create_batch_export_from_app import map_plugin_config_to_destination
from insights.models import BatchExport, Plugin, PluginAttachment, PluginConfig
from insights.models.team.util import delete_batch_exports
from insights.temporal.common.client import sync_connect
from insights.temporal.common.codec import EncryptionCodec
...
def snowflake_plugin(organization) -> typing.Generator[Plugin, None, None]:
    plugin = Plugin.objects.create(
        ...
        url=append_random("https://github.com/hanzoai/snowflake-export-plugin"),
        plugin_type="custom",
...
def s3_plugin(organization) -> typing.Generator[Plugin, None, None]:
    plugin = Plugin.objects.create(
        ...
        url=append_random("https://github.com/hanzoai/s3-export-plugin"),
        plugin_type="custom",
        organization=organization,
    )
    yield plugin
...
def bigquery_plugin(organization) -> typing.Generator[Plugin, None, None]:
    plugin = Plugin.objects.create(
        ...
        url=append_random("https://github.com/hanzoai/bigquery-plugin"),
        plugin_type="custom",
        organization=organization,
    )
    yield plugin
...
def postgres_plugin(organization) -> typing.Generator[Plugin, None, None]:
    plugin = Plugin.objects.create(
        ...
        url=append_random("https://github.com/hanzoai/postgres-plugin"),
        plugin_type="custom",
        organization=organization,
    )
    yield plugin
