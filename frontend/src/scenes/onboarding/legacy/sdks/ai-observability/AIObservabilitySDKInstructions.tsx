import { EmbeddingEvent } from '@hanzo/shared-onboarding/ai-observability/_snippets/embedding-event'
import { GenerationEvent } from '@hanzo/shared-onboarding/ai-observability/_snippets/generation-event'
import { NotableGenerationProperties } from '@hanzo/shared-onboarding/ai-observability/_snippets/notable-generation-properties'
import { SpanEvent } from '@hanzo/shared-onboarding/ai-observability/_snippets/span-event'
import { TraceEvent } from '@hanzo/shared-onboarding/ai-observability/_snippets/trace-event'
import { AnthropicInstallation } from '@hanzo/shared-onboarding/ai-observability/anthropic'
import { AutoGenInstallation } from '@hanzo/shared-onboarding/ai-observability/autogen'
import { AWSBedrockInstallation } from '@hanzo/shared-onboarding/ai-observability/aws-bedrock'
import { AzureOpenAIInstallation } from '@hanzo/shared-onboarding/ai-observability/azure-openai'
import { CerebrasInstallation } from '@hanzo/shared-onboarding/ai-observability/cerebras'
import { CloudflareAIGatewayInstallation } from '@hanzo/shared-onboarding/ai-observability/cloudflare-ai-gateway'
import { CohereInstallation } from '@hanzo/shared-onboarding/ai-observability/cohere'
import { ConvexInstallation } from '@hanzo/shared-onboarding/ai-observability/convex'
import { CrewAIInstallation } from '@hanzo/shared-onboarding/ai-observability/crewai'
import { DedalusInstallation } from '@hanzo/shared-onboarding/ai-observability/dedalus'
import { DeepSeekInstallation } from '@hanzo/shared-onboarding/ai-observability/deepseek'
import { DSPyInstallation } from '@hanzo/shared-onboarding/ai-observability/dspy'
import { EveInstallation } from '@hanzo/shared-onboarding/ai-observability/eve'
import { FireworksAIInstallation } from '@hanzo/shared-onboarding/ai-observability/fireworks-ai'
import { GoogleInstallation } from '@hanzo/shared-onboarding/ai-observability/google'
import { GroqInstallation } from '@hanzo/shared-onboarding/ai-observability/groq'
import { HeliconeInstallation } from '@hanzo/shared-onboarding/ai-observability/helicone'
import { HuggingFaceInstallation } from '@hanzo/shared-onboarding/ai-observability/hugging-face'
import { InstructorInstallation } from '@hanzo/shared-onboarding/ai-observability/instructor'
import { LangChainInstallation } from '@hanzo/shared-onboarding/ai-observability/langchain'
import { LangGraphInstallation } from '@hanzo/shared-onboarding/ai-observability/langgraph'
import { LiteLLMInstallation } from '@hanzo/shared-onboarding/ai-observability/litellm'
import { LlamaIndexInstallation } from '@hanzo/shared-onboarding/ai-observability/llamaindex'
import { ManualInstallation } from '@hanzo/shared-onboarding/ai-observability/manual'
import { MastraInstallation } from '@hanzo/shared-onboarding/ai-observability/mastra'
import { MirascopeInstallation } from '@hanzo/shared-onboarding/ai-observability/mirascope'
import { MistralInstallation } from '@hanzo/shared-onboarding/ai-observability/mistral'
import { OllamaInstallation } from '@hanzo/shared-onboarding/ai-observability/ollama'
import { OpenAIInstallation } from '@hanzo/shared-onboarding/ai-observability/openai'
import { OpenAIAgentsInstallation } from '@hanzo/shared-onboarding/ai-observability/openai-agents'
import { OpenRouterInstallation } from '@hanzo/shared-onboarding/ai-observability/openrouter'
import { OpenTelemetryInstallation } from '@hanzo/shared-onboarding/ai-observability/opentelemetry'
import { PerplexityInstallation } from '@hanzo/shared-onboarding/ai-observability/perplexity'
import { PortkeyInstallation } from '@hanzo/shared-onboarding/ai-observability/portkey'
import { PydanticAIInstallation } from '@hanzo/shared-onboarding/ai-observability/pydantic-ai'
import { SemanticKernelInstallation } from '@hanzo/shared-onboarding/ai-observability/semantic-kernel'
import { SmolagentsInstallation } from '@hanzo/shared-onboarding/ai-observability/smolagents'
import { TogetherAIInstallation } from '@hanzo/shared-onboarding/ai-observability/together-ai'
import { VercelAIInstallation } from '@hanzo/shared-onboarding/ai-observability/vercel-ai'
import { VercelAIGatewayInstallation } from '@hanzo/shared-onboarding/ai-observability/vercel-ai-gateway'
import { XAIInstallation } from '@hanzo/shared-onboarding/ai-observability/xai'
