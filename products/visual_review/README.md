...
**Repo** — a visual review project within a Insights team. Usually maps 1:1 to a GitHub repository. Holds configuration like which baseline file paths to use per run type.
