...
use personinsights_writer::store::StoreConfig;
...
pub const TOPIC: &str = "personinsights_updates";
pub const TARGET_TABLE: &str = "personinsights_person_tmp";
...
/// Create a mock Kafka cluster with the personinsights_updates topic.
...
/// Clean up test data from the personinsights_person_tmp table for a given team.
