...
export function initInsightsQLLanguage(monaco: Monaco, lang: ScriptLanguage = ScriptLanguage.insightsQL): void {
        ...
        monaco.languages.register(
            lang === 'insightsQL'
                ? {
                      ...
                      mimetypes: ['application/insightsql'],
                  }
                : {
                      id: lang,
                      mimetypes: ['application/insightsql+expr'],
                  }
        )
