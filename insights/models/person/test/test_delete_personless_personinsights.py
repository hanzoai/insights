"""Tests for personless distinct ID deletion via personinsights RPC.
...
from insights.personinsights_client.proto import DeletePersonlessDistinctIdsBatchForTeamResponse


class TestDeletePersonlessDistinctIdsForTeamsRouting(SimpleTestCase):
    def test_personinsights_loops_until_zero_deleted(self):
