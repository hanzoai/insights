database "insights" {
  table "ai_events" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/ai_events/tables/{shard}/insights.ai_events"
  ...
  table "kafka_ai_events_json_ws" {
    ...
    engine "kafka" {
      ...
      topic_list           = "kafka_topic_list = 'datastore_ai_events_json'"
      group_name           = "kafka_group_name = 'datastore_ai_events_ws'"
