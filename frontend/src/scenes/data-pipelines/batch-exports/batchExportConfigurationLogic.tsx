    ...
    const eventsTable: DatabaseSchemaBatchExportTable = {
        ...
        fields: {
            ...
            ...(service == 'S3' && {
                person_id: {
                    name: 'person_id',
                    insightsql_value: 'toString(person_id)',
                    type: 'string',
                    schema_valid: true,
                },
                person_properties: {
                    name: 'person_properties',
                    insightsql_value: "nullIf(person_properties, '')",
                    type: 'string',
                    schema_valid: true,
                },
                created_at: {
            ...
            ...(service != 'S3' &&
                service != 'Databricks' && {
                    team_id: {
                        name: 'team_id',
                        insightsql_value: service == 'Postgres' || service == 'Redshift' ? 'toInt32(team_id)' : 'team_id',
                        type: 'integer',
                        schema_valid: true,
                    },
                    set: {
                        name: service == 'Snowflake' ? 'people_set' : 'set',
                        insightsql_value: "nullIf(JSONExtractString(properties, '$set'), '')",
                        type: 'string',
                        schema_valid: true,
                    },
                    set_once: {
                        name: service == 'Snowflake' ? 'people_set_once' : 'set_once',
                        insightsql_value: "nullIf(JSONExtractString(properties, '$set_once'), '')",
                        type: 'string',
                        schema_valid: true,
                    },
                    site_url: {
                    ...
                    ip: {
                        name: 'ip',
                        insightsql_value: "nullIf(JSONExtractString(properties, '$ip'), '')",
                        type: 'string',
                        schema_valid: true,
                    },
                    elements_chain: {
                        name: 'elements',
                        insightsql_value: 'toJSONString(elements_chain)',
                        type: 'string',
                        schema_valid: true,
                    },
                }),
