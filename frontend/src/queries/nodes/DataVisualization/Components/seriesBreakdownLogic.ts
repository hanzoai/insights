 ...
 */
export const BREAKDOWN_NULL_KEY = '$$_insights_breakdown_null_$$'
...
export interface seriesBreakdownLogicValues {
    ...
    seriesBreakdownData: BreakdownSeriesData<number | null>;
    showSeriesBreakdown: boolean;
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface seriesBreakdownLogicActions {
    clearAxis: () => {
        value: true;
...
export type seriesBreakdownLogicType = MakeLogicType<seriesBreakdownLogicValues, seriesBreakdownLogicActions, SeriesBreakdownLogicProps, seriesBreakdownLogicMeta>;
...
export const seriesBreakdownLogic = kea<seriesBreakdownLogicType>([
    ...
    selectors({
        ...
        showSeriesBreakdown: [
            ...
            (selectedSeriesBreakdownColumn: string | null | undefined): boolean =>
        ...
        seriesBreakdownData: [
            ...
            (
                selectedBreakdownColumn: string | null | undefined,
                breakdownColumnValues: string[],
