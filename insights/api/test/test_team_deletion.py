...
from insights.temporal.common.test_utils import start_test_worker
...
class TestTeamDeletionSideEffects(NonAtomicBaseTest):
    ...
    def test_delete_bulky_postgres_data(self):
        ...
        from insights.test.persons import add_cohort_members, add_distinct_id, create_person
        ...
        # Verify personinsights RPCs were called for persons-DB cleanup
    ...
    @patch("insights.models.team.util.sync_connect")
