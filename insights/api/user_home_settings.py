...
from insights.models import Team, User, UserHomeSettings
...
class PinnedSceneTabsSerializer(serializers.Serializer):
    ...
    homepage = PinnedSceneTabSerializer(
        ...
        allow_null=True,
        help_text=(
            "Tab descriptor for the user's chosen home page — the destination opened when they click the Insights "
...
@extend_schema_view(
    ...
    partial_update=extend_schema(
        description=(
            ...
            "destination (any Insights URL — dashboard, insight, search results, scene). Either field may be "
