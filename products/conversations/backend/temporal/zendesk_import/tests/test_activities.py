...
class TestZendeskImportBatchActivity(BaseTest):
    ...
    def _run_batch(
        ...
        *,
        ...
        save_return: str | None = "https://media.insights.test/file",
    ...
    def test_staff_reply_with_unresolved_role_is_not_attributed_to_customer(self) -> None:
        ...
        self._run_batch(
            ...
            users={
                ...
                99: _zd_user(99, "staff@hanzo.ai", role=None),  # role unresolved
            },
    ...
    def test_second_end_user_reply_is_customer_not_staff(self) -> None:
        ...
        self._run_batch(
            ...
            users={
                ...
                20: _zd_user(20, "staff@hanzo.ai", role="agent"),
            },
        ...
        self.assertEqual(by_body["from staff"].item_context["author_email"], "staff@hanzo.ai")
    ...
    def test_deleted_staff_author_recovered_from_comment_via_sender(self) -> None:
        ...
        comments = [
            ...
            _zd_comment(
                ...
                public=True,
                body="staff reply",
                via_from={"name": "Marcus", "address": "marcus@hanzo.ai"},
            ),
        ]
        self._run_batch(
            [208],
        ...
        self.assertEqual(staff.item_context["author_email"], "marcus@hanzo.ai")
    ...
    def test_distinct_id_is_the_zendesk_requester_email(self) -> None:
        ...
        # email verbatim, never a distinct_id resolved from a Insights person's `properties.email`.
    ...
    def test_image_attachment_embedded_in_rich_content(self) -> None:
        ...
        self._run_batch(
            ...
            save_return="https://media.insights.test/shot.png",
        )
        ...
        self.assertEqual(image_nodes[0]["attrs"]["src"], "https://media.insights.test/shot.png")
        ...
        self.assertIn("https://media.insights.test/shot.png", content)
    ...
    def test_non_image_attachment_linked(self) -> None:
        ...
        self._run_batch(
            ...
            save_return="https://media.insights.test/doc.pdf",
        )
        ...
        content = stored.content
        assert content is not None
        self.assertIn("[doc.pdf](https://media.insights.test/doc.pdf)", content)
