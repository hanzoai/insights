...
} from '~/common/generated/personinsights/personinsights/types/v1/group_pb'
import type { Group as ProtoGroup } from '~/common/generated/personinsights/personinsights/types/v1/group_pb'
import { PersonSchema } from '~/common/generated/personinsights/personinsights/types/v1/person_pb'
import type { Person as ProtoPerson } from '~/common/generated/personinsights/personinsights/types/v1/person_pb'
...
/**
 * Build a proto Group that mirrors a postgres row, as a real personinsights-router
...
describe('PersonHog ↔ Postgres parity', () => {
    ...
    const insertTestTeam = async (id: number) => {
        await insertRow(hub.postgres, 'insights_project', {
            id,
            organization_id: 'ca30f2ec-e9a4-4001-bf27-3ef194086068',
            name: `Test Project ${id}`,
            created_at: new Date().toISOString(),
        })
        await insertRow(hub.postgres, 'insights_team', {
            id,
            name: `Test Team ${id}`,
            organization_id: 'ca30f2ec-e9a4-4001-bf27-3ef194086068',
            project_id: id,
