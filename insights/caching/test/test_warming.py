...
from insights.caching.warming import insights_to_keep_fresh, schedule_warming_for_teams_task, warm_insight_cache_task
...
class TestWarming(APIBaseTest):
    ...
    @patch("insights.caching.warming.get_stale_insights")
...
class TestScheduleWarmingForTeamsTask(APIBaseTest):
    ...
    @patch("insights.caching.warming.largest_teams")
    @patch("insights.caching.warming.insights_to_keep_fresh")
    @patch("insights.caching.warming.warm_insight_cache_task.si")
...
class TestWarmInsightCacheTask(APIBaseTest):
    @patch("insights.caching.warming.capture_exception")
    @patch("insights.caching.warming.process_query_dict", side_effect=DatastoreAtCapacity())
