...
import { Button, Checkbox, Input, Modal, Tooltip } from '@hanzo/elements'
...
export function ColumnSelectionPicker({
    ...
    return (
        <div className="flex flex-col gap-2">
            <Input type="search" placeholder="Filter columns" size="small" value={filter} onChange={setFilter} />
            ...
            {!hideActions && (
                <div className="flex items-center justify-between gap-2 mt-2">
                    <Button type="tertiary" onClick={setSyncAll}>
