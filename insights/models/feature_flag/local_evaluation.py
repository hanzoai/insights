...
from insights.models.feature_flag.types import FlagFilters, FlagProperty, PropertyFilterType
...
from insights.storage.hypercache import HyperCache, emit_cache_sync_metrics
...
def feature_flag_changed(sender, instance: "FeatureFlag", **kwargs):
    from insights.tasks.feature_flags import update_team_flags_cache
