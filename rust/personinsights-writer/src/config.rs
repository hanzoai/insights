...
pub struct Config {
    ...
    /// Target table for person upserts. Set to "insights_person" for
    /// production cutover, "personinsights_person_tmp" for validation.
    #[envconfig(default = "personinsights_person_tmp")]
