...
from insights.insightsql_queries.insights.utils.breakdowns import strip_user_aliases
...
def breakdown_extract_expr(property_name: str, breakdown_type: str, group_type_index: int | None = None) -> ast.Expr:
    ...
    if breakdown_type == "insightsql":
        # The value is a raw InsightsQL expression, not a property name. Parse it and
