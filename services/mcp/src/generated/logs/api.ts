...
export const logsAlertsCreateBodyFiltersOneFilterGroupOneValuesItemValuesItemOnefourTypeDefault = `insightsql`
...
export const logsAlertsPartialUpdateBodyFiltersOneFilterGroupOneValuesItemValuesItemOnefourTypeDefault = `insightsql`
...
/**
 * Create a notification destination for this alert. One InsightsFunction is created per alert event kind (firing, resolved, ...) atomically.
 */
...
/**
 * Delete a notification destination by deleting its InsightsFunction group atomically.
 */
...
export const logsAlertsDestinationsDeleteCreateBodyInsightsFunctionIdsMax = 4

export const LogsAlertsDestinationsDeleteCreateBody = /* @__PURE__ */ zod.object({
    insights_function_ids: zod
        .array(zod.string())
        .min(1)
        .max(logsAlertsDestinationsDeleteCreateBodyInsightsFunctionIdsMax)
        .describe('InsightsFunction IDs to delete as one atomic destination group.'),
})
...
export const logsAlertsSimulateCreateBodyFiltersOneFilterGroupOneValuesItemValuesItemOnefourTypeDefault = `insightsql`
