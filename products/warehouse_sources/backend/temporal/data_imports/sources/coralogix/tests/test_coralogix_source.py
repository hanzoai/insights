...
from insights.schema import DataWarehouseSourceCategory, ReleaseStatus, SourceFieldInputConfig, SourceFieldSelectConfig
...
class TestCoralogixSource:
    ...
    def test_source_config_shape(self) -> None:
        ...
        assert config.docsUrl == "https://hanzo.ai/docs/cdp/sources/coralogix"
