...
from insights.models.exported_asset import ExportedAsset, get_public_access_token, save_content_from_file
...
def record_and_persist_video_activity(build: dict[str, Any]) -> None:
    ...
    from insights.tasks.exports.video_exporter import record_replay_to_file
