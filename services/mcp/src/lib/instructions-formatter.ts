...
export class InstructionsFormatter {
    ...
    /** Build the top-level description of the `insights:exec` tool. */
    ...
    buildClaudeExecHelpEntries(ctx: InstructionsContext): ExecHelpEntry[] {
        const entries: ExecHelpEntry[] = [
            {
                ...
                description: ctx.dataCatalogEnabled
                    ? 'Query or analyze Insights data; governed metrics, certified tables, and verified joins live in the catalog.'
                    : 'Query or analyze Insights data, metrics, and events.',
        ...
        entries.push({
            ...
            kind: 'guide',
            title: 'Feedback',
            description: 'Send feedback about Insights.',
