...
from posthog.schema import BounceRatePageViewMode, InsightsQLQueryModifiers, SessionTableVersion

from posthog.insightsql import ast
from posthog.insightsql.database.schema.sessions_v1 import (
...
class TestSessionsV1(ClickhouseDestroyTablesMixin, ClickhouseTestMixin, APIBaseTest):
    ...
    def __execute(self, query):
        modifiers = InsightsQLQueryModifiers(sessionTableVersion=SessionTableVersion.V1)
