...
class SegmentSource(ResumableSource[SegmentSourceConfig, SegmentResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter a Twilio Segment workspace-scoped Public API token to pull your Segment workspace configuration into the Insights Data warehouse.
...
This connects to the Segment **Public API** (workspace configuration, admin, and metadata) — not the event or Profile data plane.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/segment",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldSelectConfig(
