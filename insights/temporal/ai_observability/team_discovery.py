...
# which in practice means local development or CI, where the hanzo_insights SDK
...
def _get_ai_observability_workflow_config() -> AIObservabilityWorkflowConfig:
    ...
    try:
        payload: dict | None = hanzo_insights.get_feature_flag_payload(  # type: ignore[assignment]  # ty: ignore[invalid-assignment]
