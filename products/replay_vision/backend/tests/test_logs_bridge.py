...
from insights.otel_logs import reset_otel_logs_for_tests
...
class TestVisionLogMirror(SimpleTestCase):
    ...
    def test_pipeline_logs_serialize_and_export_through_the_real_worker_chain(self) -> None:
        ...
        with mock.patch("insights.security.outbound_proxy.internal_requests_session", return_value=mock_session):
            configure_logger(
