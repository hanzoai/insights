...
from products.insights_ai.eval_harness.engines.registry import resolve_engine
from products.insights_ai.eval_harness.engines.types import (
    EnvVarSpec,
    EvalSummary,
    ExperimentResult,
    ExperimentSpec,
...
from products.insights_ai.eval_harness.one_shot import _OneShotEvalRun
...
def _build_run(tmp_path: Path, monkeypatch: pytest.MonkeyPatch, ctx: EvalContext, task_fn: Any) -> _OneShotEvalRun:
    monkeypatch.setattr("products.insights_ai.eval_harness.base.build_case_dir", lambda *_: tmp_path)
