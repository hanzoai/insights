...
# --- InsightsQL renderer -------------------------------------------------------------------
# The same cost model, rendered as InsightsQL expression strings so a warehouse view can compute
# provider / os / vcpu / multiplier / billable_seconds / estimated_cost_usd in Datastore
...
# Datastore-backed parity test guards against. Each renderer takes SQL expression strings for
# its inputs and returns a InsightsQL expression; the caller (logic.views.job_costs) threads them
