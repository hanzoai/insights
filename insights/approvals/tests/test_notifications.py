...
from insights.approvals.models import Approval, ApprovalDecision, ApprovalPolicy, ChangeRequest, ChangeRequestState
from insights.approvals.notifications import (
...
from insights.email import CUSTOMER_IO_TEMPLATE_ID_MAP
...
class TestSendApprovalEmail(TestApprovalNotifications):
    @patch("insights.approvals.notifications.EmailMessage")
    @patch("insights.approvals.notifications.is_email_available")
...
class TestSendApprovalRequestedNotification(TestApprovalNotifications):
    @patch("insights.approvals.notifications._send_approval_email")
