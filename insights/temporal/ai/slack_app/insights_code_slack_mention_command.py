...
class InsightsCodeSlackMentionCommandWorkflow(InsightsWorkflow):
    ...
    @staticmethod
    def parse_inputs(inputs: list[str]) -> InsightsCodeSlackMentionCommandWorkflowInputs:
        loaded = json.loads(inputs[0])
        return InsightsCodeSlackMentionCommandWorkflowInputs(**loaded)

    @workflow.run
    async def run(self, inputs: InsightsCodeSlackMentionCommandWorkflowInputs) -> None:
        ...
        picker_inputs = InsightsCodeSlackMentionWorkflowInputs(
            event=inputs.event,
