...
class HyperspellSource(ResumableSource[HyperspellSourceConfig, HyperspellResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Hyperspell API key to pull your app's memories, connections, and extracted entities into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/hyperspell",
