...
class ActiveCampaignSource(ResumableSource[ActiveCampaignSourceConfig, ActiveCampaignResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your ActiveCampaign API URL and key to sync your CRM and marketing data into the Insights Data warehouse.
...
You can find both in your ActiveCampaign account under **Settings > Developer**. The API key is account-wide and grants read access to every endpoint listed below.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/active-campaign",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
    ...
    def get_non_retryable_errors(self) -> dict[str, str | None]:
        return {
            ...
            "ActiveCampaign API URL is not allowed": "Insights couldn't reach the ActiveCampaign API URL you entered. Check that it's correct — it should look like https://youraccount.api-us1.com — and reconnect.",
        }
