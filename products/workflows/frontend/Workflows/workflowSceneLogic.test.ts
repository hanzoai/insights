...
describe('workflowSceneLogic', () => {
    ...
    // — the one sidePanelContextLogic reads SIDE_PANEL_CONTEXT_KEY from — exposes the script_flow resource.
    it('exposes the script_flow access control context for a saved workflow', () => {
