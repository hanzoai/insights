...
CAPTION = """Pull weather and air quality data from [Open-Meteo](https://open-meteo.com) into the Insights Data warehouse, so you can join it against your own events.
