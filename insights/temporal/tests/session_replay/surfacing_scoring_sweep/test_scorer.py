...
from insights.temporal.session_replay.surfacing_scoring_sweep import scorer as scorer_mod
from insights.temporal.session_replay.surfacing_scoring_sweep.features import FEATURE_RANGES, MissingFeatureRangeError
from insights.temporal.session_replay.surfacing_scoring_sweep.scorer import (
    ScoreRangeError,
    _load_booster,
    get_feature_names,
    predict,
...
from insights.temporal.tests.session_replay.surfacing_scoring_sweep.conftest import (
...
class TestModelLoading:
    ...
    def test_load_booster_raises_when_s3_returns_none(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "insights.temporal.session_replay.surfacing_scoring_sweep.scorer.object_storage.read_bytes",
