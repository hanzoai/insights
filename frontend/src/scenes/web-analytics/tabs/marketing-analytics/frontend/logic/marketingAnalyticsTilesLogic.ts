...
// Maps a chart column to a InsightsQL aggregate over the native cost precompute table. Costs are already
    ...
    selectors({
        ...
        marketingChartTile: [
            ...
            (
                ...
                // Typed property filter, not raw InsightsQL interpolation: source IDs come from the
                // integration_sources URL param, so embedding them in a InsightsQL string would allow
