...
export const template: InsightsFunctionTemplate = {
    ...
    id: 'template-unify',
    name: 'Unify',
    description: 'Send Insights events to Unify',
...
let res := fetch('https://analytics.unifygtm.com/api/v1/webhooks/insights', {
    'method': 'POST',
    'headers': {
    ...
    inputs_schema: [
        {
            ...
            description:
                'Your Unify write key for authentication. You can find your write key in the Unify app under Settings → Integrations → Insights.',
            default: '',
            secret: true,
            required: true,
        },
        {
            ...
            label: 'Person',
            description:
                'Mapping of Unify Person attributes to Insights person properties. Email is required to associate an event with a Person.',
            default: {
        ...
        },
        {
            ...
            label: 'Company',
            description:
                'Mapping of Unify Company attributes to Insights company properties. Domain is required to associate an event with a Company.',
            default: {
