...
const userInterviewTopicsIntervieweesList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedIntervieweeContextList>
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof UserInterviewTopicsIntervieweesListSchema>) => {
        ...
        return await withInsightsUrl(context, result, '/user_interviews')
    },
})
...
const userInterviewTopicsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedUserInterviewTopicList>
> => ({
...
const userInterviewsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedUserInterviewList>
> => ({
