...
pub struct Args {
    ...
    /// The identifier Insights uses to look up this mapping file when processing your stack traces.
    /// Must match the identifier provided to the Insights SDK at runtime for this build.
    #[arg(short, long)]
    pub map_id: String,
