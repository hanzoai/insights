"""Tests that person API endpoints produce identical results via personinsights.
...
class TestRetrievePerson(PersonhogTestMixin, APIBaseTest):
    def test_retrieve_by_uuid(self):
        ...
        self._assert_personinsights_called("get_person_by_uuid")
    ...
    def test_retrieve_by_pk(self):
        ...
        self._assert_personinsights_not_called("get_person_by_uuid")
...
class TestDeleteProperty(PersonhogTestMixin, APIBaseTest):
    ...
    def test_uuid_lookup(self, mock_capture):
        ...
        self._assert_personinsights_called("get_person_by_uuid")
        self._assert_personinsights_called("get_distinct_ids_for_person")
...
class TestBatchByDistinctIds(PersonhogTestMixin, APIBaseTest):
    ...
    def test_empty_list(self):
        ...
        self._assert_personinsights_not_called("get_persons_by_distinct_ids_in_team")
...
class TestBulkDeletePersons(PersonhogTestMixin, APIBaseTest):
    ...
    def test_bulk_delete_partial_failure_only_deletes_successful_from_postgres(self, mock_delete_person):
        ...
        calls = self._assert_personinsights_called("delete_persons")
        if calls:
            # Only the successful person should be sent to personinsights for PG deletion
