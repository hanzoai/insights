...
from insights.temporal.session_replay.gemini_cleanup_sweep.tracking import (
    index_size,
    iter_tracked_files,
    track_uploaded_file,
    untrack_uploaded_file,
)
from insights.temporal.session_replay.gemini_cleanup_sweep.types import TrackedFile
...
async def test_track_raises_when_redis_pipeline_fails(gemini_redis):
    ...
    with patch(
        "insights.temporal.session_replay.gemini_cleanup_sweep.tracking.get_async_client",
