...
To run:
    ...
    flox activate -- bash -c "set -a; source .env; set +a; python -m products.insights_ai.eval_harness.harness eval_unknown_events_confirmation"
"""
...
from products.insights_ai.eval_harness.scorers import NoToolCall, RequiredToolCall
from products.insights_ai.evals.experiments.scorers import AskedForConfirmation
...
# justify it as a typo of a real Insights event in the seeded team.
