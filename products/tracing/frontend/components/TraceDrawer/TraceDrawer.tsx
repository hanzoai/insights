...
import { Button, Tabs, Tag, SpinnerOverlay } from '@hanzo/elements'
...
export function TraceDrawer({
    ...
    // query, fall back to Attributes — otherwise activeKey would point at a tab Tabs has dropped
        ...
        <Drawer
            ...
            title={
                <div className="flex items-center gap-2 min-w-0">
                    ...
                    {rootSpan && <Tag>{formatDuration(rootSpan.duration_nano)}</Tag>}
                        ...
                        <>
                            ...
                            <Tabs
                                ...
                                tabs={[
                                    ...
                                    // Conditional (Tabs ignores falsy entries): only DB spans have a query.
                                    queryText
                                        ? {
                                              key: 'query',
                                              label: 'Query',
