...
class KnowledgeSource(ModelActivityMixin, CreatedMetaFields, UpdatedMetaFields, UUIDModel):
    ...
    team = models.ForeignKey("insights.Team", on_delete=models.CASCADE, related_name="business_knowledge_sources")
    ...
    class Meta:
        db_table = "insights_business_knowledge_knowledgesource"
        ordering = ["-created_at"]
        indexes = [
