...
export interface hogFlowEditorLogicActions {
    ...
    resetFlowFromInsightsFlow: (hogFlow: InsightsFlow) => {
...
export type hogFlowEditorLogicType = MakeLogicType<hogFlowEditorLogicValues, hogFlowEditorLogicActions, WorkflowLogicProps, hogFlowEditorLogicMeta>;

export const hogFlowEditorLogic = kea<hogFlowEditorLogicType>([
    props({} as WorkflowLogicProps),
    path((key) => ['scenes', 'insightsflows', 'hogFlowEditorLogic', key]),
    ...
    actions({
        ...
        resetFlowFromInsightsFlow: (hogFlow: InsightsFlow) => ({ hogFlow }),
        setReactFlowInstance: (reactFlowInstance: ReactFlowInstance<Node, Edge>) => ({
            reactFlowInstance,
        }),
    ...
    listeners(({ values, actions }) => {
        ...
        return {
            ...
            resetFlowFromInsightsFlow: ({ hogFlow }) => {
                try {
                    const edges: InsightsFlowActionEdge[] = hogFlow.edges.map((edge) => {
                    ...
                    const nodes: InsightsFlowActionNode[] = hogFlow.actions.map((action: InsightsFlowAction) => {
    ...
    subscriptions(({ actions }) => ({
        workflow: (hogFlow?: InsightsFlow, oldInsightsFlow?: InsightsFlow) => {
            ...
            if (hogFlow && !objectsEqual(hogFlow, oldInsightsFlow)) {
                actions.resetFlowFromInsightsFlow(hogFlow)
            }
        },
    })),
