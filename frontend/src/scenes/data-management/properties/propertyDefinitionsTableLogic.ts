...
export interface propertyDefinitionsTableLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface propertyDefinitionsTableLogicActions {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface propertyDefinitionsTableLogicMeta {
    key: string
...
export type propertyDefinitionsTableLogicType = MakeLogicType<
    propertyDefinitionsTableLogicValues,
    propertyDefinitionsTableLogicActions,
    PropertyDefinitionsTableLogicProps,
    propertyDefinitionsTableLogicMeta
>
