...
// A throw while building scene context blanks out ALL of Insights AI's auto-collected context
// (e.g. Insights AI reporting it has no dashboard and falling back to search). The selector that
...
const reportSceneContextError = (error: unknown): void => {
    ...
    console.error(
        '[Insights AI] Failed to build scene context — it will have no auto-collected context for this scene:',
        err
    )
    insights.captureException(err, { feature: 'max_scene_context' })
}

export type LoadedEntitiesMap = { dashboard: number[]; insight: string[] }

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface maxContextLogicValues {
    toolMap: {
        [x: string]: ToolRegistration
    } // maxGlobalLogic
    activeLoadedScene: LoadedScene | null // sceneLogic
    activeSceneId: string | null // sceneLogic
    activeSceneLogic: BuiltLogic | null // sceneLogic
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface maxContextLogicActions {
    locationChanged: ({
        method,
        pathname,
        search,
    ...
    addOrUpdateContextNotebook: (data: { short_id: string; title?: string | null }) => {
        data: {
            short_id: string
    ...
    removeContextEvaluation: (id: string) => {
        id: string
    }
    ...
    removeContextNotebook: (id: string) => {
        id: string
    }
    resetContext: () => {
        value: true
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface maxContextLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        ...
        compiledContext: (
            ...
            contextNotebooks: any,
            contextEvaluations: any,
            sceneContext: any
        ) => MaxUIContext | null
        hasData: (
            contextInsights: any,
...
export type maxContextLogicType = MakeLogicType<
    maxContextLogicValues,
    maxContextLogicActions,
    Record<string, any>,
    maxContextLogicMeta
>
