...
from insights.models import SharingConfiguration
        ...
        [
            ...
            (
                ...
                _doc(
                    ...
                    _ad_hoc_query_node(kind="InsightsQLQuery", node_id="node-2"),
                ),
                [
                    (
                        "node-2",
                        {"kind": "InsightsQLQuery", "source": {"kind": "EventsQuery", "select": ["*"]}},
                    ),
                ],
            ),
            (
    ...
    def test_shared_notebook_reserializes_allowlisted_markdown_component_props(self) -> None:
        markdown = "\n\n".join(
            [
                "hello",
                (
                    '<Embed src="https://hanzo.ai" title="Public docs" height={320} '
            ...
            markdown_node,
            {
                ...
                "attrs": {
                    ...
                    "markdown": "\n\n".join(
                        [
                            "hello",
                            '<Embed height={320} src="https://hanzo.ai" title="Public docs" />',
                        ]
                    ),
                },
            },
