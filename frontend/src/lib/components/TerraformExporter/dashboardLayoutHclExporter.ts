...
export interface DashboardLayoutHclExportOptions extends HclExportOptions {
    /** TF reference for the dashboard_id field (e.g. "insights_dashboard.my_dashboard.id") */
    dashboardTfReference: string
    /** Map of insight IDs to their TF references (e.g. "insights_insight.my_insight.id") */
...
/**
 * @see https://registry.terraform.io/providers/Insights/insights/latest/docs/resources/dashboard_layout
 */
...
const DASHBOARD_LAYOUT_EXPORTER: ResourceExporter<Partial<DashboardType<any>>, DashboardLayoutHclExportOptions> = {
    resourceType: 'insights_dashboard_layout',
