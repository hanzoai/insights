...
class SafetyCultureSource(ResumableSource[SafetyCultureSourceConfig, SafetyCultureResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your SafetyCulture API token to pull your inspections, actions, issues, assets, and workplace-operations data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/safetyculture",
