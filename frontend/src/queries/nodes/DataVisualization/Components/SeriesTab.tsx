    ...
    if (effectiveVisualizationType === ChartDisplayType.ActionsPie) {
        ...
        return (
            <div className="flex flex-col w-full p-3">
                ...
                <Label className="mt-4 mb-1">Value</Label>
                <Select
                    className="w-full"
...
const SeriesFormattingTag = ({ style }: { style?: string }): JSX.Element | null => {
    ...
    return (
        <Tag className="ml-2 shrink-0" type="default">
            {shortLabel}
        </Tag>
    )
}
...
const SeriesSelectLabel = ({
    ...
    return (
        <div className="flex items-center min-w-0 w-full">
            {showSeriesColor && <ColorGlyph className="mr-2 shrink-0" color={color} />}
    ...
    return (
        <div className="flex gap-1 mb-2 items-center">
            <ColorPicker
                ...
                customButton={<ColorButton type="tertiary" color={seriesColor} className="mr-2" />}
