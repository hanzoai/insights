...
Insights snippet, run check-loading against it, and assert the snippet was
...
<head>
  ...
  <script id="insights-init">
    // Stub insights object so the detector reports loaded=true without
...
def test_check_loading_detects_stubbed_insights(fixture_server):
    """check-loading against a fixture page reports insights as loaded."""
    pages = asyncio.run(
