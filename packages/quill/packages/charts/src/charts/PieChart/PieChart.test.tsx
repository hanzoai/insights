...
function sliceLabels(wrapper: HTMLElement): string[] {
    return Array.from(wrapper.querySelectorAll<HTMLElement>('[data-attr="script-chart-pie-slice-label"]')).map(
        (el) => el.textContent ?? ''
    )
}
...
describe('PieChart', () => {
    ...
    describe('interactive legend', () => {
        function legendButtons(container: HTMLElement): HTMLButtonElement[] {
            return Array.from(
                container.querySelectorAll<HTMLButtonElement>('[data-attr="script-chart-pie-legend"] button')
            )
        }
