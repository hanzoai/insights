...
//
// Part of the `products/insights_ai/frontend/api/<module>` public surface — import from here, not from
...
// Suggestions compound (the "Try Insights AI for…" button row + in-input dropdown) and its default content.
...
// Product data-tool widgets — the atomic Insights-entity renderers Max's LangGraph path composes directly
