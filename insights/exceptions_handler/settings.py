...
USER_SETTINGS: Optional[Any] = getattr(settings, "EXCEPTIONS_HANDLER", None)

DEFAULTS: Dict = {
    "EXCEPTION_REPORTING": "exceptions_handler.handler.exception_reporter",
...
# e.g. `exceptions_handler.exception_handler`
