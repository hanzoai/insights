...
class SurveySparrowSource(ResumableSource[SurveySparrowSourceConfig, SurveySparrowResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="SurveySparrow",
            caption="""Enter a SurveySparrow access token to pull your surveys, responses, questions, and contacts into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/surveysparrow",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
