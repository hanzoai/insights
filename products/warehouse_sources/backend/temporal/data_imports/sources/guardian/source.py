...
class GuardianSource(ResumableSource[GuardianSourceConfig, GuardianResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Guardian Open Platform API key to pull Guardian news content into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/guardian",
