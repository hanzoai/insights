...
export function buildSampleGlobals(
    ...
    if (triggerType === 'webhook') {
        ...
        sampleGlobals.event = {
            event: '$batch_script_flow_invocation',
            distinct_id: 'user123',
            properties: {},
            timestamp: '2024-01-01T12:00:00Z',
        }
            ...
            {isEmailStep ? (
                engagementEventsEnabled ? (
                    <div className="flex items-center gap-1.5 mt-2 text-xs text-muted-alt">
                        ...
                        <span>Email engagement is being captured as Insights events.</span>
                        <Link
                    ...
                    <Banner type="info" hideIcon className="mt-2">
                        <div className="flex flex-col gap-2">
                            <span className="text-xs">
                                Email engagement (sends, opens, clicks, bounces) is recorded as workflow metrics. You
                                can also capture these as standard Insights events for use in insights and funnels. They
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Button
                                    type="tertiary"
                                    size="xsmall"
                                    to="https://hanzo.ai/docs/workflows/engagement-events"
                                    targetBlank
                                >
                                    Learn more
                                </Button>
...
function TemplateNotFoundFallback({ templateId }: { templateId: string }): JSX.Element {
    useEffect(() => {
        insights.captureException(new Error('Workflow editor: script function template not found'), {
            severity: 'error',
