...
export interface workflowTemplatesLogicActions {
    deleteFlowTemplate: (template: InsightsFlowTemplate) => {
        template: InsightsFlowTemplate
    }
    deleteFlowTemplateFailure: (
        error: string,
        errorObject?: any
    ) => {
        error: string
...
export const workflowTemplatesLogic = kea<workflowTemplatesLogicType>([
    ...
    actions({
        ...
        deleteFlowTemplate: (template: InsightsFlowTemplate) => ({ template }),
    }),
    reducers({
        templateFilter: [
            '' as string,
        ...
        workflowTemplates: [
            [] as InsightsFlowTemplate[],
            {
                loadWorkflowTemplates: async (): Promise<InsightsFlowTemplate[]> => {
                    const response = await api.flowTemplates.getInsightsFlowTemplates()
                    return response.results as InsightsFlowTemplate[]
                },
                deleteFlowTemplate: async ({ template }) => {
                    await api.flowTemplates.deleteInsightsFlowTemplate(template.id)
