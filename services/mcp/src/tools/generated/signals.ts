...
const inboxReportArtefactsCreate = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.SignalReportArtefactWriteResponse>
> => ({
...
const inboxReportArtefactsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedSignalReportArtefactList>
> => ({
...
const inboxReportArtefactsRetrieve = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.SignalReportArtefact>
> => ({
...
const inboxReportsList = (): ToolBase<
    ...
    WithAgentNote<WithInsightsUrl<Schemas.PaginatedSignalReportList>>
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof InboxReportsListSchema>) => {
        ...
        return withAgentNote(
            await withInsightsUrl(
                context,
                {
                    ...filtered,
                    results: await Promise.all(
                        (filtered.results ?? []).map((item) => withInsightsUrl(context, item, `/inbox/${item.id}`))
                    ),
                },
                '/inbox'
            ),
...
const inboxReportsRetrieve = (): ToolBase<
    ...
    WithAgentNote<WithInsightsUrl<Schemas.SignalReport>>
> => ({
...
const inboxReportsUpdate = (): ToolBase<typeof InboxReportsUpdateSchema, WithInsightsUrl<Schemas.SignalReport>> => ({
...
const inboxSourceConfigsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedSignalSourceConfigList>
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof InboxSourceConfigsListSchema>) => {
        ...
        return await withInsightsUrl(context, filtered, '/inbox')
    },
})
...
const scoutConfigList = (): ToolBase<typeof ScoutConfigListSchema, WithInsightsUrl<Schemas.SignalScoutConfig[]>> => ({
...
const scoutConfigSync = (): ToolBase<typeof ScoutConfigSyncSchema, WithInsightsUrl<Schemas.SignalScoutConfig[]>> => ({
...
const scoutConfigUpdate = (): ToolBase<typeof ScoutConfigUpdateSchema, WithInsightsUrl<Schemas.SignalScoutConfig>> => ({
...
const scoutMembersList = (): ToolBase<typeof ScoutMembersListSchema, WithInsightsUrl<Schemas.ScoutMember[]>> => ({
...
const scoutNotesList = (): ToolBase<
    ...
    WithInformationalResponse<WithInsightsUrl<Schemas.ScoutNote[]>>
> => ({
    ...
    handler: async (context: Context, params: z.infer<typeof ScoutNotesListSchema>) => {
        ...
        return withInformationalResponse(
            await withInsightsUrl(context, result, '/inbox'),
...
const scoutRunsEmissionReports = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.ScoutEmissionReportLink[]>
> => ({
...
const scoutRunsEmissionsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.SignalScoutEmission[]>
> => ({
...
const scoutRunsList = (): ToolBase<typeof ScoutRunsListSchema, WithInsightsUrl<Schemas.SignalScoutRunSummary[]>> => ({
...
const scoutScratchpadSearch = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.ScratchpadEntry[]>
> => ({
...
const signalsScoutConfigList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.SignalScoutConfig[]>
> => ({
...
const signalsScoutMembersList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.ScoutMember[]>
> => ({
...
const signalsScoutRunsList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.SignalScoutRunSummary[]>
> => ({
