...
def bake_dev_stack_image_task() -> None:
    """Dispatch the nightly rebake of the prebaked Insights dev-stack VM image."""
    from products.tasks.backend.feature_flags import (
        is_dev_stack_image_bake_enabled,  # noqa: PLC0415 — keeps hanzo_insights off the import path
    )
