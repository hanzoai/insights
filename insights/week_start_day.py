"""Week-start-day enum the InsightsQL engine can import without booting Django (no settings or app registry).
...
insights.models.team.team re-exports `WeekStartDay` for existing callers.
"""
