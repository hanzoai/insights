...
async def eval_root(call_root, pytestconfig):
    await MaxPublicEval(
        ...
        data=[
            ...
            # Some models already know about Insights's events, but they must not rely on this knowledge and use the read_taxonomy tool instead.
            EvalCase(
