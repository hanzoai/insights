...
class Migration(migrations.Migration):
    ...
    before merging this migration that no rows remain unpopulated:
        ...
        SELECT COUNT(*) FROM insights_dashboardtile WHERE team_id IS NULL;
            ...
            database_operations=[
                migrations.RunSQL(
                    sql=(
                        ...
                        'ALTER TABLE "insights_dashboardtile" ALTER COLUMN "team_id" SET NOT NULL'
                    ),
                    reverse_sql='ALTER TABLE "insights_dashboardtile" ALTER COLUMN "team_id" DROP NOT NULL',
                ),
            ],
        ),
    ]
