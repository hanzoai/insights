...
from ee.datastore.sql.person import GET_PERSON_PROPERTIES_COUNT
...
from ee.datastore.materialized_columns.analyze import logger, materialize_properties_task
