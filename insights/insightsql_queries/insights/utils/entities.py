...
from insights.types import AnyPropertyFilter, EntityNode, FunnelExclusionEntityNode
...
def _semantic_property_repr(property: AnyPropertyFilter) -> str:
    if isinstance(property, EmptyPropertyFilter):
        return ""
    elif isinstance(property, InsightsQLPropertyFilter) or isinstance(property, CohortPropertyFilter):
