...
import { Banner, Button, Tab, Tabs } from '@hanzo/elements'
...
export function EngineeringAnalyticsScene(): JSX.Element {
    ...
    const tabs: Tab<EngineeringAnalyticsView>[] = [
        {
            key: 'hub',
            label: 'Overview',
    ...
    return (
        <BindLogic logic={engineeringAnalyticsLogic} props={{}}>
            <SceneContent>
                ...
                />
                <Banner type="info" dismissKey="engineering-analytics-alpha">
                    Engineering analytics is in alpha. Metrics are limited to CI events, and details may change.
                </Banner>
                <Tabs activeKey={activeView} data-attr="engineering-analytics-tabs" tabs={tabs} sceneInset />
            </SceneContent>
        </BindLogic>
    )
}
