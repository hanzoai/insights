...
SPA router sees /login&__insights_toolbar=... as one path segment.

Run: pytest insights/api/test/test_toolbar_hash_routing_repro.py -v
"""
...
from insights.api.test.test_toolbar_oauth_primitives import ToolbarOAuthAuthorizeMixin
