...
from insights.temporal.delete_teams import ACTIVITIES as REAL_ACTIVITIES
from insights.temporal.delete_teams.activities import (
...
from insights.temporal.delete_teams.workflows import (
...
def execute_deletion_workflows_inline() -> Iterator[None]:
    ...
    with (
        patch("insights.temporal.delete_teams.dispatch.start_delete_project_data_workflow", _run_delete_project_data),
        patch("insights.temporal.delete_teams.dispatch.start_delete_organization_workflow", _run_delete_organization),
    ):
        yield
