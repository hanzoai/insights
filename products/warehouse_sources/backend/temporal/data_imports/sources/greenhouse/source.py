...
class GreenhouseSource(ResumableSource[GreenhouseSourceConfig, GreenhouseResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Greenhouse Harvest credentials to automatically pull your Greenhouse recruiting data into the Insights Data warehouse.
...
The API key field is only for connections still on Harvest v1, which Greenhouse removes on 31 August 2026.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/greenhouse",
            fields=cast(
                list[FieldType],
