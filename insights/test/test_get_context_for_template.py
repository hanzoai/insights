...
from insights.models import UserHomeSettings
...
class TestGetContextForTemplate(APIBaseTest):
    def test_get_context_for_template(self):
        ...
        # Under self-capture, insights-js evaluates Insights's own flags with the dogfood-flags team's
        ...
        assert actual == {
            ...
            "js_insights_api_key": self.team.api_token,
            "js_insights_host": "",
    ...
    def test_bootstraps_configured_homepage_into_app_context(self, _name, stored_homepage):
        ...
        app_context = json.loads(actual["insights_app_context"])
