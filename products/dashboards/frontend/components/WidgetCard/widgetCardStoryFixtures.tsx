...
import { MenuOverlay, type MenuItems } from 'lib/elements/Menu'
...
/** Realistic dashboard widget ⋯ menu for Storybook — flat Menu items, not bordered buttons. */
export const mockWidgetMoreMenuItems: MenuItems = [
...
export const mockMoreOverlay = <MenuOverlay items={mockWidgetMoreMenuItems} />
