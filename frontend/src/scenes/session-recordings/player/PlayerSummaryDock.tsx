        ...
        >
            ...
            <div className="flex items-center justify-between h-11 px-3 shrink-0">
                {hasSummary ? (
                    ...
                    // AI session summaries run on Insights Cloud only — show the standard upsell.
                    <Button
                        size="small"
                        type="secondary"
                        icon={<IconMagicWand />}
                        to={urls.moveToInsightsCloud()}
                        tooltip="AI session summaries are a Insights Cloud feature (separate from Insights AI, which runs on your own provider key)"
                        data-attr="session-summary-move-to-cloud"
                    >
                        Summarize with Insights Cloud
                    </Button>
                ) : (
                    <Button
                        size="small"
