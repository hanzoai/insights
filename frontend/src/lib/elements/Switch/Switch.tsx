...
export const Switch: React.FunctionComponent<SwitchProps & React.RefAttributes<HTMLDivElement>> = forwardRef(
    function Switch(
        {
            className,
            id: rawId,
            ...
            >
                <div className="Switch__handle">
                    {loading && (
                        ...
                        >
                            <Spinner textColored={true} className="Switch__spinner-icon" />
                        </div>
                    )}
                </div>
            </ButtonHtmlComponent>
