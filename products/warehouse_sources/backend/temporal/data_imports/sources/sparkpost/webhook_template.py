...
if (not inputs.bypass_authorization_check) {
  ...
  // (`auth_type: "basic"`). Insights generates those credentials at registration time and stores
    ...
    inputs_schema=[
        {
            ...
            "description": (
                ...
                "(e.g. `Basic dXNlcjpwYXNz`). Insights rejects deliveries whose header does not match."
            ),
        },
        {
            "type": "boolean",
