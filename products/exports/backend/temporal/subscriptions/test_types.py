    ...
    @parameterized.expand(
        [
            ...
            (
                ...
                "The query the AI generated failed to run (ExposedInsightsQLError), so the report could not be computed.",
            ),
            (
                "multiple_with_types",
                2,
                ["ExposedInsightsQLError", "ResolutionError"],
                "All 2 queries the AI generated failed to run (ExposedInsightsQLError, ResolutionError), so the report could not be computed.",
            ),
        ]
    )
