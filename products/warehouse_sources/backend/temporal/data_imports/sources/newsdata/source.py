...
from products.warehouse_sources.backend.temporal.data_imports.sources.generated_configs.newsdata import (
...
class NewsDataSource(ResumableSource[NewsDataSourceConfig, NewsDataResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your NewsData.io API key to pull news articles into the Insights Data warehouse.
...
Page size and daily request credits are determined by your NewsData.io plan.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/newsdata",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
