...
from insights.models import ActivityLog, MaterializedColumnSlot, MaterializedColumnSlotState, PropertyDefinition
from insights.models.property_definition import PropertyType
from insights.temporal.backfill_materialized_property.activities import UpdateSlotStateInputs, update_slot_state
...
class TestMaterializedColumnActivityLogging(APIBaseTest):
    ...
    @patch("insights.api.materialized_column_slot.is_impersonated_session")
    @patch("insights.api.materialized_column_slot.async_to_sync")
