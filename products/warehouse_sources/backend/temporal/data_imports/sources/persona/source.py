...
class PersonaSource(ResumableSource[PersonaSourceConfig, PersonaResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Persona API key to automatically pull your Persona data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/persona",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
