...
class NoLiveEventsCheck(HealthCheck):
    ...
    remediation = Remediation(
        human="""
            Open the Web analytics health page. Confirm the Insights snippet or SDK is installed and
        ...
        agent="""
            ...
            not sending. Then fix it in the user's codebase: find where Insights is initialized, make sure
            `insights.init` runs with the correct project API key and that pageview autocapture is enabled
    ...
    def render_signal(cls, issue: HealthIssue) -> SignalContent | None:
        ...
        return SignalContent(
            description=(
                ...
                f"{NO_LIVE_EVENTS_LOOKBACK_DAYS} days. That usually means the Insights snippet/SDK "
