...
from insights.temporal.proxy_service.common import SendProxyCreatedEmailInputs, UpdateProxyRecordInputs
...
@patch("insights.temporal.proxy_service.create.use_cloudflare_proxy", return_value=True)
