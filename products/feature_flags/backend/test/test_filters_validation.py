...
def _person_prop(**overrides: Any) -> dict[str, Any]:
    return {"key": "email", "type": "person", "operator": "icontains", "value": "@hanzo.ai", **overrides}
    ...
    @parameterized.expand(
        [
            ...
            (
                ...
                {"groups": [{"properties": [_person_prop(operator="starts_with", value="insights")]}]},
                [],
            ),
            (
            ...
            (
                ...
                {"groups": [{"properties": [_person_prop(operator="not_starts_with", value="insights")]}]},
                [],
            ),
            (
