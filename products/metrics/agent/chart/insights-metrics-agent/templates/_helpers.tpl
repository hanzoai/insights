{{- define "insights-metrics-agent.fullname" -}}
...
{{- define "insights-metrics-agent.labels" -}}
...
{{- define "insights-metrics-agent.selectorLabels" -}}
app.kubernetes.io/name: {{ .Chart.Name }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}

{{- define "insights-metrics-agent.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "insights-metrics-agent.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- define "insights-metrics-agent.secretName" -}}
{{- if .Values.insights.existingSecret }}
{{- .Values.insights.existingSecret }}
{{- else }}
{{- include "insights-metrics-agent.fullname" . }}
{{- end }}
{{- end }}
...
*/}}
{{- define "insights-metrics-agent.shardRelabel" -}}
...
{{- define "insights-metrics-agent.collectorConfig" -}}
...
{{- include "insights-metrics-agent.shardRelabel" . | nindent 22 }}
{{- end }}
{{- end }}
...
extensions:
    ...
    {{- if .Values.persistence.enabled }}
    file_storage:
        directory: /var/lib/insights-agent
