...
from insights.models.group_type_mapping import GROUP_TYPES_STALE_CACHE_KEY_PREFIX, GroupTypesUnavailable
...
from insights.test.persons import _seed_group_type_mapping_into_fake, create_group_type_mapping
from insights.test.test_utils import create_group_type_mapping_without_created_at
from insights.utils import safe_cache_delete
...
class TestUpdateFlagCachesGroupMappingGuards(BaseTest):
    ...
    @patch("insights.storage.hypercache.HYPERCACHE_WRITE_SKIPPED_UNCHANGED_COUNTER")
    ...
    def test_single_project_empty_success_does_not_defeat_guard(self, mock_emptied_counter):
        ...
        from insights.models.group_type_mapping import GROUP_TYPES_CACHE_KEY_PREFIX, get_group_types_for_project
        ...
        with (
            patch("insights.personinsights_client.client.get_personinsights_client", return_value=MagicMock()),
            patch("insights.models.group_type_mapping._fetch_group_types_via_personinsights", return_value=[]),
        ):
    ...
    def test_fails_closed_when_confirmation_read_errors(self, mock_emptied_counter):
        ...
        with (
            ...
            patch(
                "insights.models.group_type_mapping._fetch_group_types_for_project_direct",
...
class TestLocalEvaluationBatch(BaseTest):
    ...
    def test_batch_no_cohort_flags_skips_cohort_loading(self):
        ...
        with self.assertNumQueries(3):
            ...
            # mappings are read from personinsights, not SQL. No cohort query should
            # be issued.
            results = _get_flags_response_for_local_evaluation_batch([team])
