...
insights.datastore.materialized_columns, which re-exports these names for existing callers.
"""
...
# _materialized_column_name in ee/datastore/materialized_columns/columns.py.
