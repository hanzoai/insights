...
from insights.temporal.delete_teams.types import (
...
async def delete_misc_small_tables_activity(inputs: TeamDataActivityInputs) -> None:
    async with Heartbeater():
        from insights.models.team.util import _delete_misc_small_tables_for_teams
...
async def delete_personless_distinct_ids_activity(inputs: TeamDataActivityInputs) -> None:
    async with Heartbeater():
        from insights.models.team.util import _delete_personless_distinct_ids_for_teams
...
async def delete_groups_activity(inputs: TeamDataActivityInputs) -> None:
    async with Heartbeater():
        from insights.models.team.util import _delete_group_type_mappings_for_teams, _delete_groups_for_teams
...
async def delete_team_persons_activity(inputs: TeamDataActivityInputs) -> None:
    async with Heartbeater():
        from insights.models.team.util import _delete_persons_for_teams
...
async def delete_data_modeling_schedules_activity(inputs: TeamDataActivityInputs) -> None:
    async with Heartbeater():
        from insights.models.team.util import delete_data_modeling_schedules
...
async def delete_team_records_activity(inputs: TeamDataActivityInputs) -> None:
    async with Heartbeater():
        from insights.models.team.util import delete_team_records
...
def _enqueue_datastore_deletion(team_ids: list[int], user_id: int) -> None:
...
@temporalio.activity.defn
async def enqueue_datastore_deletion_activity(inputs: TeamDataActivityInputs) -> None:
    async with Heartbeater():
        await database_sync_to_async_pool(_enqueue_datastore_deletion)(inputs.team_ids, inputs.user_id)


@temporalio.activity.defn
async def delete_project_record_activity(inputs: ProjectRecordInputs) -> None:
    async with Heartbeater():
        from insights.models.team.util import delete_project_record
...
def _delete_organization_record(organization_id: str, user_id: int) -> None:
    from insights.event_usage import report_organization_deletion_completed
    from insights.models.team.util import delete_organization_record
