...
from insights.schema import ProductIntentContext, ProductKey
...
class TestProductIntent(BaseTest):
    ...
    def test_has_activated_workflows_with_active_workflow(self):
        ...
        self.product_intent.save()
        InsightsFlow.objects.create(team=self.team, name="Test workflow", status=InsightsFlow.State.ACTIVE)
    ...
    def test_has_not_activated_workflows_with_draft_workflow_only(self):
        self.product_intent.product_type = ProductKey.WORKFLOWS
        self.product_intent.save()
        InsightsFlow.objects.create(team=self.team, name="Test workflow", status=InsightsFlow.State.DRAFT)
    ...
    def test_has_not_activated_workflows_with_archived_workflow_only(self):
        self.product_intent.product_type = ProductKey.WORKFLOWS
        self.product_intent.save()
        InsightsFlow.objects.create(team=self.team, name="Test workflow", status=InsightsFlow.State.ARCHIVED)
...
class TestEnqueueProductActivationCalcDebounced(BaseTest):
    ...
    def test_debounce_behaviour(
        ...
        with patch("insights.models.product_intent.product_intent.calculate_product_activation.delay") as mock_delay:
    ...
    def test_cache_failure_falls_open_logs_and_still_enqueues(self):
        ...
        with (
            patch("insights.models.product_intent.product_intent.cache.add", side_effect=Exception("redis is sad")),
            patch("insights.models.product_intent.product_intent.calculate_product_activation.delay") as mock_delay,
            patch("insights.models.product_intent.product_intent.logger.warning") as mock_log,
            patch("insights.models.product_intent.product_intent.capture_exception") as mock_capture,
        ):
...
class TestCachedProductIntentsForTeam(BaseTest):
    ...
    def test_caches_results(self):
        ...
        with patch(
            "insights.models.product_intent.product_intent._fetch_product_intents",
