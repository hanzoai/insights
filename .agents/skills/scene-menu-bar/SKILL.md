...
Insights scenes render a Mac-style menu bar above `<SceneTitleSection>` that consolidates
...
| Component                                              | Use for                                                                                                                                                                                                                                                  |
| ------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `<SceneMenuBar>`                                       | Top-level wrapper; renders above `<SceneTitleSection>`. Includes the universal right cluster (Insights AI / Docs / Support).                                                                                                                              |
...
Right cluster is fixed and universal: **Insights AI · Docs · Support**. Do not add to it.
...
all ScenePanel items across Insights and their proposed menu placement.
