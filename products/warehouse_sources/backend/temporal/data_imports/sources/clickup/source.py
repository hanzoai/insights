...
class ClickUpSource(ResumableSource[ClickUpSourceConfig, ClickUpResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your ClickUp personal API token to pull your ClickUp data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/clickup",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
