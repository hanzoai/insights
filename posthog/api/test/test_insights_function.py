...
from posthog.api.insights_function import MAX_HOG_CODE_SIZE_BYTES, MAX_TRANSFORMATIONS_PER_TEAM
...
from posthog.models.insights_functions.insights_function import DEFAULT_STATE, InsightsFunction, InsightsFunctionState
...
class TestInsightsFunctionAPIWithoutAvailableFeature(ClickhouseTestMixin, APIBaseTest, QueryMatchingTest):
    ...
    def test_create_insights_function_works_for_free_template(self):
        ...
        assert response.json()["fn"] == template_slack.code
...
class TestInsightsFunctionAPI(ClickhouseTestMixin, APIBaseTest, QueryMatchingTest):
    ...
    def test_creates_with_template_id(self, *args):
        ...
        assert response.json()["fn"] == "fetch(inputs.url);"
    ...
    def test_creates_with_template_values_if_not_provided(self, *args):
        ...
        response = self.client.post(f"/api/projects/{self.team.id}/insights_functions/", data=payload)
        assert response.status_code == status.HTTP_201_CREATED, response.json()
        assert response.json()["fn"] == webhook_template["code"].strip()
    ...
    def test_create_insights_function_with_site_app_type(self, mock_transpile_fn):
        response = self.client.post(
            ...
            data={
                ...
                "fn": "export function onLoad() { console.log('Hello, site_app'); }",
                "type": "site_app",
            },
        )
    ...
    def test_create_insights_function_with_site_destination_type(self, mock_transpile_fn):
        response = self.client.post(
            ...
            data={
                ...
                "fn": "export function onLoad() { console.log('Hello, site_destination'); }",
    ...
    def test_create_insights_function_with_invalid_typescript(self):
        response = self.client.post(
            ...
            data={
                ...
                "fn": "export function onLoad() { console.log('Missing closing brace');",
                "type": "site_app",
            },
        )
    ...
    def test_create_typescript_destination_with_inputs(self, mock_transpile_fn):
        payload = {
            ...
            "fn": "export function onLoad() { console.log(inputs.message); }",
            "type": "site_destination",
            "inputs_schema": [
    ...
    def test_can_call_a_test_invocation(self):
        with patch("posthog.api.insights_function.create_hog_invocation_test") as mock_create_hog_invocation_test:
    ...
    @patch("posthog.api.insights_function.posthoganalytics.feature_enabled", return_value=False)
