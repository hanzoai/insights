...
import { InsightsFlowTaxonomicFilters } from './InsightsFlowTaxonomicFilters'
...
function renderComponent(): { onChange: jest.Mock } {
    ...
    render(<InsightsFlowTaxonomicFilters onChange={onChange} infiniteListLogicProps={INFINITE_LIST_LOGIC_PROPS} />)
    return { onChange }
}

describe('InsightsFlowTaxonomicFilters', () => {
    beforeEach(() => {
        jest.clearAllMocks()
    })
