...
export function CodeEditor({
    ...
    const disposeTrackedModels = (): void => {
        ...
        // `codeEditorLogic` would silently break InsightsQL autocomplete /
    ...
    useOnMountEffect(() => {
        ...
        return () => {
            ...
            // skipped on both counts, so InsightsQL autocomplete/metadata
    ...
    const editorOnMount = (editor: importedEditor.IStandaloneCodeEditor, monaco: Monaco): void => {
        ...
        monacoDisposables.current.push(
            monaco.editor.registerCommand('insights.insightsql.fixWithAI', (_: unknown, prompt: unknown) => {
