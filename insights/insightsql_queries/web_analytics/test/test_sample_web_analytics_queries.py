...
or to come up with some SQL queries. We already have the clickhouse snapshots, but by using insightsQL we can
...
from insights.test.base import APIBaseTest, ClickhouseTestMixin, snapshot_insightsql_queries
