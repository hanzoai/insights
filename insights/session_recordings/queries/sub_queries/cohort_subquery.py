from insights.schema import CohortPropertyFilter, PropertyOperator, RecordingsQuery
...
from insights.session_recordings.queries.utils import is_anonymous_cohort_fix_enabled, poe_is_active
