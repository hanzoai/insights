...
Microsoft Clarity's export API allows a maximum of 10 requests per project per day and only returns the last 1-3 days of data (no historical backfill), so Insights syncs a rolling snapshot on each run rather than pulling full history.""",
            docsUrl="https://hanzo.ai/docs/cdp/sources/microsoft-clarity",
