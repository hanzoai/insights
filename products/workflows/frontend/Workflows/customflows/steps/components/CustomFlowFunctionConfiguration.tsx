...
import { CyclotronJobInputType, CustomFunctionMappingType } from '~/types'

import { workflowLogic } from '../../../workflowLogic'
import { CustomFlowFunctionMappings } from './CustomFlowFunctionMappings'

export function CustomFlowFunctionConfiguration({
    templateId,
    inputs,
    setInputs,
    mappings,
    ...
    setMappings?: (mappings: CustomFunctionMappingType[]) => void
    errors?: Record<string, string>
}): JSX.Element {
    const { workflow, customFunctionTemplatesById, customFunctionTemplatesByIdLoading } = useValues(workflowLogic)

    const template = customFunctionTemplatesById[templateId]
    useEffect(() => {
    ...
    if (customFunctionTemplatesByIdLoading) {
        return (
