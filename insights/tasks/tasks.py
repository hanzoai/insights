...
def calculate_cohort(parallel_count: int) -> None:
    from insights.tasks.calculate_cohort import enqueue_cohorts_to_calculate, reset_stuck_cohorts
...
def poll_query_performance(last_known_run_time_ns: int) -> None:
    ...
    try:
        ...
        from insights.tasks.poll_query_performance import poll_query_performance as poll_query_performance_nontask
...
def process_scheduled_changes() -> None:
    from insights.tasks.process_scheduled_changes import process_scheduled_changes
...
def sync_all_organization_available_product_features() -> None:
    from insights.tasks.sync_all_organization_available_product_features import (
...
def update_survey_adaptive_sampling() -> None:
    from insights.tasks.update_survey_adaptive_sampling import update_survey_adaptive_sampling
...
def refresh_activity_log_fields_cache(flush: bool = False, hours_back: int = 14) -> None:
    ...
    from insights.api.advanced_activity_logs.constants import BATCH_SIZE, SAMPLING_PERCENTAGE, SMALL_ORG_THRESHOLD
    from insights.api.advanced_activity_logs.field_discovery import AdvancedActivityLogFieldDiscovery
    from insights.api.advanced_activity_logs.fields_cache import delete_cached_fields
