...
from insights.helpers.email_utils import sanitize_display_name, sanitize_email_string
...
CUSTOMER_IO_TEMPLATE_ID_MAP = {
    ...
    "insights_ai_access_requested": "72",
    "wizard_pr_ready": "74",
    "loop_run_summary": "77",
}
...
def raise_if_delivery_rejected(campaign_key: str, email: str) -> None:
    ...
    sets `MessagingRecord.sent_at` *before* a post-accept step (insights capture, record save)
...
# Keys whose values are Insights-generated URLs (built from `settings.SITE_URL`
