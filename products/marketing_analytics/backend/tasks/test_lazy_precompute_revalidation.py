...
from insights.schema import DateRange, MarketingAnalyticsTableQuery

from insights.datastore.query_tagging import Feature, get_query_tag_value, reset_query_tags
...
class TestMarketingLazyPrecomputeRevalidation(BaseTest):
    ...
    @mock.patch(f"{_MODULE}.get_query_runner", side_effect=Exception("datastore down"))
