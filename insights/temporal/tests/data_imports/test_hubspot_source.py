...
from insights.temporal.data_imports.sources.hubspot.hubspot import PROPERTY_LENGTH_LIMIT, _get_properties_str
...
def test_hubspot_get_properties():
    with patch("insights.temporal.data_imports.sources.hubspot.hubspot._get_property_names") as mock_get_property_names:
