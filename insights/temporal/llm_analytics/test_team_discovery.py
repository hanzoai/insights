...
FF_PAYLOAD_PATH = "insights.temporal.llm_analytics.team_discovery.hanzo_insights.get_feature_flag_payload"
...
@patch("insights.temporal.llm_analytics.team_discovery.Heartbeater", _noop_heartbeater)
@pytest.mark.asyncio
