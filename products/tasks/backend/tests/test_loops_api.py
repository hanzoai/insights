...
from insights.models import Organization, OrganizationMembership, PersonalAPIKey, ProjectSecretAPIKey, Team, User
from insights.models.integration import Integration
from insights.models.personal_api_key import hash_key_value
from insights.models.utils import generate_random_token_personal, generate_random_token_secret
...
class LoopsAPITestCase(TestCase):
    def setUp(self) -> None:
        ...
        self.mock_feature_flag = self._start_patch("hanzo_insights.feature_enabled")
...
class LoopObjectAccessControlAPITest(LoopsAPITestCase):
    ...
    def test_activity_log_restriction_honors_loop_rbac(self):
        ...
        from insights.api.advanced_activity_logs.viewset import restrict_loop_activity
...
class LoopActivityLogVisibilityAPITest(LoopsAPITestCase):
    ...
    def test_deleted_personal_loop_activity_stays_hidden_org_wide(self):
        ...
        from insights.api.advanced_activity_logs.viewset import restrict_loop_activity_for_org
        from insights.models.activity_logging.activity_log import ActivityLog
