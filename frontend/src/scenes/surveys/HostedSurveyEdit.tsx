        ...
        <nav className="flex min-w-0 flex-col gap-3 rounded border bg-surface-primary p-3">
            ...
            <div className="flex flex-col gap-2">
                ...
                {survey.appearance?.displayThankYouMessage ? (
                    ...
                    <Button type="secondary" size="small" onClick={onAddConfirmation} className="mt-1" fullWidth>
                        Add confirmation
                    </Button>
                )}
            ...
            <div className="flex flex-col gap-2">
                {hostedSurveyUrl ? (
                    <CopySurveyLink
                        ...
                        className="flex-wrap [&_.Button]:flex-1 [&_.Button]:justify-center"
                    />
                ) : (
...
function HostedSurveyUrlParamsDropdown(): JSX.Element {
    return (
        ...
        >
            <Button type="tertiary" size="xsmall" sideIcon={<IconChevronDown />}>
                URL params
            </Button>
        </Dropdown>
    )
    ...
    return (
        <header className="flex flex-col gap-3 xl:flex-row xl:items-end xl:justify-between">
            <div className="grid min-w-0 flex-1 gap-3 lg:grid-cols-[minmax(260px,0.55fr)_minmax(220px,0.45fr)]">
                <Field.Pure label="Survey name" htmlFor="hosted-survey-name">
                    <Input
            ...
            <div className="flex shrink-0 flex-wrap items-center gap-2">
                <Button type="secondary" size="small" onClick={onConvertToInApp}>
                    Convert to in-app
                </Button>
                {hostedSurveyUrl ? (
                    <Button type="secondary" size="small" icon={<IconExternal />} to={hostedSurveyUrl} targetBlank>
                        Open
                    </Button>
                ) : null}
                <Button
                ...
                <Collapse
                    ...
                    panels={[
                        ...
                        },
                        {
                            ...
                            content: (
                                <div className="flex flex-col gap-4">
                                    <Field.Pure label={<h3 className="mb-0">Completion limit</h3>}>
