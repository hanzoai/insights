...
class TestReviewValidatorConfigAPI(APIBaseTest):
    ...
    def test_environment_url_resolves_to_the_canonical_team(self) -> None:
        ...
        url = f"/api/projects/{env.id}/review_hog/validators/{REVIEW_FN_VALIDATION_SKILL_NAME}/"
    ...
    def test_cold_team_can_select_the_canonical_immediately(self) -> None:
        ...
        res = self.client.patch(
            f"/api/projects/{cold.id}/review_hog/validators/{REVIEW_FN_VALIDATION_SKILL_NAME}/",
            {"active": True},
            format="json",
        )
