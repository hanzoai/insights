...
from insights.taxonomy.property_access import restricted_property_names
...
# query on Datastore (no per-row person lookup in Postgres, unlike the `person` column).
