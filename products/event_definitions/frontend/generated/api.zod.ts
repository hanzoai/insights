...
export const EventDefinitionsCreateBody = /* @__PURE__ */ zod
    .object({
        ...
        primary_property: zod
            ...
            .nullish()
            .describe(
                "Name of a single property on this event that Insights UIs should display alongside the event (for example `$pathname` on `$pageview`). When set, surfaces like the session replay inspector show the property's value next to the event name without the user having to open the event."
            ),
