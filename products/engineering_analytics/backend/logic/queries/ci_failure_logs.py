"""InsightsQL assembly of a pull request's CI failure logs from the Logs product.
...
def query_ci_failure_logs(
    *,
    ...
    response = curated.run(
        ...
        # The logs table lives on the LOGS Datastore cluster, not the warehouse default.
