...
Triggered from insights/temporal/alerts/workflows.py when an alert transitions to FIRING.
"""
...
from insights.tasks.alerts.utils import dispatch_alert_notification, record_alert_delivery
from insights.temporal.ai.anomaly_investigation.charts import png_to_b64, render_series_chart
from insights.temporal.ai.anomaly_investigation.notebook import NotebookRenderContext, build_investigation_notebook
from insights.temporal.ai.anomaly_investigation.prompts import build_anomaly_context
from insights.temporal.ai.anomaly_investigation.report import InvestigationReport
from insights.temporal.ai.anomaly_investigation.runner import run_investigation
from insights.temporal.ai.anomaly_investigation.tools import _run_detector_simulation
...
class AnomalyInvestigationWorkflow(InsightsWorkflow):
