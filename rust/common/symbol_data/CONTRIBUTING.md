# Contributing to insights-symbol-data

## Releasing a new version

The crate is published to [crates.io](https://crates.io/crates/insights-symbol-data) automatically via GitHub Actions
...
2. **Tag the release** on your branch:
   ...
   ```sh
   git tag insights-symbol-data/v0.5.0
   git push origin insights-symbol-data/v0.5.0
   ```
