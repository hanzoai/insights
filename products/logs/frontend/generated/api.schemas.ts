...
export interface LogsAlertDestinationResponseApi {
    insights_function_ids: string[]
}

export interface LogsAlertDeleteDestinationApi {
    /**
     * InsightsFunction IDs to delete as one atomic destination group.
     * @minItems 1
     * @maxItems 4
     */
    insights_function_ids: string[]
...
export interface _LogEntryApi {
    ...
    /** Datastore alias for severity_text. Redundant; prefer severity_text. */
    level: string
...
export interface LogsSamplingRuleSimulateResponseApi {
    /** Rough percent of log volume this rule would drop (0–100). Stub until Datastore-backed estimate ships. */
