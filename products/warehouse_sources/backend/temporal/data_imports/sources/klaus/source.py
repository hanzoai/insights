...
class KlausSource(ResumableSource[KlausSourceConfig, KlausResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Sync your Zendesk QA (formerly Klaus) reviews, AutoQA results, CSAT, disputes, and quality data into the Insights Data warehouse.
...
Note that the Zendesk QA public API is heavily rate limited, so large initial syncs can take a while — syncs pace themselves and resume automatically.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/klaus",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
