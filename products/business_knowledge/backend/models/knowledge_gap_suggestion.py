...
class KnowledgeGapSuggestion(TeamScopedRootMixin, UUIDModel):
    ...
    team = models.ForeignKey(
        "insights.Team", on_delete=models.CASCADE, db_constraint=False, related_name="business_knowledge_gap_suggestions"
    )
    ...
    # (avoids an FK constraint on the hot insights_user table). Just track when the gap appeared.
    ...
    class Meta:
        db_table = "insights_business_knowledge_knowledgegapsuggestion"
        constraints = [
