        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        {dedent`
                            Create a Insights client, then swap in Insights's OpenAI wrapper, pointed at your
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        {dedent`
                            When you use the wrapped client to call Cloudflare AI Gateway, Insights automatically
