    ...
    return [
        {
            ...
            content: (
                <Blockquote>
                    <Markdown>
                        **Note:** LiteLLM can be used as a Python SDK or as a proxy server. Insights observability
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        Now, when you use LiteLLM to call various LLM providers, Insights automatically captures an
                        `$ai_generation` event.
                    </Markdown>
