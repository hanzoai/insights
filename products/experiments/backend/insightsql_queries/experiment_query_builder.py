...
from products.experiments.backend.insightsql_queries.breakdown_injector import BreakdownInjector
from products.experiments.backend.insightsql_queries.cuped_config import CupedQueryConfig
from products.experiments.backend.insightsql_queries.experiment_cuped_query_builder import CupedQueryBuilder
from products.experiments.backend.insightsql_queries.experiment_exposure_query_builder import ExposureQueryBuilder
from products.experiments.backend.insightsql_queries.experiment_funnel_query_builder import FunnelQueryBuilder
from products.experiments.backend.insightsql_queries.experiment_mean_query_builder import MeanQueryBuilder
from products.experiments.backend.insightsql_queries.experiment_metric_values import (
...
from products.experiments.backend.insightsql_queries.experiment_query_context import (
    ExperimentPrecomputationContext,
    ExperimentQueryContext,
)
from products.experiments.backend.insightsql_queries.experiment_ratio_query_builder import RatioQueryBuilder
from products.experiments.backend.insightsql_queries.experiment_retention_query_builder import RetentionQueryBuilder
from products.experiments.backend.insightsql_queries.exposure_query_logic import normalize_to_exposure_criteria
from products.experiments.backend.insightsql_queries.funnel_step_builder import FunnelStepBuilder
from products.experiments.backend.insightsql_queries.metric_source import MetricSourceInfo
...
class ExperimentQueryBuilder:
    ...
    # bounded by num_variants × num_breakdown_values.  The InsightsQL executor injects
    ...
    def build_query(self, precomputation_context: ExperimentPrecomputationContext | None = None) -> ast.SelectQuery:
        """
        Main entry point. Returns complete query built from InsightsQL with placeholders.
