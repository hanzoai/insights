...
from insights.models.property import GroupTypeIndex, PropertyGroup

if TYPE_CHECKING:  # Avoid circular import
    from insights.models import Property, Team
...
class SimplifyFilterMixin:
    ...
    def _simplify_entity(
        ...
        **kwargs,
        ...
        from insights.models.entity import Entity, ExclusionEntity
    ...
    def _simplify_property(self, team: "Team", property: "Property", **kwargs) -> "PropertyGroup":
        if property.type == "cohort":
            ...
            from insights.models.cohort.util import simplified_cohort_filter_properties
