...
data assets so Insights AI picks the right tables/columns and joins. The surface-specific orchestration
...
def get_team_business_context(team: Team) -> str:
    ...
    # Imported lazily — insights_ai pulls in the assistant stack we don't want on this module's import path.
    from products.insights_ai.backend.models.assistant import CoreMemory  # noqa: PLC0415
