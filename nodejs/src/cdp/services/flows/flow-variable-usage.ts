...
import { CyclotronJobInvocationFlow, CyclotronJobInvocationResult } from '~/cdp/types'
import { logger } from '~/common/utils/logger'

import { actionIdForLogging } from './flow-utils'
...
// Compiled script output carried alongside the template strings. Never scanned: it's by far the
...
export function observeMissingVariableReferences(
    ...
    logger.warn('[FlowVariableUsage] Step references variables the run does not have', {
