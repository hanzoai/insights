from insights.schema import AlertCondition, InsightThreshold, IntervalType, NodeKind
...
from products.alerts.backend.evaluation.insightsql import InsightsQLDetectorExtractor, InsightsQLExtractor
