...
from insights.schema import EndpointRequest, InsightsQLQuery

from insights.api.tagged_item import cleanup_orphan_tags, set_tags_on_object
...
class EndpointCrudService:
    ...
    def create(self, data: EndpointRequest) -> Endpoint:
        ...
        try:
            ...
            # Column extraction hits Datastore — do it outside the transaction.
            try:
