...
<!-- Insights employees: `insightscli pr:upload-image <file>` uploads to the public Insights/pr-assets repo and prints markdown to paste here. Never upload customer data, secrets, or internal info. -->
...
<!-- Added or changed tests? Name the regression each group catches that no existing test did — if you can't name it, it probably shouldn't be in this PR. https://hanzo.ai/handbook/engineering/conventions/backend-coding#testing -->

👉 _Stay up-to-date with [Insights coding conventions](https://hanzo.ai/docs/contribute/coding-conventions) for a smoother review._
