...
class TestSummarizeHelpers:
    @parameterized.expand(
        [
            ("parent", "1721999999.123456", None, "https://insights.slack.com/archives/C1/p1721999999123456"),
            (
                "thread_reply",
                "1722000010.000200",
                "1721999999.123456",
                "https://insights.slack.com/archives/C1/p1722000010000200?thread_ts=1721999999.123456&cid=C1",
            ),
        ]
    )
        ...
        assert refs == [
            {
                ...
                "permalink": "https://insights.slack.com/archives/C1/p1721999999123456",
            },
            {
                "author": "bob",
                "sent_at": "2024-07-26T13:20:10.000200+00:00",
                "permalink": "https://insights.slack.com/archives/C1/p1722000010000200?thread_ts=1721999999.123456&cid=C1",
            },
        ]
