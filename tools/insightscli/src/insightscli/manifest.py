"""Manifest loading and discovery for insightscli commands."""
...
class Manifest:
    ...
    def config(self) -> dict[str, Any]:
        """Get insightscli config section."""
    ...
    def scripts_dir(self) -> Path:
        ...
        Resolution order:
        1. config.scripts_dir in insightscli.yaml (relative to repo root)
    ...
    def env_files(self) -> list[Path]:
        ...
        Precedence between files: insightscli loads in the order returned here; the
