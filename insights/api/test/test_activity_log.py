...
from insights.models.activity_logging.activity_log import ActivityLog, Detail, log_activity
...
class TestActivityLogBearerAuthAttribution(APIBaseTest):
    ...
    def test_impersonation_minted_oauth_token_write_is_marked_impersonated(self) -> None:
        staff_user = User.objects.create_and_join(self.organization, "staff@hanzo.ai", None)
