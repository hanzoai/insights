...
from insights.schema import InsightsQLQueryModifiers, PersonsOnEventsMode, ProductKey
...
def get_survey_stats(
    *,
    ...
    modifiers = InsightsQLQueryModifiers(personsOnEventsMode=PersonsOnEventsMode.PERSON_ID_NO_OVERRIDE_PROPERTIES_ON_EVENTS)
    ...
    base_stats_query = f"""
        ...
        GROUP BY event
    """
    results_base = execute_insightsql_query(
        base_stats_query,
    ...
    """
    dismissed_and_sent_count_result = execute_insightsql_query(
