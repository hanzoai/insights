...
const ACCESS_LEVEL_OPTIONS: SelectOptionLeaf<AccessLevelEnumApi>[] = [
    { value: 'read_write', label: 'Read & write' },
    { value: 'read', label: 'Read only' },
    { value: 'none', label: 'No access' },
]

const OVERRIDE_OPTIONS: SelectOptionLeaf<AccessLevelEnumApi | null>[] = [
...
function MembersTab({
    ...
    const columns: TableColumn<MemberInfo, keyof MemberInfo | undefined>[] = [
        {
            title: 'Member',
            key: 'name',
            render: (_, member) => (
    ...
    return <Table dataSource={members} columns={columns} rowKey="id" size="small" emptyState="No members found" />
}
...
function RolesTab({
    ...
    const columns: TableColumn<RoleInfo, keyof RoleInfo | undefined>[] = [
        {
            title: 'Role',
            key: 'name',
    ...
    return <Table dataSource={roles} columns={columns} rowKey="id" size="small" emptyState="No roles found" />
}
