 ...
 * needed.
 *
 * Used by scripts/lint-tool-names.ts. The skills lint (products/insights_ai/scripts/
 ...
 * only in skill prose, and detecting them here would false-positive on SDK/InsightsQL code
