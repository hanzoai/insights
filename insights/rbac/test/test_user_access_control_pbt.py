...
# Insights CI runs the backend suite with pytest-rerunfailures (--reruns 2). A rerun
...
class BaseAccessControlPropertyTest(HypothesisDjangoTestCase, BaseTest):
    ...
    def setUpTestData(cls):
        ...
        cls.other_user = User.objects.create_and_join(cls.organization, "other-pbt@hanzo.ai", "testtest")
