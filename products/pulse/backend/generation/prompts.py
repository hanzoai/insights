...
PULSE_PROMPT_SOURCE = Counter(
    "insights_pulse_prompt_source_total",
...
- Health items (kind "health") describe broken Insights resources. When you are confident one matters, surface it as a "fix"-kind opportunity carrying its evidence; the confidence rule above still applies.
