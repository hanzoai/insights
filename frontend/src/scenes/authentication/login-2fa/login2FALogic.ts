...
export interface login2FALogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface login2FALogicActions {
    beginPasskey2FA: () => {
        value: true
    }
...
export type login2FALogicType = MakeLogicType<login2FALogicValues, login2FALogicActions>
