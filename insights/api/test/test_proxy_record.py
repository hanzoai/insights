...
class TestProxyRecordAPI(APIBaseTest):
    ...
    def test_cannot_exceed_feature_limit(self, mock_capture, mock_sync_connect):
        ...
        for i in range(2):
            ProxyRecord.objects.create(
                ...
                target_cname=f"hash{i}.proxy.hanzo.ai",
            )
    ...
    def test_retrieve_proxy_record(self):
        record = ProxyRecord.objects.create(
            ...
            target_cname="abc123.proxy.hanzo.ai",
        ...
        assert data["target_cname"] == "abc123.proxy.hanzo.ai"
    ...
    @patch("insights.api.proxy_record.diagnose_proxy_record")
    def test_diagnose_returns_report(self, mock_diagnose):
        import datetime as dt

        from insights.api.proxy_record_diagnostics import (
            CheckResult,
            DiagnosticReport,
            DnsRecord,
            Remediation,
    ...
    def test_diagnose_rate_limits_repeated_calls_per_record(self, mock_diagnose):
        ...
        from insights.api.proxy_record_diagnostics import DiagnosticReport, ReportSummary
