...
const heatmapsList = (): ToolBase<typeof HeatmapsListSchema, WithInsightsUrl<Schemas.HeatmapsResponse[]>> => ({
    name: 'heatmaps-list',
    ...
    handler: async (context: Context, params: z.infer<typeof HeatmapsListSchema>) => {
        ...
        return await withInsightsUrl(context, result, '/web')
    },
})
...
const heatmapsSavedList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.SavedHeatmapListResponse[]>
> => ({
