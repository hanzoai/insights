...
from hanzo_insights.contexts import get_capture_exception_code_variables_context
from rest_framework.exceptions import ValidationError

from insights.models import Filter
from insights.models.property import Property, PropertyGroup, PropertyValidationError
...
def test_property_group_parsing_reports_and_skips_unparsable_property(
    ...
    with patch("insights.models.filters.mixins.property.capture_exception") as mock_capture_exception:
...
def test_property_group_parsing_disables_code_variable_capture_for_reported_exception():
    # capture_exception() forwards the exception object to Insights's error-tracking SDK, which
    ...
    with patch(
        "insights.models.filters.mixins.property.capture_exception", side_effect=fake_capture_exception
