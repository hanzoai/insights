...
byte-identical (same deterministic uuid and properties). Datastore does NOT collapse duplicate
...
from products.review.backend.models import ReviewReport, ReviewReportArtefact, ReviewUserSettings
...
from products.review.backend.reviewer.models.issues_review import IssuePriority
from products.review.backend.reviewer.outcomes.comment_signal import engagement_method, find_finding_comment
from products.review.backend.reviewer.outcomes.discovery import unclassified_published_reports
from products.review.backend.reviewer.outcomes.github_fetch import fetch_compare_files, fetch_review_comments
from products.review.backend.reviewer.outcomes.judge import judge_finding
from products.review.backend.reviewer.outcomes.line_proximity import parse_compare_files, touched_near
from products.review.backend.reviewer.persistence import load_findings_bundle
from products.review.backend.reviewer.tools.github_client import GitHubAPIError
    ...
    *,
    ...
    for oc in outcomes:
        capture(
            ...
            event=_EVENT,
            # Deterministic per (report, finding): the consumer-side dedup key. Datastore itself
