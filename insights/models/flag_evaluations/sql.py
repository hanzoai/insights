...
from insights.kafka_client.topics import KAFKA_DATASTORE_FLAG_EVALUATIONS
...
#     InsightsQL will expose as `insights.flag_evaluations`.
...
ENGINE = {
        kafka_engine(
            topic=KAFKA_DATASTORE_FLAG_EVALUATIONS,
...
TO {settings.DATASTORE_DATABASE}.{FLAG_EVALUATIONS_WRITABLE_TABLE}
AS SELECT
    team_id,
    uuid,
    timestamp,
    ...
    _offset,
    _partition
FROM {settings.DATASTORE_DATABASE}.{KAFKA_FLAG_EVALUATIONS_TABLE}
"""
)
