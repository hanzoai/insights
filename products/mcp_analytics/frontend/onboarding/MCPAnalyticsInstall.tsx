...
export const MCP_ANALYTICS_DOCS_URL = 'https://hanzo.ai/docs/mcp-analytics'
        ...
        <div className="w-full max-w-2xl mx-auto space-y-8">
            <div className="text-center space-y-3">
                ...
                <p className="text-muted">
                    ...
                    the <code>@hanzo/mcp</code> SDK, wires up your credentials, and starts capturing every tool call,
            ...
            <div className="flex flex-col items-center gap-2">
                ...
                <Button type="tertiary" size="small" to={MCP_ANALYTICS_DOCS_URL} targetBlank>
