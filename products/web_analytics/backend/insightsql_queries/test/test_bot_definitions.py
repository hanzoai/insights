...
from insights.models.bot_definition.sql import _bot_definition_rows
...
class TestBotDefinitionsDataStructure:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # Insights Desktop clients
            (r"desktop\.script\.dev", "Insights Desktop", "ai_assistant", "AI Agent"),
            (r"mobile\.script\.dev", "Insights Mobile", "ai_assistant", "AI Agent"),
            (r"agent\.script\.dev", "Insights Code Agent", "ai_assistant", "AI Agent"),
            (r"cloud\.script\.dev", "Insights Code Cloud", "ai_assistant", "AI Agent"),
