...
describe('SyncProgressStep', () => {
    ...
    it('includes the direct connection id in SQL editor preview URLs', () => {
        const previewUrl = new URL(getPreviewQueryUrl('orders', 'direct', 'source-123'), 'https://app.hanzo.ai')
    ...
    it('quotes dotted table names as a single InsightsQL identifier', () => {
        const previewUrl = new URL(getPreviewQueryUrl('demo.orders', 'direct', 'source-123'), 'https://app.hanzo.ai')
