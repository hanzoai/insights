...
class ZapSignSource(
    ...
    def webhook_resource_map(self) -> dict[str, str]:
        ...
        # keyed by the wildcard the Script template looks up.
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/zapsign",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
            ...
            webhookSetupCaption=(
                "Insights tries to register a webhook in ZapSign using your API token, subscribed "
                "to all document events (created, signed, refused, deleted). The webhook "
                "authenticates itself with an **Authorization** header Insights generates and "
                ...
                "same value into the field below so Insights can verify deliveries\n"
