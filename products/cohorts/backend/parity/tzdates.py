...
datetime through Datastore ``toDate(<datetime>, tz)`` — that re-interprets an already-UTC instant
...
# Saturation floor for an astronomical window: the earliest day a Datastore `DateTime64` event
