...
from insights.insightsql.database.schema.web_analytics_s3 import get_s3_function_args, get_s3_url
...
class TestWebAnalyticsS3(BaseTest):
    @patch("insights.insightsql.database.schema.web_analytics_s3.DEBUG", False)
    ...
    @patch("insights.insightsql.database.schema.web_analytics_s3.DEBUG", True)
    def test_get_s3_url_debug_format(self):
        ...
        expected_url = "http://objectstorage:19000/insights/web_stats_daily_export/2/data.native"
    ...
    def test_get_s3_function_args_debug(self):
        s3_path = "http://objectstorage:19000/insights/path/to/file.native"
