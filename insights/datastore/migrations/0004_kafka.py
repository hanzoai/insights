...
from insights.models.event.sql import DISTRIBUTED_EVENTS_TABLE_SQL, WRITABLE_EVENTS_TABLE_SQL
...
# kafka_events was a Kafka Datastore engine table that used Protobuf for
...
# https://github.com/Insights/insights/issues/9207 for detail.
#
...
# ee/datastore/migrations/0025_json_events.py for details of the new tables.
#
