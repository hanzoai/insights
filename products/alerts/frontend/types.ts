...
export type AlertConfig = TrendsAlertConfig | InsightsQLAlertConfig | FunnelsAlertConfig | MetricsAlertConfig
...
export const isInsightsQLAlertConfig = (config: AlertConfig | null | undefined): config is InsightsQLAlertConfig =>
    config?.type === 'InsightsQLAlertConfig'
...
export const isAnyRowInsightsQLConfig = (config: AlertConfig | null | undefined): boolean =>
    isInsightsQLAlertConfig(config) && config.evaluation === 'any_row'

// Capability helpers — read at call sites instead of bare `isTrendsAlertConfig`/`isInsightsQLAlertConfig`
...
export const supportsTimeWindow = (config: AlertConfig | null | undefined): boolean => !isInsightsQLAlertConfig(config)
...
export const supportsAnomalyDetection = (config: AlertConfig | null | undefined): boolean =>
    isTrendsAlertConfig(config) || (isInsightsQLAlertConfig(config) && !isAnyRowInsightsQLConfig(config))
