...
from insights.insightsql.compiler.javascript import JavaScriptCompiler, Local, _sanitize_identifier, to_js_expr, to_js_program
...
return fibonacci(6);"""
    ...
    def test_javascript_insightsqlx(self):
