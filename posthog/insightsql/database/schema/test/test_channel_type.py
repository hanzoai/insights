...
from posthog.schema import CustomChannelCondition, CustomChannelRule, FilterLogicalOperator, InsightsQLQueryModifiers
...
class TestChannelType(ClickhouseTestMixin, APIBaseTest):
    ...
    def _get_session_channel_type(self, properties=None, custom_channel_rules=None):
        ...
        session_response = execute_insightsql_query(
            parse_select(
