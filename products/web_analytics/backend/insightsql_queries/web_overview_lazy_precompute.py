...
from insights.datastore.preaggregation.web_overview_preaggregated_sql import (
...
def execute_read_query(
    *,
    ...
    Bypasses InsightsQL so we can set `select_sequential_consistency=1` on the SELECT —
    InsightsQLGlobalSettings forbids extra keys, and the read query shape is stable
