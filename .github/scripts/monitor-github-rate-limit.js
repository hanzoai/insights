// Polls GitHub's /rate_limit endpoint and emits one Insights event per resource.
//
...
// Insights — which event types and PR sizes precede the steepest core burn.
...
// GitHub App installation bucket (e.g. insights-devex-general, the setup-action
