...
from insights.auth import OAuthAccessTokenAuthentication, PersonalAPIKeyAuthentication, ProjectSecretAPIKeyAuthentication
from insights.permissions import APIScopePermission, is_authenticated_via_project_secret_api_key
