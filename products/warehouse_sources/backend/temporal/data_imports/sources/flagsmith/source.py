...
class FlagsmithSource(ResumableSource[FlagsmithSourceConfig, FlagsmithResumeConfig], ValidateDatabaseHostMixin):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Flagsmith organisation API key to pull your projects, environments, feature flags, flag states, segments, and audit log into the Insights Data warehouse.
...
Leave the API URL blank for Flagsmith SaaS, or set it to your API host (for example `https://flagsmith.example.com`) for a self-hosted deployment.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/flagsmith",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
