...
const context = { repo: { owner: 'Insights', repo: 'insights' } }
...
describe('monitor-github-rate-limit', () => {
    ...
    it('tags emissions with the offload bucket source when overridden', async () => {
        ...
        await monitor({ github, context, core }, { now: () => T_BASE, fetch: fetchMock, source: 'insights-devex-general' })

        assertMatch(captured[0].properties, {
            resource: 'core',
            remaining: 14500,
            limit: 15000,
            source: 'insights-devex-general',
        })
    })
