...
def create_person_backfill_run_for_cohort(
    ...
    *,
    ...
    sizing failure (a Datastore timeout or transport error), which propagates so the task's retry
    ...
    # Unlocked pre-pass for the sizing gate: the estimate is a Datastore round trip, so it must not
