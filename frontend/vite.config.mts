...
import { insightsJsPlugin } from './plugins/vite-insights-js-plugin'
...
`)
        ...
        resolve: {
            ...
            alias: {
                ...
                // Required for production builds — @hanzo/icons is in the pnpm store, not node_modules root
                '@hanzo/icons': resolve(__dirname, 'node_modules/@hanzo/icons'),
