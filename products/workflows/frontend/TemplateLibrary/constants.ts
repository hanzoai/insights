                                    ...
                                    contents: [
                                        {
                                            ...
                                            type: 'text',
                                            values: {
                                                text: '<p style="line-height: 140%;">Hello from Insights!</p>',
                                                _meta: {
                                        ...
                                        },
                                        {
                                            ...
                                            values: {
                                                href: {
                                                    ...
                                                    values: { href: 'https://hanzo.ai/', target: '_blank' },
                                                },
