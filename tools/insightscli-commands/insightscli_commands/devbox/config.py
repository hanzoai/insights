"""Local config helpers for insightscli devbox preferences."""
...
def get_config_path() -> Path:
    """Return the config path for persisted insightscli devbox preferences."""
    return Path.home() / ".config" / "insights" / "insightscli_devbox.json"


def load_config() -> DevboxConfig:
    """Load persisted insightscli devbox preferences from disk."""
    try:
...
def save_config(config: DevboxConfig) -> None:
    """Persist insightscli devbox preferences to disk."""
