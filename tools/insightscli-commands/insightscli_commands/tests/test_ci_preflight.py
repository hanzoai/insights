...
from insightscli_commands.ci_preflight import DIFF_CHECKS, _pnpm_workspace_root, _run_workspace_scoped, _staleness_risks
...
class TestWorkspaceScopedLockfile:
    ...
    @patch("insightscli_commands.ci_preflight._workspace_install_present", return_value=True)
    @patch("insightscli_commands.ci_preflight.shutil.which", return_value="/usr/bin/pnpm")
    @patch("insightscli_commands.ci_preflight.subprocess.run")
    ...
    @patch("insightscli_commands.ci_preflight._workspace_install_present", return_value=False)
