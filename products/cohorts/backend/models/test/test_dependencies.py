...
class TestCohortBackfillOnConditionsChanged(BaseTest):
    ...
    @mock.patch("insights.tasks.calculate_cohort.trigger_cohort_backfill_task")
    ...
    @mock.patch("hanzo_insights.feature_enabled", return_value=True)
    ...
    @mock.patch("products.cohorts.backend.models.dependencies._trigger_cohort_backfill")
    @mock.patch("hanzo_insights.feature_enabled", return_value=True)  # Flag enabled, but cohort type prevents trigger
    ...
    @mock.patch("products.cohorts.backend.models.dependencies._trigger_cohort_backfill")
    @mock.patch(
        "hanzo_insights.feature_enabled", return_value=True
    ...
    @mock.patch("products.cohorts.backend.models.dependencies._trigger_cohort_backfill")
    @mock.patch("hanzo_insights.feature_enabled", return_value=False)
