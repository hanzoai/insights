...
Run inside the Insights web container:
...
from insights.models import Organization, PersonalAPIKey, Team, User  # noqa: E402
from insights.models.utils import generate_random_token_personal, hash_key_value, mask_key_value  # noqa: E402
...
user = User.objects.filter(email="ci@hanzo.ai").first()
if not user:
    user = User.objects.create_and_join(org, "ci@hanzo.ai", "CiTest123!", "Hobby CI")
