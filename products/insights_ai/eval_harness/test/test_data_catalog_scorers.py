...
@parameterized.expand(
    [
        ...
        (
            ...
            [
                ("Read", {"file_path": "/root/.claude/skills/querying-insights-data/SKILL.md"}, "completed"),
                ...
                ("ToolSearch", {"query": "select:mcp__insights__execute-sql"}, "completed"),
                ("execute-sql", {"query": CATALOG_QUERY}, "completed"),
            ],
            1.0,
        ),
        ...
        (
            ...
            [
                ("mcp__insights_us__exec", {"command": "SELECT count() FROM events"}, "completed"),
                ("execute-sql", {"query": CATALOG_QUERY}, "completed"),
            ],
            0.0,
        ),
