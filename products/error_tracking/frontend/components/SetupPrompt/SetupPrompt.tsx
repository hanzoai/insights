...
export const ERROR_TRACKING_FRAMEWORK_LINKS: {
...
}[] = [
    {
        ...
        docsLink: 'https://hanzo.ai/docs/error-tracking/installation/web',
    },
    { name: 'Next.js', image: nextjsImage, docsLink: 'https://hanzo.ai/docs/error-tracking/installation/nextjs' },
    { name: 'React', image: reactImage, docsLink: 'https://hanzo.ai/docs/error-tracking/installation/react' },
    { name: 'Node.js', image: nodejsImage, docsLink: 'https://hanzo.ai/docs/error-tracking/installation/node' },
    { name: 'Python', image: pythonImage, docsLink: 'https://hanzo.ai/docs/error-tracking/installation/python' },
    { name: 'iOS', image: <IOSLogo />, docsLink: 'https://hanzo.ai/docs/error-tracking/installation/ios' },
    { name: 'Android', image: androidImage, docsLink: 'https://hanzo.ai/docs/error-tracking/installation/android' },
    {
        name: 'React Native',
        image: reactImage,
        docsLink: 'https://hanzo.ai/docs/error-tracking/installation/react-native',
    },
    { name: 'Flutter', image: flutterImage, docsLink: 'https://hanzo.ai/docs/error-tracking/installation/flutter' },
    { name: 'Other', docsLink: 'https://hanzo.ai/docs/error-tracking/installation' },
]
...
export function ErrorTrackingIngestionPrompt({
    ...
    return (
        <IntroductionComponent
            ...
            description="Insights captures exceptions from any of our SDKs. JavaScript apps can flip on exception autocapture; other platforms wire it up in code – the docs have per-SDK instructions."
            isEmpty={true}
            ...
            actionElementOverride={
                <div className={actionElementClassName}>
                    <p className="text-sm text-secondary m-0">
                        Read our{' '}
                        <Link to="https://hanzo.ai/docs/error-tracking" onClick={onDocsLinkClick}>
                            error tracking docs
                        </Link>
