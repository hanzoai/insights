...
function LifecycleStrip({ summary, openedAt, commitGroups }: LifecycleStripProps): JSX.Element {
    ...
    return (
        <Card hoverEffect={false} className="px-5 py-4">
...
function PerPushRunsTable({
    ...
    const columns: TableColumns<PrRunRow> = [
        {
            title: 'Push',
            key: 'push',
            render: (_, run) =>
        ...
        },
        {
            ...
            render: (_, run) =>
                (run.runAttempt ?? 1) > 1 ? (
                    <Tag type="warning">{run.runAttempt}</Tag>
                ) : (
...
function PrWorkflowsTable({
    ...
    const columns: TableColumns<PrWorkflowRow> = [
        {
            title: 'Workflow',
            key: 'workflow',
        ...
        return (
            <SceneContent>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button type="secondary" size="small" onClick={loadLifecycle} loading={lifecycleLoading}>
                        Retry
                    </Button>
                </div>
            </SceneContent>
                        ...
                        slug={
                            <>
                                ...
                                <span className="flex items-center gap-1.5">
                                    ...
                                    {pullRequest.author.is_bot && <Tag type="muted">bot</Tag>}
                                </span>
                                <span>
            ...
            >
                ...
                {prRunsLoading && commitGroups.length === 0 ? (
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Button type="secondary" size="small" onClick={loadPrRuns} loading={prRunsLoading}>
                            Retry
                        </Button>
                    </div>
                ) : commitGroups.length === 0 ? (
