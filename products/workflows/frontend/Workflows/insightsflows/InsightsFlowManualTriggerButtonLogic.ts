...
export interface flowManualTriggerButtonLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface flowManualTriggerButtonLogicActions {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface flowManualTriggerButtonLogicMeta {
    key: string
    __keaTypeGenInternalSelectorTypes: {
        variableValues: (inputs: Record<string, string>, workflow: InsightsFlow) => Record<string, any>
    }
}

export type flowManualTriggerButtonLogicType = MakeLogicType<
    flowManualTriggerButtonLogicValues,
    flowManualTriggerButtonLogicActions,
    WorkflowLogicProps,
    flowManualTriggerButtonLogicMeta
>

export const flowManualTriggerButtonLogic = kea<flowManualTriggerButtonLogicType>([
    path(['products', 'workflows', 'frontend', 'Workflows', 'insightsflows', 'flowManualTriggerButtonLogic']),
