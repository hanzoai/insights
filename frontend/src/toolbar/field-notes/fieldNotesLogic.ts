...
export interface fieldNotesLogicValues {
    ...
    fieldNotesLoading: boolean
    hasOpenedFieldNotes: boolean
    ...
    submitResult: FieldNote | null
    submitResultLoading: boolean
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface fieldNotesLogicActions {
    clearSelection: () => {
        value: true
    }
    deleteFieldNote: (id: string) => {
        id: string
    }
...
export type fieldNotesLogicType = MakeLogicType<
    fieldNotesLogicValues,
    fieldNotesLogicActions,
    Record<string, any>,
    fieldNotesLogicMeta
>
...
export const fieldNotesLogic = kea<fieldNotesLogicType>([
    ...
    selectors({
        hoverElementRect: [
            ...
            (hoverElement: HTMLElement | null): ElementRect | null =>
                hoverElement ? getRectForElement(hoverElement) : null,
        ],
        selectedElementRect: [
            (s) => [s.selectedElement, s.rectUpdateCounter],
            (selectedElement: HTMLElement | null): ElementRect | null =>
                selectedElement ? getRectForElement(selectedElement) : null,
        ],
    }),
    ...
    listeners(({ actions, values }) => ({
        showButtonFieldNotes: () => {
            toolbarInsightsJS.capture('toolbar mode triggered', { mode: 'field-notes', enabled: true })
            actions.loadFieldNotes()
        },
        hideButtonFieldNotes: () => {
            toolbarInsightsJS.capture('toolbar mode triggered', { mode: 'field-notes', enabled: false })
        },
