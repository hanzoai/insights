...
def core_coupling_count(refs: list[Reference]) -> int:
    """The PR-strategy gate from the skill: internals imports from insights/ and ee/."""
    return sum(1 for r in refs if r.is_import and (r.file.startswith("insights/") or r.file.startswith("ee/")))
