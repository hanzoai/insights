...
from insights.helpers.encrypted_fields import EncryptedFieldMixin
from insights.models.integration import Integration
from insights.models.team.team import Team
from insights.utils import decompress, load_data_from_request
    ...
    if not integrations:
        return cors_response(
            ...
            generate_exception_response(
                ...
                "Please configure the integration in your Insights project settings.",
                type="validation_error",
