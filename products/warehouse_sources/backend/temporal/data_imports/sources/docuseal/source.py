...
class DocusealSource(ResumableSource[DocusealSourceConfig, DocusealResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your DocuSeal API key to sync your templates, submissions, and submitters into the Insights Data warehouse.
...
Pick the region your DocuSeal account is hosted in. Self-hosted deployments are not supported yet.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/docuseal",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
