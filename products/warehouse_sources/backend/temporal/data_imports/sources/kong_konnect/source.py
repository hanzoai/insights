...
class KongKonnectSource(ResumableSource[KongKonnectSourceConfig, KongKonnectResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter a Kong Konnect access token to pull your gateway's Advanced Analytics API request logs into the Insights Data warehouse.
...
How far back the initial sync can reach depends on your Konnect plan's Advanced Analytics data retention.""",
            docsUrl="https://hanzo.ai/docs/cdp/sources/kong-konnect",
