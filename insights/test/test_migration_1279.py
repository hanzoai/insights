...
from insights.models import IdentityProviderConfig, LinkedIdentityProviderConfig, OrganizationDomain

migration = import_module("insights.migrations.1288_backfill_linked_identity_provider_configs")
