...
const VERSION_TAG_TYPES: TagType[] = ['success', 'warning', 'caution', 'danger', 'completion']

export function versionTag(
    obsVersion: number | null | undefined,
    currentVersion: number | null | undefined
): { type: TagType; label: string; tooltip: string } | null {
    if (obsVersion == null) {
        return null
    }
...
export function ScannerObservationsTable({ scannerId }: { scannerId: string }): JSX.Element {
    ...
    const columns: TableColumns<ReplayObservationApi> = [
        ...
        },
        {
            ...
            key: 'triggered_by',
            render: (_, obs) => (
                <Tag type={OBSERVATION_TRIGGER_TAG[obs.triggered_by].type}>
