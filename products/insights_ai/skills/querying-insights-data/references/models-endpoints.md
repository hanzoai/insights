...
API endpoints that expose saved InsightsQL or insight queries as callable API routes.
...
- Boolean fields (`is_active`) are exposed as integers (0/1) for InsightsQL compatibility
