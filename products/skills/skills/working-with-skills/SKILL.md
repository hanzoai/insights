...
description: >-
  Best practices for agents managing Insights skills via the MCP `skill-*` tools —
...
## Porting a local SKILL.md tree into Insights
...
3. Call `insights:skill-create` once with everything — the skill lands at
