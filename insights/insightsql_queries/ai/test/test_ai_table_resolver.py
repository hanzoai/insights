...
from insights.insightsql_queries.ai.ai_table_resolver import (
...
class TestIsAiEventsEnabled:
    @patch("insights.insightsql_queries.ai.ai_table_resolver.feature_enabled_or_false", return_value=True)
    ...
    @patch("insights.insightsql_queries.ai.ai_table_resolver.feature_enabled_or_false", return_value=False)
...
class TestQueryAiEvents:
    ...
    @patch("insights.insightsql_queries.ai.ai_table_resolver.use_new_events_schema", return_value=True)
    @patch("insights.insightsql_queries.ai.ai_table_resolver.execute_insightsql_query")
    ...
    def test_omits_unset_optional_kwargs(self, mock_execute):
        ...
        # execute_insightsql_query's defaults (workload=DEFAULT, etc).
        mock_execute.return_value = self._make_result([["found"]])
