...
import __dataVisualizationInsightsQL from '../../../mocks/fixtures/api/projects/team_id/insights/dataVisualizationInsightsQL.json'
...
export const SavedInsightsQLDataTable: Story = createInsightStory(__dataTableInsightsQL as any, 'view', false, {
    openSidePanel: true,
})

export const SavedDataVisualization: Story = createInsightStory(__dataVisualizationInsightsQL as any, 'view', false, {
    openSidePanel: true,
})
