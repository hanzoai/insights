...
describe('ToolExecutor metrics', () => {
    ...
    describe('direct tool calls', () => {
        ...
        it('stamps $mcp_error_code and index-normalized $mcp_error_field for a InsightsValidationError', async () => {
            vi.spyOn(catalog, 'getToolByName').mockReturnValue(
                makeFakeTool('fail-tool', async () => {
        ...
        it.each([
            ...
            [
                'a InsightsValidationError (controlled code + field only, never the detail body)',
                new InsightsValidationError({
        ...
        it('rebuilds InsightsApiError messages from status + path, never the response body or query string', async () => {
            vi.spyOn(catalog, 'getToolByName').mockReturnValue(
                makeFakeTool('fail-tool', async () => {
