...
//!
//! Verifies that a row written to `insights_instancesetting` under
//! `constance:insights:FLAGS_LOG_BODIES_TEAMS` propagates into the Rust
...
//! `insights_instancesetting` row when cargo runs integration tests in parallel.
