...
const AI_DATA_PROCESSING_DISMISSED_STORAGE_KEY = `insights_ai_data_processing_dismissed_${dayjs().format('YYYY-MM')}`

// Records, per organization, that this member has already asked an admin to enable
// Insights AI — so the request button doesn't invite repeated submissions.
const AI_ACCESS_REQUESTED_STORAGE_KEY = 'insights_ai_access_requested_by_org'
