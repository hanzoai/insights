...
``InsightsQLParserShadowMismatch`` it is not a single pure parser (it ran a
...
from insights.insightsql.parser import InsightsQLParserShadowMismatch
from insights.insightsql.scripts import _diagnostic_common
from insights.insightsql.scripts._diagnostic_common import _safe_parse, corpus_try_parse
from insights.insightsql.scripts.parser_bench import bench

_PARSE_HELPERS = [("_safe_parse", _safe_parse), ("corpus_try_parse", corpus_try_parse)]


def _raise_shadow_mismatch(_query, *, backend):
    raise InsightsQLParserShadowMismatch("select parser AST mismatch: cpp-json vs rust-json")
...
class TestDiagnosticShadowGuard(TestCase):
    ...
    def test_shadow_mismatch_aborts_the_grind(self, _name, parse_fn):
        ...
        self.assertIn("InsightsQLParserShadowMismatch", message)
    ...
    def test_bench_aborts_on_shadow_mismatch(self):
        ...
        self.assertIn("InsightsQLParserShadowMismatch", str(ctx.exception))
