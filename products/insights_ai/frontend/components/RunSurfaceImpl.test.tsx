...
describe('RunSurface', () => {
    ...
    it('does not mount the ACP run surface for a Pi task', () => {
        ...
        expect(screen.getByText("Pi session logs aren't available in Insights yet.")).toBeInTheDocument()
    ...
    it('keeps the ACP run surface available when an older API response omits runtime', () => {
        ...
        expect(screen.queryByText("Pi session logs aren't available in Insights yet.")).not.toBeInTheDocument()
    })
