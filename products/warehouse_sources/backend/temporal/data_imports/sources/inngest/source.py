...
class InngestSource(ResumableSource[InngestSourceConfig, InngestResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Inngest signing key to pull your Inngest data into the Insights Data warehouse.
...
Inngest retains event and run history for a plan-dependent window (from 24 hours up to 90 days), so schedule frequent syncs to keep a complete history in Insights.""",
            iconPath="/static/services/inngest.svg",
            docsUrl="https://hanzo.ai/docs/cdp/sources/inngest",
