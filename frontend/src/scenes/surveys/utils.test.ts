...
describe('survey utils', () => {
    ...
    describe('getSurveyResponse', () => {
        it('uses the backend InsightsQL helper for single-value questions', () => {
            const question = {
                id: 'question-123',
                type: SurveyQuestionType.Rating,
                question: 'How satisfied are you?',
        ...
        it('uses the backend InsightsQL helper for multiple choice questions', () => {
            const question = {
                id: 'question-456',
                type: SurveyQuestionType.MultipleChoice,
    ...
    describe('getExpressionCommentForQuestion', () => {
        ...
        it('collapses newlines so multi-line question text stays on a single line', () => {
            // Regression: a newline followed by a non-ASCII char used to leak past the `--` InsightsQL
