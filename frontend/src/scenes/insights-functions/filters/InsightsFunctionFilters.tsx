...
import { InsightsFunctionFiltersInternal } from './InsightsFunctionFiltersInternal'
...
export function InsightsFunctionFilters({
    embedded = false,
    ...
    useAttachedContext([
        {
            type: 'insights_function_filters',
    ...
    if (type === 'internal_destination') {
        return <InsightsFunctionFiltersInternal />
    }
                            ...
                            {isDataWarehouse ? null : (
                                <>
                                    ...
                                    <PropertyFilters
                                        ...
                                        pageKey={`InsightsFunctionPropertyFilters.${type}`}
    ...
    return (
        <MaxTool
            identifier="create_insights_function_filters"
            context={{
