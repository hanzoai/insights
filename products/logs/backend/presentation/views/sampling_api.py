...
from insights.schema import PropertyGroupFilter
...
class LogsSamplingRuleSimulateResponseSerializer(serializers.Serializer):
    estimated_reduction_pct = serializers.FloatField(
        help_text="Rough percent of log volume this rule would drop (0–100). Stub until Datastore-backed estimate ships."
    )
...
class LogsSamplingRuleViewSet(TeamAndOrgViewSetMixin, viewsets.ModelViewSet):
    ...
    lookup_field = "id"
    insights_feature_flag = "logs-settings-drop-rules"
        ...
        return Response(
            {
                ...
                "notes": "Simulation not yet implemented against Datastore.",
            },
