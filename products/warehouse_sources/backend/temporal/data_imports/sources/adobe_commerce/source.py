...
CAPTION = """Enter your Adobe Commerce (Magento 2) store URL and API credentials to pull your store data into the Insights Data warehouse.
...
class AdobeCommerceSource(ResumableSource[AdobeCommerceSourceConfig, AdobeCommerceResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/adobe-commerce",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
