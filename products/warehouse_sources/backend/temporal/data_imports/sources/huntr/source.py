...
class HuntrSource(ResumableSource[HuntrSourceConfig, HuntrResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Huntr organization access token to pull your Organization API data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/huntr",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
