...
export interface pipelineNodeLogsLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface pipelineNodeLogsLogicActions {
    clearBackgroundLogs: () => {
        value: true
    }
    loadLogs: () => any
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface pipelineNodeLogsLogicMeta {
    key: number | string
...
export type pipelineNodeLogsLogicType = MakeLogicType<
    pipelineNodeLogsLogicValues,
    pipelineNodeLogsLogicActions,
    PipelineNodeLogsLogicProps,
    pipelineNodeLogsLogicMeta
>
...
export const pipelineNodeLogsLogic = kea<pipelineNodeLogsLogicType>([
    ...
    selectors(({ actions, values }) => ({
        node: [
            (_, p) => [p.id],
            (id: number | string): PipelineNodeLimitedType => {
                if (typeof id === 'string') {
        ...
        columns: [
            (s) => [s.node],
            (node: PipelineNodeLimitedType): TableColumns<LogEntry> => {
                return [
                    {
                        title: 'Timestamp',
                        key: 'timestamp',
