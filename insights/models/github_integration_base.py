...
from insights.egress.github.transport import GitHubRateLimitError, github_request, raise_if_github_rate_limited
...
class GitHubIntegrationError(Exception):
    ...
    error after retry). Rate limits raise ``GitHubRateLimitError`` from ``insights.egress.github``
...
class GitHubIntegrationBase:
    ...
    def installation_reference_count(
        ...
        *,
        ...
        """Count Insights rows that reference a GitHub App installation.
    ...
    def uninstall_if_last_reference(
        ...
        *,
        ...
        """Uninstall the App on GitHub only when no other Insights row references it."""
        if not installation_id:
            return False
    ...
    def list_commit_attributions(
        ...
        *,
        ...
        # git log it joins against (insights/insights: ~11k listed entries per 90 days).
        max_pages: int = 150,
