...
} from './customFunctionConfigurationLogic'
import type { customFunctionTestLogicType } from './customFunctionTestLogicType'

export type CustomFunctionTestInvocationForm = {
...
export const customFunctionTestLogic = kea<customFunctionTestLogicType>([
    ...
    forms(({ props, actions, values }) => ({
        testInvocation: {
            ...
            } as CustomFunctionTestInvocationForm,
            ...
            submit: async (data) => {
                ...
                if (values.configurationHasErrors) {
                    ...
                    const configLogic = customFunctionConfigurationLogic(props)
                ...
                try {
                    const res = await api.customFunctions.createTestInvocation(props.id ?? 'new', {
                        globals,
