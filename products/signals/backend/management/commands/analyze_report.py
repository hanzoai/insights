...
DEFAULT_REPOSITORY = "insights/insights"
...
TEST_SIGNALS = [
    SignalData(
        ...
        content=(
            ...
            "the % change in conversion between those two periods. Current workaround is InsightsQL "
        ...
        extra={
            ...
            "url": "https://github.com/Insights/insights/issues/42606",
        },
    ),
    SignalData(
        ...
        extra={
            "labels": ["feature/funnels", "team/product-analytics"],
            "url": "https://github.com/Insights/insights/issues/42995",
        },
    ),
    SignalData(
        ...
        extra={
            "labels": ["feature/funnels", "team/product-analytics"],
            "url": "https://github.com/Insights/insights/issues/42996",
        },
    ),
    SignalData(
...
UPDATE_SIGNAL = SignalData(
    ...
    extra={
        "labels": ["feature/funnels", "team/product-analytics"],
        "url": "https://github.com/Insights/insights/issues/43310",
    },
)
