...
from insights.temporal.session_replay.session_summary_group.workflow import SummarizeSessionGroupWorkflow

WORKFLOW_MODULE = "insights.temporal.session_replay.session_summary_group.workflow"
