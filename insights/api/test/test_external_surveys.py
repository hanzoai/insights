...
class TestExternalSurveys(APIBaseTest):
    ...
    @patch("insights.api.survey.logger")
    def test_database_error_handling(self, mock_logger):
        """Test proper error handling for database errors"""
        with patch("insights.models.surveys.survey.Survey.objects.select_related") as mock_select:
    ...
    @patch("insights.api.survey.capture_exception")
