...
class TestBlockInsightsCodeTaskIfNoPersonalGitHub(TestCase):
    def setUp(self):
    ...
    def test_returns_true_and_posts_block_when_user_has_no_personal_github(self, mock_slack_cls):
        ...
        blocked = block_insights_code_task_if_no_personal_github_activity(
    ...
    @patch("products.slack_app.backend.feature_flags.hanzo_insights.feature_enabled")
    @patch("insights.temporal.ai.slack_app.activities.messaging.SlackIntegration")
