# Channels & Threads (Insights Desktop / Bluebird)
...
class Task(...):
    ...
    # + Index(fields=["channel", "-created_at"], name="insights_task_channel_feed_idx") for the feed
...
class TaskThreadMessage(models.Model):
    ...
    author = models.ForeignKey("insights.User", on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    content = models.TextField()
    forwarded_to_agent_at = models.DateTimeField(null=True, blank=True)
    forwarded_by = models.ForeignKey("insights.User", on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
...
## Client (Insights Desktop, bluebird mode)
