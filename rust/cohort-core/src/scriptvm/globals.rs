//! Build ScriptVM globals dicts from [`CohortStreamEvent`]s for cohort bytecode evaluation.
...
/// Normalize a Datastore `"YYYY-MM-DD HH:MM:SS.ffffff"` timestamp to ISO 8601. RFC 3339 input
...
mod tests {
    ...
    #[test]
    fn datastore_timestamp_normalizes_to_iso_millis_z() {
        assert_eq!(
