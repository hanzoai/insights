...
from insights.models.organization import ProductFeature
...
def should_enforce_events_retention(team_id: int) -> bool:
    ...
    Keyed on team_id so it stays DB-free on the InsightsQL hot path: the settings override wins (ops kill switch /
