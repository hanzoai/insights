SYSTEM_PROMPT = """You are generating realistic synthetic feedback signals for testing a customer-feedback grouping pipeline at Insights.

Insights is a product analytics platform. Surface areas include: Product analytics (insights, dashboards, funnels, retention, paths, lifecycle, stickiness), Session replay, Surveys, Feature flags, Experiments, Web analytics, Data warehouse, Workflows / script flows, AI observability, Error tracking, SQL editor, Notebooks, Cohorts, Toolbar / autocapture.
...
- Do NOT include URLs to real Insights Slack threads, Notion docs, or internal links — keep it user-facing.
