...
from insights.schema import WebAnalyticsItemKind, WebOverviewItem, WebStatsBreakdown

from insights.api.external_web_analytics.query_adapter import ExternalWebAnalyticsQueryAdapter
from insights.api.external_web_analytics.serializers import (
...
class TestExternalWebAnalyticsQueryAdapterOverview(APIBaseTest):
    ...
    @patch("insights.api.external_web_analytics.query_adapter.WebOverviewQueryRunner")
