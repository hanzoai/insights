...
/// The dev-stack leader-mode router (bin/mprocs.yaml `personinsights-router-leader`).
pub const DEV_STACK_ROUTER_URL: &str = "http://127.0.0.1:50054";

#[derive(Parser)]
#[command(
    name = "personinsights-test-harness",
    about = "Load, consistency, and e2e correctness harness for the personinsights leader path"
)]
pub struct Cli {
    #[command(subcommand)]
    pub command: Command,
...
pub struct SeedArgs {
    ...
    #[arg(long, default_value = "personinsights_person_tmp")]
...
pub struct GateArgs {
    ...
    /// cleans up in it. insights_person is deliberately never touched.
    #[arg(long, default_value = "personinsights_person_tmp")]
    pub pg_target_table: String,
    ...
    /// Create the persons through the personinsights-identity service
...
pub struct TrafficArgs {
    /// Router serving the personinsights stack under continuous test.
    ...
    #[arg(
        ...
        default_value = "personinsights_person_tmp"
    )]
    pub pg_target_table: String,
    ...
    /// `component=app`, which in the personinsights charts matches the
    /// namespace name and excludes pgbouncer sidecars.
    #[arg(
        long,
        env = "CHAOS_LEADER_NAMESPACE",
        default_value = "personinsights-leader"
    )]
    ...
    #[arg(
        ...
        default_value = "personinsights-router-leader"
    )]
    ...
    #[arg(
        ...
        default_value = "personinsights-writer"
    )]
    ...
    #[arg(long, env = "CHAOS_ETCD_PREFIX", default_value = "/personinsights/")]
