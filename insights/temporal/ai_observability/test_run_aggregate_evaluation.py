...
from insights.temporal.ai_observability.evaluation_workflow_activities import RunEvaluationInputs
...
from insights.temporal.ai_observability.run_session_evaluation import ExecuteSessionEvaluationInputs
...
def _insert_ai_event(
    *,
    ...
    `bulk_create_ai_events` (insights/models/ai_events/test_util.py) can't do this: it derives
