...
from insights.temporal.signup_enrichment.workflow import (
    MAX_ENRICH_ATTEMPTS,
...
_MODULE = "insights.temporal.signup_enrichment.workflow"
...
async def test_connection_cleanup_runs_on_the_orm_thread():
    ...
    with (
        ...
        snapshot,
        patch(
            "insights.temporal.common.utils._close_initialized_connections",
