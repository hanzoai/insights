...
from insights.models.event.sql import SELECT_PROP_VALUES_SQL_WITH_FILTER
from insights.models.person.sql import SELECT_PERSON_PROP_VALUES_SQL, SELECT_PERSON_PROP_VALUES_SQL_WITH_FILTER
