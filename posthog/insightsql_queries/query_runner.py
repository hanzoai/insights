...
from posthog.insightsql.modifiers import create_default_modifiers_for_user
...
from posthog.insightsql_queries.query_cache import count_query_cache_hit
from posthog.insightsql_queries.query_cache_base import QueryCacheManagerBase
from posthog.insightsql_queries.query_cache_factory import get_query_cache_manager
from posthog.insightsql_queries.query_metadata import extract_query_metadata
from posthog.insightsql_queries.utils.event_usage import log_event_usage_from_query_metadata
...
def get_query_runner(
    ...
    if kind == "SuggestedQuestionsQuery":
        from posthog.insightsql_queries.ai.suggested_questions_query_runner import SuggestedQuestionsQueryRunner
