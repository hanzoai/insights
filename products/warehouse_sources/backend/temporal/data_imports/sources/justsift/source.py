...
class JustSiftSource(ResumableSource[JustSiftSourceConfig, JustSiftResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter a Sift API token to pull your organization's people directory and field catalog into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/justsift",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
