...
Same PR `https://github.com/Insights/insights/pull/62096` at frozen head `ba725a89` (re-verify pre-flight).
...
(`LABEL=<label> ... OUT_DIR=products/review/eval/experiments/2026-07-pipeline-models/runs`)
