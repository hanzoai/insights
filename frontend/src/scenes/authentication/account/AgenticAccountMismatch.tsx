...
export function AgenticAccountMismatch(): JSX.Element {
    ...
    const submitLogout = (): void => {
        ...
        csrfInput.value = getCookie('insights_csrftoken') || ''
        ...
        <BridgePage view="agentic-account-mismatch">
            ...
            <div className="text-center mb-6">
                <p className="mb-2">
                    ...
                    linked to {expectedEmail ? <strong>{expectedEmail}</strong> : 'a different Insights account'}.
                </p>
                <p>To continue, log out and sign in with the correct email.</p>
            </div>
            <div className="flex flex-col gap-2">
                <Button fullWidth type="primary" center onClick={submitLogout}>
