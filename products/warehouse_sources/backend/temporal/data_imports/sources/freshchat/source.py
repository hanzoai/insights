...
class FreshchatSource(ResumableSource[FreshchatSourceConfig, FreshchatResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            label="Freshchat",
            caption="""Enter your Freshchat account domain and API token to pull your Freshchat messaging data into the Insights Data warehouse.
...
Your **API token** is generated by an account admin under **Admin settings → API tokens**. It is sent as a Bearer token.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/freshchat",
