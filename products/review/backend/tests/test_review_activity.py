...
from products.review.backend.reviewer.artefact_content import PRSnapshotArtefact
...
from products.review.backend.reviewer.tools.select_perspectives import PerspectiveSelectionDTO
from products.review.backend.temporal.activities import (
...
_MODULE = "products.review.backend.temporal.activities"
            ...
            await ActivityEnvironment().run(
                ...
                _review_input(
                    ...
                    wave_perspectives=[
                        LoadedPerspectiveDTO(
                            pass_number=1,
                            skill_name="review-script-perspective-logic",
                            version=1,
