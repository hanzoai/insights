...
import {
    ...
    type DateTimeValue,
    quickRanges,
} from '@hanzo/quill-components'
import { Button, Popover, PopoverContent, PopoverTrigger } from '@hanzo/quill-primitives'

import { dayjs } from 'lib/dayjs'

// Quick ranges that translate to Insights relative date strings, so queries stay
// rolling ("-7d" re-resolves on every load). Minute-level ranges are omitted on
// purpose: in Insights date strings "m" means months, so those apply as absolute
// timestamps instead.
