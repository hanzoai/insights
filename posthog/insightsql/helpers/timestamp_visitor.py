...
from posthog.insightsql.ast import ArithmeticOperationOp
from posthog.insightsql.context import InsightsQLContext
from posthog.insightsql.database.models import DatabaseField
from posthog.insightsql.errors import NotImplementedError
from posthog.insightsql.visitor import Visitor


def is_simple_timestamp_field_expression(
    expr: ast.Expr, context: InsightsQLContext, tombstone_string: Optional[str] = None
) -> bool:
...
class IsSimpleTimestampFieldExpressionVisitor(Visitor[bool]):
    ...
    def __init__(self, context: InsightsQLContext, tombstone_string: Optional[str] = None):
