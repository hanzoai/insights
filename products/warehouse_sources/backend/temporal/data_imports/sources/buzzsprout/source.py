...
class BuzzsproutSource(SimpleSource[BuzzsproutSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Buzzsprout API token and podcast ID to sync your podcast data into the Insights Data warehouse.
...
You can find both your API token and podcast ID in your [Buzzsprout API settings](https://www.buzzsprout.com/my/profile/api).""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/buzzsprout",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
