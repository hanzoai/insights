...
import { SearchableSelect, SegmentedButton, SelectOptions, Tag } from '@hanzo/elements'
            ...
            <div className="flex flex-col gap-2">
                <div className="flex items-center justify-between gap-3 rounded-lg border border-border px-3 py-2 bg-surface-primary">
                    ...
                    <SegmentedButton
                        ...
                        onChange={(newValue) => {
                            insights.capture('homepage configure set homepage', {
                        ...
                        options={[
                            {
                                ...
                                label: (
                                    <>
                                        Launchpad{' '}
                                        <Tag size="small" type="highlight" className="ml-1">
                                            New
                                        </Tag>
                                    </>
                                ),
                    ...
                    <section className="space-y-3 bg-surface-secondary rounded-lg p-3 border">
                        ...
                        <SearchableSelect<number | null>
                            ...
                            onChange={(dashboardId) => {
                                insights.capture('homepage configure default dashboard changed')
