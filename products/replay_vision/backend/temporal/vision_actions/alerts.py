...
def _persist_fired(
    ...
    # on instances whose SITE_URL isn't a hanzo.ai host (self-hosted, dev).
...
def _persist_recovered(
    ...
    # Same post-strip linkification as fired messages, so the URL isn't defanged off hanzo.ai hosts.
