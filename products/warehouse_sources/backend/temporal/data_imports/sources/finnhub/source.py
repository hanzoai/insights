...
class FinnhubSource(SimpleSource[FinnhubSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Finnhub API key to pull market and company financial data into the Insights Data warehouse.
...
Note: the free tier is rate limited to 60 requests/minute, and some endpoints require a paid plan.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/finnhub",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
