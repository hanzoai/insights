...
pub(crate) const DB_QUERY_DURATION: &str = "personinsights_replica_db_query_duration_ms";
pub(crate) const DB_POOL_ACQUIRE_DURATION: &str = "personinsights_replica_db_pool_acquire_duration_ms";
pub(crate) const DB_ROWS_RETURNED: &str = "personinsights_replica_db_rows_returned";
pub(crate) const DB_BULK_CHUNKS: &str = "personinsights_replica_db_bulk_chunks";
...
impl PostgresStorage {
    ...
    /// as `personinsights_replica_db_pool_acquire_duration_ms` with `pool`, `client`,
    /// and `method` labels.
    pub(crate) async fn acquire_timed(
        ...
        common_metrics::histogram(
            ...
            &[
                ...
                (
                    "client".to_string(),
                    personinsights_common::grpc::current_client_name().to_string(),
                ),
                (
                    "method".to_string(),
                    personinsights_common::grpc::current_method_name().to_string(),
                ),
            ],
            elapsed_ms,
        );
