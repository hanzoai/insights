...
class BambooHRSource(ResumableSource[BambooHRSourceConfig, BambooHRResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your BambooHR company subdomain and API key to pull your HR data into the Insights Data warehouse.
...
Make sure your API key has access to the data you want to sync (employee, time off, and account metadata).""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/bamboohr",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
