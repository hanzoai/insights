...
/// at runtime from insights_instancesetting (key:
/// `constance:insights:FLAGS_LOG_BODIES_TEAMS`).
///
...
pub struct Config {
    ...
    // from insights_instancesetting at runtime.
    ...
    // Used to safely deploy and test the personinsights migration path
    ...
    pub fn default_test_config() -> Self {
        Self {
            ...
            behavioral_cohorts_read_database_url:
                "postgres://insights:insights@localhost:5432/test_insights".to_string(),
