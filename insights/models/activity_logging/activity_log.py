...
def apply_activity_visibility_restrictions(queryset: QuerySet, user: Union["User", AnonymousUser, None]) -> QuerySet:
    ...
    """
    from insights.models.activity_logging.utils import activity_visibility_manager
...
def activity_log_created(sender, instance: "ActivityLog", created, **kwargs):
    from insights.api.advanced_activity_logs import ActivityLogSerializer
    ...
    try:
        ...
        if instance.team_id is not None:
            ...
            from insights.tasks.activity_log import broadcast_activity_log_to_organization
