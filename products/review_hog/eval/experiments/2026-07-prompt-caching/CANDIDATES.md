...
fork-seed) are patched directly in the local Insights Desktop checkout (`/Users/woutut/Documents/Code/code`); the proven
...
- Harness work (V1/V2/V3 fixes, T1-T3 in INVESTIGATION.md) lives in the Insights Desktop repo. 2026-07-06: the user opened
