...
from insights.caching.fetch_from_cache import InsightResult
from insights.insightsql_queries.query_runner import ExecutionMode
from insights.models import Dashboard, ExportedAsset, Insight, InsightVariable
...
@patch("insights.tasks.exports.image_exporter._screenshot_asset")
@patch(
    "insights.tasks.exports.image_exporter.open",
...
class TestImageExporter(APIBaseTest):
    ...
    @patch("insights.tasks.exports.image_exporter.calculate_for_query_based_insight")
    ...
    @patch("insights.tasks.exports.image_exporter._screenshot_asset")
    @patch("insights.tasks.exports.image_exporter.open", new_callable=mock_open, read_data=b"image_data")
    @patch("os.remove")
