...
from insights.api.event_definition_generators.golang import GolangGenerator
from insights.api.event_definition_generators.python import PythonGenerator
