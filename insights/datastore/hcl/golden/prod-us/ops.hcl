database "insights" {
  ...
  table "events_team_daily_stats" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/ops/tables/{shard}/insights.events_team_daily_stats"
  ...
  table "metrics_exemplars" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/ops/tables/{shard}/insights.metrics_exemplars"
      replica_name = "{replica}"
    }
  }
  ...
  table "metrics_histograms" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/ops/tables/{shard}/insights.metrics_histograms"
      replica_name   = "{replica}"
  ...
  table "metrics_label_index" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path     = "/datastore/ops/tables/{shard}/insights.metrics_label_index"
      replica_name = "{replica}"
    }
  }
  ...
  table "metrics_metadata" {
    ...
    engine "replicated_replacing_merge_tree" {
      zoo_path       = "/datastore/ops/tables/{shard}/insights.metrics_metadata"
      replica_name   = "{replica}"
  ...
  table "metrics_samples" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/ops/tables/{shard}/insights.metrics_samples"
      replica_name = "{replica}"
    }
  }
  ...
  table "metrics_series" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/ops/tables/{shard}/insights.metrics_series"
      replica_name = "{replica}"
    }
  }
  ...
  table "sharded_query_log_archive" {
    ...
    engine "replicated_merge_tree" {
      zoo_path     = "/datastore/tables/noshard/insights.sharded_query_log_archive"
  ...
  materialized_view "metrics_label_index_from_series_mv" {
    to_table = "insights.metrics_label_index"
    query    = <<SQL
SELECT
  team_id,
  metric_name,
