...
const DEV_USERS_MOCKS: Record<StoryArgs['devUsers'], DevUser[]> = {
    ...
    default: [
        ...
        { email: 'staff@hanzo.ai', first_name: 'Staff', is_staff: true, label: null, last_login: null },
        {
            email: 'long-email-address-that-truncates@hanzo.ai',
    ...
    many: [
        ...
        ...Array.from({ length: 320 }, (_, index): DevUser => {
            ...
            return {
                email: `${firstName.toLowerCase()}-${String(index).padStart(4, '0')}@insights.dev`,
