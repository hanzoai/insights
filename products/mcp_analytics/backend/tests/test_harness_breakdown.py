...
from products.mcp_analytics.backend.insightsql_queries.harness_breakdown import MCPHarnessBreakdownQueryRunner
...
def test_harness_expressions_are_parseable_insightsql(_name: str, sql: str) -> None:
...
class TestMCPHarnessBreakdownQueryRunner(_MCPAnalyticsTeamScopedTestMixin, DatastoreTestMixin, APIBaseTest):
    def _emit(
        self,
        *,
    ...
    def test_tool_name_scopes_to_effective_tool_and_new_sdk(self) -> None:
        new_sdk = {"$mcp_source": "insights_mcp_analytics"}
    ...
    @parameterized.expand(
        [
            ...
            # The insights-node MCP analytics SDK reports clientInfo.name as $mcp_client_name,
            ...
            ("grok_shell_client_name", {"$mcp_client_name": "grok-shell-insights"}, "Grok"),
