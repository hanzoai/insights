...
class TestFetchItemEmbeddingsForClustering:
    @patch("insights.temporal.ai_observability.trace_clustering.data.execute_insightsql_query")
    ...
    def test_single_query_for_all_cases(self, mock_execute, mock_team):
        """Both job_id and no-job_id paths use a single execute_insightsql_query call."""
        mock_result = MagicMock()
