...
from insights.schema import LogsSparklineBreakdownBy, LogsSparklineRankBy
...
class SparklineQueryRunner(LogsQueryRunner):
    ...
    def settings(self) -> InsightsQLGlobalSettings:
        ...
        # a fresh InsightsQLGlobalSettings here would silently re-enable those buggy defaults.
