    ...
    return [
            ...
            content: (
                <>
                    <CalloutBox type="info" icon="IconInfo" title="Full working examples">
                        <Markdown>
                            See the complete
                            [Node.js](https://github.com/Insights/insights-js/tree/main/examples/example-ai-azure-openai)
                            and
                            [Python](https://github.com/Insights/insights-python/tree/master/examples/example-ai-azure-openai)
                            examples on GitHub. If you're using the Insights SDK wrapper instead of OpenTelemetry, see
                            the [Node.js
                            wrapper](https://github.com/Insights/insights-js/tree/e08ff1be/examples/example-ai-azure-openai)
                            and [Python
                            wrapper](https://github.com/Insights/insights-python/tree/7223c52/examples/example-ai-azure-openai)
                            examples.
                        </Markdown>
                    </CalloutBox>
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        Now, when you call Azure OpenAI, Insights automatically captures `$ai_generation` events via the
