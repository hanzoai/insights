...
export interface addPersonToCohortModalLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface addPersonToCohortModalLogicActions {
    addPerson: (personId: string) => {
        personId: string
    }
    addPersonsToCohort: () => boolean
    hideAddPersonToCohortModal: () => {
        value: true
    }
    loadCohortPersons: () => any
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface addPersonToCohortModalLogicMeta {
    key: string
}

export type addPersonToCohortModalLogicType = MakeLogicType<
    addPersonToCohortModalLogicValues,
    addPersonToCohortModalLogicActions,
    AddPersonToCohortModalProps,
    addPersonToCohortModalLogicMeta
>
