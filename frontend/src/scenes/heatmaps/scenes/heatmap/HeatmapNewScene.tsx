...
function MatchingDataReadiness(): JSX.Element {
    ...
    return (
        <Banner type="warning" action={checkAgain}>
...
function ChoosePageStep(): JSX.Element {
    ...
    return (
        <Card hoverEffect={false} className="max-w-3xl mx-auto">
            <div className="flex flex-col gap-6">
                ...
                {dataUrl && pageStepBlockReason?.includes('heatmap data URL') ? (
                    <Banner type="error">Enter a complete URL including http:// or https://.</Banner>
                ) : null}
        ...
        <div className="flex flex-col gap-4">
            ...
            {type === 'iframe' && !isDisplayUrlAuthorized ? (
                <Banner type="warning">
                    <div className="flex flex-col gap-3">
                        <div>
                            The page URL's origin must be authorized before Insights can embed it. Screenshot does not
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex justify-between">
                    ...
                    {pageAccess !== 'login' ? (
                        ...
                        <Button type="primary" onClick={() => navigateToStep('review')}>
                            Continue
                        </Button>
                    ) : null}
                </div>
...
function ReviewStep(): JSX.Element {
    ...
    return (
        <Card hoverEffect={false} className={cn('mx-auto', usesRecordingBackground ? 'max-w-5xl' : 'max-w-3xl')}>
            <div className="flex flex-col gap-6">
                <div>
                ...
                <div className="flex justify-between">
                    <Button type="secondary" onClick={goBack} disabled={!usesRecordingBackground && loading}>
                        Back
                    </Button>
                    {usesRecordingBackground ? (
                        <Button
...
function RecordingHeatmapStep(): JSX.Element {
    ...
    return (
        <div className="flex flex-col gap-4">
            <Card hoverEffect={false} className="sticky top-0 z-20">
                <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex gap-2">
                        <Button type="secondary" onClick={closeRecordingHeatmap}>
                            Back to review
                        </Button>
                        <Button type="primary" onClick={finishRecordingHeatmap}>
                            Finish
                        </Button>
                    </div>
                </div>
