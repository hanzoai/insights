...
export type RecapCta = 'view_dashboard' | 'ask_insights_ai' | 'go_to_web_analytics'
export type RecapButton = RecapShareMethod | RecapCta
type RecapButtonIntent = 'share' | 'web_analytics_view' | 'insights_ai_usage'
type RecapButtonDestination = 'clipboard' | 'web_analytics_dashboard' | 'insights_ai_side_panel'
...
export const webAnalyticsRecapLogic = kea<webAnalyticsRecapLogicType>([
    ...
    listeners(({ values, actions }) => {
        ...
        const buttonContext = (
            ...
            if (button === 'ask_insights_ai') {
                return { intent: 'insights_ai_usage', destination: 'insights_ai_side_panel' }
            }
        ...
        return {
            recordOpened: () => {
                ...
                insights.capture('web_analytics_recap_opened', {
            ...
            loadRecapSuccess: () => {
                if (values.recap?.persona) {
                    insights.capture('web_analytics_recap_persona_assigned', {
                        ...recapProperties(),
            ...
            recordReachedEnd: () => {
                insights.capture('web_analytics_recap_completed', recapProperties())
            },
            recordButtonClicked: ({ button }) => {
                insights.capture('web_analytics_recap_button_clicked', {
                    ...recapProperties(),
                    button,
            ...
            recordShared: ({ method }) => {
                insights.capture('web_analytics_recap_shared', {
                    ...recapProperties(),
                    method,
                })
            },
            recordCtaClicked: ({ cta }) => {
                ...
                insights.capture('web_analytics_recap_cta_clicked', {
                    ...recapProperties(),
                    cta,
                })
            },
