...
/** Which Insights AI implementation the Max scene renders when the sandbox flag is on (see maxGlobalLogic). */
export const PHAI_VIEW_MODE_KEY = 'insights_ai_view_mode'
