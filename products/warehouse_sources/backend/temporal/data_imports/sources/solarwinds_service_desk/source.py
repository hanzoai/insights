...
class SolarwindsServiceDeskSource(
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your SolarWinds Service Desk JSON web token to pull your service desk data into the Insights Data warehouse.
...
SolarWinds Service Desk runs independent regional stacks that do not share data — pick the region your account is on.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/solarwinds-service-desk",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldSelectConfig(
