...
/** GitHub connected, no repo chosen — repo picker shown, "Install Insights here" disabled. */
...
export const RepoPickerOpen: Story = cloudRunStory({
    ...
    extraPlay: async () => {
        // Input puts data-attr on the <input> element itself, so match the input directly —
...
export const Playground: StoryObj<PlaygroundArgs> = {
    ...
    argTypes: {
        ...
        repository: {
            ...
            description: 'Repository to pre-select — empty leaves "Install Insights here" disabled',
        },
        pullRequestQueued: {
            control: 'boolean',
