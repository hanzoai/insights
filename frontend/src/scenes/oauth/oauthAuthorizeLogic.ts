...
const WILDCARD_LABEL = 'All Insights data'
...
// Mirrors PRIVILEGED_SCOPES + OAUTH_HIDDEN_SCOPE_OBJECTS in insights/scopes.py: objects
    ...
    listeners(({ values, actions }) => ({
        ...
        createNewProject: async ({ name }) => {
            ...
            try {
                ...
                toast.error(e.detail || 'Failed to create project')
            } finally {
