...
class OktaSource(ResumableSource[OktaSourceConfig, OktaResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Okta org domain and an API token to pull your Okta data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/okta",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
