...
from insights.models.activity_logging.utils import activity_storage, get_changed_fields_local
...
class ModelActivityMixin(models.Model):
    ...
    def _should_log_activity_for_update(self, **kwargs) -> tuple[bool, Any]:
        ...
        from insights.models.activity_logging.activity_log import ActivityScope, signal_exclusions
...
class ImpersonatedContext:
    ...
    def __init__(self, request):
        ...
        from insights.helpers.impersonation import is_impersonated  # noqa: PLC0415
