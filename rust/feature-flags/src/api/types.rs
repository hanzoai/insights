...
pub struct FlagsQueryParams {
    ...
    /// e.g. https://us.hanzo.ai/flags?v=2&config=true
    #[serde(default, deserialize_with = "deserialize_optional_bool")]
    ...
    /// e.g. https://us.hanzo.ai/flags?v=2&detailed_analysis=true
    #[serde(default, deserialize_with = "deserialize_optional_bool")]
    ...
    /// e.g. https://us.hanzo.ai/flags?v=2&only_use_override_person_properties=true
    #[serde(default, deserialize_with = "deserialize_optional_bool")]
