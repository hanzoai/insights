...
from insights.management.commands._base_hypercache_command import BaseHyperCacheCommand
...
class TestUpdateCacheStatsSafe(BaseTest):
    ...
    def test_successful_cache_stats_update(self):
        ...
        with patch("insights.management.commands._base_hypercache_command.get_cache_stats") as mock_get_cache_stats:
...
class TestExpiryTrackingVerification(BaseTest):
    ...
    def test_batch_check_expiry_returns_all_true_when_no_expiry_key_configured(self):
        ...
        from insights.storage.hypercache_manager import batch_check_expiry_tracking
    ...
    def test_batch_check_expiry_uses_pipelining(self):
        ...
        with patch("insights.storage.hypercache_manager.get_client") as mock_get_client:
...
class TestGetTeamsQueryset(BaseTest):
    ...
    def test_config_queryset_fn_scopes_all_teams_path(self):
        ...
        from insights.models import Team as TeamModel
        ...
        with patch("insights.management.commands._base_hypercache_command.get_cache_stats"):
...
class TestFlagVerifyCommandScoping(BaseTest):
    ...
    def test_includes_teams_with_only_soft_deleted_flags(self):
        ...
        from insights.management.commands.verify_flags_cache import Command as VerifyFlagsCommand
    ...
    def test_flag_definitions_command_scopes_same_way(self):
        ...
        from insights.management.commands.verify_flag_definitions_cache import Command as VerifyFlagDefinitionsCommand
        from insights.models import Team as TeamModel
