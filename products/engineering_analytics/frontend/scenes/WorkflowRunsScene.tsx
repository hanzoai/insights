    ...
    return (
        <Card hoverEffect={false} className="p-4">
            <div className="mb-1 flex items-baseline gap-2">
                ...
                <Tag type="warning">estimate · wall-clock × reference rate</Tag>
            </div>
            {costs.map((cost) => (
                <ShareRow
...
export function WorkflowRunsScene(): JSX.Element {
    ...
    const runColumns: TableColumns<WorkflowRunRow> = [
        {
            title: 'Run',
            key: 'run',
            render: (_, run) => (
        ...
        return (
            <SceneContent>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button type="secondary" size="small" onClick={loadRuns} loading={runsLoading}>
                        Retry
                    </Button>
                </div>
            </SceneContent>
