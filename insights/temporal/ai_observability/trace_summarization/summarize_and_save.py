...
from insights.temporal.ai_observability.trace_summarization.state import delete_text_repr, load_text_repr
...
class SaveSummaryEventContext:
    """Shared context for saving summary events to Datastore."""
