...
import { Button, Tag, Spinner, Tooltip } from '@hanzo/elements'
import { BarChart, LineChart, PieChart } from '@hanzo/quill-charts'
import type { BarChartConfig, LineChartConfig, Series } from '@hanzo/quill-charts'
        ...
        <div className="max-w-72 space-y-1.5 p-0.5">
            ...
            {setupStatus?.kind === 'installing' &&
                (setupStatus.mode === 'cloud' ? (
                    <p className="m-0">
                        The setup wizard is installing Insights in your codebase. Once it's done, it will open a pull
                        request for you to merge.
                    </p>
                ) : (
                    <p className="m-0">
                        The setup wizard is installing Insights in your codebase. You'll see real data here soon after
                        it's done.
                    </p>
                ))}
        ...
        >
            <div className="SampleDataState__tag flex items-center gap-1">
                {setupStatus?.kind === 'pull_request' && !setupStatus.pullRequest.merged && (
                    <Button size="xsmall" type="primary" to={setupStatus.pullRequest.url} targetBlank>
                        Merge setup PR
                    </Button>
                )}
                {setupStatus?.kind === 'installing' && (
                    <Tooltip
                        title={
                            <div className="max-w-72 space-y-1.5 p-0.5">
                                ...
                                {setupStatus.mode === 'cloud' ? (
                                    <p className="m-0">
                                        The AI setup wizard is installing Insights in the cloud, on a copy of your
                                        codebase. Once it's done, it will open a pull request for you to review and
                                        merge.
                                    </p>
                                ) : (
                                    <p className="m-0">
                                        The AI setup wizard is installing Insights in your codebase from your terminal.
                        ...
                        delayMs={0}
                    >
                        <Tag type="muted" className="gap-1 cursor-help">
                        ...
                        title={
                            <div className="max-w-72 space-y-1.5 p-0.5">
                                ...
                                <p className="m-0">
                                    ...
                                    installs the Insights SDK, and starts sending events. Click to copy.
                                </p>
                            </div>
                        }
                        placement="bottom"
                    ...
                    >
                        <span>
                            <CommandBlock
                                ...
                                decoration="rainbow"
                                condensed
                                // Sized down to sit flush with the Tag next to it
                ...
                <Tooltip title={<SampleDataTooltipContent />} interactive delayMs={100} placement="bottom">
                    <Tag className="cursor-help" type="muted">
                        Sample data
                    </Tag>
                </Tooltip>
            </div>
