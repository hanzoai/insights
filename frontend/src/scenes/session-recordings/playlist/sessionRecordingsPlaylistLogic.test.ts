...
describe('sessionRecordingsPlaylistLogic', () => {
    ...
    describe('global logic', () => {
        ...
        describe('unusableEventsInFilter', () => {
            ...
            const allEventsFilter = {
                name: 'All events',
                type: 'events',
                properties: [{ key: "$group_0 = 'test'", type: PropertyFilterType.InsightsQL }],
            } as ActionFilter
                ...
                values: [
                    {
                        type: 'events',
                        name: 'All events',
                        properties: [{ key: "$group_0 = 'abc'", type: 'insightsql' }],
                    } as ActionFilter,
                ],
            }
    ...
    describe('relevance sort experiment', () => {
        ...
        const mockFlags = (flags: Record<string, string | boolean>): void => {
            jest.spyOn(insights, 'getFeatureFlag').mockImplementation((key) => flags[key as string] as any)
        }
            ...
            values: [
                {
                    type: 'events',
                    name: 'All events',
                    properties: [{ key: "$group_0 = 'test-group'", type: 'insightsql' }],
                } as ActionFilter,
            ],
        }
