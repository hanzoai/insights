...
import { isDataVisualizationNode, isInsightsQLQuery, isSavedInsightNode } from '~/queries/utils'
 ...
 *
 * The URL and the label are resolved together because `urls.insightNew` redirects a InsightsQL-backed
