...
export interface accountRelationshipsInputLogicValues {
    currentProjectId: number | null // projectLogic
    definitions: AccountRelationshipDefinitionApi[]
    definitionsLoading: boolean
    pendingDefinitionIds: string[]
}

// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface accountRelationshipsInputLogicActions {
    addPendingDefinition: (definitionId: string) => {
        definitionId: string
    }
    loadDefinitions: () => any
    ...
    removePendingDefinition: (definitionId: string) => {
        definitionId: string
    }
}

export type accountRelationshipsInputLogicType = MakeLogicType<
    accountRelationshipsInputLogicValues,
    accountRelationshipsInputLogicActions
>
...
export const accountRelationshipsInputLogic = kea<accountRelationshipsInputLogicType>([
    ...
    listeners({
        loadDefinitionsFailure: ({ error }) => {
            insights.captureException(error, { scope: 'accountRelationshipsInputLogic.load' })
        },
    }),
    afterMount(({ actions }) => {
