    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption=(
                ...
                "membership tiers, promotions and mailing list into Insights.\n\n"
                f"{DEVELOPER_SETTINGS_HELP}"
            ),
            keywords=["merch", "memberships", "creator commerce"],
            docsUrl="https://hanzo.ai/docs/cdp/sources/fourthwall",
            ...
            webhookSetupCaption=(
                "Insights tries to register a webhook on your shop using the API user above, "
                ...
                "so Insights can verify deliveries."
            ),
            webhookFields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
                        ...
                        placeholder="",
                        caption=(
                            "Your shop's webhook secret key, from Settings > For developers. Insights "
