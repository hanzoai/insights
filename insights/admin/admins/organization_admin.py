...
from insights.admin.inlines.organization_domain_inline import OrganizationDomainInline
from insights.admin.inlines.organization_invite_inline import OrganizationInviteInline
from insights.admin.inlines.organization_member_inline import OrganizationMemberInline
from insights.admin.inlines.project_inline import ProjectInline
from insights.admin.inlines.team_inline import TeamInline
from insights.admin.paginators.no_count_paginator import NoCountPaginator
...
BULK_DELETE_MODEL_REGISTRY: tuple[tuple[str, str, str], ...] = (
    ...
    ("insights.models.person.PersonDistinctId", "team_id", "Person Distinct IDs"),
    ("insights.models.person.PersonlessDistinctId", "team_id", "Personless Distinct IDs"),
    (
        "products.error_tracking.backend.models.ErrorTrackingIssueFingerprintV2",
        "team_id",
        "Error Tracking Fingerprints",
    ),
    ("insights.models.feature_flag.feature_flag.FeatureFlagHashKeyOverride", "team_id", "Feature Flag Overrides"),
    ("insights.models.group.group.Group", "team_id", "Groups"),
    ("insights.models.group_type_mapping.GroupTypeMapping", "team_id", "Group Type Mappings"),
    ("insights.models.person.Person", "team_id", "Persons"),
    ("insights.models.insight_caching_state.InsightCachingState", "team_id", "Insight Caching States"),
)
        ...
        results.append(
            {
                "name": "Cohort People",
                "count": f"Error: {e}",
                "model": "insights.models.cohort.CohortPeople",
            }
        )
        ...
        results.append(
            {
                "name": "Batch Exports",
                "count": f"Error: {e}",
                "model": "insights.batch_exports.models.BatchExport",
            }
        )
