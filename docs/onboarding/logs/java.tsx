    ...
    return [
        {
            ...
            content: (
                <>
                    <Markdown>
                        Insights logs uses the standard OpenTelemetry SDK — no Insights-specific packages required. Add
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>Configure the OpenTelemetry log exporter to send logs to Insights:</Markdown>
                    <CodeBlock
                        blocks={[
                            {
                                language: 'java',
