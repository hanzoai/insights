...
from insights.temporal.data_imports.sources.linkedin_ads.source import LinkedInAdsSource
...
class TestLinkedInAdsSource:
    ...
    @mock.patch("insights.temporal.data_imports.sources.linkedin_ads.source.Integration")
    ...
    @mock.patch("insights.temporal.data_imports.sources.linkedin_ads.source.Integration")
    @mock.patch("insights.temporal.data_imports.sources.linkedin_ads.source.capture_exception")
