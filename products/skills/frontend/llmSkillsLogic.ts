...
export const SKILL_CATEGORY_TABS: SkillCategoryTab[] = [
    {
        ...
        label: 'Scouts',
        description:
            "Scouts — scheduled agents that scan your project and surface findings in your inbox. Includes Insights's canonical scouts and any custom ones you author.",
    },
    {
        key: 'review-script',
        category: 'review_hog',
    ...
    listeners(({ actions, asyncActions, values, selectors }) => ({
        ...
        deleteSkill: async ({ skillName }) => {
            try {
                ...
                toast.info(`${skillName || 'Skill'} has been archived.`)
        ...
        importSkill: async ({ file }) => {
            ...
            try {
                ...
                toast.error(errorDetail(e) || 'Failed to import skill — is it a valid skill zip?')
            } finally {
        ...
        downloadSkillZip: async ({ skillName }) => {
            try {
                ...
                toast.error(errorDetail(e) || (e instanceof Error ? e.message : 'Failed to export skill'))
            }
        },
        ...
        loadMarketplaceState: async () => {
            ...
            try {
                ...
                toast.error(errorDetail(e) || 'Failed to check your skill store connection.')
            } finally {
