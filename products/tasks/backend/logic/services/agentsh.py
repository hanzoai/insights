...
GH_GUARD_INSTALL_PATH = "/opt/insights/bin/gh"
...
INFRASTRUCTURE_DOMAINS = [
    ...
    "gateway.us.hanzo.ai",
    "gateway.eu.hanzo.ai",
    "ai-gateway.us.hanzo.ai",
    "ai-gateway.eu.hanzo.ai",
]
...
# in every environment (dev's ai-gateway.dev.insights.dev is outside
# *.hanzo.ai, so the static infrastructure list alone can't cover it).
