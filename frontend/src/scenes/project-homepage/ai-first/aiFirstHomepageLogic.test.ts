...
describe('aiFirstHomepageLogic', () => {
    ...
    // Regression guard: on the Insights AI homepage, a `#panel=max:<prompt>` link should prefill the
    ...
    // user on the new Insights AI surface starts a LangGraph conversation that surface never renders,
