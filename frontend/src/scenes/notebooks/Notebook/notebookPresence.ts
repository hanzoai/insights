...
const NOTEBOOK_MARKDOWN_CLIENT_ID_SESSION_STORAGE_KEY = 'insights_notebook_markdown_client_id'
...
export type NotebookPresenceParticipant = NotebookPresenceState & {
    ...
    isAI?: boolean
    profileUser?: Pick<UserType, 'email' | 'first_name' | 'mascot_config'>
}
...
export function getNotebookPresenceParticipants(
    currentUser: Pick<UserType, 'email' | 'first_name' | 'mascot_config' | 'id'> | null,
