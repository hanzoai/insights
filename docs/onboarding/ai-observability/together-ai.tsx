    ...
    return [
            ...
            content: (
                <>
                    <CalloutBox type="info" icon="IconInfo" title="Full working examples">
                        <Markdown>
                            See the complete
                            [Node.js](https://github.com/Insights/insights-js/tree/main/examples/example-ai-together-ai)
                            and
                            [Python](https://github.com/Insights/insights-python/tree/master/examples/example-ai-together-ai)
                            examples on GitHub. If you're using the Insights SDK wrapper instead of OpenTelemetry, see
                            the [Node.js
                            wrapper](https://github.com/Insights/insights-js/tree/e08ff1be/examples/example-ai-together-ai)
                            and [Python
                            wrapper](https://github.com/Insights/insights-python/tree/7223c52/examples/example-ai-together-ai)
                            examples.
                        </Markdown>
                    </CalloutBox>
        ...
        },
        {
            ...
            content: (
                <>
                    <Markdown>
                        Now, when you use the OpenAI SDK to call Together AI, Insights automatically captures
