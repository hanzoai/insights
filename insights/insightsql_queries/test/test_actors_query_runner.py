...
class TestActorsQueryRunner(ClickhouseTestMixin, APIBaseTest):
    ...
    @patch("insights.insightsql_queries.insights.paginators.execute_insightsql_query", wraps=execute_insightsql_query)
    ...
    def test_person_strategy_batches_large_actor_sets(self):
        ...
        from insights.insightsql_queries.actor_strategies import PersonStrategy
