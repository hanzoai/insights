...
def main():
    ...
    _ = os.environ.setdefault("DJANGO_SETTINGS_MODULE", "insights.settings")
    django.setup()
...
def start_session(team_id: int, batch_export_id: str | None = None):
    ...
    from insights.batch_exports.debug.debugger import BatchExportsDebugger
    from insights.models import BatchExport
