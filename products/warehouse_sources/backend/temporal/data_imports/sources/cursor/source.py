...
class CursorSource(ResumableSource[CursorSourceConfig, CursorResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Cursor Admin API key to automatically pull your team's Cursor usage and spend data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/cursor",
