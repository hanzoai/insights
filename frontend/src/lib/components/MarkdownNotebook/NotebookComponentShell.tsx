...
export type ComponentTitleTone = 'default' | 'insight' | 'sql' | 'data' | 'media' | 'experiment' | 'code' | 'insights'
            ...
            >
                ...
                {mode === 'edit' || toolbarMenuItems || showCollapseToggle ? (
                    <div className="MarkdownNotebook__component-actions">
                        ...
                        {toolbarMenuItems ? (
                            <Menu items={toolbarMenuItems} placement="bottom-end">
                                <Button
...
export function getComponentTitleTone(tagName: string, category: string | undefined): ComponentTitleTone {
    ...
    if (tagName === 'DuckSQL' || tagName === 'InsightsQLSQL') {
        return 'sql'
    }
