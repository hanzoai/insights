...
export const template: InsightsFunctionTemplate = {
    ...
    name: 'Appcues',
    description:
        'Forward Insights events and person properties to Appcues to power onboarding flows, in-app messages, and targeting.',
...
`,
    inputs_schema: [
        ...
        },
        {
            ...
            type: 'string',
            label: 'User ID',
            description: 'The identifier for the user in Appcues. Defaults to the Insights distinct ID.',
