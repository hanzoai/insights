...
from insights.session_recordings.session_recording_v2_service import (
    FIVE_SECONDS,
    RecordingBlock,
    list_blocks,
    listing_cache_key,
...
class TestSessionRecordingV2Service(TestCase):
    ...
    @patch("insights.session_recordings.session_recording_v2_service.fetch_blocks_from_recording_api")
    ...
    @patch("insights.session_recordings.session_recording_v2_service.cache")
    @patch("insights.session_recordings.session_recording_v2_service.fetch_blocks_from_recording_api")
