...
def get_connect_info(team_id: int, short_id: str, user: User) -> contracts.StreamlitConnectInfo:
    ...
    iframe_url = f"{sandbox_url}/?_insights_token={access_token.token}"
    if modal_token:
        iframe_url += f"&_modal_connect_token={modal_token}&_insights_modal_token={modal_token}"
