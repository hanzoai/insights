...
//
// `@hanzo/brand/hoggies` inlines each SVG into the JS bundle, and some illustrations are
...
// `@hanzo/brand/hoggies/png/<name>` module is a tiny stub exporting the image URL and
...
/** Shape of a `@hanzo/brand/hoggies/png/<name>` module. */
