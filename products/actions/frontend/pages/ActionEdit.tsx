...
const REFERENCES_COLUMNS: TableColumns<ActionReferenceApi> = [
    {
        title: 'Name',
        dataIndex: 'name',
        render: function RenderName(_, ref) {
            return <TableLink title={ref.name} to={ref.url} />
        },
    },
    {
        title: 'Type',
    ...
    createdByColumn() as TableColumns<ActionReferenceApi>[number],
    createdAtColumn() as TableColumns<ActionReferenceApi>[number],
]
...
function ReferencesList({ logicProps }: { logicProps: ActionEditLogicProps }): JSX.Element {
    ...
    return (
        <div className="flex flex-col gap-4">
            <Input type="search" placeholder="Search..." value={referencesSearch} onChange={setReferencesSearch} />
            <Table
