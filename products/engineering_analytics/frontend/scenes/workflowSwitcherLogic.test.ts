...
describe('workflowSwitcherLogic', () => {
    ...
    beforeEach(() => {
        ...
        mockWorkflowHealth.mockResolvedValue([
            healthItem('Insights', 'insights', 'Frontend CI'),
            healthItem('Insights', 'insights', 'Backend CI'),
            healthItem('Insights', 'hanzo.ai', 'Deploy'),
        ])
        logic = workflowSwitcherLogic({ repoOwner: 'Insights', repoName: 'insights', sourceId: null })
        logic.mount()
    })
