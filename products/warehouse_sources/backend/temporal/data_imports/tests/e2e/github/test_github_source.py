...
class TestGithubWebhookSource:
    ...
    def test_create_webhook_sends_secret_and_returns_it_as_extra_input(self) -> None:
        ...
        with mock.patch(
            ...
            result = self.source.create_webhook(_pat_config(), "https://app.hanzo.ai/webhook", team_id=1)
        ...
        # for the framework to persist as the script function's signing_secret.
    ...
    def test_delete_webhook_lists_then_deletes_matching_hook(self) -> None:
        webhook_url = "https://app.hanzo.ai/webhook"
    ...
    def test_sync_webhook_events_targets_every_mapped_event(self) -> None:
        ...
        with mock.patch(
            ...
            result = self.source.sync_webhook_events(
                _pat_config(), "https://app.hanzo.ai/webhook", team_id=1, eligible_schema_names=["reviews"]
            )

        assert result.success is True
        _token, repo, url, events = update.call_args.args
        assert repo == "owner/repo"
        assert url == "https://app.hanzo.ai/webhook"
    ...
    def test_update_repo_webhook_permission_error_fails_with_hint(self) -> None:
        ...
        with mock.patch(
            ...
            result = update_repo_webhook(
                "tok", "owner/repo", "https://app.hanzo.ai/webhook", ["pull_request_review"]
            )
