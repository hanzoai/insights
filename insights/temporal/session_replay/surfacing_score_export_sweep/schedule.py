...
from insights.temporal.session_replay.surfacing_score_export_sweep.types import ExportScoresSweepInputs
...
async def create_surfacing_score_export_sweep_schedule(client: Client) -> None:
    """Upserted on deploy via `insights/temporal/schedule.py`'s `schedules` list."""
