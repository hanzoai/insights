...
from insights.temporal.session_replay.count_playlist_items.activities import (
    count_recordings_for_playlist,
    fetch_playlists_to_count,
)
from insights.temporal.session_replay.count_playlist_items.types import CountPlaylistInput, PlaylistInfo


@temporalio.workflow.defn(name="count-all-playlists")
class CountAllPlaylistsWorkflow(InsightsWorkflow):
...
class CountPlaylistWorkflow(InsightsWorkflow):
