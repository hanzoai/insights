...
Finds cursed identifiers and stale comments in `Insights/insights`, researches each (git blame + required Insights MCP lookup), emits the Signals shape.
...
DEBUG only. Set up local sandboxes + GitHub integration + Insights MCP OAuth first — see [docs/internal/sandboxes-setup-guide.md](../../../../../docs/internal/sandboxes-setup-guide.md).
