...
const constants = {
    'context.app.name': 'InsightsPlugin',
    channel: 's2s',
}
...
const generic = {
    ...
    'context.app.version': 'properties.insights_version',
    ...
    'context.insights_version': 'properties.insights_version',
...
function constructRudderPayload(event: ProcessedPluginEvent) {
    ...
    // add all pther insights keys under props not starting with $ to Rudder payload properties
