...
from insights.migration_helpers import SafeAddIndexConcurrently, SafeRemoveIndexConcurrently
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        SafeRemoveIndexConcurrently(
            model_name="ticket",
            name="insights_con_team_sla_idx",
        ),
        SafeRemoveIndexConcurrently(
            model_name="ticket",
            name="insights_con_team_snooze_idx",
        ),
    ]
