    ...
    const tasks = displayOrder.map((originalIndex) => {
        ...
        return async (): Promise<void> => {
            ...
            try {
                ...
                // backend (see products/experiments/backend/insightsql_queries/error_handling.py), which
...
export interface experimentLogicValues {
    ...
    getInsightType: (metric: ExperimentFunnelsQuery | ExperimentMetricUnion | ExperimentTrendsQuery | undefined) => InsightType;
...
export interface experimentLogicActions {
    ...
    reportExperimentTimeseriesRecalculated: (experimentId: ExperimentIdType, metric: ExperimentMetricUnion) => {
        experimentId: ExperimentIdType;
        metric: ExperimentMetricUnion;
    }; // eventUsageLogic
    reportExperimentTimeseriesViewed: (experimentId: ExperimentIdType, metric: ExperimentMetricUnion) => {
        experimentId: ExperimentIdType;
        metric: ExperimentMetricUnion;
    }; // eventUsageLogic
    ...
    addSharedMetricsToExperiment: (sharedMetricIds: SharedMetric["id"][], metadata: {
        type: "primary" | "secondary";
    }) => {
        metadata: {
            type: "primary" | "secondary";
    ...
    createExperiment: (draft?: boolean, folder?: string | null) => {
    ...
    createExposureCohortFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    createExposureCohortSuccess: (exposureCohort: CohortType | null, payload?: any) => {
        exposureCohort: CohortType | null;
        payload?: any;
    };
    ...
    endExperiment: (openCleanupPr?: boolean, repository?: string | null, setRepositoryAsTeamDefault?: boolean) => {
        openCleanupPr: boolean;
        repository: string | null;
        setRepositoryAsTeamDefault: boolean;
    };
    endExperimentWithoutShipping: (openCleanupPr?: boolean, repository?: string | null, setRepositoryAsTeamDefault?: boolean) => {
        openCleanupPr: boolean;
        repository: string | null;
        setRepositoryAsTeamDefault: boolean;
    };
    ...
    loadExperimentFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadExperimentSuccess: (experiment: Experiment, payload?: {
        triggeredBy?: ExperimentTriggeredBy;
    }) => {
        experiment: Experiment;
        payload?: {
    ...
    loadExposuresFailure: (error: string, errorObject?: any) => {
        error: string;
        errorObject?: any;
    };
    loadExposuresSuccess: (exposures: any, payload?: boolean) => {
        exposures: any;
        payload?: boolean;
    };
    loadPrimaryMetricsResults: (refresh?: boolean, refreshId?: string) => {
        refresh: boolean | undefined;
        refreshId: string | undefined;
    };
    loadSecondaryMetricsResults: (refresh?: boolean, refreshId?: string) => {
        refresh: boolean | undefined;
        refreshId: string | undefined;
    };
    ...
    refreshExperimentResults: (forceRefresh?: boolean, triggeredBy?: ExperimentTriggeredBy, refreshIfStale?: boolean) => {
    ...
    removeMetric: (uuid: string, context: "primary" | "secondary") => {
        context: "primary" | "secondary";
        uuid: string;
    };
    removeMetricBreakdown: (uuid: string, index: number, breakdown: Breakdown) => {
        breakdown: Breakdown;
        index: number;
        uuid: string;
    };
    ...
    saveMetricsReorder: (isSecondary: boolean, orderedUuids: string[], removedUuids: string[], movedUuids: string[]) => {
        isSecondary: boolean;
        movedUuids: string[];
        orderedUuids: string[];
        removedUuids: string[];
    ...
    setExperimentValue: (key: FieldName, value: any) => {
        name: FieldName;
        value: any;
    };
    ...
    setVariantExcluded: (variantKey: string, excluded: boolean) => {
        excluded: boolean;
        variantKey: string;
    };
    ...
    submitExperimentFailure: (error: Error, errors: Record<string, any>) => {
        error: Error;
        errors: Record<string, any>;
    };
    ...
    updateExperimentSuccess: (experimentUpdate: Experiment, payload?: ExperimentUpdatePayload) => {
    ...
    updateMetricBreakdown: (uuid: string, breakdown: Breakdown) => {
        breakdown: Breakdown;
        uuid: string;
    };
...
export interface experimentLogicMeta {
    ...
    __keaTypeGenInternalSelectorTypes: {
        ...
        experimentMathAggregationForTrends: (experiment: Experiment) => () => CountPerActorMathType | PropertyMathType | undefined;
        minimumDetectableEffect: (experiment: Experiment, defaultMinimumDetectableEffect: number) => number;
        recommendedSampleSize: (conversionMetrics: FunnelTimeConversionMetrics, variants: MultivariateFlagVariant[], minimumDetectableEffect: number) => number;
        recommendedRunningTime: (experiment: Experiment, variants: MultivariateFlagVariant[], getInsightType: (metric: ExperimentFunnelsQuery | ExperimentMetricUnion | ExperimentTrendsQuery | undefined) => InsightType, firstPrimaryMetric: ExperimentFunnelsQuery | ExperimentMetricUnion | ExperimentTrendsQuery | undefined, funnelResults: FunnelResultType, conversionMetrics: FunnelTimeConversionMetrics, trendResults: TrendResult[], minimumDetectableEffect: number) => number;
        ...
        experimentWarning: (experiment: Experiment, isExperimentRunning: boolean, isExperimentDraft: boolean, isFlagActive: boolean, isSingleVariantShipped: boolean, shippedVariantKey: string | null) => ExperimentWarning | null;
        hasPrimaryMetricSet: (primaryMetricsLengthWithSharedMetrics: number) => boolean;
        firstPrimaryMetric: (experiment: Experiment) => ExperimentFunnelsQuery | ExperimentMetric | ExperimentTrendsQuery | undefined;
        ...
        getOrderedMetricsWithResults: (experiment: Experiment, primaryMetricsResults: CachedNewExperimentQueryResponse[], primaryMetricsResultsErrors: any[], secondaryMetricsResults: CachedNewExperimentQueryResponse[], secondaryMetricsResultsErrors: any[]) => (isSecondary: boolean) => {
            displayIndex: number;
            error: any;
            metric: ExperimentMetricUnion;
            metricIndex: number;
        ...
        orderedPrimaryMetricsWithResults: (getOrderedMetricsWithResults: (isSecondary: boolean) => {
            displayIndex: number;
            error: any;
            metric: ExperimentMetricUnion;
            metricIndex: number;
        ...
        orderedSecondaryMetricsWithResults: (getOrderedMetricsWithResults: (isSecondary: boolean) => {
            displayIndex: number;
            error: any;
            metric: ExperimentMetricUnion;
            metricIndex: number;
...
export type experimentLogicType = MakeLogicType<experimentLogicValues, experimentLogicActions, ExperimentLogicProps, experimentLogicMeta>;
    ...
    listeners(({ values, actions, asyncActions, cache }) => ({
        ...
        launchExperiment: async () => {
            ...
            try {
                ...
                toast.error(error.detail || 'Failed to launch experiment')
            } finally {
        ...
        endExperiment: async ({ openCleanupPr, repository, setRepositoryAsTeamDefault }) => {
            ...
            try {
                ...
                toast.error(error.detail || 'Failed to end experiment')
            } finally {
        ...
        pauseExperiment: async () => {
            try {
                ...
                toast.error(error.detail || 'Failed to pause experiment')
            }
        },
        resumeExperiment: async () => {
            try {
                ...
                toast.error(error.detail || 'Failed to resume experiment')
            }
        },
        freezeExposure: async () => {
            ...
            try {
                ...
                actions.setExperiment(response)
                refreshTreeItem('experiment', String(values.experimentId))
                toast.success('Exposure frozen — enrolled users keep their variant and metrics keep updating')
            } catch (error: any) {
                toast.error(error.detail || 'Failed to freeze exposure')
            } finally {
        ...
        unfreezeExposure: async () => {
            ...
            try {
                ...
                actions.setExperiment(response)
                refreshTreeItem('experiment', String(values.experimentId))
                toast.success('Exposure unfrozen — new users can enroll again')
            } catch (error: any) {
                toast.error(error.detail || 'Failed to unfreeze exposure')
            } finally {
        ...
        archiveExperiment: async ({ disableFeatureFlag }) => {
            try {
                ...
                toast.error(error.detail || 'Failed to archive experiment')
            }
        },
        unarchiveExperiment: async () => {
            try {
                ...
                toast.error(error.detail || 'Failed to unarchive experiment')
            }
        },
        ...
        resetRunningExperiment: async () => {
            try {
                ...
                toast.error(error.detail || 'Failed to reset experiment')
            }
        },
        ...
        finishExperiment: async ({
            ...
            try {
                ...
                if (error.status === 409 && error.data?.change_request_id) {
                    ...
                    toast.error(error.detail || 'Failed to ship variant')
                }
            } finally {
                actions.setEndExperimentLoading(false)
            }
        ...
        updateExperimentVariantNotes: async ({ variantNotes }) => {
            try {
                ...
                if (isExperimentConflictError(error)) {
                    ...
                    toast.error('Failed to update experiment variant notes')
                }
            }
        },
        ...
        duplicateSharedMetricAsInlineMetric: ({ isSecondary, newUuid }) => {
            ...
            if (metrics.some((metric) => metric.uuid === newUuid)) {
                toast.success('Metric duplicated as a single-use metric')
            }
        },
        ...
        setVariantExcluded: async ({ variantKey, excluded }, _breakpoint) => {
            ...
            try {
                ...
                toast.error('Could not update variant exclusion. Please try again.')
                throw error
            }
        },
