...
from insights.egress.limiter.policies import RatePolicy, register_policy
from insights.kafka_client import helper
from insights.kafka_client.client import _KafkaSecurityProtocol
from insights.kafka_client.routing import get_producer, get_profile_settings
...
def build_capture_kwargs(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if payload.get("kind") == "group":
        ...
        # Mirror the canonical group-identify write (ee/datastore/views/groups.py::trigger_group_identify):
    ...
    def __init__(
        ...
        *,
        ...
        if capture_fn is None:
            from insights.api.capture import capture_internal  # noqa: PLC0415
