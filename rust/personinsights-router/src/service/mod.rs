...
pub struct PersonInsightsRouterService {
    router: Arc<PersonInsightsRouter>,
}

impl PersonInsightsRouterService {
    pub fn new(router: Arc<PersonInsightsRouter>) -> Self {
        Self { router }
    }
}
...
#[tonic::async_trait]
impl PersonInsightsService for PersonInsightsRouterService {
