...
CLICKHOUSE_BACKUPS_BUCKET: str | None = os.getenv("DATASTORE_BACKUPS_BUCKET", os.getenv("CLICKHOUSE_BACKUPS_BUCKET"))

CLICKHOUSE_FULL_BACKUP_SCHEDULE: str = os.getenv("DATASTORE_FULL_BACKUP_SCHEDULE", os.getenv("CLICKHOUSE_FULL_BACKUP_SCHEDULE", "0 22 * * 5"))
CLICKHOUSE_INCREMENTAL_BACKUP_SCHEDULE: str = os.getenv("DATASTORE_INCREMENTAL_BACKUP_SCHEDULE", os.getenv("CLICKHOUSE_INCREMENTAL_BACKUP_SCHEDULE", "0 22 * * 0-4,6"))
