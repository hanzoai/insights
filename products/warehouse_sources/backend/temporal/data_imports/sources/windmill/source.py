...
class WindmillSource(ResumableSource[WindmillSourceConfig, WindmillResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Windmill instance URL, workspace ID, and API token to sync your Windmill data into the Insights Data warehouse.
...
The audit logs table requires a workspace-admin token and is a Windmill Enterprise Edition feature.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/windmill",
