 ...
 *
 * Insights API - MCP 19 enabled ops
 * OpenAPI spec version: 1.0.0
 */
import * as zod from 'zod'

export const InsightsFlowsListParams = /* @__PURE__ */ zod.object({
    project_id: zod
        .string()
        .describe(
...
export const InsightsFlowsListQueryParams = /* @__PURE__ */ zod.object({
...
export const InsightsFlowsCreateParams = /* @__PURE__ */ zod.object({
    project_id: zod
        .string()
        .describe(
            "Project ID of the project you're trying to access. To find the ID of the project, make a call to \/api\/projects\/."
...
export const InsightsFlowsRetrieveParams = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this script flow.'),
    project_id: zod
        .string()
        .describe(
            "Project ID of the project you're trying to access. To find the ID of the project, make a call to \/api\/projects\/."
...
export const InsightsFlowsPartialUpdateParams = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this script flow.'),
    project_id: zod
        .string()
        .describe(
...
export const InsightsFlowsActionsEmailPartialUpdateParams = /* @__PURE__ */ zod.object({
...
export const InsightsFlowsBatchJobsListParams = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this script flow.'),
    project_id: zod
        .string()
        .describe(
...
export const InsightsFlowsDiscardDraftCreateParams = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this script flow.'),
    project_id: zod
        .string()
        .describe(
...
export const InsightsFlowsGraphPartialUpdateParams = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this script flow.'),
    project_id: zod
        .string()
        .describe(
...
export const InsightsFlowsInvocationResultsRetrieveParams = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this script flow.'),
    project_id: zod
        .string()
        .describe(
...
export const InsightsFlowsInvocationResultRetrieveParams = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this script flow.'),
...
export const InsightsFlowsInvocationsCreateParams = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this script flow.'),
    project_id: zod
        .string()
        .describe(
...
export const InsightsFlowsLogsRetrieveParams = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this script flow.'),
    project_id: zod
        .string()
        .describe(
...
export const InsightsFlowsMetricsRetrieveParams = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this script flow.'),
    project_id: zod
        .string()
        .describe(
...
export const InsightsFlowsPublishCreateParams = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this script flow.'),
    project_id: zod
        .string()
        .describe(
...
export const InsightsFlowsRevisionsListParams = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this script flow.'),
    project_id: zod
        .string()
        .describe(
...
export const InsightsFlowsRevisionsListQueryParams = /* @__PURE__ */ zod.object({
    limit: zod.number().optional().describe('Number of results to return per page.'),
    offset: zod.number().optional().describe('The initial index from which to return the results.'),
})

export const InsightsFlowsRevisionsRetrieveParams = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this script flow.'),
    project_id: zod
        .string()
        .describe(
...
export const InsightsFlowsRevisionsRestoreCreateParams = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this script flow.'),
    project_id: zod
        .string()
        .describe(
...
export const InsightsFlowsSchedulesPartialUpdateParams = /* @__PURE__ */ zod.object({
    id: zod.string().describe('A UUID string identifying this script flow.'),
    project_id: zod
        .string()
        .describe(
...
export const InsightsFlowsMetricsGlobalRetrieveParams = /* @__PURE__ */ zod.object({
    project_id: zod
        .string()
        .describe(
            "Project ID of the project you're trying to access. To find the ID of the project, make a call to \/api\/projects\/."
