...
class FloatAppSource(ResumableSource[FloatAppSourceConfig, FloatAppResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Float access token to automatically pull your Float resource-management data into the Insights Data warehouse.
...
All streams sync via full refresh — Float's API exposes no server-side modified-since filter on its core resources.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/float-app",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
