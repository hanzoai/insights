...
class UnleashSource(ResumableSource[UnleashSourceConfig, UnleashResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Unleash instance URL and an Admin API token to sync your feature flags, projects, environments, strategies, segments, and other configuration data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/unleash",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
