...
class AshbySource(ResumableSource[AshbySourceConfig, AshbyResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Ashby API key to pull your Ashby (ATS) data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/ashby",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
    ...
    def get_schemas(
        ...
        # `createdAfter` filter — neither maps safely onto Insights's timestamp-watermark
