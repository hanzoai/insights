...
from insights.temporal.session_replay.surfacing_score_export_sweep.activities import (
    export_scores_partition_activity,
    list_export_partitions_activity,
)
from insights.temporal.session_replay.surfacing_score_export_sweep.constants import MAX_CONCURRENT_EXPORT_PARTITIONS
from insights.temporal.session_replay.surfacing_score_export_sweep.types import (
    ExportPartitionResult,
    ExportPartitionSpec,
    ExportScoresSweepInputs,
    ListExportPartitionsResult,
)
from insights.temporal.session_replay.surfacing_score_export_sweep.workflow import ExportSurfacingScoresWorkflow
...
async def test_bounds_concurrent_partition_activities() -> None:
    ...
    with (
        ...
        patch(
            "insights.temporal.session_replay.surfacing_score_export_sweep.workflow.record_tick_summary"
        ) as record_summary,
    ):
