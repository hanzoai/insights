...
class OrbSource(ResumableSource[OrbSourceConfig, OrbResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Orb API key to automatically pull your Orb billing data into the Insights Data warehouse.
...
You can create an API key in your [Orb account settings](https://app.withorb.com/settings). A read-only key is sufficient.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/orb",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
