...
from insights.storage.recordings.errors import FileFetchError, FileUploadError
from insights.storage.recordings.file_storage import AsyncFileStorage, FileStorage, async_file_storage, file_storage
...
class TestFileStorage(APIBaseTest):
    ...
    @patch("insights.storage.recordings.file_storage.boto3_client")
...
class TestAsyncFileStorage(APIBaseTest):
    ...
    @patch("insights.storage.recordings.file_storage.aioboto3")
