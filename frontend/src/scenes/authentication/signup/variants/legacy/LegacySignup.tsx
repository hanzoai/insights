...
function Signup(): JSX.Element | null {
    ...
    const footerHighlights = {
        cloud: ['Hosted & managed by Insights', 'Pay per event, cancel anytime', 'Fast and reliable support'],
...
const productBenefits = [
    ...
    },
    {
        ...
        description: 'Airbus, Hasura, Y Combinator, Staples, and thousands more trust Insights as their Product OS.',
    },
]
