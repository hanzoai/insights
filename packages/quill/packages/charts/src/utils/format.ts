// Self-contained number/colour/currency formatting helpers. script-charts is intended to
// move into a standalone UI library, so this file deliberately has no Insights imports —
