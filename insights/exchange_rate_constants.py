# Django-free home for the exchange-rate Datastore dictionary constants. Kept out of
# insights.models.exchange_rate.sql (whose package __init__ boots the Django ORM) so the InsightsQL
# engine — schema tables and the printer — can reference them without booting Django.
# insights.models.exchange_rate.sql re-exports these for existing callers.
