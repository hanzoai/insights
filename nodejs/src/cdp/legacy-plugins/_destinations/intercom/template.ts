...
export const intercomPlugin: LegacyDestinationPlugin = {
    ...
    template: {
        ...
        icon_url: 'https://raw.githubusercontent.com/PostHog/insights-intercom-plugin/main/logo.png',
        category: [],
        ...
        inputs_schema: [
            ...
            },
            {
                ...
                type: 'string',
                description:
                    'A comma-separated list of Insights events you want to send to Intercom (e.g.: `$identify,mycustomevent` ).',
                default: '$identify',
                required: true,
                secret: false,
            },
            {
                ...
                type: 'string',
                description:
                    'A comma-separated list of email domains to ignore and not send events for in Intercom (e.g. `hanzo.ai,dev.hanzo.ai` ).',
                default: '',
                required: false,
                secret: false,
            },
