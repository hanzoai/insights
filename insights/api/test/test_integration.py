...
from insights.models.integration import PRIVATE_CHANNEL_WITHOUT_ACCESS, EmailIntegration, Integration, SlackIntegration
...
class TestEmailIntegration:
    ...
    def test_integration_from_domain(self, mock_ses_provider_class):
        ...
        mock_client.create_email_domain.assert_called_once_with(
            "insights.com", mail_from_subdomain="youmustnothavelikedmyemail", team_id=self.team.id
        )
    ...
    def test_email_verify_returns_ses_result(self, mock_ses_provider_class):
        ...
        mock_client.verify_email_domain.assert_called_once_with(
            "insights.com", mail_from_subdomain="feedback", team_id=self.team.id
        )
