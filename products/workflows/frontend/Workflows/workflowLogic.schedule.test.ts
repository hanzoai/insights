...
import { DEFAULT_STATE, ONE_TIME_RRULE } from './insightsflows/steps/components/rrule-helpers'
import { InsightsFlowSchedule } from './insightsflows/types'
import { workflowLogic } from './workflowLogic'

const WEEKLY_MONDAY_RRULE = 'FREQ=WEEKLY;INTERVAL=1;BYDAY=MO'
const STARTS_AT = '2026-04-10T09:00:00.000Z'

const makeSchedule = (overrides: Partial<InsightsFlowSchedule> = {}): InsightsFlowSchedule => ({
    id: 'schedule-1',
