...
from insights.schema import InsightsQLQueryModifiers, PropertyOperator, SessionPropertyFilter, WebStatsBreakdown
...
from insights.insightsql.property import _expr_to_compare_op, property_to_expr
from insights.insightsql.timings import InsightsQLTimings

from insights.models.property import Property, ValueT
...
def first_pageview_session_filter_expr(
    ...
    *,
    ...
    Datastore turns the plain `IN` into a `GLOBAL IN` under
...
def first_pageview_aware_properties_to_expr(
    ...
    *,
    team: "Team",
    modifiers: Optional[InsightsQLQueryModifiers],
    ...
    inside_periods = parse_expr(
        ...
        placeholders={"date_from": date_range.date_from_as_insightsql(), "date_to": date_range.date_to_as_insightsql()},
    )
