...
/** Map a clustering level to the Datastore event name its runs are emitted under. */
...
export interface clustersLogicMeta {
    __keaTypeGenInternalSelectorTypes: {
        ...
        scatterPlotDatasets: (filteredSortedClusters: Cluster[]) => ScatterDataset[]
    }
}
...
export const clustersLogic = kea<clustersLogicType>([
        ...
        propertyFilteredItemIds: [
            null as Set<string> | null,
            {
                loadPropertyFilteredItemIds: async (_, breakpoint) => {
                    ...
                    // filter rather than a raw InsightsQL `where` clause: `properties.$ai_generation_id`
                    ...
                    const eventsQuery: EventsQuery = {
                        ...
                        // Required for the query runner to populate the `product` Datastore
    ...
    listeners(({ actions, values }) => ({
        ...
        loadClusterMetricsForRun: async ({ run }) => {
            ...
            // Use those directly instead of a second InsightsQL round-trip that tries to
