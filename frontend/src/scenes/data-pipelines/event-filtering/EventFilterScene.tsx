...
import { Banner, Button, Divider, Label, Modal, SegmentedButton } from '@hanzo/elements'
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-start justify-between">
                            <div>
                                <Label>Drop events matching</Label>
                        ...
                        >
                            ...
                            {showFilterFormErrors && filterFormErrors.mode && (
                                <Banner type="error">{filterFormErrors.mode}</Banner>
                            )}
                            <DragOverlay>
                                {activeNode ? (
                    ...
                    <div className="flex gap-2">
                        <Button type="primary" onClick={() => submitFilterForm()} loading={isFilterFormSubmitting}>
                            Save
                        </Button>
                    </div>
                </div>
