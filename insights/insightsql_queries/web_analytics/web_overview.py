...
HAVING {inside_start_timestamp_period}
    ...
    def outer_select(self) -> ast.SelectQuery:
        ...
        def metric_pair(
            ...
            # This could also be done using tuples like the stats_table but I will keep the protocol as close as possible: https://github.com/hanzoai/insights/blob/26588f3689aa505fbf857afcae4e8bd18cf75606/insights/insightsql_queries/web_analytics/stats_table.py#L390-L399
