...
export function BaseCurrency({ hideTitle = false, disabledReason }: BaseCurrencyProps): JSX.Element {
    ...
    return (
        <SceneSection
            ...
            description="Insights will convert all currency values for the entire project to this currency before displaying them to you. If we can't properly detect your currency, we'll assume it's in this currency as well."
        >
            <div>
                <CurrencyDropdown
