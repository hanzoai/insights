...
from insights.permissions import AccessControlPermission, APIScopePermission, TeamMemberAccessPermission
...
class LLMSkillMarketplaceViewSet(TeamAndOrgViewSetMixin, viewsets.GenericViewSet):
    ...
    www_authenticate_challenge = 'Basic realm="Insights Skills Marketplace"'
