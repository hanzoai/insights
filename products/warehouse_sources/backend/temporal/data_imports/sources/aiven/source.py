...
class AivenSource(SimpleSource[AivenSourceConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter an Aiven API token to pull your Aiven projects, services and billing data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/aiven",
