...
class SnapshotLoader:
    ...
    def _patch_query_runners(self):
        self.patches = [
            patch(
                "posthog.insightsql_queries.ai.team_taxonomy_query_runner.TeamTaxonomyQueryRunner",
                new=PatchedTeamTaxonomyQueryRunner,
            ),
            patch(
                "posthog.insightsql_queries.ai.event_taxonomy_query_runner.EventTaxonomyQueryRunner",
                new=PatchedEventTaxonomyQueryRunner,
            ),
            patch(
                "posthog.insightsql_queries.ai.actors_property_taxonomy_query_runner.ActorsPropertyTaxonomyQueryRunner",
