...
export interface InsightsAiContextLogicProps {
...
export interface insightsAiContextLogicValues {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface insightsAiContextLogicActions {
    attach: (item: AttachedContext) => {
...
// Generated by kea-typegen. Update if you're an agent, ignore if you're human.
export interface insightsAiContextLogicMeta {
    key: string
    __keaTypeGenInternalSelectorTypes: {
        chipsForDisplay: (attachments: AttachedContext[]) => {
            icon: ReactNode
            key: string
            label: string
        }[]
...
export type insightsAiContextLogicType = MakeLogicType<
    insightsAiContextLogicValues,
    insightsAiContextLogicActions,
    InsightsAiContextLogicProps,
    insightsAiContextLogicMeta
>
 ...
 */
export const insightsAiContextLogic = kea<insightsAiContextLogicType>([
    props({} as InsightsAiContextLogicProps),
    key((props) => props.conversationId),
    path((key) => ['scenes', 'max', 'insightsAiContextLogic', key]),
    connect(() => ({
    ...
    selectors({
        chipsForDisplay: [
            ...
            (attachments: AttachedContext[]): { key: string; label: string; icon: ReactNode }[] =>
