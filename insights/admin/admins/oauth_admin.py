...
from insights.models.oauth import OAuthApplication, revoke_application_sessions
from insights.models.oauth_provisioning import ProvisioningConfig, ProvisioningRateLimits
...
# Registered manually in `insights/admin/__init__.py::register_all_admin()`
...
class OAuthApplicationAdmin(admin.ModelAdmin):  # nosemgrep: admin-modeladmin-needs-register-decorator
    ...
    def revoke_all_sessions(self, request, queryset):
        ...
        return TemplateResponse(request, "admin/insights/oauthapplication/revoke_all_sessions_confirm.html", context)
