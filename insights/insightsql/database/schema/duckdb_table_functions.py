...
class RangeTable(FunctionCallTable, DANGEROUS_NoTeamIdCheckTable):
    ...
    description: str = (
        ...
        "the stop value is exclusive. Not supported in the Datastore dialect."
    )
    ...
    def to_printed_datastore(self, context):
        raise QueryError("range() is not supported in Datastore dialect")
...
class GenerateSeriesTable(FunctionCallTable, DANGEROUS_NoTeamIdCheckTable):
    ...
    description: str = (
        ...
        "the stop value is inclusive. Not supported in the Datastore dialect."
    )
    fields: dict[str, FieldOrTable] = {
    ...
    def to_printed_datastore(self, context):
        raise QueryError("generate_series() is not supported in Datastore dialect")
...
class OpaqueFunctionCallTable(FunctionCallTable, DANGEROUS_NoTeamIdCheckTable):
    ...
    description: str = (
        ...
        "Exposes a single column named after the function with an unknown type. Not supported in the Datastore dialect."
    )
    fields: dict[str, FieldOrTable]
    name: str
    ...
    def to_printed_datastore(self, context):
        raise QueryError(f"Table function '{self.name}' is not supported in Datastore dialect")
