...
class AviationstackSource(ResumableSource[AviationstackSourceConfig, AviationstackResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your aviationstack access key to pull real-time, scheduled, and historical flight data plus aviation reference tables into the Insights Data warehouse.
...
Note: aviationstack pricing is a monthly request quota tied to your plan. Some tables (e.g. historical flights and certain filters) require a paid plan.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/aviationstack",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
