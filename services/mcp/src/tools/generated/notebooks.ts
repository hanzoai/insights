...
const notebooksCreate = (): ToolBase<typeof NotebooksCreateSchema, WithInsightsUrl<Schemas.Notebook>> => ({
...
const notebooksGet = (): ToolBase<
    ...
    WithInformationalResponse<WithInsightsUrl<Schemas.NotebookSQLV2StateResponse>>
> => ({
    name: 'notebooks-get',
...
const notebooksList = (): ToolBase<
    ...
    WithInsightsUrl<Schemas.PaginatedNotebookMinimalList>
> => ({
    name: 'notebooks-list',
    ...
    handler: async (context: Context, params: z.infer<typeof NotebooksListSchema>) => {
        ...
        return await withInsightsUrl(context, result, '/notebooks')
    },
})
...
const notebooksRetrieve = (): ToolBase<typeof NotebooksRetrieveSchema, WithInsightsUrl<Schemas.Notebook>> => ({
