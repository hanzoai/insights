...
2. Fail-closed manager coverage: every team-scoped model uses
   ...
   don't are checked against `insights/models/scoping/baseline_unmigrated.txt`
...
BASELINE_FILE = REPO_ROOT / "insights/models/scoping/baseline_unmigrated.txt"
...
def check_fail_closed_baseline(
    ...
    *,
    ...
    if new_violations:
        ...
        print("  See insights/models/scoping/README.md for the contract.")
        return True, False
