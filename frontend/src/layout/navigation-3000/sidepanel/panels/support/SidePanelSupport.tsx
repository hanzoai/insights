...
export function SidePanelSupport(): JSX.Element {
    ...
    // Free plans can't open new tickets, but tickets they already have (billing questions, Insights AI
                ...
                <SidePanelPaneHeader showCloseButton={false} title={isEmailFormOpen ? supportPanelTitle : 'Support'}>
                    {showTickets && (
                        <Button
                            ...
                            // Button's tooltip→aria-label fallback only applies to plain buttons,
                        ...
                        <>
                            ...
                            {showTickets && isBillingLoaded && (
                                <Section title={canCreateTicket ? 'Contact us' : 'Your tickets'}>
                                    ...
                                    <p>
                                        {canCreateTicket
                                            ? "Can't find what you need and Insights AI unable to help? Message our support engineers."
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <Button
                                            type="secondary"
                                            status="alt"
                                            to="https://github.com/Insights/insights/issues/new?&labels=enhancement&template=feature_request.yml"
                                            icon={<IconFeatures />}
                                            targetBlank
                                        >
                                            Request a feature
