...
/**
 * Redeem a Insights Desktop invite code to enable access.
...
export const loopsCreateBodyConnectorsOneInsightsMcpScopesDefault = `read_only`
    ...
    .object({
            ...
            .array(
                zod.object({
                    ...
                    full_name: zod
                        ...
                        .describe('Repository in `organization\/repo` format, e.g. `insights\/insights`.'),
                })
            )
        ...
        connectors: zod
            .object({
                ...
                insights_mcp_scopes: zod
                    .enum(['read_only', 'full'])
                    .describe('\* `read_only` - read_only\n\* `full` - full')
                    .default(loopsCreateBodyConnectorsOneInsightsMcpScopesDefault)
                    .describe(
...
export const loopsPartialUpdateBodyConnectorsOneInsightsMcpScopesDefault = `read_only`
        ...
        connectors: zod
            .object({
                ...
                insights_mcp_scopes: zod
                    .enum(['read_only', 'full'])
                    .describe('\* `read_only` - read_only\n\* `full` - full')
                    .default(loopsPartialUpdateBodyConnectorsOneInsightsMcpScopesDefault)
                    .describe(
                        "Scope of the Insights MCP access injected into this loop's runs.\n\n\* `read_only` - read_only\n\* `full` - full"
                    ),
            })
...
/**
 * API for a channel's system-announcement feed — durable "Insights agent" rows
...
export const TasksCreateBody = /* @__PURE__ */ zod
    .object({
        ...
        repository: zod
            ...
            .nullish()
            .describe('Target GitHub repository in `organization\/repo` format (e.g. `insights\/insights-js`).'),
...
export const TasksRunsCreateBody = /* @__PURE__ */ zod
    .object({
        ...
        github_user_token: zod
            .string()
            .optional()
            .describe('Ephemeral GitHub user token from Insights Desktop for user-authored cloud pull requests.'),
        initial_permission_mode: zod
...
/**
 * Renders a Insights insight (ad-hoc query JSON or a saved insight) to a PNG server-side and registers it as a slack_file living artifact in one call. Blocks until the render finishes.
...
export const TasksWarmCreateBody = /* @__PURE__ */ zod
    .object({
        repository: zod
            ...
            .describe('Target GitHub repository to clone, in `organization\/repo` format (e.g. `insights\/insights`).'),
