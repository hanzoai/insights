    ...
    return (
        <div className="flex-shrink-0 mx-auto md:mx-0 md:w-40">
            <div className="w-40 h-40 mx-auto">
                <MascotRobot className="w-full h-full" />
            </div>
...
function CallActionButton({
    ...
    switch (state) {
        ...
        case 'in-call':
            return (
                <Button type="secondary" onClick={onStop}>
                    End interview
                </Button>
            )
        case 'error':
    ...
    return (
        <div className="max-w-2xl mx-auto px-4 py-12">
            ...
            <p className="text-xs text-muted text-center mt-12">
                Your conversation will be transcribed and analyzed to help improve Insights. We won't share your
