...
from insights.models.utils import UpdatedMetaFields, UUIDModel, uuid7
from insights.products import Products
from insights.schema_enums import ProductIntentContext, ProductItemCategory, ProductKey
...
class UserProductList(UUIDModel, UpdatedMetaFields):
    ...
    # which loop back through `insights.models`). When the plugin analyzes the model mid-cycle it
