...
from insights.models.event.sql import EVENTS_PROPERTIES_JSON_SUBCOLUMNS, PERSON_PROPERTIES_JSON_SUBCOLUMNS
from insights.models.group.sql import GET_GROUP_IDS_BY_PROPERTY_SQL
from insights.models.person.sql import GET_DISTINCT_IDS_BY_PERSON_ID_FILTER, GET_DISTINCT_IDS_BY_PROPERTY_SQL
from insights.models.property import (
    NEGATED_OPERATORS,
    OperatorType,
    Property,
    PropertyGroup,
...
from insights.models.property.property import ValueT
...
from insights.utils import is_json, is_valid_regex
...
def parse_prop_clauses(
    ...
    *,
    ...
    use_new_events_schema = insightsql_context.uses_new_events_schema() if insightsql_context is not None else False
...
def _json_events_subcolumn_expr(
    ...
    if "%" not in property_name:
        ...
        return f"{column_ref}{separator}{escape_datastore_identifier(property_name)}"
