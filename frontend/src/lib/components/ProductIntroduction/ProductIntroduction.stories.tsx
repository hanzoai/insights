...
/** Dashboard empty-state-style intro: matches `EmptyDashboardComponent` copy, with `MascotChart` + responsive layout. */
    ...
    return (
        <div className="flex flex-col gap-6">
            <p className="text-secondary text-sm m-0">
                Left: main-content width under 48rem → stacked. Right: over 48rem → row (script beside copy).
            </p>
