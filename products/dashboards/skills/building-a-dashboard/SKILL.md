...
description: >
  ...
  Covers deciding create vs update, reusing existing insights vs creating new ones, and using Insights's
...
Insights ships vetted dashboard templates for common topics, and orgs can share their own. Consult them before you
