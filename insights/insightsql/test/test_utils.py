...
from insights.insightsql.utils import deserialize_hx_ast, ilike_matches, like_matches
...
class TestUtils(BaseTest):
    ...
    def test_deserialize_hx_ast(self):
        ...
        assert deserialize_hx_ast(
            ...
            select=[
                ast.InsightsQLXTag(
                    kind="blink", attributes=[ast.InsightsQLXAttribute(name="children", value=[ast.Field(chain=["event"])])]
                ),
