...
from insights.temporal.session_replay.rasterize_recording.activities.stuck_counter import (
    _STUCK_TTL_SECONDS,
...
async def test_bump_stuck_counter_pipelines_incr_and_expire():
    ...
    with patch(
        "insights.temporal.session_replay.rasterize_recording.activities.stuck_counter.get_async_client",
