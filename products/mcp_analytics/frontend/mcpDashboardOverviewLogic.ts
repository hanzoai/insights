...
// Mirrors MCPToolQualityRowsQueryRunner (products/mcp_analytics/backend/insightsql_queries/tool_quality_tables.py)
...
// runner (products/mcp_analytics/backend/insightsql_queries/harness_breakdown.py) — the
...
function kpiWindowFilters(queryFilters: InsightsQLFilters, kpiWindow: KpiWindow): InsightsQLFilters {
...
export interface mcpDashboardOverviewLogicValues {
    ...
    queryFilters: InsightsQLFilters
