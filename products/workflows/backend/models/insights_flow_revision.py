...
class InsightsFlowRevision(TeamScopedRootMixin, UUIDTModel):
    ...
    hog_flow = models.ForeignKey("workflows.InsightsFlow", on_delete=models.CASCADE, related_name="revisions")
    ...
    def __str__(self) -> str:
        return f"InsightsFlowRevision {self.hog_flow_id} v{self.version}"
