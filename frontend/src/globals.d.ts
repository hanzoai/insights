...
declare global {
    ...
    const __INSIGHTS_TOOLBAR_PUBLIC_PATH__: string
    ...
    const __INSIGHTS_TOOLBAR_APP_ENTRY__: string
    ...
    interface Window {
        ...
        JS_INSIGHTS_IDENTITY_DISTINCT_ID?: string
        JS_INSIGHTS_IDENTITY_HASH?: string
