...
class TestDiscoverDomainConnect(BaseTest):
    ...
    @patch("insights.domain_connect._fetch_provider_settings")
    @patch("insights.domain_connect._lookup_domain_connect_endpoint")
...
class TestGenerateApplyUrl(BaseTest):
    ...
    @patch("insights.domain_connect._fetch_provider_settings")
    @patch("insights.domain_connect.get_signing_key")
    ...
    @patch("insights.domain_connect.discover_domain_connect")
    @patch("insights.domain_connect.get_signing_key")
