...
class BluetallySource(ResumableSource[BluetallySourceConfig, BluetallyResumeConfig]):
    ...
    default_version = "v1"
    api_docs_url = "https://developer.bluetally.com/reference"
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your BlueTally API key to sync your IT asset management data into the Insights Data warehouse.
...
If your account has multi-tenancy enabled, also enter the tenant ID the key should act on.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/bluetally",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
