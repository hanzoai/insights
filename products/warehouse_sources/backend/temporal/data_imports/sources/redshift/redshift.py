"""Redshift driver for Insights's data-warehouse import pipeline.
...
Insights-layer wrapper that just holds an instance and validates
credentials.
"""
        ...
        def get_rows() -> Iterator[Any]:
            ...
            with self.connect(config) as streaming_connection:
                ...
                yield from _stream_arrow_batches(
                    ...
                    chunk_size,
                    arrow_schema,
                    f"insights_{inputs.team_id}_{schema}.{table_name}",
                    logger,
                )
