...
class TestSessionBatchEventsQueryRunner(DatastoreTestMixin, APIBaseTest):
    ...
    def test_cached_response_vs_calculate(self):
        ...
        with freeze_time("2025-01-11T16:00:00"):
            ...
            self.assertEqual(calculate_response.insightsql, cached_response.insightsql)
    ...
    def test_pagination_with_offset(self):
        """Test pagination functionality with offset parameter using InsightsQLHasMorePaginator."""
