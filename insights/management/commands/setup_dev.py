...
from insights.demo.legacy import ORGANIZATION_NAME, TEAM_NAME, create_demo_data
from insights.models import EventProperty, PersonalAPIKey, Plugin, PluginConfig, PluginSourceFile, Team, User
