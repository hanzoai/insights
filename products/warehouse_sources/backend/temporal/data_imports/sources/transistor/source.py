...
class TransistorSource(ResumableSource[TransistorSourceConfig, TransistorResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Sync your shows, episodes, private podcast subscribers, and daily download analytics from [Transistor](https://transistor.fm) into the Insights Data warehouse.
...
Download analytics sync incrementally by day. The other tables sync as a full refresh.""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/transistor",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
