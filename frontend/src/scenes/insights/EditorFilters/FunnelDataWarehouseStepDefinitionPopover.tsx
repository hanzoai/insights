...
import { Button, InputSelect, SegmentedButton, Link } from '@hanzo/elements'
...
function FunnelDataWarehouseStepDefinitionPopoverContent({
    ...
    const {
        ...
        activeFieldValue,
        activeFieldOptions,
        activeFieldIsInsightsQL,
        isAggregatingByGroup,
        isAggregatingByInsightsQL,
        linkedTables,
        previewTable,
    ...
    return (
        <div className="flex flex-col">
                    ...
                    {isAggregatingByInsightsQL ? (
                        ...
                        <>
                            ...
                            <div className="mt-1">
                                ...
                                <Link to="https://hanzo.ai/docs/data-warehouse/join#table-joins" target="_blank">
                                    For more help
                                </Link>
                                .
                            </div>
            ...
            <InputSelect
                ...
                value={activeFieldIsInsightsQL ? [''] : activeFieldValue != null ? [activeFieldValue] : null}
            ...
            <div className="flex justify-end mt-4">
                <Button onClick={selectTable} type="primary">
                    Select
                </Button>
            </div>
        </div>
