...
_WORKFLOW_ID = "review-pr:42:insights/insights:7-sandbox"
...
@pytest.mark.parametrize(
    ...
    [
        (
            ["github.com", "api.github.com", "hanzo.ai", "us.hanzo.ai", "example.com"],
            ["github.com", "api.github.com", "example.com", "*.hanzo.ai", "api.anthropic.com"],
        ),
        (
            [],
            ["*.hanzo.ai", "api.anthropic.com"],
        ),
        (
            ["github.com", "localhost", "host.docker.internal", "registry.npmjs.org"],
            ["github.com", "registry.npmjs.org", "*.hanzo.ai", "api.anthropic.com"],
        ),
        (
            ["*.hanzo.ai", "*.us.hanzo.ai", "gateway.us.hanzo.ai", "github.com"],
            ["*.hanzo.ai", "github.com", "api.anthropic.com"],
        ),
        (
            ["github.com", "github.com", "api.anthropic.com"],
            ["github.com", "api.anthropic.com", "*.hanzo.ai"],
        ),
    ],
)
...
@override_settings(DEBUG=False, SANDBOX_AI_GATEWAY_URL="https://ai-gateway.dev.insights.dev")
def test_to_modal_domain_allowlist_admits_configured_gateway_host():
    ...
    # *.hanzo.ai and nothing else admits it.
    assert "ai-gateway.dev.insights.dev" in _to_modal_domain_allowlist([])
...
def test_build_environment_variables_injects_ai_gateway_pair(_api, _jwt, _git):
    ...
    assert env["AI_GATEWAY_URL"] == "https://ai-gateway.us.hanzo.ai"
