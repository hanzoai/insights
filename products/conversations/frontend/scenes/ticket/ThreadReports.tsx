 ...
 * glance: not a person, not sent to anyone, and about this conversation. It wears the Insights mark
        ...
        <div className="mb-4">
            ...
            <div className="flex items-center justify-between w-full gap-2 mb-1">
                <div className="flex items-center gap-1.5 min-w-0">
                    {/* The Insights mark rather than an avatar: this is our software acting, not a
