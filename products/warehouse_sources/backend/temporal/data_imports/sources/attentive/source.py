...
class AttentiveSource(
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/attentive",
            ...
            webhookSetupCaption=(
                "Insights tries to register the webhook for you using your API key. Attentive doesn't "
    ...
    def webhook_inputs_updated(
        ...
        # fire events at Insights before we can verify them with the signing
