...
Turns Insights products ON so their signal sources have data to read. The wizard
...
from insights.api.team import TEAM_CONFIG_ADMIN_FIELDS_SET
from insights.helpers.impersonation import is_impersonated
from insights.models import OrganizationMembership, User
from insights.models.activity_logging.activity_log import Detail, dict_changes_between, log_activity
from insights.models.team import Team

# Written only when the team has none set. insights-js already masks inputs + passwords
...
def _enable_conversations(team: Team, touched: set[str]) -> str:
    ...
    # Mirror handle_conversations_token_on_update (insights/api/team.py): mint a widget
