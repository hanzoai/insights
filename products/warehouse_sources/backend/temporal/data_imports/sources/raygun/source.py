...
RAYGUN_CAPTION = """Enter a Raygun [personal access token](https://raygun.com/documentation/product-guides/apis/personal-access-tokens/) to pull your Raygun crash reporting and real user monitoring data into the Insights Data warehouse.
...
class RaygunSource(ResumableSource[RaygunSourceConfig, RaygunResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/raygun",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
