...
# omit limit get everything; the max doubles as the safety cap on the Datastore scan
...
class MCPToolCallSerializer(serializers.Serializer):
    event_id = serializers.CharField(read_only=True, help_text="Datastore uuid of the $mcp_tool_call event.")
...
class MCPSessionListQuerySerializer(serializers.Serializer):
    ...
    date_from = serializers.CharField(
        ...
        allow_blank=True,
        help_text=(
            "Start of the window to aggregate sessions over. Insights date string — relative "
    ...
    date_to = serializers.CharField(
        required=False,
        allow_blank=True,
        help_text="End of the window. Insights date string or absolute ISO timestamp. Defaults to now.",
    )
...
class MCPSessionSerializer(serializers.Serializer):
    ...
    distinct_id_count = serializers.IntegerField(
        read_only=True, help_text="Number of distinct Insights distinct_ids that produced events in the session."
    )
