...
class OmnisendSource(ResumableSource[OmnisendSourceConfig, OmnisendResumeConfig]):
    ...
    def get_source_config(self) -> SourceConfig:
        return SourceConfig(
            ...
            caption="""Enter your Omnisend API key to automatically pull your Omnisend data into the Insights Data warehouse.
...
""",
            ...
            docsUrl="https://hanzo.ai/docs/cdp/sources/omnisend",
            fields=cast(
                list[FieldType],
                [
                    SourceFieldInputConfig(
