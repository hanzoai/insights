...
# posthog/insightsql_queries/ai/team_taxonomy_query_runner.py
class TeamTaxonomyItemSnapshot(AvroBase):
    results: list[TeamTaxonomyItem]


# posthog/insightsql_queries/ai/event_taxonomy_query_runner.py
class PropertyTaxonomySnapshot(AvroBase):
    event: str
    results: list[EventTaxonomyItem]


# posthog/insightsql_queries/ai/actors_property_taxonomy_query_runner.py
