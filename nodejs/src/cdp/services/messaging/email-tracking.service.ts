...
// Allowlist of metrics that surface as Insights events when engagement-event capture is enabled.
...
export const resolveEmailEngagementDistinctId = (
    invocation: Pick<CyclotronJobInvocationInsightsFunction, 'state'>
): string | undefined => {
