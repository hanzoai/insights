// ---------------------------------------------------------------------------
// Custom Insights request header names
// ---------------------------------------------------------------------------
...
pub const INSIGHTS_AI_GATEWAY_SIGNATURE: &str = crate::gateway_provenance::SIGNATURE_HEADER;

/// AI-gateway provenance: RFC3339 timestamp the gateway signed at.
pub const INSIGHTS_AI_GATEWAY_SIGNED_AT: &str = crate::gateway_provenance::SIGNED_AT_HEADER;
...
/// Insights-Request-Timestamp header vs. server receive time. Buckets
