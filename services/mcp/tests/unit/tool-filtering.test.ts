...
describe('OAUTH_SCOPES_SUPPORTED completeness', () => {
    ...
    // (mirrors INTERNAL_API_SCOPE_OBJECTS in insights/scopes.py). Tools may require them, but
    ...
    // OAuth-hidden scopes (generated from OAUTH_HIDDEN_SCOPE_OBJECTS in insights/scopes.py)
