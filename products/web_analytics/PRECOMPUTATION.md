...
- **Coverage** (today): `web_overview_query` and the PATHS (`WebStatsBreakdown.PAGE` + `includeBounceRate`) tile of `web_stats_table_query`. See `insights/insightsql_queries/web_analytics/web_overview_lazy_precompute.py` and `web_stats_paths_lazy_precompute.py`
...
Reference implementation: `insights/insightsql_queries/web_analytics/web_overview_lazy_precompute.py`.
...
- `insights/insightsql_queries/web_analytics/web_overview.py` — runner
- `insights/insightsql_queries/web_analytics/web_overview_lazy_precompute.py` — overview lazy path
- `insights/insightsql_queries/web_analytics/web_overview_pre_aggregated.py` — overview v2 path
- `insights/insightsql_queries/web_analytics/stats_table.py` — stats table runner
- `insights/insightsql_queries/web_analytics/web_stats_paths_lazy_precompute.py` — PATHS lazy path
- `insights/insightsql_queries/web_analytics/web_lazy_precompute_common.py` — shared eligibility gate + helpers
