        ...
        toasts: [
            {
                type: 'error',
                message:
                    'Load experiment failed: This feature is part of the premium Insights offering. To use it, subscribe to Insights Cloud with a generous free tier: https://app.posthog.com/organization/billing',
            },
        ],
    },
}
