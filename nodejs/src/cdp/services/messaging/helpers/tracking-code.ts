...
export const TRACKING_CODE_HEADER_NAME = 'X-Insights-Tracking-Code'
...
export type TrackingInvocation = Pick<CyclotronJobInvocationInsightsFunction, 'functionId' | 'id' | 'teamId'> & {
    ...
    // looked up on arrival. Absent for script function sends, which have no version.
    ...
    parse(encodedTrackingCode: string): ParsedTrackingCode | null {
        ...
        try {
            ...
            return {
                ...
                isTest: isTest === '1',
                // Empty for script function sends, which have no version.
                workflowVersion:
