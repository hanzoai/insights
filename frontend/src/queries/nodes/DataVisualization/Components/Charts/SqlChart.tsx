...
/**
 * Picks the @hanzo/quill-charts renderer for a SQL insight: combo for mixed bar + line/area
 ...
 *  stacked-bar, and combo series to the matching @hanzo/quill-charts renderer. */
