"""Property-definition metadata for InsightsQL property-type resolution.
...
from insights.property_columns import PropertyName, TableColumn
...
def load_property_metadata(
    ...
    *,
    ...
    from insights.datastore.materialized_columns import (  # noqa: PLC0415
        DMAT_STRING_COLUMN_NAME_PREFIX,
        get_enabled_materialized_columns_by_table,
    )
    from insights.models import PropertyDefinition, Team  # noqa: PLC0415
    from insights.models.materialized_column_slots import (  # noqa: PLC0415
