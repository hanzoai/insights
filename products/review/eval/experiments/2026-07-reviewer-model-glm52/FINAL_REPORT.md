...
2. **Codex MCP flakiness:** 9/21 Codex sandboxes in C1 (and several in C2) never got the `insights`
   MCP server's tools (`insights/exec` absent; agent logs "MCP skill reader is not exposed in this
