import { FlowScheduleService } from './flow-schedule.service'
...
const config = {
    ...
    FLOW_SCHEDULER_MAX_POLL_INTERVAL_MS: 300_000,
    FLOW_SCHEDULER_HEALTH_TIMEOUT_MS: 600_000,
} as any
...
describe('FlowScheduleService', () => {
    let service: FlowScheduleService

    beforeEach(() => {
        jest.clearAllMocks()
        service = new FlowScheduleService(config)
