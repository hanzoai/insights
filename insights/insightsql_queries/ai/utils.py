...
from insights.caching.utils import ThresholdMode, is_stale
...
# Ordered tuple of heavy column names. Used for unpacking event tuples from Datastore.
...
def merge_heavy_properties(
    ...
    Datastore).  Empty strings are skipped (the column default when the
    property was absent).
