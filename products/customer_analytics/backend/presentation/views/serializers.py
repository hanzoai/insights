...
class CustomPropertyDefinitionSerializer(DataclassSerializer):
    ...
    is_canonical = serializers.BooleanField(
        read_only=True,
        help_text=(
            "True when Insights writes this property itself. Its name and display type are fixed — "
...
class AccountAssignmentSerializer(DataclassSerializer):
    ...
    id = serializers.IntegerField(read_only=True, help_text="Insights user id of the assignee.")
...
class AccountRelationshipWriteSerializer(serializers.Serializer):
    ...
    user = serializers.IntegerField(
        help_text="Insights user id of the assignee. Must be a member of the account's organization."
    )
