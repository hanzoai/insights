...
WOOCOMMERCE_USER_AGENT = "Insights Data Warehouse (WooCommerce source; +https://hanzo.ai)"
...
def _assert_host_safe(store_url: str, team_id: int) -> None:
    ...
    self-hosted instances and blocks private/internal IPs on Insights Cloud.
    """
...
def create_webhook(
    ...
    echoes back on read - hence returning it via `extra_inputs` for the script function to verify with.
