...
from insights.temporal.ai.slack_app.attachments import build_slack_attachment_prompt_text, prepare_slack_file_artifacts
...
class TestSlackAttachments(SimpleTestCase):
    ...
    def test_prepares_safe_slack_file_as_user_attachment(
        ...
        with patch("insights.temporal.ai.slack_app.attachments._download_slack_file", return_value=b"hello") as download:
    ...
    def test_rejects_disallowed_attachment_metadata_without_downloading(
        ...
        with patch("insights.temporal.ai.slack_app.attachments._download_slack_file") as download:
    ...
    def test_blocks_script_payload_after_download(self) -> None:
        with patch(
            "insights.temporal.ai.slack_app.attachments._download_slack_file",
    ...
    def test_rejects_html_interstitial_response(self) -> None:
        ...
        with patch("insights.temporal.ai.slack_app.attachments.requests.get", return_value=response):
